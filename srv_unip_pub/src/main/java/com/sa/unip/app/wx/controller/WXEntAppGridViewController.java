...
/**
 * 视图[WXEntAppGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXEntAppGridView.do")
public class WXEntAppGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WXEntAppGridViewController() throws Exception {
        super();
        this.setId("44c339c6ec50320fe9a67c684e1404d8");
        this.setCaption("微信企业应用");
        this.setTitle("微信企业应用实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wx/WXEntAppGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXEntAppGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXEntAppGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXEntAppGridViewSearchFormHandler");
        searchForm.init(this);
