...
import com.sa.unip.app.srv.common.ctrlmodel.UserRoleMain2GridModel;
...
/**
 * 应用视图[UserRoleGridView]表格[grid]后台处理对象基类
 */
public class UserRoleGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleMain2GridModel gridModel = null;
    public UserRoleGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserRoleMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserRoleMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserRole entity)throws Exception {
