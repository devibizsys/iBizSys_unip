...
/**
 * 实体[工作流步骤]数据表格[grid]部件模型
 */
public class  WFStepMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFStepMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFSTEPID");
            gridEditItem.setCaption("工作流步骤标识");
