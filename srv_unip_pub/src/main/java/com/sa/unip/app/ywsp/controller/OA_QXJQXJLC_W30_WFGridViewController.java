...
/**
 * 视图[OA_QXJQXJLC_W30_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJQXJLC_W30_WFGridView.do")
public class OA_QXJQXJLC_W30_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_QXJQXJLC_W30_WFGridViewController() throws Exception {
        super();
        this.setId("39ce92d814d5bc209bd5ce14773538f7");
        this.setCaption("请休假");
        this.setTitle("请休假工作流表格视图(请休假流程:院领导审批)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJQXJLC_W30_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJQXJLC_W30_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJQXJLC_W30_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJQXJLC_W30_WFGridViewSearchFormHandler");
        searchForm.init(this);
