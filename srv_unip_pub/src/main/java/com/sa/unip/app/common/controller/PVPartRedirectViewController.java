...
/**
 * 视图[PVPartRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PVPartRedirectView.do")
public class PVPartRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public PVPartRedirectViewController() throws Exception {
        super();
        this.setId("269c40e60847c8b40789943820ffa1f3");
        this.setCaption("门户视图部件");
        this.setTitle("门户视图部件实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/PVPartRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PVPartRedirectViewController",this);
    }
