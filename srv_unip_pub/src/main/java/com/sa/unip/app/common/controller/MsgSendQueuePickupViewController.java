...
/**
 * 视图[MsgSendQueuePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgSendQueuePickupView.do")
public class MsgSendQueuePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public MsgSendQueuePickupViewController() throws Exception {
        super();
        this.setId("721fa6a14d2dc8358e9cea5de9970bf8");
        this.setCaption("消息发送队列");
        this.setTitle("消息发送队列实体数据选择视图");
        this.setCapLanResTag("DE.LNAME.MSGSENDQUEUE");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/MsgSendQueuePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgSendQueuePickupViewController",this);
    }
