...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_QXJSHYJFormEditFormModel;
...
public class OA_QXJWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_QXJSHYJFormEditFormModel editformModel = null;
    public OA_QXJWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_QXJSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_QXJSHYJFormEditFormModel getRealEditFormModel() {
