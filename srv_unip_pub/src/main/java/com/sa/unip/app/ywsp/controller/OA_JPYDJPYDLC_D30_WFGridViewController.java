...
/**
 * 视图[OA_JPYDJPYDLC_D30_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_JPYDJPYDLC_D30_WFGridView.do")
public class OA_JPYDJPYDLC_D30_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_JPYDJPYDLC_D30_WFGridViewController() throws Exception {
        super();
        this.setId("75b8c22928f94e03079d74a057612797");
        this.setCaption("机票预订");
        this.setTitle("机票预订工作流表格视图(机票预订流程:已完成)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_JPYDJPYDLC_D30_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_JPYDJPYDLC_D30_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDJPYDLC_D30_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDJPYDLC_D30_WFGridViewSearchFormHandler");
        searchForm.init(this);
