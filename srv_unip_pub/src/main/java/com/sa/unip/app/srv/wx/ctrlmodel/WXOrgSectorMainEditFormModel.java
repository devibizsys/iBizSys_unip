...
/**
 * 实体[微信部门]编辑表单[form]部件模型
 */
public class WXOrgSectorMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WXOrgSectorMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXORGSECTORID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信部门标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXORGSECTORID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXORGSECTORNAME");
            formItem.setCaption("微信部门名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXORGSECTORNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxorgsectorname
        iFormItem = this.createFormItem("wxorgsectorname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxorgsectorname");
            formItem.setDEFName("WXORGSECTORNAME");
            formItem.setCaption("微信部门名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxorgsectorname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // deptid
        iFormItem = this.createFormItem("deptid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("deptid");
            formItem.setDEFName("DEPTID");
            formItem.setCaption("部门编号");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("deptid");
        ...
        this.registerFormItem(iFormItem);
        // wxorgsectorid
        iFormItem = this.createFormItem("wxorgsectorid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxorgsectorid");
            formItem.setDEFName("WXORGSECTORID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信部门标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxorgsectorid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
