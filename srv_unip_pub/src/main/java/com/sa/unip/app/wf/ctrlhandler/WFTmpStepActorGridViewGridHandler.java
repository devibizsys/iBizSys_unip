...
import com.sa.unip.app.srv.wf.ctrlmodel.WFTmpStepActorMainGridModel;
...
/**
 * 应用视图[WFTmpStepActorGridView]表格[grid]后台处理对象基类
 */
public class WFTmpStepActorGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFTmpStepActorMainGridModel gridModel = null;
    public WFTmpStepActorGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFTmpStepActorMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFTmpStepActorMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFTmpStepActor entity)throws Exception {
