...
/**
 * 实体[系统管理模块]搜索表单[searchform]部件模型
 */
public class  SysAdminDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public SysAdminDefaultSearchFormModel() {
        super();
