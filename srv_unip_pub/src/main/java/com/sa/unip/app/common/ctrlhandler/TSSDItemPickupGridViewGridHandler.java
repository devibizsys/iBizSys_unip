...
/**
 * 应用视图[TSSDItemPickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDItemPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDItemMainGridModel gridModel = null;
    public TSSDItemPickupGridViewGridHandler()  {
        super();
    }
