...
/**
 * 视图[TSSDTaskPolicyMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskPolicyMPickupView.do")
public class TSSDTaskPolicyMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public TSSDTaskPolicyMPickupViewController() throws Exception {
        super();
        this.setId("754af186603d0ee53333c1e6d73854a2");
        this.setCaption("调度任务项策略");
        this.setTitle("调度任务项策略实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskPolicyMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskPolicyMPickupViewController",this);
    }
