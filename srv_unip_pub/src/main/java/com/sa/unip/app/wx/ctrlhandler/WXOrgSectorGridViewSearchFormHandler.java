...
public class WXOrgSectorGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WXOrgSectorDefaultSearchFormModel searchformModel = null;
    public WXOrgSectorGridViewSearchFormHandler()  {
        super();
    }
