...
/**
 * 应用视图[OA_CHRYYCHGridView2]表格[grid]后台处理对象基类
 */
public class OA_CHRYYCHGridView2GridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CHRYMainGridModel gridModel = null;
    public OA_CHRYYCHGridView2GridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchYCH2(deDataSetFetchContext);
    }
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_CHRY entity)throws Exception {
