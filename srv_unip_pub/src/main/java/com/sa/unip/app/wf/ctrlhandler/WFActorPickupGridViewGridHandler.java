...
/**
 * 应用视图[WFActorPickupGridView]表格[grid]后台处理对象基类
 */
public class WFActorPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFActorMainGridModel gridModel = null;
    public WFActorPickupGridViewGridHandler()  {
        super();
    }
