...
/**
 * 应用视图[WFUIWizardPickupGridView]表格[grid]后台处理对象基类
 */
public class WFUIWizardPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUIWizardMainGridModel gridModel = null;
    public WFUIWizardPickupGridViewGridHandler()  {
        super();
    }
