...
/**
 * 应用视图[OA_SBWXSBWXLC_D_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_SBWXSBWXLC_D_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_SBWXMainGridModel gridModel = null;
    public OA_SBWXSBWXLC_D_WFGridViewGridHandler()  {
        super();
    }
