...
public class WFInstanceMainEditFormWfworkflownameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFInstanceMainEditFormWfworkflownameHandler()  {
        super();
    }
