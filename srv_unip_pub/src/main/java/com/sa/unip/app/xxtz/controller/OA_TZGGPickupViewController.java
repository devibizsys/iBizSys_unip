...
/**
 * 视图[OA_TZGGPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGPickupView.do")
public class OA_TZGGPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_TZGGPickupViewController() throws Exception {
        super();
        this.setId("b2cdec7a6b2f5e2e2c69cb320294e85a");
        this.setCaption("通知公告");
        this.setTitle("通知公告数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_TZGG");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGG.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGPickupViewController",this);
    }
