...
public class TSSDPolicyOwnerEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected TSSDPolicyOwnerMainEditFormModel editformModel = null;
    public TSSDPolicyOwnerEditView2EditFormHandler()  {
        super();
    }
