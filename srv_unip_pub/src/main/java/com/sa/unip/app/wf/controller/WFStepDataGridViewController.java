...
/**
 * 视图[WFStepDataGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepDataGridView.do")
public class WFStepDataGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFStepDataGridViewController() throws Exception {
        super();
        this.setId("516f34a686a529e7166d2cb100ae6242");
        this.setCaption("工作流步骤数据");
        this.setTitle("工作流步骤数据实体表格视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPDATA");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEPDATA.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepDataGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepDataGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepDataGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepDataGridViewSearchFormHandler");
        searchForm.init(this);
