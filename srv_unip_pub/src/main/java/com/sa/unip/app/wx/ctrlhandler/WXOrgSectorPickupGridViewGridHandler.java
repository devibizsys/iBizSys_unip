...
/**
 * 应用视图[WXOrgSectorPickupGridView]表格[grid]后台处理对象基类
 */
public class WXOrgSectorPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXOrgSectorMainGridModel gridModel = null;
    public WXOrgSectorPickupGridViewGridHandler()  {
        super();
    }
