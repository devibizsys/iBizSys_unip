...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUserAssistMainGridModel;
...
/**
 * 应用视图[WFUserAssistGridView]表格[grid]后台处理对象基类
 */
public class WFUserAssistGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserAssistMainGridModel gridModel = null;
    public WFUserAssistGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFUserAssistMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFUserAssistMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFUserAssist entity)throws Exception {
