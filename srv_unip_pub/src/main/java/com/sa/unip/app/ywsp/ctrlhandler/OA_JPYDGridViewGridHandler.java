...
/**
 * 应用视图[OA_JPYDGridView]表格[grid]后台处理对象基类
 */
public class OA_JPYDGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_JPYDMainGridModel gridModel = null;
    public OA_JPYDGridViewGridHandler()  {
        super();
    }
