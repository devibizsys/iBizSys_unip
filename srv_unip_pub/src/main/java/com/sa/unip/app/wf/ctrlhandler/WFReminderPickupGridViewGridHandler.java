...
/**
 * 应用视图[WFReminderPickupGridView]表格[grid]后台处理对象基类
 */
public class WFReminderPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFReminderMainGridModel gridModel = null;
    public WFReminderPickupGridViewGridHandler()  {
        super();
    }
