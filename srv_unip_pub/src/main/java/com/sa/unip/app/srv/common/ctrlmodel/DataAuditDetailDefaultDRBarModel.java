...
/**
 * 实体[数据审计明细]数据关系栏[drbar]部件模型
 */
public class  DataAuditDetailDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DataAuditDetailDefaultDRBarModel() {
        super();
    }
