...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_XMJDMainGridModel;
...
/**
 * 应用视图[OA_XMJDGridView]表格[grid]后台处理对象基类
 */
public class OA_XMJDGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_XMJDMainGridModel gridModel = null;
    public OA_XMJDGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_XMJDMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_XMJDMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_XMJD entity)throws Exception {
