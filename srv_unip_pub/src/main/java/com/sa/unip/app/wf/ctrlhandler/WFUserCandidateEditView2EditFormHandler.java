...
public class WFUserCandidateEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected WFUserCandidateMainEditFormModel editformModel = null;
    public WFUserCandidateEditView2EditFormHandler()  {
        super();
    }
