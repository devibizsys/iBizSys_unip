 ...
 * 树导航视图控件后台处理基类
 */
public class OrgUserMPickupView2TreeExpBarHandler extends net.ibizsys.paas.ctrlhandler.TreeExpBarHandlerBase {


    protected OrgUsertreeexpbarTreeExpBarModel treeExpBarModel = null;
    public OrgUserMPickupView2TreeExpBarHandler()  {
        super();
    }
