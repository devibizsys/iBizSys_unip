...
/**
 * 实体[工作流用户]编辑表单[form]部件模型
 */
public class WFUserMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUserMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERID");
            formItem.setCaption("工作流用户标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERNAME");
            formItem.setCaption("工作流用户名称");
        ...
        this.registerFormItem(iFormItem);
        // wfusername
        iFormItem = this.createFormItem("wfusername");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfusername");
            formItem.setDEFName("WFUSERNAME");
            formItem.setCaption("工作流用户名称");
        ...
        this.registerFormItem(iFormItem);
        // isrecvwork
        iFormItem = this.createFormItem("isrecvwork");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("isrecvwork");
            formItem.setDEFName("ISRECVWORK");
            formItem.setEnableCond(0);
            formItem.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
            formItem.setCaption("是否接收工作");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("isrecvwork");
        ...
        this.registerFormItem(iFormItem);
        // recvinform
        iFormItem = this.createFormItem("recvinform");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("recvinform");
            formItem.setDEFName("RECVINFORM");
            formItem.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
            formItem.setCaption("接收工作通知");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("recvinform");
            dataItem.setDataType(9);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfuserid
        iFormItem = this.createFormItem("wfuserid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfuserid");
            formItem.setDEFName("WFUSERID");
            formItem.setCaption("工作流用户标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfuserid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
