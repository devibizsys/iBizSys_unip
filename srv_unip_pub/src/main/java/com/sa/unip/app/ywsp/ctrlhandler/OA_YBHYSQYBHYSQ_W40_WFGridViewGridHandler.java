...
/**
 * 应用视图[OA_YBHYSQYBHYSQ_W40_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_YBHYSQYBHYSQ_W40_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_YBHYSQMainGridModel gridModel = null;
    public OA_YBHYSQYBHYSQ_W40_WFGridViewGridHandler()  {
        super();
    }
