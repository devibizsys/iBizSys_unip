...
/**
 * 视图[UserRoleDataMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDataMPickupView.do")
public class UserRoleDataMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserRoleDataMPickupViewController() throws Exception {
        super();
        this.setId("ed5552c1798be17faaa652b91f01de3d");
        this.setCaption("数据对象能力");
        this.setTitle("数据对象能力实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDataMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDataMPickupViewController",this);
    }
