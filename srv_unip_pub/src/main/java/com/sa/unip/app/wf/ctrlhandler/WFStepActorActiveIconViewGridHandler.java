...
/**
 * 应用视图[WFStepActorActiveIconView]表格[grid]后台处理对象基类
 */
public class WFStepActorActiveIconViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFStepActorGridHandlerBase {

    protected WFStepActorMain2GridModel gridModel = null;
    public WFStepActorActiveIconViewGridHandler()  {
        super();
    }
