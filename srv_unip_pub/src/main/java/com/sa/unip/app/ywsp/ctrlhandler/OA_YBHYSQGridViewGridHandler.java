...
/**
 * 应用视图[OA_YBHYSQGridView]表格[grid]后台处理对象基类
 */
public class OA_YBHYSQGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_YBHYSQMainGridModel gridModel = null;
    public OA_YBHYSQGridViewGridHandler()  {
        super();
    }
