...
/**
 * 视图[MsgAccountDetailGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgAccountDetailGridView.do")
public class MsgAccountDetailGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public MsgAccountDetailGridViewController() throws Exception {
        super();
        this.setId("d173d2e6ea1b07aeb845f00dd36b4b84");
        this.setCaption("组消息账户明细");
        this.setTitle("组消息账户明细实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/MsgAccountDetailGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgAccountDetailGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgAccountDetailGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgAccountDetailGridViewSearchFormHandler");
        searchForm.init(this);
