...
/**
 * 视图[DataSyncInMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncInMPickupView.do")
public class DataSyncInMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public DataSyncInMPickupViewController() throws Exception {
        super();
        this.setId("b0119994d4e45c11791478f142e2cec4");
        this.setCaption("数据同步接收队列");
        this.setTitle("数据同步接收队列实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataSyncInMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncInMPickupViewController",this);
    }
