...
/**
 * 实体[办公用品申请]数据表格[grid]部件模型
 */
public class  OA_BGYPSQMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public OA_BGYPSQMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 日期
        iGridColumn = createGridColumn("rq");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("rq");
            gridColumnModel.setDataItemName("rq");
            gridColumnModel.setCaption("日期");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 rq
        iGridDataItem = createGridDataItem("rq");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("rq");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 bgypsqzt
        iGridDataItem = createGridDataItem("bgypsqzt");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("bgypsqzt");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 bgypsqbz
        iGridDataItem = createGridDataItem("bgypsqbz");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("bgypsqbz");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 oa_bgypsqid
        iGridDataItem = createGridDataItem("oa_bgypsqid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("oa_bgypsqid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("OA_BGYPSQID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("OA_BGYPSQID");
            gridEditItem.setCaption("办公用品申请标识");
