...
/**
 * 实体[组织部门人员]数据表格[grid]部件模型
 */
public class  OrgSecUserMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public OrgSecUserMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 组织部门人员名称
        iGridColumn = createGridColumn("orgsecusername");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("orgsecusername");
            gridColumnModel.setDataItemName("orgsecusername");
            gridColumnModel.setCaption("组织部门人员名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 orgsecuserid
        iGridDataItem = createGridDataItem("orgsecuserid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("orgsecuserid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 orgsecusername
        iGridDataItem = createGridDataItem("orgsecusername");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("orgsecusername");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("ORGSECUSERID");
            gridEditItem.setCaption("组织部门人员标识");
