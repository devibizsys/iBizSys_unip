...
/**
 * 实体[用户词典]数据表格[grid]部件模型
 */
public class  UserDictMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserDictMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("用户词典名称");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERDICTID");
            gridEditItem.setCaption("用户词典标识");
