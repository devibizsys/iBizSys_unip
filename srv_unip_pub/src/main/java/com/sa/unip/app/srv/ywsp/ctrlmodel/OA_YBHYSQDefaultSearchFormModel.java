...
/**
 * 实体[会议申请]搜索表单[searchform]部件模型
 */
public class  OA_YBHYSQDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OA_YBHYSQDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        iFormItem = this.createFormItem("n_oa_ybhysqname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_oa_ybhysqname_like");
            formItem.setDEFName("OA_YBHYSQNAME");
            formItem.setCaption("会议标题");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_oa_ybhysqname_like");
