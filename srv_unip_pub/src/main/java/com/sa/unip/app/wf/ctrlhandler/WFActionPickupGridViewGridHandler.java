...
/**
 * 应用视图[WFActionPickupGridView]表格[grid]后台处理对象基类
 */
public class WFActionPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFActionMainGridModel gridModel = null;
    public WFActionPickupGridViewGridHandler()  {
        super();
    }
