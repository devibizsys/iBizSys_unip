...
import com.sa.unip.app.srv.demodel.ctrlmodel.DataEntityMainGridModel;
...
/**
 * 应用视图[DataEntityGridView]表格[grid]后台处理对象基类
 */
public class DataEntityGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataEntityMainGridModel gridModel = null;
    public DataEntityGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DataEntityMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DataEntityMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DataEntity entity)throws Exception {
