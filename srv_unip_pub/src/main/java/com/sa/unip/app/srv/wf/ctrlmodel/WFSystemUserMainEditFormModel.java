...
/**
 * 实体[工作流系统用户]编辑表单[form]部件模型
 */
public class WFSystemUserMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFSystemUserMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFSYSTEMUSERID");
            formItem.setCaption("工作流系统用户标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFSYSTEMUSERID");
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFSYSTEMUSERNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfsystemuserid
        iFormItem = this.createFormItem("wfsystemuserid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfsystemuserid");
            formItem.setDEFName("WFSYSTEMUSERID");
            formItem.setCaption("工作流系统用户标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfsystemuserid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
