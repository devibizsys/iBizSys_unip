...
/**
 * 实体[工作流用户]搜索表单[searchform]部件模型
 */
public class  WFUserDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WFUserDefaultSearchFormModel() {
        super();
