...
/**
 * 视图[PortalPageRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PortalPageRedirectView.do")
public class PortalPageRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public PortalPageRedirectViewController() throws Exception {
        super();
        this.setId("6dfd18f95d343b01cadbd55fa5dfd676");
        this.setCaption("门户页面");
        this.setTitle("门户页面实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/PortalPageRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PortalPageRedirectViewController",this);
    }
