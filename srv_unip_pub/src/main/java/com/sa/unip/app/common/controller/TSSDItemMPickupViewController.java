...
/**
 * 视图[TSSDItemMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDItemMPickupView.do")
public class TSSDItemMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public TSSDItemMPickupViewController() throws Exception {
        super();
        this.setId("fb603c1d0194b72f543831ba91ebe8c6");
        this.setCaption("任务时刻策略项");
        this.setTitle("任务时刻策略项实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDItemMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDItemMPickupViewController",this);
    }
