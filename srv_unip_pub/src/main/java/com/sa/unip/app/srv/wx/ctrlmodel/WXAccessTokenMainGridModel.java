...
/**
 * 实体[微信访问票据]数据表格[grid]部件模型
 */
public class  WXAccessTokenMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WXAccessTokenMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.wx.demodel.WXAccessTokenDEModel wXAccessTokenDEModel;
    protected  net.ibizsys.psrt.srv.wx.demodel.WXAccessTokenDEModel getWXAccessTokenDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 微信访问票据名称
        iGridColumn = createGridColumn("wxaccesstokenname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("wxaccesstokenname");
            gridColumnModel.setDataItemName("wxaccesstokenname");
            gridColumnModel.setCaption("微信访问票据名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wxaccesstokenname
        iGridDataItem = createGridDataItem("wxaccesstokenname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxaccesstokenname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXACCESSTOKENNAME");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wxaccesstokenid
        iGridDataItem = createGridDataItem("wxaccesstokenid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxaccesstokenid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXACCESSTOKENID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WXACCESSTOKENID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("微信访问票据标识");
