...
/**
 * 视图[UserPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserPickupView.do")
public class UserPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserPickupViewController() throws Exception {
        super();
        this.setId("551e9755455ac729c0f5552c44cee4a5");
        this.setCaption("用户");
        this.setTitle("用户实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserPickupViewController",this);
    }
