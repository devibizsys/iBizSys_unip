...
/**
 * 应用视图[DEDataChg2PickupGridView]表格[grid]后台处理对象基类
 */
public class DEDataChg2PickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DEDataChg2MainGridModel gridModel = null;
    public DEDataChg2PickupGridViewGridHandler()  {
        super();
    }
