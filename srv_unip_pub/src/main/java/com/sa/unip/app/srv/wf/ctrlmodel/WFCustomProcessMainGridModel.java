...
/**
 * 实体[工作流预定义处理]数据表格[grid]部件模型
 */
public class  WFCustomProcessMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFCustomProcessMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wfcustomprocessid
        iGridDataItem = createGridDataItem("wfcustomprocessid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfcustomprocessid");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFCUSTOMPROCESSID");
            gridEditItem.setCaption("工作流预定义处理标识");
