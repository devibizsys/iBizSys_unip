...
/**
 * 视图[DEDataChgDispMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChgDispMPickupView.do")
public class DEDataChgDispMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public DEDataChgDispMPickupViewController() throws Exception {
        super();
        this.setId("197dea6f95932a9f4c338b69ded8fc6d");
        this.setCaption("实体数据变更派发引擎");
        this.setTitle("实体数据变更派发引擎实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DEDataChgDispMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChgDispMPickupViewController",this);
    }
