...
/**
 * 视图[OA_FLFGMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_FLFGMPickupView.do")
public class OA_FLFGMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_FLFGMPickupViewController() throws Exception {
        super();
        this.setId("c574757ad2d9a66b058ef433f007011b");
        this.setCaption("法律法规");
        this.setTitle("法律法规数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_FLFG");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/jcsj/OA_FLFGMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_FLFGMPickupViewController",this);
    }
