...
/**
 * 实体[用户角色成员]搜索表单[searchform]部件模型
 */
public class  UserRoleDetailDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserRoleDetailDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_userroledetailname_like
        iFormItem = this.createFormItem("n_userroledetailname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_userroledetailname_like");
            formItem.setDEFName("USERROLEDETAILNAME");
            formItem.setCaption("用户角色成员名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_userroledetailname_like");
