...
/**
 * 应用视图[WFUserGroupPickupGridView]表格[grid]后台处理对象基类
 */
public class WFUserGroupPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserGroupMainGridModel gridModel = null;
    public WFUserGroupPickupGridViewGridHandler()  {
        super();
    }
