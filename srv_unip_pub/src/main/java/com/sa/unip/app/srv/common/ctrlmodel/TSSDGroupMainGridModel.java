...
/**
 * 实体[任务时刻策略组]数据表格[grid]部件模型
 */
public class  TSSDGroupMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public TSSDGroupMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 任务时刻策略组名称
        iGridColumn = createGridColumn("tssdgroupname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("tssdgroupname");
            gridColumnModel.setDataItemName("tssdgroupname");
            gridColumnModel.setCaption("任务时刻策略组名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 tssdgroupname
        iGridDataItem = createGridDataItem("tssdgroupname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdgroupname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDGROUPNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("TSSDGROUPID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("任务时刻策略组标识");
