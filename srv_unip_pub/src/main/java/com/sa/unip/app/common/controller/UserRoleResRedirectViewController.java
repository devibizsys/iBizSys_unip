...
/**
 * 视图[UserRoleResRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleResRedirectView.do")
public class UserRoleResRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserRoleResRedirectViewController() throws Exception {
        super();
        this.setId("88d432537900da7f68fc88ef7bd03039");
        this.setCaption("用户角色资源能力");
        this.setTitle("用户角色资源能力实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserRoleResRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleResRedirectViewController",this);
    }
