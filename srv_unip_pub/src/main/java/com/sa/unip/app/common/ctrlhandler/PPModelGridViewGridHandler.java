...
import com.sa.unip.app.srv.common.ctrlmodel.PPModelMainGridModel;
...
/**
 * 应用视图[PPModelGridView]表格[grid]后台处理对象基类
 */
public class PPModelGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected PPModelMainGridModel gridModel = null;
    public PPModelGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (PPModelMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected PPModelMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(PPModel entity)throws Exception {
