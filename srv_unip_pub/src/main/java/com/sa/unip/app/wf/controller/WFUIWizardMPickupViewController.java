...
/**
 * 视图[WFUIWizardMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUIWizardMPickupView.do")
public class WFUIWizardMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFUIWizardMPickupViewController() throws Exception {
        super();
        this.setId("57e8655dad430ecf616a1f13b3f13d7b");
        this.setCaption("工作流操作界面");
        this.setTitle("工作流操作界面实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUIWizardMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUIWizardMPickupViewController",this);
    }
