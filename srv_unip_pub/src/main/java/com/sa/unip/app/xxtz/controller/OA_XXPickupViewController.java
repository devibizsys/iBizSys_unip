...
/**
 * 视图[OA_XXPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_XXPickupView.do")
public class OA_XXPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_XXPickupViewController() throws Exception {
        super();
        this.setId("a297bb977e421efba16192dcdd096081");
        this.setCaption("消息");
        this.setTitle("消息数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_XX");
        this.setTitleLanResTag("PAGE.TITLE.OA_XX.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/xxtz/OA_XXPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_XXPickupViewController",this);
    }
