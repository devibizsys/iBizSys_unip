...
/**
 * 应用视图[TSSDTaskPolicyGridView]表格[grid]后台处理对象基类
 */
public class TSSDTaskPolicyGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDTaskPolicyMainGridModel gridModel = null;
    public TSSDTaskPolicyGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDTaskPolicy entity)throws Exception {
