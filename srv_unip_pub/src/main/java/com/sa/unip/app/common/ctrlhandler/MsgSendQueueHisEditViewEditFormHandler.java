...
public class MsgSendQueueHisEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected MsgSendQueueHisMain2EditFormModel editformModel = null;
    public MsgSendQueueHisEditViewEditFormHandler()  {
        super();
    }
