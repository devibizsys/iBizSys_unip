...
/**
 * 应用视图[WFStepDataTraceChartView]表格[grid]后台处理对象基类
 */
public class WFStepDataTraceChartViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFStepDataGridHandlerBase {

    protected WFStepDataMain2GridModel gridModel = null;
    public WFStepDataTraceChartViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFStepDataMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
