...
/**
 * 视图[WFAppSettingPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFAppSettingPickupView.do")
public class WFAppSettingPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFAppSettingPickupViewController() throws Exception {
        super();
        this.setId("5dc22293b0e569542b2569e1bef924d6");
        this.setCaption("工作流系统设定");
        this.setTitle("工作流应用设定实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFAppSettingPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFAppSettingPickupViewController",this);
    }
