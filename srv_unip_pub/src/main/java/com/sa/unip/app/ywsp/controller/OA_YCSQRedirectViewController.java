...
/**
 * 视图[OA_YCSQRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQRedirectView.do")
public class OA_YCSQRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_YCSQRedirectViewController() throws Exception {
        super();
        this.setId("0e7fc1aee53589ab05132716841195a6");
        this.setCaption("用餐申请");
        this.setTitle("用餐申请数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_YCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YCSQ.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQRedirectViewController",this);
    }
