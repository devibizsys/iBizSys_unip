...
/**
 * 视图[WFStepPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepPickupView.do")
public class WFStepPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFStepPickupViewController() throws Exception {
        super();
        this.setId("7f6a99d19af65c4d64ffb7ede3bb77f3");
        this.setCaption("工作流步骤");
        this.setTitle("工作流步骤实体数据选择视图");
        this.setCapLanResTag("DE.LNAME.WFSTEP");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEP.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFStepPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepPickupViewController",this);
    }
