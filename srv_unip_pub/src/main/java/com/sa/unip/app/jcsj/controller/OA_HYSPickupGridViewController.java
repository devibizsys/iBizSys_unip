...
/**
 * 视图[OA_HYSPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_HYSPickupGridView.do")
public class OA_HYSPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_HYSPickupGridViewController() throws Exception {
        super();
        this.setId("b967f0a9206c6f2ed22acf51be26682f");
        this.setCaption("会议室");
        this.setTitle("会议室选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_HYS");
        this.setTitleLanResTag("PAGE.TITLE.OA_HYS.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/jcsj/OA_HYSPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_HYSPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_HYSPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_HYSPickupGridViewSearchFormHandler");
        searchForm.init(this);
