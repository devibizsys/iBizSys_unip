...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDEngineMainGridModel;
...
/**
 * 应用视图[TSSDEnginePickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDEnginePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDEngineMainGridModel gridModel = null;
    public TSSDEnginePickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDEngineMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDEngineMainGridModel getRealGridModel() {
