...
/**
 * 应用视图[UniResPickupGridView]表格[grid]后台处理对象基类
 */
public class UniResPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UniResMainGridModel gridModel = null;
    public UniResPickupGridViewGridHandler()  {
        super();
    }
