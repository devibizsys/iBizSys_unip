...
/**
 * 视图[UserRoleDEFieldEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDEFieldEditView2.do")
public class UserRoleDEFieldEditView2Controller extends net.ibizsys.paas.controller.EditView2ControllerBase {
    public UserRoleDEFieldEditView2Controller() throws Exception {
        super();
        this.setId("72ee31871d4acfcdedec844ecfdeb34a");
        this.setCaption("用户角色实体属性访问");
        this.setTitle("用户角色实体属性访问实体编辑视图（左右关系）");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleDEFieldEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDEFieldEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.UserRoleDEFieldDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDEFieldEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDEFieldEditView2DRBarHandler");
        drBar.init(this);
