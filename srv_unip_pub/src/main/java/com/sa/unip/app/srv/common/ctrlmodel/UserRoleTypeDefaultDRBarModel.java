...
/**
 * 实体[用户角色类型]数据关系栏[drbar]部件模型
 */
public class  UserRoleTypeDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserRoleTypeDefaultDRBarModel() {
        super();
    }
