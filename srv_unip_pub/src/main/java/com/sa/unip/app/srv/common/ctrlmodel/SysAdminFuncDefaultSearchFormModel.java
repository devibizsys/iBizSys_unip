...
/**
 * 实体[系统管理功能]搜索表单[searchform]部件模型
 */
public class  SysAdminFuncDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public SysAdminFuncDefaultSearchFormModel() {
        super();
