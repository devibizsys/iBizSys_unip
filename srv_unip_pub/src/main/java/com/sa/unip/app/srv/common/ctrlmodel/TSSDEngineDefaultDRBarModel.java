...
/**
 * 实体[任务调度引擎]数据关系栏[drbar]部件模型
 */
public class  TSSDEngineDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDEngineDefaultDRBarModel() {
        super();
    }
