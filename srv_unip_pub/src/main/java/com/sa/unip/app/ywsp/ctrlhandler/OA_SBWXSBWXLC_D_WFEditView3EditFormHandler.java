...
public class OA_SBWXSBWXLC_D_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_SBWXMainEditFormModel editformModel = null;
    public OA_SBWXSBWXLC_D_WFEditView3EditFormHandler()  {
        super();
    }
