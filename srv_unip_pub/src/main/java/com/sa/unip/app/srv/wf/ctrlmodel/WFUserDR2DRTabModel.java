...
/**
 * 实体[工作流用户]数据分页[drtab]部件模型
 */
public class  WFUserDR2DRTabModel extends net.ibizsys.paas.ctrlmodel.DRTabModelBase {

    public WFUserDR2DRTabModel()  {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem1.setText("工作流用户组成员");
        drCtrlItem1.setDRViewId("DRITEM1");
        drCtrlItem1.setIconPath("");
        drCtrlItem1.setIconCls("");
        drCtrlItem1.setEnableMode("ALL");
        drCtrlItem1.setViewParam("srfparentdeid","ef2c7b349c855e594aa4fe0cb7ad8b48");
        drCtrlItem1.setViewParam("srfparenttype","DER1N");
        drCtrlItem1.setViewParam("srfder1nid","DER1N_WFUSERGROUPDETAIL_WFUSER_WFUSERID");
    }
}