...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDGroupDetailMainGridModel;
...
/**
 * 应用视图[TSSDGroupDetailGridView]表格[grid]后台处理对象基类
 */
public class TSSDGroupDetailGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDGroupDetailMainGridModel gridModel = null;
    public TSSDGroupDetailGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDGroupDetailMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDGroupDetailMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDGroupDetail entity)throws Exception {
