...
/**
 * 视图[WFUIWizardPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUIWizardPickupView.do")
public class WFUIWizardPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFUIWizardPickupViewController() throws Exception {
        super();
        this.setId("09899d0c996cf9dc0f9554b3409e866e");
        this.setCaption("工作流操作界面");
        this.setTitle("工作流操作界面实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUIWizardPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUIWizardPickupViewController",this);
    }
