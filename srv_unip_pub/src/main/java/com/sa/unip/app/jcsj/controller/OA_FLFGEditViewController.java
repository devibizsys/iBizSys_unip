...
/**
 * 视图[OA_FLFGEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_FLFGEditView.do")
public class OA_FLFGEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public OA_FLFGEditViewController() throws Exception {
        super();
        this.setId("431df18964f6b49563a16fdab56a559a");
        ...
        ViewControllerGlobal.registerViewController("/app/jcsj/OA_FLFGEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_FLFGEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_FLFGEditViewEditFormHandler");
        editForm.init(this);
