...
/**
 * 实体[注册表]数据关系栏[drbar]部件模型
 */
public class  RegistryDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public RegistryDefaultDRBarModel() {
        super();
    }
