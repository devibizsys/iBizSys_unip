...
/**
 * 视图[CodeListRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/CodeListRedirectView.do")
public class CodeListRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public CodeListRedirectViewController() throws Exception {
        super();
        this.setId("e83918359fdb3d40ce2e8458ea2af855");
        this.setCaption("代码表");
        this.setTitle("代码表实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/CodeListRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.CodeListRedirectViewController",this);
    }
