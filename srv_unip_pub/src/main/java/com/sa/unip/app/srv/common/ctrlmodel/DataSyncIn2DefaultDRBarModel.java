...
/**
 * 实体[数据同步接收队列2]数据关系栏[drbar]部件模型
 */
public class  DataSyncIn2DefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DataSyncIn2DefaultDRBarModel() {
        super();
    }
