...
/**
 * 视图[OA_SBWXSBWXLC_W10_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXSBWXLC_W10_WFEditView3.do")
public class OA_SBWXSBWXLC_W10_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_SBWXSBWXLC_W10_WFEditView3Controller() throws Exception {
        super();
        this.setId("1a81a78f81407b012e2b3ea4968d5eef");
        this.setCaption("设备维修");
        this.setTitle("设备维修工作流视图(设备维修流程v1:部门领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXSBWXLC_W10_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXSBWXLC_W10_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_W10_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_W10_WFEditView3EditFormHandler");
        editForm.init(this);
