...
public class OrgSecUserTypeEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OrgSecUserTypeMain2EditFormModel editformModel = null;
    public OrgSecUserTypeEditView2EditFormHandler()  {
        super();
    }
