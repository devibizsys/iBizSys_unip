...
/**
 * 实体[食堂外卖订购]流程导航栏[expbar]部件模型
 */
public class  OA_STWMDGexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_STWMDGexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("49A0F3C3-CC7E-4297-95D2-5A2A8D30C09A"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("STWMDGLC:D:20");
        ...
        expBarItem3.setExpViewId("STWMDGLC:D:20:10");
        ...
        expBarItem4.setExpViewId("STWMDGLC:D:20:20");
        ...
        expBarItem5.setExpViewId("STWMDGLC:D:30");
        ...
        expBarItem6.setExpViewId("STWMDGLC:D:40");
        ...
        expBarItem7.setExpViewId("STWMDGLC:W");
        ...
        expBarItem8.setExpViewId("STWMDGLC:W:10");
        ...
        expBarItem9.setExpViewId("STWMDGLC:W:20");
