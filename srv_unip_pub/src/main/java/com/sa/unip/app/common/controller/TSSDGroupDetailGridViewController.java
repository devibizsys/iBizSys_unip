...
/**
 * 视图[TSSDGroupDetailGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDGroupDetailGridView.do")
public class TSSDGroupDetailGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public TSSDGroupDetailGridViewController() throws Exception {
        super();
        this.setId("3af38759c0d4e8dc5881bd4a5efb9985");
        this.setCaption("任务时刻策略组明细");
        this.setTitle("任务时刻策略组明细实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/TSSDGroupDetailGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDGroupDetailGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDGroupDetailGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDGroupDetailGridViewSearchFormHandler");
        searchForm.init(this);
