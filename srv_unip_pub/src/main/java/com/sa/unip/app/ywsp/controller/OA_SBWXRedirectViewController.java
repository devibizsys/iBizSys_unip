...
/**
 * 视图[OA_SBWXRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXRedirectView.do")
public class OA_SBWXRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_SBWXRedirectViewController() throws Exception {
        super();
        this.setId("90c5105b8b44d5b31682783554f25876");
        this.setCaption("设备维修");
        this.setTitle("设备维修数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_SBWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_SBWX.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXRedirectViewController",this);
    }
