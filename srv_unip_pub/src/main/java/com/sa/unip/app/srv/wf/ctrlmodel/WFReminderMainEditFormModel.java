...
/**
 * 实体[工作流工作催办]编辑表单[form]部件模型
 */
public class WFReminderMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFReminderMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFREMINDERID");
            formItem.setCaption("工作流工作催办标识");
        ...
        this.registerFormItem(iFormItem);
        // wfreminderid
        iFormItem = this.createFormItem("wfreminderid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfreminderid");
            formItem.setDEFName("WFREMINDERID");
            formItem.setCaption("工作流工作催办标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfreminderid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
