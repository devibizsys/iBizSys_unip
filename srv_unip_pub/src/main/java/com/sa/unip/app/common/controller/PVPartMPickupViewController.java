...
/**
 * 视图[PVPartMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PVPartMPickupView.do")
public class PVPartMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public PVPartMPickupViewController() throws Exception {
        super();
        this.setId("163a3f7ecea83817090ffdb4abb3f650");
        this.setCaption("门户视图部件");
        this.setTitle("门户视图部件实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/PVPartMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PVPartMPickupViewController",this);
    }
