...
public class WFSystemUserPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFSystemUserDefaultSearchFormModel searchformModel = null;
    public WFSystemUserPickupGridViewSearchFormHandler()  {
        super();
    }
