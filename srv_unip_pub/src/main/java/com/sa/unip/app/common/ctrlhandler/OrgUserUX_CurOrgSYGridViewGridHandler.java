...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserUX_Main2GridModel;
...
/**
 * 应用视图[OrgUserUX_CurOrgSYGridView]表格[grid]后台处理对象基类
 */
public class OrgUserUX_CurOrgSYGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserUX_Main2GridModel gridModel = null;
    public OrgUserUX_CurOrgSYGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgUserUX_Main2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgUserUX_Main2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurOrg(deDataSetFetchContext);
    }
