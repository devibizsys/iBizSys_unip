...
/**
 * 应用视图[WFAssistWorkPickupGridView]表格[grid]后台处理对象基类
 */
public class WFAssistWorkPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFAssistWorkMainGridModel gridModel = null;
    public WFAssistWorkPickupGridViewGridHandler()  {
        super();
    }
