...
public class OA_TZGGTZGGSQLC_D20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_TZGGDefaultSearchFormModel searchformModel = null;
    public OA_TZGGTZGGSQLC_D20_WFGridViewSearchFormHandler()  {
        super();
    }
