...
import com.sa.unip.app.srv.common.ctrlmodel.UserGroupMain2GridModel;
...
/**
 * 应用视图[UserGroupPickupGridView]表格[grid]后台处理对象基类
 */
public class UserGroupPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserGroupMain2GridModel gridModel = null;
    public UserGroupPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserGroupMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserGroupMain2GridModel getRealGridModel() {
