...
/**
 * 应用视图[OA_TZGGPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_TZGGPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_TZGGMainGridModel gridModel = null;
    public OA_TZGGPickupGridViewGridHandler()  {
        super();
    }
