...
/**
 * 视图[ServicePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/ServicePickupView.do")
public class ServicePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public ServicePickupViewController() throws Exception {
        super();
        this.setId("593f25b4f0b775f0249a15445d6df1bf");
        this.setCaption("服务");
        this.setTitle("服务实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/ServicePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.ServicePickupViewController",this);
    }
