...
/**
 * 视图[OrgSecUserTypeEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSecUserTypeEditView2.do")
public class OrgSecUserTypeEditView2Controller extends net.ibizsys.paas.controller.EditView2ControllerBase {
    public OrgSecUserTypeEditView2Controller() throws Exception {
        super();
        this.setId("40a587ced526d840d14c00e9adabebf9");
        this.setCaption("部门人员关系类型");
        this.setTitle("部门人员关系类型实体编辑视图（左右分区）");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgSecUserTypeEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSecUserTypeEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.OrgSecUserTypeDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgSecUserTypeEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgSecUserTypeEditView2DRBarHandler");
        drBar.init(this);
