 ...
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_GZRZRZTJLC_W10_WFEditView3.do")
public class OA_GZRZRZTJLC_W10_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_GZRZRZTJLC_W10_WFEditView3Controller() throws Exception {
        super();
        this.setId("e4fabc4f9658858ce3b9dd40e957fd65");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_GZRZRZTJLC_W10_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_GZRZRZTJLC_W10_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_GZRZRZTJLC_W10_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_GZRZRZTJLC_W10_WFEditView3EditFormHandler");
        editForm.init(this);
