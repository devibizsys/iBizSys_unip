...
/**
 * 实体[微信公众号]搜索表单[searchform]部件模型
 */
public class  WXAccountDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WXAccountDefaultSearchFormModel() {
        super();
