...
/**
 * 应用视图[OrgTypePickupGridView]表格[grid]后台处理对象基类
 */
public class OrgTypePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgTypeMain2GridModel gridModel = null;
    public OrgTypePickupGridViewGridHandler()  {
        super();
    }
