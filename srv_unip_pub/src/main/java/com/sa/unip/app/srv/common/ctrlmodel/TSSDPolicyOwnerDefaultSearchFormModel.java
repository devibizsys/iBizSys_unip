...
/**
 * 实体[任务时刻策略所有者]搜索表单[searchform]部件模型
 */
public class  TSSDPolicyOwnerDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public TSSDPolicyOwnerDefaultSearchFormModel() {
        super();
