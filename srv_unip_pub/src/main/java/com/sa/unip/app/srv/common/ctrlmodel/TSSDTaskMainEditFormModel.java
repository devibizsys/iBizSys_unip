...
/**
 * 实体[任务调度任务项]编辑表单[form]部件模型
 */
public class TSSDTaskMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDTaskMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务调度任务项标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKNAME");
            formItem.setCaption("调度任务项名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdtaskname
        iFormItem = this.createFormItem("tssdtaskname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtaskname");
            formItem.setDEFName("TSSDTASKNAME");
            formItem.setCaption("调度任务项名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdtaskid
        iFormItem = this.createFormItem("tssdtaskid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtaskid");
            formItem.setDEFName("TSSDTASKID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务调度任务项标识");
