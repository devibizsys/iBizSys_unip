...
/**
 * 视图[OrgSecUserTypeRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSecUserTypeRedirectView.do")
public class OrgSecUserTypeRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OrgSecUserTypeRedirectViewController() throws Exception {
        super();
        this.setId("77cb8e6bf9c354a605b1b6a9f3102a22");
        this.setCaption("部门人员关系类型");
        this.setTitle("部门人员关系类型实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/OrgSecUserTypeRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSecUserTypeRedirectViewController",this);
    }
