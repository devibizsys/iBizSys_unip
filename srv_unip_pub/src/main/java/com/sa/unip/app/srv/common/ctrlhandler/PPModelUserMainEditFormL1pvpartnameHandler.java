...
public class PPModelUserMainEditFormL1pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormL1pvpartnameHandler()  {
        super();
    }
