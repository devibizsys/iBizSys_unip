...
public class WFUCPolicyPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFUCPolicyDefaultSearchFormModel searchformModel = null;
    public WFUCPolicyPickupGridViewSearchFormHandler()  {
        super();
    }
