...
/**
 * 视图[OA_YBHYSQRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQRedirectView.do")
public class OA_YBHYSQRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_YBHYSQRedirectViewController() throws Exception {
        super();
        this.setId("ef56dc4af8edfd651fede5a2bccf934a");
        this.setCaption("会议申请");
        this.setTitle("会议申请数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_YBHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YBHYSQ.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQRedirectViewController",this);
    }
