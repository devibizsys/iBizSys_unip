...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_QXJMainEditFormModel;
...
public class OA_QXJQXJLC_W20_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_QXJMainEditFormModel editformModel = null;
    public OA_QXJQXJLC_W20_WFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_QXJMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_QXJMainEditFormModel getRealEditFormModel() {
