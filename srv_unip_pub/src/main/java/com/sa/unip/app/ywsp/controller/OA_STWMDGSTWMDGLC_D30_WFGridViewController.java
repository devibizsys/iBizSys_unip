...
/**
 * 视图[OA_STWMDGSTWMDGLC_D30_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGSTWMDGLC_D30_WFGridView.do")
public class OA_STWMDGSTWMDGLC_D30_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_STWMDGSTWMDGLC_D30_WFGridViewController() throws Exception {
        super();
        this.setId("e3175ae68ca62bd16b7910b874eebb26");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购工作流表格视图(食堂外卖订购流程:已完成)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGSTWMDGLC_D30_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGSTWMDGLC_D30_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_D30_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_D30_WFGridViewSearchFormHandler");
        searchForm.init(this);
