...
/**
 * 视图[TSSDTaskTypeRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskTypeRedirectView.do")
public class TSSDTaskTypeRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public TSSDTaskTypeRedirectViewController() throws Exception {
        super();
        this.setId("be3239391cb8421598f81e1c6e342ab6");
        this.setCaption("任务调度任务类型");
        this.setTitle("任务调度任务类型实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskTypeRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskTypeRedirectViewController",this);
    }
