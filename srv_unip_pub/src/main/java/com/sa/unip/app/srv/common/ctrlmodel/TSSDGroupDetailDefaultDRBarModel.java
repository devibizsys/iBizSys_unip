...
/**
 * 实体[任务时刻策略组明细]数据关系栏[drbar]部件模型
 */
public class  TSSDGroupDetailDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDGroupDetailDefaultDRBarModel() {
        super();
    }
