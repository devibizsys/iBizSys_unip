...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_CCSQMainEditFormModel;
...
public class OA_CCSQCCSQLC_W10_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CCSQMainEditFormModel editformModel = null;
    public OA_CCSQCCSQLC_W10_WFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CCSQMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CCSQMainEditFormModel getRealEditFormModel() {
