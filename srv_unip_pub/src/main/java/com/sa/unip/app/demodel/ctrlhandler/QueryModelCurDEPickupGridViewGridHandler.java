...
import com.sa.unip.app.srv.demodel.ctrlmodel.QueryModelMainGridModel;
...
/**
 * 应用视图[QueryModelCurDEPickupGridView]表格[grid]后台处理对象基类
 */
public class QueryModelCurDEPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected QueryModelMainGridModel gridModel = null;
    public QueryModelCurDEPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (QueryModelMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected QueryModelMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurDE(deDataSetFetchContext);
    }
