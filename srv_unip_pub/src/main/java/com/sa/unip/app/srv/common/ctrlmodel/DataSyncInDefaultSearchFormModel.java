...
/**
 * 实体[数据同步接收队列]搜索表单[searchform]部件模型
 */
public class  DataSyncInDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DataSyncInDefaultSearchFormModel() {
        super();
