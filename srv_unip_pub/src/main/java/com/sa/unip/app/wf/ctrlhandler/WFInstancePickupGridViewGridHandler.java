...
import com.sa.unip.app.srv.wf.ctrlmodel.WFInstanceMainGridModel;
...
/**
 * 应用视图[WFInstancePickupGridView]表格[grid]后台处理对象基类
 */
public class WFInstancePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFInstanceMainGridModel gridModel = null;
    public WFInstancePickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFInstanceMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFInstanceMainGridModel getRealGridModel() {
