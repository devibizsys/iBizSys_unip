...
/**
 * 实体[数据对象能力明细]搜索表单[searchform]部件模型
 */
public class  UserRoleDataDetailDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserRoleDataDetailDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_userroledatadetailname_like
        iFormItem = this.createFormItem("n_userroledatadetailname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_userroledatadetailname_like");
            formItem.setDEFName("USERROLEDATADETAILNAME");
            formItem.setCaption("数据对象能力明细名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_userroledatadetailname_like");
