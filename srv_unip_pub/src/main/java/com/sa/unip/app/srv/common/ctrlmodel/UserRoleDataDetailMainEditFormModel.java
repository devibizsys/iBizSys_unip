...
/**
 * 实体[数据对象能力明细]编辑表单[form]部件模型
 */
public class UserRoleDataDetailMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserRoleDataDetailMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLEDATADETAILID");
            formItem.setCaption("数据对象能力明细标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLEDATADETAILNAME");
            formItem.setCaption("数据对象能力明细名称");
        ...
        this.registerFormItem(iFormItem);
        // querymodelname
        iFormItem = this.createFormItem("querymodelname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("querymodelname");
            formItem.setDEFName("QUERYMODELNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("查询模型");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("querymodelname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // isexclude
        iFormItem = this.createFormItem("isexclude");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("isexclude");
            formItem.setDEFName("ISEXCLUDE");
            formItem.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
            formItem.setCaption("排除数据范围");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("isexclude");
        ...
        this.registerFormItem(iFormItem);
        // userroledatadetailid
        iFormItem = this.createFormItem("userroledatadetailid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroledatadetailid");
            formItem.setDEFName("USERROLEDATADETAILID");
            formItem.setCaption("数据对象能力明细标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroledatadetailid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // querymodelid
        iFormItem = this.createFormItem("querymodelid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("querymodelid");
            formItem.setDEFName("QUERYMODELID");
            formItem.setEnableCond(1);
            formItem.setCaption("查询模型");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("querymodelid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
