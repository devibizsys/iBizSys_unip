...
/**
 * 实体[系统管理功能]编辑表单[form]部件模型
 */
public class SysAdminFuncMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public SysAdminFuncMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SYSADMINFUNCID");
            formItem.setEnableCond(0);
            formItem.setCaption("系统管理功能标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SYSADMINFUNCNAME");
            formItem.setCaption("系统管理功能名称");
        ...
        this.registerFormItem(iFormItem);
        // sysadminfuncname
        iFormItem = this.createFormItem("sysadminfuncname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("sysadminfuncname");
            formItem.setDEFName("SYSADMINFUNCNAME");
            formItem.setCaption("系统管理功能名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("sysadminfuncname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // sysadminfuncid
        iFormItem = this.createFormItem("sysadminfuncid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("sysadminfuncid");
            formItem.setDEFName("SYSADMINFUNCID");
            formItem.setEnableCond(0);
            formItem.setCaption("系统管理功能标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("sysadminfuncid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
