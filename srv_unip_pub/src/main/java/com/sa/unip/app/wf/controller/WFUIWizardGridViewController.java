...
/**
 * 视图[WFUIWizardGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUIWizardGridView.do")
public class WFUIWizardGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFUIWizardGridViewController() throws Exception {
        super();
        this.setId("18ce14ec39380a3f45f2236cab6e3d15");
        this.setCaption("工作流操作界面");
        this.setTitle("工作流操作界面实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUIWizardGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUIWizardGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUIWizardGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUIWizardGridViewSearchFormHandler");
        searchForm.init(this);
