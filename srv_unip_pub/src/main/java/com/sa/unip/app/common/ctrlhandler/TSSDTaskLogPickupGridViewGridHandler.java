...
/**
 * 应用视图[TSSDTaskLogPickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDTaskLogPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDTaskLogMainGridModel gridModel = null;
    public TSSDTaskLogPickupGridViewGridHandler()  {
        super();
    }
