...
/**
 * 视图[DEDataChg2PickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChg2PickupView.do")
public class DEDataChg2PickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DEDataChg2PickupViewController() throws Exception {
        super();
        this.setId("f3c0eee7c4bc290e1015754c0ac4f729");
        this.setCaption("实体数据变更（已处理）");
        this.setTitle("实体数据变更（已处理）实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DEDataChg2PickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChg2PickupViewController",this);
    }
