...
import com.sa.unip.app.srv.common.ctrlmodel.UserDictItemMain2GridModel;
...
/**
 * 应用视图[UserDictItemGridView]表格[grid]后台处理对象基类
 */
public class UserDictItemGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDictItemMain2GridModel gridModel = null;
    public UserDictItemGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserDictItemMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserDictItemMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserDictItem entity)throws Exception {
