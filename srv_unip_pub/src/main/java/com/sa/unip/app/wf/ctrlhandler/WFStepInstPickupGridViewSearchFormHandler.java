...
public class WFStepInstPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFStepInstDefaultSearchFormModel searchformModel = null;
    public WFStepInstPickupGridViewSearchFormHandler()  {
        super();
    }
