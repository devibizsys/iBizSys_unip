...
/**
 * 视图[WFUCPolicyRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUCPolicyRedirectView.do")
public class WFUCPolicyRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFUCPolicyRedirectViewController() throws Exception {
        super();
        this.setId("82b1fe502c2b60bafdc9bd37a5ff0d9d");
        this.setCaption("工作流候选用户策略");
        this.setTitle("工作流候选用户策略实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFUCPolicyRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUCPolicyRedirectViewController",this);
    }
