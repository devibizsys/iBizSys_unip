...
/**
 * 实体[数据审计明细]数据表格[grid]部件模型
 */
public class  DataAuditDetailMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public DataAuditDetailMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 属性
        iGridColumn = createGridColumn("dataauditdetailname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("dataauditdetailname");
            gridColumnModel.setDataItemName("dataauditdetailname");
            gridColumnModel.setCaption("属性");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 dataauditid
        iGridDataItem = createGridDataItem("dataauditid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dataauditid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DATAAUDITID");
        ...
        //建立数据项 dataauditdetailid
        iGridDataItem = createGridDataItem("dataauditdetailid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dataauditdetailid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DATAAUDITDETAILID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        if(iGridDataItem == null) {
            ...
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DATAAUDITDETAILNAME");
            dataItemParam0.setFormat("");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 dataauditdetailname
        iGridDataItem = createGridDataItem("dataauditdetailname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dataauditdetailname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DATAAUDITDETAILNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("DATAAUDITDETAILID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("数据审计明细标识");
