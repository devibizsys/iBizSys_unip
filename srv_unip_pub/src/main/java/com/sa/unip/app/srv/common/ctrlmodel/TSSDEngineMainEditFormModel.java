...
/**
 * 实体[任务调度引擎]编辑表单[form]部件模型
 */
public class TSSDEngineMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDEngineMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDENGINEID");
            formItem.setEnableCond(1);
            formItem.setCaption("任务调度引擎标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDENGINENAME");
            formItem.setCaption("任务调度引擎名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdenginename
        iFormItem = this.createFormItem("tssdenginename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdenginename");
            formItem.setDEFName("TSSDENGINENAME");
            formItem.setCaption("任务调度引擎名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdenginename");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdengineid
        iFormItem = this.createFormItem("tssdengineid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdengineid");
            formItem.setDEFName("TSSDENGINEID");
            formItem.setEnableCond(1);
            formItem.setCaption("任务调度引擎标识");
