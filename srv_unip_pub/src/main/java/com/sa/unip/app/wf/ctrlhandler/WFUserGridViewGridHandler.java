...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUserJQMainGridModel;
...
/**
 * 应用视图[WFUserGridView]表格[grid]后台处理对象基类
 */
public class WFUserGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserJQMainGridModel gridModel = null;
    public WFUserGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFUserJQMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFUserJQMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFUser entity)throws Exception {
