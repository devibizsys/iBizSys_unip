...
public class MsgAccountDetailEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected MsgAccountDetailMainEditFormModel editformModel = null;
    public MsgAccountDetailEditViewEditFormHandler()  {
        super();
    }
