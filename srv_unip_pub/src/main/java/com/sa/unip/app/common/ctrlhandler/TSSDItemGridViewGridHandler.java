...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDItemMainGridModel;
...
/**
 * 应用视图[TSSDItemGridView]表格[grid]后台处理对象基类
 */
public class TSSDItemGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDItemMainGridModel gridModel = null;
    public TSSDItemGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDItemMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDItemMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDItem entity)throws Exception {
