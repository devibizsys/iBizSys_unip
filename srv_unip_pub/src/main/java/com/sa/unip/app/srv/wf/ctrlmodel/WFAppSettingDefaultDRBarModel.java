...
/**
 * 实体[工作流系统设定]数据关系栏[drbar]部件模型
 */
public class  WFAppSettingDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFAppSettingDefaultDRBarModel() {
        super();
    }
