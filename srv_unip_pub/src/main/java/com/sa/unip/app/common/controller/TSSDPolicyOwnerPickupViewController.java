...
/**
 * 视图[TSSDPolicyOwnerPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDPolicyOwnerPickupView.do")
public class TSSDPolicyOwnerPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public TSSDPolicyOwnerPickupViewController() throws Exception {
        super();
        this.setId("5d44ca1a2fe7789dc412e74e57405401");
        this.setCaption("任务时刻策略所有者");
        this.setTitle("任务时刻策略所有者实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDPolicyOwnerPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDPolicyOwnerPickupViewController",this);
    }
