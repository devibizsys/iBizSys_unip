...
/**
 * 实体[用户角色数据能力]搜索表单[searchform]部件模型
 */
public class  UserRoleDatasDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserRoleDatasDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_userroledatasname_like
        iFormItem = this.createFormItem("n_userroledatasname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_userroledatasname_like");
            formItem.setDEFName("USERROLEDATASNAME");
            formItem.setCaption("用户角色数据能力名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_userroledatasname_like");
