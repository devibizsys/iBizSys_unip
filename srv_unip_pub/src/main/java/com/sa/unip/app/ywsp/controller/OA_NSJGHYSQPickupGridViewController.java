...
/**
 * 视图[OA_NSJGHYSQPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_NSJGHYSQPickupGridView.do")
public class OA_NSJGHYSQPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_NSJGHYSQPickupGridViewController() throws Exception {
        super();
        this.setId("4195fd1a6be6c5f57a05d62e8e5cac4b");
        this.setCaption("内设机构会议申请");
        this.setTitle("内设机构会议申请选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_NSJGHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_NSJGHYSQ.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_NSJGHYSQPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_NSJGHYSQPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_NSJGHYSQPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_NSJGHYSQPickupGridViewSearchFormHandler");
        searchForm.init(this);
