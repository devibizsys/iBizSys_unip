...
/**
 * 视图[OA_TZGGWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGWFActionView.do")
public class OA_TZGGWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_TZGGWFActionViewController() throws Exception {
        super();
        this.setId("5480dcbe8d5457b752beb532744c6af6");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.xxtz.ctrlmodel.OA_TZGGSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGWFActionViewEditFormHandler");
        editForm.init(this);
