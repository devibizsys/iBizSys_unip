...
/**
 * 视图[OA_JPYDJPYDLC_W_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_JPYDJPYDLC_W_WFGridView.do")
public class OA_JPYDJPYDLC_W_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_JPYDJPYDLC_W_WFGridViewController() throws Exception {
        super();
        this.setId("7657bc641378e6d59b2a8bb1e0fd5cd3");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_JPYDJPYDLC_W_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_JPYDJPYDLC_W_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDJPYDLC_W_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDJPYDLC_W_WFGridViewSearchFormHandler");
        searchForm.init(this);
