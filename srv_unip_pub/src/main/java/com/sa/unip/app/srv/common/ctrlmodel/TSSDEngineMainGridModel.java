...
/**
 * 实体[任务调度引擎]数据表格[grid]部件模型
 */
public class  TSSDEngineMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public TSSDEngineMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.TSSDEngineDEModel tSSDEngineDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.TSSDEngineDEModel getTSSDEngineDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 任务调度引擎名称
        iGridColumn = createGridColumn("tssdenginename");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("tssdenginename");
            gridColumnModel.setDataItemName("tssdenginename");
            gridColumnModel.setCaption("任务调度引擎名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 tssdengineid
        iGridDataItem = createGridDataItem("tssdengineid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdengineid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDENGINEID");
        ...
        //建立数据项 tssdenginename
        iGridDataItem = createGridDataItem("tssdenginename");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdenginename");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDENGINENAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("TSSDENGINEID");
            gridEditItem.setEnableCond(1);
            gridEditItem.setCaption("任务调度引擎标识");
