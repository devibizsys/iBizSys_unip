...
/**
 * 视图[TSSDPolicyOwnerPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDPolicyOwnerPickupGridView.do")
public class TSSDPolicyOwnerPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public TSSDPolicyOwnerPickupGridViewController() throws Exception {
        super();
        this.setId("3b75f3a6801b6310ca862a27660e7c25");
        this.setCaption("任务时刻策略所有者");
        this.setTitle("任务时刻策略所有者实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/TSSDPolicyOwnerPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDPolicyOwnerPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDPolicyOwnerPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDPolicyOwnerPickupGridViewSearchFormHandler");
        searchForm.init(this);
