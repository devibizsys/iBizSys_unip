...
/**
 * 实体[工作流用户组成员]数据表格[grid]部件模型
 */
public class  WFUserGroupDetailMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFUserGroupDetailMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wfusergroupid
        iGridDataItem = createGridDataItem("wfusergroupid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfusergroupid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        if(iGridDataItem == null) {
            ...
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUSERGROUPDETAILID");
        ...
        if(iGridDataItem == null) {
            ...
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUSERGROUPDETAILNAME");
            dataItemParam0.setFormat("");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wfusergroupdetailid
        iGridDataItem = createGridDataItem("wfusergroupdetailid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfusergroupdetailid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUSERGROUPDETAILID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFUSERGROUPDETAILID");
            gridEditItem.setCaption("工作流用户组成员标识");
