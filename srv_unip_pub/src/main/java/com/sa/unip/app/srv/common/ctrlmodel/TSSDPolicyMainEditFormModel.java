...
/**
 * 实体[任务时刻策略]编辑表单[form]部件模型
 */
public class TSSDPolicyMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDPolicyMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDPOLICYID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDPOLICYNAME");
            formItem.setCaption("任务时刻策略名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdpolicyname
        iFormItem = this.createFormItem("tssdpolicyname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdpolicyname");
            formItem.setDEFName("TSSDPOLICYNAME");
            formItem.setCaption("任务时刻策略名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdpolicyname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdpolicyid
        iFormItem = this.createFormItem("tssdpolicyid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdpolicyid");
            formItem.setDEFName("TSSDPOLICYID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略标识");
