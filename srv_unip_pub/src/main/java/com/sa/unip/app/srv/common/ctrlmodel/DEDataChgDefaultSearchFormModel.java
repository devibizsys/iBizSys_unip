...
/**
 * 实体[实体数据变更]搜索表单[searchform]部件模型
 */
public class  DEDataChgDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DEDataChgDefaultSearchFormModel() {
        super();
