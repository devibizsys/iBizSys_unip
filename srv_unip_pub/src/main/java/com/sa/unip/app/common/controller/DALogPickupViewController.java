...
/**
 * 视图[DALogPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DALogPickupView.do")
public class DALogPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DALogPickupViewController() throws Exception {
        super();
        this.setId("323386b3446bcb6724a371cbc3fcd3d9");
        this.setCaption("DA日志");
        this.setTitle("DA日志实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DALogPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DALogPickupViewController",this);
    }
