...
/**
 * 视图[OA_YCSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQEditView.do")
public class OA_YCSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_YCSQEditViewController() throws Exception {
        super();
        this.setId("c65ef89d4f53e99452432ea04b5f3d2e");
        this.setCaption("用餐申请");
        this.setTitle("用餐申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_YCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YCSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQEditViewEditFormHandler");
        editForm.init(this);
