...
/**
 * 视图[WFWorkflowEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFWorkflowEditView.do")
public class WFWorkflowEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public WFWorkflowEditViewController() throws Exception {
        super();
        this.setId("3a1b2e875914c7ef106d54c00f93b1c0");
        this.setCaption("工作流配置");
        this.setTitle("工作流配置实体编辑视图");
        this.setCapLanResTag("DE.LNAME.WFWORKFLOW");
        this.setTitleLanResTag("PAGE.TITLE.WFWORKFLOW.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFWorkflowEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFWorkflowEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFWorkflowEditViewEditFormHandler");
        editForm.init(this);
