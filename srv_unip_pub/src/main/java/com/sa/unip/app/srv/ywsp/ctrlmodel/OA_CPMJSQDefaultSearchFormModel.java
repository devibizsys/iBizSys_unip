...
/**
 * 实体[车牌门禁申请]搜索表单[searchform]部件模型
 */
public class  OA_CPMJSQDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OA_CPMJSQDefaultSearchFormModel() {
        super();
