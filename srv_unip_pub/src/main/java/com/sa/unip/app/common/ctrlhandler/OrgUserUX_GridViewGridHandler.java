...
/**
 * 应用视图[OrgUserUX_GridView]表格[grid]后台处理对象基类
 */
public class OrgUserUX_GridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserUX_Main2GridModel gridModel = null;
    public OrgUserUX_GridViewGridHandler()  {
        super();
    }
