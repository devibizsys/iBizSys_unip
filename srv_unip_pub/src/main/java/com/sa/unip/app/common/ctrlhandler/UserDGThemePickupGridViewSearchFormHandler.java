...
public class UserDGThemePickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected UserDGThemeDefaultSearchFormModel searchformModel = null;
    public UserDGThemePickupGridViewSearchFormHandler()  {
        super();
    }
