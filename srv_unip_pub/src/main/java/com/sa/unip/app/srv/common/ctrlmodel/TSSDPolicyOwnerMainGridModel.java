...
/**
 * 实体[任务时刻策略所有者]数据表格[grid]部件模型
 */
public class  TSSDPolicyOwnerMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public TSSDPolicyOwnerMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.TSSDPolicyOwnerDEModel tSSDPolicyOwnerDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.TSSDPolicyOwnerDEModel getTSSDPolicyOwnerDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 任务时刻策略所有者名称
        iGridColumn = createGridColumn("tssdpolicyownername");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("tssdpolicyownername");
            gridColumnModel.setDataItemName("tssdpolicyownername");
            gridColumnModel.setCaption("任务时刻策略所有者名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 tssdpolicyownertype
        iGridDataItem = createGridDataItem("tssdpolicyownertype");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdpolicyownertype");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDPOLICYOWNERTYPE");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 tssdpolicyownerid
        iGridDataItem = createGridDataItem("tssdpolicyownerid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdpolicyownerid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDPOLICYOWNERID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 tssdpolicyownername
        iGridDataItem = createGridDataItem("tssdpolicyownername");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdpolicyownername");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDPOLICYOWNERNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("TSSDPOLICYOWNERID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("任务时刻策略所有者标识");
