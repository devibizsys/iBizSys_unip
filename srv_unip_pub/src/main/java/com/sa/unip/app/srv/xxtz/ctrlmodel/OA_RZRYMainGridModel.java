...
/**
 * 实体[日志人员]数据表格[grid]部件模型
 */
public class  OA_RZRYMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public OA_RZRYMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 日志人员名称
        iGridColumn = createGridColumn("oa_rzryname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("oa_rzryname");
            gridColumnModel.setDataItemName("oa_rzryname");
            gridColumnModel.setCaption("日志人员名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 oa_rzryid
        iGridDataItem = createGridDataItem("oa_rzryid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("oa_rzryid");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 oa_rzryname
        iGridDataItem = createGridDataItem("oa_rzryname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("oa_rzryname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 gzrzid
        iGridDataItem = createGridDataItem("gzrzid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("gzrzid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("OA_RZRYID");
            gridEditItem.setCaption("日志人员标识");
