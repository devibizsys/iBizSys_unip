...
/**
 * 视图[OA_JPYDJPYDLC_WFExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_JPYDJPYDLC_WFExpView.do")
public class OA_JPYDJPYDLC_WFExpViewController extends net.ibizsys.pswf.controller.WFExpViewControllerBase {
    public OA_JPYDJPYDLC_WFExpViewController() throws Exception {
        super();
        this.setId("a7c87f6ee958982797627281590c283d");
        this.setCaption("机票预订");
        this.setTitle("机票预订工作流导航视图(机票预订流程)");
        this.setCapLanResTag("DE.LNAME.OA_JPYD");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.EXPBAR","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_JPYDJPYDLC_WFExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_JPYDJPYDLC_WFExpViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 expbar
        ICtrlModel expBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_JPYDexpbarWFExpBarModel");
        expBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 expbar
        ICtrlHandler expBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDJPYDLC_WFExpViewExpBarHandler");
        expBar.init(this);
