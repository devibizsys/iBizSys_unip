...
/**
 * 视图[FileRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/FileRedirectView.do")
public class FileRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public FileRedirectViewController() throws Exception {
        super();
        this.setId("9d2fce2f840697dfc3af7f4d4c3cb781");
        this.setCaption("文件");
        this.setTitle("文件实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/FileRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.FileRedirectViewController",this);
    }
