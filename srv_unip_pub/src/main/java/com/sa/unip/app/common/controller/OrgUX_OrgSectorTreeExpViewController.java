...
/**
 * 视图[OrgUX_OrgSectorTreeExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUX_OrgSectorTreeExpView.do")
public class OrgUX_OrgSectorTreeExpViewController extends net.ibizsys.paas.controller.TreeExpViewControllerBase {
    public OrgUX_OrgSectorTreeExpViewController() throws Exception {
        super();
        this.setId("0b7fc9a61573674cffd4872ab5dc0b3f");
        this.setCaption("组织机构");
        this.setTitle("UX_组织部门实体树导航视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUX_OrgSectorTreeExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUX_OrgSectorTreeExpViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 treeexpbar_tree
        ICtrlModel treeexpbar_tree=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.OrgUX_DQSTreeModel");
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 treeexpbar
        ICtrlHandler treeexpbar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUX_OrgSectorTreeExpViewTreeExpBarHandler");
        treeexpbar.init(this);
        this.registerCtrlHandler("treeexpbar",treeexpbar);
        //注册 treeexpbar_tree
        ICtrlHandler treeexpbar_tree = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUX_OrgSectorTreeExpViewTreeexpbar_treeHandler");
        treeexpbar_tree.init(this);
