...
/**
 * 视图[OrgSecUserTypeGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSecUserTypeGridView.do")
public class OrgSecUserTypeGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OrgSecUserTypeGridViewController() throws Exception {
        super();
        this.setId("074ba043171640cf409274c700d59889");
        this.setCaption("部门人员关系类型");
        this.setTitle("部门人员关系类型实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgSecUserTypeGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSecUserTypeGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgSecUserTypeGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgSecUserTypeGridViewSearchFormHandler");
        searchForm.init(this);
