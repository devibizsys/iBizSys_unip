...
/**
 * 视图[OA_ZSKPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_ZSKPickupView.do")
public class OA_ZSKPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_ZSKPickupViewController() throws Exception {
        super();
        this.setId("af501c781a6106f6b130056842970f48");
        this.setCaption("知识库");
        this.setTitle("知识库数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_ZSK");
        this.setTitleLanResTag("PAGE.TITLE.OA_ZSK.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/jcsj/OA_ZSKPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_ZSKPickupViewController",this);
    }
