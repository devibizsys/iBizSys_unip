...
/**
 * 视图[OrgUserUX_CurOrgXJRYGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserUX_CurOrgXJRYGridView.do")
public class OrgUserUX_CurOrgXJRYGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OrgUserUX_CurOrgXJRYGridViewController() throws Exception {
        super();
        this.setId("8613e02bf49ac9bef9e009212c2f927b");
        this.setCaption("组织人员");
        this.setTitle("UX_当前组织下级人员实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserUX_CurOrgXJRYGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserUX_CurOrgXJRYGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserUX_CurOrgXJRYGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserUX_CurOrgXJRYGridViewSearchFormHandler");
        searchForm.init(this);
