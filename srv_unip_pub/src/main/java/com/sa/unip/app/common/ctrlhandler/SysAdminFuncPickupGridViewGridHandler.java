...
import com.sa.unip.app.srv.common.ctrlmodel.SysAdminFuncMainGridModel;
...
/**
 * 应用视图[SysAdminFuncPickupGridView]表格[grid]后台处理对象基类
 */
public class SysAdminFuncPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected SysAdminFuncMainGridModel gridModel = null;
    public SysAdminFuncPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (SysAdminFuncMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected SysAdminFuncMainGridModel getRealGridModel() {
