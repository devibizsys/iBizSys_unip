...
import com.sa.unip.app.srv.wf.ctrlmodel.WFStepInstMainGridModel;
...
/**
 * 应用视图[WFStepInstPickupGridView]表格[grid]后台处理对象基类
 */
public class WFStepInstPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepInstMainGridModel gridModel = null;
    public WFStepInstPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFStepInstMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFStepInstMainGridModel getRealGridModel() {
