...
/**
 * 实体[任务调度日志]编辑表单[form]部件模型
 */
public class TSSDTaskLogMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDTaskLogMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKLOGID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务调度日志标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKLOGNAME");
            formItem.setCaption("任务调度日志名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdtasklogname
        iFormItem = this.createFormItem("tssdtasklogname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtasklogname");
            formItem.setDEFName("TSSDTASKLOGNAME");
            formItem.setCaption("任务调度日志名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdtasklogname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdtasklogid
        iFormItem = this.createFormItem("tssdtasklogid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtasklogid");
            formItem.setDEFName("TSSDTASKLOGID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务调度日志标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdtasklogid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
