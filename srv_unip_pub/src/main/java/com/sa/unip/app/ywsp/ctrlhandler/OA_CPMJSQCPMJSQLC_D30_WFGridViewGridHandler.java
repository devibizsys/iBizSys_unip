...
/**
 * 应用视图[OA_CPMJSQCPMJSQLC_D30_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_CPMJSQCPMJSQLC_D30_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_CPMJSQMainGridModel gridModel = null;
    public OA_CPMJSQCPMJSQLC_D30_WFGridViewGridHandler()  {
        super();
    }
