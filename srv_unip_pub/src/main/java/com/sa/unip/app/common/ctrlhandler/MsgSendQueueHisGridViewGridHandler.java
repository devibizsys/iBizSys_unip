...
import com.sa.unip.app.srv.common.ctrlmodel.MsgSendQueueHisMain2GridModel;
...
/**
 * 应用视图[MsgSendQueueHisGridView]表格[grid]后台处理对象基类
 */
public class MsgSendQueueHisGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgSendQueueHisMain2GridModel gridModel = null;
    public MsgSendQueueHisGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (MsgSendQueueHisMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected MsgSendQueueHisMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(MsgSendQueueHis entity)throws Exception {
