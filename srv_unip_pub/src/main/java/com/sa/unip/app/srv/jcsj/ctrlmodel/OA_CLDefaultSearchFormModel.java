...
/**
 * 实体[车辆]搜索表单[searchform]部件模型
 */
public class  OA_CLDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OA_CLDefaultSearchFormModel() {
        super();
