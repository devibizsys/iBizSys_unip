...
/**
 * 应用视图[WFDynamicUserPickupGridView]表格[grid]后台处理对象基类
 */
public class WFDynamicUserPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFDynamicUserMainGridModel gridModel = null;
    public WFDynamicUserPickupGridViewGridHandler()  {
        super();
    }
