...
/**
 * 应用视图[TSSDTaskTypePickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDTaskTypePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDTaskTypeMainGridModel gridModel = null;
    public TSSDTaskTypePickupGridViewGridHandler()  {
        super();
    }
