...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YCSQSHYJFormEditFormModel;
...
public class OA_YCSQWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_YCSQSHYJFormEditFormModel editformModel = null;
    public OA_YCSQWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YCSQSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YCSQSHYJFormEditFormModel getRealEditFormModel() {
