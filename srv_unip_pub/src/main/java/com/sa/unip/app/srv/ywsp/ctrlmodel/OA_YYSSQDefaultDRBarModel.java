...
/**
 * 实体[饮用水申请]数据关系栏[drbar]部件模型
 */
public class  OA_YYSSQDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OA_YYSSQDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setTextLanResTag("DE.LNAME.OA_YYSSQ");
