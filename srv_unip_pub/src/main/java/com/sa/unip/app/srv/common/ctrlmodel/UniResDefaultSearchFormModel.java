...
/**
 * 实体[统一资源]搜索表单[searchform]部件模型
 */
public class  UniResDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UniResDefaultSearchFormModel() {
        super();
