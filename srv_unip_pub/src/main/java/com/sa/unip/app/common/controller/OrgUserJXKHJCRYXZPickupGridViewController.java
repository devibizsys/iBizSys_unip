...
/**
 * 视图[OrgUserJXKHJCRYXZPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserJXKHJCRYXZPickupGridView.do")
public class OrgUserJXKHJCRYXZPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OrgUserJXKHJCRYXZPickupGridViewController() throws Exception {
        super();
        this.setId("6c6def1083a5dc779544ea24ae922a0f");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体绩效考核检察人员选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserJXKHJCRYXZPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserJXKHJCRYXZPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 grid
        ICtrlModel grid=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.OrgUserUX_Main3GridModel");
        grid.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserJXKHJCRYXZPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserJXKHJCRYXZPickupGridViewSearchFormHandler");
        searchForm.init(this);
