...
/**
 * 视图[OA_TZGGTZGGSQLC_D_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGTZGGSQLC_D_WFEditView3.do")
public class OA_TZGGTZGGSQLC_D_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_TZGGTZGGSQLC_D_WFEditView3Controller() throws Exception {
        super();
        this.setId("78e91842caf9a23d2a54118db79d0890");
        this.setCaption("通知公告");
        this.setTitle("通知公告工作流视图(通知公告申请)");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGTZGGSQLC_D_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGTZGGSQLC_D_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_D_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_D_WFEditView3EditFormHandler");
        editForm.init(this);
