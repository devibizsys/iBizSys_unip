...
/**
 * 实体[帐户使用记录]数据关系栏[drbar]部件模型
 */
public class  LoginLogDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public LoginLogDefaultDRBarModel() {
        super();
    }
