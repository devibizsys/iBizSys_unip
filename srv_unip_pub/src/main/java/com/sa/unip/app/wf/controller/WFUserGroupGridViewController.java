...
/**
 * 视图[WFUserGroupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupGridView.do")
public class WFUserGroupGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFUserGroupGridViewController() throws Exception {
        super();
        this.setId("3b233410b6206073487bc4ddaa8eb1ff");
        this.setCaption("工作流用户组");
        this.setTitle("工作流用户组实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGroupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGroupGridViewSearchFormHandler");
        searchForm.init(this);
