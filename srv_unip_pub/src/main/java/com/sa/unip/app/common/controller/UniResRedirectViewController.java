...
/**
 * 视图[UniResRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UniResRedirectView.do")
public class UniResRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UniResRedirectViewController() throws Exception {
        super();
        this.setId("0f59955767affab78d6fac6aa00e3229");
        this.setCaption("统一资源");
        this.setTitle("统一资源实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UniResRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UniResRedirectViewController",this);
    }
