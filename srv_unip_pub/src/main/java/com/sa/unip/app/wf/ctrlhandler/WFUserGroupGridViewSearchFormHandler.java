...
public class WFUserGroupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFUserGroupDefaultSearchFormModel searchformModel = null;
    public WFUserGroupGridViewSearchFormHandler()  {
        super();
    }
