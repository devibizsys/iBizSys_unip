...
/**
 * 实体[通知公告]流程导航栏[expbar]部件模型
 */
public class  OA_TZGGexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_TZGGexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("21C2D14F-CB19-468E-A8E2-B1219566CA04"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("TZGGSQLC:D:20");
        ...
        expBarItem3.setExpViewId("TZGGSQLC:D:20:10");
        ...
        expBarItem4.setExpViewId("TZGGSQLC:D:20:20");
        ...
        expBarItem5.setExpViewId("TZGGSQLC:D:30");
        ...
        expBarItem6.setExpViewId("TZGGSQLC:D:40");
        ...
        expBarItem7.setExpViewId("TZGGSQLC:W");
        ...
        expBarItem8.setExpViewId("TZGGSQLC:W:10");
        ...
        expBarItem9.setExpViewId("TZGGSQLC:W:20");
