...
/**
 * 实体[系统]数据表格[grid]部件模型
 */
public class  SystemMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public SystemMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.SystemDEModel systemDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.SystemDEModel getSystemDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 系统名称
        iGridColumn = createGridColumn("systemname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("systemname");
            gridColumnModel.setDataItemName("systemname");
            gridColumnModel.setCaption("系统名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 systemid
        iGridDataItem = createGridDataItem("systemid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("systemid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("SYSTEMID");
        ...
        //建立数据项 systemname
        iGridDataItem = createGridDataItem("systemname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("systemname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("SYSTEMNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("SYSTEMID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("系统标识");
