...
/**
 * 应用视图[WXMessagePickupGridView]表格[grid]后台处理对象基类
 */
public class WXMessagePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXMessageMainGridModel gridModel = null;
    public WXMessagePickupGridViewGridHandler()  {
        super();
    }
