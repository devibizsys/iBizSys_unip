...
/**
 * 视图[OA_BGYPSQBGYPSQLC_D_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQBGYPSQLC_D_WFEditView3.do")
public class OA_BGYPSQBGYPSQLC_D_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_BGYPSQBGYPSQLC_D_WFEditView3Controller() throws Exception {
        super();
        this.setId("e3a46405d338567fbb6b0f446026e947");
        this.setCaption("办公用品申请");
        this.setTitle("办公用品申请工作流视图(办公用品申领流程)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQBGYPSQLC_D_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQBGYPSQLC_D_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQBGYPSQLC_D_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQBGYPSQLC_D_WFEditView3EditFormHandler");
        editForm.init(this);
