...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_NSJGHYSQSHYJFormEditFormModel;
...
public class OA_NSJGHYSQWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_NSJGHYSQSHYJFormEditFormModel editformModel = null;
    public OA_NSJGHYSQWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_NSJGHYSQSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_NSJGHYSQSHYJFormEditFormModel getRealEditFormModel() {
