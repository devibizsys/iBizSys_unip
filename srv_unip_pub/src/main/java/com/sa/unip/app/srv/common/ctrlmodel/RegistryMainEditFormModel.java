...
/**
 * 实体[注册表]编辑表单[form]部件模型
 */
public class RegistryMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public RegistryMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("REGISTRYID");
            formItem.setEnableCond(0);
            formItem.setCaption("注册表标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("REGISTRYNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("系统目录");
        ...
        this.registerFormItem(iFormItem);
        // registryname
        iFormItem = this.createFormItem("registryname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("registryname");
            formItem.setDEFName("REGISTRYNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("系统目录");
        ...
        this.registerFormItem(iFormItem);
        // registryid
        iFormItem = this.createFormItem("registryid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("registryid");
            formItem.setDEFName("REGISTRYID");
            formItem.setEnableCond(0);
            formItem.setCaption("注册表标识");
