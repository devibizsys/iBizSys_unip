...
/**
 * 视图[UserGroupDetailMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserGroupDetailMPickupView.do")
public class UserGroupDetailMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserGroupDetailMPickupViewController() throws Exception {
        super();
        this.setId("8867323ed65397da044a3329c77ed948");
        this.setCaption("用户组成员");
        this.setTitle("用户组成员实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserGroupDetailMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserGroupDetailMPickupViewController",this);
    }
