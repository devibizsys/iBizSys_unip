...
/**
 * 实体[组织人员级别]数据关系栏[drbar]部件模型
 */
public class  OrgUserLevelDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OrgUserLevelDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        //添加 详细信息
        DRCtrlItem drCtrlItem1 = drCtrlRootItem.addItem("e6c870c62a861cfd5593212fa41d6f88","form");
        ...
        //添加 组织人员
        DRCtrlItem drCtrlItem2 = drCtrlRootItem.addItem("dritem1","e6c870c62a861cfd5593212fa41d6f88");
        drCtrlItem2.setText("组织人员");
        ...
        drCtrlItem2.setViewParam("srfparentdeid","e6c870c62a861cfd5593212fa41d6f88");
        drCtrlItem2.setViewParam("srfparenttype","DER1N");
        drCtrlItem2.setViewParam("srfder1nid","DER1N_ORGUSER_ORGUSERLEVEL_ORGUSERLEVELID");
    }
}