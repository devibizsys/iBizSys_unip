...
/**
 * 视图[UserObjectMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserObjectMPickupView.do")
public class UserObjectMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserObjectMPickupViewController() throws Exception {
        super();
        this.setId("8e4fa05f4327b35f7ca9311ee6c2b3da");
        this.setCaption("用户对象");
        this.setTitle("用户对象实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserObjectMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserObjectMPickupViewController",this);
    }
