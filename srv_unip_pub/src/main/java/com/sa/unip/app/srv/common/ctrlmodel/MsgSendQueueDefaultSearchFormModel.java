...
/**
 * 实体[消息发送队列]搜索表单[searchform]部件模型
 */
public class  MsgSendQueueDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public MsgSendQueueDefaultSearchFormModel() {
        super();
