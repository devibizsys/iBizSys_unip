...
/**
 * 视图[OrgSecUserTypePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSecUserTypePickupView.do")
public class OrgSecUserTypePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgSecUserTypePickupViewController() throws Exception {
        super();
        this.setId("d2fe58b2caaa9d3e57216379e08caaf1");
        this.setCaption("部门人员关系类型");
        this.setTitle("部门人员关系类型实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgSecUserTypePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSecUserTypePickupViewController",this);
    }
