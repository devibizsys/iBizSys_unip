...
public class QueryModelPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected QueryModelDefaultSearchFormModel searchformModel = null;
    public QueryModelPickupGridViewSearchFormHandler()  {
        super();
    }
