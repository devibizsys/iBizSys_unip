...
public class UserRoleDEFieldEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected UserRoleDEFieldMain2EditFormModel editformModel = null;
    public UserRoleDEFieldEditViewEditFormHandler()  {
        super();
    }
