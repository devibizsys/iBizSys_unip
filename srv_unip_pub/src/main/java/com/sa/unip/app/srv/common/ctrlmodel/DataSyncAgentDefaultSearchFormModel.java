...
/**
 * 实体[数据同步代理]搜索表单[searchform]部件模型
 */
public class  DataSyncAgentDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DataSyncAgentDefaultSearchFormModel() {
        super();
