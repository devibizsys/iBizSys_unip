...
/**
 * 实体[实体]编辑表单[form]部件模型
 */
public class DataEntityMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DataEntityMainEditFormModel()  {
        super();
        this.setName("form");
    }
