...
/**
 * 应用视图[OA_YYSSQGridView]表格[grid]后台处理对象基类
 */
public class OA_YYSSQGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_YYSSQMainGridModel gridModel = null;
    public OA_YYSSQGridViewGridHandler()  {
        super();
    }
