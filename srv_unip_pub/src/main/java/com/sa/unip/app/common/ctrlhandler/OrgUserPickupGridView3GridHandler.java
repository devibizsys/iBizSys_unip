...
/**
 * 应用视图[OrgUserPickupGridView3]表格[grid]后台处理对象基类
 */
public class OrgUserPickupGridView3GridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserMain2GridModel gridModel = null;
    public OrgUserPickupGridView3GridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchDQCBR(deDataSetFetchContext);
    }
