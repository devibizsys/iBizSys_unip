...
/**
 * 应用视图[UserRoleDEFieldPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDEFieldPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDEFieldMain2GridModel gridModel = null;
    public UserRoleDEFieldPickupGridViewGridHandler()  {
        super();
    }
