...
public class OA_BGYPSQPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_BGYPSQDefaultSearchFormModel searchformModel = null;
    public OA_BGYPSQPickupGridViewSearchFormHandler()  {
        super();
    }
