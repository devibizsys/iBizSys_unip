...
public class PPModelUserMainEditFormC3pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormC3pvpartnameHandler()  {
        super();
    }
