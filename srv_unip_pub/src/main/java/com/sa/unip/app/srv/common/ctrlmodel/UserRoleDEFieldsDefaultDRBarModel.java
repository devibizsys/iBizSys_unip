...
/**
 * 实体[用户角色相关实体属性访问控制]数据关系栏[drbar]部件模型
 */
public class  UserRoleDEFieldsDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserRoleDEFieldsDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setText("用户角色相关实体属性访问控制");
