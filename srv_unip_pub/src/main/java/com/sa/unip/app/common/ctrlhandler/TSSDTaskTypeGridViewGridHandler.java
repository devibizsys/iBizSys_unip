...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDTaskTypeMainGridModel;
...
/**
 * 应用视图[TSSDTaskTypeGridView]表格[grid]后台处理对象基类
 */
public class TSSDTaskTypeGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDTaskTypeMainGridModel gridModel = null;
    public TSSDTaskTypeGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDTaskTypeMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDTaskTypeMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDTaskType entity)throws Exception {
