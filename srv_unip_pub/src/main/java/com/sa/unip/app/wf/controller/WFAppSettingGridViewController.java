...
/**
 * 视图[WFAppSettingGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFAppSettingGridView.do")
public class WFAppSettingGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFAppSettingGridViewController() throws Exception {
        super();
        this.setId("b1a20fcd6f64f80f63ded23f0bd0d33a");
        this.setCaption("工作流系统设定");
        this.setTitle("工作流应用设定实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFAppSettingGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFAppSettingGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFAppSettingGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFAppSettingGridViewSearchFormHandler");
        searchForm.init(this);
