...
/**
 * 视图[UserRoleDataActionPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDataActionPickupView.do")
public class UserRoleDataActionPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserRoleDataActionPickupViewController() throws Exception {
        super();
        this.setId("cabe1bfeb0a2715e399031ea4489e3c7");
        this.setCaption("用户角色数据操作");
        this.setTitle("用户角色数据操作实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDataActionPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDataActionPickupViewController",this);
    }
