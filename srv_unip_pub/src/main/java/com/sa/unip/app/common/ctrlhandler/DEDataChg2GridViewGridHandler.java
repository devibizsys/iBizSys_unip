...
import com.sa.unip.app.srv.common.ctrlmodel.DEDataChg2MainGridModel;
...
/**
 * 应用视图[DEDataChg2GridView]表格[grid]后台处理对象基类
 */
public class DEDataChg2GridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DEDataChg2MainGridModel gridModel = null;
    public DEDataChg2GridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DEDataChg2MainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DEDataChg2MainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DEDataChg2 entity)throws Exception {
