...
/**
 * 视图[WFStepActorActiveGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepActorActiveGridView.do")
public class WFStepActorActiveGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFStepActorActiveGridViewController() throws Exception {
        super();
        this.setId("314aebca2be096a6309ccbe377cdad2f");
        this.setCaption("工作流步骤操作者");
        this.setTitle("当前流程操作者表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepActorActiveGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepActorActiveGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepActorActiveGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepActorActiveGridViewSearchFormHandler");
        searchForm.init(this);
