...
/**
 * 视图[WFUserMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserMPickupView.do")
public class WFUserMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFUserMPickupViewController() throws Exception {
        super();
        this.setId("b8071112e38fdf6ea17a08eff690f9c3");
        this.setCaption("工作流用户");
        this.setTitle("工作流用户实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUserMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserMPickupViewController",this);
    }
