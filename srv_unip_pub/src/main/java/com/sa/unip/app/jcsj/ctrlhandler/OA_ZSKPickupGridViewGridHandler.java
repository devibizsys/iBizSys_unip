...
/**
 * 应用视图[OA_ZSKPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_ZSKPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_ZSKMainGridModel gridModel = null;
    public OA_ZSKPickupGridViewGridHandler()  {
        super();
    }
