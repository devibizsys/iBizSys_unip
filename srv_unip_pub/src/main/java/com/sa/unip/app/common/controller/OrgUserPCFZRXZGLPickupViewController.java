...
/**
 * 视图[OrgUserPCFZRXZGLPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserPCFZRXZGLPickupView.do")
public class OrgUserPCFZRXZGLPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgUserPCFZRXZGLPickupViewController() throws Exception {
        super();
        this.setId("c9391e8e2a3551b716a2ad61684c1edc");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体数据选择过滤视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgUserPCFZRXZGLPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserPCFZRXZGLPickupViewController",this);
    }
