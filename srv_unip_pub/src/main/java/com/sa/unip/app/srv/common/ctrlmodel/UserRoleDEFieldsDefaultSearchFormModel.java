...
/**
 * 实体[用户角色相关实体属性访问控制]搜索表单[searchform]部件模型
 */
public class  UserRoleDEFieldsDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserRoleDEFieldsDefaultSearchFormModel() {
        super();
