...
import com.sa.unip.app.srv.wf.ctrlmodel.WFVersionMainGridModel;
...
/**
 * 应用视图[WFVersionGridView]表格[grid]后台处理对象基类
 */
public class WFVersionGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFVersionMainGridModel gridModel = null;
    public WFVersionGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFVersionMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFVersionMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFVersion entity)throws Exception {
