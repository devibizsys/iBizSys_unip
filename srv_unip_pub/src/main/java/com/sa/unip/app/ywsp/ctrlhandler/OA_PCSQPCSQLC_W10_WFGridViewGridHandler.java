...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_PCSQMainGridModel;
...
/**
 * 应用视图[OA_PCSQPCSQLC_W10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_PCSQPCSQLC_W10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_PCSQMainGridModel gridModel = null;
    public OA_PCSQPCSQLC_W10_WFGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_PCSQMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_PCSQMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_PCSQ entity)throws Exception {
