...
/**
 * 视图[OA_CZRZEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xtgl/OA_CZRZEditView2.do")
public class OA_CZRZEditView2Controller extends net.ibizsys.paas.controller.EditView2ControllerBase {
    public OA_CZRZEditView2Controller() throws Exception {
        super();
        this.setId("968e69b038852b771839feaad7cb5182");
        this.setCaption("操作日志");
        this.setTitle("操作日志编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_CZRZ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CZRZ.EDITVIEW2");
        ...
        ViewControllerGlobal.registerViewController("/app/xtgl/OA_CZRZEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xtgl.controller.OA_CZRZEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.xtgl.ctrlmodel.OA_CZRZDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xtgl.ctrlhandler.OA_CZRZEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xtgl.ctrlhandler.OA_CZRZEditView2DRBarHandler");
        drBar.init(this);
