...
/**
 * 实体[工作流配置版本]数据表格[grid]部件模型
 */
public class  WFVersionMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFVersionMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wfwfversionid
        iGridDataItem = createGridDataItem("wfwfversionid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfwfversionid");
        ...
        //建立数据项 wfwfid
        iGridDataItem = createGridDataItem("wfwfid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfwfid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFWFID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFWFVERSIONID");
            gridEditItem.setCaption("工作流配置版本标识");
