...
/**
 * 实体[代码表]数据表格[grid]部件模型
 */
public class  CodeListMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public CodeListMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("代码表名称");
        ...
        //建立表格列 代码表标识
        iGridColumn = createGridColumn("codelistid");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("codelistid");
            gridColumnModel.setDataItemName("codelistid");
            gridColumnModel.setCaption("代码表标识");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("CODELISTID");
            gridEditItem.setCaption("代码表标识");
