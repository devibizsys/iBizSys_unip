...
/**
 * 实体[系统管理模块]编辑表单[form]部件模型
 */
public class SysAdminMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public SysAdminMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SYSADMINID");
            formItem.setEnableCond(0);
            formItem.setCaption("系统管理标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SYSADMINNAME");
            formItem.setCaption("系统管理名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("SYSADMINNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // sysadminname
        iFormItem = this.createFormItem("sysadminname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("sysadminname");
            formItem.setDEFName("SYSADMINNAME");
            formItem.setCaption("系统管理名称");
        ...
        this.registerFormItem(iFormItem);
        // sysadminid
        iFormItem = this.createFormItem("sysadminid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("sysadminid");
            formItem.setDEFName("SYSADMINID");
            formItem.setEnableCond(0);
            formItem.setCaption("系统管理标识");
