...
/**
 * 视图[GG_DBRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/GG_DBRedirectView.do")
public class GG_DBRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public GG_DBRedirectViewController() throws Exception {
        super();
        this.setId("6b6afeb4adcf45f47550139ad73cf7e1");
        this.setCaption("待办");
        this.setTitle("待办数据重定向视图");
        this.setCapLanResTag("DE.LNAME.GG_DB");
        this.setTitleLanResTag("PAGE.TITLE.GG_DB.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/GG_DBRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.GG_DBRedirectViewController",this);
    }
