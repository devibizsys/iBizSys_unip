...
/**
 * 实体[服务]数据表格[grid]部件模型
 */
public class  ServiceMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public ServiceMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 服务名称
        iGridColumn = createGridColumn("servicename");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("servicename");
            gridColumnModel.setDataItemName("servicename");
            gridColumnModel.setCaption("服务名称");
        ...
        //建立表格列 服务容器
        iGridColumn = createGridColumn("container");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("container");
            gridColumnModel.setDataItemName("container");
            gridColumnModel.setCaption("服务容器");
            gridColumnModel.setCodeListId("net.ibizsys.psrt.srv.codelist.ServiceContainerCodeListModel");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 服务运行状态
        iGridColumn = createGridColumn("servicestate");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("servicestate");
            gridColumnModel.setDataItemName("servicestate");
            gridColumnModel.setCaption("服务运行状态");
            gridColumnModel.setCodeListId("net.ibizsys.psrt.srv.codelist.ServiceRunStateCodeListModel");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 servicestate
        iGridDataItem = createGridDataItem("servicestate");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("servicestate");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("SERVICESTATE");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 container
        iGridDataItem = createGridDataItem("container");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("container");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("CONTAINER");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 servicename
        iGridDataItem = createGridDataItem("servicename");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("servicename");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 serviceid
        iGridDataItem = createGridDataItem("serviceid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("serviceid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("SERVICEID");
            gridEditItem.setEnableCond(1);
            gridEditItem.setCaption("服务标识");
