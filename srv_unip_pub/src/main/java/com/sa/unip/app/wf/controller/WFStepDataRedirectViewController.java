...
/**
 * 视图[WFStepDataRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepDataRedirectView.do")
public class WFStepDataRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFStepDataRedirectViewController() throws Exception {
        super();
        this.setId("20331e4e9e70cd16724277fb5453bff0");
        this.setCaption("工作流步骤数据");
        this.setTitle("工作流步骤数据实体数据重定向视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPDATA");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFStepDataRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepDataRedirectViewController",this);
    }
