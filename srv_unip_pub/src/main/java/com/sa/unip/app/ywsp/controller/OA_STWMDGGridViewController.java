...
/**
 * 视图[OA_STWMDGGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGGridView.do")
public class OA_STWMDGGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_STWMDGGridViewController() throws Exception {
        super();
        this.setId("ec876f0a821345d10a9717125ef7b3f5");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购表格视图");
        this.setCapLanResTag("DE.LNAME.OA_STWMDG");
        this.setTitleLanResTag("PAGE.TITLE.OA_STWMDG.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGGridViewSearchFormHandler");
        searchForm.init(this);
