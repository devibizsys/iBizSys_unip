...
/**
 * 视图[UserGroupDetailRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserGroupDetailRedirectView.do")
public class UserGroupDetailRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserGroupDetailRedirectViewController() throws Exception {
        super();
        this.setId("bab82222738269e8ac5b89d62847a6f0");
        this.setCaption("用户组成员");
        this.setTitle("用户组成员实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserGroupDetailRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserGroupDetailRedirectViewController",this);
    }
