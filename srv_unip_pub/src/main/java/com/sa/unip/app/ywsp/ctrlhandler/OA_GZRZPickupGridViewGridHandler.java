...
/**
 * 应用视图[OA_GZRZPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_GZRZPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_GZRZMainGridModel gridModel = null;
    public OA_GZRZPickupGridViewGridHandler()  {
        super();
    }
