...
public class DataSyncOut2PickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected DataSyncOut2DefaultSearchFormModel searchformModel = null;
    public DataSyncOut2PickupGridViewSearchFormHandler()  {
        super();
    }
