...
/**
 * 视图[WFAssistWorkGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFAssistWorkGridView.do")
public class WFAssistWorkGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFAssistWorkGridViewController() throws Exception {
        super();
        this.setId("3cfe801f6dee38cedd6bde9c7884d2ce");
        this.setCaption("工作流代办工作");
        this.setTitle("工作流代办工作实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFAssistWorkGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFAssistWorkGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFAssistWorkGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFAssistWorkGridViewSearchFormHandler");
        searchForm.init(this);
