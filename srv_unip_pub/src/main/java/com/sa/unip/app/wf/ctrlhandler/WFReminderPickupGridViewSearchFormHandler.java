...
public class WFReminderPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFReminderDefaultSearchFormModel searchformModel = null;
    public WFReminderPickupGridViewSearchFormHandler()  {
        super();
    }
