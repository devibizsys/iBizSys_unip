...
/**
 * 视图[OA_NSJGHYSQPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_NSJGHYSQPickupView.do")
public class OA_NSJGHYSQPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_NSJGHYSQPickupViewController() throws Exception {
        super();
        this.setId("0d09cbb3e26247795af387683a777efd");
        this.setCaption("内设机构会议申请");
        this.setTitle("内设机构会议申请数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_NSJGHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_NSJGHYSQ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_NSJGHYSQPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_NSJGHYSQPickupViewController",this);
    }
