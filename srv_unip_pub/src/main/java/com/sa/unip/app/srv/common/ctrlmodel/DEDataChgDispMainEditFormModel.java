...
/**
 * 实体[实体数据变更派发引擎]编辑表单[form]部件模型
 */
public class DEDataChgDispMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DEDataChgDispMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DEDATACHGDISPID");
            formItem.setEnableCond(0);
            formItem.setCaption("实体数据变更派发标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DEDATACHGDISPNAME");
            formItem.setCaption("数据变更派发引擎");
        ...
        this.registerFormItem(iFormItem);
        // dedatachgdispname
        iFormItem = this.createFormItem("dedatachgdispname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dedatachgdispname");
            formItem.setDEFName("DEDATACHGDISPNAME");
            formItem.setCaption("数据变更派发引擎");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dedatachgdispname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // dedatachgdispid
        iFormItem = this.createFormItem("dedatachgdispid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dedatachgdispid");
            formItem.setDEFName("DEDATACHGDISPID");
            formItem.setEnableCond(0);
            formItem.setCaption("实体数据变更派发标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dedatachgdispid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
