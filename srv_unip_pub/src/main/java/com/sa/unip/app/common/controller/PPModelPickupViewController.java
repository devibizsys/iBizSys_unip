...
/**
 * 视图[PPModelPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PPModelPickupView.do")
public class PPModelPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public PPModelPickupViewController() throws Exception {
        super();
        this.setId("97e410195711782f1a1d0e1d3934d4b0");
        this.setCaption("门户页面模型");
        this.setTitle("门户页面模型实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/PPModelPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PPModelPickupViewController",this);
    }
