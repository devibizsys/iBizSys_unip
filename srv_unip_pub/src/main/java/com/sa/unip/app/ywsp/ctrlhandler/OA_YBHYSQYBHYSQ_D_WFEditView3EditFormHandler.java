...
public class OA_YBHYSQYBHYSQ_D_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YBHYSQMainEditFormModel editformModel = null;
    public OA_YBHYSQYBHYSQ_D_WFEditView3EditFormHandler()  {
        super();
    }
