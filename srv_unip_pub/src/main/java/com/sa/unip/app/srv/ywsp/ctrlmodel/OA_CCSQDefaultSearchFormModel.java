...
/**
 * 实体[出差申请]搜索表单[searchform]部件模型
 */
public class  OA_CCSQDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OA_CCSQDefaultSearchFormModel() {
        super();
