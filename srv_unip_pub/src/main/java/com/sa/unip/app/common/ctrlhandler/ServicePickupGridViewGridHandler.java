...
/**
 * 应用视图[ServicePickupGridView]表格[grid]后台处理对象基类
 */
public class ServicePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected ServiceMainGridModel gridModel = null;
    public ServicePickupGridViewGridHandler()  {
        super();
    }
