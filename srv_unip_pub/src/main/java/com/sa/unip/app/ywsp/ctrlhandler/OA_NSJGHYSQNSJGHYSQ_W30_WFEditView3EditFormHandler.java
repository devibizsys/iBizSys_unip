...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_NSJGHYSQMainEditFormModel;
...
public class OA_NSJGHYSQNSJGHYSQ_W30_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_NSJGHYSQMainEditFormModel editformModel = null;
    public OA_NSJGHYSQNSJGHYSQ_W30_WFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_NSJGHYSQMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_NSJGHYSQMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgusername'
        IFormItemHandler orgusernameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.ywsp.ctrlhandler.OA_NSJGHYSQMainEditFormOrgusernameHandler");
        ...
        //注册 'hysname'
        IFormItemHandler hysnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.ywsp.ctrlhandler.OA_NSJGHYSQMainEditFormHysnameHandler");
