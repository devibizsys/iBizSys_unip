...
/**
 * 应用视图[WXAccessTokenPickupGridView]表格[grid]后台处理对象基类
 */
public class WXAccessTokenPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXAccessTokenMainGridModel gridModel = null;
    public WXAccessTokenPickupGridViewGridHandler()  {
        super();
    }
