...
/**
 * 视图[OrgUnitCatGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUnitCatGridView.do")
public class OrgUnitCatGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OrgUnitCatGridViewController() throws Exception {
        super();
        this.setId("4f38482271b9d5129ebe5130799b3ff1");
        this.setCaption("组织单元类别");
        this.setTitle("组织单元类别实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUnitCatGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUnitCatGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUnitCatGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUnitCatGridViewSearchFormHandler");
        searchForm.init(this);
