...
/**
 * 应用视图[SysAdminFuncGridView]表格[grid]后台处理对象基类
 */
public class SysAdminFuncGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected SysAdminFuncMainGridModel gridModel = null;
    public SysAdminFuncGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(SysAdminFunc entity)throws Exception {
