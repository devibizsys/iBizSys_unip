...
public class PVPartPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected PVPartDefaultSearchFormModel searchformModel = null;
    public PVPartPickupGridViewSearchFormHandler()  {
        super();
    }
