...
/**
 * 应用视图[WFStepDataTraceGridView]表格[grid]后台处理对象基类
 */
public class WFStepDataTraceGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFStepDataGridHandlerBase {

    protected WFStepDataMain2GridModel gridModel = null;
    public WFStepDataTraceGridViewGridHandler()  {
        super();
    }
