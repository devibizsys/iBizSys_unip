...
/**
 * 视图[OrgUserMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserMPickupView.do")
public class OrgUserMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OrgUserMPickupViewController() throws Exception {
        super();
        this.setId("70518890a99638aa69c9574079be0957");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgUserMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserMPickupViewController",this);
    }
