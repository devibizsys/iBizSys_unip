...
public class OA_CGSQCGSQLC_D_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CGSQMainEditFormModel editformModel = null;
    public OA_CGSQCGSQLC_D_WFEditView3EditFormHandler()  {
        super();
    }
