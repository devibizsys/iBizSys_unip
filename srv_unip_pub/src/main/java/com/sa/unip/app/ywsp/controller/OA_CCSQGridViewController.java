...
/**
 * 视图[OA_CCSQGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQGridView.do")
public class OA_CCSQGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_CCSQGridViewController() throws Exception {
        super();
        this.setId("d3a91aa8e3518aa1b83c122afd5800ad");
        this.setCaption("出差申请");
        this.setTitle("出差申请表格视图");
        this.setCapLanResTag("DE.LNAME.QA_CCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CCSQ.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQGridViewSearchFormHandler");
        searchForm.init(this);
