...
/**
 * 视图[WFStepActorPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepActorPickupGridView.do")
public class WFStepActorPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public WFStepActorPickupGridViewController() throws Exception {
        super();
        this.setId("f6207e6412c85209c6c53e9d8ffdee3a");
        this.setCaption("工作流步骤操作者");
        this.setTitle("工作流步骤操作者实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepActorPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepActorPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 searchform
        ICtrlModel searchForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.wf.ctrlmodel.WFStepActorDefaultSearchFormModel");
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepActorPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepActorPickupGridViewSearchFormHandler");
        searchForm.init(this);
