...
/**
 * 视图[OA_CLWXPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CLWXPickupView.do")
public class OA_CLWXPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_CLWXPickupViewController() throws Exception {
        super();
        this.setId("d3d198437883b508f89493b447457431");
        this.setCaption("车辆维修");
        this.setTitle("车辆维修数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_CLWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_CLWX.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CLWXPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CLWXPickupViewController",this);
    }
