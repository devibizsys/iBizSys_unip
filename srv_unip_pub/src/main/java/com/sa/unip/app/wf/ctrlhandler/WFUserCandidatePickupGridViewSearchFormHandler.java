...
public class WFUserCandidatePickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFUserCandidateDefaultSearchFormModel searchformModel = null;
    public WFUserCandidatePickupGridViewSearchFormHandler()  {
        super();
    }
