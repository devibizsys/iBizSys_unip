...
/**
 * 视图[SysAdminFuncGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/SysAdminFuncGridView.do")
public class SysAdminFuncGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public SysAdminFuncGridViewController() throws Exception {
        super();
        this.setId("2688e1312027dde0779cb462a46740fa");
        this.setCaption("系统管理功能");
        this.setTitle("系统管理功能实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/SysAdminFuncGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.SysAdminFuncGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.SysAdminFuncGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.SysAdminFuncGridViewSearchFormHandler");
        searchForm.init(this);
