...
/**
 * 实体[用户角色相关实体属性访问控制]数据表格[grid]部件模型
 */
public class  UserRoleDEFieldsMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserRoleDEFieldsMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.UserRoleDEFieldsDEModel userRoleDEFieldsDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.UserRoleDEFieldsDEModel getUserRoleDEFieldsDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 用户角色相关实体属性访问控制
        iGridColumn = createGridColumn("userroledefieldsname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("userroledefieldsname");
            gridColumnModel.setDataItemName("userroledefieldsname");
            gridColumnModel.setCaption("用户角色相关实体属性访问控制");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 userroledefieldsid
        iGridDataItem = createGridDataItem("userroledefieldsid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userroledefieldsid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERROLEDEFIELDSID");
        ...
        //建立数据项 userroledefieldid
        iGridDataItem = createGridDataItem("userroledefieldid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userroledefieldid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 userroledefieldsname
        iGridDataItem = createGridDataItem("userroledefieldsname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userroledefieldsname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERROLEDEFIELDSNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERROLEDEFIELDSID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("用户角色相关实体属性访问控制标识");
