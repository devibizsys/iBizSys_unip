...
public class OA_JPYDJPYDLC_W20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_JPYDDefaultSearchFormModel searchformModel = null;
    public OA_JPYDJPYDLC_W20_WFGridViewSearchFormHandler()  {
        super();
    }
