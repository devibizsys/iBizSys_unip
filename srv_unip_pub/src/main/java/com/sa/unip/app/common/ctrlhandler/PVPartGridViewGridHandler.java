...
/**
 * 应用视图[PVPartGridView]表格[grid]后台处理对象基类
 */
public class PVPartGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected PVPartMainGridModel gridModel = null;
    public PVPartGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(PVPart entity)throws Exception {
