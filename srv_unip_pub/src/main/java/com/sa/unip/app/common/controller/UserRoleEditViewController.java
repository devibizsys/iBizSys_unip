...
/**
 * 视图[UserRoleEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleEditView.do")
public class UserRoleEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public UserRoleEditViewController() throws Exception {
        super();
        this.setId("dc79bce8898e8df7336f5120d04f7394");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleEditViewEditFormHandler");
        editForm.init(this);
