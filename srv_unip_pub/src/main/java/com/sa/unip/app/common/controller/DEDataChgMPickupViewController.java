...
/**
 * 视图[DEDataChgMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChgMPickupView.do")
public class DEDataChgMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public DEDataChgMPickupViewController() throws Exception {
        super();
        this.setId("2c8fed337dfda007c93a81ac4655c5b6");
        this.setCaption("实体数据变更");
        this.setTitle("实体数据变更实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DEDataChgMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChgMPickupViewController",this);
    }
