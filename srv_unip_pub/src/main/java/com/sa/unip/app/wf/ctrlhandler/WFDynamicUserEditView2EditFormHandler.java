...
import com.sa.unip.app.srv.wf.ctrlmodel.WFDynamicUserMainEditFormModel;
...
public class WFDynamicUserEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected WFDynamicUserMainEditFormModel editformModel = null;
    public WFDynamicUserEditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (WFDynamicUserMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected WFDynamicUserMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected String getGetEntityAction() {
        return WFDynamicUserService.ACTION_GET;
    }
    ...
    protected IEntity getDraftEntityFrom(Object objKeyValue)throws Exception {
        WFDynamicUser entity = new WFDynamicUser();
        entity.set(WFDynamicUser.FIELD_WFDYNAMICUSERID,objKeyValue);
        this.getRealService().executeAction(WFDynamicUserService.ACTION_GETDRAFTFROM,entity);
        return entity;
    }
