...
/**
 * 视图[OA_SBWXSBWXLC_D10_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXSBWXLC_D10_WFGridView.do")
public class OA_SBWXSBWXLC_D10_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_SBWXSBWXLC_D10_WFGridViewController() throws Exception {
        super();
        this.setId("88eabac2c3a484bdbd3e17c1f2fba228");
        this.setCaption("设备维修");
        this.setTitle("设备维修工作流表格视图(设备维修流程:未提交)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXSBWXLC_D10_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXSBWXLC_D10_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_D10_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_D10_WFGridViewSearchFormHandler");
        searchForm.init(this);
