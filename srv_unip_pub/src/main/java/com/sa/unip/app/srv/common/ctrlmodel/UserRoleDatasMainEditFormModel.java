...
/**
 * 实体[用户角色数据能力]编辑表单[form]部件模型
 */
public class UserRoleDatasMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserRoleDatasMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLEDATASID");
            formItem.setCaption("用户角色数据能力标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERROLEDATASID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLEDATASNAME");
            formItem.setCaption("用户角色数据能力名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERROLEDATASNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userrolename
        iFormItem = this.createFormItem("userrolename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userrolename");
            formItem.setDEFName("USERROLENAME");
            formItem.setEnableCond(1);
            formItem.setCaption("用户角色");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userrolename");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userroledatasid
        iFormItem = this.createFormItem("userroledatasid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroledatasid");
            formItem.setDEFName("USERROLEDATASID");
            formItem.setCaption("用户角色数据能力标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroledatasid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userroleid
        iFormItem = this.createFormItem("userroleid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroleid");
            formItem.setDEFName("USERROLEID");
            formItem.setEnableCond(1);
            formItem.setCaption("用户角色");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroleid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
