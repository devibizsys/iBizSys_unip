...
import com.sa.unip.app.srv.common.ctrlmodel.MsgTemplateMain2GridModel;
...
/**
 * 应用视图[MsgTemplateGridView]表格[grid]后台处理对象基类
 */
public class MsgTemplateGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgTemplateMain2GridModel gridModel = null;
    public MsgTemplateGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (MsgTemplateMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected MsgTemplateMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(MsgTemplate entity)throws Exception {
