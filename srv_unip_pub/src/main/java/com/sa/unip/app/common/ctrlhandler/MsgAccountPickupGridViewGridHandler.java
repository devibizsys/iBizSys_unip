...
/**
 * 应用视图[MsgAccountPickupGridView]表格[grid]后台处理对象基类
 */
public class MsgAccountPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgAccountMain2GridModel gridModel = null;
    public MsgAccountPickupGridViewGridHandler()  {
        super();
    }
