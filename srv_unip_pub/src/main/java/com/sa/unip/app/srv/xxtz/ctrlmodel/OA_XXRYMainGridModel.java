...
/**
 * 实体[消息人员]数据表格[grid]部件模型
 */
public class  OA_XXRYMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public OA_XXRYMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 消息人员名称
        iGridColumn = createGridColumn("oa_xxryname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("oa_xxryname");
            gridColumnModel.setDataItemName("oa_xxryname");
            gridColumnModel.setCaption("消息人员名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 oa_xxryname
        iGridDataItem = createGridDataItem("oa_xxryname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("oa_xxryname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 oa_xxryid
        iGridDataItem = createGridDataItem("oa_xxryid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("oa_xxryid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("OA_XXRYID");
            gridEditItem.setCaption("消息人员标识");
