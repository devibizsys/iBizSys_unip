...
import com.sa.unip.app.srv.common.ctrlmodel.DataSyncAgentMainGridModel;
...
/**
 * 应用视图[DataSyncAgentGridView]表格[grid]后台处理对象基类
 */
public class DataSyncAgentGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncAgentMainGridModel gridModel = null;
    public DataSyncAgentGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DataSyncAgentMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DataSyncAgentMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DataSyncAgent entity)throws Exception {
