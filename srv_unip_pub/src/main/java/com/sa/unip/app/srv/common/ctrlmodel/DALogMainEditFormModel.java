...
/**
 * 实体[DA日志]编辑表单[form]部件模型
 */
public class DALogMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DALogMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DALOG_ID");
            formItem.setEnableCond(2);
            formItem.setCaption("DA日志标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DALOG_NAME");
            formItem.setCaption("DA日志名称");
        ...
        this.registerFormItem(iFormItem);
        // dalog_name
        iFormItem = this.createFormItem("dalog_name");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dalog_name");
            formItem.setDEFName("DALOG_NAME");
            formItem.setCaption("DA日志名称");
        ...
        this.registerFormItem(iFormItem);
        // dalog_id
        iFormItem = this.createFormItem("dalog_id");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dalog_id");
            formItem.setDEFName("DALOG_ID");
            formItem.setEnableCond(2);
            formItem.setCaption("DA日志标识");
