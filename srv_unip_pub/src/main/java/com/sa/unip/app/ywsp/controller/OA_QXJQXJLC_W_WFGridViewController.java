...
/**
 * 视图[OA_QXJQXJLC_W_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJQXJLC_W_WFGridView.do")
public class OA_QXJQXJLC_W_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_QXJQXJLC_W_WFGridViewController() throws Exception {
        super();
        this.setId("e6cd455022827cc7badec065ef61561d");
        this.setCaption("请休假");
        this.setTitle("请休假工作流表格视图(请休假流程)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJQXJLC_W_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJQXJLC_W_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJQXJLC_W_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJQXJLC_W_WFGridViewSearchFormHandler");
        searchForm.init(this);
