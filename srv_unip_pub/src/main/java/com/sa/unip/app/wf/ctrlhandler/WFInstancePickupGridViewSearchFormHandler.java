...
public class WFInstancePickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFInstanceDefaultSearchFormModel searchformModel = null;
    public WFInstancePickupGridViewSearchFormHandler()  {
        super();
    }
