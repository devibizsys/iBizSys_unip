...
/**
 * 实体[日志人员]编辑表单[form]部件模型
 */
public class OA_RZRYMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_RZRYMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_RZRYID");
            formItem.setCaption("日志人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_RZRYID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.OA_RZRYNAME");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("OA_RZRYNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_rzryname
        iFormItem = this.createFormItem("oa_rzryname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_rzryname");
            formItem.setDEFName("OA_RZRYNAME");
            formItem.setCaption("日志人员名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_RZRYNAME");
        ...
        this.registerFormItem(iFormItem);
        // oa_rzryid
        iFormItem = this.createFormItem("oa_rzryid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_rzryid");
            formItem.setDEFName("OA_RZRYID");
            formItem.setCaption("日志人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_RZRYID");
