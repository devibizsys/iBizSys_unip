...
/**
 * 实体[采购申请]数据分页[drtab]部件模型
 */
public class  OA_CGSQCGSQLCDRDRTabModel extends net.ibizsys.paas.ctrlmodel.DRTabModelBase {

    public OA_CGSQCGSQLCDRDRTabModel()  {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem1.setViewParam("srfparentdeid","d5b99fe05938f9adcfc252174e25526e");
        //添加 流程催办
        ...
        drCtrlItem2.setViewParam("srfparentdeid","d5b99fe05938f9adcfc252174e25526e");
        //添加 流程跟踪
        ...
        drCtrlItem3.setViewParam("srfparentdeid","d5b99fe05938f9adcfc252174e25526e");
    }
}