...
/**
 * 视图[WFStepActorMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepActorMPickupView.do")
public class WFStepActorMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFStepActorMPickupViewController() throws Exception {
        super();
        this.setId("84fe37a22f05de7c6c5df0db6f7ce0ac");
        this.setCaption("工作流步骤操作者");
        this.setTitle("工作流步骤操作者实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFStepActorMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepActorMPickupViewController",this);
    }
