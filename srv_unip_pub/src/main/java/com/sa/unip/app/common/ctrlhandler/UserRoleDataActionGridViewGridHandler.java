...
import com.sa.unip.app.srv.common.ctrlmodel.UserRoleDataActionMainGridModel;
...
/**
 * 应用视图[UserRoleDataActionGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDataActionGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDataActionMainGridModel gridModel = null;
    public UserRoleDataActionGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserRoleDataActionMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserRoleDataActionMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserRoleDataAction entity)throws Exception {
