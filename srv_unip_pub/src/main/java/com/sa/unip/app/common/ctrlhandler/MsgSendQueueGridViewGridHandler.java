...
import com.sa.unip.app.srv.common.ctrlmodel.MsgSendQueueMain2GridModel;
...
/**
 * 应用视图[MsgSendQueueGridView]表格[grid]后台处理对象基类
 */
public class MsgSendQueueGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgSendQueueMain2GridModel gridModel = null;
    public MsgSendQueueGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (MsgSendQueueMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected MsgSendQueueMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(MsgSendQueue entity)throws Exception {
