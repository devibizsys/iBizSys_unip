...
public class OA_YBHYSQYBHYSQ_W50_WFEditView3DRTabHandler extends net.ibizsys.paas.ctrlhandler.DRTabHandlerBase {

    protected OA_YBHYSQYBHYSQDRDRTabModel drTabModel = null;
    public OA_YBHYSQYBHYSQ_W50_WFEditView3DRTabHandler()  {
        super();
    }
