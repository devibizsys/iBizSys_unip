...
/**
 * 视图[WFUserGroupDetailRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupDetailRedirectView.do")
public class WFUserGroupDetailRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFUserGroupDetailRedirectViewController() throws Exception {
        super();
        this.setId("934c594b3671933058f3177538bdd2e9");
        this.setCaption("工作流用户组成员");
        this.setTitle("工作流用户组成员实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupDetailRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupDetailRedirectViewController",this);
    }
