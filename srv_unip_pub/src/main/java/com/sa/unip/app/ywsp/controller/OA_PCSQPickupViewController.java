...
/**
 * 视图[OA_PCSQPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_PCSQPickupView.do")
public class OA_PCSQPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_PCSQPickupViewController() throws Exception {
        super();
        this.setId("389a207989d59018ffc5dac040a8fe3c");
        this.setCaption("派车申请");
        this.setTitle("派车申请数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_PCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_PCSQ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_PCSQPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_PCSQPickupViewController",this);
    }
