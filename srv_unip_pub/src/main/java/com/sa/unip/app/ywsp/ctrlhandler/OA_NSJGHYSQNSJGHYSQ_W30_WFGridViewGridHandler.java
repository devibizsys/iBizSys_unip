...
/**
 * 应用视图[OA_NSJGHYSQNSJGHYSQ_W30_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_NSJGHYSQNSJGHYSQ_W30_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_NSJGHYSQMainGridModel gridModel = null;
    public OA_NSJGHYSQNSJGHYSQ_W30_WFGridViewGridHandler()  {
        super();
    }
