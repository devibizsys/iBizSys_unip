...
/**
 * 应用视图[OA_STWMDGSTWMDGLC_D20_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_STWMDGSTWMDGLC_D20_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_STWMDGMainGridModel gridModel = null;
    public OA_STWMDGSTWMDGLC_D20_WFGridViewGridHandler()  {
        super();
    }
