...
public class WXMediaPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WXMediaDefaultSearchFormModel searchformModel = null;
    public WXMediaPickupGridViewSearchFormHandler()  {
        super();
    }
