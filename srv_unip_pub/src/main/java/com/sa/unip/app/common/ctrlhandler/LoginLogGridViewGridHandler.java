...
import com.sa.unip.app.srv.common.ctrlmodel.LoginLogMain2GridModel;
...
/**
 * 应用视图[LoginLogGridView]表格[grid]后台处理对象基类
 */
public class LoginLogGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected LoginLogMain2GridModel gridModel = null;
    public LoginLogGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (LoginLogMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected LoginLogMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(LoginLog entity)throws Exception {
