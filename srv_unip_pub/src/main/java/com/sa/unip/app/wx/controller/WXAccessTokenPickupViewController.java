...
/**
 * 视图[WXAccessTokenPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXAccessTokenPickupView.do")
public class WXAccessTokenPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WXAccessTokenPickupViewController() throws Exception {
        super();
        this.setId("f76b46b34cac596d04be1b18323aa529");
        this.setCaption("微信访问票据");
        this.setTitle("微信访问票据实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wx/WXAccessTokenPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXAccessTokenPickupViewController",this);
    }
