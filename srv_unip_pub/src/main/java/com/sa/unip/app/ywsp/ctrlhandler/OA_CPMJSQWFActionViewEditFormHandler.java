...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_CPMJSQSHYJFormEditFormModel;
...
public class OA_CPMJSQWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_CPMJSQSHYJFormEditFormModel editformModel = null;
    public OA_CPMJSQWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CPMJSQSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CPMJSQSHYJFormEditFormModel getRealEditFormModel() {
