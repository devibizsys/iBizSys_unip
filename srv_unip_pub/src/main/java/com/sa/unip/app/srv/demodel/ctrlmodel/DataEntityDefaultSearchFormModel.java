...
/**
 * 实体[实体]搜索表单[searchform]部件模型
 */
public class  DataEntityDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DataEntityDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_dename_like
        iFormItem = this.createFormItem("n_dename_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_dename_like");
            formItem.setDEFName("DENAME");
            formItem.setCaption("实体名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_dename_like");
