...
/**
 * 视图[OA_CLWXCLWXLC_W10_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CLWXCLWXLC_W10_WFGridView.do")
public class OA_CLWXCLWXLC_W10_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_CLWXCLWXLC_W10_WFGridViewController() throws Exception {
        super();
        this.setId("56800268c1fe78ecdd1163ff1ed38759");
        this.setCaption("车辆维修");
        this.setTitle("车辆维修工作流表格视图(车辆维修流程:部门领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CLWXCLWXLC_W10_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CLWXCLWXLC_W10_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXCLWXLC_W10_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXCLWXLC_W10_WFGridViewSearchFormHandler");
        searchForm.init(this);
