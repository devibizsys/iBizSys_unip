...
/**
 * 应用视图[PPModelPickupGridView]表格[grid]后台处理对象基类
 */
public class PPModelPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected PPModelMainGridModel gridModel = null;
    public PPModelPickupGridViewGridHandler()  {
        super();
    }
