...
/**
 * 实体[工作流工作列表]搜索表单[searchform]部件模型
 */
public class  WFWorkListDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WFWorkListDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_wfworklistname_like
        iFormItem = this.createFormItem("n_wfworklistname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_wfworklistname_like");
            formItem.setDEFName("WFWORKLISTNAME");
            formItem.setCaption("流程工作列表名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_wfworklistname_like");
