...
/**
 * 视图[OA_FLFGRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_FLFGRedirectView.do")
public class OA_FLFGRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_FLFGRedirectViewController() throws Exception {
        super();
        this.setId("8c6b6a5ab972861c17d0050a310a8d5c");
        this.setCaption("法律法规");
        this.setTitle("法律法规数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_FLFG");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/jcsj/OA_FLFGRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_FLFGRedirectViewController",this);
    }
