...
/**
 * 视图[UserRoleDataActionRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDataActionRedirectView.do")
public class UserRoleDataActionRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserRoleDataActionRedirectViewController() throws Exception {
        super();
        this.setId("e10fc86475fbb29bed01e1bd59b1c758");
        this.setCaption("用户角色数据操作");
        this.setTitle("用户角色数据操作实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDataActionRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDataActionRedirectViewController",this);
    }
