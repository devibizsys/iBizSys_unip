...
/**
 * 应用视图[OrgUserUX_GridView2]表格[grid]后台处理对象基类
 */
public class OrgUserUX_GridView2GridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserUX_Main2GridModel gridModel = null;
    public OrgUserUX_GridView2GridHandler()  {
        super();
    }
