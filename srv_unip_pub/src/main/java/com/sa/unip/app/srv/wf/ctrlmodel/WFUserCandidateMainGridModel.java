...
/**
 * 实体[工作流用户候选者]数据表格[grid]部件模型
 */
public class  WFUserCandidateMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFUserCandidateMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("工作流主用户");
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("工作流候选用户");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 候选次序
        iGridColumn = createGridColumn("candidateorder");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("candidateorder");
            gridColumnModel.setDataItemName("candidateorder");
            gridColumnModel.setCaption("候选次序");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wfusercandidateid
        iGridDataItem = createGridDataItem("wfusercandidateid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfusercandidateid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 candidateorder
        iGridDataItem = createGridDataItem("candidateorder");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("candidateorder");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("CANDIDATEORDER");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFUSERCANDIDATEID");
            gridEditItem.setCaption("工作流用户候选者标识");
