...
/**
 * 视图[UserDictCatGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserDictCatGridView.do")
public class UserDictCatGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public UserDictCatGridViewController() throws Exception {
        super();
        this.setId("bed60f3cd471ca04d825bff1dd249ab5");
        this.setCaption("用户词条类别");
        this.setTitle("用户词典类别实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserDictCatGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserDictCatGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserDictCatGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserDictCatGridViewSearchFormHandler");
        searchForm.init(this);
