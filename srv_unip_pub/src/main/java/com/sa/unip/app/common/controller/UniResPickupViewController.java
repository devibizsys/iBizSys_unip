...
/**
 * 视图[UniResPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UniResPickupView.do")
public class UniResPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UniResPickupViewController() throws Exception {
        super();
        this.setId("69689fcc2922a19df99b5e0eec4cc0d1");
        this.setCaption("统一资源");
        this.setTitle("统一资源实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UniResPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UniResPickupViewController",this);
    }
