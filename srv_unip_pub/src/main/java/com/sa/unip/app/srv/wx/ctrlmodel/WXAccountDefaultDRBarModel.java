...
/**
 * 实体[微信公众号]数据关系栏[drbar]部件模型
 */
public class  WXAccountDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WXAccountDefaultDRBarModel() {
        super();
    }
