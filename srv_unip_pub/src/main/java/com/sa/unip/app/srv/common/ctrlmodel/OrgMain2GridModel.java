...
/**
 * 实体[组织机构]数据表格[grid]部件模型
 */
public class  OrgMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public OrgMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("组织机构名称");
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("组织编号");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 上级机构
        iGridColumn = createGridColumn("porgname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("porgname");
            gridColumnModel.setDataItemName("porgname");
            gridColumnModel.setCaption("上级机构");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 porgid
        iGridDataItem = createGridDataItem("porgid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("porgid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("PORGID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 porgname
        iGridDataItem = createGridDataItem("porgname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("porgname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("PORGNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("ORGID");
            gridEditItem.setCaption("组织机构标识");
