...
/**
 * 视图[WFUserGroupRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupRedirectView.do")
public class WFUserGroupRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFUserGroupRedirectViewController() throws Exception {
        super();
        this.setId("29683023c83cc6226546cc67a4f966c3");
        this.setCaption("工作流用户组");
        this.setTitle("工作流用户组实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupRedirectViewController",this);
    }
