...
/**
 * 实体[工作流用户组成员]搜索表单[searchform]部件模型
 */
public class  WFUserGroupDetailDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WFUserGroupDetailDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_wfusergroupdetailname_like
        iFormItem = this.createFormItem("n_wfusergroupdetailname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_wfusergroupdetailname_like");
            formItem.setDEFName("WFUSERGROUPDETAILNAME");
            formItem.setCaption("工作流用户名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_wfusergroupdetailname_like");
