 ...
 * 树导航视图控件后台处理基类
 */
public class OrgUX_OrgSectorTreeExpViewTreeExpBarHandler extends net.ibizsys.paas.ctrlhandler.TreeExpBarHandlerBase {


    protected OrgtreeexpbarTreeExpBarModel treeExpBarModel = null;
    public OrgUX_OrgSectorTreeExpViewTreeExpBarHandler()  {
        super();
    }
