...
/**
 * 实体[数据对象能力]搜索表单[searchform]部件模型
 */
public class  UserRoleDataDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserRoleDataDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_userroledataname_like
        iFormItem = this.createFormItem("n_userroledataname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_userroledataname_like");
            formItem.setDEFName("USERROLEDATANAME");
            formItem.setCaption("能力名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_userroledataname_like");
