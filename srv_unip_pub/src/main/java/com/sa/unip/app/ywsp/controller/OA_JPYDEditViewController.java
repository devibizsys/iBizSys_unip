...
/**
 * 视图[OA_JPYDEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_JPYDEditView.do")
public class OA_JPYDEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_JPYDEditViewController() throws Exception {
        super();
        this.setId("520fc210514bb80efe5d361992f72ab6");
        this.setCaption("机票预订");
        this.setTitle("机票预订编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_JPYD");
        this.setTitleLanResTag("PAGE.TITLE.OA_JPYD.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_JPYDEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_JPYDEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDEditViewEditFormHandler");
        editForm.init(this);
