...
/**
 * 实体[调度任务项策略]编辑表单[form]部件模型
 */
public class TSSDTaskPolicyMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDTaskPolicyMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKPOLICYID");
            formItem.setEnableCond(0);
            formItem.setCaption("调度任务项策略标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKPOLICYNAME");
            formItem.setCaption("调度任务项策略名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdtaskpolicyname
        iFormItem = this.createFormItem("tssdtaskpolicyname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtaskpolicyname");
            formItem.setDEFName("TSSDTASKPOLICYNAME");
            formItem.setCaption("调度任务项策略名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdtaskpolicyname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdtaskpolicyid
        iFormItem = this.createFormItem("tssdtaskpolicyid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtaskpolicyid");
            formItem.setDEFName("TSSDTASKPOLICYID");
            formItem.setEnableCond(0);
            formItem.setCaption("调度任务项策略标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdtaskpolicyid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
