...
import com.sa.unip.app.srv.wf.ctrlmodel.WFAppSettingMainGridModel;
...
/**
 * 应用视图[WFAppSettingGridView]表格[grid]后台处理对象基类
 */
public class WFAppSettingGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFAppSettingMainGridModel gridModel = null;
    public WFAppSettingGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFAppSettingMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFAppSettingMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFAppSetting entity)throws Exception {
