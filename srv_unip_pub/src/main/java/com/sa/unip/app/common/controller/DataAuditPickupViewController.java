...
/**
 * 视图[DataAuditPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataAuditPickupView.do")
public class DataAuditPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DataAuditPickupViewController() throws Exception {
        super();
        this.setId("a55a59476d2fbe3d27a6e6f58d2415fd");
        this.setCaption("数据审计");
        this.setTitle("数据审计实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataAuditPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataAuditPickupViewController",this);
    }
