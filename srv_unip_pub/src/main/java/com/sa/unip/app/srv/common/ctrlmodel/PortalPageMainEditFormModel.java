...
/**
 * 实体[门户页面]编辑表单[form]部件模型
 */
public class PortalPageMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public PortalPageMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // portalpagename
        iFormItem = this.createFormItem("portalpagename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("portalpagename");
            formItem.setDEFName("PORTALPAGENAME");
            formItem.setCaption("门户页面名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("portalpagename");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
