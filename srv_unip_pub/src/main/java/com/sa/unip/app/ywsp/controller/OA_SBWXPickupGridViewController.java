...
/**
 * 视图[OA_SBWXPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXPickupGridView.do")
public class OA_SBWXPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_SBWXPickupGridViewController() throws Exception {
        super();
        this.setId("04af19cc324fc4f4bc222de28b8886ed");
        this.setCaption("设备维修");
        this.setTitle("设备维修选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_SBWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_SBWX.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXPickupGridViewSearchFormHandler");
        searchForm.init(this);
