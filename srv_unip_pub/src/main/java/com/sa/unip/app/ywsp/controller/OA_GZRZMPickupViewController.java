...
/**
 * 视图[OA_GZRZMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_GZRZMPickupView.do")
public class OA_GZRZMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_GZRZMPickupViewController() throws Exception {
        super();
        this.setId("61caf688e9f69426beda34f864cb9e84");
        this.setCaption("工作日志");
        this.setTitle("工作日志数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_GZRZMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_GZRZMPickupViewController",this);
    }
