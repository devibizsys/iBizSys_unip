...
/**
 * 应用视图[OA_YBHYSQYBHYSQ_D10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_YBHYSQYBHYSQ_D10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_YBHYSQMainGridModel gridModel = null;
    public OA_YBHYSQYBHYSQ_D10_WFGridViewGridHandler()  {
        super();
    }
