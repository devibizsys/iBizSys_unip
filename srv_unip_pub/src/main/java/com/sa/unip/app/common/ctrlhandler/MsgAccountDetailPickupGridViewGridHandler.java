...
/**
 * 应用视图[MsgAccountDetailPickupGridView]表格[grid]后台处理对象基类
 */
public class MsgAccountDetailPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgAccountDetailMainGridModel gridModel = null;
    public MsgAccountDetailPickupGridViewGridHandler()  {
        super();
    }
