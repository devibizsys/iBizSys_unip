...
/**
 * 应用视图[WFStepInstGridView]表格[grid]后台处理对象基类
 */
public class WFStepInstGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepInstMainGridModel gridModel = null;
    public WFStepInstGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFStepInst entity)throws Exception {
