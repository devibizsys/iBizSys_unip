...
/**
 * 视图[OA_YYSSQYYSSQ_D_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YYSSQYYSSQ_D_WFGridView.do")
public class OA_YYSSQYYSSQ_D_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_YYSSQYYSSQ_D_WFGridViewController() throws Exception {
        super();
        this.setId("82fdadf0c371be9cd89455ddca08f929");
        this.setCaption("饮用水申请");
        this.setTitle("饮用水申请工作流表格视图(饮用水申请流程)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YYSSQYYSSQ_D_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YYSSQYYSSQ_D_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YYSSQYYSSQ_D_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YYSSQYYSSQ_D_WFGridViewSearchFormHandler");
        searchForm.init(this);
