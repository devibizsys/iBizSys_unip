...
/**
 * 应用视图[OA_GZRZRZTJLC_D_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_GZRZRZTJLC_D_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_GZRZMainGridModel gridModel = null;
    public OA_GZRZRZTJLC_D_WFGridViewGridHandler()  {
        super();
    }
