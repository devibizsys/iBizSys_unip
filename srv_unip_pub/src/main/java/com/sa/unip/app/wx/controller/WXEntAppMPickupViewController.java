...
/**
 * 视图[WXEntAppMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXEntAppMPickupView.do")
public class WXEntAppMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WXEntAppMPickupViewController() throws Exception {
        super();
        this.setId("f1d1fce6b5de229290e098e1386812db");
        this.setCaption("微信企业应用");
        this.setTitle("微信企业应用实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wx/WXEntAppMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXEntAppMPickupViewController",this);
    }
