...
import com.sa.unip.app.srv.common.ctrlmodel.DataSyncOut2MainGridModel;
...
/**
 * 应用视图[DataSyncOut2GridView]表格[grid]后台处理对象基类
 */
public class DataSyncOut2GridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncOut2MainGridModel gridModel = null;
    public DataSyncOut2GridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DataSyncOut2MainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DataSyncOut2MainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DataSyncOut2 entity)throws Exception {
