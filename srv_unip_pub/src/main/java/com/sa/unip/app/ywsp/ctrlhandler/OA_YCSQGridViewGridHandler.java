...
/**
 * 应用视图[OA_YCSQGridView]表格[grid]后台处理对象基类
 */
public class OA_YCSQGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_YCSQMainGridModel gridModel = null;
    public OA_YCSQGridViewGridHandler()  {
        super();
    }
