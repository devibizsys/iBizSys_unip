...
/**
 * 视图[OA_CPMJSQMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CPMJSQMPickupView.do")
public class OA_CPMJSQMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_CPMJSQMPickupViewController() throws Exception {
        super();
        this.setId("ffde84096a6ded198d8e83471c7eb997");
        this.setCaption("车牌门禁申请");
        this.setTitle("车牌门禁申请数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_CPMJSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CPMJSQ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CPMJSQMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CPMJSQMPickupViewController",this);
    }
