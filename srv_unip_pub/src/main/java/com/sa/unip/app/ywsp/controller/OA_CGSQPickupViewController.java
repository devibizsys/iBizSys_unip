...
/**
 * 视图[OA_CGSQPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CGSQPickupView.do")
public class OA_CGSQPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_CGSQPickupViewController() throws Exception {
        super();
        this.setId("a8ce30026b29e23b98df69b5edb5d1a5");
        this.setCaption("采购申请");
        this.setTitle("采购申请数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_CGSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CGSQ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CGSQPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CGSQPickupViewController",this);
    }
