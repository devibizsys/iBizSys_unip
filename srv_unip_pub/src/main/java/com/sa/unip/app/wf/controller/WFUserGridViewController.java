...
/**
 * 视图[WFUserGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGridView.do")
public class WFUserGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFUserGridViewController() throws Exception {
        super();
        this.setId("8153a96cf1985100aaf4e08f69d736c6");
        this.setCaption("工作流用户");
        this.setTitle("工作流用户实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUserGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 grid
        ICtrlModel grid=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.wf.ctrlmodel.WFUserJQMainGridModel");
        grid.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGridViewSearchFormHandler");
        searchForm.init(this);
