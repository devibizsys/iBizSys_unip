...
/**
 * 实体[系统]编辑表单[form]部件模型
 */
public class SystemMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public SystemMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SYSTEMID");
            formItem.setEnableCond(0);
            formItem.setCaption("系统标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SYSTEMNAME");
            formItem.setCaption("系统名称");
        ...
        this.registerFormItem(iFormItem);
        // systemname
        iFormItem = this.createFormItem("systemname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("systemname");
            formItem.setDEFName("SYSTEMNAME");
            formItem.setCaption("系统名称");
        ...
        this.registerFormItem(iFormItem);
        // systemid
        iFormItem = this.createFormItem("systemid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("systemid");
            formItem.setDEFName("SYSTEMID");
            formItem.setEnableCond(0);
            formItem.setCaption("系统标识");
