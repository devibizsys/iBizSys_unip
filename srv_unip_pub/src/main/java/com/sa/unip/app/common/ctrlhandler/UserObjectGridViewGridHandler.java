...
import com.sa.unip.app.srv.common.ctrlmodel.UserObjectMain2GridModel;
...
/**
 * 应用视图[UserObjectGridView]表格[grid]后台处理对象基类
 */
public class UserObjectGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserObjectMain2GridModel gridModel = null;
    public UserObjectGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserObjectMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserObjectMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserObject entity)throws Exception {
