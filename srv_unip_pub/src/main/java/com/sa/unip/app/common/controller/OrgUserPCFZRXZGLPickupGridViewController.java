...
/**
 * 视图[OrgUserPCFZRXZGLPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserPCFZRXZGLPickupGridView.do")
public class OrgUserPCFZRXZGLPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OrgUserPCFZRXZGLPickupGridViewController() throws Exception {
        super();
        this.setId("b810d9b36c61988151165e3c2af69ec8");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体选择表格过滤视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserPCFZRXZGLPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserPCFZRXZGLPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserPCFZRXZGLPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserPCFZRXZGLPickupGridViewSearchFormHandler");
        searchForm.init(this);
