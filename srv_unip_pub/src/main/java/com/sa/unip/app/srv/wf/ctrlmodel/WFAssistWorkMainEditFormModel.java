...
/**
 * 实体[工作流代办工作]编辑表单[form]部件模型
 */
public class WFAssistWorkMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFAssistWorkMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFASSISTWORKID");
            formItem.setEnableCond(0);
            formItem.setCaption("工作流代办工作标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFASSISTWORKNAME");
            formItem.setCaption("工作流代办工作名称");
        ...
        this.registerFormItem(iFormItem);
        // wfassistworkname
        iFormItem = this.createFormItem("wfassistworkname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfassistworkname");
            formItem.setDEFName("WFASSISTWORKNAME");
            formItem.setCaption("工作流代办工作名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfassistworkname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfassistworkid
        iFormItem = this.createFormItem("wfassistworkid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfassistworkid");
            formItem.setDEFName("WFASSISTWORKID");
            formItem.setEnableCond(0);
            formItem.setCaption("工作流代办工作标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfassistworkid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
