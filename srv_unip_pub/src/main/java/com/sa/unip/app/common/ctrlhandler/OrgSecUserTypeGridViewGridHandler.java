...
import com.sa.unip.app.srv.common.ctrlmodel.OrgSecUserTypeMain2GridModel;
...
/**
 * 应用视图[OrgSecUserTypeGridView]表格[grid]后台处理对象基类
 */
public class OrgSecUserTypeGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSecUserTypeMain2GridModel gridModel = null;
    public OrgSecUserTypeGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgSecUserTypeMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgSecUserTypeMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OrgSecUserType entity)throws Exception {
