...
/**
 * 实体[任务时刻策略所有者]数据关系栏[drbar]部件模型
 */
public class  TSSDPolicyOwnerDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDPolicyOwnerDefaultDRBarModel() {
        super();
    }
