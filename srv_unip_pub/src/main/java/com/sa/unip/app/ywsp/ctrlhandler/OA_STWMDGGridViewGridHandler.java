...
/**
 * 应用视图[OA_STWMDGGridView]表格[grid]后台处理对象基类
 */
public class OA_STWMDGGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_STWMDGMainGridModel gridModel = null;
    public OA_STWMDGGridViewGridHandler()  {
        super();
    }
