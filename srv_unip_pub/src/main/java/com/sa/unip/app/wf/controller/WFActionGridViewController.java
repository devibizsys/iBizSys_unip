...
/**
 * 视图[WFActionGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFActionGridView.do")
public class WFActionGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFActionGridViewController() throws Exception {
        super();
        this.setId("5ec933d358a2066baaf4597fef248f82");
        this.setCaption("工作流用户操作");
        this.setTitle("工作流用户操作实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFActionGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFActionGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFActionGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFActionGridViewSearchFormHandler");
        searchForm.init(this);
