...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserUX_Form_OrgUserEditFormModel;
...
public class OrgUserUX_EditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OrgUserUX_Form_OrgUserEditFormModel editformModel = null;
    public OrgUserUX_EditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OrgUserUX_Form_OrgUserEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OrgUserUX_Form_OrgUserEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.OrgUserUX_Form_OrgUserEditFormOrgsectornameHandler");
        ...
        IFormItemHandler orgsecusertypenameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.OrgUserUX_Form_OrgUserEditFormOrgsecusertypenameHandler");
        ...
        //注册 'orguserlevelname'
        IFormItemHandler orguserlevelnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.OrgUserUX_Form_OrgUserEditFormOrguserlevelnameHandler");
