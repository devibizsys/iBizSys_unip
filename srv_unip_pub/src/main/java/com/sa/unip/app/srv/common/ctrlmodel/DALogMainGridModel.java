...
/**
 * 实体[DA日志]数据表格[grid]部件模型
 */
public class  DALogMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public DALogMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.DALogDEModel dALogDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.DALogDEModel getDALogDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 DA日志名称
        iGridColumn = createGridColumn("dalog_name");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("dalog_name");
            gridColumnModel.setDataItemName("dalog_name");
            gridColumnModel.setCaption("DA日志名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 dalog_id
        iGridDataItem = createGridDataItem("dalog_id");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dalog_id");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DALOG_ID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 dalog_name
        iGridDataItem = createGridDataItem("dalog_name");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dalog_name");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DALOG_NAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("DALOG_ID");
            gridEditItem.setEnableCond(2);
            gridEditItem.setCaption("DA日志标识");
