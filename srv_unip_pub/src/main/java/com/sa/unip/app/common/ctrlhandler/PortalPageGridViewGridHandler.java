...
import com.sa.unip.app.srv.common.ctrlmodel.PortalPageMainGridModel;
...
/**
 * 应用视图[PortalPageGridView]表格[grid]后台处理对象基类
 */
public class PortalPageGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected PortalPageMainGridModel gridModel = null;
    public PortalPageGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (PortalPageMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected PortalPageMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(PortalPage entity)throws Exception {
