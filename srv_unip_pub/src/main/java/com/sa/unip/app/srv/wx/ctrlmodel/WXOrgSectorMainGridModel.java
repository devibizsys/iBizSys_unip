...
/**
 * 实体[微信部门]数据表格[grid]部件模型
 */
public class  WXOrgSectorMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WXOrgSectorMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 微信部门名称
        iGridColumn = createGridColumn("wxorgsectorname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("wxorgsectorname");
            gridColumnModel.setDataItemName("wxorgsectorname");
            gridColumnModel.setCaption("微信部门名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wxorgsectorid
        iGridDataItem = createGridDataItem("wxorgsectorid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxorgsectorid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wxorgsectorname
        iGridDataItem = createGridDataItem("wxorgsectorname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxorgsectorname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WXORGSECTORID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("微信部门标识");
