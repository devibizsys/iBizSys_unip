...
/**
 * 实体[工作流操作界面]编辑表单[form]部件模型
 */
public class WFUIWizardMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUIWizardMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.wf.demodel.WFUIWizardDEModel wFUIWizardDEModel;
    protected  net.ibizsys.psrt.srv.wf.demodel.WFUIWizardDEModel getWFUIWizardDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUIWIZARDID");
            formItem.setEnableCond(0);
            formItem.setCaption("工作流操作界面标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUIWIZARDID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUIWIZARDNAME");
            formItem.setCaption("工作流操作界面名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUIWIZARDNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfuiwizardname
        iFormItem = this.createFormItem("wfuiwizardname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfuiwizardname");
            formItem.setDEFName("WFUIWIZARDNAME");
            formItem.setCaption("工作流操作界面名称");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfuiwizardname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfuiwizardid
        iFormItem = this.createFormItem("wfuiwizardid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfuiwizardid");
            formItem.setDEFName("WFUIWIZARDID");
            formItem.setEnableCond(0);
            formItem.setCaption("工作流操作界面标识");
