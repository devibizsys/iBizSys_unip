...
/**
 * 视图[TSSDTaskPolicyRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskPolicyRedirectView.do")
public class TSSDTaskPolicyRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public TSSDTaskPolicyRedirectViewController() throws Exception {
        super();
        this.setId("99ade7cca921b6ebf9b42ee5b8ed2b90");
        this.setCaption("调度任务项策略");
        this.setTitle("调度任务项策略实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskPolicyRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskPolicyRedirectViewController",this);
    }
