...
/**
 * 视图[WXAccountPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXAccountPickupView.do")
public class WXAccountPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WXAccountPickupViewController() throws Exception {
        super();
        this.setId("07568c2bb0b14f40757b50f0c2c43635");
        this.setCaption("微信公众号");
        this.setTitle("微信公众号实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wx/WXAccountPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXAccountPickupViewController",this);
    }
