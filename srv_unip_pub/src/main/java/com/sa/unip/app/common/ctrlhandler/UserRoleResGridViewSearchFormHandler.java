...
public class UserRoleResGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected UserRoleResDefaultSearchFormModel searchformModel = null;
    public UserRoleResGridViewSearchFormHandler()  {
        super();
    }
