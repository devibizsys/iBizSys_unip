...
/**
 * 应用视图[WFStepPickupGridView]表格[grid]后台处理对象基类
 */
public class WFStepPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepMainGridModel gridModel = null;
    public WFStepPickupGridViewGridHandler()  {
        super();
    }
