...
/**
 * 实体[消息人员]编辑表单[form]部件模型
 */
public class OA_XXRYMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_XXRYMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_XXRYID");
            formItem.setCaption("消息人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_XXRYID");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("OA_XXRYID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_XXRYNAME");
            formItem.setCaption("消息人员名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_XXRYNAME");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("OA_XXRYNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_xxryname
        iFormItem = this.createFormItem("oa_xxryname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_xxryname");
            formItem.setDEFName("OA_XXRYNAME");
            formItem.setCaption("消息人员名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_XXRYNAME");
        ...
        this.registerFormItem(iFormItem);
        // oa_xxryid
        iFormItem = this.createFormItem("oa_xxryid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_xxryid");
            formItem.setDEFName("OA_XXRYID");
            formItem.setCaption("消息人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_XXRYID");
