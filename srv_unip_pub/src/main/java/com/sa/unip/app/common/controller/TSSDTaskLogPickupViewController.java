...
/**
 * 视图[TSSDTaskLogPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskLogPickupView.do")
public class TSSDTaskLogPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public TSSDTaskLogPickupViewController() throws Exception {
        super();
        this.setId("6f68482a08d046c2cb47050c8acfa717");
        this.setCaption("任务调度日志");
        this.setTitle("任务调度日志实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskLogPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskLogPickupViewController",this);
    }
