...
/**
 * 视图[OA_NSJGHYSQNSJGHYSQ_WFExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_NSJGHYSQNSJGHYSQ_WFExpView.do")
public class OA_NSJGHYSQNSJGHYSQ_WFExpViewController extends net.ibizsys.pswf.controller.WFExpViewControllerBase {
    public OA_NSJGHYSQNSJGHYSQ_WFExpViewController() throws Exception {
        super();
        this.setId("b6f56c9976e21eb00f56c87550c65384");
        this.setCaption("内设机构会议申请");
        this.setTitle("内设机构会议申请工作流导航视图(内设机构会议申请)");
        this.setCapLanResTag("DE.LNAME.OA_NSJGHYSQ");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.EXPBAR","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_NSJGHYSQNSJGHYSQ_WFExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_NSJGHYSQNSJGHYSQ_WFExpViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 expbar
        ICtrlModel expBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_NSJGHYSQexpbarWFExpBarModel");
        expBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 expbar
        ICtrlHandler expBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_NSJGHYSQNSJGHYSQ_WFExpViewExpBarHandler");
        expBar.init(this);
