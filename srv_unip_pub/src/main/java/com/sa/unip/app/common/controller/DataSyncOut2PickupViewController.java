...
/**
 * 视图[DataSyncOut2PickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncOut2PickupView.do")
public class DataSyncOut2PickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DataSyncOut2PickupViewController() throws Exception {
        super();
        this.setId("1cc0b0953917f579272be515da3472a8");
        this.setCaption("数据同步发送队列2");
        this.setTitle("数据同步发送队列2实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataSyncOut2PickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncOut2PickupViewController",this);
    }
