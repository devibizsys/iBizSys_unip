...
/**
 * 实体[任务时刻策略项]编辑表单[form]部件模型
 */
public class TSSDItemMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDItemMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDITEMID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略项标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDITEMNAME");
            formItem.setCaption("任务时刻策略项");
        ...
        this.registerFormItem(iFormItem);
        // tssditemname
        iFormItem = this.createFormItem("tssditemname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssditemname");
            formItem.setDEFName("TSSDITEMNAME");
            formItem.setCaption("任务时刻策略项");
        ...
        this.registerFormItem(iFormItem);
        // tssditemid
        iFormItem = this.createFormItem("tssditemid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssditemid");
            formItem.setDEFName("TSSDITEMID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略项标识");
