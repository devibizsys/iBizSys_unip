...
/**
 * 应用视图[OrgSecUserTypePickupGridView]表格[grid]后台处理对象基类
 */
public class OrgSecUserTypePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSecUserTypeMain2GridModel gridModel = null;
    public OrgSecUserTypePickupGridViewGridHandler()  {
        super();
    }
