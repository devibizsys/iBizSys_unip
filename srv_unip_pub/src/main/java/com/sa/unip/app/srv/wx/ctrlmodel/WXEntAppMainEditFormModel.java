...
/**
 * 实体[微信企业应用]编辑表单[form]部件模型
 */
public class WXEntAppMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WXEntAppMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXENTAPPID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信企业应用标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXENTAPPNAME");
            formItem.setCaption("微信企业应用名称");
        ...
        this.registerFormItem(iFormItem);
        // wxaccountname
        iFormItem = this.createFormItem("wxaccountname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxaccountname");
            formItem.setDEFName("WXACCOUNTNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("公众号");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxaccountname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxentappname
        iFormItem = this.createFormItem("wxentappname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxentappname");
            formItem.setDEFName("WXENTAPPNAME");
            formItem.setCaption("应用名称");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxentappname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // apptype
        iFormItem = this.createFormItem("apptype");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("apptype");
            formItem.setDEFName("APPTYPE");
            formItem.setCodeListId("com.sa.unip.srv.codelist.WXEntAppTypeCodeListModel");
            formItem.setCaption("应用类型");
            formItem.setAllowEmpty(false);
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("apptype");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // agentid
        iFormItem = this.createFormItem("agentid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("agentid");
            formItem.setDEFName("AGENTID");
            formItem.setCaption("Agentid");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("agentid");
        ...
        this.registerFormItem(iFormItem);
        // apiappsecret
        iFormItem = this.createFormItem("apiappsecret");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("apiappsecret");
            formItem.setDEFName("APIAPPSECRET");
            formItem.setCaption("Secret");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("apiappsecret");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // apitoken
        iFormItem = this.createFormItem("apitoken");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("apitoken");
            formItem.setDEFName("APITOKEN");
            formItem.setCaption("Token");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("apitoken");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // apiencodingaeskey
        iFormItem = this.createFormItem("apiencodingaeskey");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("apiencodingaeskey");
            formItem.setDEFName("APIENCODINGAESKEY");
            formItem.setCaption("EncodingAESKey");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("apiencodingaeskey");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // apiurl
        iFormItem = this.createFormItem("apiurl");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("apiurl");
            formItem.setDEFName("APIURL");
            formItem.setCaption("消息API地址");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("apiurl");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // repenterflag
        iFormItem = this.createFormItem("repenterflag");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("repenterflag");
            formItem.setDEFName("REPENTERFLAG");
            formItem.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
            formItem.setCaption("上报进入应用事件");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("repenterflag");
            dataItem.setDataType(9);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // replocationflag
        iFormItem = this.createFormItem("replocationflag");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("replocationflag");
            formItem.setDEFName("REPLOCATIONFLAG");
            formItem.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
            formItem.setCaption("上报地理位置");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("replocationflag");
            dataItem.setDataType(9);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // appurl
        iFormItem = this.createFormItem("appurl");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("appurl");
            formItem.setDEFName("APPURL");
            formItem.setCaption("应用首页");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("appurl");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxaccountid
        iFormItem = this.createFormItem("wxaccountid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxaccountid");
            formItem.setDEFName("WXACCOUNTID");
            formItem.setEnableCond(1);
            formItem.setCaption("微信公众号");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxaccountid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxentappid
        iFormItem = this.createFormItem("wxentappid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxentappid");
            formItem.setDEFName("WXENTAPPID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信企业应用标识");
