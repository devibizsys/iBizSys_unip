...
/**
 * 视图[OA_NSJGHYSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_NSJGHYSQEditView.do")
public class OA_NSJGHYSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_NSJGHYSQEditViewController() throws Exception {
        super();
        this.setId("47fff81c371a1b66d8965c0892991a93");
        this.setCaption("内设机构会议申请");
        this.setTitle("内设机构会议申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_NSJGHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_NSJGHYSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_NSJGHYSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_NSJGHYSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_NSJGHYSQEditViewEditFormHandler");
        editForm.init(this);
