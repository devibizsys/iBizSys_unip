...
/**
 * 视图[OA_QXJWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJWFActionView.do")
public class OA_QXJWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_QXJWFActionViewController() throws Exception {
        super();
        this.setId("268c4781162a760841e0df7e19453ea2");
        this.setCaption("请休假");
        this.setTitle("审意见");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_QXJSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJWFActionViewEditFormHandler");
        editForm.init(this);
