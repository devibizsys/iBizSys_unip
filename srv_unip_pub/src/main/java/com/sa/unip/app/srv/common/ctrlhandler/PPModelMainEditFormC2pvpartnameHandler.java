...
public class PPModelMainEditFormC2pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelMainEditFormC2pvpartnameHandler()  {
        super();
    }
