...
/**
 * 实体[文件]搜索表单[searchform]部件模型
 */
public class  FileDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public FileDefaultSearchFormModel() {
        super();
