...
/**
 * 实体[工作流用户代办]数据关系栏[drbar]部件模型
 */
public class  WFUserAssistDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFUserAssistDefaultDRBarModel() {
        super();
    }
