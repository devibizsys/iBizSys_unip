...
public class OA_TZGGTZGGSQLC_D_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_TZGGDefaultSearchFormModel searchformModel = null;
    public OA_TZGGTZGGSQLC_D_WFGridViewSearchFormHandler()  {
        super();
    }
