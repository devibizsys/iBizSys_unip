...
/**
 * 应用视图[UserRoleDataActionPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDataActionPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDataActionMainGridModel gridModel = null;
    public UserRoleDataActionPickupGridViewGridHandler()  {
        super();
    }
