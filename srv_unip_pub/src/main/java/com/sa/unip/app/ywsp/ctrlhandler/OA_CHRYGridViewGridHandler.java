...
/**
 * 应用视图[OA_CHRYGridView]表格[grid]后台处理对象基类
 */
public class OA_CHRYGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CHRYMainGridModel gridModel = null;
    public OA_CHRYGridViewGridHandler()  {
        super();
    }
