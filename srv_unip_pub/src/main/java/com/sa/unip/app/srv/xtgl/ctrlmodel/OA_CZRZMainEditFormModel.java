...
/**
 * 实体[操作日志]编辑表单[form]部件模型
 */
public class OA_CZRZMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_CZRZMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_CZRZID");
            formItem.setCaption("操作日志标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_CZRZID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.OA_CZRZNAME");
        ...
        this.registerFormItem(iFormItem);
        // oa_czrzname
        iFormItem = this.createFormItem("oa_czrzname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_czrzname");
            formItem.setDEFName("OA_CZRZNAME");
            formItem.setCaption("操作日志名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_CZRZNAME");
        ...
        this.registerFormItem(iFormItem);
        // oa_czrzid
        iFormItem = this.createFormItem("oa_czrzid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_czrzid");
            formItem.setDEFName("OA_CZRZID");
            formItem.setCaption("操作日志标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_CZRZID");
