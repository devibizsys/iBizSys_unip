...
/**
 * 应用视图[OA_PCSQGridView]表格[grid]后台处理对象基类
 */
public class OA_PCSQGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_PCSQMainGridModel gridModel = null;
    public OA_PCSQGridViewGridHandler()  {
        super();
    }
