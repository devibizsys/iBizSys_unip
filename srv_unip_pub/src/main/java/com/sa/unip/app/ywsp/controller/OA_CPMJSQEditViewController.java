...
/**
 * 视图[OA_CPMJSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CPMJSQEditView.do")
public class OA_CPMJSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_CPMJSQEditViewController() throws Exception {
        super();
        this.setId("44aa242e0c6292b79e348751b4aba0c9");
        this.setCaption("车牌门禁申请");
        this.setTitle("车牌门禁申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_CPMJSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CPMJSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CPMJSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CPMJSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CPMJSQEditViewEditFormHandler");
        editForm.init(this);
