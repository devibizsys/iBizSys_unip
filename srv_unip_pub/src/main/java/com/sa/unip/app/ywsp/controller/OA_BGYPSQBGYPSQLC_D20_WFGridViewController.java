...
/**
 * 视图[OA_BGYPSQBGYPSQLC_D20_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQBGYPSQLC_D20_WFGridView.do")
public class OA_BGYPSQBGYPSQLC_D20_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_BGYPSQBGYPSQLC_D20_WFGridViewController() throws Exception {
        super();
        this.setId("60eb90606934133e04da5242273117a9");
        this.setCaption("办公用品申请");
        this.setTitle("办公用品申请工作流表格视图(办公用品申领流程:审核中)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQBGYPSQLC_D20_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQBGYPSQLC_D20_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQBGYPSQLC_D20_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQBGYPSQLC_D20_WFGridViewSearchFormHandler");
        searchForm.init(this);
