...
/**
 * 应用视图[DEDataChgPickupGridView]表格[grid]后台处理对象基类
 */
public class DEDataChgPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DEDataChgMainGridModel gridModel = null;
    public DEDataChgPickupGridViewGridHandler()  {
        super();
    }
