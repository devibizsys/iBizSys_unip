...
/**
 * 视图[TSSDPolicyOwnerRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDPolicyOwnerRedirectView.do")
public class TSSDPolicyOwnerRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public TSSDPolicyOwnerRedirectViewController() throws Exception {
        super();
        this.setId("21f28e73f7b2fd8d9632fc654bc19da1");
        this.setCaption("任务时刻策略所有者");
        this.setTitle("任务时刻策略所有者实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/TSSDPolicyOwnerRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDPolicyOwnerRedirectViewController",this);
    }
