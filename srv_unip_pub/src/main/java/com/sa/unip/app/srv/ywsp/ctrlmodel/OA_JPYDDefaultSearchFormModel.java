...
/**
 * 实体[机票预订]搜索表单[searchform]部件模型
 */
public class  OA_JPYDDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OA_JPYDDefaultSearchFormModel() {
        super();
