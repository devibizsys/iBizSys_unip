...
/**
 * 视图[DataSyncIn2PickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncIn2PickupView.do")
public class DataSyncIn2PickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DataSyncIn2PickupViewController() throws Exception {
        super();
        this.setId("10dc714879855881305699d54c142143");
        this.setCaption("数据同步接收队列2");
        this.setTitle("数据同步接收队列2实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataSyncIn2PickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncIn2PickupViewController",this);
    }
