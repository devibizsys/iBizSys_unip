...
/**
 * 视图[WFUserCandidateRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserCandidateRedirectView.do")
public class WFUserCandidateRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFUserCandidateRedirectViewController() throws Exception {
        super();
        this.setId("8b4c2b1ff0c328851ffd738bfb0ffd98");
        this.setCaption("工作流用户候选者");
        this.setTitle("工作流用户候选者实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFUserCandidateRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserCandidateRedirectViewController",this);
    }
