...
/**
 * 实体[消息账户]数据关系栏[drbar]部件模型
 */
public class  MsgAccountDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public MsgAccountDefaultDRBarModel() {
        super();
    }
