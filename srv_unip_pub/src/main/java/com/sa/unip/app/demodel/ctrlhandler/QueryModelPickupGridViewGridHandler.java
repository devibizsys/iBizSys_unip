...
/**
 * 应用视图[QueryModelPickupGridView]表格[grid]后台处理对象基类
 */
public class QueryModelPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected QueryModelMainGridModel gridModel = null;
    public QueryModelPickupGridViewGridHandler()  {
        super();
    }
