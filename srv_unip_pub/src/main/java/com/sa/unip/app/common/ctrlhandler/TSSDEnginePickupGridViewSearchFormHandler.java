...
public class TSSDEnginePickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected TSSDEngineDefaultSearchFormModel searchformModel = null;
    public TSSDEnginePickupGridViewSearchFormHandler()  {
        super();
    }
