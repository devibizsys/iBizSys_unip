...
public class PPModelUserMainEditFormL4pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormL4pvpartnameHandler()  {
        super();
    }
