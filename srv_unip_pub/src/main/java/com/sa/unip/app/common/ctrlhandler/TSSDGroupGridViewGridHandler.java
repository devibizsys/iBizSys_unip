...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDGroupMainGridModel;
...
/**
 * 应用视图[TSSDGroupGridView]表格[grid]后台处理对象基类
 */
public class TSSDGroupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDGroupMainGridModel gridModel = null;
    public TSSDGroupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDGroupMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDGroupMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDGroup entity)throws Exception {
