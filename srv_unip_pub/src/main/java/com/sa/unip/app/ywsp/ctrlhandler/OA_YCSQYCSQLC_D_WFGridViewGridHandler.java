...
/**
 * 应用视图[OA_YCSQYCSQLC_D_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_YCSQYCSQLC_D_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_YCSQMainGridModel gridModel = null;
    public OA_YCSQYCSQLC_D_WFGridViewGridHandler()  {
        super();
    }
