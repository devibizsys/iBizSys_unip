...
/**
 * 实体[注册表]搜索表单[searchform]部件模型
 */
public class  RegistryDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public RegistryDefaultSearchFormModel() {
        super();
