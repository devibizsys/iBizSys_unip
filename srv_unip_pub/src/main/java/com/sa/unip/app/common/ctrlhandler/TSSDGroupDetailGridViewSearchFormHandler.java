...
public class TSSDGroupDetailGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected TSSDGroupDetailDefaultSearchFormModel searchformModel = null;
    public TSSDGroupDetailGridViewSearchFormHandler()  {
        super();
    }
