...
/**
 * 视图[DataSyncOut2MPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncOut2MPickupView.do")
public class DataSyncOut2MPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public DataSyncOut2MPickupViewController() throws Exception {
        super();
        this.setId("6187465e40166d2cf9b01dc208be9483");
        this.setCaption("数据同步发送队列2");
        this.setTitle("数据同步发送队列2实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataSyncOut2MPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncOut2MPickupViewController",this);
    }
