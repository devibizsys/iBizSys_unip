...
/**
 * 视图[UserEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserEditView.do")
public class UserEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public UserEditViewController() throws Exception {
        super();
        this.setId("c45c9ee882d38451c488c710b33148ac");
        this.setCaption("用户");
        this.setTitle("用户编辑");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserEditViewEditFormHandler");
        editForm.init(this);
