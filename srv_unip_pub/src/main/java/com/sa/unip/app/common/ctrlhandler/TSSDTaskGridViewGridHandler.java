...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDTaskMainGridModel;
...
/**
 * 应用视图[TSSDTaskGridView]表格[grid]后台处理对象基类
 */
public class TSSDTaskGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDTaskMainGridModel gridModel = null;
    public TSSDTaskGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDTaskMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDTaskMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDTask entity)throws Exception {
