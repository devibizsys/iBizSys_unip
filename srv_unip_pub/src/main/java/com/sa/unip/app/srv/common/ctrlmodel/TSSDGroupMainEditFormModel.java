...
/**
 * 实体[任务时刻策略组]编辑表单[form]部件模型
 */
public class TSSDGroupMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDGroupMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.common.demodel.TSSDGroupDEModel tSSDGroupDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.TSSDGroupDEModel getTSSDGroupDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDGROUPID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略组标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDGROUPNAME");
            formItem.setCaption("任务时刻策略组名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDGROUPNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdgroupname
        iFormItem = this.createFormItem("tssdgroupname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdgroupname");
            formItem.setDEFName("TSSDGROUPNAME");
            formItem.setCaption("任务时刻策略组名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdgroupname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdgroupid
        iFormItem = this.createFormItem("tssdgroupid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdgroupid");
            formItem.setDEFName("TSSDGROUPID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略组标识");
