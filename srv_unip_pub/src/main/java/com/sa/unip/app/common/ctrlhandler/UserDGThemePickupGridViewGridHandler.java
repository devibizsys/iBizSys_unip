...
import com.sa.unip.app.srv.common.ctrlmodel.UserDGThemeMainGridModel;
...
/**
 * 应用视图[UserDGThemePickupGridView]表格[grid]后台处理对象基类
 */
public class UserDGThemePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDGThemeMainGridModel gridModel = null;
    public UserDGThemePickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserDGThemeMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserDGThemeMainGridModel getRealGridModel() {
