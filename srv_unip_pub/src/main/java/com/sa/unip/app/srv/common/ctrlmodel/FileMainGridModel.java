...
/**
 * 实体[文件]数据表格[grid]部件模型
 */
public class  FileMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public FileMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 file_id
        iGridDataItem = createGridDataItem("file_id");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("file_id");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("FILE_ID");
            gridEditItem.setEnableCond(2);
            gridEditItem.setCaption("文件标识");
