...
/**
 * 实体[微信公众号]编辑表单[form]部件模型
 */
public class WXAccountMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WXAccountMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // apiappid
        iFormItem = this.createFormItem("apiappid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("apiappid");
            formItem.setDEFName("APIAPPID");
            formItem.setCaption("AppId");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("apiappid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
