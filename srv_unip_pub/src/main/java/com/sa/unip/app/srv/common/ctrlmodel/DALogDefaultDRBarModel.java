...
/**
 * 实体[DA日志]数据关系栏[drbar]部件模型
 */
public class  DALogDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DALogDefaultDRBarModel() {
        super();
    }
