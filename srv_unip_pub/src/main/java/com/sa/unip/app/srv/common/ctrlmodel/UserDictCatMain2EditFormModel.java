...
/**
 * 实体[用户词条类别]编辑表单[form]部件模型
 */
public class UserDictCatMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserDictCatMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERDICTCATID");
            formItem.setCaption("用户词典类别标识");
        ...
        this.registerFormItem(iFormItem);
        // userdictcatname
        iFormItem = this.createFormItem("userdictcatname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userdictcatname");
            formItem.setDEFName("USERDICTCATNAME");
            formItem.setCaption("用户词典类别名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userdictcatname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userdictcatid
        iFormItem = this.createFormItem("userdictcatid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userdictcatid");
            formItem.setDEFName("USERDICTCATID");
            formItem.setCaption("用户词典类别标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userdictcatid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
