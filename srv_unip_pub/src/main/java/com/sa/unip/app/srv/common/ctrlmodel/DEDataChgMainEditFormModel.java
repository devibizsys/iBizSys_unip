...
/**
 * 实体[实体数据变更]编辑表单[form]部件模型
 */
public class DEDataChgMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DEDataChgMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DEDATACHGID");
            formItem.setEnableCond(0);
            formItem.setCaption("实体数据变更标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DEDATACHGNAME");
            formItem.setCaption("实体数据变更名称");
        ...
        this.registerFormItem(iFormItem);
        // dedatachgname
        iFormItem = this.createFormItem("dedatachgname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dedatachgname");
            formItem.setDEFName("DEDATACHGNAME");
            formItem.setCaption("实体数据变更名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dedatachgname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // dedatachgid
        iFormItem = this.createFormItem("dedatachgid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dedatachgid");
            formItem.setDEFName("DEDATACHGID");
            formItem.setEnableCond(0);
            formItem.setCaption("实体数据变更标识");
