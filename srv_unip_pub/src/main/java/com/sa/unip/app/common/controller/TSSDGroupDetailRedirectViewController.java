...
/**
 * 视图[TSSDGroupDetailRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDGroupDetailRedirectView.do")
public class TSSDGroupDetailRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public TSSDGroupDetailRedirectViewController() throws Exception {
        super();
        this.setId("d05e5767a31c9ebede33cc2c92d15b39");
        this.setCaption("任务时刻策略组明细");
        this.setTitle("任务时刻策略组明细实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/TSSDGroupDetailRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDGroupDetailRedirectViewController",this);
    }
