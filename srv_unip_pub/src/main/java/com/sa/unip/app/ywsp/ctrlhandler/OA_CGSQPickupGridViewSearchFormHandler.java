...
public class OA_CGSQPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_CGSQDefaultSearchFormModel searchformModel = null;
    public OA_CGSQPickupGridViewSearchFormHandler()  {
        super();
    }
