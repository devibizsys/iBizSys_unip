...
/**
 * 实体[数据同步发送队列2]搜索表单[searchform]部件模型
 */
public class  DataSyncOut2DefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DataSyncOut2DefaultSearchFormModel() {
        super();
