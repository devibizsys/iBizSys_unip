...
/**
 * 视图[OA_SBWXSBWXLC_WFExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXSBWXLC_WFExpView.do")
public class OA_SBWXSBWXLC_WFExpViewController extends net.ibizsys.pswf.controller.WFExpViewControllerBase {
    public OA_SBWXSBWXLC_WFExpViewController() throws Exception {
        super();
        this.setId("f6ce3df881c90a0f75b60ce2773afa2e");
        this.setCaption("设备维修");
        this.setTitle("设备维修工作流导航视图(设备维修流程)");
        this.setCapLanResTag("DE.LNAME.OA_SBWX");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.EXPBAR","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXSBWXLC_WFExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXSBWXLC_WFExpViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 expbar
        ICtrlModel expBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_SBWXexpbarWFExpBarModel");
        expBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 expbar
        ICtrlHandler expBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_WFExpViewExpBarHandler");
        expBar.init(this);
