...
/**
 * 应用视图[DataAuditPickupGridView]表格[grid]后台处理对象基类
 */
public class DataAuditPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataAuditMainGridModel gridModel = null;
    public DataAuditPickupGridViewGridHandler()  {
        super();
    }
