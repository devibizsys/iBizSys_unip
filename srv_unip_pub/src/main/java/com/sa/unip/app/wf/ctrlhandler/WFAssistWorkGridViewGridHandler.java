...
/**
 * 应用视图[WFAssistWorkGridView]表格[grid]后台处理对象基类
 */
public class WFAssistWorkGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFAssistWorkMainGridModel gridModel = null;
    public WFAssistWorkGridViewGridHandler()  {
        super();
    }
