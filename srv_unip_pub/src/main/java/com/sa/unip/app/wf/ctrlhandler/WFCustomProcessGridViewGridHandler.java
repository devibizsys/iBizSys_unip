...
import com.sa.unip.app.srv.wf.ctrlmodel.WFCustomProcessMainGridModel;
...
/**
 * 应用视图[WFCustomProcessGridView]表格[grid]后台处理对象基类
 */
public class WFCustomProcessGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFCustomProcessMainGridModel gridModel = null;
    public WFCustomProcessGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFCustomProcessMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFCustomProcessMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFCustomProcess entity)throws Exception {
