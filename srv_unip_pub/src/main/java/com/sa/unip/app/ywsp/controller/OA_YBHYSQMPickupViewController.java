...
/**
 * 视图[OA_YBHYSQMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQMPickupView.do")
public class OA_YBHYSQMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_YBHYSQMPickupViewController() throws Exception {
        super();
        this.setId("cc7bd1db3393645c8210e13c53055b4b");
        this.setCaption("会议申请");
        this.setTitle("会议申请数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_YBHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YBHYSQ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQMPickupViewController",this);
    }
