...
/**
 * 应用视图[OA_JPYDPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_JPYDPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_JPYDMainGridModel gridModel = null;
    public OA_JPYDPickupGridViewGridHandler()  {
        super();
    }
