...
/**
 * 应用视图[LoginLogPickupGridView]表格[grid]后台处理对象基类
 */
public class LoginLogPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected LoginLogMain2GridModel gridModel = null;
    public LoginLogPickupGridViewGridHandler()  {
        super();
    }
