...
/**
 * 视图[WXAccessTokenGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXAccessTokenGridView.do")
public class WXAccessTokenGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WXAccessTokenGridViewController() throws Exception {
        super();
        this.setId("b2ca5fafeb24c63942c1b3d0561af6f9");
        this.setCaption("微信访问票据");
        this.setTitle("微信访问票据实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wx/WXAccessTokenGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXAccessTokenGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXAccessTokenGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXAccessTokenGridViewSearchFormHandler");
        searchForm.init(this);
