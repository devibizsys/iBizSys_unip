...
/**
 * 视图[OA_TZGGTZGGSQLC_W_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGTZGGSQLC_W_WFGridView.do")
public class OA_TZGGTZGGSQLC_W_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_TZGGTZGGSQLC_W_WFGridViewController() throws Exception {
        super();
        this.setId("8daf955bf5f8805fbe67fbdbc81f2641");
        this.setCaption("通知公告");
        this.setTitle("通知公告工作流表格视图(通知公告申请)");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGTZGGSQLC_W_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGTZGGSQLC_W_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_W_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_W_WFGridViewSearchFormHandler");
        searchForm.init(this);
