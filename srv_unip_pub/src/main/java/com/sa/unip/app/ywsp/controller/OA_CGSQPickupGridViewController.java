...
/**
 * 视图[OA_CGSQPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CGSQPickupGridView.do")
public class OA_CGSQPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_CGSQPickupGridViewController() throws Exception {
        super();
        this.setId("c71ab6ec8f80b641834c85b80ead6b84");
        this.setCaption("采购申请");
        this.setTitle("采购申请选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_CGSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CGSQ.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CGSQPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CGSQPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CGSQPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CGSQPickupGridViewSearchFormHandler");
        searchForm.init(this);
