...
/**
 * 视图[WFActorRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFActorRedirectView.do")
public class WFActorRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFActorRedirectViewController() throws Exception {
        super();
        this.setId("6cba437416d40acac723e8003193170a");
        this.setCaption("工作流操作者");
        this.setTitle("工作流操作者实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFActorRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFActorRedirectViewController",this);
    }
