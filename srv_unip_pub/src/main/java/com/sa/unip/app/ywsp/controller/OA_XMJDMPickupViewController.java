...
/**
 * 视图[OA_XMJDMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_XMJDMPickupView.do")
public class OA_XMJDMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_XMJDMPickupViewController() throws Exception {
        super();
        this.setId("4e3afcf9fac2103fb41eb3361fde943e");
        this.setCaption("项目进度");
        this.setTitle("项目进度数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_XMJD");
        this.setTitleLanResTag("PAGE.TITLE.OA_XMJD.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_XMJDMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_XMJDMPickupViewController",this);
    }
