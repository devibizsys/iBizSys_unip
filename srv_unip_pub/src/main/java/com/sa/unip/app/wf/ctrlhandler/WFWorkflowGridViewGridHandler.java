...
import com.sa.unip.app.srv.wf.ctrlmodel.WFWorkflowMainGridModel;
...
/**
 * 应用视图[WFWorkflowGridView]表格[grid]后台处理对象基类
 */
public class WFWorkflowGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFWorkflowMainGridModel gridModel = null;
    public WFWorkflowGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFWorkflowMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFWorkflowMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFWorkflow entity)throws Exception {
