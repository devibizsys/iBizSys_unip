...
/**
 * 实体[数据对象能力]数据分页[drtab]部件模型
 */
public class  UserRoleDataDR2DRTabModel extends net.ibizsys.paas.ctrlmodel.DRTabModelBase {

    public UserRoleDataDR2DRTabModel()  {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem1.setText("数据范围明细");
        drCtrlItem1.setDRViewId("DRITEM1");
        drCtrlItem1.setIconPath("");
        drCtrlItem1.setIconCls("");
        drCtrlItem1.setEnableMode("ALL");
        drCtrlItem1.setViewParam("srfparentdeid","c4125399a698dc5f8acca6dc8b38b353");
        drCtrlItem1.setViewParam("srfparenttype","DER1N");
        drCtrlItem1.setViewParam("srfder1nid","DER1N_USERROLEDATADETAIL_USERROLEDATA_USERROLEDATAID");
        //添加 数据操作能力
        DRCtrlItem drCtrlItem2 = drCtrlRootItem.addItem("dritem2","");
        drCtrlItem2.setText("数据操作能力");
        ...
        drCtrlItem2.setViewParam("srfder1nid","DER1N_USERROLEDATAACTION_USERROLEDATA_USERROLEDATAID");
        //添加 用户角色
        DRCtrlItem drCtrlItem3 = drCtrlRootItem.addItem("dritem3","");
        drCtrlItem3.setText("用户角色");
        ...
        drCtrlItem3.setViewParam("srfder1nid","DER1N_USERROLEDATAS_USERROLEDATA_USERROLEDATAID");
    }
}