...
/**
 * 实体[工作流交互操作]编辑表单[form]部件模型
 */
public class WFIAActionMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFIAActionMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFIAACTIONID");
            formItem.setCaption("工作流交互操作标识");
        ...
        this.registerFormItem(iFormItem);
        // wfiaactionid
        iFormItem = this.createFormItem("wfiaactionid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfiaactionid");
            formItem.setDEFName("WFIAACTIONID");
            formItem.setCaption("工作流交互操作标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfiaactionid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
