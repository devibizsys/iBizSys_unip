...
/**
 * 视图[TSSDEnginePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDEnginePickupView.do")
public class TSSDEnginePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public TSSDEnginePickupViewController() throws Exception {
        super();
        this.setId("47c77604d0c67e564caa5cf4ff977dc1");
        this.setCaption("任务调度引擎");
        this.setTitle("任务调度引擎实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDEnginePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDEnginePickupViewController",this);
    }
