...
/**
 * 视图[OrgUserPickupView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserPickupView3.do")
public class OrgUserPickupView3Controller extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgUserPickupView3Controller() throws Exception {
        super();
        this.setId("e27b45a817e805251fd4e4dd6d89c2d4");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserPickupView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserPickupView3Controller",this);
    }
