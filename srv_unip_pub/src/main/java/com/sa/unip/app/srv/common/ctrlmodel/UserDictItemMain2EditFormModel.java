...
/**
 * 实体[用户词条]编辑表单[form]部件模型
 */
public class UserDictItemMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserDictItemMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERDICTITEMID");
            formItem.setCaption("用户词典词条标识");
        ...
        this.registerFormItem(iFormItem);
        // userdictitemname
        iFormItem = this.createFormItem("userdictitemname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userdictitemname");
            formItem.setDEFName("USERDICTITEMNAME");
            formItem.setCaption("词条名称");
            formItem.setAllowEmpty(false);
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userdictitemname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // markflag
        iFormItem = this.createFormItem("markflag");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("markflag");
            formItem.setDEFName("MARKFLAG");
            formItem.setCaption("标记常用");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("markflag");
        ...
        this.registerFormItem(iFormItem);
        // userdictitemid
        iFormItem = this.createFormItem("userdictitemid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userdictitemid");
            formItem.setDEFName("USERDICTITEMID");
            formItem.setCaption("用户词典词条标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userdictitemid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
