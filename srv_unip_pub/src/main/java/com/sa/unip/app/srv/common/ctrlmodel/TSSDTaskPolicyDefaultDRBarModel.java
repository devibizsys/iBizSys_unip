...
/**
 * 实体[调度任务项策略]数据关系栏[drbar]部件模型
 */
public class  TSSDTaskPolicyDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDTaskPolicyDefaultDRBarModel() {
        super();
    }
