...
/**
 * 视图[WFSystemUserMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFSystemUserMPickupView.do")
public class WFSystemUserMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFSystemUserMPickupViewController() throws Exception {
        super();
        this.setId("7740dcc21ece37eff7a8c3aef1e79df1");
        this.setCaption("工作流系统用户");
        this.setTitle("工作流系统用户实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFSystemUserMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFSystemUserMPickupViewController",this);
    }
