...
public class OA_TZGGTZGGSQLC_W20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_TZGGDefaultSearchFormModel searchformModel = null;
    public OA_TZGGTZGGSQLC_W20_WFGridViewSearchFormHandler()  {
        super();
    }
