...
public class WFTmpStepActorGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFTmpStepActorDefaultSearchFormModel searchformModel = null;
    public WFTmpStepActorGridViewSearchFormHandler()  {
        super();
    }
