...
/**
 * 实体[组织单元类别]编辑表单[form]部件模型
 */
public class OrgUnitCatMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OrgUnitCatMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("ORGUNITCATID");
            formItem.setCaption("组织单元类别标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("ORGUNITCATNAME");
            formItem.setCaption("组织单元类别名称");
        ...
        this.registerFormItem(iFormItem);
        // orgunitcatid
        iFormItem = this.createFormItem("orgunitcatid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("orgunitcatid");
            formItem.setDEFName("ORGUNITCATID");
            formItem.setCaption("组织单元类别标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("orgunitcatid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // orgunitcatname
        iFormItem = this.createFormItem("orgunitcatname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("orgunitcatname");
            formItem.setDEFName("ORGUNITCATNAME");
            formItem.setCaption("组织单元类别名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("orgunitcatname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // catcode
        iFormItem = this.createFormItem("catcode");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("catcode");
            formItem.setDEFName("CATCODE");
            formItem.setCaption("类别代码");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("catcode");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
