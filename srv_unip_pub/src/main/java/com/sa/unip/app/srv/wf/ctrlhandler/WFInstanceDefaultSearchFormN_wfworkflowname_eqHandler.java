...
public class WFInstanceDefaultSearchFormN_wfworkflowname_eqHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFInstanceDefaultSearchFormN_wfworkflowname_eqHandler()  {
        super();
    }
