...
/**
 * 视图[MsgSendQueueEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgSendQueueEditView.do")
public class MsgSendQueueEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public MsgSendQueueEditViewController() throws Exception {
        super();
        this.setId("bc97b4fce63c9802b36385b218af9598");
        this.setCaption("消息发送队列");
        this.setTitle("消息发送队列实体编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/MsgSendQueueEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgSendQueueEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgSendQueueEditViewEditFormHandler");
        editForm.init(this);
