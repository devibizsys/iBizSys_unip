...
/**
 * 视图[OA_YBHYSQSHYJWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQSHYJWFActionView.do")
public class OA_YBHYSQSHYJWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_YBHYSQSHYJWFActionViewController() throws Exception {
        super();
        this.setId("658165f993f43a91ebd2919c71279420");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQSHYJWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQSHYJWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YBHYSQSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQSHYJWFActionViewEditFormHandler");
        editForm.init(this);
