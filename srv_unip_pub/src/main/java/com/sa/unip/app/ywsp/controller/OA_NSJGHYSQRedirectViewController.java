...
/**
 * 视图[OA_NSJGHYSQRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_NSJGHYSQRedirectView.do")
public class OA_NSJGHYSQRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_NSJGHYSQRedirectViewController() throws Exception {
        super();
        this.setId("f46735c423a4cd5f34ea1aee115b4236");
        this.setCaption("内设机构会议申请");
        this.setTitle("内设机构会议申请数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_NSJGHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_NSJGHYSQ.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_NSJGHYSQRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_NSJGHYSQRedirectViewController",this);
    }
