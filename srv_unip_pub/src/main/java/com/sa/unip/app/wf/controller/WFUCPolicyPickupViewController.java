...
/**
 * 视图[WFUCPolicyPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUCPolicyPickupView.do")
public class WFUCPolicyPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFUCPolicyPickupViewController() throws Exception {
        super();
        this.setId("ee0ca06b20e969a62c993e9b5fe4830d");
        this.setCaption("工作流候选用户策略");
        this.setTitle("工作流候选用户策略实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUCPolicyPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUCPolicyPickupViewController",this);
    }
