...
/**
 * 视图[FileMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/FileMPickupView.do")
public class FileMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public FileMPickupViewController() throws Exception {
        super();
        this.setId("acd35a4bc48292e28b321218e69b8eac");
        this.setCaption("文件");
        this.setTitle("文件实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/FileMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.FileMPickupViewController",this);
    }
