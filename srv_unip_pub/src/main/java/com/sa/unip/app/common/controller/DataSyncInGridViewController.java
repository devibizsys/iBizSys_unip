...
/**
 * 视图[DataSyncInGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncInGridView.do")
public class DataSyncInGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public DataSyncInGridViewController() throws Exception {
        super();
        this.setId("6bb3c34d987aec0afce8ce9cae034420");
        this.setCaption("数据同步接收队列");
        this.setTitle("数据同步接收队列实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/DataSyncInGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncInGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DataSyncInGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DataSyncInGridViewSearchFormHandler");
        searchForm.init(this);
