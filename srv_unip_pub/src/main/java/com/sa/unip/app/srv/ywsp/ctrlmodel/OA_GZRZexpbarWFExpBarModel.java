...
/**
 * 实体[工作日志]流程导航栏[expbar]部件模型
 */
public class  OA_GZRZexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_GZRZexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("E7BDF6C1-A7A2-43BB-AB28-4E6DC36DA33F"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("RZTJLC:D:20");
        ...
        expBarItem3.setExpViewId("RZTJLC:D:20:10");
        ...
        expBarItem4.setExpViewId("RZTJLC:D:20:20");
        ...
        expBarItem5.setExpViewId("RZTJLC:D:30");
        ...
        expBarItem6.setExpViewId("RZTJLC:D:40");
        ...
        expBarItem7.setExpViewId("RZTJLC:W");
        ...
        expBarItem8.setExpViewId("RZTJLC:W:10");
        ...
        expBarItem9.setExpViewId("RZTJLC:W:20");
