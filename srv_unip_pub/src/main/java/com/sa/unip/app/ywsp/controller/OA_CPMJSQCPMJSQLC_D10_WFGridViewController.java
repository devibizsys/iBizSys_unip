...
/**
 * 视图[OA_CPMJSQCPMJSQLC_D10_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CPMJSQCPMJSQLC_D10_WFGridView.do")
public class OA_CPMJSQCPMJSQLC_D10_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_CPMJSQCPMJSQLC_D10_WFGridViewController() throws Exception {
        super();
        this.setId("c9f47357a30165d864d563597cbc0e6e");
        this.setCaption("车牌门禁申请");
        this.setTitle("车牌门禁申请工作流表格视图(车牌门禁申请流程:未提交)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CPMJSQCPMJSQLC_D10_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CPMJSQCPMJSQLC_D10_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CPMJSQCPMJSQLC_D10_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CPMJSQCPMJSQLC_D10_WFGridViewSearchFormHandler");
        searchForm.init(this);
