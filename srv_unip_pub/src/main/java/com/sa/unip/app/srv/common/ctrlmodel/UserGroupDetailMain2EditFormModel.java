...
/**
 * 实体[用户组成员]编辑表单[form]部件模型
 */
public class UserGroupDetailMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserGroupDetailMain2EditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.common.demodel.UserGroupDetailDEModel userGroupDetailDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.UserGroupDetailDEModel getUserGroupDetailDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERGROUPDETAILID");
            formItem.setCaption("用户组成员标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERGROUPDETAILID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERGROUPDETAILNAME");
            formItem.setCaption("用户组成员名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERGROUPDETAILNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // usergroupname
        iFormItem = this.createFormItem("usergroupname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("usergroupname");
            formItem.setDEFName("USERGROUPNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("用户组");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("usergroupname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userobjectname
        iFormItem = this.createFormItem("userobjectname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userobjectname");
            formItem.setDEFName("USEROBJECTNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("用户对象");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userobjectname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // usergroupdetailid
        iFormItem = this.createFormItem("usergroupdetailid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("usergroupdetailid");
            formItem.setDEFName("USERGROUPDETAILID");
            formItem.setCaption("用户组成员标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("usergroupdetailid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // usergroupid
        iFormItem = this.createFormItem("usergroupid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("usergroupid");
            formItem.setDEFName("USERGROUPID");
            formItem.setEnableCond(1);
            formItem.setCaption("用户组");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("usergroupid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userobjectid
        iFormItem = this.createFormItem("userobjectid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userobjectid");
            formItem.setDEFName("USEROBJECTID");
            formItem.setEnableCond(1);
            formItem.setCaption("用户对象");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userobjectid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
