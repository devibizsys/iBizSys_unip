...
/**
 * 视图[OA_XMJDPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_XMJDPickupView.do")
public class OA_XMJDPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_XMJDPickupViewController() throws Exception {
        super();
        this.setId("c06dc5f06394bf1da3020529c9a79848");
        this.setCaption("项目进度");
        this.setTitle("项目进度数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_XMJD");
        this.setTitleLanResTag("PAGE.TITLE.OA_XMJD.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_XMJDPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_XMJDPickupViewController",this);
    }
