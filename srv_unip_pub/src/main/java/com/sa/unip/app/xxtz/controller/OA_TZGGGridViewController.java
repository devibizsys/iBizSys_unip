...
/**
 * 视图[OA_TZGGGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGGridView.do")
public class OA_TZGGGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_TZGGGridViewController() throws Exception {
        super();
        this.setId("40e3f331245565e5e8d6c6178470784d");
        this.setCaption("通知公告");
        this.setTitle("通知公告表格视图");
        this.setCapLanResTag("DE.LNAME.OA_TZGG");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGG.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGGridViewSearchFormHandler");
        searchForm.init(this);
