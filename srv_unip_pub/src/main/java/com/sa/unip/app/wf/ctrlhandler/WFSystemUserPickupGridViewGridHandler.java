...
/**
 * 应用视图[WFSystemUserPickupGridView]表格[grid]后台处理对象基类
 */
public class WFSystemUserPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFSystemUserMainGridModel gridModel = null;
    public WFSystemUserPickupGridViewGridHandler()  {
        super();
    }
