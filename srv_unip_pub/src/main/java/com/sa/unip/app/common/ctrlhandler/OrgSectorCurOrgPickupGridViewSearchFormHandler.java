...
public class OrgSectorCurOrgPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgSectorDefaultSearchFormModel searchformModel = null;
    public OrgSectorCurOrgPickupGridViewSearchFormHandler()  {
        super();
    }
