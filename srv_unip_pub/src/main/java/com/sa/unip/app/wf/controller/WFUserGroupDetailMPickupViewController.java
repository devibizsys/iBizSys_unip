...
/**
 * 视图[WFUserGroupDetailMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupDetailMPickupView.do")
public class WFUserGroupDetailMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFUserGroupDetailMPickupViewController() throws Exception {
        super();
        this.setId("71b6e345a929b8309c74cb984b1adbb3");
        this.setCaption("工作流用户组成员");
        this.setTitle("工作流用户组成员实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupDetailMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupDetailMPickupViewController",this);
    }
