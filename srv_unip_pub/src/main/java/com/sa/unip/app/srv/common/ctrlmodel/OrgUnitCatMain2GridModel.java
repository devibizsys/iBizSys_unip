...
/**
 * 实体[组织单元类别]数据表格[grid]部件模型
 */
public class  OrgUnitCatMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public OrgUnitCatMain2GridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.OrgUnitCatDEModel orgUnitCatDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.OrgUnitCatDEModel getOrgUnitCatDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 组织单元类别名称
        iGridColumn = createGridColumn("orgunitcatname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("orgunitcatname");
            gridColumnModel.setDataItemName("orgunitcatname");
            gridColumnModel.setCaption("组织单元类别名称");
        ...
        //建立表格列 类别代码
        iGridColumn = createGridColumn("catcode");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("catcode");
            gridColumnModel.setDataItemName("catcode");
            gridColumnModel.setCaption("类别代码");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 orgunitcatname
        iGridDataItem = createGridDataItem("orgunitcatname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("orgunitcatname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("ORGUNITCATNAME");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 orgunitcatid
        iGridDataItem = createGridDataItem("orgunitcatid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("orgunitcatid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("ORGUNITCATID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 catcode
        iGridDataItem = createGridDataItem("catcode");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("catcode");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("CATCODE");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("ORGUNITCATID");
            gridEditItem.setCaption("组织单元类别标识");
