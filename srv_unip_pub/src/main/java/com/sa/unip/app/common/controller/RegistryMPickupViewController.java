...
/**
 * 视图[RegistryMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/RegistryMPickupView.do")
public class RegistryMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public RegistryMPickupViewController() throws Exception {
        super();
        this.setId("6eb84b61f42a9a099d689e3ef12b573b");
        this.setCaption("注册表");
        this.setTitle("注册表实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/RegistryMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.RegistryMPickupViewController",this);
    }
