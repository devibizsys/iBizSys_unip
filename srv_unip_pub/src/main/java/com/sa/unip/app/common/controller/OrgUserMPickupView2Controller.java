...
/**
 * 视图[OrgUserMPickupView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserMPickupView2.do")
public class OrgUserMPickupView2Controller extends net.ibizsys.paas.controller.MPickupView2ControllerBase {
    public OrgUserMPickupView2Controller() throws Exception {
        super();
        this.setId("11dd1be25dc148e634d0989619b379a2");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体多项数据选择视图（左右关系）");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserMPickupView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserMPickupView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 treeexpbar
        ICtrlHandler treeexpbar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserMPickupView2TreeExpBarHandler");
        treeexpbar.init(this);
        this.registerCtrlHandler("treeexpbar",treeexpbar);
        //注册 treeexpbar_tree
        ICtrlHandler treeexpbar_tree = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserMPickupView2Treeexpbar_treeHandler");
        treeexpbar_tree.init(this);
