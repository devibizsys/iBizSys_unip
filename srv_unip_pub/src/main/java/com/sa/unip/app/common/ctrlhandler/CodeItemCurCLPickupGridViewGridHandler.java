...
import com.sa.unip.app.srv.common.ctrlmodel.CodeItemMain2GridModel;
...
/**
 * 应用视图[CodeItemCurCLPickupGridView]表格[grid]后台处理对象基类
 */
public class CodeItemCurCLPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected CodeItemMain2GridModel gridModel = null;
    public CodeItemCurCLPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (CodeItemMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected CodeItemMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurCL(deDataSetFetchContext);
    }
