...
/**
 * 应用视图[WFWorkflowPickupGridView]表格[grid]后台处理对象基类
 */
public class WFWorkflowPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFWorkflowMainGridModel gridModel = null;
    public WFWorkflowPickupGridViewGridHandler()  {
        super();
    }
