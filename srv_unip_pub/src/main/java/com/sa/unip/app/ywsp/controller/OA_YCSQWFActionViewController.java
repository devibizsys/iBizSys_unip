...
/**
 * 视图[OA_YCSQWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQWFActionView.do")
public class OA_YCSQWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_YCSQWFActionViewController() throws Exception {
        super();
        this.setId("cca18eebaa10e72e8cb257050ced95dd");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YCSQSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQWFActionViewEditFormHandler");
        editForm.init(this);
