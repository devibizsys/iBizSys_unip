...
/**
 * 视图[UniResMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UniResMPickupView.do")
public class UniResMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UniResMPickupViewController() throws Exception {
        super();
        this.setId("a01944219a2c643c3b3c64134702e08c");
        this.setCaption("统一资源");
        this.setTitle("统一资源实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UniResMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UniResMPickupViewController",this);
    }
