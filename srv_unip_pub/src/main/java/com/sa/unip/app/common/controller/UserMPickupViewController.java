...
/**
 * 视图[UserMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserMPickupView.do")
public class UserMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserMPickupViewController() throws Exception {
        super();
        this.setId("5dd8263cf490611dd695cd6a1b9051f2");
        this.setCaption("用户");
        this.setTitle("用户实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserMPickupViewController",this);
    }
