...
/**
 * 实体[消息发送队列（历史）]编辑表单[form]部件模型
 */
public class MsgSendQueueHisMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public MsgSendQueueHisMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("MSGSENDQUEUEHISID");
            formItem.setEnableCond(0);
            formItem.setCaption("消息发送队列（历史）标识");
            formItem.setCapLanResTag("DEF.LNAME.MSGSENDQUEUEHISID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("MSGSENDQUEUEHISNAME");
            formItem.setCaption("消息发送队列（历史）名称");
            formItem.setCapLanResTag("DEF.LNAME.MSGSENDQUEUEHISNAME");
        ...
        this.registerFormItem(iFormItem);
        // msgsendqueuehisid
        iFormItem = this.createFormItem("msgsendqueuehisid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("msgsendqueuehisid");
            formItem.setDEFName("MSGSENDQUEUEHISID");
            formItem.setEnableCond(0);
            formItem.setCaption("消息发送队列（历史）标识");
            formItem.setCapLanResTag("DEF.LNAME.MSGSENDQUEUEHISID");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("msgsendqueuehisid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
