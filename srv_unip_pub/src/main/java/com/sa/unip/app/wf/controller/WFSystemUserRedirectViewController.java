...
/**
 * 视图[WFSystemUserRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFSystemUserRedirectView.do")
public class WFSystemUserRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFSystemUserRedirectViewController() throws Exception {
        super();
        this.setId("a5509fc2b512e107edc7a791db296929");
        this.setCaption("工作流系统用户");
        this.setTitle("工作流系统用户实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFSystemUserRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFSystemUserRedirectViewController",this);
    }
