...
/**
 * 视图[OA_CZRZMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xtgl/OA_CZRZMPickupView.do")
public class OA_CZRZMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_CZRZMPickupViewController() throws Exception {
        super();
        this.setId("a6ab5e675bda10720cd91081606e9035");
        this.setCaption("操作日志");
        this.setTitle("操作日志数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_CZRZ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CZRZ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/xtgl/OA_CZRZMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xtgl.controller.OA_CZRZMPickupViewController",this);
    }
