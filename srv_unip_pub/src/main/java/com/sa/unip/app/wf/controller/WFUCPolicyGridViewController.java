...
/**
 * 视图[WFUCPolicyGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUCPolicyGridView.do")
public class WFUCPolicyGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFUCPolicyGridViewController() throws Exception {
        super();
        this.setId("09d71c6d4371a83a7ef1da7577d99631");
        this.setCaption("工作流候选用户策略");
        this.setTitle("工作流候选用户策略实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUCPolicyGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUCPolicyGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUCPolicyGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUCPolicyGridViewSearchFormHandler");
        searchForm.init(this);
    ...
    protected void prepareUIActions()throws Exception {
        this.registerUIAction("EnablePolicy");
        this.registerUIAction("DisablePolicy");
