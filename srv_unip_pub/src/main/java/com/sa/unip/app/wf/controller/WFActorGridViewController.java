...
/**
 * 视图[WFActorGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFActorGridView.do")
public class WFActorGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFActorGridViewController() throws Exception {
        super();
        this.setId("edd2ed1aef43ee80b05ff3682d2e24a8");
        this.setCaption("工作流操作者");
        this.setTitle("工作流操作者实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFActorGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFActorGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFActorGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFActorGridViewSearchFormHandler");
        searchForm.init(this);
