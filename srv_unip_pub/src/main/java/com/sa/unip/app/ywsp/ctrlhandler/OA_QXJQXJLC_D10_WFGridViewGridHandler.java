...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_QXJMainGridModel;
...
/**
 * 应用视图[OA_QXJQXJLC_D10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_QXJQXJLC_D10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_QXJMainGridModel gridModel = null;
    public OA_QXJQXJLC_D10_WFGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_QXJMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_QXJMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_QXJ entity)throws Exception {
