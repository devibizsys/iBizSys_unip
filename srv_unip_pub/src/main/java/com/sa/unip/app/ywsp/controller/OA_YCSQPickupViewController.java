...
/**
 * 视图[OA_YCSQPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQPickupView.do")
public class OA_YCSQPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_YCSQPickupViewController() throws Exception {
        super();
        this.setId("0de3ff4cac10c2e4a55472590cbe89d1");
        this.setCaption("用餐申请");
        this.setTitle("用餐申请数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_YCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YCSQ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQPickupViewController",this);
    }
