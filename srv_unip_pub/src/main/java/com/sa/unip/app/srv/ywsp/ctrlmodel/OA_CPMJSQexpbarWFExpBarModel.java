...
/**
 * 实体[车牌门禁申请]流程导航栏[expbar]部件模型
 */
public class  OA_CPMJSQexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_CPMJSQexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("BCE28AB4-6801-4E94-B40C-1B4DEA610230"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("CPMJSQLC:D:20");
        ...
        expBarItem3.setExpViewId("CPMJSQLC:D:20:10");
        ...
        expBarItem4.setExpViewId("CPMJSQLC:D:20:20");
        ...
        expBarItem5.setExpViewId("CPMJSQLC:D:30");
        ...
        expBarItem6.setExpViewId("CPMJSQLC:D:40");
        ...
        expBarItem7.setExpViewId("CPMJSQLC:W");
        ...
        expBarItem8.setExpViewId("CPMJSQLC:W:10");
        ...
        expBarItem9.setExpViewId("CPMJSQLC:W:20");
