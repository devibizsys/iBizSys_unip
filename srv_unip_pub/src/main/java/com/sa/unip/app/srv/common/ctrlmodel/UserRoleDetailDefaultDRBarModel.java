...
/**
 * 实体[用户角色成员]数据关系栏[drbar]部件模型
 */
public class  UserRoleDetailDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserRoleDetailDefaultDRBarModel() {
        super();
    }
