...
/**
 * 视图[DataSyncOutRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncOutRedirectView.do")
public class DataSyncOutRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public DataSyncOutRedirectViewController() throws Exception {
        super();
        this.setId("16df8980dd24037ebb27d940095f4c92");
        this.setCaption("数据同步发送队列");
        this.setTitle("数据同步发送队列实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/DataSyncOutRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncOutRedirectViewController",this);
    }
