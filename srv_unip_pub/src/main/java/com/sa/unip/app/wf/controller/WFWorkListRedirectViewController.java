 ...
 */
@Controller
@RequestMapping(value = "/app/wf/WFWorkListRedirectView.do")
public class WFWorkListRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFWorkListRedirectViewController() throws Exception {
        super();
        this.setId("200594ab0a1296a317c40cd8285037ce");
        this.setCaption("工作流工作列表");
        this.setTitle("工作流工作列表实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFWorkListRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFWorkListRedirectViewController",this);
    }
