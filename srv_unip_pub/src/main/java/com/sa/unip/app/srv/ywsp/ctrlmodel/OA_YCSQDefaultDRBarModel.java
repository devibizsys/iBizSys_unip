...
/**
 * 实体[用餐申请]数据关系栏[drbar]部件模型
 */
public class  OA_YCSQDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OA_YCSQDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setTextLanResTag("DE.LNAME.OA_YCSQ");
