...
/**
 * 视图[WFUserGroupDetailGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupDetailGridView.do")
public class WFUserGroupDetailGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFUserGroupDetailGridViewController() throws Exception {
        super();
        this.setId("3aedc7b525d94d1b3487c06163a1adff");
        this.setCaption("工作流用户组成员");
        this.setTitle("工作流用户组成员实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupDetailGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupDetailGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGroupDetailGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGroupDetailGridViewSearchFormHandler");
        searchForm.init(this);
