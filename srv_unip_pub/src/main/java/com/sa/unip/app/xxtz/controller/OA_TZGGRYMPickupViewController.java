...
/**
 * 视图[OA_TZGGRYMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGRYMPickupView.do")
public class OA_TZGGRYMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_TZGGRYMPickupViewController() throws Exception {
        super();
        this.setId("b746e215bddab473564a763df49d9c93");
        this.setCaption("通知公告人员");
        this.setTitle("通知公告人员数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_GGTZRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGGRY.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGRYMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGRYMPickupViewController",this);
    }
