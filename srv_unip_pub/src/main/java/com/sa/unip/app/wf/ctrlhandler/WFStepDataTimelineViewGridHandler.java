...
/**
 * 应用视图[WFStepDataTimelineView]表格[grid]后台处理对象基类
 */
public class WFStepDataTimelineViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFStepDataGridHandlerBase {

    protected WFStepDataMain2GridModel gridModel = null;
    public WFStepDataTimelineViewGridHandler()  {
        super();
    }
