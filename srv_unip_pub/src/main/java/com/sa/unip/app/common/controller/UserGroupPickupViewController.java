...
/**
 * 视图[UserGroupPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserGroupPickupView.do")
public class UserGroupPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserGroupPickupViewController() throws Exception {
        super();
        this.setId("fd6b635da946818cd17f60566fa65585");
        this.setCaption("用户组");
        this.setTitle("用户组实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserGroupPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserGroupPickupViewController",this);
    }
