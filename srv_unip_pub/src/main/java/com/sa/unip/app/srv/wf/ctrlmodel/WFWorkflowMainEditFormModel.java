...
/**
 * 实体[工作流配置]编辑表单[form]部件模型
 */
public class WFWorkflowMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFWorkflowMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setCaption("工作流配置标识");
            formItem.setCapLanResTag("DEF.LNAME.WFWORKFLOWID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.WFWORKFLOWNAME");
        ...
        this.registerFormItem(iFormItem);
        // wftype
        iFormItem = this.createFormItem("wftype");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wftype");
            formItem.setDEFName("WFTYPE");
            formItem.setCodeListId("net.ibizsys.psrt.srv.codelist.WFConfigTypeCodeListModel");
            formItem.setCaption("流程类型");
            formItem.setCapLanResTag("DEF.LNAME.WFTYPE");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wftype");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfstate
        iFormItem = this.createFormItem("wfstate");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfstate");
            formItem.setDEFName("WFSTATE");
            formItem.setCodeListId("net.ibizsys.psrt.srv.codelist.WFConfigStateCodeListModel");
            formItem.setCaption("工作流状态");
            formItem.setCapLanResTag("DEF.LNAME.WFSTATE");
            formItem.setAllowEmpty(false);
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfstate");
        ...
        this.registerFormItem(iFormItem);
        // remindmsgtemplname
        iFormItem = this.createFormItem("remindmsgtemplname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("remindmsgtemplname");
            formItem.setDEFName("REMINDMSGTEMPLNAME");
            formItem.setCaption("催办消息模板");
            formItem.setCapLanResTag("DEF.LNAME.REMINDMSGTEMPLNAME");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("remindmsgtemplname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        if(iFormItem==null) {
            ...
            formItem.setCaption("版本");
            formItem.setCapLanResTag("DEF.LNAME.WFWORKFLOW.WFVERSION");
            formItem.setAllowEmpty(false);
        ...
        if(iFormItem==null) {
            ...
            formItem.setCaption("工作流说明");
            formItem.setCapLanResTag("DEF.LNAME.WFWORKFLOW.MEMO");
        ...
        this.registerFormItem(iFormItem);
        // remindmsgtemplid
        iFormItem = this.createFormItem("remindmsgtemplid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("remindmsgtemplid");
            formItem.setDEFName("REMINDMSGTEMPLID");
            formItem.setCaption("催办消息模板");
            formItem.setCapLanResTag("DEF.LNAME.REMINDMSGTEMPLID");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("remindmsgtemplid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
