...
/**
 * 应用视图[WFUCPolicyPickupGridView]表格[grid]后台处理对象基类
 */
public class WFUCPolicyPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUCPolicyMain2GridModel gridModel = null;
    public WFUCPolicyPickupGridViewGridHandler()  {
        super();
    }
