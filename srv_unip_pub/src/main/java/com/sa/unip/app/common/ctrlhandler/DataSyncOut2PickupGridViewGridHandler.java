...
/**
 * 应用视图[DataSyncOut2PickupGridView]表格[grid]后台处理对象基类
 */
public class DataSyncOut2PickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncOut2MainGridModel gridModel = null;
    public DataSyncOut2PickupGridViewGridHandler()  {
        super();
    }
