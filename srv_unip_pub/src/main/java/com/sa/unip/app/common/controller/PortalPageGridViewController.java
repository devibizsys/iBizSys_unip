...
/**
 * 视图[PortalPageGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PortalPageGridView.do")
public class PortalPageGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public PortalPageGridViewController() throws Exception {
        super();
        this.setId("cc7c5d85e864caf103711daec778e456");
        this.setCaption("门户页面");
        this.setTitle("门户页面实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/PortalPageGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PortalPageGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.PortalPageGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.PortalPageGridViewSearchFormHandler");
        searchForm.init(this);
