...
public class PPModelMainEditFormL2pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelMainEditFormL2pvpartnameHandler()  {
        super();
    }
