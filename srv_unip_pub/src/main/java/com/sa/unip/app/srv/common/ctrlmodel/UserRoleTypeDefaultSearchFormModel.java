...
/**
 * 实体[用户角色类型]搜索表单[searchform]部件模型
 */
public class  UserRoleTypeDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserRoleTypeDefaultSearchFormModel() {
        super();
