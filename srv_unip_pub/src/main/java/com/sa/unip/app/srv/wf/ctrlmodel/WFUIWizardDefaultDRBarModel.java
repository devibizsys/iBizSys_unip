...
/**
 * 实体[工作流操作界面]数据关系栏[drbar]部件模型
 */
public class  WFUIWizardDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFUIWizardDefaultDRBarModel() {
        super();
    }
