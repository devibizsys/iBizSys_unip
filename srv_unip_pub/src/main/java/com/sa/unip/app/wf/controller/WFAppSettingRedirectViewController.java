...
/**
 * 视图[WFAppSettingRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFAppSettingRedirectView.do")
public class WFAppSettingRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFAppSettingRedirectViewController() throws Exception {
        super();
        this.setId("e5ca42c196c064b1f0884e39efd8a6b0");
        this.setCaption("工作流系统设定");
        this.setTitle("工作流系统设定实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFAppSettingRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFAppSettingRedirectViewController",this);
    }
