...
/**
 * 视图[UserDictMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserDictMPickupView.do")
public class UserDictMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserDictMPickupViewController() throws Exception {
        super();
        this.setId("c5e38ddbc8180ea5a341a620dc6c1bcd");
        this.setCaption("用户词典");
        this.setTitle("用户词典实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserDictMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserDictMPickupViewController",this);
    }
