...
/**
 * 视图[OA_YBHYSQYBHYSQ_W20_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQYBHYSQ_W20_WFGridView.do")
public class OA_YBHYSQYBHYSQ_W20_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_YBHYSQYBHYSQ_W20_WFGridViewController() throws Exception {
        super();
        this.setId("a4a5688c674b921371a012d7504685f0");
        this.setCaption("会议申请");
        this.setTitle("会议申请工作流表格视图(会议申请:会议室申请)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQYBHYSQ_W20_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQYBHYSQ_W20_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_W20_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_W20_WFGridViewSearchFormHandler");
        searchForm.init(this);
