...
/**
 * 实体[门户页面模型]数据关系栏[drbar]部件模型
 */
public class  PPModelDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public PPModelDefaultDRBarModel() {
        super();
    }
