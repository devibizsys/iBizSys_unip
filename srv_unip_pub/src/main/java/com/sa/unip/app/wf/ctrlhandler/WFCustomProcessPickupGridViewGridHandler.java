...
/**
 * 应用视图[WFCustomProcessPickupGridView]表格[grid]后台处理对象基类
 */
public class WFCustomProcessPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFCustomProcessMainGridModel gridModel = null;
    public WFCustomProcessPickupGridViewGridHandler()  {
        super();
    }
