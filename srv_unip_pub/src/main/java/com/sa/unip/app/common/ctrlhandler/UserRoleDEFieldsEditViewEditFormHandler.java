...
public class UserRoleDEFieldsEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected UserRoleDEFieldsMainEditFormModel editformModel = null;
    public UserRoleDEFieldsEditViewEditFormHandler()  {
        super();
    }
