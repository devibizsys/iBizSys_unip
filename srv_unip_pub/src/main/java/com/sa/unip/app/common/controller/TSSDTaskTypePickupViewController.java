...
/**
 * 视图[TSSDTaskTypePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskTypePickupView.do")
public class TSSDTaskTypePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public TSSDTaskTypePickupViewController() throws Exception {
        super();
        this.setId("ed7b05a672cabe531c063897250d76c4");
        this.setCaption("任务调度任务类型");
        this.setTitle("任务调度任务类型实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskTypePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskTypePickupViewController",this);
    }
