...
/**
 * 视图[OA_CGSQCGSQLC_W_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CGSQCGSQLC_W_WFGridView.do")
public class OA_CGSQCGSQLC_W_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_CGSQCGSQLC_W_WFGridViewController() throws Exception {
        super();
        this.setId("88771028ea82a616808cce5a9d1c9042");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CGSQCGSQLC_W_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CGSQCGSQLC_W_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CGSQCGSQLC_W_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CGSQCGSQLC_W_WFGridViewSearchFormHandler");
        searchForm.init(this);
