...
/**
 * 实体[文件]编辑表单[form]部件模型
 */
public class FileMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public FileMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.common.demodel.FileDEModel fileDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.FileDEModel getFileDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("FILE_ID");
            formItem.setEnableCond(2);
            formItem.setCaption("文件标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("FILE_ID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("FILE_NAME");
            formItem.setCaption("文件名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("FILE_NAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // file_id
        iFormItem = this.createFormItem("file_id");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("file_id");
            formItem.setDEFName("FILE_ID");
            formItem.setEnableCond(2);
            formItem.setCaption("文件标识");
