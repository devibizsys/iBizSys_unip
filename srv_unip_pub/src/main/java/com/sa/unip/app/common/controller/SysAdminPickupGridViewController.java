...
/**
 * 视图[SysAdminPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/SysAdminPickupGridView.do")
public class SysAdminPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public SysAdminPickupGridViewController() throws Exception {
        super();
        this.setId("0c50caa727e779f281f903c965ab0f86");
        this.setCaption("系统管理模块");
        this.setTitle("系统管理模块实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/SysAdminPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.SysAdminPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.SysAdminPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.SysAdminPickupGridViewSearchFormHandler");
        searchForm.init(this);
