...
public class TSSDTaskTypeGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected TSSDTaskTypeDefaultSearchFormModel searchformModel = null;
    public TSSDTaskTypeGridViewSearchFormHandler()  {
        super();
    }
