...
/**
 * 实体[工作流步骤子实例]数据表格[grid]部件模型
 */
public class  WFStepInstMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFStepInstMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wfstepinstid
        iGridDataItem = createGridDataItem("wfstepinstid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfstepinstid");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFSTEPINSTID");
            gridEditItem.setCaption("工作流步骤子实例标识");
