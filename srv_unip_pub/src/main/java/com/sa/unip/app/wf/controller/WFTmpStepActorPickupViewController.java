...
/**
 * 视图[WFTmpStepActorPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFTmpStepActorPickupView.do")
public class WFTmpStepActorPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFTmpStepActorPickupViewController() throws Exception {
        super();
        this.setId("a50d8cf7a0453475b458b3788ad73dff");
        this.setCaption("工作流步骤操作者（临时）");
        this.setTitle("工作流步骤操作者（临时）实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFTmpStepActorPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFTmpStepActorPickupViewController",this);
    }
