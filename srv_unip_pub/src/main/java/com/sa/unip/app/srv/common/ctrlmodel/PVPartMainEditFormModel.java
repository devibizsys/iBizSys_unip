...
/**
 * 实体[门户视图部件]编辑表单[form]部件模型
 */
public class PVPartMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public PVPartMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("PVPARTID");
            formItem.setEnableCond(0);
            formItem.setCaption("门户视图部件标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("PVPARTNAME");
            formItem.setCaption("门户视图部件名称");
        ...
        this.registerFormItem(iFormItem);
        // pvpartname
        iFormItem = this.createFormItem("pvpartname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("pvpartname");
            formItem.setDEFName("PVPARTNAME");
            formItem.setCaption("门户视图部件名称");
        ...
        this.registerFormItem(iFormItem);
        // pvpartid
        iFormItem = this.createFormItem("pvpartid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("pvpartid");
            formItem.setDEFName("PVPARTID");
            formItem.setEnableCond(0);
            formItem.setCaption("门户视图部件标识");
