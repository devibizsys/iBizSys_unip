...
/**
 * 应用视图[DataAuditDetailPickupGridView]表格[grid]后台处理对象基类
 */
public class DataAuditDetailPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataAuditDetailMainGridModel gridModel = null;
    public DataAuditDetailPickupGridViewGridHandler()  {
        super();
    }
