...
/**
 * 视图[WFStepDataEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepDataEditView.do")
public class WFStepDataEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public WFStepDataEditViewController() throws Exception {
        super();
        this.setId("2c12bbda7e0266f8c2c6731846d84aca");
        this.setCaption("工作流步骤数据");
        this.setTitle("工作流步骤数据实体编辑视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPDATA");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEPDATA.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepDataEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepDataEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepDataEditViewEditFormHandler");
        editForm.init(this);
