...
public class UserRoleDatasMainEditFormUserrolenameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public UserRoleDatasMainEditFormUserrolenameHandler()  {
        super();
    }
