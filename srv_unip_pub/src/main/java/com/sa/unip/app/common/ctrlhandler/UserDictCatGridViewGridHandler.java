...
import com.sa.unip.app.srv.common.ctrlmodel.UserDictCatMain2GridModel;
...
/**
 * 应用视图[UserDictCatGridView]表格[grid]后台处理对象基类
 */
public class UserDictCatGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDictCatMain2GridModel gridModel = null;
    public UserDictCatGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserDictCatMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserDictCatMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserDictCat entity)throws Exception {
