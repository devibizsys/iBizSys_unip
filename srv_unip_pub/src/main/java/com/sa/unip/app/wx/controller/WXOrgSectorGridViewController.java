...
/**
 * 视图[WXOrgSectorGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXOrgSectorGridView.do")
public class WXOrgSectorGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WXOrgSectorGridViewController() throws Exception {
        super();
        this.setId("e584c3859aa4ca3a7ff6300cfbbc6180");
        this.setCaption("微信部门");
        this.setTitle("微信部门实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wx/WXOrgSectorGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXOrgSectorGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXOrgSectorGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXOrgSectorGridViewSearchFormHandler");
        searchForm.init(this);
