...
/**
 * 视图[UserGroupMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserGroupMPickupView.do")
public class UserGroupMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserGroupMPickupViewController() throws Exception {
        super();
        this.setId("fcdf03a11b50cfd2b4e8f3b498e1c6e1");
        this.setCaption("用户组");
        this.setTitle("用户组实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserGroupMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserGroupMPickupViewController",this);
    }
