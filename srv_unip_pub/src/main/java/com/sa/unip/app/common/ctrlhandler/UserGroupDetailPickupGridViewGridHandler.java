...
/**
 * 应用视图[UserGroupDetailPickupGridView]表格[grid]后台处理对象基类
 */
public class UserGroupDetailPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserGroupDetailMain2GridModel gridModel = null;
    public UserGroupDetailPickupGridViewGridHandler()  {
        super();
    }
