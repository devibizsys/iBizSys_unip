...
/**
 * 视图[OA_RZRYRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_RZRYRedirectView.do")
public class OA_RZRYRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_RZRYRedirectViewController() throws Exception {
        super();
        this.setId("8e1b29fdcccf31dd0bcdca7639d2ecb6");
        this.setCaption("日志人员");
        this.setTitle("日志人员数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_RZRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_RZRY.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/xxtz/OA_RZRYRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_RZRYRedirectViewController",this);
    }
