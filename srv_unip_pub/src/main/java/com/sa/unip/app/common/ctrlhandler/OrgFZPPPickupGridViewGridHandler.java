...
/**
 * 应用视图[OrgFZPPPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgFZPPPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgMain2GridModel gridModel = null;
    public OrgFZPPPickupGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchUX_ORGXJDW(deDataSetFetchContext);
    }
