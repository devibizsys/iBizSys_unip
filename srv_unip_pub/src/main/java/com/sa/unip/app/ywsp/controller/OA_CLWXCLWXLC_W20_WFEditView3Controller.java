...
/**
 * 视图[OA_CLWXCLWXLC_W20_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CLWXCLWXLC_W20_WFEditView3.do")
public class OA_CLWXCLWXLC_W20_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_CLWXCLWXLC_W20_WFEditView3Controller() throws Exception {
        super();
        this.setId("87abaac601bc9fffed56c304540bdc30");
        this.setCaption("车辆维修");
        this.setTitle("车辆维修工作流视图(车辆维修流程v1:承办处领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CLWXCLWXLC_W20_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CLWXCLWXLC_W20_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXCLWXLC_W20_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXCLWXLC_W20_WFEditView3EditFormHandler");
        editForm.init(this);
