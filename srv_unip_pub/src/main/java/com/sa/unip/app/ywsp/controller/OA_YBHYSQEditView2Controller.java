...
/**
 * 视图[OA_YBHYSQEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQEditView2.do")
public class OA_YBHYSQEditView2Controller extends net.ibizsys.pswf.controller.EditView2ControllerBase {
    public OA_YBHYSQEditView2Controller() throws Exception {
        super();
        this.setId("a40f433bb89e6a968492fc3abda0e505");
        this.setCaption("会议申请");
        this.setTitle("会议申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_YBHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YBHYSQ.EDITVIEW2");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YBHYSQDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQEditView2DRBarHandler");
        drBar.init(this);
