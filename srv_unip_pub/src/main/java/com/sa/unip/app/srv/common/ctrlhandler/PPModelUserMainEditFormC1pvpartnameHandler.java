...
public class PPModelUserMainEditFormC1pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormC1pvpartnameHandler()  {
        super();
    }
