...
/**
 * 视图[WFInstanceMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFInstanceMPickupView.do")
public class WFInstanceMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFInstanceMPickupViewController() throws Exception {
        super();
        this.setId("264b0321bf0fd7368d1219cadb8aa986");
        this.setCaption("工作流实例");
        this.setTitle("工作流实例实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFInstanceMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFInstanceMPickupViewController",this);
    }
