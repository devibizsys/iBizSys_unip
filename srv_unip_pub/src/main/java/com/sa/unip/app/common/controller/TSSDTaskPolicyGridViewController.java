...
/**
 * 视图[TSSDTaskPolicyGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskPolicyGridView.do")
public class TSSDTaskPolicyGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public TSSDTaskPolicyGridViewController() throws Exception {
        super();
        this.setId("01a965b76a00daec7b18dcdb3bf462bb");
        this.setCaption("调度任务项策略");
        this.setTitle("调度任务项策略实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskPolicyGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskPolicyGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDTaskPolicyGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDTaskPolicyGridViewSearchFormHandler");
        searchForm.init(this);
