...
import com.sa.unip.app.srv.common.ctrlmodel.ServiceMainGridModel;
...
/**
 * 应用视图[ServiceGridView]表格[grid]后台处理对象基类
 */
public class ServiceGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected ServiceMainGridModel gridModel = null;
    public ServiceGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (ServiceMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected ServiceMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(Service entity)throws Exception {
