...
/**
 * 实体[任务调度日志]数据关系栏[drbar]部件模型
 */
public class  TSSDTaskLogDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDTaskLogDefaultDRBarModel() {
        super();
    }
