...
/**
 * 应用视图[FilePickupGridView]表格[grid]后台处理对象基类
 */
public class FilePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected FileMainGridModel gridModel = null;
    public FilePickupGridViewGridHandler()  {
        super();
    }
