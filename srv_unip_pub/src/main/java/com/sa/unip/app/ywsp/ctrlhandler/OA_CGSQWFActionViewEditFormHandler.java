...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_CGSQSHYJFormEditFormModel;
...
public class OA_CGSQWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_CGSQSHYJFormEditFormModel editformModel = null;
    public OA_CGSQWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CGSQSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CGSQSHYJFormEditFormModel getRealEditFormModel() {
