...
public class OA_YBHYSQYBHYSQ_W_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_YBHYSQDefaultSearchFormModel searchformModel = null;
    public OA_YBHYSQYBHYSQ_W_WFGridViewSearchFormHandler()  {
        super();
    }
