...
/**
 * 视图[UserRoleDatasEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDatasEditView.do")
public class UserRoleDatasEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public UserRoleDatasEditViewController() throws Exception {
        super();
        this.setId("156da29800da2356d5aabc0ab400ce4f");
        this.setCaption("用户角色数据能力");
        this.setTitle("用户角色数据能力实体编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleDatasEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDatasEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDatasEditViewEditFormHandler");
        editForm.init(this);
