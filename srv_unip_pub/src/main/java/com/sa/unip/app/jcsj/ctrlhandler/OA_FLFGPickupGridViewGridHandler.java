...
/**
 * 应用视图[OA_FLFGPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_FLFGPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_FLFGMainGridModel gridModel = null;
    public OA_FLFGPickupGridViewGridHandler()  {
        super();
    }
