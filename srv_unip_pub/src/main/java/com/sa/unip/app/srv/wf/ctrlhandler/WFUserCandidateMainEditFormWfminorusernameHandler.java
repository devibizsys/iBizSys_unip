...
public class WFUserCandidateMainEditFormWfminorusernameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFUserCandidateMainEditFormWfminorusernameHandler()  {
        super();
    }
