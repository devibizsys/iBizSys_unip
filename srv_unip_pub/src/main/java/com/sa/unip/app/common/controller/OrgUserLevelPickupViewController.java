...
/**
 * 视图[OrgUserLevelPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserLevelPickupView.do")
public class OrgUserLevelPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgUserLevelPickupViewController() throws Exception {
        super();
        this.setId("fa02d9e1f35e767fcdd2f42732929c0b");
        this.setCaption("组织人员级别");
        this.setTitle("组织人员级别实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgUserLevelPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserLevelPickupViewController",this);
    }
