...
/**
 * 应用视图[DataSyncIn2PickupGridView]表格[grid]后台处理对象基类
 */
public class DataSyncIn2PickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncIn2MainGridModel gridModel = null;
    public DataSyncIn2PickupGridViewGridHandler()  {
        super();
    }
