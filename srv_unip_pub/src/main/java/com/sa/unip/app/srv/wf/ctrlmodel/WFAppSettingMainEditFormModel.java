...
/**
 * 实体[工作流系统设定]编辑表单[form]部件模型
 */
public class WFAppSettingMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFAppSettingMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFAPPSETTINGID");
            formItem.setCaption("工作流应用设定标识");
        ...
        this.registerFormItem(iFormItem);
        // wfappsettingname
        iFormItem = this.createFormItem("wfappsettingname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfappsettingname");
            formItem.setDEFName("WFAPPSETTINGNAME");
            formItem.setCaption("系统工作流设定");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfappsettingname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfappsettingid
        iFormItem = this.createFormItem("wfappsettingid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfappsettingid");
            formItem.setDEFName("WFAPPSETTINGID");
            formItem.setCaption("工作流应用设定标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfappsettingid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // remindmsgtempid
        iFormItem = this.createFormItem("remindmsgtempid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("remindmsgtempid");
            formItem.setDEFName("REMINDMSGTEMPID");
            formItem.setCaption("催办消息模板");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("remindmsgtempid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
