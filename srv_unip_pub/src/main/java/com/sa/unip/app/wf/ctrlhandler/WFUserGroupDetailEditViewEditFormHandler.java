...
public class WFUserGroupDetailEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected WFUserGroupDetailMainEditFormModel editformModel = null;
    public WFUserGroupDetailEditViewEditFormHandler()  {
        super();
    }
