...
/**
 * 应用视图[MsgTemplatePickupGridView]表格[grid]后台处理对象基类
 */
public class MsgTemplatePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgTemplateMain2GridModel gridModel = null;
    public MsgTemplatePickupGridViewGridHandler()  {
        super();
    }
