...
/**
 * 实体[任务时刻策略组]数据关系栏[drbar]部件模型
 */
public class  TSSDGroupDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDGroupDefaultDRBarModel() {
        super();
    }
