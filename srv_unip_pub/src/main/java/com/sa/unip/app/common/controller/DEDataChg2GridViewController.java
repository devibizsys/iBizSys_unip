...
/**
 * 视图[DEDataChg2GridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChg2GridView.do")
public class DEDataChg2GridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public DEDataChg2GridViewController() throws Exception {
        super();
        this.setId("fda822e9fdc3149fc094fc94acee27e9");
        this.setCaption("实体数据变更（已处理）");
        this.setTitle("实体数据变更（已处理）实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/DEDataChg2GridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChg2GridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DEDataChg2GridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DEDataChg2GridViewSearchFormHandler");
        searchForm.init(this);
