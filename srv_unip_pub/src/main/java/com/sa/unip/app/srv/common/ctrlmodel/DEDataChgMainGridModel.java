...
/**
 * 实体[实体数据变更]数据表格[grid]部件模型
 */
public class  DEDataChgMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public DEDataChgMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.DEDataChgDEModel dEDataChgDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.DEDataChgDEModel getDEDataChgDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 实体数据变更名称
        iGridColumn = createGridColumn("dedatachgname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("dedatachgname");
            gridColumnModel.setDataItemName("dedatachgname");
            gridColumnModel.setCaption("实体数据变更名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 dedatachgid
        iGridDataItem = createGridDataItem("dedatachgid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dedatachgid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHGID");
        ...
        if(iGridDataItem == null) {
            ...
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHGNAME");
            dataItemParam0.setFormat("");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 dedatachgname
        iGridDataItem = createGridDataItem("dedatachgname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dedatachgname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHGNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("DEDATACHGID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("实体数据变更标识");
