...
/**
 * 视图[OA_XXRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_XXRedirectView.do")
public class OA_XXRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_XXRedirectViewController() throws Exception {
        super();
        this.setId("4baa061435a23cfdd1238efe7eeb5663");
        this.setCaption("消息");
        this.setTitle("消息数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_XX");
        this.setTitleLanResTag("PAGE.TITLE.OA_XX.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/xxtz/OA_XXRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_XXRedirectViewController",this);
    }
