...
/**
 * 视图[OA_CLWXPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CLWXPickupGridView.do")
public class OA_CLWXPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_CLWXPickupGridViewController() throws Exception {
        super();
        this.setId("8b31874701dbdd4b784d6dfdd5cd57c7");
        this.setCaption("车辆维修");
        this.setTitle("车辆维修选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_CLWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_CLWX.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CLWXPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CLWXPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXPickupGridViewSearchFormHandler");
        searchForm.init(this);
