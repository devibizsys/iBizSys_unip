...
/**
 * 应用视图[OrgUserLevelGridView]表格[grid]后台处理对象基类
 */
public class OrgUserLevelGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserLevelMain2GridModel gridModel = null;
    public OrgUserLevelGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OrgUserLevel entity)throws Exception {
