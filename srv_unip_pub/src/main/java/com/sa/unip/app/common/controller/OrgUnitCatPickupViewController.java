...
/**
 * 视图[OrgUnitCatPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUnitCatPickupView.do")
public class OrgUnitCatPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgUnitCatPickupViewController() throws Exception {
        super();
        this.setId("1834697cb0d12c811bd71eb2ba8a09a8");
        this.setCaption("组织单元类别");
        this.setTitle("组织单元类别实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgUnitCatPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUnitCatPickupViewController",this);
    }
