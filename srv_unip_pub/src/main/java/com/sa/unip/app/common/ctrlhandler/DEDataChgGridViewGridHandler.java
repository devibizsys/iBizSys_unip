...
import com.sa.unip.app.srv.common.ctrlmodel.DEDataChgMainGridModel;
...
/**
 * 应用视图[DEDataChgGridView]表格[grid]后台处理对象基类
 */
public class DEDataChgGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DEDataChgMainGridModel gridModel = null;
    public DEDataChgGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DEDataChgMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DEDataChgMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DEDataChg entity)throws Exception {
