...
/**
 * 视图[WFReminderGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFReminderGridView.do")
public class WFReminderGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFReminderGridViewController() throws Exception {
        super();
        this.setId("9d27bf78a50f5bfa96f41a93523f0a8d");
        this.setCaption("工作流工作催办");
        this.setTitle("工作流工作催办实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFReminderGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFReminderGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFReminderGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFReminderGridViewSearchFormHandler");
        searchForm.init(this);
