...
/**
 * 实体[工作流工作催办]数据关系栏[drbar]部件模型
 */
public class  WFReminderDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFReminderDefaultDRBarModel() {
        super();
    }
