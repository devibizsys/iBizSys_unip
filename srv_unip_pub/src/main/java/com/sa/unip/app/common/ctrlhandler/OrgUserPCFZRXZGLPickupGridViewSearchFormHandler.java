...
public class OrgUserPCFZRXZGLPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgUserDefaultSearchFormModel searchformModel = null;
    public OrgUserPCFZRXZGLPickupGridViewSearchFormHandler()  {
        super();
    }
