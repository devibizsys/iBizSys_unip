...
/**
 * 视图[OA_CZRZRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xtgl/OA_CZRZRedirectView.do")
public class OA_CZRZRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_CZRZRedirectViewController() throws Exception {
        super();
        this.setId("6ec22a9a44c0f08860d4f186e342799d");
        this.setCaption("操作日志");
        this.setTitle("操作日志数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_CZRZ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CZRZ.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/xtgl/OA_CZRZRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xtgl.controller.OA_CZRZRedirectViewController",this);
    }
