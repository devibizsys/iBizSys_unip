...
/**
 * 实体[工作流系统用户]数据关系栏[drbar]部件模型
 */
public class  WFSystemUserDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFSystemUserDefaultDRBarModel() {
        super();
    }
