...
/**
 * 应用视图[SystemGridView]表格[grid]后台处理对象基类
 */
public class SystemGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected SystemMainGridModel gridModel = null;
    public SystemGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(System entity)throws Exception {
