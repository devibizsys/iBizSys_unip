...
public class UserRoleDetailEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected UserRoleDetailMainEditFormModel editformModel = null;
    public UserRoleDetailEditViewEditFormHandler()  {
        super();
    }
