...
/**
 * 视图[FilePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/FilePickupView.do")
public class FilePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public FilePickupViewController() throws Exception {
        super();
        this.setId("d3d8a6ee0744317f683be4e8e53447f6");
        this.setCaption("文件");
        this.setTitle("文件实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/FilePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.FilePickupViewController",this);
    }
