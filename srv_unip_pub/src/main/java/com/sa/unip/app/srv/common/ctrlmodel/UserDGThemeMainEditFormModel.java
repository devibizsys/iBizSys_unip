...
/**
 * 实体[用户表格自定义]编辑表单[form]部件模型
 */
public class UserDGThemeMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserDGThemeMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.common.demodel.UserDGThemeDEModel userDGThemeDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.UserDGThemeDEModel getUserDGThemeDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERDGTHEMEID");
            formItem.setCaption("表格列定义标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERDGTHEMEID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERDGTHEMENAME");
            formItem.setCaption("表格列定义名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERDGTHEMENAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userdgthemeid
        iFormItem = this.createFormItem("userdgthemeid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userdgthemeid");
            formItem.setDEFName("USERDGTHEMEID");
            formItem.setCaption("表格列定义标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userdgthemeid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
