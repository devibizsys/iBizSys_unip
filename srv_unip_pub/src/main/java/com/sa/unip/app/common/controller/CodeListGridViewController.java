...
/**
 * 视图[CodeListGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/CodeListGridView.do")
public class CodeListGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public CodeListGridViewController() throws Exception {
        super();
        this.setId("b64051b0a188d64eb3dd968023a0129e");
        this.setCaption("代码表");
        this.setTitle("代码表实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/CodeListGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.CodeListGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.CodeListGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.CodeListGridViewSearchFormHandler");
        searchForm.init(this);
    ...
    protected void prepareUIActions()throws Exception {
        this.registerUIAction("RefreshModel");
