...
import com.sa.unip.app.srv.common.ctrlmodel.OrgTypeMain2GridModel;
...
/**
 * 应用视图[OrgTypeGridView]表格[grid]后台处理对象基类
 */
public class OrgTypeGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgTypeMain2GridModel gridModel = null;
    public OrgTypeGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgTypeMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgTypeMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OrgType entity)throws Exception {
