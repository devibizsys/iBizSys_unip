...
/**
 * 视图[CodeItemRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/CodeItemRedirectView.do")
public class CodeItemRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public CodeItemRedirectViewController() throws Exception {
        super();
        this.setId("6da4d92227bcb33a8b4e8a3da8905b2f");
        this.setCaption("代码项");
        this.setTitle("代码项实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/CodeItemRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.CodeItemRedirectViewController",this);
    }
