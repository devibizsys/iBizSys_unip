...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserMain2GridModel;
...
/**
 * 应用视图[OrgUserPCFZRXZGLPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgUserPCFZRXZGLPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserMain2GridModel gridModel = null;
    public OrgUserPCFZRXZGLPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgUserMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgUserMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchPCFZRXZGL(deDataSetFetchContext);
    }
