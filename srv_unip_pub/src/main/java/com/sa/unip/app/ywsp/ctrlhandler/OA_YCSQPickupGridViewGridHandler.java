...
/**
 * 应用视图[OA_YCSQPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_YCSQPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_YCSQMainGridModel gridModel = null;
    public OA_YCSQPickupGridViewGridHandler()  {
        super();
    }
