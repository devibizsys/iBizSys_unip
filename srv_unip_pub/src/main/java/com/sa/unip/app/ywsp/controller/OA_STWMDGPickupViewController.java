...
/**
 * 视图[OA_STWMDGPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGPickupView.do")
public class OA_STWMDGPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_STWMDGPickupViewController() throws Exception {
        super();
        this.setId("fc97e9df8ac5e1321dfebbab60317086");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_STWMDG");
        this.setTitleLanResTag("PAGE.TITLE.OA_STWMDG.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGPickupViewController",this);
    }
