...
/**
 * 视图[WFWorkflowGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFWorkflowGridView.do")
public class WFWorkflowGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFWorkflowGridViewController() throws Exception {
        super();
        this.setId("a07c656274b981ad77bbed0d9973b250");
        this.setCaption("工作流配置");
        this.setTitle("工作流配置实体表格视图");
        this.setCapLanResTag("DE.LNAME.WFWORKFLOW");
        this.setTitleLanResTag("PAGE.TITLE.WFWORKFLOW.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFWorkflowGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFWorkflowGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFWorkflowGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFWorkflowGridViewSearchFormHandler");
        searchForm.init(this);
