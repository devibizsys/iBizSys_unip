...
/**
 * 视图[OA_STWMDGSTWMDGLC_D_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGSTWMDGLC_D_WFGridView.do")
public class OA_STWMDGSTWMDGLC_D_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_STWMDGSTWMDGLC_D_WFGridViewController() throws Exception {
        super();
        this.setId("277ccfe687ac8911edabc34d0e2c0f8f");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGSTWMDGLC_D_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGSTWMDGLC_D_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_D_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_D_WFGridViewSearchFormHandler");
        searchForm.init(this);
