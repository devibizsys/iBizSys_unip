...
import com.sa.unip.app.srv.jcsj.ctrlmodel.OA_CLMainGridModel;
...
/**
 * 应用视图[OA_CLPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_CLPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CLMainGridModel gridModel = null;
    public OA_CLPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_CLMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_CLMainGridModel getRealGridModel() {
