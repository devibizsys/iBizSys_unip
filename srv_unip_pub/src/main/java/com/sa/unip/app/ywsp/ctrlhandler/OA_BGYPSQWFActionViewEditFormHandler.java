...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_BGYPSQSHYJFormEditFormModel;
...
public class OA_BGYPSQWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_BGYPSQSHYJFormEditFormModel editformModel = null;
    public OA_BGYPSQWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_BGYPSQSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_BGYPSQSHYJFormEditFormModel getRealEditFormModel() {
