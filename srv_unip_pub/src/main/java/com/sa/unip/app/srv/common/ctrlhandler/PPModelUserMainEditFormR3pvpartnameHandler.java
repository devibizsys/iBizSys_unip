...
public class PPModelUserMainEditFormR3pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormR3pvpartnameHandler()  {
        super();
    }
