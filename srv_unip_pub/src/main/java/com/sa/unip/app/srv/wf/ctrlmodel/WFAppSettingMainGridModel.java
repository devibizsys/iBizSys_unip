...
/**
 * 实体[工作流系统设定]数据表格[grid]部件模型
 */
public class  WFAppSettingMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFAppSettingMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 系统工作流设定
        iGridColumn = createGridColumn("wfappsettingname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("wfappsettingname");
            gridColumnModel.setDataItemName("wfappsettingname");
            gridColumnModel.setCaption("系统工作流设定");
        ...
        //建立表格列 催办消息模板
        iGridColumn = createGridColumn("remindmsgtemplname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("remindmsgtemplname");
            gridColumnModel.setDataItemName("remindmsgtemplname");
            gridColumnModel.setCaption("催办消息模板");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 remindmsgtemplname
        iGridDataItem = createGridDataItem("remindmsgtemplname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("remindmsgtemplname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("REMINDMSGTEMPLNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wfappsettingid
        iGridDataItem = createGridDataItem("wfappsettingid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfappsettingid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFAPPSETTINGID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 remindmsgtempid
        iGridDataItem = createGridDataItem("remindmsgtempid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("remindmsgtempid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("REMINDMSGTEMPID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        if(iGridDataItem == null) {
            ...
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFAPPSETTINGNAME");
            dataItemParam0.setFormat("");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wfappsettingname
        iGridDataItem = createGridDataItem("wfappsettingname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfappsettingname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFAPPSETTINGNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFAPPSETTINGID");
            gridEditItem.setCaption("工作流应用设定标识");
