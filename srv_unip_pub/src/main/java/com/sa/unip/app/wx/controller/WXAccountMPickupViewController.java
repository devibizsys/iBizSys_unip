...
/**
 * 视图[WXAccountMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXAccountMPickupView.do")
public class WXAccountMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WXAccountMPickupViewController() throws Exception {
        super();
        this.setId("c4211b501d423090a0291020e7834b7e");
        this.setCaption("微信公众号");
        this.setTitle("微信公众号实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wx/WXAccountMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXAccountMPickupViewController",this);
    }
