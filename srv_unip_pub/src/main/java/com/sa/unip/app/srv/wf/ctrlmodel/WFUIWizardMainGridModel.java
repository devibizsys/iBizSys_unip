...
/**
 * 实体[工作流操作界面]数据表格[grid]部件模型
 */
public class  WFUIWizardMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFUIWizardMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 工作流操作界面名称
        iGridColumn = createGridColumn("wfuiwizardname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("wfuiwizardname");
            gridColumnModel.setDataItemName("wfuiwizardname");
            gridColumnModel.setCaption("工作流操作界面名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wfuiwizardid
        iGridDataItem = createGridDataItem("wfuiwizardid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfuiwizardid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wfuiwizardname
        iGridDataItem = createGridDataItem("wfuiwizardname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfuiwizardname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFUIWIZARDID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("工作流操作界面标识");
