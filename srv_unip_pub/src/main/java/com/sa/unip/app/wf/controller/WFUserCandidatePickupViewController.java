...
/**
 * 视图[WFUserCandidatePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserCandidatePickupView.do")
public class WFUserCandidatePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFUserCandidatePickupViewController() throws Exception {
        super();
        this.setId("bfdfa9d66a1fda40978fd022c66ddf99");
        this.setCaption("工作流用户候选者");
        this.setTitle("工作流用户候选者实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUserCandidatePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserCandidatePickupViewController",this);
    }
