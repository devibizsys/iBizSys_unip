...
import com.sa.unip.app.srv.common.ctrlmodel.SystemMainGridModel;
...
/**
 * 应用视图[SystemPickupGridView]表格[grid]后台处理对象基类
 */
public class SystemPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected SystemMainGridModel gridModel = null;
    public SystemPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (SystemMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected SystemMainGridModel getRealGridModel() {
