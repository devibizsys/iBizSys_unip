...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_GZRZMainGridModel;
...
/**
 * 应用视图[OA_GZRZRZTJLC_D10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_GZRZRZTJLC_D10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_GZRZMainGridModel gridModel = null;
    public OA_GZRZRZTJLC_D10_WFGridViewGridHandler()  {
        super();
    }
