...
public class WFWorkflowMainEditFormRemindmsgtemplnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFWorkflowMainEditFormRemindmsgtemplnameHandler()  {
        super();
    }
