...
/**
 * 视图[UserRoleDEFieldsGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDEFieldsGridView.do")
public class UserRoleDEFieldsGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public UserRoleDEFieldsGridViewController() throws Exception {
        super();
        this.setId("265a18f9335ff40dfba9865272f3e0ef");
        this.setCaption("用户角色相关实体属性访问控制");
        this.setTitle("用户角色相关实体属性访问控制实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleDEFieldsGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDEFieldsGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDEFieldsGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDEFieldsGridViewSearchFormHandler");
        searchForm.init(this);
