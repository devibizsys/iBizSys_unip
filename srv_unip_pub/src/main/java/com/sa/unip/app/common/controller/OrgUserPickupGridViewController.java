 ...
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserPickupGridView.do")
public class OrgUserPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OrgUserPickupGridViewController() throws Exception {
        super();
        this.setId("913f06c206175224a4e6ea2113cb3e1c");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserPickupGridViewSearchFormHandler");
        searchForm.init(this);
