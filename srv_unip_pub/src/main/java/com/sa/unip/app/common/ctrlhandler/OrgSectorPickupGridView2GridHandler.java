...
/**
 * 应用视图[OrgSectorPickupGridView2]表格[grid]后台处理对象基类
 */
public class OrgSectorPickupGridView2GridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSectorMain2GridModel gridModel = null;
    public OrgSectorPickupGridView2GridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchDQCBBM(deDataSetFetchContext);
    }
