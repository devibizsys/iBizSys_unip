...
public class OA_YYSSQYYSSQ_D_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_YYSSQDefaultSearchFormModel searchformModel = null;
    public OA_YYSSQYYSSQ_D_WFGridViewSearchFormHandler()  {
        super();
    }
