...
/**
 * 实体[组织单元类别]数据关系栏[drbar]部件模型
 */
public class  OrgUnitCatDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OrgUnitCatDefaultDRBarModel() {
        super();
    }
