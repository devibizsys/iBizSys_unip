...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserUX_Main3GridModel;
...
/**
 * 应用视图[OrgUserJXKHJCRYXZPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgUserJXKHJCRYXZPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserUX_Main3GridModel gridModel = null;
    public OrgUserJXKHJCRYXZPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgUserUX_Main3GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgUserUX_Main3GridModel getRealGridModel() {
