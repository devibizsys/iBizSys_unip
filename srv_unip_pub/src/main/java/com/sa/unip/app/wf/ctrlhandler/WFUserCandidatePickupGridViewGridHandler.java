...
/**
 * 应用视图[WFUserCandidatePickupGridView]表格[grid]后台处理对象基类
 */
public class WFUserCandidatePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserCandidateMainGridModel gridModel = null;
    public WFUserCandidatePickupGridViewGridHandler()  {
        super();
    }
