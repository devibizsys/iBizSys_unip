...
/**
 * 视图[OA_QXJEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJEditView.do")
public class OA_QXJEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_QXJEditViewController() throws Exception {
        super();
        this.setId("d27abce61e590733c023adef419a1931");
        this.setCaption("请休假");
        this.setTitle("请休假编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_QXJ");
        this.setTitleLanResTag("PAGE.TITLE.OA_QXJ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJEditViewEditFormHandler");
        editForm.init(this);
