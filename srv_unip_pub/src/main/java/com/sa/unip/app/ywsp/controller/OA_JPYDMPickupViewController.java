...
/**
 * 视图[OA_JPYDMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_JPYDMPickupView.do")
public class OA_JPYDMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_JPYDMPickupViewController() throws Exception {
        super();
        this.setId("f060d16c532b0f1feeb789b15dafdef1");
        this.setCaption("机票预订");
        this.setTitle("机票预订数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_JPYD");
        this.setTitleLanResTag("PAGE.TITLE.OA_JPYD.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_JPYDMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_JPYDMPickupViewController",this);
    }
