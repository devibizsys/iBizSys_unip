 ...
 */
@Controller
@RequestMapping(value = "/app/common/OA_CHRYRedirectView2.do")
public class OA_CHRYRedirectView2Controller extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_CHRYRedirectView2Controller() throws Exception {
        super();
        this.setId("08db74c8a3e187d1476f1f54b6555ca6");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OA_CHRYRedirectView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OA_CHRYRedirectView2Controller",this);
    }
