...
/**
 * 视图[OrgSectorRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSectorRedirectView.do")
public class OrgSectorRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OrgSectorRedirectViewController() throws Exception {
        super();
        this.setId("2f2e6078a87c9a01c5a4ebd8bd5badae");
        this.setCaption("组织部门");
        this.setTitle("组织部门实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/OrgSectorRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSectorRedirectViewController",this);
    }
