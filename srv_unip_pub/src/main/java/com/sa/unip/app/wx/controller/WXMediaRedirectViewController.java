...
/**
 * 视图[WXMediaRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXMediaRedirectView.do")
public class WXMediaRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WXMediaRedirectViewController() throws Exception {
        super();
        this.setId("436b35ffe66ab8443b556d582cd2fa6b");
        this.setCaption("微信多媒体内容");
        this.setTitle("微信多媒体内容实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wx/WXMediaRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXMediaRedirectViewController",this);
    }
