...
/**
 * 应用视图[UserRoleDataDetailPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDataDetailPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDataDetailMainGridModel gridModel = null;
    public UserRoleDataDetailPickupGridViewGridHandler()  {
        super();
    }
