...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDTaskPolicyMainGridModel;
...
/**
 * 应用视图[TSSDTaskPolicyPickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDTaskPolicyPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDTaskPolicyMainGridModel gridModel = null;
    public TSSDTaskPolicyPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDTaskPolicyMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDTaskPolicyMainGridModel getRealGridModel() {
