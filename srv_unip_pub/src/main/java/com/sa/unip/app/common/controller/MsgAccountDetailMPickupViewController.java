...
/**
 * 视图[MsgAccountDetailMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgAccountDetailMPickupView.do")
public class MsgAccountDetailMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public MsgAccountDetailMPickupViewController() throws Exception {
        super();
        this.setId("66165644161e91776aefdc34940acc58");
        this.setCaption("组消息账户明细");
        this.setTitle("组消息账户明细实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/MsgAccountDetailMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgAccountDetailMPickupViewController",this);
    }
