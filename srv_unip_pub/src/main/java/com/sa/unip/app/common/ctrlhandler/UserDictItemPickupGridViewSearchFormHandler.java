...
public class UserDictItemPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected UserDictItemDefaultSearchFormModel searchformModel = null;
    public UserDictItemPickupGridViewSearchFormHandler()  {
        super();
    }
