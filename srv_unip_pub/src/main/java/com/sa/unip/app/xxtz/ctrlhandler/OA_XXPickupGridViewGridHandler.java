...
/**
 * 应用视图[OA_XXPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_XXPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_XXMainGridModel gridModel = null;
    public OA_XXPickupGridViewGridHandler()  {
        super();
    }
