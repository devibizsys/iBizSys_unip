...
public class OA_PCSQMainEditFormOa_clnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OA_PCSQMainEditFormOa_clnameHandler()  {
        super();
    }
