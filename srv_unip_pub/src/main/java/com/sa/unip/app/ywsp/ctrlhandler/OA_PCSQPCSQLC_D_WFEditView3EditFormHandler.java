...
public class OA_PCSQPCSQLC_D_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_PCSQMainEditFormModel editformModel = null;
    public OA_PCSQPCSQLC_D_WFEditView3EditFormHandler()  {
        super();
    }
