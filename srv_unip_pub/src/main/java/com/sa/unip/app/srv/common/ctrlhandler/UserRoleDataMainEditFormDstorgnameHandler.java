...
public class UserRoleDataMainEditFormDstorgnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public UserRoleDataMainEditFormDstorgnameHandler()  {
        super();
    }
