...
/**
 * 应用视图[WFAppSettingPickupGridView]表格[grid]后台处理对象基类
 */
public class WFAppSettingPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFAppSettingMainGridModel gridModel = null;
    public WFAppSettingPickupGridViewGridHandler()  {
        super();
    }
