...
public class PPModelMainEditFormR4pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelMainEditFormR4pvpartnameHandler()  {
        super();
    }
