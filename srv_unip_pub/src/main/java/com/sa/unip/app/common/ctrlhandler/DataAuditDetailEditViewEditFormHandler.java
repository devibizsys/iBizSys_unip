...
public class DataAuditDetailEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected DataAuditDetailMainEditFormModel editformModel = null;
    public DataAuditDetailEditViewEditFormHandler()  {
        super();
    }
