...
/**
 * 实体[工作流代办工作]数据关系栏[drbar]部件模型
 */
public class  WFAssistWorkDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFAssistWorkDefaultDRBarModel() {
        super();
    }
