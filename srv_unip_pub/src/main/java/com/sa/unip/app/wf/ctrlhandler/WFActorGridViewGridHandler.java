...
import com.sa.unip.app.srv.wf.ctrlmodel.WFActorMainGridModel;
...
/**
 * 应用视图[WFActorGridView]表格[grid]后台处理对象基类
 */
public class WFActorGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFActorMainGridModel gridModel = null;
    public WFActorGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFActorMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFActorMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFActor entity)throws Exception {
