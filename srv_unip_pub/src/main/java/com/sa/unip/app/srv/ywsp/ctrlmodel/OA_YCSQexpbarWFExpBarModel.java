...
/**
 * 实体[用餐申请]流程导航栏[expbar]部件模型
 */
public class  OA_YCSQexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_YCSQexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("ADE23A90-392B-4847-9284-052BCC1AD79C"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("YCSQLC:D:20");
        ...
        expBarItem3.setExpViewId("YCSQLC:D:20:10");
        ...
        expBarItem4.setExpViewId("YCSQLC:D:20:20");
        ...
        expBarItem5.setExpViewId("YCSQLC:D:30");
        ...
        expBarItem6.setExpViewId("YCSQLC:D:40");
        ...
        expBarItem7.setExpViewId("YCSQLC:W");
        ...
        expBarItem8.setExpViewId("YCSQLC:W:10");
        ...
        expBarItem9.setExpViewId("YCSQLC:W:20");
