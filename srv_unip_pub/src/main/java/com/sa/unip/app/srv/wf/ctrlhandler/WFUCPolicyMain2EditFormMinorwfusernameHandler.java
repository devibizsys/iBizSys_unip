...
public class WFUCPolicyMain2EditFormMinorwfusernameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFUCPolicyMain2EditFormMinorwfusernameHandler()  {
        super();
    }
