...
/**
 * 实体[微信访问票据]编辑表单[form]部件模型
 */
public class WXAccessTokenMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WXAccessTokenMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXACCESSTOKENID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信访问票据标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXACCESSTOKENNAME");
            formItem.setCaption("微信访问票据名称");
        ...
        this.registerFormItem(iFormItem);
        // wxaccesstokenname
        iFormItem = this.createFormItem("wxaccesstokenname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxaccesstokenname");
            formItem.setDEFName("WXACCESSTOKENNAME");
            formItem.setCaption("微信访问票据名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxaccesstokenname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxaccesstokenid
        iFormItem = this.createFormItem("wxaccesstokenid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxaccesstokenid");
            formItem.setDEFName("WXACCESSTOKENID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信访问票据标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxaccesstokenid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
