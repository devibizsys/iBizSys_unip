...
/**
 * 应用视图[OrgSectorCurOrgPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgSectorCurOrgPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSectorMain2GridModel gridModel = null;
    public OrgSectorCurOrgPickupGridViewGridHandler()  {
        super();
    }
