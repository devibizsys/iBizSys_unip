...
/**
 * 实体[数据审计明细]编辑表单[form]部件模型
 */
public class DataAuditDetailMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DataAuditDetailMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATAAUDITDETAILID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据审计明细标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATAAUDITDETAILNAME");
            formItem.setEnableCond(0);
            formItem.setCaption("属性");
        ...
        this.registerFormItem(iFormItem);
        // dataauditdetailname
        iFormItem = this.createFormItem("dataauditdetailname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dataauditdetailname");
            formItem.setDEFName("DATAAUDITDETAILNAME");
            formItem.setEnableCond(0);
            formItem.setCaption("属性");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dataauditdetailname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // dataauditdetailid
        iFormItem = this.createFormItem("dataauditdetailid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dataauditdetailid");
            formItem.setDEFName("DATAAUDITDETAILID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据审计明细标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dataauditdetailid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
