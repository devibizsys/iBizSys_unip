...
/**
 * 应用视图[OA_PCSQPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_PCSQPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_PCSQMainGridModel gridModel = null;
    public OA_PCSQPickupGridViewGridHandler()  {
        super();
    }
