...
/**
 * 视图[OA_YBHYSQPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQPickupView.do")
public class OA_YBHYSQPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_YBHYSQPickupViewController() throws Exception {
        super();
        this.setId("73c26439e9c41a8557c49220fd113a52");
        this.setCaption("会议申请");
        this.setTitle("会议申请数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_YBHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YBHYSQ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQPickupViewController",this);
    }
