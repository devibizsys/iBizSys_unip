...
/**
 * 视图[WFActorMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFActorMPickupView.do")
public class WFActorMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFActorMPickupViewController() throws Exception {
        super();
        this.setId("c54beaf4a4537a6e89a8b6abd0b8700f");
        this.setCaption("工作流操作者");
        this.setTitle("工作流操作者实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFActorMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFActorMPickupViewController",this);
    }
