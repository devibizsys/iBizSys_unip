...
/**
 * 视图[MsgTemplateRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgTemplateRedirectView.do")
public class MsgTemplateRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public MsgTemplateRedirectViewController() throws Exception {
        super();
        this.setId("0a8f71c87f965f844049a47ba5804a2d");
        this.setCaption("消息模板");
        this.setTitle("消息模板实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/MsgTemplateRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgTemplateRedirectViewController",this);
    }
