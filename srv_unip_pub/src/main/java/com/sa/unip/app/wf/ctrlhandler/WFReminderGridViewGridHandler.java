...
import com.sa.unip.app.srv.wf.ctrlmodel.WFReminderMainGridModel;
...
/**
 * 应用视图[WFReminderGridView]表格[grid]后台处理对象基类
 */
public class WFReminderGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFReminderMainGridModel gridModel = null;
    public WFReminderGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFReminderMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFReminderMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFReminder entity)throws Exception {
