...
import com.sa.unip.app.srv.wx.ctrlmodel.WXAccessTokenMainGridModel;
...
/**
 * 应用视图[WXAccessTokenGridView]表格[grid]后台处理对象基类
 */
public class WXAccessTokenGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXAccessTokenMainGridModel gridModel = null;
    public WXAccessTokenGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WXAccessTokenMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WXAccessTokenMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WXAccessToken entity)throws Exception {
