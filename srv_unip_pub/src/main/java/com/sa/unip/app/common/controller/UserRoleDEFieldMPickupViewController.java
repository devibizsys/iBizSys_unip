...
/**
 * 视图[UserRoleDEFieldMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDEFieldMPickupView.do")
public class UserRoleDEFieldMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserRoleDEFieldMPickupViewController() throws Exception {
        super();
        this.setId("a828923ed2060a894f91fcdb586d0ad5");
        this.setCaption("用户角色实体属性访问");
        this.setTitle("用户角色实体属性访问实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDEFieldMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDEFieldMPickupViewController",this);
    }
