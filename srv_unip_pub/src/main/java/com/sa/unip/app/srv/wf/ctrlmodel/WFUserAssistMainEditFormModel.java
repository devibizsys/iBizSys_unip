...
/**
 * 实体[工作流用户代办]编辑表单[form]部件模型
 */
public class WFUserAssistMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUserAssistMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERASSISTID");
            formItem.setCaption("工作流用户代办标识");
        ...
        this.registerFormItem(iFormItem);
        // wfstep
        iFormItem = this.createFormItem("wfstep");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfstep");
            formItem.setDEFName("WFSTEP");
            formItem.setCaption("代办步骤");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfstep");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfuserassistid
        iFormItem = this.createFormItem("wfuserassistid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfuserassistid");
            formItem.setDEFName("WFUSERASSISTID");
            formItem.setCaption("工作流用户代办标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfuserassistid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
