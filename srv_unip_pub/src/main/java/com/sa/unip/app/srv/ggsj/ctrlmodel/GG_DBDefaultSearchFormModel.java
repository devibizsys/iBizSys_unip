...
/**
 * 实体[待办]搜索表单[searchform]部件模型
 */
public class  GG_DBDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public GG_DBDefaultSearchFormModel() {
        super();
