...
/**
 * 应用视图[DataSyncOutPickupGridView]表格[grid]后台处理对象基类
 */
public class DataSyncOutPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncOutMainGridModel gridModel = null;
    public DataSyncOutPickupGridViewGridHandler()  {
        super();
    }
