...
/**
 * 实体[数据同步代理]数据关系栏[drbar]部件模型
 */
public class  DataSyncAgentDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DataSyncAgentDefaultDRBarModel() {
        super();
    }
    ...
    protected  net.ibizsys.psrt.srv.common.demodel.DataSyncAgentDEModel getDataSyncAgentDEModel() {
