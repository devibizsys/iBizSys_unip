...
/**
 * 视图[OA_JPYDGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_JPYDGridView.do")
public class OA_JPYDGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_JPYDGridViewController() throws Exception {
        super();
        this.setId("87ab21684d11ed316bcab204080c4cdf");
        this.setCaption("机票预订");
        this.setTitle("机票预订表格视图");
        this.setCapLanResTag("DE.LNAME.OA_JPYD");
        this.setTitleLanResTag("PAGE.TITLE.OA_JPYD.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_JPYDGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_JPYDGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_JPYDGridViewSearchFormHandler");
        searchForm.init(this);
