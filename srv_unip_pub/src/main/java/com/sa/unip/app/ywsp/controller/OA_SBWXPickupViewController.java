...
/**
 * 视图[OA_SBWXPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXPickupView.do")
public class OA_SBWXPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_SBWXPickupViewController() throws Exception {
        super();
        this.setId("6c9f2f10d6208003268f2ee46a3fd05c");
        this.setCaption("设备维修");
        this.setTitle("设备维修数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_SBWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_SBWX.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXPickupViewController",this);
    }
