...
public class OA_NSJGHYSQGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_NSJGHYSQDefaultSearchFormModel searchformModel = null;
    public OA_NSJGHYSQGridViewSearchFormHandler()  {
        super();
    }
