...
/**
 * 视图[TSSDGroupRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDGroupRedirectView.do")
public class TSSDGroupRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public TSSDGroupRedirectViewController() throws Exception {
        super();
        this.setId("e9a27262a4bc87f8c6a7785cbb579ca3");
        this.setCaption("任务时刻策略组");
        this.setTitle("任务时刻策略组实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/TSSDGroupRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDGroupRedirectViewController",this);
    }
