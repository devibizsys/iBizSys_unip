...
/**
 * 视图[OA_STWMDGPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGPickupGridView.do")
public class OA_STWMDGPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_STWMDGPickupGridViewController() throws Exception {
        super();
        this.setId("7cafb6cc7410766a42c3ea7cbcca7274");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_STWMDG");
        this.setTitleLanResTag("PAGE.TITLE.OA_STWMDG.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGPickupGridViewSearchFormHandler");
        searchForm.init(this);
