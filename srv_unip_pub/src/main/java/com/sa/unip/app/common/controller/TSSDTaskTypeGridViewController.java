...
/**
 * 视图[TSSDTaskTypeGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskTypeGridView.do")
public class TSSDTaskTypeGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public TSSDTaskTypeGridViewController() throws Exception {
        super();
        this.setId("859d383388ad22a26a5f618d52743012");
        this.setCaption("任务调度任务类型");
        this.setTitle("任务调度任务类型实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskTypeGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskTypeGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDTaskTypeGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDTaskTypeGridViewSearchFormHandler");
        searchForm.init(this);
