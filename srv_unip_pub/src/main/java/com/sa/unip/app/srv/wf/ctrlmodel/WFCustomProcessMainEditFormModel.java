...
/**
 * 实体[工作流预定义处理]编辑表单[form]部件模型
 */
public class WFCustomProcessMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFCustomProcessMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFCUSTOMPROCESSID");
            formItem.setCaption("工作流预定义处理标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFCUSTOMPROCESSID");
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFCUSTOMPROCESSNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfcustomprocessid
        iFormItem = this.createFormItem("wfcustomprocessid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfcustomprocessid");
            formItem.setDEFName("WFCUSTOMPROCESSID");
            formItem.setCaption("工作流预定义处理标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfcustomprocessid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
