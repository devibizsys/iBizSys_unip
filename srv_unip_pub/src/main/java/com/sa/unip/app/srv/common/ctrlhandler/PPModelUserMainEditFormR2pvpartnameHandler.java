...
public class PPModelUserMainEditFormR2pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormR2pvpartnameHandler()  {
        super();
    }
