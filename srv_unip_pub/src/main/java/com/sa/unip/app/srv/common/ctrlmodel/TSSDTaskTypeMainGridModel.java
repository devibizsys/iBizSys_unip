...
/**
 * 实体[任务调度任务类型]数据表格[grid]部件模型
 */
public class  TSSDTaskTypeMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public TSSDTaskTypeMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.TSSDTaskTypeDEModel tSSDTaskTypeDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.TSSDTaskTypeDEModel getTSSDTaskTypeDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 任务类型名称
        iGridColumn = createGridColumn("tssdtasktypename");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("tssdtasktypename");
            gridColumnModel.setDataItemName("tssdtasktypename");
            gridColumnModel.setCaption("任务类型名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 tssdtasktypename
        iGridDataItem = createGridDataItem("tssdtasktypename");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdtasktypename");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDTASKTYPENAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        if(iGridDataItem == null) {
            ...
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDTASKTYPEID");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 tssdtasktypeid
        iGridDataItem = createGridDataItem("tssdtasktypeid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdtasktypeid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDTASKTYPEID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("TSSDTASKTYPEID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("任务调度任务类型标识");
