...
/**
 * 视图[OA_PCSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_PCSQEditView.do")
public class OA_PCSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_PCSQEditViewController() throws Exception {
        super();
        this.setId("fef4a847f0839bfb329bd1cd2260449f");
        this.setCaption("派车申请");
        this.setTitle("派车申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_PCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_PCSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_PCSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_PCSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_PCSQEditViewEditFormHandler");
        editForm.init(this);
