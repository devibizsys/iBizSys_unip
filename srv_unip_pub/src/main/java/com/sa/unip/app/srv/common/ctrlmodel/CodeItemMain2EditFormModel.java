...
/**
 * 实体[代码项]编辑表单[form]部件模型
 */
public class CodeItemMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public CodeItemMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("CODEITEMID");
            formItem.setCaption("代码项标识");
        ...
        this.registerFormItem(iFormItem);
        // pcodeitemname
        iFormItem = this.createFormItem("pcodeitemname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("pcodeitemname");
            formItem.setDEFName("PCODEITEMNAME");
            formItem.setCaption("上级代码项");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("pcodeitemname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // codeitemname
        iFormItem = this.createFormItem("codeitemname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("codeitemname");
            formItem.setDEFName("CODEITEMNAME");
            formItem.setCaption("代码项名称");
            formItem.setAllowEmpty(false);
        ...
        this.registerFormItem(iFormItem);
        // codeitemvalue
        iFormItem = this.createFormItem("codeitemvalue");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("codeitemvalue");
            formItem.setDEFName("CODEITEMVALUE");
            formItem.setCaption("代码项值");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("codeitemvalue");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // shortkey
        iFormItem = this.createFormItem("shortkey");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("shortkey");
            formItem.setDEFName("SHORTKEY");
            formItem.setCaption("快捷输入");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("shortkey");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // codeitemid
        iFormItem = this.createFormItem("codeitemid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("codeitemid");
            formItem.setDEFName("CODEITEMID");
            formItem.setCaption("代码项标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("codeitemid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // pcodeitemid
        iFormItem = this.createFormItem("pcodeitemid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("pcodeitemid");
            formItem.setDEFName("PCODEITEMID");
            formItem.setCaption("上级代码项");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("pcodeitemid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
