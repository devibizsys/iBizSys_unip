...
/**
 * 视图[UserDictItemMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserDictItemMPickupView.do")
public class UserDictItemMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserDictItemMPickupViewController() throws Exception {
        super();
        this.setId("b00f52efd6eb694d3321fd4d7a53e7f2");
        this.setCaption("用户词条");
        this.setTitle("用户词典词条实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserDictItemMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserDictItemMPickupViewController",this);
    }
