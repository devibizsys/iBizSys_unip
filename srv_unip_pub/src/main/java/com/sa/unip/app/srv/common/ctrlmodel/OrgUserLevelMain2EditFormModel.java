...
/**
 * 实体[组织人员级别]编辑表单[form]部件模型
 */
public class OrgUserLevelMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OrgUserLevelMain2EditFormModel()  {
        super();
        this.setName("form");
    }
