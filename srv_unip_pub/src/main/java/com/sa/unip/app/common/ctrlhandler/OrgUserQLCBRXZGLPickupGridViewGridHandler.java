...
/**
 * 应用视图[OrgUserQLCBRXZGLPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgUserQLCBRXZGLPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserMain2GridModel gridModel = null;
    public OrgUserQLCBRXZGLPickupGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchQLCBRXZGL(deDataSetFetchContext);
    }
