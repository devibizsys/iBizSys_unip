...
/**
 * 应用视图[OrgSectorCurOrgXJBMGridView]表格[grid]后台处理对象基类
 */
public class OrgSectorCurOrgXJBMGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSectorMain2GridModel gridModel = null;
    public OrgSectorCurOrgXJBMGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchUX_ORGSECTORXJBM(deDataSetFetchContext);
    }
