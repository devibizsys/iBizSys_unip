...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUserMainGridModel;
...
/**
 * 应用视图[WFUserPickupGridView]表格[grid]后台处理对象基类
 */
public class WFUserPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserMainGridModel gridModel = null;
    public WFUserPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFUserMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFUserMainGridModel getRealGridModel() {
