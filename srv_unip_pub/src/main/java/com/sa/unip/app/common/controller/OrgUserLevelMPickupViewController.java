...
/**
 * 视图[OrgUserLevelMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserLevelMPickupView.do")
public class OrgUserLevelMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OrgUserLevelMPickupViewController() throws Exception {
        super();
        this.setId("8f68f7e931ee898fd0c541ef14764e51");
        this.setCaption("组织人员级别");
        this.setTitle("组织人员级别实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgUserLevelMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserLevelMPickupViewController",this);
    }
