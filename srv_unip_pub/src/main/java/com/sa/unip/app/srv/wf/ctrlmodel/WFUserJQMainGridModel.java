...
/**
 * 实体[工作流用户]数据表格[grid]部件模型
 */
public class  WFUserJQMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFUserJQMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("工作流用户名称");
        ...
        //建立表格列 是否接收工作
        iGridColumn = createGridColumn("isrecvwork");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("isrecvwork");
            gridColumnModel.setDataItemName("isrecvwork");
            gridColumnModel.setCaption("是否接收工作");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 接收工作通知
        iGridColumn = createGridColumn("recvinform");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("recvinform");
            gridColumnModel.setDataItemName("recvinform");
            gridColumnModel.setCaption("接收工作通知");
            gridColumnModel.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 recvinform
        iGridDataItem = createGridDataItem("recvinform");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("recvinform");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("RECVINFORM");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 isrecvwork
        iGridDataItem = createGridDataItem("isrecvwork");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("isrecvwork");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("ISRECVWORK");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFUSERID");
            gridEditItem.setCaption("工作流用户标识");
