...
import com.sa.unip.app.srv.common.ctrlmodel.RegistryMainGridModel;
...
/**
 * 应用视图[RegistryGridView]表格[grid]后台处理对象基类
 */
public class RegistryGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected RegistryMainGridModel gridModel = null;
    public RegistryGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (RegistryMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected RegistryMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(Registry entity)throws Exception {
