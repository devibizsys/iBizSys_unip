...
/**
 * 视图[MsgTemplatePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgTemplatePickupView.do")
public class MsgTemplatePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public MsgTemplatePickupViewController() throws Exception {
        super();
        this.setId("c7fa6c451e3b9ff4878371f4c0c563d4");
        this.setCaption("消息模板");
        this.setTitle("消息模板实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/MsgTemplatePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgTemplatePickupViewController",this);
    }
