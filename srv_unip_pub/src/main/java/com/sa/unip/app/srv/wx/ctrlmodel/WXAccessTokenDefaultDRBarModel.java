...
/**
 * 实体[微信访问票据]数据关系栏[drbar]部件模型
 */
public class  WXAccessTokenDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WXAccessTokenDefaultDRBarModel() {
        super();
    }
