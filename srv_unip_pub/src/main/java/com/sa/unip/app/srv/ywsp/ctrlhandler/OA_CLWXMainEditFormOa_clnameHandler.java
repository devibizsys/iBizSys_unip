...
public class OA_CLWXMainEditFormOa_clnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OA_CLWXMainEditFormOa_clnameHandler()  {
        super();
    }
