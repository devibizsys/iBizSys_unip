...
/**
 * 视图[OA_GZRZEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_GZRZEditView.do")
public class OA_GZRZEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_GZRZEditViewController() throws Exception {
        super();
        this.setId("fb109b2d35710d7c9fe924797613af5f");
        this.setCaption("工作日志");
        this.setTitle("工作日志编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_GZRZEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_GZRZEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_GZRZEditViewEditFormHandler");
        editForm.init(this);
