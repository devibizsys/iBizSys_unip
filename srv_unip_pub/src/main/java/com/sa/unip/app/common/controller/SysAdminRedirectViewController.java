...
/**
 * 视图[SysAdminRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/SysAdminRedirectView.do")
public class SysAdminRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public SysAdminRedirectViewController() throws Exception {
        super();
        this.setId("3cdef051cf927ea3d14a29d541f45386");
        this.setCaption("系统管理模块");
        this.setTitle("系统管理模块实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/SysAdminRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.SysAdminRedirectViewController",this);
    }
