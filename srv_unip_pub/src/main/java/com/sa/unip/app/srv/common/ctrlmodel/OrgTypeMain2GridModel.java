...
/**
 * 实体[组织类型]数据表格[grid]部件模型
 */
public class  OrgTypeMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public OrgTypeMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 组织类型标识
        iGridColumn = createGridColumn("orgtypeid");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("orgtypeid");
            gridColumnModel.setDataItemName("orgtypeid");
            gridColumnModel.setCaption("组织类型标识");
        ...
        //建立表格列 组织类型名称
        iGridColumn = createGridColumn("orgtypename");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("orgtypename");
            gridColumnModel.setDataItemName("orgtypename");
            gridColumnModel.setCaption("组织类型名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 orgtypename
        iGridDataItem = createGridDataItem("orgtypename");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("orgtypename");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("ORGTYPENAME");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 orgtypeid
        iGridDataItem = createGridDataItem("orgtypeid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("orgtypeid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("ORGTYPEID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("ORGTYPEID");
            gridEditItem.setCaption("组织类型标识");
