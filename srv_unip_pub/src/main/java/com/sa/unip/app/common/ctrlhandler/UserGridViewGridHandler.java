...
import com.sa.unip.app.srv.common.ctrlmodel.UserMain2GridModel;
...
/**
 * 应用视图[UserGridView]表格[grid]后台处理对象基类
 */
public class UserGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserMain2GridModel gridModel = null;
    public UserGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(User entity)throws Exception {
