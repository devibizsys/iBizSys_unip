...
/**
 * 视图[DataSyncInRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncInRedirectView.do")
public class DataSyncInRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public DataSyncInRedirectViewController() throws Exception {
        super();
        this.setId("d650c02559b5cbea87e3be6478aec9e2");
        this.setCaption("数据同步接收队列");
        this.setTitle("数据同步接收队列实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/DataSyncInRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncInRedirectViewController",this);
    }
