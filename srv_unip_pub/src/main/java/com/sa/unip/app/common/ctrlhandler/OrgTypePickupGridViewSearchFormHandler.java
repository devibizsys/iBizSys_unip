...
public class OrgTypePickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgTypeDefaultSearchFormModel searchformModel = null;
    public OrgTypePickupGridViewSearchFormHandler()  {
        super();
    }
