...
/**
 * 实体[组消息账户明细]搜索表单[searchform]部件模型
 */
public class  MsgAccountDetailDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public MsgAccountDetailDefaultSearchFormModel() {
        super();
