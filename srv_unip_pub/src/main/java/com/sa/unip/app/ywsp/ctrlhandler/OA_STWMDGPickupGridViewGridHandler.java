...
/**
 * 应用视图[OA_STWMDGPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_STWMDGPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_STWMDGMainGridModel gridModel = null;
    public OA_STWMDGPickupGridViewGridHandler()  {
        super();
    }
