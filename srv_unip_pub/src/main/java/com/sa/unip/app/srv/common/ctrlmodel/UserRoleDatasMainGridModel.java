...
/**
 * 实体[用户角色数据能力]数据表格[grid]部件模型
 */
public class  UserRoleDatasMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserRoleDatasMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 用户角色
        iGridColumn = createGridColumn("userrolename");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("userrolename");
            gridColumnModel.setDataItemName("userrolename");
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("实体数据能力");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 userroledatasid
        iGridDataItem = createGridDataItem("userroledatasid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userroledatasid");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 userrolename
        iGridDataItem = createGridDataItem("userrolename");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userrolename");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERROLENAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERROLEDATASID");
            gridEditItem.setCaption("用户角色数据能力标识");
