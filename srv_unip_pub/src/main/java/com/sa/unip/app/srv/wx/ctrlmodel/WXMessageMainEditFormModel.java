...
/**
 * 实体[微信消息]编辑表单[form]部件模型
 */
public class WXMessageMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WXMessageMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.wx.demodel.WXMessageDEModel wXMessageDEModel;
    protected  net.ibizsys.psrt.srv.wx.demodel.WXMessageDEModel getWXMessageDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXMESSAGEID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信消息标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXMESSAGEID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXMESSAGENAME");
            formItem.setCaption("微信消息名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXMESSAGENAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxmessagename
        iFormItem = this.createFormItem("wxmessagename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxmessagename");
            formItem.setDEFName("WXMESSAGENAME");
            formItem.setCaption("微信消息名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxmessagename");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxmessageid
        iFormItem = this.createFormItem("wxmessageid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxmessageid");
            formItem.setDEFName("WXMESSAGEID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信消息标识");
