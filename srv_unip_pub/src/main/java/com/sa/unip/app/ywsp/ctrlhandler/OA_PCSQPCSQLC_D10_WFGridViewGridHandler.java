...
/**
 * 应用视图[OA_PCSQPCSQLC_D10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_PCSQPCSQLC_D10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_PCSQMainGridModel gridModel = null;
    public OA_PCSQPCSQLC_D10_WFGridViewGridHandler()  {
        super();
    }
