...
public class PPModelUserMainEditFormL2pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormL2pvpartnameHandler()  {
        super();
    }
