...
/**
 * 实体[数据对象能力明细]数据关系栏[drbar]部件模型
 */
public class  UserRoleDataDetailDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserRoleDataDetailDefaultDRBarModel() {
        super();
    }
