...
/**
 * 实体[系统管理模块]数据表格[grid]部件模型
 */
public class  SysAdminMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public SysAdminMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 系统管理名称
        iGridColumn = createGridColumn("sysadminname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("sysadminname");
            gridColumnModel.setDataItemName("sysadminname");
            gridColumnModel.setCaption("系统管理名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 sysadminname
        iGridDataItem = createGridDataItem("sysadminname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("sysadminname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("SYSADMINID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("系统管理标识");
