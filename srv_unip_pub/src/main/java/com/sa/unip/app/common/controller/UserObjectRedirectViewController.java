...
/**
 * 视图[UserObjectRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserObjectRedirectView.do")
public class UserObjectRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserObjectRedirectViewController() throws Exception {
        super();
        this.setId("fcbd9103f0ff2f8f8c58ca68cc23f69d");
        this.setCaption("用户对象");
        this.setTitle("用户对象实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserObjectRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserObjectRedirectViewController",this);
    }
