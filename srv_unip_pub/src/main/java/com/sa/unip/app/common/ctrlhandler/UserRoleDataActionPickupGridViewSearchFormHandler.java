...
public class UserRoleDataActionPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected UserRoleDataActionDefaultSearchFormModel searchformModel = null;
    public UserRoleDataActionPickupGridViewSearchFormHandler()  {
        super();
    }
