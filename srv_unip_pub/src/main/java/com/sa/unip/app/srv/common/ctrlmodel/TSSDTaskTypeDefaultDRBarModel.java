...
/**
 * 实体[任务调度任务类型]数据关系栏[drbar]部件模型
 */
public class  TSSDTaskTypeDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDTaskTypeDefaultDRBarModel() {
        super();
    }
