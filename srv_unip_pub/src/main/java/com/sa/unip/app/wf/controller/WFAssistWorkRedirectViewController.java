...
/**
 * 视图[WFAssistWorkRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFAssistWorkRedirectView.do")
public class WFAssistWorkRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFAssistWorkRedirectViewController() throws Exception {
        super();
        this.setId("f0265ee45dbb7fbb00796fda09045e34");
        this.setCaption("工作流代办工作");
        this.setTitle("工作流代办工作实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFAssistWorkRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFAssistWorkRedirectViewController",this);
    }
