...
/**
 * 应用视图[GG_DBGridView]表格[grid]后台处理对象基类
 */
public class GG_DBGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected GG_DBMainGridModel gridModel = null;
    public GG_DBGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(GG_DB entity)throws Exception {
