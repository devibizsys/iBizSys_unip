...
public class OrgSecUserMain2EditFormOrgnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OrgSecUserMain2EditFormOrgnameHandler()  {
        super();
    }
