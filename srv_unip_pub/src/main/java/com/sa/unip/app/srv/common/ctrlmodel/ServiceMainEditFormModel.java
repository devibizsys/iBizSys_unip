...
/**
 * 实体[服务]编辑表单[form]部件模型
 */
public class ServiceMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public ServiceMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SERVICEID");
            formItem.setEnableCond(1);
            formItem.setCaption("服务标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("SERVICEID");
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("SERVICENAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // servicename
        iFormItem = this.createFormItem("servicename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("servicename");
            formItem.setDEFName("SERVICENAME");
            formItem.setCaption("服务名称");
        ...
        this.registerFormItem(iFormItem);
        // container
        iFormItem = this.createFormItem("container");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("container");
        ...
        this.registerFormItem(iFormItem);
        // startmode
        iFormItem = this.createFormItem("startmode");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("startmode");
            formItem.setDEFName("STARTMODE");
            formItem.setCodeListId("net.ibizsys.psrt.srv.codelist.ServiceStartModeCodeListModel");
            formItem.setCaption("启动模式");
            formItem.setAllowEmpty(false);
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("startmode");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // runorder
        iFormItem = this.createFormItem("runorder");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("runorder");
            formItem.setDEFName("RUNORDER");
            formItem.setCaption("服务次序");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("runorder");
        ...
        this.registerFormItem(iFormItem);
        // servicestate
        iFormItem = this.createFormItem("servicestate");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("servicestate");
            formItem.setDEFName("SERVICESTATE");
            formItem.setEnableCond(0);
            formItem.setIgnoreInput(3);
            formItem.setCodeListId("net.ibizsys.psrt.srv.codelist.ServiceRunStateCodeListModel");
            formItem.setCaption("服务运行状态");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("servicestate");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("net.ibizsys.psrt.srv.codelist.ServiceRunStateCodeListModel");
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
        }
        ...
        this.registerFormItem(iFormItem);
        // serviceobject
        iFormItem = this.createFormItem("serviceobject");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("serviceobject");
            formItem.setDEFName("SERVICEOBJECT");
            formItem.setCaption("服务对象");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("serviceobject");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // serviceparam
        iFormItem = this.createFormItem("serviceparam");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("serviceparam");
            formItem.setDEFName("SERVICEPARAM");
            formItem.setCaption("服务参数");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("serviceparam");
            dataItem.setDataType(21);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // serviceid
        iFormItem = this.createFormItem("serviceid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("serviceid");
            formItem.setDEFName("SERVICEID");
            formItem.setEnableCond(1);
            formItem.setCaption("服务标识");
