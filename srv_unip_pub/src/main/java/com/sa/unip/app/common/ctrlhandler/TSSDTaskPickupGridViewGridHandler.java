...
/**
 * 应用视图[TSSDTaskPickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDTaskPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDTaskMainGridModel gridModel = null;
    public TSSDTaskPickupGridViewGridHandler()  {
        super();
    }
