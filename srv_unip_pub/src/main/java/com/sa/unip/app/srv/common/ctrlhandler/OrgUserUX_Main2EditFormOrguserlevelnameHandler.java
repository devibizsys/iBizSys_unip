...
public class OrgUserUX_Main2EditFormOrguserlevelnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OrgUserUX_Main2EditFormOrguserlevelnameHandler()  {
        super();
    }
