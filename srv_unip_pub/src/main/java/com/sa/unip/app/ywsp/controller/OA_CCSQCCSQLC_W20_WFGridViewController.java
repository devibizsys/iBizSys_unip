...
/**
 * 视图[OA_CCSQCCSQLC_W20_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQCCSQLC_W20_WFGridView.do")
public class OA_CCSQCCSQLC_W20_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_CCSQCCSQLC_W20_WFGridViewController() throws Exception {
        super();
        this.setId("c8f110230ca5f6e370061a71e2aa4086");
        this.setCaption("出差申请");
        this.setTitle("出差申请工作流表格视图(出差申请流程:承办处领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQCCSQLC_W20_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQCCSQLC_W20_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQCCSQLC_W20_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQCCSQLC_W20_WFGridViewSearchFormHandler");
        searchForm.init(this);
