...
/**
 * 视图[OA_BGYPSQMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQMPickupView.do")
public class OA_BGYPSQMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_BGYPSQMPickupViewController() throws Exception {
        super();
        this.setId("3676faa59e0a3be0bc40a32f4ac7f644");
        this.setCaption("办公用品申请");
        this.setTitle("办公用品申请数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_BGYPSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_BGYPSQ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQMPickupViewController",this);
    }
