...
/**
 * 应用视图[DEDataChgDispPickupGridView]表格[grid]后台处理对象基类
 */
public class DEDataChgDispPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DEDataChgDispMainGridModel gridModel = null;
    public DEDataChgDispPickupGridViewGridHandler()  {
        super();
    }
