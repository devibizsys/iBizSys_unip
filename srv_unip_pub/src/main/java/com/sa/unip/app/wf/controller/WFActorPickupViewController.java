...
/**
 * 视图[WFActorPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFActorPickupView.do")
public class WFActorPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFActorPickupViewController() throws Exception {
        super();
        this.setId("7ed2dd3f51c7568021ad556b465b32c9");
        this.setCaption("工作流操作者");
        this.setTitle("工作流操作者实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFActorPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFActorPickupViewController",this);
    }
