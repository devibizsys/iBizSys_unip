...
/**
 * 视图[PortalPageMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PortalPageMPickupView.do")
public class PortalPageMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public PortalPageMPickupViewController() throws Exception {
        super();
        this.setId("07e4cc01d1e17ca240e5e2900adced7a");
        this.setCaption("门户页面");
        this.setTitle("门户页面实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/PortalPageMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PortalPageMPickupViewController",this);
    }
