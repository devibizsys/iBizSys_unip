...
/**
 * 实体[工作流用户候选者]编辑表单[form]部件模型
 */
public class WFUserCandidateMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUserCandidateMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.wf.demodel.WFUserCandidateDEModel wFUserCandidateDEModel;
    protected  net.ibizsys.psrt.srv.wf.demodel.WFUserCandidateDEModel getWFUserCandidateDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERCANDIDATEID");
            formItem.setCaption("工作流用户候选者标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUSERCANDIDATEID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERCANDIDATENAME");
            formItem.setCaption("工作流用户候选者名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUSERCANDIDATENAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfmajorusername
        iFormItem = this.createFormItem("wfmajorusername");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfmajorusername");
            formItem.setDEFName("WFMAJORUSERNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("工作流主用户");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfmajorusername");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfminorusername
        iFormItem = this.createFormItem("wfminorusername");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfminorusername");
            formItem.setDEFName("WFMINORUSERNAME");
            formItem.setCaption("工作流候选用户");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfminorusername");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // candidateorder
        iFormItem = this.createFormItem("candidateorder");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("candidateorder");
            formItem.setDEFName("CANDIDATEORDER");
            formItem.setCaption("候选次序");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("candidateorder");
        ...
        this.registerFormItem(iFormItem);
        // wfminoruserid
        iFormItem = this.createFormItem("wfminoruserid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfminoruserid");
            formItem.setDEFName("WFMINORUSERID");
            formItem.setCaption("工作流候选用户");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfminoruserid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfmajoruserid
        iFormItem = this.createFormItem("wfmajoruserid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfmajoruserid");
            formItem.setDEFName("WFMAJORUSERID");
            formItem.setEnableCond(1);
            formItem.setCaption("工作流主用户");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfmajoruserid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfusercandidateid
        iFormItem = this.createFormItem("wfusercandidateid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfusercandidateid");
            formItem.setDEFName("WFUSERCANDIDATEID");
            formItem.setCaption("工作流用户候选者标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfusercandidateid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
