...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserLevelMain2GridModel;
...
/**
 * 应用视图[OrgUserLevelPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgUserLevelPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserLevelMain2GridModel gridModel = null;
    public OrgUserLevelPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgUserLevelMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgUserLevelMain2GridModel getRealGridModel() {
