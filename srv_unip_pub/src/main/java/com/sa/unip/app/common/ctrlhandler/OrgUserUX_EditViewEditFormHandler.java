...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserUX_Main2EditFormModel;
...
public class OrgUserUX_EditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OrgUserUX_Main2EditFormModel editformModel = null;
    public OrgUserUX_EditViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OrgUserUX_Main2EditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OrgUserUX_Main2EditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.OrgUserUX_Main2EditFormOrgsectornameHandler");
        ...
        IFormItemHandler orgsecusertypenameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.OrgUserUX_Main2EditFormOrgsecusertypenameHandler");
        ...
        //注册 'orguserlevelname'
        IFormItemHandler orguserlevelnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.OrgUserUX_Main2EditFormOrguserlevelnameHandler");
