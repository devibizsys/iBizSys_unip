...
/**
 * 视图[OA_YYSSQYYSSQ_W10_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YYSSQYYSSQ_W10_WFEditView3.do")
public class OA_YYSSQYYSSQ_W10_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_YYSSQYYSSQ_W10_WFEditView3Controller() throws Exception {
        super();
        this.setId("4546b14e27f2c39794baf19a2f00f42e");
        this.setCaption("饮用水申请");
        this.setTitle("饮用水申请工作流视图(饮用水申请流程v1:部门领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YYSSQYYSSQ_W10_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YYSSQYYSSQ_W10_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YYSSQYYSSQ_W10_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YYSSQYYSSQ_W10_WFEditView3EditFormHandler");
        editForm.init(this);
