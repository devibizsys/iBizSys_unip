...
/**
 * 视图[OA_SBWXEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXEditView.do")
public class OA_SBWXEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_SBWXEditViewController() throws Exception {
        super();
        this.setId("9d444d0e6b62377360fb9c40ed4d3127");
        this.setCaption("设备维修");
        this.setTitle("设备维修编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_SBWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_SBWX.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXEditViewEditFormHandler");
        editForm.init(this);
