...
/**
 * 实体[用户角色]数据表格[grid]部件模型
 */
public class  UserRoleMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserRoleMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("用户角色名称");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERROLEID");
            gridEditItem.setCaption("用户角色标识");
