...
/**
 * 实体[代码表]编辑表单[form]部件模型
 */
public class CodeListMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public CodeListMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("CODELISTID");
            formItem.setCaption("代码表标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("CODELISTNAME");
            formItem.setCaption("代码表名称");
        ...
        this.registerFormItem(iFormItem);
        // codelistid
        iFormItem = this.createFormItem("codelistid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("codelistid");
            formItem.setDEFName("CODELISTID");
            formItem.setCaption("代码表标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("codelistid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // codelistname
        iFormItem = this.createFormItem("codelistname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("codelistname");
            formItem.setDEFName("CODELISTNAME");
            formItem.setCaption("代码表名称");
