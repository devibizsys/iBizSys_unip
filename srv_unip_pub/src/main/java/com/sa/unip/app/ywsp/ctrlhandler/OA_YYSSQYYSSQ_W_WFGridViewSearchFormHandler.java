...
public class OA_YYSSQYYSSQ_W_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_YYSSQDefaultSearchFormModel searchformModel = null;
    public OA_YYSSQYYSSQ_W_WFGridViewSearchFormHandler()  {
        super();
    }
