...
/**
 * 实体[数据同步接收队列]编辑表单[form]部件模型
 */
public class DataSyncInMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DataSyncInMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCINID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据同步接收队列标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCINNAME");
            formItem.setCaption("数据同步接收队列名称");
        ...
        this.registerFormItem(iFormItem);
        // datasyncinname
        iFormItem = this.createFormItem("datasyncinname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncinname");
            formItem.setDEFName("DATASYNCINNAME");
            formItem.setCaption("数据同步接收队列名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datasyncinname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // datasyncinid
        iFormItem = this.createFormItem("datasyncinid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncinid");
            formItem.setDEFName("DATASYNCINID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据同步接收队列标识");
