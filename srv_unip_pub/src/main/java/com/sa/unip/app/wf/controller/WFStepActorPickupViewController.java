...
/**
 * 视图[WFStepActorPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepActorPickupView.do")
public class WFStepActorPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFStepActorPickupViewController() throws Exception {
        super();
        this.setId("e255f470fc60fa305c15afdc8180e03e");
        this.setCaption("工作流步骤操作者");
        this.setTitle("工作流步骤操作者实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFStepActorPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepActorPickupViewController",this);
    }
