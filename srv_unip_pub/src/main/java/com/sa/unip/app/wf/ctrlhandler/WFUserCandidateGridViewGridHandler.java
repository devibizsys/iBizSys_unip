...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUserCandidateMainGridModel;
...
/**
 * 应用视图[WFUserCandidateGridView]表格[grid]后台处理对象基类
 */
public class WFUserCandidateGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserCandidateMainGridModel gridModel = null;
    public WFUserCandidateGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFUserCandidateMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFUserCandidateMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFUserCandidate entity)throws Exception {
