...
import com.sa.unip.app.srv.xxtz.ctrlmodel.OA_TZGGSHYJFormEditFormModel;
...
public class OA_TZGGWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_TZGGSHYJFormEditFormModel editformModel = null;
    public OA_TZGGWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_TZGGSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_TZGGSHYJFormEditFormModel getRealEditFormModel() {
