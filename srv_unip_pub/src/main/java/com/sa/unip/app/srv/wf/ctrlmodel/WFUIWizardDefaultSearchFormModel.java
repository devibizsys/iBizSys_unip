...
/**
 * 实体[工作流操作界面]搜索表单[searchform]部件模型
 */
public class  WFUIWizardDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WFUIWizardDefaultSearchFormModel() {
        super();
