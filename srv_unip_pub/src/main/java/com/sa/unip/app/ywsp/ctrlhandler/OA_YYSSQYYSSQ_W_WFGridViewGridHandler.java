...
/**
 * 应用视图[OA_YYSSQYYSSQ_W_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_YYSSQYYSSQ_W_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_YYSSQMainGridModel gridModel = null;
    public OA_YYSSQYYSSQ_W_WFGridViewGridHandler()  {
        super();
    }
