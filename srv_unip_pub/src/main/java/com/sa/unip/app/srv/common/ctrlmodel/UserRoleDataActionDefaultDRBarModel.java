...
/**
 * 实体[用户角色数据操作]数据关系栏[drbar]部件模型
 */
public class  UserRoleDataActionDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserRoleDataActionDefaultDRBarModel() {
        super();
    }
