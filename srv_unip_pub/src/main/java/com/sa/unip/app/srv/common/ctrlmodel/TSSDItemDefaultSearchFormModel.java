...
/**
 * 实体[任务时刻策略项]搜索表单[searchform]部件模型
 */
public class  TSSDItemDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public TSSDItemDefaultSearchFormModel() {
        super();
