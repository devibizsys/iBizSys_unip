...
/**
 * 实体[微信多媒体内容]搜索表单[searchform]部件模型
 */
public class  WXMediaDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WXMediaDefaultSearchFormModel() {
        super();
