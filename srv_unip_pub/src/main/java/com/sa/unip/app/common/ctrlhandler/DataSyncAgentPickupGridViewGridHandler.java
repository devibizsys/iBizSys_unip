...
/**
 * 应用视图[DataSyncAgentPickupGridView]表格[grid]后台处理对象基类
 */
public class DataSyncAgentPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncAgentMainGridModel gridModel = null;
    public DataSyncAgentPickupGridViewGridHandler()  {
        super();
    }
