...
/**
 * 应用视图[UserRoleDetailPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDetailPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDetailMain2GridModel gridModel = null;
    public UserRoleDetailPickupGridViewGridHandler()  {
        super();
    }
