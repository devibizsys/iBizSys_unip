...
/**
 * 视图[OrgUserQLCBRXZGLPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserQLCBRXZGLPickupView.do")
public class OrgUserQLCBRXZGLPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgUserQLCBRXZGLPickupViewController() throws Exception {
        super();
        this.setId("2e42d8ca017562cade236de1b326bd25");
        this.setCaption("组织人员");
        this.setTitle("权利组织人员实体数据选择过滤视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgUserQLCBRXZGLPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserQLCBRXZGLPickupViewController",this);
    }
