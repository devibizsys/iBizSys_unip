...
/**
 * 视图[MsgTemplateGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgTemplateGridView.do")
public class MsgTemplateGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public MsgTemplateGridViewController() throws Exception {
        super();
        this.setId("a121f6c6447a1c9bf508ce351a1f3438");
        this.setCaption("消息模板");
        this.setTitle("消息模板实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/MsgTemplateGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgTemplateGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgTemplateGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgTemplateGridViewSearchFormHandler");
        searchForm.init(this);
