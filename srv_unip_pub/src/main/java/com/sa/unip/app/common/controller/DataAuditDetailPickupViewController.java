...
/**
 * 视图[DataAuditDetailPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataAuditDetailPickupView.do")
public class DataAuditDetailPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DataAuditDetailPickupViewController() throws Exception {
        super();
        this.setId("c267d1f061e656aa33b1ee28f8e5be8f");
        this.setCaption("数据审计明细");
        this.setTitle("数据审计明细实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataAuditDetailPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataAuditDetailPickupViewController",this);
    }
