...
/**
 * 应用视图[OrgUserUX_CurOrgXJRYGridView]表格[grid]后台处理对象基类
 */
public class OrgUserUX_CurOrgXJRYGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserUX_MainGridModel gridModel = null;
    public OrgUserUX_CurOrgXJRYGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchUX_ORGXJRY(deDataSetFetchContext);
    }
