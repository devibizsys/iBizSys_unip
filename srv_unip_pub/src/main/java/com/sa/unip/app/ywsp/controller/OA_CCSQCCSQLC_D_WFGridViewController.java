...
/**
 * 视图[OA_CCSQCCSQLC_D_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQCCSQLC_D_WFGridView.do")
public class OA_CCSQCCSQLC_D_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_CCSQCCSQLC_D_WFGridViewController() throws Exception {
        super();
        this.setId("c42ebc88d53b131c2b002371b5a27a70");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQCCSQLC_D_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQCCSQLC_D_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQCCSQLC_D_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQCCSQLC_D_WFGridViewSearchFormHandler");
        searchForm.init(this);
