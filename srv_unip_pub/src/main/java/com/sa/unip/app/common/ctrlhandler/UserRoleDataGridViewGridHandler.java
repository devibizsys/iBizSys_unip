...
import com.sa.unip.app.srv.common.ctrlmodel.UserRoleDataMainGridModel;
...
/**
 * 应用视图[UserRoleDataGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDataGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDataMainGridModel gridModel = null;
    public UserRoleDataGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserRoleDataMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserRoleDataMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserRoleData entity)throws Exception {
