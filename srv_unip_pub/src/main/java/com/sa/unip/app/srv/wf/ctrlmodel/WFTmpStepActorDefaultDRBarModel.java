...
/**
 * 实体[工作流步骤操作者（临时）]数据关系栏[drbar]部件模型
 */
public class  WFTmpStepActorDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFTmpStepActorDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setText("工作流步骤操作者（临时）");
