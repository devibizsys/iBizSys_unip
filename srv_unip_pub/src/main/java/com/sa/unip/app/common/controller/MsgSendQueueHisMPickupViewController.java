...
/**
 * 视图[MsgSendQueueHisMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgSendQueueHisMPickupView.do")
public class MsgSendQueueHisMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public MsgSendQueueHisMPickupViewController() throws Exception {
        super();
        this.setId("643d83237cb01d9e8233b8802d60df7a");
        this.setCaption("消息发送队列（历史）");
        this.setTitle("消息发送队列（历史）实体数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.MSGSENDQUEUEHIS");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/MsgSendQueueHisMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgSendQueueHisMPickupViewController",this);
    }
