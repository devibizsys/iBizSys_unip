...
/**
 * 实体[用户组成员]数据关系栏[drbar]部件模型
 */
public class  UserGroupDetailDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserGroupDetailDefaultDRBarModel() {
        super();
    }
