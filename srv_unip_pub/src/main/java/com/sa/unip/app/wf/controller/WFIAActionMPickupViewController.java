...
/**
 * 视图[WFIAActionMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFIAActionMPickupView.do")
public class WFIAActionMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFIAActionMPickupViewController() throws Exception {
        super();
        this.setId("c76ccc8a3421ada0f795c28300b252cb");
        this.setCaption("工作流交互操作");
        this.setTitle("工作流交互操作实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFIAActionMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFIAActionMPickupViewController",this);
    }
