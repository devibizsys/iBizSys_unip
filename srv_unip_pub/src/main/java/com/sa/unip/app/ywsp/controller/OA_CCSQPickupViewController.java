...
/**
 * 视图[OA_CCSQPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQPickupView.do")
public class OA_CCSQPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_CCSQPickupViewController() throws Exception {
        super();
        this.setId("b5dee2234a3d78b6a84bc101dff74b64");
        this.setCaption("出差申请");
        this.setTitle("出差申请数据选择视图");
        this.setCapLanResTag("DE.LNAME.QA_CCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CCSQ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQPickupViewController",this);
    }
