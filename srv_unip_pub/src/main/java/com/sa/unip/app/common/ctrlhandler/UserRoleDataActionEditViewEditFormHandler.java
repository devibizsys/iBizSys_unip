...
public class UserRoleDataActionEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected UserRoleDataActionMainEditFormModel editformModel = null;
    public UserRoleDataActionEditViewEditFormHandler()  {
        super();
    }
