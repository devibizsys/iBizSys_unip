...
/**
 * 视图[WFStepDataTimelineView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepDataTimelineView.do")
public class WFStepDataTimelineViewController extends net.ibizsys.paas.controller.MDCustomViewControllerBase {
    public WFStepDataTimelineViewController() throws Exception {
        super();
        this.setId("d772d2d7b7829712b49976ca15e492b7");
        this.setCaption("工作流步骤数据");
        this.setTitle("工作流步骤时间视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPDATA");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEPDATA.TIMELINEVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepDataTimelineView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepDataTimelineViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepDataTimelineViewGridHandler");
        grid.init(this);
