...
import com.sa.unip.app.srv.wx.ctrlmodel.WXOrgSectorMainEditFormModel;
...
public class WXOrgSectorEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected WXOrgSectorMainEditFormModel editformModel = null;
    public WXOrgSectorEditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (WXOrgSectorMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected WXOrgSectorMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.wx.ctrlhandler.WXOrgSectorMainEditFormOrgsectornameHandler");
        ...
        //注册 'wxaccountname'
        IFormItemHandler wxaccountnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.wx.ctrlhandler.WXOrgSectorMainEditFormWxaccountnameHandler");
    ...
    protected String getGetEntityAction() {
        return WXOrgSectorService.ACTION_GET;
    }
    ...
    protected IEntity getDraftEntityFrom(Object objKeyValue)throws Exception {
        WXOrgSector entity = new WXOrgSector();
        entity.set(WXOrgSector.FIELD_WXORGSECTORID,objKeyValue);
        this.getRealService().executeAction(WXOrgSectorService.ACTION_GETDRAFTFROM,entity);
        return entity;
    }
