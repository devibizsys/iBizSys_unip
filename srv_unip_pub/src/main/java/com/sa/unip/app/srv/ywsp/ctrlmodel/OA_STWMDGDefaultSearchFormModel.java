...
/**
 * 实体[食堂外卖订购]搜索表单[searchform]部件模型
 */
public class  OA_STWMDGDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OA_STWMDGDefaultSearchFormModel() {
        super();
