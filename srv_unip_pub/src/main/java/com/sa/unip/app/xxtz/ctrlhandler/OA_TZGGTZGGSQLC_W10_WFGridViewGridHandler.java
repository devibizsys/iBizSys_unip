...
/**
 * 应用视图[OA_TZGGTZGGSQLC_W10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_TZGGTZGGSQLC_W10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_TZGGMainGridModel gridModel = null;
    public OA_TZGGTZGGSQLC_W10_WFGridViewGridHandler()  {
        super();
    }
