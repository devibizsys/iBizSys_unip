...
/**
 * 视图[WFUserRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserRedirectView.do")
public class WFUserRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFUserRedirectViewController() throws Exception {
        super();
        this.setId("ccd51d5ba123f310cf248a54efb5f602");
        this.setCaption("工作流用户");
        this.setTitle("工作流用户实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFUserRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserRedirectViewController",this);
    }
