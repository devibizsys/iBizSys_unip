...
/**
 * 视图[OA_YBHYSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQEditView.do")
public class OA_YBHYSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_YBHYSQEditViewController() throws Exception {
        super();
        this.setId("2528dde6b90cdac41fe74e92c1efb02f");
        this.setCaption("会议申请");
        this.setTitle("会议申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_YBHYSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YBHYSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQEditViewEditFormHandler");
        editForm.init(this);
