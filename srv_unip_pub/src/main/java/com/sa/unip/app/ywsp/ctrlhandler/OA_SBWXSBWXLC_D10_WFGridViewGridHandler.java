...
/**
 * 应用视图[OA_SBWXSBWXLC_D10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_SBWXSBWXLC_D10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_SBWXMainGridModel gridModel = null;
    public OA_SBWXSBWXLC_D10_WFGridViewGridHandler()  {
        super();
    }
