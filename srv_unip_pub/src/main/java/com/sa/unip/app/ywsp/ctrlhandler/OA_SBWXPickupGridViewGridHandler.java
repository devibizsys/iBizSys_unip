...
/**
 * 应用视图[OA_SBWXPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_SBWXPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_SBWXMainGridModel gridModel = null;
    public OA_SBWXPickupGridViewGridHandler()  {
        super();
    }
