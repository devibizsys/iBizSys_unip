...
/**
 * 应用视图[UserGroupGridView]表格[grid]后台处理对象基类
 */
public class UserGroupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserGroupMain2GridModel gridModel = null;
    public UserGroupGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserGroup entity)throws Exception {
