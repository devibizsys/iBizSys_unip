...
/**
 * 应用视图[WFUserAssistPickupGridView]表格[grid]后台处理对象基类
 */
public class WFUserAssistPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserAssistMainGridModel gridModel = null;
    public WFUserAssistPickupGridViewGridHandler()  {
        super();
    }
