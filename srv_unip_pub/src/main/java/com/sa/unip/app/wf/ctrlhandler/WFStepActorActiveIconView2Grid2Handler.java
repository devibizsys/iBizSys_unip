...
import com.sa.unip.app.srv.wf.ctrlmodel.WFStepDataMain2GridModel;
...
/**
 * 应用视图[WFStepActorActiveIconView2]表格[grid2]后台处理对象基类
 */
public class WFStepActorActiveIconView2Grid2Handler extends net.ibizsys.pswf.ctrlhandler.WFStepDataGridHandlerBase {

    protected WFStepDataMain2GridModel gridModel = null;
    public WFStepActorActiveIconView2Grid2Handler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFStepDataMain2GridModel)this.getViewController().getCtrlModel("grid2");
        super.onInit();
     ...
     * @return
     */
    protected WFStepDataMain2GridModel getRealGridModel() {
