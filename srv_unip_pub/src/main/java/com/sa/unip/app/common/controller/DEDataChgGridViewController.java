...
/**
 * 视图[DEDataChgGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChgGridView.do")
public class DEDataChgGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public DEDataChgGridViewController() throws Exception {
        super();
        this.setId("775c4c5485b6fac717af1760440adf89");
        this.setCaption("实体数据变更");
        this.setTitle("实体数据变更实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/DEDataChgGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChgGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DEDataChgGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DEDataChgGridViewSearchFormHandler");
        searchForm.init(this);
