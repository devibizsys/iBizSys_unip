...
/**
 * 应用视图[OA_CHRYWCHGridView]表格[grid]后台处理对象基类
 */
public class OA_CHRYWCHGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CHRYMainGridModel gridModel = null;
    public OA_CHRYWCHGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchWCH(deDataSetFetchContext);
    }
