...
/**
 * 视图[WFStepInstPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepInstPickupView.do")
public class WFStepInstPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFStepInstPickupViewController() throws Exception {
        super();
        this.setId("d706f0f9f9598c24e3046fccf5a45907");
        this.setCaption("工作流步骤子实例");
        this.setTitle("工作流步骤子实例实体数据选择视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPINST");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEPINST.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFStepInstPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepInstPickupViewController",this);
    }
