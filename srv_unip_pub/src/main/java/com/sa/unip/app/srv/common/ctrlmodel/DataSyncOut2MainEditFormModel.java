...
/**
 * 实体[数据同步发送队列2]编辑表单[form]部件模型
 */
public class DataSyncOut2MainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DataSyncOut2MainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCOUT2ID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据同步发送队列2标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCOUT2NAME");
            formItem.setCaption("数据同步发送队列2名称");
        ...
        this.registerFormItem(iFormItem);
        // datasyncout2name
        iFormItem = this.createFormItem("datasyncout2name");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncout2name");
            formItem.setDEFName("DATASYNCOUT2NAME");
            formItem.setCaption("数据同步发送队列2名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datasyncout2name");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // datasyncout2id
        iFormItem = this.createFormItem("datasyncout2id");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncout2id");
            formItem.setDEFName("DATASYNCOUT2ID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据同步发送队列2标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datasyncout2id");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
