...
/**
 * 实体[消息模板]搜索表单[searchform]部件模型
 */
public class  MsgTemplateDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public MsgTemplateDefaultSearchFormModel() {
        super();
