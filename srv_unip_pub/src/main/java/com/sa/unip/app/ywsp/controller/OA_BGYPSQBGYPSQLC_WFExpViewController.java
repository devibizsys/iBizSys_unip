...
/**
 * 视图[OA_BGYPSQBGYPSQLC_WFExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQBGYPSQLC_WFExpView.do")
public class OA_BGYPSQBGYPSQLC_WFExpViewController extends net.ibizsys.pswf.controller.WFExpViewControllerBase {
    public OA_BGYPSQBGYPSQLC_WFExpViewController() throws Exception {
        super();
        this.setId("f98c16989b2373fe753089c220c593a4");
        this.setCaption("办公用品申请");
        this.setTitle("办公用品申请工作流导航视图(办公用品申领流程)");
        this.setCapLanResTag("DE.LNAME.OA_BGYPSQ");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.EXPBAR","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQBGYPSQLC_WFExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQBGYPSQLC_WFExpViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 expbar
        ICtrlModel expBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_BGYPSQexpbarWFExpBarModel");
        expBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 expbar
        ICtrlHandler expBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQBGYPSQLC_WFExpViewExpBarHandler");
        expBar.init(this);
