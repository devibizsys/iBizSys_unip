...
/**
 * 视图[OA_QXJRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJRedirectView.do")
public class OA_QXJRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_QXJRedirectViewController() throws Exception {
        super();
        this.setId("7d8a3dc07b0aa23de9df0c82dc9b564f");
        this.setCaption("请休假");
        this.setTitle("请休假数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_QXJ");
        this.setTitleLanResTag("PAGE.TITLE.OA_QXJ.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJRedirectViewController",this);
    }
