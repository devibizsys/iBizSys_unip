...
/**
 * 视图[OA_CLPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_CLPickupGridView.do")
public class OA_CLPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_CLPickupGridViewController() throws Exception {
        super();
        this.setId("7f98631834f7e4a2ded79c7511aceb8f");
        this.setCaption("车辆");
        this.setTitle("车辆选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_CL");
        this.setTitleLanResTag("PAGE.TITLE.OA_CL.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/jcsj/OA_CLPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_CLPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_CLPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_CLPickupGridViewSearchFormHandler");
        searchForm.init(this);
