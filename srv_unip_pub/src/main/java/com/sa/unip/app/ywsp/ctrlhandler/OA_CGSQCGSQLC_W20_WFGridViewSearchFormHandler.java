...
public class OA_CGSQCGSQLC_W20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_CGSQDefaultSearchFormModel searchformModel = null;
    public OA_CGSQCGSQLC_W20_WFGridViewSearchFormHandler()  {
        super();
    }
