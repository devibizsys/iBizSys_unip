...
/**
 * 实体[任务时刻策略]数据关系栏[drbar]部件模型
 */
public class  TSSDPolicyDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public TSSDPolicyDefaultDRBarModel() {
        super();
    }
