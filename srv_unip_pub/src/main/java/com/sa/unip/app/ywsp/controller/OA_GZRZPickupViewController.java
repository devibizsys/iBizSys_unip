...
/**
 * 视图[OA_GZRZPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_GZRZPickupView.do")
public class OA_GZRZPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_GZRZPickupViewController() throws Exception {
        super();
        this.setId("d17ac7b4633868157032097a9a27c833");
        this.setCaption("工作日志");
        this.setTitle("工作日志数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_GZRZPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_GZRZPickupViewController",this);
    }
