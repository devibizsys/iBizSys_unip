...
/**
 * 实体[实体数据变更（已处理）]搜索表单[searchform]部件模型
 */
public class  DEDataChg2DefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DEDataChg2DefaultSearchFormModel() {
        super();
