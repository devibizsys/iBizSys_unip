...
import com.sa.unip.app.srv.common.ctrlmodel.UserRoleTypeMainGridModel;
...
/**
 * 应用视图[UserRoleTypeGridView]表格[grid]后台处理对象基类
 */
public class UserRoleTypeGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleTypeMainGridModel gridModel = null;
    public UserRoleTypeGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserRoleTypeMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserRoleTypeMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserRoleType entity)throws Exception {
