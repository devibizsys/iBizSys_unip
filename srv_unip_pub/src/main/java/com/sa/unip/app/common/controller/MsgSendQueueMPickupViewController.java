...
/**
 * 视图[MsgSendQueueMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgSendQueueMPickupView.do")
public class MsgSendQueueMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public MsgSendQueueMPickupViewController() throws Exception {
        super();
        this.setId("fea4a586b28049c67fdc93d06c785e43");
        this.setCaption("消息发送队列");
        this.setTitle("消息发送队列实体数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.MSGSENDQUEUE");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/MsgSendQueueMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgSendQueueMPickupViewController",this);
    }
