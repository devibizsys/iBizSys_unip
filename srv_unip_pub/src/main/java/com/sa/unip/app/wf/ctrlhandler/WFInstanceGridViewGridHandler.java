...
/**
 * 应用视图[WFInstanceGridView]表格[grid]后台处理对象基类
 */
public class WFInstanceGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFInstanceMainGridModel gridModel = null;
    public WFInstanceGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFInstance entity)throws Exception {
