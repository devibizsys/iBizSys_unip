...
import com.sa.unip.app.srv.common.ctrlmodel.PVPartMainGridModel;
...
/**
 * 应用视图[PVPartCurPVPickupGridView]表格[grid]后台处理对象基类
 */
public class PVPartCurPVPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected PVPartMainGridModel gridModel = null;
    public PVPartCurPVPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (PVPartMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected PVPartMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurPV(deDataSetFetchContext);
    }
