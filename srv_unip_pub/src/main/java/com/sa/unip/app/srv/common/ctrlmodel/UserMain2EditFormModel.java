...
/**
 * 实体[用户]编辑表单[form]部件模型
 */
public class UserMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERID");
            formItem.setCaption("用户标识");
        ...
        this.registerFormItem(iFormItem);
        // userid
        iFormItem = this.createFormItem("userid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userid");
            formItem.setDEFName("USERID");
            formItem.setCaption("用户标识");
        ...
        this.registerFormItem(iFormItem);
        // username
        iFormItem = this.createFormItem("username");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("username");
            formItem.setDEFName("USERNAME");
            formItem.setCaption("用户名称");
        ...
        this.registerFormItem(iFormItem);
        // usermode
        iFormItem = this.createFormItem("usermode");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("usermode");
            formItem.setDEFName("USERMODE");
            formItem.setCaption("用户模式");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("usermode");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // timezone
        iFormItem = this.createFormItem("timezone");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("timezone");
            formItem.setDEFName("TIMEZONE");
            formItem.setCodeListId("com.sa.unip.srv.codelist.CodeList59CodeListModel");
            formItem.setCaption("所在时区");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("timezone");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
