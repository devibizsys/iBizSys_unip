...
/**
 * 视图[DataSyncAgentEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncAgentEditView2.do")
public class DataSyncAgentEditView2Controller extends net.ibizsys.paas.controller.EditView2ControllerBase {
    public DataSyncAgentEditView2Controller() throws Exception {
        super();
        this.setId("dacdce92f13ea49338a0a9e8d7fadf9c");
        this.setCaption("数据同步代理");
        this.setTitle("数据同步代理实体编辑视图（左右关系）");
        ...
        ViewControllerGlobal.registerViewController("/app/common/DataSyncAgentEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncAgentEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.DataSyncAgentDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DataSyncAgentEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DataSyncAgentEditView2DRBarHandler");
        drBar.init(this);
