...
/**
 * 应用视图[PortalPagePickupGridView]表格[grid]后台处理对象基类
 */
public class PortalPagePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected PortalPageMainGridModel gridModel = null;
    public PortalPagePickupGridViewGridHandler()  {
        super();
    }
