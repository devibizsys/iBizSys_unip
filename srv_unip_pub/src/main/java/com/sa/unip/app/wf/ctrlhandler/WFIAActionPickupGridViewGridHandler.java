...
import com.sa.unip.app.srv.wf.ctrlmodel.WFIAActionMainGridModel;
...
/**
 * 应用视图[WFIAActionPickupGridView]表格[grid]后台处理对象基类
 */
public class WFIAActionPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFIAActionMainGridModel gridModel = null;
    public WFIAActionPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFIAActionMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFIAActionMainGridModel getRealGridModel() {
