...
public class PPModelMainEditFormL3pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelMainEditFormL3pvpartnameHandler()  {
        super();
    }
