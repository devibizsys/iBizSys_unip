...
/**
 * 实体[实体数据变更]数据关系栏[drbar]部件模型
 */
public class  DEDataChgDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DEDataChgDefaultDRBarModel() {
        super();
    }
