...
/**
 * 视图[PPModelMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PPModelMPickupView.do")
public class PPModelMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public PPModelMPickupViewController() throws Exception {
        super();
        this.setId("11358514b90e9797950e3d1bb5b9a389");
        this.setCaption("门户页面模型");
        this.setTitle("门户页面模型实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/PPModelMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PPModelMPickupViewController",this);
    }
