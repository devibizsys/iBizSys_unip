...
/**
 * 视图[OrgSectorPickupView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSectorPickupView2.do")
public class OrgSectorPickupView2Controller extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgSectorPickupView2Controller() throws Exception {
        super();
        this.setId("698cedc2362563b1548f5852a23370ce");
        this.setCaption("组织部门");
        this.setTitle("组织部门实体数据选择过滤视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgSectorPickupView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSectorPickupView2Controller",this);
    }
