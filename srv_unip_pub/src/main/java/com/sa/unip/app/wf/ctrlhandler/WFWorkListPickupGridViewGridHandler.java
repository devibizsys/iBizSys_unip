...
/**
 * 应用视图[WFWorkListPickupGridView]表格[grid]后台处理对象基类
 */
public class WFWorkListPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFWorkListMainGridModel gridModel = null;
    public WFWorkListPickupGridViewGridHandler()  {
        super();
    }
