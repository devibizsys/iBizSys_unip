...
/**
 * 视图[MsgSendQueueHisGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgSendQueueHisGridView.do")
public class MsgSendQueueHisGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public MsgSendQueueHisGridViewController() throws Exception {
        super();
        this.setId("3eb6aa8f244478fb3d9f3d32088f100f");
        this.setCaption("消息发送队列（历史）");
        this.setTitle("消息发送队列（历史）实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/MsgSendQueueHisGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgSendQueueHisGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgSendQueueHisGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgSendQueueHisGridViewSearchFormHandler");
        searchForm.init(this);
