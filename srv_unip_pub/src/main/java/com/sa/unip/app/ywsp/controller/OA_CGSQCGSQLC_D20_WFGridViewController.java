...
/**
 * 视图[OA_CGSQCGSQLC_D20_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CGSQCGSQLC_D20_WFGridView.do")
public class OA_CGSQCGSQLC_D20_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_CGSQCGSQLC_D20_WFGridViewController() throws Exception {
        super();
        this.setId("9bf404fc456c4ca5b54b3c7dcab9ea37");
        this.setCaption("采购申请");
        this.setTitle("采购申请工作流表格视图(采购申请流程:审批中)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CGSQCGSQLC_D20_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CGSQCGSQLC_D20_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CGSQCGSQLC_D20_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CGSQCGSQLC_D20_WFGridViewSearchFormHandler");
        searchForm.init(this);
