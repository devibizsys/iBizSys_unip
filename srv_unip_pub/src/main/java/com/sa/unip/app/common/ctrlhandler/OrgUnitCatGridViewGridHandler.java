...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUnitCatMain2GridModel;
...
/**
 * 应用视图[OrgUnitCatGridView]表格[grid]后台处理对象基类
 */
public class OrgUnitCatGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUnitCatMain2GridModel gridModel = null;
    public OrgUnitCatGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgUnitCatMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgUnitCatMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OrgUnitCat entity)throws Exception {
