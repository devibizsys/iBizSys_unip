...
/**
 * 视图[UserGroupDetailGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserGroupDetailGridView.do")
public class UserGroupDetailGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public UserGroupDetailGridViewController() throws Exception {
        super();
        this.setId("a22b805d413edcea8db0fea112c1aff3");
        this.setCaption("用户组成员");
        this.setTitle("用户组成员实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserGroupDetailGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserGroupDetailGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserGroupDetailGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserGroupDetailGridViewSearchFormHandler");
        searchForm.init(this);
