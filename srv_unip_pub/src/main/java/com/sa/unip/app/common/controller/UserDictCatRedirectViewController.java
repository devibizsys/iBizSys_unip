...
/**
 * 视图[UserDictCatRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserDictCatRedirectView.do")
public class UserDictCatRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserDictCatRedirectViewController() throws Exception {
        super();
        this.setId("c334be7dec06c74f2f6a1d19111ff858");
        this.setCaption("用户词条类别");
        this.setTitle("用户词条类别实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserDictCatRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserDictCatRedirectViewController",this);
    }
