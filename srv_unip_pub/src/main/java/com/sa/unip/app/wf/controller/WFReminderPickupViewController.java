...
/**
 * 视图[WFReminderPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFReminderPickupView.do")
public class WFReminderPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFReminderPickupViewController() throws Exception {
        super();
        this.setId("e285f49e5cbc1cba94639e0d5962afbb");
        this.setCaption("工作流工作催办");
        this.setTitle("工作流工作催办实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFReminderPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFReminderPickupViewController",this);
    }
