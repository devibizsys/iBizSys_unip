...
import com.sa.unip.app.srv.common.ctrlmodel.UserDictMain2GridModel;
...
/**
 * 应用视图[UserDictGridView]表格[grid]后台处理对象基类
 */
public class UserDictGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDictMain2GridModel gridModel = null;
    public UserDictGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (UserDictMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected UserDictMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserDict entity)throws Exception {
