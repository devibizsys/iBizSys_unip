...
public class OA_NSJGHYSQNSJGHYSQ_W40_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_NSJGHYSQDefaultSearchFormModel searchformModel = null;
    public OA_NSJGHYSQNSJGHYSQ_W40_WFGridViewSearchFormHandler()  {
        super();
    }
