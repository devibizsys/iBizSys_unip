...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUIWizardGotoStepEditFormModel;
...
public class WFUIWizardGotoOptionViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.OptionFormHandlerBase {

    protected WFUIWizardGotoStepEditFormModel editformModel = null;
    public WFUIWizardGotoOptionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (WFUIWizardGotoStepEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected WFUIWizardGotoStepEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'wfstepvalue'
        IFormItemHandler wfstepvalueHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.wf.ctrlhandler.WFUIWizardGotoStepEditFormWfstepvalueHandler");
        wfstepvalueHandler.init(this.getEditFormModel(),this);
        this.registerCtrlItemHandler(ITEMACTIONTYPE_FORMITEM+"wfstepvalue",wfstepvalueHandler);
