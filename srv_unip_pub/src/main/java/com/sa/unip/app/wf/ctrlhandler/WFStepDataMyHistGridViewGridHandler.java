...
import com.sa.unip.app.srv.wf.ctrlmodel.WFStepDataMyHistGridModel;
...
/**
 * 应用视图[WFStepDataMyHistGridView]表格[grid]后台处理对象基类
 */
public class WFStepDataMyHistGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepDataMyHistGridModel gridModel = null;
    public WFStepDataMyHistGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFStepDataMyHistGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFStepDataMyHistGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchMyHist(deDataSetFetchContext);
    }
