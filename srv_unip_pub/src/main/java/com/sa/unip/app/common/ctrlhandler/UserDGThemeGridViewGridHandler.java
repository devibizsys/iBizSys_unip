...
/**
 * 应用视图[UserDGThemeGridView]表格[grid]后台处理对象基类
 */
public class UserDGThemeGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDGThemeMainGridModel gridModel = null;
    public UserDGThemeGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(UserDGTheme entity)throws Exception {
