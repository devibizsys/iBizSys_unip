...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserDefaultSearchFormModel;
...
public class OrgUserJXKHJCRYXZPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgUserDefaultSearchFormModel searchformModel = null;
    public OrgUserJXKHJCRYXZPickupGridViewSearchFormHandler()  {
        super();
    }
