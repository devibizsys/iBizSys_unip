...
/**
 * 视图[UserDictEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserDictEditView.do")
public class UserDictEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public UserDictEditViewController() throws Exception {
        super();
        this.setId("b51e7c424c2420072c3e082cbd6f94d6");
        this.setCaption("用户词典");
        this.setTitle("用户词典实体编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserDictEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserDictEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserDictEditViewEditFormHandler");
        editForm.init(this);
