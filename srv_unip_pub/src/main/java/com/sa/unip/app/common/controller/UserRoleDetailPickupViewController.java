...
/**
 * 视图[UserRoleDetailPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDetailPickupView.do")
public class UserRoleDetailPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserRoleDetailPickupViewController() throws Exception {
        super();
        this.setId("f1bca03d810d37c7519d37141fc9106d");
        this.setCaption("用户角色成员");
        this.setTitle("用户角色成员实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDetailPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDetailPickupViewController",this);
    }
