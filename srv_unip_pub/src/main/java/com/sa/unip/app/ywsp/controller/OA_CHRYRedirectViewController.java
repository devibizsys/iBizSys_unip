...
/**
 * 视图[OA_CHRYRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CHRYRedirectView.do")
public class OA_CHRYRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_CHRYRedirectViewController() throws Exception {
        super();
        this.setId("96854df5d87110d838af7b44de4e3dd9");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CHRYRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CHRYRedirectViewController",this);
    }
