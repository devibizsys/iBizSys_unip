...
import com.sa.unip.app.srv.common.ctrlmodel.MsgAccountDetailMainGridModel;
...
/**
 * 应用视图[MsgAccountDetailGridView]表格[grid]后台处理对象基类
 */
public class MsgAccountDetailGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgAccountDetailMainGridModel gridModel = null;
    public MsgAccountDetailGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (MsgAccountDetailMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected MsgAccountDetailMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(MsgAccountDetail entity)throws Exception {
