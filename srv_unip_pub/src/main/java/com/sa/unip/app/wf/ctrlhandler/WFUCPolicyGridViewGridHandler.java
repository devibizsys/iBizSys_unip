...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUCPolicyMain2GridModel;
...
/**
 * 应用视图[WFUCPolicyGridView]表格[grid]后台处理对象基类
 */
public class WFUCPolicyGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUCPolicyMain2GridModel gridModel = null;
    public WFUCPolicyGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFUCPolicyMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFUCPolicyMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFUCPolicy entity)throws Exception {
