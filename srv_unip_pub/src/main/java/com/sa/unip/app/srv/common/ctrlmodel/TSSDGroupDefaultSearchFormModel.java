...
/**
 * 实体[任务时刻策略组]搜索表单[searchform]部件模型
 */
public class  TSSDGroupDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public TSSDGroupDefaultSearchFormModel() {
        super();
