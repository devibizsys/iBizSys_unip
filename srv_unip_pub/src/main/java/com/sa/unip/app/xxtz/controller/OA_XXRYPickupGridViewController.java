...
/**
 * 视图[OA_XXRYPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_XXRYPickupGridView.do")
public class OA_XXRYPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_XXRYPickupGridViewController() throws Exception {
        super();
        this.setId("b1977847d3944f3a50d50d7d7de215ef");
        this.setCaption("消息人员");
        this.setTitle("消息人员选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_XXRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_XXRY.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_XXRYPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_XXRYPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_XXRYPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_XXRYPickupGridViewSearchFormHandler");
        searchForm.init(this);
