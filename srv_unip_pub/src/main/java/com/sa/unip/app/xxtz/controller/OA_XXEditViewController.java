...
/**
 * 视图[OA_XXEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_XXEditView.do")
public class OA_XXEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public OA_XXEditViewController() throws Exception {
        super();
        this.setId("7216d49e6a2852bf64bc3456556556b7");
        this.setCaption("消息");
        this.setTitle("消息编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_XX");
        this.setTitleLanResTag("PAGE.TITLE.OA_XX.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_XXEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_XXEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_XXEditViewEditFormHandler");
        editForm.init(this);
