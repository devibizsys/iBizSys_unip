...
/**
 * 视图[RegistryPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/RegistryPickupView.do")
public class RegistryPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public RegistryPickupViewController() throws Exception {
        super();
        this.setId("bf2a008de888c75c56d6c9424c9f0a63");
        this.setCaption("注册表");
        this.setTitle("注册表实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/RegistryPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.RegistryPickupViewController",this);
    }
