...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUIWizardMainGridModel;
...
/**
 * 应用视图[WFUIWizardGridView]表格[grid]后台处理对象基类
 */
public class WFUIWizardGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUIWizardMainGridModel gridModel = null;
    public WFUIWizardGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFUIWizardMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFUIWizardMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFUIWizard entity)throws Exception {
