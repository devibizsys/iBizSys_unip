...
import com.sa.unip.app.srv.wf.ctrlmodel.WFStepMainGridModel;
...
/**
 * 应用视图[WFStepGridView]表格[grid]后台处理对象基类
 */
public class WFStepGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepMainGridModel gridModel = null;
    public WFStepGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFStepMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFStepMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFStep entity)throws Exception {
