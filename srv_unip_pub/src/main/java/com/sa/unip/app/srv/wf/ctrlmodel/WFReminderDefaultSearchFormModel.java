...
/**
 * 实体[工作流工作催办]搜索表单[searchform]部件模型
 */
public class  WFReminderDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WFReminderDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_wfremindername_like
        iFormItem = this.createFormItem("n_wfremindername_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_wfremindername_like");
            formItem.setDEFName("WFREMINDERNAME");
            formItem.setCaption("标题(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_wfremindername_like");
