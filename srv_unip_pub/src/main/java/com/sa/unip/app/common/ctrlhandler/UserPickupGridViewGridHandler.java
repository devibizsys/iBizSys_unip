...
/**
 * 应用视图[UserPickupGridView]表格[grid]后台处理对象基类
 */
public class UserPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserMain2GridModel gridModel = null;
    public UserPickupGridViewGridHandler()  {
        super();
    }
