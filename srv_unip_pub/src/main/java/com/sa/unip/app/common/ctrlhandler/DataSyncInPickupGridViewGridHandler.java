...
/**
 * 应用视图[DataSyncInPickupGridView]表格[grid]后台处理对象基类
 */
public class DataSyncInPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncInMainGridModel gridModel = null;
    public DataSyncInPickupGridViewGridHandler()  {
        super();
    }
