...
/**
 * 视图[OA_CLMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_CLMPickupView.do")
public class OA_CLMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_CLMPickupViewController() throws Exception {
        super();
        this.setId("6b99fc50244d7aa58477789869bd86b1");
        this.setCaption("车辆");
        this.setTitle("车辆数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_CL");
        this.setTitleLanResTag("PAGE.TITLE.OA_CL.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/jcsj/OA_CLMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_CLMPickupViewController",this);
    }
