...
/**
 * 视图[OA_CGSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CGSQEditView.do")
public class OA_CGSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_CGSQEditViewController() throws Exception {
        super();
        this.setId("fc31f0140c2dff77af607774c510f447");
        this.setCaption("采购申请");
        this.setTitle("采购申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_CGSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CGSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CGSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CGSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CGSQEditViewEditFormHandler");
        editForm.init(this);
