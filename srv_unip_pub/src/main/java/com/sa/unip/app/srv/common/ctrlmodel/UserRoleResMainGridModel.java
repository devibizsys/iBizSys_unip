...
/**
 * 实体[用户角色资源能力]数据表格[grid]部件模型
 */
public class  UserRoleResMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserRoleResMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 资源
        iGridColumn = createGridColumn("uniresname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("uniresname");
            gridColumnModel.setDataItemName("uniresname");
            gridColumnModel.setCaption("资源");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 userroleresid
        iGridDataItem = createGridDataItem("userroleresid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userroleresid");
        ...
        //建立数据项 uniresname
        iGridDataItem = createGridDataItem("uniresname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("uniresname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("UNIRESNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 uniresid
        iGridDataItem = createGridDataItem("uniresid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("uniresid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("UNIRESID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERROLERESID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("用户角色资源能力标识");
