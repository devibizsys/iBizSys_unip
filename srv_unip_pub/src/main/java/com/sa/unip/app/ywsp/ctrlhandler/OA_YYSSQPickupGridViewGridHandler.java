...
/**
 * 应用视图[OA_YYSSQPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_YYSSQPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_YYSSQMainGridModel gridModel = null;
    public OA_YYSSQPickupGridViewGridHandler()  {
        super();
    }
