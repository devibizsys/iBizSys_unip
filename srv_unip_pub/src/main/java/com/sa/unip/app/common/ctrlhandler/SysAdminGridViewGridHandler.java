...
import com.sa.unip.app.srv.common.ctrlmodel.SysAdminMainGridModel;
...
/**
 * 应用视图[SysAdminGridView]表格[grid]后台处理对象基类
 */
public class SysAdminGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected SysAdminMainGridModel gridModel = null;
    public SysAdminGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (SysAdminMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected SysAdminMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(SysAdmin entity)throws Exception {
