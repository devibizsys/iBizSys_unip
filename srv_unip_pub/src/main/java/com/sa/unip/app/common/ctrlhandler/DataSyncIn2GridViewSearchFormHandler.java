...
public class DataSyncIn2GridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected DataSyncIn2DefaultSearchFormModel searchformModel = null;
    public DataSyncIn2GridViewSearchFormHandler()  {
        super();
    }
