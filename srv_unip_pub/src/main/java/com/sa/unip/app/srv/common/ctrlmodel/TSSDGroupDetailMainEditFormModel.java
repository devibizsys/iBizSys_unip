...
/**
 * 实体[任务时刻策略组明细]编辑表单[form]部件模型
 */
public class TSSDGroupDetailMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDGroupDetailMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDGROUPDETAILID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略组明细标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDGROUPDETAILNAME");
            formItem.setCaption("任务时刻策略组明细名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdgroupdetailname
        iFormItem = this.createFormItem("tssdgroupdetailname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdgroupdetailname");
            formItem.setDEFName("TSSDGROUPDETAILNAME");
            formItem.setCaption("任务时刻策略组明细名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdgroupdetailname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdgroupdetailid
        iFormItem = this.createFormItem("tssdgroupdetailid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdgroupdetailid");
            formItem.setDEFName("TSSDGROUPDETAILID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略组明细标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdgroupdetailid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
