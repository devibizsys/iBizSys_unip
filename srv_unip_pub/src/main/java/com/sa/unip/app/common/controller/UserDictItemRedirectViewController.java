...
/**
 * 视图[UserDictItemRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserDictItemRedirectView.do")
public class UserDictItemRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserDictItemRedirectViewController() throws Exception {
        super();
        this.setId("23ef31235f3712a26f2d54acf3570dfc");
        this.setCaption("用户词条");
        this.setTitle("用户词条实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserDictItemRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserDictItemRedirectViewController",this);
    }
