...
public class OA_PCSQPCSQLC_W_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_PCSQDefaultSearchFormModel searchformModel = null;
    public OA_PCSQPCSQLC_W_WFGridViewSearchFormHandler()  {
        super();
    }
