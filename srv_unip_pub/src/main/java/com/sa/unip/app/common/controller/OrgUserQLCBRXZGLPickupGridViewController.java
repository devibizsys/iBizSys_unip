...
/**
 * 视图[OrgUserQLCBRXZGLPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserQLCBRXZGLPickupGridView.do")
public class OrgUserQLCBRXZGLPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OrgUserQLCBRXZGLPickupGridViewController() throws Exception {
        super();
        this.setId("d32621c103c3787ce55e92f89eb134dc");
        this.setCaption("组织人员");
        this.setTitle("权利组织人员实体选择表格过滤视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserQLCBRXZGLPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserQLCBRXZGLPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 grid
        ICtrlModel grid=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.OrgUserMain2GridModel");
        grid.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserQLCBRXZGLPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserQLCBRXZGLPickupGridViewSearchFormHandler");
        searchForm.init(this);
