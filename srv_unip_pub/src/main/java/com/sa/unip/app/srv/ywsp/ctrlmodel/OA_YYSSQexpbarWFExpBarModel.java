...
/**
 * 实体[饮用水申请]流程导航栏[expbar]部件模型
 */
public class  OA_YYSSQexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_YYSSQexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("A070B5AC-8168-43BE-93AA-07D345BF9444"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("YYSSQ:D:20");
        ...
        expBarItem3.setExpViewId("YYSSQ:D:20:10");
        ...
        expBarItem4.setExpViewId("YYSSQ:D:20:20");
        ...
        expBarItem5.setExpViewId("YYSSQ:D:30");
        ...
        expBarItem6.setExpViewId("YYSSQ:D:40");
        ...
        expBarItem7.setExpViewId("YYSSQ:W");
        ...
        expBarItem8.setExpViewId("YYSSQ:W:10");
        ...
        expBarItem9.setExpViewId("YYSSQ:W:20");
