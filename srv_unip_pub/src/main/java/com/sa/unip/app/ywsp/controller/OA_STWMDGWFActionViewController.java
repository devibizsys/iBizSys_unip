...
/**
 * 视图[OA_STWMDGWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGWFActionView.do")
public class OA_STWMDGWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_STWMDGWFActionViewController() throws Exception {
        super();
        this.setId("f8f7643a35d1d7a626a9962d9615fe3d");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_STWMDGSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGWFActionViewEditFormHandler");
        editForm.init(this);
