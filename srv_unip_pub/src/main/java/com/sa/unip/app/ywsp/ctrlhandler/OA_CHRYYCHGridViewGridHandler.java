...
/**
 * 应用视图[OA_CHRYYCHGridView]表格[grid]后台处理对象基类
 */
public class OA_CHRYYCHGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CHRYMainGridModel gridModel = null;
    public OA_CHRYYCHGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchYCH(deDataSetFetchContext);
    }
