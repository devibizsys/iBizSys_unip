 ...
 * 树视图控件后台处理基类
 */
public class OrgUserPickupView2Treeexpbar_treeHandler extends net.ibizsys.paas.ctrlhandler.TreeHandlerBase {

    protected OrgAllOrgTreeModel treeModel = null;
    public OrgUserPickupView2Treeexpbar_treeHandler()  {
        super();
    }
