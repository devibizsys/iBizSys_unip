...
/**
 * 视图[OA_CCSQMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQMPickupView.do")
public class OA_CCSQMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_CCSQMPickupViewController() throws Exception {
        super();
        this.setId("27386007304cd7a4f963f4874cb3da7d");
        this.setCaption("出差申请");
        this.setTitle("出差申请数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.QA_CCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CCSQ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQMPickupViewController",this);
    }
