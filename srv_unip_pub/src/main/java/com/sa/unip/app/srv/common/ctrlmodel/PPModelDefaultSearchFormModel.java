...
/**
 * 实体[门户页面模型]搜索表单[searchform]部件模型
 */
public class  PPModelDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public PPModelDefaultSearchFormModel() {
        super();
