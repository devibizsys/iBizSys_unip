...
/**
 * 应用视图[UserRoleDataPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDataPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDataMainGridModel gridModel = null;
    public UserRoleDataPickupGridViewGridHandler()  {
        super();
    }
