...
/**
 * 视图[OA_CHRYYQJGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CHRYYQJGridView.do")
public class OA_CHRYYQJGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_CHRYYQJGridViewController() throws Exception {
        super();
        this.setId("2d677c5d700bcc67b9de28ffecb8e011");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CHRYYQJGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CHRYYQJGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CHRYYQJGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CHRYYQJGridViewSearchFormHandler");
        searchForm.init(this);
