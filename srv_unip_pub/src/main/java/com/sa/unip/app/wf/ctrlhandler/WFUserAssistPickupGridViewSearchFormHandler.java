...
public class WFUserAssistPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFUserAssistDefaultSearchFormModel searchformModel = null;
    public WFUserAssistPickupGridViewSearchFormHandler()  {
        super();
    }
