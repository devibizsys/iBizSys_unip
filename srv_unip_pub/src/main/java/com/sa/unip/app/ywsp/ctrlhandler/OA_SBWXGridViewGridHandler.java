...
/**
 * 应用视图[OA_SBWXGridView]表格[grid]后台处理对象基类
 */
public class OA_SBWXGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_SBWXMainGridModel gridModel = null;
    public OA_SBWXGridViewGridHandler()  {
        super();
    }
