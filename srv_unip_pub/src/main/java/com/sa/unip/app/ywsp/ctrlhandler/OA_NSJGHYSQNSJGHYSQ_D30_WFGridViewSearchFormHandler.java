...
public class OA_NSJGHYSQNSJGHYSQ_D30_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_NSJGHYSQDefaultSearchFormModel searchformModel = null;
    public OA_NSJGHYSQNSJGHYSQ_D30_WFGridViewSearchFormHandler()  {
        super();
    }
