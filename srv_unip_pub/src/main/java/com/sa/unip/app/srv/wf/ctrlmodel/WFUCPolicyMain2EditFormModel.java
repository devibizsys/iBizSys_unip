...
/**
 * 实体[工作流候选用户策略]编辑表单[form]部件模型
 */
public class WFUCPolicyMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUCPolicyMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUCPOLICYID");
            formItem.setEnableCond(0);
            formItem.setCaption("工作流候选用户策略标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUCPOLICYNAME");
            formItem.setCaption("工作流候选用户策略名称");
        ...
        this.registerFormItem(iFormItem);
        // majorwfusername
        iFormItem = this.createFormItem("majorwfusername");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("majorwfusername");
            formItem.setDEFName("MAJORWFUSERNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("工作流用户");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("majorwfusername");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // minorwfusername
        iFormItem = this.createFormItem("minorwfusername");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("minorwfusername");
            formItem.setDEFName("MINORWFUSERNAME");
            formItem.setCaption("候选用户");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("minorwfusername");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // begintime
        iFormItem = this.createFormItem("begintime");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("begintime");
            formItem.setDEFName("BEGINTIME");
        ...
        this.registerFormItem(iFormItem);
        // policystate
        iFormItem = this.createFormItem("policystate");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("policystate");
            formItem.setDEFName("POLICYSTATE");
            formItem.setEnableCond(0);
            formItem.setIgnoreInput(3);
            formItem.setCodeListId("net.ibizsys.psrt.srv.codelist.WFUCPolicyStateCodeListModel");
            formItem.setCaption("策略状态");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("policystate");
        ...
        this.registerFormItem(iFormItem);
        // wfucpolicyid
        iFormItem = this.createFormItem("wfucpolicyid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfucpolicyid");
            formItem.setDEFName("WFUCPOLICYID");
            formItem.setEnableCond(0);
            formItem.setCaption("工作流候选用户策略标识");
        ...
        this.registerFormItem(iFormItem);
        // minorwfuserid
        iFormItem = this.createFormItem("minorwfuserid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("minorwfuserid");
            formItem.setDEFName("MINORWFUSERID");
            formItem.setCaption("候选用户");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("minorwfuserid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // majorwfuserid
        iFormItem = this.createFormItem("majorwfuserid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("majorwfuserid");
            formItem.setDEFName("MAJORWFUSERID");
            formItem.setEnableCond(1);
            formItem.setCaption("工作流用户");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("majorwfuserid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
