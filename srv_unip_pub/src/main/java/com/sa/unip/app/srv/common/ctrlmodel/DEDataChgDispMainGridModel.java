...
/**
 * 实体[实体数据变更派发引擎]数据表格[grid]部件模型
 */
public class  DEDataChgDispMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public DEDataChgDispMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 数据变更派发引擎
        iGridColumn = createGridColumn("dedatachgdispname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("dedatachgdispname");
            gridColumnModel.setDataItemName("dedatachgdispname");
            gridColumnModel.setCaption("数据变更派发引擎");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 dedatachgdispid
        iGridDataItem = createGridDataItem("dedatachgdispid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dedatachgdispid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHGDISPID");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 dedatachgdispname
        iGridDataItem = createGridDataItem("dedatachgdispname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dedatachgdispname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHGDISPNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("DEDATACHGDISPID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("实体数据变更派发标识");
