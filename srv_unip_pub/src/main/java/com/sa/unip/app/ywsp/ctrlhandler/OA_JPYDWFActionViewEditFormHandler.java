...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_JPYDSHYJFormEditFormModel;
...
public class OA_JPYDWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_JPYDSHYJFormEditFormModel editformModel = null;
    public OA_JPYDWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_JPYDSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_JPYDSHYJFormEditFormModel getRealEditFormModel() {
