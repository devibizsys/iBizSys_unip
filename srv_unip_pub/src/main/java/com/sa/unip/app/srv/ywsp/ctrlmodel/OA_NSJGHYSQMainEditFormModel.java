 ...
 */
public class OA_NSJGHYSQMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_NSJGHYSQMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // hysid
        iFormItem = this.createFormItem("hysid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("hysid");
            formItem.setDEFName("HYSID");
            formItem.setCaption("会议室标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("hysid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
