...
/**
 * 应用视图[TSSDEngineGridView]表格[grid]后台处理对象基类
 */
public class TSSDEngineGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDEngineMainGridModel gridModel = null;
    public TSSDEngineGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDEngine entity)throws Exception {
