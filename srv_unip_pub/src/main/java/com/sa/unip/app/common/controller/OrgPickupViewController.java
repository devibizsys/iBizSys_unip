...
/**
 * 视图[OrgPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgPickupView.do")
public class OrgPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgPickupViewController() throws Exception {
        super();
        this.setId("345e9d554894bb3e4e6661511091f340");
        this.setCaption("组织机构");
        this.setTitle("组织机构实体数据选择视图");
        this.setCapLanResTag("DE.LNAME.ORG");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgPickupViewController",this);
    }
