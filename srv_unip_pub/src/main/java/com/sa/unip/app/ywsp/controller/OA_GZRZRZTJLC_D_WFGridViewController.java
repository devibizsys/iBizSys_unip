 ...
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_GZRZRZTJLC_D_WFGridView.do")
public class OA_GZRZRZTJLC_D_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_GZRZRZTJLC_D_WFGridViewController() throws Exception {
        super();
        this.setId("207fcd2c070f0959d3ea1b894f0bdae2");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_GZRZRZTJLC_D_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_GZRZRZTJLC_D_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_GZRZRZTJLC_D_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_GZRZRZTJLC_D_WFGridViewSearchFormHandler");
        searchForm.init(this);
