...
/**
 * 实体[工作流系统用户]数据表格[grid]部件模型
 */
public class  WFSystemUserMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFSystemUserMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wfsystemuserid
        iGridDataItem = createGridDataItem("wfsystemuserid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfsystemuserid");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFSYSTEMUSERID");
            gridEditItem.setCaption("工作流系统用户标识");
