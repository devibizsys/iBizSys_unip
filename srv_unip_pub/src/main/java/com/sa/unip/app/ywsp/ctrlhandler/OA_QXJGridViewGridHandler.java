...
/**
 * 应用视图[OA_QXJGridView]表格[grid]后台处理对象基类
 */
public class OA_QXJGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_QXJMainGridModel gridModel = null;
    public OA_QXJGridViewGridHandler()  {
        super();
    }
