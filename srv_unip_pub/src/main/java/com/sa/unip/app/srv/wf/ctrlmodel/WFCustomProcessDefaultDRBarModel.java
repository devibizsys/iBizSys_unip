...
/**
 * 实体[工作流预定义处理]数据关系栏[drbar]部件模型
 */
public class  WFCustomProcessDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFCustomProcessDefaultDRBarModel() {
        super();
    }
