...
/**
 * 视图[TSSDGroupDetailPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDGroupDetailPickupView.do")
public class TSSDGroupDetailPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public TSSDGroupDetailPickupViewController() throws Exception {
        super();
        this.setId("0599c78f3d78efab46d851124bb47b6c");
        this.setCaption("任务时刻策略组明细");
        this.setTitle("任务时刻策略组明细实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDGroupDetailPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDGroupDetailPickupViewController",this);
    }
