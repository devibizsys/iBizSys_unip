...
/**
 * 应用视图[UserObjectPickupGridView]表格[grid]后台处理对象基类
 */
public class UserObjectPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserObjectMain2GridModel gridModel = null;
    public UserObjectPickupGridViewGridHandler()  {
        super();
    }
