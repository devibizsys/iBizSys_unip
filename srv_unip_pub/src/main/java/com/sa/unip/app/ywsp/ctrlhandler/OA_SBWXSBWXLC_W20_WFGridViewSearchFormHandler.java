...
public class OA_SBWXSBWXLC_W20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_SBWXDefaultSearchFormModel searchformModel = null;
    public OA_SBWXSBWXLC_W20_WFGridViewSearchFormHandler()  {
        super();
    }
