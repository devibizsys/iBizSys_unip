...
/**
 * 实体[用户组成员]数据表格[grid]部件模型
 */
public class  UserGroupDetailMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserGroupDetailMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("用户组");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 usergroupdetailid
        iGridDataItem = createGridDataItem("usergroupdetailid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("usergroupdetailid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERGROUPDETAILID");
            gridEditItem.setCaption("用户组成员标识");
