...
/**
 * 视图[OA_TZGGEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGEditView2.do")
public class OA_TZGGEditView2Controller extends net.ibizsys.pswf.controller.EditView2ControllerBase {
    public OA_TZGGEditView2Controller() throws Exception {
        super();
        this.setId("eabd95d44f7855846d6d083a08580fd4");
        this.setCaption("通知公告");
        this.setTitle("通知公告编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_TZGG");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGG.EDITVIEW2");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.xxtz.ctrlmodel.OA_TZGGDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGEditView2DRBarHandler");
        drBar.init(this);
