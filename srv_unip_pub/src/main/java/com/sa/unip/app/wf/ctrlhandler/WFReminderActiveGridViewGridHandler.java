...
import com.sa.unip.app.srv.wf.ctrlmodel.WFReminderMain2GridModel;
...
/**
 * 应用视图[WFReminderActiveGridView]表格[grid]后台处理对象基类
 */
public class WFReminderActiveGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFReminderMain2GridModel gridModel = null;
    public WFReminderActiveGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFReminderMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFReminderMain2GridModel getRealGridModel() {
