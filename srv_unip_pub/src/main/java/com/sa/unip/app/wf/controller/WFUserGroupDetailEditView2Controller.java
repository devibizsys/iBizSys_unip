...
/**
 * 视图[WFUserGroupDetailEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupDetailEditView2.do")
public class WFUserGroupDetailEditView2Controller extends net.ibizsys.paas.controller.EditView2ControllerBase {
    public WFUserGroupDetailEditView2Controller() throws Exception {
        super();
        this.setId("ed9a6b8bfd7bd702f3508db86192c7ff");
        this.setCaption("工作流用户组成员");
        this.setTitle("工作流用户组成员编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupDetailEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupDetailEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.wf.ctrlmodel.WFUserGroupDetailDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGroupDetailEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserGroupDetailEditView2DRBarHandler");
        drBar.init(this);
