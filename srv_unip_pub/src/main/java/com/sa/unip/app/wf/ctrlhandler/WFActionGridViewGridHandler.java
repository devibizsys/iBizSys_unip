...
import com.sa.unip.app.srv.wf.ctrlmodel.WFActionMainGridModel;
...
/**
 * 应用视图[WFActionGridView]表格[grid]后台处理对象基类
 */
public class WFActionGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFActionMainGridModel gridModel = null;
    public WFActionGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFActionMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFActionMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFAction entity)throws Exception {
