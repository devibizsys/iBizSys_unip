...
/**
 * 视图[OrgUserRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserRedirectView.do")
public class OrgUserRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OrgUserRedirectViewController() throws Exception {
        super();
        this.setId("95e8ff2fe4015b7192db8c693b1b9c46");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/OrgUserRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserRedirectViewController",this);
    }
