...
/**
 * 应用视图[OA_NSJGHYSQNSJGHYSQ_D10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_NSJGHYSQNSJGHYSQ_D10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_NSJGHYSQMainGridModel gridModel = null;
    public OA_NSJGHYSQNSJGHYSQ_D10_WFGridViewGridHandler()  {
        super();
    }
