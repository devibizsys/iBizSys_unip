...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_STWMDGMainEditFormModel;
...
public class OA_STWMDGSTWMDGLC_W10_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_STWMDGMainEditFormModel editformModel = null;
    public OA_STWMDGSTWMDGLC_W10_WFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_STWMDGMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_STWMDGMainEditFormModel getRealEditFormModel() {
