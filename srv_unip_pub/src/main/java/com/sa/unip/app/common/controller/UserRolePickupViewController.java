...
/**
 * 视图[UserRolePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRolePickupView.do")
public class UserRolePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserRolePickupViewController() throws Exception {
        super();
        this.setId("968b7e94ad617dffb4a34dfb7829a17e");
        this.setCaption("用户角色");
        this.setTitle("用户角色实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRolePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRolePickupViewController",this);
    }
