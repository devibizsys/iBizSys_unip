...
public class OrgSectorPickupGridView2SearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgSectorDefaultSearchFormModel searchformModel = null;
    public OrgSectorPickupGridView2SearchFormHandler()  {
        super();
    }
