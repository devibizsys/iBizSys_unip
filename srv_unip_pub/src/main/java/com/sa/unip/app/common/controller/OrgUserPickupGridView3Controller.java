...
/**
 * 视图[OrgUserPickupGridView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserPickupGridView3.do")
public class OrgUserPickupGridView3Controller extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OrgUserPickupGridView3Controller() throws Exception {
        super();
        this.setId("a68f2f9c579b608cf360da4e28cb74a1");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserPickupGridView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserPickupGridView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserPickupGridView3GridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserPickupGridView3SearchFormHandler");
        searchForm.init(this);
