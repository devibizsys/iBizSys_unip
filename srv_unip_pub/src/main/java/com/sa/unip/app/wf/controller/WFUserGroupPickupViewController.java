...
/**
 * 视图[WFUserGroupPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupPickupView.do")
public class WFUserGroupPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFUserGroupPickupViewController() throws Exception {
        super();
        this.setId("3d1ef8e3c2e02425b1fea0ef2956b3d6");
        this.setCaption("工作流用户组");
        this.setTitle("工作流用户组实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupPickupViewController",this);
    }
