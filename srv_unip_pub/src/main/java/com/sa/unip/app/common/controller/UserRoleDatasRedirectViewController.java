...
/**
 * 视图[UserRoleDatasRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDatasRedirectView.do")
public class UserRoleDatasRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserRoleDatasRedirectViewController() throws Exception {
        super();
        this.setId("e064bd4654582353b8e8a3b6fa7e365f");
        this.setCaption("用户角色数据能力");
        this.setTitle("用户角色数据能力实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDatasRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDatasRedirectViewController",this);
    }
