...
public class DataSyncOutGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected DataSyncOutDefaultSearchFormModel searchformModel = null;
    public DataSyncOutGridViewSearchFormHandler()  {
        super();
    }
