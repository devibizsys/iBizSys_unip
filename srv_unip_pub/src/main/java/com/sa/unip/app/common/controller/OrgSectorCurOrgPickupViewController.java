...
/**
 * 视图[OrgSectorCurOrgPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSectorCurOrgPickupView.do")
public class OrgSectorCurOrgPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgSectorCurOrgPickupViewController() throws Exception {
        super();
        this.setId("858c04f6d6d663b74be90dd36bcfb193");
        this.setCaption("组织部门");
        this.setTitle("当前组织部门数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgSectorCurOrgPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSectorCurOrgPickupViewController",this);
    }
