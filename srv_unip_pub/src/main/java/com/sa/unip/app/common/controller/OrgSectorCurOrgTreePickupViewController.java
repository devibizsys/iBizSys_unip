...
/**
 * 视图[OrgSectorCurOrgTreePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSectorCurOrgTreePickupView.do")
public class OrgSectorCurOrgTreePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgSectorCurOrgTreePickupViewController() throws Exception {
        super();
        this.setId("48c3e4f4313c4c2e2d73cde35fb8b99f");
        this.setCaption("组织部门");
        this.setTitle("当前组织部门树型选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgSectorCurOrgTreePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSectorCurOrgTreePickupViewController",this);
    }
