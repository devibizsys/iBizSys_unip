...
/**
 * 视图[WFUserAssistGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserAssistGridView.do")
public class WFUserAssistGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFUserAssistGridViewController() throws Exception {
        super();
        this.setId("c6d19f483c06f6c51dcfab038c4708d6");
        this.setCaption("工作流用户代办");
        this.setTitle("工作流用户代办实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUserAssistGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserAssistGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserAssistGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserAssistGridViewSearchFormHandler");
        searchForm.init(this);
