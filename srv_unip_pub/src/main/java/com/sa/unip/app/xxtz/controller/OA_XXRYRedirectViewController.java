...
/**
 * 视图[OA_XXRYRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_XXRYRedirectView.do")
public class OA_XXRYRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_XXRYRedirectViewController() throws Exception {
        super();
        this.setId("342e25472673700b0e576304b7fa94b2");
        this.setCaption("消息人员");
        this.setTitle("消息人员数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_XXRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_XXRY.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/xxtz/OA_XXRYRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_XXRYRedirectViewController",this);
    }
