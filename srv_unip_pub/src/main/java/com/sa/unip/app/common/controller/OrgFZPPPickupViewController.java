...
/**
 * 视图[OrgFZPPPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgFZPPPickupView.do")
public class OrgFZPPPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgFZPPPickupViewController() throws Exception {
        super();
        this.setId("e680f75ccf4630b4279f4b967dc69dd0");
        this.setCaption("组织机构");
        this.setTitle("组织机构分组平铺选择视图");
        this.setCapLanResTag("DE.LNAME.ORG");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgFZPPPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgFZPPPickupViewController",this);
    }
