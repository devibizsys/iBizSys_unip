...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_SBWXSHYJFormEditFormModel;
...
public class OA_SBWXWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_SBWXSHYJFormEditFormModel editformModel = null;
    public OA_SBWXWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_SBWXSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_SBWXSHYJFormEditFormModel getRealEditFormModel() {
