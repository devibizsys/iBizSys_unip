...
import com.sa.unip.app.srv.xxtz.ctrlmodel.OA_TZGGRYMainEditFormModel;
...
public class OA_TZGGRYEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OA_TZGGRYMainEditFormModel editformModel = null;
    public OA_TZGGRYEditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_TZGGRYMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_TZGGRYMainEditFormModel getRealEditFormModel() {
