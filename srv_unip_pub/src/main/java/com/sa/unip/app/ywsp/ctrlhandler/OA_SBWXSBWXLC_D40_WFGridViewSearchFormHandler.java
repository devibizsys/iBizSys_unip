...
public class OA_SBWXSBWXLC_D40_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_SBWXDefaultSearchFormModel searchformModel = null;
    public OA_SBWXSBWXLC_D40_WFGridViewSearchFormHandler()  {
        super();
    }
