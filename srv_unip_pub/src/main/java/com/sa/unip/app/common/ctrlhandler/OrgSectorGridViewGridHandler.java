...
/**
 * 应用视图[OrgSectorGridView]表格[grid]后台处理对象基类
 */
public class OrgSectorGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSectorMain2GridModel gridModel = null;
    public OrgSectorGridViewGridHandler()  {
        super();
    }
