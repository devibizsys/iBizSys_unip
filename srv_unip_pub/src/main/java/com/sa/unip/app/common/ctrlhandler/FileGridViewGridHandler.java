...
import com.sa.unip.app.srv.common.ctrlmodel.FileMainGridModel;
...
/**
 * 应用视图[FileGridView]表格[grid]后台处理对象基类
 */
public class FileGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected FileMainGridModel gridModel = null;
    public FileGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (FileMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected FileMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(File entity)throws Exception {
