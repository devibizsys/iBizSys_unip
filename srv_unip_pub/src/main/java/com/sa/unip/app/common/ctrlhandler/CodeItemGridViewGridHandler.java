...
/**
 * 应用视图[CodeItemGridView]表格[grid]后台处理对象基类
 */
public class CodeItemGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected CodeItemMain2GridModel gridModel = null;
    public CodeItemGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(CodeItem entity)throws Exception {
