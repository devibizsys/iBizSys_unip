...
public class OA_PCSQPCSQLC_W20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_PCSQDefaultSearchFormModel searchformModel = null;
    public OA_PCSQPCSQLC_W20_WFGridViewSearchFormHandler()  {
        super();
    }
