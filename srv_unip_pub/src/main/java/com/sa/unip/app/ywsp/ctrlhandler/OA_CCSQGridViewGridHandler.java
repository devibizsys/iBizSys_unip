...
/**
 * 应用视图[OA_CCSQGridView]表格[grid]后台处理对象基类
 */
public class OA_CCSQGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CCSQMainGridModel gridModel = null;
    public OA_CCSQGridViewGridHandler()  {
        super();
    }
