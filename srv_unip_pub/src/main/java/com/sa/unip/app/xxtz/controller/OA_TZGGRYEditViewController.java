...
/**
 * 视图[OA_TZGGRYEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGRYEditView.do")
public class OA_TZGGRYEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public OA_TZGGRYEditViewController() throws Exception {
        super();
        this.setId("37c12d4e8e57782e4ec1ffaab931161e");
        this.setCaption("通知公告人员");
        this.setTitle("通知公告人员编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_GGTZRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGGRY.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGRYEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGRYEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGRYEditViewEditFormHandler");
        editForm.init(this);
