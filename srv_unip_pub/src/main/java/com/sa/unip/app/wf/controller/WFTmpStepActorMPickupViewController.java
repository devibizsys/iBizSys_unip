...
/**
 * 视图[WFTmpStepActorMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFTmpStepActorMPickupView.do")
public class WFTmpStepActorMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFTmpStepActorMPickupViewController() throws Exception {
        super();
        this.setId("cccb0316e833d53f97c49c049fd4b17d");
        this.setCaption("工作流步骤操作者（临时）");
        this.setTitle("工作流步骤操作者（临时）实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFTmpStepActorMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFTmpStepActorMPickupViewController",this);
    }
