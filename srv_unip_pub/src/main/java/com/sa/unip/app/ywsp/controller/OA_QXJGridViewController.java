...
/**
 * 视图[OA_QXJGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJGridView.do")
public class OA_QXJGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_QXJGridViewController() throws Exception {
        super();
        this.setId("73ac781268ed779efbe95e021d48cc4b");
        this.setCaption("请休假");
        this.setTitle("请休假表格视图");
        this.setCapLanResTag("DE.LNAME.OA_QXJ");
        this.setTitleLanResTag("PAGE.TITLE.OA_QXJ.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJGridViewSearchFormHandler");
        searchForm.init(this);
