...
/**
 * 视图[OA_CGSQRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CGSQRedirectView.do")
public class OA_CGSQRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_CGSQRedirectViewController() throws Exception {
        super();
        this.setId("8b8c5676240e6b357da4d67f0dd718fc");
        this.setCaption("采购申请");
        this.setTitle("采购申请数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_CGSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CGSQ.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CGSQRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CGSQRedirectViewController",this);
    }
