...
/**
 * 应用视图[MsgSendQueuePickupGridView]表格[grid]后台处理对象基类
 */
public class MsgSendQueuePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgSendQueueMain2GridModel gridModel = null;
    public MsgSendQueuePickupGridViewGridHandler()  {
        super();
    }
