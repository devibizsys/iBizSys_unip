...
/**
 * 视图[WXMediaPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXMediaPickupView.do")
public class WXMediaPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WXMediaPickupViewController() throws Exception {
        super();
        this.setId("4346621c50ca165d878f35a0b5ec717b");
        this.setCaption("微信多媒体内容");
        this.setTitle("微信多媒体内容实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wx/WXMediaPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXMediaPickupViewController",this);
    }
