...
/**
 * 视图[WFStepActorActiveIconView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepActorActiveIconView.do")
public class WFStepActorActiveIconViewController extends net.ibizsys.paas.controller.MDCustomViewControllerBase {
    public WFStepActorActiveIconViewController() throws Exception {
        super();
        this.setId("ce712cf0578d1b774a078695d1b24f2f");
        this.setCaption("工作流步骤操作者");
        this.setTitle("工作流步骤操作者实体多数据自定义视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepActorActiveIconView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepActorActiveIconViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepActorActiveIconViewGridHandler");
        grid.init(this);
