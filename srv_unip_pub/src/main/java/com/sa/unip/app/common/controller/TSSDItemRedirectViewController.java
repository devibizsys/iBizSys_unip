...
/**
 * 视图[TSSDItemRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDItemRedirectView.do")
public class TSSDItemRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public TSSDItemRedirectViewController() throws Exception {
        super();
        this.setId("1cbabbfd859e7aa2f175c26b540f617e");
        this.setCaption("任务时刻策略项");
        this.setTitle("任务时刻策略项实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/TSSDItemRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDItemRedirectViewController",this);
    }
