...
/**
 * 实体[请休假]数据关系栏[drbar]部件模型
 */
public class  OA_QXJDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OA_QXJDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setTextLanResTag("DE.LNAME.OA_QXJ");
