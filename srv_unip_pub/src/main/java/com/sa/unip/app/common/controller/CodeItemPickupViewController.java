...
/**
 * 视图[CodeItemPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/CodeItemPickupView.do")
public class CodeItemPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public CodeItemPickupViewController() throws Exception {
        super();
        this.setId("138e620c9220bb424fb33255513225ff");
        this.setCaption("代码项");
        this.setTitle("代码项实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/CodeItemPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.CodeItemPickupViewController",this);
    }
