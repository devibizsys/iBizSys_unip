...
/**
 * 实体[车辆维修]流程导航栏[expbar]部件模型
 */
public class  OA_CLWXexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_CLWXexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("F0924354-0FAF-4863-BAF3-7438CB558E48"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("CLWXLC:D:20");
        ...
        expBarItem3.setExpViewId("CLWXLC:D:20:10");
        ...
        expBarItem4.setExpViewId("CLWXLC:D:20:20");
        ...
        expBarItem5.setExpViewId("CLWXLC:D:30");
        ...
        expBarItem6.setExpViewId("CLWXLC:D:40");
        ...
        expBarItem7.setExpViewId("CLWXLC:W");
        ...
        expBarItem8.setExpViewId("CLWXLC:W:10");
        ...
        expBarItem9.setExpViewId("CLWXLC:W:20");
