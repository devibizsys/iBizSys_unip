...
/**
 * 实体[文件]数据关系栏[drbar]部件模型
 */
public class  FileDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public FileDefaultDRBarModel() {
        super();
    }
