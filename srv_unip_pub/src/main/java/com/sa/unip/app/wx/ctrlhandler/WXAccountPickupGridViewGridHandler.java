...
/**
 * 应用视图[WXAccountPickupGridView]表格[grid]后台处理对象基类
 */
public class WXAccountPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXAccountMainGridModel gridModel = null;
    public WXAccountPickupGridViewGridHandler()  {
        super();
    }
