...
/**
 * 实体[数据审计]数据关系栏[drbar]部件模型
 */
public class  DataAuditDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DataAuditDefaultDRBarModel() {
        super();
    }
