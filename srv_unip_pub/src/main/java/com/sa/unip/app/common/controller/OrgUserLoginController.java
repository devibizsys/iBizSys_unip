...
/**
 * 视图[OrgUserLogin]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserLogin.do")
public class OrgUserLoginController extends net.ibizsys.paas.controller.CustomViewControllerBase {
    public OrgUserLoginController() throws Exception {
        super();
        this.setId("1051841a61fba1473078c991e01d7eb1");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体自定义视图");
        this.setAccessUserMode(1);

        ViewControllerGlobal.registerViewController("/app/common/OrgUserLogin.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserLoginController",this);
    }
