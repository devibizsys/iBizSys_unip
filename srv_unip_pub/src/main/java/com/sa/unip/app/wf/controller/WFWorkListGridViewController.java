...
/**
 * 视图[WFWorkListGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFWorkListGridView.do")
public class WFWorkListGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFWorkListGridViewController() throws Exception {
        super();
        this.setId("87dd21ea32469ceec701e1f8a02dfe4f");
        this.setCaption("工作流工作列表");
        this.setTitle("流程工作列表实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFWorkListGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFWorkListGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFWorkListGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFWorkListGridViewSearchFormHandler");
        searchForm.init(this);
