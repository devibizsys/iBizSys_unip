 ...
 */
package com.sa.unip.app.srv.ggsj.ctrlmodel;
...
/**
 * 实体[待办]编辑表单[form]部件模型
 */
public class GG_DBMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public GG_DBMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private com.sa.unip.srv.ggsj.demodel.GG_DBDEModel gG_DBDEModel;
    protected  com.sa.unip.srv.ggsj.demodel.GG_DBDEModel getGG_DBDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("GG_DBID");
            formItem.setCaption("待办标识");
            formItem.setCapLanResTag("DEF.LNAME.GG_DBID");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("GG_DBID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("GG_DBNAME");
            formItem.setCaption("待办名称");
            formItem.setCapLanResTag("DEF.LNAME.GG_DBNAME");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("GG_DBNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // gg_dbname
        iFormItem = this.createFormItem("gg_dbname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("gg_dbname");
            formItem.setDEFName("GG_DBNAME");
            formItem.setCaption("待办名称");
            formItem.setCapLanResTag("DEF.LNAME.GG_DBNAME");
        ...
        this.registerFormItem(iFormItem);
        // gg_dbid
        iFormItem = this.createFormItem("gg_dbid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("gg_dbid");
            formItem.setDEFName("GG_DBID");
            formItem.setCaption("待办标识");
            formItem.setCapLanResTag("DEF.LNAME.GG_DBID");
