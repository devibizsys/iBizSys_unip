...
/**
 * 应用视图[OA_CLGridView]表格[grid]后台处理对象基类
 */
public class OA_CLGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CLMainGridModel gridModel = null;
    public OA_CLGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_CL entity)throws Exception {
