...
/**
 * 应用视图[CodeItemPickupGridView]表格[grid]后台处理对象基类
 */
public class CodeItemPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected CodeItemMain2GridModel gridModel = null;
    public CodeItemPickupGridViewGridHandler()  {
        super();
    }
