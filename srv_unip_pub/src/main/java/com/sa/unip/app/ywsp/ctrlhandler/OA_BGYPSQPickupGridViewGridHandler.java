...
/**
 * 应用视图[OA_BGYPSQPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_BGYPSQPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_BGYPSQMainGridModel gridModel = null;
    public OA_BGYPSQPickupGridViewGridHandler()  {
        super();
    }
