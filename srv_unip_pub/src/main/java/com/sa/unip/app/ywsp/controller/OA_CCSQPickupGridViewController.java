...
/**
 * 视图[OA_CCSQPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQPickupGridView.do")
public class OA_CCSQPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_CCSQPickupGridViewController() throws Exception {
        super();
        this.setId("d0c046b5a090472af44ff12f55b306dd");
        this.setCaption("出差申请");
        this.setTitle("出差申请选择表格视图");
        this.setCapLanResTag("DE.LNAME.QA_CCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CCSQ.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQPickupGridViewSearchFormHandler");
        searchForm.init(this);
