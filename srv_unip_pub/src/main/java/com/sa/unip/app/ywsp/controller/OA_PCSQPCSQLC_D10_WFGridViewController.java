...
/**
 * 视图[OA_PCSQPCSQLC_D10_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_PCSQPCSQLC_D10_WFGridView.do")
public class OA_PCSQPCSQLC_D10_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_PCSQPCSQLC_D10_WFGridViewController() throws Exception {
        super();
        this.setId("ad2f554913a43bb91b3ef4b86f887183");
        this.setCaption("派车申请");
        this.setTitle("派车申请工作流表格视图(派车申请流程:未提交)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_PCSQPCSQLC_D10_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_PCSQPCSQLC_D10_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_PCSQPCSQLC_D10_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_PCSQPCSQLC_D10_WFGridViewSearchFormHandler");
        searchForm.init(this);
