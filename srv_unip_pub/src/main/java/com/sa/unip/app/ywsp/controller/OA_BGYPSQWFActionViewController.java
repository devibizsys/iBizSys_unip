...
/**
 * 视图[OA_BGYPSQWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQWFActionView.do")
public class OA_BGYPSQWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_BGYPSQWFActionViewController() throws Exception {
        super();
        this.setId("4fdaca925a3251f454ff5dcd42e542c3");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_BGYPSQSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQWFActionViewEditFormHandler");
        editForm.init(this);
