...
/**
 * 实体[实体数据变更（已处理）]编辑表单[form]部件模型
 */
public class DEDataChg2MainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DEDataChg2MainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DEDATACHG2ID");
            formItem.setEnableCond(0);
            formItem.setCaption("实体数据变更2标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DEDATACHG2NAME");
            formItem.setCaption("实体数据变更2名称");
        ...
        this.registerFormItem(iFormItem);
        // dedatachg2name
        iFormItem = this.createFormItem("dedatachg2name");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dedatachg2name");
            formItem.setDEFName("DEDATACHG2NAME");
            formItem.setCaption("实体数据变更2名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dedatachg2name");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // dedatachg2id
        iFormItem = this.createFormItem("dedatachg2id");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dedatachg2id");
            formItem.setDEFName("DEDATACHG2ID");
            formItem.setEnableCond(0);
            formItem.setCaption("实体数据变更2标识");
