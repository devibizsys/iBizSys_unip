...
/**
 * 视图[OA_BGYPSQGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQGridView.do")
public class OA_BGYPSQGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_BGYPSQGridViewController() throws Exception {
        super();
        this.setId("1b497651027a8712896497310606e042");
        this.setCaption("办公用品申请");
        this.setTitle("办公用品申请表格视图");
        this.setCapLanResTag("DE.LNAME.OA_BGYPSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_BGYPSQ.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQGridViewSearchFormHandler");
        searchForm.init(this);
