...
import com.sa.unip.app.srv.common.ctrlmodel.CodeListMainGridModel;
...
/**
 * 应用视图[CodeListGridView]表格[grid]后台处理对象基类
 */
public class CodeListGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected CodeListMainGridModel gridModel = null;
    public CodeListGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (CodeListMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected CodeListMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(CodeList entity)throws Exception {
