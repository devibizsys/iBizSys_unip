...
/**
 * 实体[用户对象]数据表格[grid]部件模型
 */
public class  UserObjectMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserObjectMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 用户对象标识
        iGridColumn = createGridColumn("userobjectid");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("userobjectid");
            gridColumnModel.setDataItemName("userobjectid");
            gridColumnModel.setCaption("用户对象标识");
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("用户对象名称");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 用户对象类型
        iGridColumn = createGridColumn("userobjecttype");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("userobjecttype");
            gridColumnModel.setDataItemName("userobjecttype");
            gridColumnModel.setCaption("用户对象类型");
            gridColumnModel.setCodeListId("com.sa.unip.srv.codelist.CodeList5CodeListModel");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USEROBJECTID");
            gridEditItem.setCaption("用户对象标识");
