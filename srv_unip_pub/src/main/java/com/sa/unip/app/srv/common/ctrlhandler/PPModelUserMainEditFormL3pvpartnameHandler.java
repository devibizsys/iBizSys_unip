...
public class PPModelUserMainEditFormL3pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormL3pvpartnameHandler()  {
        super();
    }
