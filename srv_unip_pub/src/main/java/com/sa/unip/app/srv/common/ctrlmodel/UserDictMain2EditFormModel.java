...
/**
 * 实体[用户词典]编辑表单[form]部件模型
 */
public class UserDictMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserDictMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERDICTID");
            formItem.setCaption("用户词典标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERDICTNAME");
            formItem.setCaption("用户词典名称");
        ...
        this.registerFormItem(iFormItem);
        // userdictname
        iFormItem = this.createFormItem("userdictname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userdictname");
            formItem.setDEFName("USERDICTNAME");
            formItem.setCaption("用户词典名称");
        ...
        this.registerFormItem(iFormItem);
        // ownertype
        iFormItem = this.createFormItem("ownertype");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("ownertype");
            formItem.setDEFName("OWNERTYPE");
            formItem.setEnableCond(1);
            formItem.setCaption("所有者类型");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("ownertype");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // ownerid
        iFormItem = this.createFormItem("ownerid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("ownerid");
            formItem.setDEFName("OWNERID");
            formItem.setEnableCond(1);
            formItem.setCaption("所有者标识");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("ownerid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userdictid
        iFormItem = this.createFormItem("userdictid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userdictid");
            formItem.setDEFName("USERDICTID");
            formItem.setCaption("用户词典标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userdictid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
