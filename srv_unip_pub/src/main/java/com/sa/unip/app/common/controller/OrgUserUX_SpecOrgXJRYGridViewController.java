...
/**
 * 视图[OrgUserUX_SpecOrgXJRYGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserUX_SpecOrgXJRYGridView.do")
public class OrgUserUX_SpecOrgXJRYGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OrgUserUX_SpecOrgXJRYGridViewController() throws Exception {
        super();
        this.setId("6f8044ca2b89d4f451e2b4730b27167d");
        this.setCaption("组织人员");
        this.setTitle("UX_指定组织下级人员实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserUX_SpecOrgXJRYGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserUX_SpecOrgXJRYGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 grid
        ICtrlModel grid=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.OrgUserUX_MainGridModel");
        grid.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserUX_SpecOrgXJRYGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserUX_SpecOrgXJRYGridViewSearchFormHandler");
        searchForm.init(this);
