...
/**
 * 视图[DEDataChg2RedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChg2RedirectView.do")
public class DEDataChg2RedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public DEDataChg2RedirectViewController() throws Exception {
        super();
        this.setId("5d264c8657c91a2c3377fb27bdc5c96c");
        this.setCaption("实体数据变更（已处理）");
        this.setTitle("实体数据变更（已处理）实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/DEDataChg2RedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChg2RedirectViewController",this);
    }
