...
public class OA_CPMJSQCPMJSQLC_D_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CPMJSQMainEditFormModel editformModel = null;
    public OA_CPMJSQCPMJSQLC_D_WFEditView3EditFormHandler()  {
        super();
    }
