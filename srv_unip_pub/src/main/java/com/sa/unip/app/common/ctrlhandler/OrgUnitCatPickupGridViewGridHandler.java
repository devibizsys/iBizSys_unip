...
/**
 * 应用视图[OrgUnitCatPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgUnitCatPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUnitCatMain2GridModel gridModel = null;
    public OrgUnitCatPickupGridViewGridHandler()  {
        super();
    }
