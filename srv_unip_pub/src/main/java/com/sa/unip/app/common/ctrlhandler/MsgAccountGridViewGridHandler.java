...
import com.sa.unip.app.srv.common.ctrlmodel.MsgAccountMain2GridModel;
...
/**
 * 应用视图[MsgAccountGridView]表格[grid]后台处理对象基类
 */
public class MsgAccountGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgAccountMain2GridModel gridModel = null;
    public MsgAccountGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (MsgAccountMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected MsgAccountMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(MsgAccount entity)throws Exception {
