...
/**
 * 视图[DataSyncOutPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncOutPickupView.do")
public class DataSyncOutPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DataSyncOutPickupViewController() throws Exception {
        super();
        this.setId("ae990967e700ef7bcad03023840f73c2");
        this.setCaption("数据同步发送队列");
        this.setTitle("数据同步发送队列实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataSyncOutPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncOutPickupViewController",this);
    }
