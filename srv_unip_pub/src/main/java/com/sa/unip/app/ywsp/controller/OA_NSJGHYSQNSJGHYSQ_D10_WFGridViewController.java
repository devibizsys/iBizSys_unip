...
/**
 * 视图[OA_NSJGHYSQNSJGHYSQ_D10_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_NSJGHYSQNSJGHYSQ_D10_WFGridView.do")
public class OA_NSJGHYSQNSJGHYSQ_D10_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_NSJGHYSQNSJGHYSQ_D10_WFGridViewController() throws Exception {
        super();
        this.setId("728bac9229f3c07bc94dc44daad08f0f");
        this.setCaption("内设机构会议申请");
        this.setTitle("内设机构会议申请工作流表格视图(内设机构会议申请:未提交)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_NSJGHYSQNSJGHYSQ_D10_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_NSJGHYSQNSJGHYSQ_D10_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_NSJGHYSQNSJGHYSQ_D10_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_NSJGHYSQNSJGHYSQ_D10_WFGridViewSearchFormHandler");
        searchForm.init(this);
