...
/**
 * 实体[组消息账户明细]数据表格[grid]部件模型
 */
public class  MsgAccountDetailMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public MsgAccountDetailMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 组消息账户明细名称
        iGridColumn = createGridColumn("msgaccountdetailname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("msgaccountdetailname");
            gridColumnModel.setDataItemName("msgaccountdetailname");
            gridColumnModel.setCaption("组消息账户明细名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 msgaccountdetailid
        iGridDataItem = createGridDataItem("msgaccountdetailid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("msgaccountdetailid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("MSGACCOUNTDETAILID");
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 msgaccountdetailname
        iGridDataItem = createGridDataItem("msgaccountdetailname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("msgaccountdetailname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("MSGACCOUNTDETAILNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 minormsgaccountid
        iGridDataItem = createGridDataItem("minormsgaccountid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("minormsgaccountid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("MINORMSGACCOUNTID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 majormsgaccountid
        iGridDataItem = createGridDataItem("majormsgaccountid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("majormsgaccountid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("MAJORMSGACCOUNTID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("MSGACCOUNTDETAILID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("组消息账户明细标识");
