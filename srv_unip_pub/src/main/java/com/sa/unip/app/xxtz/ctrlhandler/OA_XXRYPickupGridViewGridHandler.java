...
/**
 * 应用视图[OA_XXRYPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_XXRYPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_XXRYMainGridModel gridModel = null;
    public OA_XXRYPickupGridViewGridHandler()  {
        super();
    }
