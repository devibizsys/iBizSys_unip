...
/**
 * 视图[MsgAccountGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgAccountGridView.do")
public class MsgAccountGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public MsgAccountGridViewController() throws Exception {
        super();
        this.setId("b4489a0bf422519615430a88d8de12ad");
        this.setCaption("消息账户");
        this.setTitle("消息账户实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/MsgAccountGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgAccountGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgAccountGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgAccountGridViewSearchFormHandler");
        searchForm.init(this);
