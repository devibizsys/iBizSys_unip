...
/**
 * 实体[任务调度日志]搜索表单[searchform]部件模型
 */
public class  TSSDTaskLogDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public TSSDTaskLogDefaultSearchFormModel() {
        super();
