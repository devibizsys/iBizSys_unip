...
/**
 * 实体[实体数据变更（已处理）]数据表格[grid]部件模型
 */
public class  DEDataChg2MainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public DEDataChg2MainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 实体数据变更2名称
        iGridColumn = createGridColumn("dedatachg2name");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("dedatachg2name");
            gridColumnModel.setDataItemName("dedatachg2name");
            gridColumnModel.setCaption("实体数据变更2名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 dedatachg2id
        iGridDataItem = createGridDataItem("dedatachg2id");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dedatachg2id");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHG2ID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        if(iGridDataItem == null) {
            ...
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHG2NAME");
            dataItemParam0.setFormat("");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 dedatachg2name
        iGridDataItem = createGridDataItem("dedatachg2name");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dedatachg2name");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEDATACHG2NAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("DEDATACHG2ID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("实体数据变更2标识");
