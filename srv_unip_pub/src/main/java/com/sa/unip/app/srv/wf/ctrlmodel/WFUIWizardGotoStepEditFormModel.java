 ...
 */
public class WFUIWizardGotoStepEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUIWizardGotoStepEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // datainfo
        iFormItem = this.createFormItem("datainfo");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datainfo");
            formItem.setDEFName("DATAINFO");
            formItem.setEnableCond(0);
            formItem.setCaption("操作数据信息");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datainfo");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // actionmode
        iFormItem = this.createFormItem("actionmode");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("actionmode");
            formItem.setDEFName("ACTIONMODE");
            formItem.setCreateDV("GOTOSTEP");
            formItem.setCaption("操作模式");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("actionmode");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfstepvalue
        iFormItem = this.createFormItem("wfstepvalue");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfstepvalue");
            formItem.setDEFName("WFSTEPVALUE");
            formItem.setCodeListId("net.ibizsys.psrt.srv.codelist.WFGotoStepCodeListModel");
            formItem.setCaption("调整步骤值");
            formItem.setAllowEmpty(false);
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfstepvalue");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // actionparam
        iFormItem = this.createFormItem("actionparam");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("actionparam");
            formItem.setDEFName("ACTIONPARAM");
            formItem.setCreateDVT("CONTEXT");
            formItem.setCreateDV("srfkeys");
            formItem.setCaption("操作参数");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("actionparam");
