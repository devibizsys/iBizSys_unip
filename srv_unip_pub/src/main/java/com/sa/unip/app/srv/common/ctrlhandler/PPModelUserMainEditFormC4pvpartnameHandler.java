...
public class PPModelUserMainEditFormC4pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormC4pvpartnameHandler()  {
        super();
    }
