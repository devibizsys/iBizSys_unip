...
/**
 * 实体[工作流用户操作]数据关系栏[drbar]部件模型
 */
public class  WFActionDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFActionDefaultDRBarModel() {
        super();
    }
