...
/**
 * 实体[工作流配置版本]编辑表单[form]部件模型
 */
public class WFVersionMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFVersionMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFWFVERSIONID");
            formItem.setCaption("工作流配置版本标识");
            formItem.setCapLanResTag("DEF.LNAME.WFWFVERSIONID");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFWFVERSIONID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.WFWFVERSIONNAME");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFWFVERSIONNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfwfversionid
        iFormItem = this.createFormItem("wfwfversionid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfwfversionid");
            formItem.setDEFName("WFWFVERSIONID");
            formItem.setCaption("工作流配置版本标识");
            formItem.setCapLanResTag("DEF.LNAME.WFWFVERSIONID");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfwfversionid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
