...
/**
 * 应用视图[UserRolePickupGridView]表格[grid]后台处理对象基类
 */
public class UserRolePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleMain2GridModel gridModel = null;
    public UserRolePickupGridViewGridHandler()  {
        super();
    }
