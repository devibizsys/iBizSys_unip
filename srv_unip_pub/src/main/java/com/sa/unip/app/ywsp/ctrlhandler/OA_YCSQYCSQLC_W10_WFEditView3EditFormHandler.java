...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YCSQMainEditFormModel;
...
public class OA_YCSQYCSQLC_W10_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YCSQMainEditFormModel editformModel = null;
    public OA_YCSQYCSQLC_W10_WFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YCSQMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YCSQMainEditFormModel getRealEditFormModel() {
