...
/**
 * 视图[FileEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/FileEditView.do")
public class FileEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public FileEditViewController() throws Exception {
        super();
        this.setId("eb8baa16d2e87e3044fb3db339328a56");
        this.setCaption("文件");
        this.setTitle("文件实体编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/FileEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.FileEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.FileEditViewEditFormHandler");
        editForm.init(this);
