...
public class UserRoleTypePickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected UserRoleTypeDefaultSearchFormModel searchformModel = null;
    public UserRoleTypePickupGridViewSearchFormHandler()  {
        super();
    }
