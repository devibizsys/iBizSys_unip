...
/**
 * 视图[DataEntityMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/demodel/DataEntityMPickupView.do")
public class DataEntityMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public DataEntityMPickupViewController() throws Exception {
        super();
        this.setId("e168df8343b179decf6f73aeb076471a");
        this.setCaption("实体");
        this.setTitle("实体实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/demodel/DataEntityMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.demodel.controller.DataEntityMPickupViewController",this);
    }
