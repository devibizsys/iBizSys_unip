...
/**
 * 实体[数据同步发送队列]数据关系栏[drbar]部件模型
 */
public class  DataSyncOutDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DataSyncOutDefaultDRBarModel() {
        super();
    }
