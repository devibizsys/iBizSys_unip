...
/**
 * 视图[OA_STWMDGSTWMDGLC_W10_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGSTWMDGLC_W10_WFEditView3.do")
public class OA_STWMDGSTWMDGLC_W10_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_STWMDGSTWMDGLC_W10_WFEditView3Controller() throws Exception {
        super();
        this.setId("c5557a617f58509cf9990c3ff8ae3fb7");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购工作流视图(食堂外卖订购流程v1:部门领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGSTWMDGLC_W10_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGSTWMDGLC_W10_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_W10_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_W10_WFEditView3EditFormHandler");
        editForm.init(this);
