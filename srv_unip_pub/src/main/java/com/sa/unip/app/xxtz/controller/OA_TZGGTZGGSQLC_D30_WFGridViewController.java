...
/**
 * 视图[OA_TZGGTZGGSQLC_D30_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGTZGGSQLC_D30_WFGridView.do")
public class OA_TZGGTZGGSQLC_D30_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_TZGGTZGGSQLC_D30_WFGridViewController() throws Exception {
        super();
        this.setId("c4a57ccdb6daf894aecdcc01094df1f9");
        this.setCaption("通知公告");
        this.setTitle("通知公告工作流表格视图(通知公告申请:已完成)");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGTZGGSQLC_D30_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGTZGGSQLC_D30_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_D30_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_D30_WFGridViewSearchFormHandler");
        searchForm.init(this);
