 ...
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserPickupView.do")
public class OrgUserPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgUserPickupViewController() throws Exception {
        super();
        this.setId("fafe687d6c75b179da28d9379404fb79");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserPickupViewController",this);
    }
