...
/**
 * 视图[OrgUnitCatRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUnitCatRedirectView.do")
public class OrgUnitCatRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OrgUnitCatRedirectViewController() throws Exception {
        super();
        this.setId("a7ae49ec47aedb9a8263814cac0eebca");
        this.setCaption("组织单元类别");
        this.setTitle("组织单元类别实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/OrgUnitCatRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUnitCatRedirectViewController",this);
    }
