...
/**
 * 视图[DEDataChgDispGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChgDispGridView.do")
public class DEDataChgDispGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public DEDataChgDispGridViewController() throws Exception {
        super();
        this.setId("53f0e67a4719cda4dc499f03af053917");
        this.setCaption("实体数据变更派发引擎");
        this.setTitle("实体数据变更派发引擎实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/DEDataChgDispGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChgDispGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DEDataChgDispGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DEDataChgDispGridViewSearchFormHandler");
        searchForm.init(this);
