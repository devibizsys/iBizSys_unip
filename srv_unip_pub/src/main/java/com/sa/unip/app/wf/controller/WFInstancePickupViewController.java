...
/**
 * 视图[WFInstancePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFInstancePickupView.do")
public class WFInstancePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFInstancePickupViewController() throws Exception {
        super();
        this.setId("84620242104d9dc5fd06bffbe71bdf1b");
        this.setCaption("工作流实例");
        this.setTitle("工作流实例实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFInstancePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFInstancePickupViewController",this);
    }
