...
/**
 * 视图[WFCustomProcessMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFCustomProcessMPickupView.do")
public class WFCustomProcessMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFCustomProcessMPickupViewController() throws Exception {
        super();
        this.setId("8ecc324b50ea136aaff675fab5738659");
        this.setCaption("工作流预定义处理");
        this.setTitle("工作流预定义处理实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFCustomProcessMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFCustomProcessMPickupViewController",this);
    }
