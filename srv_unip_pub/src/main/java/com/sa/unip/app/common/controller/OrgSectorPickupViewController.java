 ...
 */
@Controller
@RequestMapping(value = "/app/common/OrgSectorPickupView.do")
public class OrgSectorPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgSectorPickupViewController() throws Exception {
        super();
        this.setId("b50579ea0dfc11745cb896c2eacd9c91");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgSectorPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSectorPickupViewController",this);
    }
