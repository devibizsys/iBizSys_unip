...
/**
 * 视图[WFIAActionGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFIAActionGridView.do")
public class WFIAActionGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFIAActionGridViewController() throws Exception {
        super();
        this.setId("2bcf81fe446ec0557d8b0c8bb1f56fdd");
        this.setCaption("工作流交互操作");
        this.setTitle("工作流交互操作实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFIAActionGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFIAActionGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFIAActionGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFIAActionGridViewSearchFormHandler");
        searchForm.init(this);
