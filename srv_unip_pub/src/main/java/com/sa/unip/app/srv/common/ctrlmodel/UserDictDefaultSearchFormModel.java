...
/**
 * 实体[用户词典]搜索表单[searchform]部件模型
 */
public class  UserDictDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserDictDefaultSearchFormModel() {
        super();
