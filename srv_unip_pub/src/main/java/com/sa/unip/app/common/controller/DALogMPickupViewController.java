...
/**
 * 视图[DALogMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DALogMPickupView.do")
public class DALogMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public DALogMPickupViewController() throws Exception {
        super();
        this.setId("e307c0aac1dba99d160ab91c0342edd4");
        this.setCaption("DA日志");
        this.setTitle("DA日志实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DALogMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DALogMPickupViewController",this);
    }
