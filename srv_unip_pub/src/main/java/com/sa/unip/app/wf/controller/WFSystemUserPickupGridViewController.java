...
/**
 * 视图[WFSystemUserPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFSystemUserPickupGridView.do")
public class WFSystemUserPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public WFSystemUserPickupGridViewController() throws Exception {
        super();
        this.setId("83ed3c0a22c2a77152a2db1b67a5de99");
        this.setCaption("工作流系统用户");
        this.setTitle("工作流系统用户实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFSystemUserPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFSystemUserPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFSystemUserPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFSystemUserPickupGridViewSearchFormHandler");
        searchForm.init(this);
