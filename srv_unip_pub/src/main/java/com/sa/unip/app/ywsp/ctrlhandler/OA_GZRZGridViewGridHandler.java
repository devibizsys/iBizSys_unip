...
/**
 * 应用视图[OA_GZRZGridView]表格[grid]后台处理对象基类
 */
public class OA_GZRZGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_GZRZMainGridModel gridModel = null;
    public OA_GZRZGridViewGridHandler()  {
        super();
    }
