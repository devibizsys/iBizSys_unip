...
/**
 * 实体[注册表]数据表格[grid]部件模型
 */
public class  RegistryMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public RegistryMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.RegistryDEModel registryDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.RegistryDEModel getRegistryDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 系统目录
        iGridColumn = createGridColumn("registryname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("registryname");
            gridColumnModel.setDataItemName("registryname");
            gridColumnModel.setCaption("系统目录");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 registryname
        iGridDataItem = createGridDataItem("registryname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("registryname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("REGISTRYNAME");
        ...
        //建立数据项 registryid
        iGridDataItem = createGridDataItem("registryid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("registryid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("REGISTRYID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("REGISTRYID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("注册表标识");
