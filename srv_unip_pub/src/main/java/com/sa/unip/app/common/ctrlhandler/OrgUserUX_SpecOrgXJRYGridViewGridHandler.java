...
import com.sa.unip.app.srv.common.ctrlmodel.OrgUserUX_MainGridModel;
...
/**
 * 应用视图[OrgUserUX_SpecOrgXJRYGridView]表格[grid]后台处理对象基类
 */
public class OrgUserUX_SpecOrgXJRYGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserUX_MainGridModel gridModel = null;
    public OrgUserUX_SpecOrgXJRYGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgUserUX_MainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgUserUX_MainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchUX_ORGUSERSPEC(deDataSetFetchContext);
    }
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OrgUser entity)throws Exception {
