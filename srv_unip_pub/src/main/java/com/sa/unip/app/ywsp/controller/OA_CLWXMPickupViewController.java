...
/**
 * 视图[OA_CLWXMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CLWXMPickupView.do")
public class OA_CLWXMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_CLWXMPickupViewController() throws Exception {
        super();
        this.setId("9e580b10a9a687f41f634fd497fde63e");
        this.setCaption("车辆维修");
        this.setTitle("车辆维修数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_CLWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_CLWX.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CLWXMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CLWXMPickupViewController",this);
    }
