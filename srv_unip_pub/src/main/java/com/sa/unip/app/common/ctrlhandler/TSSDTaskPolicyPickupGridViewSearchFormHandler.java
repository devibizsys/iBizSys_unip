...
public class TSSDTaskPolicyPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected TSSDTaskPolicyDefaultSearchFormModel searchformModel = null;
    public TSSDTaskPolicyPickupGridViewSearchFormHandler()  {
        super();
    }
