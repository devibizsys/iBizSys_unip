...
/**
 * 视图[OA_SBWXSBWXLC_D_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXSBWXLC_D_WFEditView3.do")
public class OA_SBWXSBWXLC_D_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_SBWXSBWXLC_D_WFEditView3Controller() throws Exception {
        super();
        this.setId("ac1be3a1125d32931254d9dbd437f647");
        this.setCaption("设备维修");
        this.setTitle("设备维修工作流视图(设备维修流程)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXSBWXLC_D_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXSBWXLC_D_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_D_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_D_WFEditView3EditFormHandler");
        editForm.init(this);
