...
/**
 * 视图[OA_YCSQMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQMPickupView.do")
public class OA_YCSQMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_YCSQMPickupViewController() throws Exception {
        super();
        this.setId("28c0a9fc4eb2269facd1151d824bffa2");
        this.setCaption("用餐申请");
        this.setTitle("用餐申请数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_YCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YCSQ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQMPickupViewController",this);
    }
