...
public class WFCustomProcessGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFCustomProcessDefaultSearchFormModel searchformModel = null;
    public WFCustomProcessGridViewSearchFormHandler()  {
        super();
    }
