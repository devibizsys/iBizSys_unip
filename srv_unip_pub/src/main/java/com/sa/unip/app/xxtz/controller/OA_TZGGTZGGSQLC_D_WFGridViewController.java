...
/**
 * 视图[OA_TZGGTZGGSQLC_D_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGTZGGSQLC_D_WFGridView.do")
public class OA_TZGGTZGGSQLC_D_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_TZGGTZGGSQLC_D_WFGridViewController() throws Exception {
        super();
        this.setId("ca73310e69de694b3f77cec3c67c4a28");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGTZGGSQLC_D_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGTZGGSQLC_D_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_D_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_D_WFGridViewSearchFormHandler");
        searchForm.init(this);
