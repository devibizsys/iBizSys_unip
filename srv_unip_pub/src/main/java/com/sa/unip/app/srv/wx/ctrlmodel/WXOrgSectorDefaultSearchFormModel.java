...
/**
 * 实体[微信部门]搜索表单[searchform]部件模型
 */
public class  WXOrgSectorDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WXOrgSectorDefaultSearchFormModel() {
        super();
