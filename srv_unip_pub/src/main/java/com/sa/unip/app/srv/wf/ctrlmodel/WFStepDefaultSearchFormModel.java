...
/**
 * 实体[工作流步骤]搜索表单[searchform]部件模型
 */
public class  WFStepDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WFStepDefaultSearchFormModel() {
        super();
