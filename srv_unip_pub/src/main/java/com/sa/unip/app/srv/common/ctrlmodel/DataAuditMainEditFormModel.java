...
/**
 * 实体[数据审计]编辑表单[form]部件模型
 */
public class DataAuditMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DataAuditMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATAAUDITID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据审计标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATAAUDITNAME");
            formItem.setCaption("审计条目");
        ...
        this.registerFormItem(iFormItem);
        // dataauditname
        iFormItem = this.createFormItem("dataauditname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dataauditname");
            formItem.setDEFName("DATAAUDITNAME");
            formItem.setCaption("审计条目");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dataauditname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // dataauditid
        iFormItem = this.createFormItem("dataauditid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dataauditid");
            formItem.setDEFName("DATAAUDITID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据审计标识");
