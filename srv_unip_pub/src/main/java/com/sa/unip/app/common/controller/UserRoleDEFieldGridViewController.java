...
/**
 * 视图[UserRoleDEFieldGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDEFieldGridView.do")
public class UserRoleDEFieldGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public UserRoleDEFieldGridViewController() throws Exception {
        super();
        this.setId("24de278fdfb9554e099ef882eca2e130");
        this.setCaption("用户角色实体属性访问");
        this.setTitle("用户角色实体属性访问实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleDEFieldGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDEFieldGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDEFieldGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDEFieldGridViewSearchFormHandler");
        searchForm.init(this);
