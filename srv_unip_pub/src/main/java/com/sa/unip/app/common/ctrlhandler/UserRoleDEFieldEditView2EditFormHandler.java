...
import com.sa.unip.app.srv.common.ctrlmodel.UserRoleDEFieldMain2EditFormModel;
...
public class UserRoleDEFieldEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected UserRoleDEFieldMain2EditFormModel editformModel = null;
    public UserRoleDEFieldEditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (UserRoleDEFieldMain2EditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected UserRoleDEFieldMain2EditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'dename'
        IFormItemHandler denameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.UserRoleDEFieldMain2EditFormDenameHandler");
    ...
    protected String getGetEntityAction() {
        return UserRoleDEFieldService.ACTION_GET;
    }
    ...
    protected IEntity getDraftEntityFrom(Object objKeyValue)throws Exception {
        UserRoleDEField entity = new UserRoleDEField();
        entity.set(UserRoleDEField.FIELD_USERROLEDEFIELDID,objKeyValue);
        this.getRealService().executeAction(UserRoleDEFieldService.ACTION_GETDRAFTFROM,entity);
        return entity;
    }
