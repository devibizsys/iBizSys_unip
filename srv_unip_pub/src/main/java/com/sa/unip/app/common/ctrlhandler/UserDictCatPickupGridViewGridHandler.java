...
/**
 * 应用视图[UserDictCatPickupGridView]表格[grid]后台处理对象基类
 */
public class UserDictCatPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDictCatMain2GridModel gridModel = null;
    public UserDictCatPickupGridViewGridHandler()  {
        super();
    }
