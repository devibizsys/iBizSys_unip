...
public class OA_CLWXCLWXLC_D_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CLWXMainEditFormModel editformModel = null;
    public OA_CLWXCLWXLC_D_WFEditView3EditFormHandler()  {
        super();
    }
