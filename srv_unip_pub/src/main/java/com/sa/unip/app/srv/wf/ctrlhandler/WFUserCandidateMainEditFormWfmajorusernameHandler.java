...
public class WFUserCandidateMainEditFormWfmajorusernameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFUserCandidateMainEditFormWfmajorusernameHandler()  {
        super();
    }
