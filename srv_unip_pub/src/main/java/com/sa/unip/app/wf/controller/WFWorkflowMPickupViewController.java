...
/**
 * 视图[WFWorkflowMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFWorkflowMPickupView.do")
public class WFWorkflowMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFWorkflowMPickupViewController() throws Exception {
        super();
        this.setId("86056a5a801e75caa23b7482c3eda66d");
        this.setCaption("工作流配置");
        this.setTitle("工作流配置实体数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.WFWORKFLOW");
        this.setTitleLanResTag("PAGE.TITLE.WFWORKFLOW.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFWorkflowMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFWorkflowMPickupViewController",this);
    }
