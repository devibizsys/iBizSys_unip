...
/**
 * 视图[TSSDEngineRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDEngineRedirectView.do")
public class TSSDEngineRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public TSSDEngineRedirectViewController() throws Exception {
        super();
        this.setId("ca6aa6af10dd71ff1160278f11056d9e");
        this.setCaption("任务调度引擎");
        this.setTitle("任务调度引擎实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/TSSDEngineRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDEngineRedirectViewController",this);
    }
