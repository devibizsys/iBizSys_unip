...
import com.sa.unip.app.srv.common.ctrlmodel.UserRoleResMainEditFormModel;
...
public class UserRoleResEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected UserRoleResMainEditFormModel editformModel = null;
    public UserRoleResEditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (UserRoleResMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected UserRoleResMainEditFormModel getRealEditFormModel() {
