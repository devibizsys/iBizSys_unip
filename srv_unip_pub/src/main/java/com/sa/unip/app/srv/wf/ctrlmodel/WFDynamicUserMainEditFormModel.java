...
/**
 * 实体[工作流动态用户]编辑表单[form]部件模型
 */
public class WFDynamicUserMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFDynamicUserMainEditFormModel()  {
        super();
        this.setName("form");
    }

    private net.ibizsys.psrt.srv.wf.demodel.WFDynamicUserDEModel wFDynamicUserDEModel;
    protected  net.ibizsys.psrt.srv.wf.demodel.WFDynamicUserDEModel getWFDynamicUserDEModel() {
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFDYNAMICUSERID");
            formItem.setCaption("工作流动态用户标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFDYNAMICUSERID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFDYNAMICUSERNAME");
            formItem.setCaption("工作流动态用户名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFDYNAMICUSERNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfdynamicuserid
        iFormItem = this.createFormItem("wfdynamicuserid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfdynamicuserid");
            formItem.setDEFName("WFDYNAMICUSERID");
            formItem.setCaption("工作流动态用户标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfdynamicuserid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
