...
import com.sa.unip.app.srv.wx.ctrlmodel.WXAccountMainGridModel;
...
/**
 * 应用视图[WXAccountGridView]表格[grid]后台处理对象基类
 */
public class WXAccountGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXAccountMainGridModel gridModel = null;
    public WXAccountGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WXAccountMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WXAccountMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WXAccount entity)throws Exception {
