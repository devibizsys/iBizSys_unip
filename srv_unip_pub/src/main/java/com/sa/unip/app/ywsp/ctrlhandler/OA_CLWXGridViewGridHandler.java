...
/**
 * 应用视图[OA_CLWXGridView]表格[grid]后台处理对象基类
 */
public class OA_CLWXGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CLWXMainGridModel gridModel = null;
    public OA_CLWXGridViewGridHandler()  {
        super();
    }
