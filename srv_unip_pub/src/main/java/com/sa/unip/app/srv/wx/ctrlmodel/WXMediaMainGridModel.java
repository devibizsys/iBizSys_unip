...
/**
 * 实体[微信多媒体内容]数据表格[grid]部件模型
 */
public class  WXMediaMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WXMediaMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.wx.demodel.WXMediaDEModel wXMediaDEModel;
    protected  net.ibizsys.psrt.srv.wx.demodel.WXMediaDEModel getWXMediaDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 微信多媒体内容名称
        iGridColumn = createGridColumn("wxmedianame");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("wxmedianame");
            gridColumnModel.setDataItemName("wxmedianame");
            gridColumnModel.setCaption("微信多媒体内容名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wxmedianame
        iGridDataItem = createGridDataItem("wxmedianame");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxmedianame");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXMEDIANAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wxmediaid
        iGridDataItem = createGridDataItem("wxmediaid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxmediaid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXMEDIAID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WXMEDIAID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("微信多媒体内容标识");
