...
/**
 * 视图[WFUserCandidatePickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserCandidatePickupGridView.do")
public class WFUserCandidatePickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public WFUserCandidatePickupGridViewController() throws Exception {
        super();
        this.setId("bd5c254958a3f224e42de3899baa930b");
        this.setCaption("工作流用户候选者");
        this.setTitle("工作流用户候选者实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFUserCandidatePickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserCandidatePickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserCandidatePickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFUserCandidatePickupGridViewSearchFormHandler");
        searchForm.init(this);
