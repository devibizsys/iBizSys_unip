...
/**
 * 视图[TSSDTaskLogMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDTaskLogMPickupView.do")
public class TSSDTaskLogMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public TSSDTaskLogMPickupViewController() throws Exception {
        super();
        this.setId("47bee214bfcebf3c601b3e9063ca7bb0");
        this.setCaption("任务调度日志");
        this.setTitle("任务调度日志实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/TSSDTaskLogMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDTaskLogMPickupViewController",this);
    }
