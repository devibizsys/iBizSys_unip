...
import com.sa.unip.app.srv.common.ctrlmodel.DALogMainGridModel;
...
/**
 * 应用视图[DALogGridView]表格[grid]后台处理对象基类
 */
public class DALogGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DALogMainGridModel gridModel = null;
    public DALogGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DALogMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DALogMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DALog entity)throws Exception {
