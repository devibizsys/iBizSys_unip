...
/**
 * 实体[用户词条类别]数据表格[grid]部件模型
 */
public class  UserDictCatMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserDictCatMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("用户词典类别名称");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERDICTCATID");
            gridEditItem.setCaption("用户词典类别标识");
