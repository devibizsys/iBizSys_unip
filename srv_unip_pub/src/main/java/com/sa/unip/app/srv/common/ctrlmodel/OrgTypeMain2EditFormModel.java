...
/**
 * 实体[组织类型]编辑表单[form]部件模型
 */
public class OrgTypeMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OrgTypeMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("ORGTYPEID");
            formItem.setCaption("组织类型标识");
        ...
        this.registerFormItem(iFormItem);
        // orgtypeid
        iFormItem = this.createFormItem("orgtypeid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("orgtypeid");
            formItem.setDEFName("ORGTYPEID");
            formItem.setCaption("组织类型标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("orgtypeid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // orgtypename
        iFormItem = this.createFormItem("orgtypename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("orgtypename");
            formItem.setDEFName("ORGTYPENAME");
            formItem.setCaption("组织类型名称");
