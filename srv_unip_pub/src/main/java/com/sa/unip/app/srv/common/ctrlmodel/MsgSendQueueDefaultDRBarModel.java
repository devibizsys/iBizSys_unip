...
/**
 * 实体[消息发送队列]数据关系栏[drbar]部件模型
 */
public class  MsgSendQueueDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public MsgSendQueueDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setText("消息发送队列");
        drCtrlItem0.setDRViewId("");
        drCtrlItem0.setExpanded(true);
        drCtrlItem0.setTextLanResTag("DE.LNAME.MSGSENDQUEUE");
