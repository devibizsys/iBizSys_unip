...
/**
 * 实体[统一资源]数据关系栏[drbar]部件模型
 */
public class  UniResDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UniResDefaultDRBarModel() {
        super();
    }
    ...
    protected  net.ibizsys.psrt.srv.common.demodel.UniResDEModel getUniResDEModel() {
