...
/**
 * 应用视图[WFStepActorActiveGridView]表格[grid]后台处理对象基类
 */
public class WFStepActorActiveGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFStepActorGridHandlerBase {

    protected WFStepActorMain2GridModel gridModel = null;
    public WFStepActorActiveGridViewGridHandler()  {
        super();
    }
