...
/**
 * 应用视图[UserDictPickupGridView]表格[grid]后台处理对象基类
 */
public class UserDictPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDictMain2GridModel gridModel = null;
    public UserDictPickupGridViewGridHandler()  {
        super();
    }
