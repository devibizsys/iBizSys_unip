...
/**
 * 应用视图[MsgSendQueueHisPickupGridView]表格[grid]后台处理对象基类
 */
public class MsgSendQueueHisPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected MsgSendQueueHisMain2GridModel gridModel = null;
    public MsgSendQueueHisPickupGridViewGridHandler()  {
        super();
    }
