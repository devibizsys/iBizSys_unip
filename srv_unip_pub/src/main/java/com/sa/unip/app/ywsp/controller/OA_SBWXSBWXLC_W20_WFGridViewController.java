...
/**
 * 视图[OA_SBWXSBWXLC_W20_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_SBWXSBWXLC_W20_WFGridView.do")
public class OA_SBWXSBWXLC_W20_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_SBWXSBWXLC_W20_WFGridViewController() throws Exception {
        super();
        this.setId("9f1905fdc0f41816f55112ba397906fd");
        this.setCaption("设备维修");
        this.setTitle("设备维修工作流表格视图(设备维修流程:资产管理处审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_SBWXSBWXLC_W20_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_SBWXSBWXLC_W20_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_W20_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_SBWXSBWXLC_W20_WFGridViewSearchFormHandler");
        searchForm.init(this);
