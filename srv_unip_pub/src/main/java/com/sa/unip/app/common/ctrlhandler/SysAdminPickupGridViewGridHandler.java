...
/**
 * 应用视图[SysAdminPickupGridView]表格[grid]后台处理对象基类
 */
public class SysAdminPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected SysAdminMainGridModel gridModel = null;
    public SysAdminPickupGridViewGridHandler()  {
        super();
    }
