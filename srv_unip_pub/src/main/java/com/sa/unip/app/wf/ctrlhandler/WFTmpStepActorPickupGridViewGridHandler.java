...
/**
 * 应用视图[WFTmpStepActorPickupGridView]表格[grid]后台处理对象基类
 */
public class WFTmpStepActorPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFTmpStepActorMainGridModel gridModel = null;
    public WFTmpStepActorPickupGridViewGridHandler()  {
        super();
    }
