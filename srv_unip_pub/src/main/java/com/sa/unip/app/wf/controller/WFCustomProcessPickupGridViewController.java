...
/**
 * 视图[WFCustomProcessPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFCustomProcessPickupGridView.do")
public class WFCustomProcessPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public WFCustomProcessPickupGridViewController() throws Exception {
        super();
        this.setId("acc8a7b597c0a3ef049b836c5aaae056");
        this.setCaption("工作流预定义处理");
        this.setTitle("工作流预定义处理实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFCustomProcessPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFCustomProcessPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFCustomProcessPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFCustomProcessPickupGridViewSearchFormHandler");
        searchForm.init(this);
