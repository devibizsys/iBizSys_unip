...
/**
 * 实体[用户角色资源能力]编辑表单[form]部件模型
 */
public class UserRoleResMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserRoleResMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLERESID");
            formItem.setEnableCond(0);
            formItem.setCaption("用户角色资源能力标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERROLERESID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLERESNAME");
            formItem.setCaption("用户角色资源能力名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("USERROLERESNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userroleresname
        iFormItem = this.createFormItem("userroleresname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroleresname");
            formItem.setDEFName("USERROLERESNAME");
            formItem.setCaption("用户角色资源能力名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroleresname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userroleresid
        iFormItem = this.createFormItem("userroleresid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroleresid");
            formItem.setDEFName("USERROLERESID");
            formItem.setEnableCond(0);
            formItem.setCaption("用户角色资源能力标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroleresid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
