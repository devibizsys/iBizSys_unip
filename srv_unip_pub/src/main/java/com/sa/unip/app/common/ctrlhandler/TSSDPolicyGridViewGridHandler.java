...
import com.sa.unip.app.srv.common.ctrlmodel.TSSDPolicyMainGridModel;
...
/**
 * 应用视图[TSSDPolicyGridView]表格[grid]后台处理对象基类
 */
public class TSSDPolicyGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDPolicyMainGridModel gridModel = null;
    public TSSDPolicyGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (TSSDPolicyMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected TSSDPolicyMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(TSSDPolicy entity)throws Exception {
