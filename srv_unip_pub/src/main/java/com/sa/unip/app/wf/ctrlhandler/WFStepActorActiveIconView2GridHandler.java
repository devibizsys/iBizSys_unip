...
import com.sa.unip.app.srv.wf.ctrlmodel.WFStepActorMain2GridModel;
...
/**
 * 应用视图[WFStepActorActiveIconView2]表格[grid]后台处理对象基类
 */
public class WFStepActorActiveIconView2GridHandler extends net.ibizsys.pswf.ctrlhandler.WFStepActorGridHandlerBase {

    protected WFStepActorMain2GridModel gridModel = null;
    public WFStepActorActiveIconView2GridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFStepActorMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFStepActorMain2GridModel getRealGridModel() {
