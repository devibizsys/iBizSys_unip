...
/**
 * 应用视图[OrgSecUserPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgSecUserPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSecUserMain2GridModel gridModel = null;
    public OrgSecUserPickupGridViewGridHandler()  {
        super();
    }
