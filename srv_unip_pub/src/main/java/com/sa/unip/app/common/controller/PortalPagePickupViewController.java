...
/**
 * 视图[PortalPagePickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/PortalPagePickupView.do")
public class PortalPagePickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public PortalPagePickupViewController() throws Exception {
        super();
        this.setId("8a21a9d25041af3224230a3c421a6174");
        this.setCaption("门户页面");
        this.setTitle("门户页面实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/PortalPagePickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.PortalPagePickupViewController",this);
    }
