...
public class OrgSecUserPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgSecUserDefaultSearchFormModel searchformModel = null;
    public OrgSecUserPickupGridViewSearchFormHandler()  {
        super();
    }
