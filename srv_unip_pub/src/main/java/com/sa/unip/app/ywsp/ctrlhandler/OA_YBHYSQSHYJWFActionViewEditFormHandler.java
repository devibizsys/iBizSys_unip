...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YBHYSQSHYJFormEditFormModel;
...
public class OA_YBHYSQSHYJWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_YBHYSQSHYJFormEditFormModel editformModel = null;
    public OA_YBHYSQSHYJWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YBHYSQSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YBHYSQSHYJFormEditFormModel getRealEditFormModel() {
