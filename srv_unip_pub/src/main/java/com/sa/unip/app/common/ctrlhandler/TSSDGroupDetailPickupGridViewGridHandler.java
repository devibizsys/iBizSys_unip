...
/**
 * 应用视图[TSSDGroupDetailPickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDGroupDetailPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDGroupDetailMainGridModel gridModel = null;
    public TSSDGroupDetailPickupGridViewGridHandler()  {
        super();
    }
