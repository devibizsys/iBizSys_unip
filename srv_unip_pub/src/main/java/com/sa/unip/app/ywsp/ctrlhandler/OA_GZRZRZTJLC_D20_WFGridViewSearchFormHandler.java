...
public class OA_GZRZRZTJLC_D20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_GZRZDefaultSearchFormModel searchformModel = null;
    public OA_GZRZRZTJLC_D20_WFGridViewSearchFormHandler()  {
        super();
    }
