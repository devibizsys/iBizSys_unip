...
public class OA_CPMJSQPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_CPMJSQDefaultSearchFormModel searchformModel = null;
    public OA_CPMJSQPickupGridViewSearchFormHandler()  {
        super();
    }
