...
/**
 * 视图[WXMediaGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXMediaGridView.do")
public class WXMediaGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WXMediaGridViewController() throws Exception {
        super();
        this.setId("e72da95306e2180a6965dc14a5034318");
        this.setCaption("微信多媒体内容");
        this.setTitle("微信多媒体内容实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wx/WXMediaGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXMediaGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXMediaGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXMediaGridViewSearchFormHandler");
        searchForm.init(this);
