 ...
 */
@Controller
@RequestMapping(value = "/app/common/UserGroupEditView3.do")
public class UserGroupEditView3Controller extends net.ibizsys.paas.controller.EditView3ControllerBase {
    public UserGroupEditView3Controller() throws Exception {
        super();
        this.setId("4b0fdae77e4ab7ceb8928a798db16547");
        this.setCaption("用户组");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserGroupEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserGroupEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 drtab
        ICtrlModel drTab=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.UserGroupDR2DRTabModel");
        drTab.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserGroupEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserGroupEditView3EditFormHandler");
        editForm.init(this);
