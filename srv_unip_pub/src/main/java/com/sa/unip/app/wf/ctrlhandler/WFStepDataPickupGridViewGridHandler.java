...
import com.sa.unip.app.srv.wf.ctrlmodel.WFStepDataMainGridModel;
...
/**
 * 应用视图[WFStepDataPickupGridView]表格[grid]后台处理对象基类
 */
public class WFStepDataPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepDataMainGridModel gridModel = null;
    public WFStepDataPickupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFStepDataMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFStepDataMainGridModel getRealGridModel() {
