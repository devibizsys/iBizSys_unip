...
public class WFActorPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFActorDefaultSearchFormModel searchformModel = null;
    public WFActorPickupGridViewSearchFormHandler()  {
        super();
    }
