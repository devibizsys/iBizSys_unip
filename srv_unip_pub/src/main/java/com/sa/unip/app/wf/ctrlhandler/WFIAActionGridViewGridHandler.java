...
/**
 * 应用视图[WFIAActionGridView]表格[grid]后台处理对象基类
 */
public class WFIAActionGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFIAActionMainGridModel gridModel = null;
    public WFIAActionGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFIAAction entity)throws Exception {
