...
/**
 * 视图[OA_YYSSQPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YYSSQPickupView.do")
public class OA_YYSSQPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_YYSSQPickupViewController() throws Exception {
        super();
        this.setId("2e874f069302538c29eda2f318b1c881");
        this.setCaption("饮用水申请");
        this.setTitle("饮用水申请数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_YYSSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YYSSQ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YYSSQPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YYSSQPickupViewController",this);
    }
