...
/**
 * 视图[MsgAccountPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgAccountPickupView.do")
public class MsgAccountPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public MsgAccountPickupViewController() throws Exception {
        super();
        this.setId("09216ea2af29dc56cf2fb105596f2171");
        this.setCaption("消息账户");
        this.setTitle("消息账户实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/MsgAccountPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgAccountPickupViewController",this);
    }
