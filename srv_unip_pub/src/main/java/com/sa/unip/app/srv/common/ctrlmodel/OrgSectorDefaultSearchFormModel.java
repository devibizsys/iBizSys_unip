...
/**
 * 实体[组织部门]搜索表单[searchform]部件模型
 */
public class  OrgSectorDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OrgSectorDefaultSearchFormModel() {
        super();
