...
/**
 * 应用视图[TSSDGroupPickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDGroupPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDGroupMainGridModel gridModel = null;
    public TSSDGroupPickupGridViewGridHandler()  {
        super();
    }
