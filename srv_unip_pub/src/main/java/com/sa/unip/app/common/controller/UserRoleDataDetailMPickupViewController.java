...
/**
 * 视图[UserRoleDataDetailMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDataDetailMPickupView.do")
public class UserRoleDataDetailMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserRoleDataDetailMPickupViewController() throws Exception {
        super();
        this.setId("f1433c550f0ae54ea41d920ad67056b6");
        this.setCaption("数据对象能力明细");
        this.setTitle("数据对象能力明细实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDataDetailMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDataDetailMPickupViewController",this);
    }
