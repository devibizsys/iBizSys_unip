...
import com.sa.unip.app.srv.wx.ctrlmodel.WXMediaMainGridModel;
...
/**
 * 应用视图[WXMediaGridView]表格[grid]后台处理对象基类
 */
public class WXMediaGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXMediaMainGridModel gridModel = null;
    public WXMediaGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WXMediaMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WXMediaMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WXMedia entity)throws Exception {
