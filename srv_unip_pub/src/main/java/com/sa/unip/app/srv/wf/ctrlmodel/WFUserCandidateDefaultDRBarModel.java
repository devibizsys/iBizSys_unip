...
/**
 * 实体[工作流用户候选者]数据关系栏[drbar]部件模型
 */
public class  WFUserCandidateDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFUserCandidateDefaultDRBarModel() {
        super();
    }
