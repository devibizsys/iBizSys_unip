...
/**
 * 视图[WFReminderMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFReminderMPickupView.do")
public class WFReminderMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFReminderMPickupViewController() throws Exception {
        super();
        this.setId("67c74c2bb29a0004ddd63a65309a0700");
        this.setCaption("工作流工作催办");
        this.setTitle("工作流工作催办实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFReminderMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFReminderMPickupViewController",this);
    }
