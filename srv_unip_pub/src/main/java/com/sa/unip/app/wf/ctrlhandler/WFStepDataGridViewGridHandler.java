...
/**
 * 应用视图[WFStepDataGridView]表格[grid]后台处理对象基类
 */
public class WFStepDataGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepDataMainGridModel gridModel = null;
    public WFStepDataGridViewGridHandler()  {
        super();
    }
