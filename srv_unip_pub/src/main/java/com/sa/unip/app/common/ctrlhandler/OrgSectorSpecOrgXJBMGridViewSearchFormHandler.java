...
public class OrgSectorSpecOrgXJBMGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgSectorDefaultSearchFormModel searchformModel = null;
    public OrgSectorSpecOrgXJBMGridViewSearchFormHandler()  {
        super();
    }
