...
public class UserRoleDetailMainEditFormUesrrolenameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public UserRoleDetailMainEditFormUesrrolenameHandler()  {
        super();
    }
