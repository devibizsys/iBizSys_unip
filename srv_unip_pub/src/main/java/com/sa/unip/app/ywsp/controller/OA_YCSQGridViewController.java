...
/**
 * 视图[OA_YCSQGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQGridView.do")
public class OA_YCSQGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_YCSQGridViewController() throws Exception {
        super();
        this.setId("33e322b47c3c1b8636edb7ddb9fcea96");
        this.setCaption("用餐申请");
        this.setTitle("用餐申请表格视图");
        this.setCapLanResTag("DE.LNAME.OA_YCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YCSQ.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQGridViewSearchFormHandler");
        searchForm.init(this);
