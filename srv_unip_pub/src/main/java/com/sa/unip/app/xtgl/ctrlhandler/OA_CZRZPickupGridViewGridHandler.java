...
/**
 * 应用视图[OA_CZRZPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_CZRZPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CZRZMainGridModel gridModel = null;
    public OA_CZRZPickupGridViewGridHandler()  {
        super();
    }
