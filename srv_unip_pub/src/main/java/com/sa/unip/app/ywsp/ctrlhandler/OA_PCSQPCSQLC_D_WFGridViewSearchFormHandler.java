...
public class OA_PCSQPCSQLC_D_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_PCSQDefaultSearchFormModel searchformModel = null;
    public OA_PCSQPCSQLC_D_WFGridViewSearchFormHandler()  {
        super();
    }
