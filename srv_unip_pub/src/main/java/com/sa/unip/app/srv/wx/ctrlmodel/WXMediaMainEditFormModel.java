...
/**
 * 实体[微信多媒体内容]编辑表单[form]部件模型
 */
public class WXMediaMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WXMediaMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXMEDIAID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信多媒体内容标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WXMEDIANAME");
            formItem.setCaption("微信多媒体内容名称");
        ...
        this.registerFormItem(iFormItem);
        // wxmedianame
        iFormItem = this.createFormItem("wxmedianame");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxmedianame");
            formItem.setDEFName("WXMEDIANAME");
            formItem.setCaption("微信多媒体内容名称");
        ...
        this.registerFormItem(iFormItem);
        // wxmediaid
        iFormItem = this.createFormItem("wxmediaid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxmediaid");
            formItem.setDEFName("WXMEDIAID");
            formItem.setEnableCond(0);
            formItem.setCaption("微信多媒体内容标识");
