...
public class OA_BGYPSQBGYPSQLC_D10_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_BGYPSQDefaultSearchFormModel searchformModel = null;
    public OA_BGYPSQBGYPSQLC_D10_WFGridViewSearchFormHandler()  {
        super();
    }
