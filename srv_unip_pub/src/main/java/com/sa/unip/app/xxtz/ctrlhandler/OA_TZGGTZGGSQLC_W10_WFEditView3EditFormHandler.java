...
import com.sa.unip.app.srv.xxtz.ctrlmodel.OA_TZGGMainEditFormModel;
...
public class OA_TZGGTZGGSQLC_W10_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_TZGGMainEditFormModel editformModel = null;
    public OA_TZGGTZGGSQLC_W10_WFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_TZGGMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_TZGGMainEditFormModel getRealEditFormModel() {
