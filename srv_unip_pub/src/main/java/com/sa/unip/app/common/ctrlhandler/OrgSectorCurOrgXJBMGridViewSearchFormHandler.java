...
public class OrgSectorCurOrgXJBMGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgSectorDefaultSearchFormModel searchformModel = null;
    public OrgSectorCurOrgXJBMGridViewSearchFormHandler()  {
        super();
    }
