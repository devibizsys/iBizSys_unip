...
import com.sa.unip.app.srv.common.ctrlmodel.DataSyncInMainGridModel;
...
/**
 * 应用视图[DataSyncInGridView]表格[grid]后台处理对象基类
 */
public class DataSyncInGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataSyncInMainGridModel gridModel = null;
    public DataSyncInGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DataSyncInMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DataSyncInMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DataSyncIn entity)throws Exception {
