 ...
 */
public class OA_CHRYMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_CHRYMainEditFormModel()  {
        super();
        this.setName("form");
    }
