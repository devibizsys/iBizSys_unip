...
/**
 * 实体[任务调度任务类型]编辑表单[form]部件模型
 */
public class TSSDTaskTypeMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDTaskTypeMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKTYPEID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务调度任务类型标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDTASKTYPENAME");
            formItem.setCaption("任务类型名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdtasktypename
        iFormItem = this.createFormItem("tssdtasktypename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtasktypename");
            formItem.setDEFName("TSSDTASKTYPENAME");
            formItem.setCaption("任务类型名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdtasktypename");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdtasktypeid
        iFormItem = this.createFormItem("tssdtasktypeid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdtasktypeid");
            formItem.setDEFName("TSSDTASKTYPEID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务调度任务类型标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdtasktypeid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
