...
/**
 * 实体[数据同步代理]编辑表单[form]部件模型
 */
public class DataSyncAgentMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DataSyncAgentMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCAGENTID");
            formItem.setEnableCond(1);
            formItem.setCaption("数据同步代理标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCAGENTNAME");
            formItem.setCaption("数据同步代理名称");
        ...
        this.registerFormItem(iFormItem);
        // datasyncagentname
        iFormItem = this.createFormItem("datasyncagentname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncagentname");
            formItem.setDEFName("DATASYNCAGENTNAME");
            formItem.setCaption("数据同步代理名称");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datasyncagentname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // datasyncagentid
        iFormItem = this.createFormItem("datasyncagentid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncagentid");
            formItem.setDEFName("DATASYNCAGENTID");
            formItem.setEnableCond(1);
            formItem.setCaption("数据同步代理标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datasyncagentid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
