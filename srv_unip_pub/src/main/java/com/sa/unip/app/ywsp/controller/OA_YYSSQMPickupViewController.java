...
/**
 * 视图[OA_YYSSQMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YYSSQMPickupView.do")
public class OA_YYSSQMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_YYSSQMPickupViewController() throws Exception {
        super();
        this.setId("3da9bdb3365806747849c3594954a7b2");
        this.setCaption("饮用水申请");
        this.setTitle("饮用水申请数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_YYSSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YYSSQ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YYSSQMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YYSSQMPickupViewController",this);
    }
