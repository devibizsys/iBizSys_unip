...
/**
 * 应用视图[TSSDPolicyOwnerPickupGridView]表格[grid]后台处理对象基类
 */
public class TSSDPolicyOwnerPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected TSSDPolicyOwnerMainGridModel gridModel = null;
    public TSSDPolicyOwnerPickupGridViewGridHandler()  {
        super();
    }
