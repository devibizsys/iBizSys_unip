...
public class OA_YBHYSQYBHYSQ_D10_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_YBHYSQDefaultSearchFormModel searchformModel = null;
    public OA_YBHYSQYBHYSQ_D10_WFGridViewSearchFormHandler()  {
        super();
    }
