...
/**
 * 视图[OrgUserJXKHJCRYPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserJXKHJCRYPickupView.do")
public class OrgUserJXKHJCRYPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OrgUserJXKHJCRYPickupViewController() throws Exception {
        super();
        this.setId("96dcacd37fbfb05ed555fe4bdb662567");
        this.setCaption("组织人员");
        this.setTitle("组织人员实体绩效考核检查人员选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgUserJXKHJCRYPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserJXKHJCRYPickupViewController",this);
    }
