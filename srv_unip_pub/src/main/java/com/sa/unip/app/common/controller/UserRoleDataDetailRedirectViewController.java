...
/**
 * 视图[UserRoleDataDetailRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDataDetailRedirectView.do")
public class UserRoleDataDetailRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserRoleDataDetailRedirectViewController() throws Exception {
        super();
        this.setId("2e34be108753484837f873995709b7a4");
        this.setCaption("数据对象能力明细");
        this.setTitle("数据对象能力明细实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDataDetailRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDataDetailRedirectViewController",this);
    }
