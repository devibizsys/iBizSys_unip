...
/**
 * 视图[CodeListMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/CodeListMPickupView.do")
public class CodeListMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public CodeListMPickupViewController() throws Exception {
        super();
        this.setId("f8bf510d4f40c869802d04dbbfda4d70");
        this.setCaption("代码表");
        this.setTitle("代码表实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/CodeListMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.CodeListMPickupViewController",this);
    }
