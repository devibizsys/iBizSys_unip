...
/**
 * 应用视图[DALogPickupGridView]表格[grid]后台处理对象基类
 */
public class DALogPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DALogMainGridModel gridModel = null;
    public DALogPickupGridViewGridHandler()  {
        super();
    }
