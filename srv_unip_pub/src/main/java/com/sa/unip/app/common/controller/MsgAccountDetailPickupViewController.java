...
/**
 * 视图[MsgAccountDetailPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgAccountDetailPickupView.do")
public class MsgAccountDetailPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public MsgAccountDetailPickupViewController() throws Exception {
        super();
        this.setId("194cf433ade8b0c85a0b9ca92b27e417");
        this.setCaption("组消息账户明细");
        this.setTitle("组消息账户明细实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/MsgAccountDetailPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgAccountDetailPickupViewController",this);
    }
