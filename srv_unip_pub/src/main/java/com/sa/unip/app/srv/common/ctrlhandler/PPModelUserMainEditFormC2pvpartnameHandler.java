...
public class PPModelUserMainEditFormC2pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormC2pvpartnameHandler()  {
        super();
    }
