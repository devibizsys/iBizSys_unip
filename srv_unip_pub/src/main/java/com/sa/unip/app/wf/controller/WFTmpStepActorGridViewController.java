...
/**
 * 视图[WFTmpStepActorGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFTmpStepActorGridView.do")
public class WFTmpStepActorGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFTmpStepActorGridViewController() throws Exception {
        super();
        this.setId("17108a753fd9ac50a99dcc99af522ccd");
        this.setCaption("工作流步骤操作者（临时）");
        this.setTitle("工作流步骤操作者（临时）实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFTmpStepActorGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFTmpStepActorGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFTmpStepActorGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFTmpStepActorGridViewSearchFormHandler");
        searchForm.init(this);
