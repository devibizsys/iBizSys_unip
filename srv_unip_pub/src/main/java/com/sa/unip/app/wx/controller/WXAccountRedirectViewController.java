...
/**
 * 视图[WXAccountRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXAccountRedirectView.do")
public class WXAccountRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WXAccountRedirectViewController() throws Exception {
        super();
        this.setId("f2cf6ea5ba77018cd34ceb051f97de77");
        this.setCaption("微信公众号");
        this.setTitle("微信公众号实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wx/WXAccountRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXAccountRedirectViewController",this);
    }
