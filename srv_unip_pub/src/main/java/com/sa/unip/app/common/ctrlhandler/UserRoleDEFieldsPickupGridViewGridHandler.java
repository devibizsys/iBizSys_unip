...
/**
 * 应用视图[UserRoleDEFieldsPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDEFieldsPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDEFieldsMainGridModel gridModel = null;
    public UserRoleDEFieldsPickupGridViewGridHandler()  {
        super();
    }
