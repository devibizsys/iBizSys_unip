...
/**
 * 实体[工作流候选用户策略]搜索表单[searchform]部件模型
 */
public class  WFUCPolicyDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WFUCPolicyDefaultSearchFormModel() {
        super();
