...
/**
 * 应用视图[OA_BGYPSQBGYPSQLC_W20_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_BGYPSQBGYPSQLC_W20_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_BGYPSQMainGridModel gridModel = null;
    public OA_BGYPSQBGYPSQLC_W20_WFGridViewGridHandler()  {
        super();
    }
