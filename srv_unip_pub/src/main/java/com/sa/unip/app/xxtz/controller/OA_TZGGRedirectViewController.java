...
/**
 * 视图[OA_TZGGRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGRedirectView.do")
public class OA_TZGGRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_TZGGRedirectViewController() throws Exception {
        super();
        this.setId("250592a3ca2c8b7c90738e5f6f2c5d3f");
        this.setCaption("通知公告");
        this.setTitle("通知公告数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_TZGG");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGG.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGRedirectViewController",this);
    }
