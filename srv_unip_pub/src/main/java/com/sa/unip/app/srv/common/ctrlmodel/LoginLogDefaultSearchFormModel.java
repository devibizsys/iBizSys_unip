...
/**
 * 实体[帐户使用记录]搜索表单[searchform]部件模型
 */
public class  LoginLogDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public LoginLogDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_loginlogname_like
        iFormItem = this.createFormItem("n_loginlogname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_loginlogname_like");
            formItem.setDEFName("LOGINLOGNAME");
            formItem.setCaption("帐户使用记录名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_loginlogname_like");
