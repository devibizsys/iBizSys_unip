...
/**
 * 实体[任务调度任务类型]搜索表单[searchform]部件模型
 */
public class  TSSDTaskTypeDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public TSSDTaskTypeDefaultSearchFormModel() {
        super();
