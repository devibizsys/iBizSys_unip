...
/**
 * 应用视图[UserDictItemPickupGridView]表格[grid]后台处理对象基类
 */
public class UserDictItemPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserDictItemMain2GridModel gridModel = null;
    public UserDictItemPickupGridViewGridHandler()  {
        super();
    }
