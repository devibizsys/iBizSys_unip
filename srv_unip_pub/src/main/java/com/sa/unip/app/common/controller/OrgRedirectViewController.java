...
/**
 * 视图[OrgRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgRedirectView.do")
public class OrgRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OrgRedirectViewController() throws Exception {
        super();
        this.setId("aeb4d24fe56f0945601cca6ffccbd025");
        this.setCaption("组织机构");
        this.setTitle("组织机构实体数据重定向视图");
        this.setCapLanResTag("DE.LNAME.ORG");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/OrgRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgRedirectViewController",this);
    }
