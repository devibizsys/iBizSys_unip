...
/**
 * 应用视图[UserRoleDatasPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleDatasPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleDatasMainGridModel gridModel = null;
    public UserRoleDatasPickupGridViewGridHandler()  {
        super();
    }
