...
public class UserRoleMainEditFormUserroletypeHandler extends net.ibizsys.paas.ctrlhandler.CodeListFormItemHandlerBase {

    public UserRoleMainEditFormUserroletypeHandler()  {
        super();
    }
