...
/**
 * 实体[用户组]数据关系栏[drbar]部件模型
 */
public class  UserGroupDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserGroupDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        //添加 详细信息
        DRCtrlItem drCtrlItem1 = drCtrlRootItem.addItem("5eba267a2d34c0c5dc686961a48f62d1","form");
        ...
        //添加 用户组成员
        DRCtrlItem drCtrlItem2 = drCtrlRootItem.addItem("dritem1","5eba267a2d34c0c5dc686961a48f62d1");
        drCtrlItem2.setText("用户组成员");
        ...
        drCtrlItem2.setViewParam("srfparentdeid","5eba267a2d34c0c5dc686961a48f62d1");
        drCtrlItem2.setViewParam("srfparenttype","DER1N");
        drCtrlItem2.setViewParam("srfder1nid","DER1N_USERGROUPDETAIL_USERGROUP_USERGROUPID");
    }
}