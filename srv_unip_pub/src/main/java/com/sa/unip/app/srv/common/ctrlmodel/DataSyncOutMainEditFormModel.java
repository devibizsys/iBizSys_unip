...
/**
 * 实体[数据同步发送队列]编辑表单[form]部件模型
 */
public class DataSyncOutMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public DataSyncOutMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCOUTID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据同步发送队列标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("DATASYNCOUTNAME");
            formItem.setCaption("数据同步发送队列名称");
        ...
        this.registerFormItem(iFormItem);
        // datasyncoutname
        iFormItem = this.createFormItem("datasyncoutname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncoutname");
            formItem.setDEFName("DATASYNCOUTNAME");
            formItem.setCaption("数据同步发送队列名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datasyncoutname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // datasyncoutid
        iFormItem = this.createFormItem("datasyncoutid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("datasyncoutid");
            formItem.setDEFName("DATASYNCOUTID");
            formItem.setEnableCond(0);
            formItem.setCaption("数据同步发送队列标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("datasyncoutid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
