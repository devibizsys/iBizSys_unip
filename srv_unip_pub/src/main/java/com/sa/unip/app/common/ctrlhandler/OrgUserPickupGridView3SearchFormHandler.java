...
public class OrgUserPickupGridView3SearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgUserDefaultSearchFormModel searchformModel = null;
    public OrgUserPickupGridView3SearchFormHandler()  {
        super();
    }
