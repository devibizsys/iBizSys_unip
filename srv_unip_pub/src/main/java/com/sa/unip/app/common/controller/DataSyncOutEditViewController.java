...
/**
 * 视图[DataSyncOutEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncOutEditView.do")
public class DataSyncOutEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public DataSyncOutEditViewController() throws Exception {
        super();
        this.setId("f063a9f2886495a091cc74e08523ad2c");
        this.setCaption("数据同步发送队列");
        this.setTitle("数据同步发送队列实体编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/DataSyncOutEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncOutEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DataSyncOutEditViewEditFormHandler");
        editForm.init(this);
