...
/**
 * 视图[DataEntityGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/demodel/DataEntityGridView.do")
public class DataEntityGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public DataEntityGridViewController() throws Exception {
        super();
        this.setId("4f1987159f1c23fa642e79e88ed9119a");
        this.setCaption("实体");
        this.setTitle("实体实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/demodel/DataEntityGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.demodel.controller.DataEntityGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.demodel.ctrlhandler.DataEntityGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.demodel.ctrlhandler.DataEntityGridViewSearchFormHandler");
        searchForm.init(this);
