...
public class OrgUserUX_GridView2SearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgUserDefaultSearchFormModel searchformModel = null;
    public OrgUserUX_GridView2SearchFormHandler()  {
        super();
    }
