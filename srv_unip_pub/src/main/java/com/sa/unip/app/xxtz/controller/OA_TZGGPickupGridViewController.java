...
/**
 * 视图[OA_TZGGPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xxtz/OA_TZGGPickupGridView.do")
public class OA_TZGGPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_TZGGPickupGridViewController() throws Exception {
        super();
        this.setId("718011f2d445f59199d3010874a98f7a");
        this.setCaption("通知公告");
        this.setTitle("通知公告选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_TZGG");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGG.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/xxtz/OA_TZGGPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xxtz.controller.OA_TZGGPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xxtz.ctrlhandler.OA_TZGGPickupGridViewSearchFormHandler");
        searchForm.init(this);
