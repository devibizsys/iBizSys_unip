...
public class OrgSectorMain2EditFormOrgnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OrgSectorMain2EditFormOrgnameHandler()  {
        super();
    }
