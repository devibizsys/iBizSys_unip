...
public class OA_XXRYPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_XXRYDefaultSearchFormModel searchformModel = null;
    public OA_XXRYPickupGridViewSearchFormHandler()  {
        super();
    }
