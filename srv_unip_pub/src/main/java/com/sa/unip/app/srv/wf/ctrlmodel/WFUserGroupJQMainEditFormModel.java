...
/**
 * 实体[工作流用户组]编辑表单[form]部件模型
 */
public class WFUserGroupJQMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUserGroupJQMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERGROUPID");
            formItem.setCaption("工作流用户组标识");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUSERGROUPID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERGROUPNAME");
            formItem.setCaption("用户组名称");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WFUSERGROUPNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfusergroupname
        iFormItem = this.createFormItem("wfusergroupname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfusergroupname");
            formItem.setDEFName("WFUSERGROUPNAME");
            formItem.setCaption("用户组名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfusergroupname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wfusergroupid
        iFormItem = this.createFormItem("wfusergroupid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfusergroupid");
            formItem.setDEFName("WFUSERGROUPID");
            formItem.setCaption("工作流用户组标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfusergroupid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
