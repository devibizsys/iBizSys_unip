...
/**
 * 实体[系统管理功能]数据关系栏[drbar]部件模型
 */
public class  SysAdminFuncDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public SysAdminFuncDefaultDRBarModel() {
        super();
    }
