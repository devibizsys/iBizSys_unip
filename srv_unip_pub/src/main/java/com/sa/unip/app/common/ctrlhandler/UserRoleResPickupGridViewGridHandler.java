...
/**
 * 应用视图[UserRoleResPickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleResPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleResMainGridModel gridModel = null;
    public UserRoleResPickupGridViewGridHandler()  {
        super();
    }
