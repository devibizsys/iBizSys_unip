...
/**
 * 实体[微信访问票据]搜索表单[searchform]部件模型
 */
public class  WXAccessTokenDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public WXAccessTokenDefaultSearchFormModel() {
        super();
