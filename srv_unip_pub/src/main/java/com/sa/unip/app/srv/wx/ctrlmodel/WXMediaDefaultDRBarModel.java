...
/**
 * 实体[微信多媒体内容]数据关系栏[drbar]部件模型
 */
public class  WXMediaDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WXMediaDefaultDRBarModel() {
        super();
    }
