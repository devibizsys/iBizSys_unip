...
public class OA_NSJGHYSQPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_NSJGHYSQDefaultSearchFormModel searchformModel = null;
    public OA_NSJGHYSQPickupGridViewSearchFormHandler()  {
        super();
    }
