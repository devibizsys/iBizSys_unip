...
/**
 * 实体[组消息账户明细]编辑表单[form]部件模型
 */
public class MsgAccountDetailMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public MsgAccountDetailMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("MSGACCOUNTDETAILID");
            formItem.setEnableCond(0);
            formItem.setCaption("组消息账户明细标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("MSGACCOUNTDETAILNAME");
            formItem.setCaption("组消息账户明细名称");
        ...
        this.registerFormItem(iFormItem);
        // msgaccountdetailname
        iFormItem = this.createFormItem("msgaccountdetailname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("msgaccountdetailname");
            formItem.setDEFName("MSGACCOUNTDETAILNAME");
            formItem.setCaption("组消息账户明细名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("msgaccountdetailname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // msgaccountdetailid
        iFormItem = this.createFormItem("msgaccountdetailid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("msgaccountdetailid");
            formItem.setDEFName("MSGACCOUNTDETAILID");
            formItem.setEnableCond(0);
            formItem.setCaption("组消息账户明细标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("msgaccountdetailid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
