...
/**
 * 实体[实体数据变更派发引擎]数据关系栏[drbar]部件模型
 */
public class  DEDataChgDispDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DEDataChgDispDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setText("实体数据变更派发引擎");
