...
/**
 * 实体[数据同步发送队列]数据表格[grid]部件模型
 */
public class  DataSyncOutMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public DataSyncOutMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 数据同步发送队列名称
        iGridColumn = createGridColumn("datasyncoutname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("datasyncoutname");
            gridColumnModel.setDataItemName("datasyncoutname");
            gridColumnModel.setCaption("数据同步发送队列名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 datasyncoutname
        iGridDataItem = createGridDataItem("datasyncoutname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("datasyncoutname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DATASYNCOUTNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 datasyncoutid
        iGridDataItem = createGridDataItem("datasyncoutid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("datasyncoutid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DATASYNCOUTID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("DATASYNCOUTID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("数据同步发送队列标识");
