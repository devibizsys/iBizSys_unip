...
/**
 * 实体[工作流动态用户]数据表格[grid]部件模型
 */
public class  WFDynamicUserMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WFDynamicUserMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wfdynamicuserid
        iGridDataItem = createGridDataItem("wfdynamicuserid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wfdynamicuserid");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WFDYNAMICUSERID");
            gridEditItem.setCaption("工作流动态用户标识");
