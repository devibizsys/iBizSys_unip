...
/**
 * 视图[WFStepInstPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepInstPickupGridView.do")
public class WFStepInstPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public WFStepInstPickupGridViewController() throws Exception {
        super();
        this.setId("9a14e7b45b32a927491a7a04ce318f26");
        this.setCaption("工作流步骤子实例");
        this.setTitle("工作流步骤子实例实体选择表格视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPINST");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEPINST.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepInstPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepInstPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepInstPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepInstPickupGridViewSearchFormHandler");
        searchForm.init(this);
