...
/**
 * 实体[工作流交互操作]数据关系栏[drbar]部件模型
 */
public class  WFIAActionDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public WFIAActionDefaultDRBarModel() {
        super();
    }
