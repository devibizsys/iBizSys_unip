...
/**
 * 视图[WFVersionGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFVersionGridView.do")
public class WFVersionGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFVersionGridViewController() throws Exception {
        super();
        this.setId("07da5928d7f2de69763b42e184fdf579");
        this.setCaption("工作流配置版本");
        this.setTitle("工作流配置版本实体表格视图");
        this.setCapLanResTag("DE.LNAME.WFWFVERSION");
        this.setTitleLanResTag("PAGE.TITLE.WFWFVERSION.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFVersionGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFVersionGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFVersionGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFVersionGridViewSearchFormHandler");
        searchForm.init(this);
