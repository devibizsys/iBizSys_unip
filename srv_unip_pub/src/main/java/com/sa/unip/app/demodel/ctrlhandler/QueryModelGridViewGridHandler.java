...
/**
 * 应用视图[QueryModelGridView]表格[grid]后台处理对象基类
 */
public class QueryModelGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected QueryModelMainGridModel gridModel = null;
    public QueryModelGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(QueryModel entity)throws Exception {
