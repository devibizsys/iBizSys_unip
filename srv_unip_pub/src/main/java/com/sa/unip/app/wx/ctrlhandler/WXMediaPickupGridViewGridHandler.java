...
/**
 * 应用视图[WXMediaPickupGridView]表格[grid]后台处理对象基类
 */
public class WXMediaPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXMediaMainGridModel gridModel = null;
    public WXMediaPickupGridViewGridHandler()  {
        super();
    }
