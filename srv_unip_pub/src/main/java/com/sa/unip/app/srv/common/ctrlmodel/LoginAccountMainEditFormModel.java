...
/**
 * 实体[登录帐户]编辑表单[form]部件模型
 */
public class LoginAccountMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public LoginAccountMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("LOGINACCOUNTID");
            formItem.setEnableCond(1);
            formItem.setCaption("登录帐户标识");
        ...
        this.registerFormItem(iFormItem);
        // loginaccountname
        iFormItem = this.createFormItem("loginaccountname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("loginaccountname");
            formItem.setDEFName("LOGINACCOUNTNAME");
            formItem.setEnableCond(1);
            formItem.setCaption("登录帐户");
            formItem.setAllowEmpty(false);
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("loginaccountname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // pwd
        iFormItem = this.createFormItem("pwd");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("pwd");
            formItem.setDEFName("PWD");
            formItem.setCaption("登录密码");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("pwd");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // isenable
        iFormItem = this.createFormItem("isenable");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("isenable");
        ...
        this.registerFormItem(iFormItem);
        // appuitheme
        iFormItem = this.createFormItem("appuitheme");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("appuitheme");
            formItem.setDEFName("APPUITHEME");
            formItem.setCodeListId("com.sa.unip.srv.codelist.CodeList58CodeListModel");
            formItem.setCaption("应用界面主题");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("appuitheme");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // language
        iFormItem = this.createFormItem("language");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("language");
            formItem.setDEFName("LANGUAGE");
            formItem.setCodeListId("com.sa.unip.srv.codelist.CodeList56CodeListModel");
            formItem.setCaption("默认语言");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("language");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // lastlogintime
        iFormItem = this.createFormItem("lastlogintime");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("lastlogintime");
            formItem.setDEFName("LASTLOGINTIME");
            formItem.setEnableCond(0);
            formItem.setCaption("最后登录时间");
            formItem.setValueTranslator("DATE|YYYY-MM-DD HH:mm:ss");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("lastlogintime");
            dataItem.setDataType(5);
        ...
        this.registerFormItem(iFormItem);
        // loginaccountid
        iFormItem = this.createFormItem("loginaccountid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("loginaccountid");
            formItem.setDEFName("LOGINACCOUNTID");
            formItem.setEnableCond(1);
            formItem.setCaption("登录帐户标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("loginaccountid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
