...
/**
 * 视图[WFUIWizardRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUIWizardRedirectView.do")
public class WFUIWizardRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFUIWizardRedirectViewController() throws Exception {
        super();
        this.setId("e1dd854a2b68c0e955f48f6910813b29");
        this.setCaption("工作流操作界面");
        this.setTitle("工作流操作界面实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFUIWizardRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUIWizardRedirectViewController",this);
    }
