 ...
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_ZSKGridView.do")
public class OA_ZSKGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_ZSKGridViewController() throws Exception {
        super();
        this.setId("7d362e86f838f8e4096321d7adbcf2db");
        this.setCaption("知识库");
        ...
        ViewControllerGlobal.registerViewController("/app/jcsj/OA_ZSKGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_ZSKGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_ZSKGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_ZSKGridViewSearchFormHandler");
        searchForm.init(this);
