...
/**
 * 应用视图[RegistryPickupGridView]表格[grid]后台处理对象基类
 */
public class RegistryPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected RegistryMainGridModel gridModel = null;
    public RegistryPickupGridViewGridHandler()  {
        super();
    }
