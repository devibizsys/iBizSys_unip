...
/**
 * 视图[OA_CGSQMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CGSQMPickupView.do")
public class OA_CGSQMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_CGSQMPickupViewController() throws Exception {
        super();
        this.setId("40f6981245f8d4e21359872cc28db70d");
        this.setCaption("采购申请");
        this.setTitle("采购申请数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_CGSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CGSQ.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CGSQMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CGSQMPickupViewController",this);
    }
