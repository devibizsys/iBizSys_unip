...
public class UserGroupDetailEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected UserGroupDetailMain2EditFormModel editformModel = null;
    public UserGroupDetailEditViewEditFormHandler()  {
        super();
    }
