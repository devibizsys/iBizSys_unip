...
public class WXAccountMainEditFormOrgnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WXAccountMainEditFormOrgnameHandler()  {
        super();
    }
