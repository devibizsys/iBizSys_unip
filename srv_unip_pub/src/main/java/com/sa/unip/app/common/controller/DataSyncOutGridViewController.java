...
/**
 * 视图[DataSyncOutGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncOutGridView.do")
public class DataSyncOutGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public DataSyncOutGridViewController() throws Exception {
        super();
        this.setId("0893d53dddcdea9dffe0b2e31edd54eb");
        this.setCaption("数据同步发送队列");
        this.setTitle("数据同步发送队列实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/DataSyncOutGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncOutGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DataSyncOutGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.DataSyncOutGridViewSearchFormHandler");
        searchForm.init(this);
