...
public class WFUserAssistMainEditFormWfmajorusernameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFUserAssistMainEditFormWfmajorusernameHandler()  {
        super();
    }
