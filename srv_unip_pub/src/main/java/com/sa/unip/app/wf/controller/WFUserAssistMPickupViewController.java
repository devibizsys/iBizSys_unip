...
/**
 * 视图[WFUserAssistMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserAssistMPickupView.do")
public class WFUserAssistMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFUserAssistMPickupViewController() throws Exception {
        super();
        this.setId("05e7c91e45f5e311a7b443fe8763419c");
        this.setCaption("工作流用户代办");
        this.setTitle("工作流用户代办实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUserAssistMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserAssistMPickupViewController",this);
    }
