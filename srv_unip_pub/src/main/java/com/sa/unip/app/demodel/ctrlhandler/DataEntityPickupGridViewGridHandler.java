...
/**
 * 应用视图[DataEntityPickupGridView]表格[grid]后台处理对象基类
 */
public class DataEntityPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataEntityMainGridModel gridModel = null;
    public DataEntityPickupGridViewGridHandler()  {
        super();
    }
