...
/**
 * 实体[服务]数据关系栏[drbar]部件模型
 */
public class  ServiceDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public ServiceDefaultDRBarModel() {
        super();
    }
