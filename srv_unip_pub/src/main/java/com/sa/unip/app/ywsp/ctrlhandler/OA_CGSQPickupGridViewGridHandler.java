...
/**
 * 应用视图[OA_CGSQPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_CGSQPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CGSQMainGridModel gridModel = null;
    public OA_CGSQPickupGridViewGridHandler()  {
        super();
    }
