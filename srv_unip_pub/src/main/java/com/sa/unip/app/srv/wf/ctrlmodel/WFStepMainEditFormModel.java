...
/**
 * 实体[工作流步骤]编辑表单[form]部件模型
 */
public class WFStepMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFStepMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFSTEPID");
            formItem.setCaption("工作流步骤标识");
            formItem.setCapLanResTag("DEF.LNAME.WFSTEPID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFSTEPNAME");
            formItem.setCaption("工作流步骤名称");
            formItem.setCapLanResTag("DEF.LNAME.WFSTEPNAME");
        ...
        this.registerFormItem(iFormItem);
        // wfstepid
        iFormItem = this.createFormItem("wfstepid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfstepid");
            formItem.setDEFName("WFSTEPID");
            formItem.setCaption("工作流步骤标识");
            formItem.setCapLanResTag("DEF.LNAME.WFSTEPID");
