...
/**
 * 视图[OA_STWMDGSTWMDGLC_D20_WFGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGSTWMDGLC_D20_WFGridView.do")
public class OA_STWMDGSTWMDGLC_D20_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_STWMDGSTWMDGLC_D20_WFGridViewController() throws Exception {
        super();
        this.setId("d6603a5d7698b51dcc28d6d6a23e99a9");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购工作流表格视图(食堂外卖订购流程:审核中)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGSTWMDGLC_D20_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGSTWMDGLC_D20_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_D20_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_D20_WFGridViewSearchFormHandler");
        searchForm.init(this);
