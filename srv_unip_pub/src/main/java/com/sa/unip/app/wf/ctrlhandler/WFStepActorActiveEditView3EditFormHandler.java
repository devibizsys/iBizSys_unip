...
public class WFStepActorActiveEditView3EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected WFStepActorMain2EditFormModel editformModel = null;
    public WFStepActorActiveEditView3EditFormHandler()  {
        super();
    }
    ...
    * 准备部件成员处理对象
    ...
    protected IEntity updateEntity(IEntity iEntity)throws Exception {
        this.getRealService().executeAction(WFStepActorService.ACTION_REMINDSAVE,iEntity);
        return iEntity;
    }
