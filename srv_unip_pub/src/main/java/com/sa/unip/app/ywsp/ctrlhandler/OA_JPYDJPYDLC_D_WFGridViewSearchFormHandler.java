...
public class OA_JPYDJPYDLC_D_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_JPYDDefaultSearchFormModel searchformModel = null;
    public OA_JPYDJPYDLC_D_WFGridViewSearchFormHandler()  {
        super();
    }
