...
/**
 * 视图[UserRoleDatasPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDatasPickupView.do")
public class UserRoleDatasPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserRoleDatasPickupViewController() throws Exception {
        super();
        this.setId("eb179d0a066625f1ec9caca3b6611b12");
        this.setCaption("用户角色数据能力");
        this.setTitle("用户角色数据能力实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDatasPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDatasPickupViewController",this);
    }
