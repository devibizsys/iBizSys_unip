...
/**
 * 视图[UserRoleEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleEditView3.do")
public class UserRoleEditView3Controller extends net.ibizsys.paas.controller.EditView3ControllerBase {
    public UserRoleEditView3Controller() throws Exception {
        super();
        this.setId("3f5ee8d87ecec5f3eb0b36edf7110422");
        this.setCaption("用户角色");
        this.setTitle("用户角色编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 drtab
        ICtrlModel drTab=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.UserRoleDR2DRTabModel");
        drTab.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleEditView3EditFormHandler");
        editForm.init(this);
