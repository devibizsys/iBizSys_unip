...
/**
 * 实体[任务时刻策略所有者]编辑表单[form]部件模型
 */
public class TSSDPolicyOwnerMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public TSSDPolicyOwnerMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDPOLICYOWNERID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略所有者标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TSSDPOLICYOWNERNAME");
            formItem.setCaption("任务时刻策略所有者名称");
        ...
        this.registerFormItem(iFormItem);
        // tssdpolicyownername
        iFormItem = this.createFormItem("tssdpolicyownername");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdpolicyownername");
            formItem.setDEFName("TSSDPOLICYOWNERNAME");
            formItem.setCaption("任务时刻策略所有者名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdpolicyownername");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // tssdpolicyownerid
        iFormItem = this.createFormItem("tssdpolicyownerid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("tssdpolicyownerid");
            formItem.setDEFName("TSSDPOLICYOWNERID");
            formItem.setEnableCond(0);
            formItem.setCaption("任务时刻策略所有者标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("tssdpolicyownerid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
