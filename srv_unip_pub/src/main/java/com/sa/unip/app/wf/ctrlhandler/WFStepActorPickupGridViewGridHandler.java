...
/**
 * 应用视图[WFStepActorPickupGridView]表格[grid]后台处理对象基类
 */
public class WFStepActorPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepActorMain2GridModel gridModel = null;
    public WFStepActorPickupGridViewGridHandler()  {
        super();
    }
