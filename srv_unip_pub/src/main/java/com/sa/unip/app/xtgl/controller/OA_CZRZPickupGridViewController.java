...
/**
 * 视图[OA_CZRZPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/xtgl/OA_CZRZPickupGridView.do")
public class OA_CZRZPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_CZRZPickupGridViewController() throws Exception {
        super();
        this.setId("83b5c9da6cfd872ef50bb83fc98a7032");
        this.setCaption("操作日志");
        this.setTitle("操作日志选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_CZRZ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CZRZ.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/xtgl/OA_CZRZPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.xtgl.controller.OA_CZRZPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xtgl.ctrlhandler.OA_CZRZPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.xtgl.ctrlhandler.OA_CZRZPickupGridViewSearchFormHandler");
        searchForm.init(this);
