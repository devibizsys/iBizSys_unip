...
public class OrgUserUX_CurOrgXJRYGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgUserDefaultSearchFormModel searchformModel = null;
    public OrgUserUX_CurOrgXJRYGridViewSearchFormHandler()  {
        super();
    }
