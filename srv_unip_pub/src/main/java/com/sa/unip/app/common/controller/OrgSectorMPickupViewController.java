...
/**
 * 视图[OrgSectorMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSectorMPickupView.do")
public class OrgSectorMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OrgSectorMPickupViewController() throws Exception {
        super();
        this.setId("39ae7f332a0919b3ba266c935bf9882d");
        this.setCaption("组织部门");
        this.setTitle("组织部门实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgSectorMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSectorMPickupViewController",this);
    }
