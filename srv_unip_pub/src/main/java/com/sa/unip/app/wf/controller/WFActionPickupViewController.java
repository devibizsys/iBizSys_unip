...
/**
 * 视图[WFActionPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFActionPickupView.do")
public class WFActionPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFActionPickupViewController() throws Exception {
        super();
        this.setId("6aa7ab724be4ddb753a1ef50ae04cd4f");
        this.setCaption("工作流用户操作");
        this.setTitle("工作流用户操作实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFActionPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFActionPickupViewController",this);
    }
