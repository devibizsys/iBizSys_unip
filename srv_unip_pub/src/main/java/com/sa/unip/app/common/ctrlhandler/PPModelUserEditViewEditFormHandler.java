...
import com.sa.unip.app.srv.common.ctrlmodel.PPModelUserMainEditFormModel;
...
public class PPModelUserEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected PPModelUserMainEditFormModel editformModel = null;
    public PPModelUserEditViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (PPModelUserMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected PPModelUserMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'l1pvpartname'
        IFormItemHandler l1pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormL1pvpartnameHandler");
        ...
        //注册 'c1pvpartname'
        IFormItemHandler c1pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormC1pvpartnameHandler");
        ...
        //注册 'r1pvpartname'
        IFormItemHandler r1pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormR1pvpartnameHandler");
        ...
        //注册 'l2pvpartname'
        IFormItemHandler l2pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormL2pvpartnameHandler");
        ...
        //注册 'c2pvpartname'
        IFormItemHandler c2pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormC2pvpartnameHandler");
        ...
        //注册 'r2pvpartname'
        IFormItemHandler r2pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormR2pvpartnameHandler");
        ...
        //注册 'l3pvpartname'
        IFormItemHandler l3pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormL3pvpartnameHandler");
        ...
        //注册 'c3pvpartname'
        IFormItemHandler c3pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormC3pvpartnameHandler");
        ...
        //注册 'r3pvpartname'
        IFormItemHandler r3pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormR3pvpartnameHandler");
        ...
        //注册 'l4pvpartname'
        IFormItemHandler l4pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormL4pvpartnameHandler");
        ...
        //注册 'c4pvpartname'
        IFormItemHandler c4pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormC4pvpartnameHandler");
        ...
        //注册 'r4pvpartname'
        IFormItemHandler r4pvpartnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.common.ctrlhandler.PPModelUserMainEditFormR4pvpartnameHandler");
