...
import com.sa.unip.app.srv.common.ctrlmodel.OrgSectorMain2GridModel;
...
/**
 * 应用视图[OrgSectorSpecOrgXJBMGridView]表格[grid]后台处理对象基类
 */
public class OrgSectorSpecOrgXJBMGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSectorMain2GridModel gridModel = null;
    public OrgSectorSpecOrgXJBMGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OrgSectorMain2GridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OrgSectorMain2GridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchUX_ORGSECTORSPEC(deDataSetFetchContext);
    }
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OrgSector entity)throws Exception {
