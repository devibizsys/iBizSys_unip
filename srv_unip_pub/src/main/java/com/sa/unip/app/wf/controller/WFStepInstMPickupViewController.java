...
/**
 * 视图[WFStepInstMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepInstMPickupView.do")
public class WFStepInstMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFStepInstMPickupViewController() throws Exception {
        super();
        this.setId("6bffa9989c97d40e41c759b341dbc7f2");
        this.setCaption("工作流步骤子实例");
        this.setTitle("工作流步骤子实例实体数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPINST");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEPINST.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFStepInstMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepInstMPickupViewController",this);
    }
