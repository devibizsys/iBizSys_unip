...
/**
 * 实体[DA日志]搜索表单[searchform]部件模型
 */
public class  DALogDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DALogDefaultSearchFormModel() {
        super();
