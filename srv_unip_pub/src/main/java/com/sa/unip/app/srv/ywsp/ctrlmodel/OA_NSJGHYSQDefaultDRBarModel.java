...
/**
 * 实体[内设机构会议申请]数据关系栏[drbar]部件模型
 */
public class  OA_NSJGHYSQDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OA_NSJGHYSQDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setTextLanResTag("DE.LNAME.OA_NSJGHYSQ");
