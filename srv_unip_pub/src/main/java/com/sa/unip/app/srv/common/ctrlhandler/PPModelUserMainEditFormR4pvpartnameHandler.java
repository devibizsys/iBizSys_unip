...
public class PPModelUserMainEditFormR4pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormR4pvpartnameHandler()  {
        super();
    }
