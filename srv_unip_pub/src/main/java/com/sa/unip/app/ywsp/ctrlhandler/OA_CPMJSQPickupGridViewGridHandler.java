...
/**
 * 应用视图[OA_CPMJSQPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_CPMJSQPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CPMJSQMainGridModel gridModel = null;
    public OA_CPMJSQPickupGridViewGridHandler()  {
        super();
    }
