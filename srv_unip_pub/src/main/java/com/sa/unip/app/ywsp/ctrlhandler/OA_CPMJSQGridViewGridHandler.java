...
/**
 * 应用视图[OA_CPMJSQGridView]表格[grid]后台处理对象基类
 */
public class OA_CPMJSQGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CPMJSQMainGridModel gridModel = null;
    public OA_CPMJSQGridViewGridHandler()  {
        super();
    }
