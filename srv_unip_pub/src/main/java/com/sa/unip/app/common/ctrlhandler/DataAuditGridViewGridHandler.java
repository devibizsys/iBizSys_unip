...
import com.sa.unip.app.srv.common.ctrlmodel.DataAuditMainGridModel;
...
/**
 * 应用视图[DataAuditGridView]表格[grid]后台处理对象基类
 */
public class DataAuditGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected DataAuditMainGridModel gridModel = null;
    public DataAuditGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (DataAuditMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected DataAuditMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(DataAudit entity)throws Exception {
