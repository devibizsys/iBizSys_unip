...
import com.sa.unip.app.srv.wx.ctrlmodel.WXEntAppMainGridModel;
...
/**
 * 应用视图[WXEntAppGridView]表格[grid]后台处理对象基类
 */
public class WXEntAppGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXEntAppMainGridModel gridModel = null;
    public WXEntAppGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WXEntAppMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WXEntAppMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WXEntApp entity)throws Exception {
