...
/**
 * 视图[MsgSendQueueHisEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/MsgSendQueueHisEditView2.do")
public class MsgSendQueueHisEditView2Controller extends net.ibizsys.paas.controller.EditView2ControllerBase {
    public MsgSendQueueHisEditView2Controller() throws Exception {
        super();
        this.setId("00461774a7ea8343a3002f485c548f5c");
        this.setCaption("消息发送队列（历史）");
        this.setTitle("消息发送队列（历史）实体编辑视图（左右关系）");
        ...
        ViewControllerGlobal.registerViewController("/app/common/MsgSendQueueHisEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.MsgSendQueueHisEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.MsgSendQueueHisDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgSendQueueHisEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.MsgSendQueueHisEditView2DRBarHandler");
        drBar.init(this);
