...
/**
 * 实体[派车申请]流程导航栏[expbar]部件模型
 */
public class  OA_PCSQexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_PCSQexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("AAD2F165-1BC4-477E-8C47-35E7AF46BBDD"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("PCSQLC:D:20");
        ...
        expBarItem3.setExpViewId("PCSQLC:D:20:10");
        ...
        expBarItem4.setExpViewId("PCSQLC:D:20:20");
        ...
        expBarItem5.setExpViewId("PCSQLC:D:30");
        ...
        expBarItem6.setExpViewId("PCSQLC:D:40");
        ...
        expBarItem7.setExpViewId("PCSQLC:W");
        ...
        expBarItem8.setExpViewId("PCSQLC:W:10");
        ...
        expBarItem9.setExpViewId("PCSQLC:W:20");
