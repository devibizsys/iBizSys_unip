...
/**
 * 视图[DataEntityPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/demodel/DataEntityPickupView.do")
public class DataEntityPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DataEntityPickupViewController() throws Exception {
        super();
        this.setId("ae53c8292b0536b2569528ece2eef16d");
        this.setCaption("实体");
        this.setTitle("实体实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/demodel/DataEntityPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.demodel.controller.DataEntityPickupViewController",this);
    }
