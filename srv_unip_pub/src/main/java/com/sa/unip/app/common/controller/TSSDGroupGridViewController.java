...
/**
 * 视图[TSSDGroupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/TSSDGroupGridView.do")
public class TSSDGroupGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public TSSDGroupGridViewController() throws Exception {
        super();
        this.setId("b4c923c7e677a8ad27644b876b302005");
        this.setCaption("任务时刻策略组");
        this.setTitle("任务时刻策略组实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/TSSDGroupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.TSSDGroupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDGroupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.TSSDGroupGridViewSearchFormHandler");
        searchForm.init(this);
