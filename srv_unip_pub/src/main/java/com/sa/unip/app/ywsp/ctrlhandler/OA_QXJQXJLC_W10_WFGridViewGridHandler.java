...
/**
 * 应用视图[OA_QXJQXJLC_W10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_QXJQXJLC_W10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_QXJMainGridModel gridModel = null;
    public OA_QXJQXJLC_W10_WFGridViewGridHandler()  {
        super();
    }
