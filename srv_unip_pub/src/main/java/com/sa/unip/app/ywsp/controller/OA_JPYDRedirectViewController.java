...
/**
 * 视图[OA_JPYDRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_JPYDRedirectView.do")
public class OA_JPYDRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_JPYDRedirectViewController() throws Exception {
        super();
        this.setId("74ced444e46576827a782ae584845775");
        this.setCaption("机票预订");
        this.setTitle("机票预订数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_JPYD");
        this.setTitleLanResTag("PAGE.TITLE.OA_JPYD.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_JPYDRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_JPYDRedirectViewController",this);
    }
