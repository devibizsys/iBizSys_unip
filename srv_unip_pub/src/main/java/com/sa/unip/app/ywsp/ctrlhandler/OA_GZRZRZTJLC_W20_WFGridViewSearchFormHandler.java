...
public class OA_GZRZRZTJLC_W20_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_GZRZDefaultSearchFormModel searchformModel = null;
    public OA_GZRZRZTJLC_W20_WFGridViewSearchFormHandler()  {
        super();
    }
