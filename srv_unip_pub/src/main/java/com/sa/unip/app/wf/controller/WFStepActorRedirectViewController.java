...
/**
 * 视图[WFStepActorRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepActorRedirectView.do")
public class WFStepActorRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFStepActorRedirectViewController() throws Exception {
        super();
        this.setId("3d886fdb1a0edbb9787d5deee5e89620");
        this.setCaption("工作流步骤操作者");
        this.setTitle("工作流步骤操作者实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFStepActorRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepActorRedirectViewController",this);
    }
