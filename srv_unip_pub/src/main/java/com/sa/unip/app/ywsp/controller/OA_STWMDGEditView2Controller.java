...
/**
 * 视图[OA_STWMDGEditView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_STWMDGEditView2.do")
public class OA_STWMDGEditView2Controller extends net.ibizsys.pswf.controller.EditView2ControllerBase {
    public OA_STWMDGEditView2Controller() throws Exception {
        super();
        this.setId("01cdaa90218da1f091dfc6e9a179d9d8");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_STWMDG");
        this.setTitleLanResTag("PAGE.TITLE.OA_STWMDG.EDITVIEW2");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_STWMDGEditView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_STWMDGEditView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 drbar
        ICtrlModel drBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_STWMDGDefaultDRBarModel");
        drBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGEditView2EditFormHandler");
        editForm.init(this);
        this.registerCtrlHandler("form",editForm);
        //注册 drbar
        ICtrlHandler drBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_STWMDGEditView2DRBarHandler");
        drBar.init(this);
