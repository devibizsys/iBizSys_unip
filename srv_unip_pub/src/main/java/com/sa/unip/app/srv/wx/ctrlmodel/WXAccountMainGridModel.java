...
/**
 * 实体[微信公众号]数据表格[grid]部件模型
 */
public class  WXAccountMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WXAccountMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.wx.demodel.WXAccountDEModel wXAccountDEModel;
    protected  net.ibizsys.psrt.srv.wx.demodel.WXAccountDEModel getWXAccountDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("微信公众号名称");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 API地址
        iGridColumn = createGridColumn("apiurl");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("apiurl");
            gridColumnModel.setDataItemName("apiurl");
            gridColumnModel.setCaption("API地址");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 apiurl
        iGridDataItem = createGridDataItem("apiurl");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("apiurl");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("APIURL");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WXACCOUNTID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("微信公众号标识");
