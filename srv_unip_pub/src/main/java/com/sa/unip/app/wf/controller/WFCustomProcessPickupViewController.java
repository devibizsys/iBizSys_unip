...
/**
 * 视图[WFCustomProcessPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFCustomProcessPickupView.do")
public class WFCustomProcessPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFCustomProcessPickupViewController() throws Exception {
        super();
        this.setId("c0e44657ce87a9ff486065b9d53f83fa");
        this.setCaption("工作流预定义处理");
        this.setTitle("工作流预定义处理实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFCustomProcessPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFCustomProcessPickupViewController",this);
    }
