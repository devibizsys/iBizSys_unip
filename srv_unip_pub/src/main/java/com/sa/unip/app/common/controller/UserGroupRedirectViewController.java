...
/**
 * 视图[UserGroupRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserGroupRedirectView.do")
public class UserGroupRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserGroupRedirectViewController() throws Exception {
        super();
        this.setId("ef3b328479942c55aa4cbb807f2776f2");
        this.setCaption("用户组");
        this.setTitle("用户组实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserGroupRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserGroupRedirectViewController",this);
    }
