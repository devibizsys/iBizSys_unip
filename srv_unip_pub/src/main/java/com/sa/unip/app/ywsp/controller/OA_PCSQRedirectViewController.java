...
/**
 * 视图[OA_PCSQRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_PCSQRedirectView.do")
public class OA_PCSQRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_PCSQRedirectViewController() throws Exception {
        super();
        this.setId("6e8d25ff0a75493bac938698b08ee7ef");
        this.setCaption("派车申请");
        this.setTitle("派车申请数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_PCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_PCSQ.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_PCSQRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_PCSQRedirectViewController",this);
    }
