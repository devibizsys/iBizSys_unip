...
/**
 * 实体[用户对象]编辑表单[form]部件模型
 */
public class UserObjectMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserObjectMain2EditFormModel()  {
        super();
        this.setName("form");
    }
