...
/**
 * 视图[WFWorkListPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFWorkListPickupView.do")
public class WFWorkListPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFWorkListPickupViewController() throws Exception {
        super();
        this.setId("e37585017db8870f15cb89d7b68ed32c");
        this.setCaption("工作流工作列表");
        this.setTitle("流程工作列表实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFWorkListPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFWorkListPickupViewController",this);
    }
