...
public class OrgUserUX_Form_OrgUserEditFormOrguserlevelnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OrgUserUX_Form_OrgUserEditFormOrguserlevelnameHandler()  {
        super();
    }
