...
/**
 * 实体[用户]数据表格[grid]部件模型
 */
public class  UserMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 用户标识
        iGridColumn = createGridColumn("userid");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("userid");
            gridColumnModel.setDataItemName("userid");
            gridColumnModel.setCaption("用户标识");
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("用户名称");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 系统数据
        iGridColumn = createGridColumn("issystem");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("issystem");
            gridColumnModel.setDataItemName("issystem");
            gridColumnModel.setCaption("系统数据");
            gridColumnModel.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 issystem
        iGridDataItem = createGridDataItem("issystem");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("issystem");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("ISSYSTEM");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERID");
            gridEditItem.setCaption("用户标识");
