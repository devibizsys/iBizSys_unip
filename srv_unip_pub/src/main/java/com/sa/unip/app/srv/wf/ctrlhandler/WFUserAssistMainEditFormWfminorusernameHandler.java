...
public class WFUserAssistMainEditFormWfminorusernameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public WFUserAssistMainEditFormWfminorusernameHandler()  {
        super();
    }
