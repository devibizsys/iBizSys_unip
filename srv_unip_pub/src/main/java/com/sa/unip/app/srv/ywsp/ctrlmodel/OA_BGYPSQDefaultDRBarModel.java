...
/**
 * 实体[办公用品申请]数据关系栏[drbar]部件模型
 */
public class  OA_BGYPSQDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OA_BGYPSQDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setTextLanResTag("DE.LNAME.OA_BGYPSQ");
