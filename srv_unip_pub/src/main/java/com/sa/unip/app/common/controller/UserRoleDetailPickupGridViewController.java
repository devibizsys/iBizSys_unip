...
/**
 * 视图[UserRoleDetailPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDetailPickupGridView.do")
public class UserRoleDetailPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public UserRoleDetailPickupGridViewController() throws Exception {
        super();
        this.setId("1993ed4aa7bd86e958902b256532a1bb");
        this.setCaption("用户角色成员");
        this.setTitle("用户角色成员实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleDetailPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDetailPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDetailPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDetailPickupGridViewSearchFormHandler");
        searchForm.init(this);
