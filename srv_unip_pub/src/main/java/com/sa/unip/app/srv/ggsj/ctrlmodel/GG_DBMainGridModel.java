...
/**
 * 实体[待办]数据表格[grid]部件模型
 */
public class  GG_DBMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public GG_DBMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 待办名称
        iGridColumn = createGridColumn("gg_dbname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("gg_dbname");
            gridColumnModel.setDataItemName("gg_dbname");
            gridColumnModel.setCaption("待办名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 gg_dbid
        iGridDataItem = createGridDataItem("gg_dbid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("gg_dbid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 gg_dbname
        iGridDataItem = createGridDataItem("gg_dbname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("gg_dbname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("GG_DBNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("GG_DBID");
            gridEditItem.setCaption("待办标识");
