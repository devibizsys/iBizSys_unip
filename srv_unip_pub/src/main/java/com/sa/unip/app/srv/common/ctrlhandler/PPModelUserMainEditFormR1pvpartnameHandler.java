...
public class PPModelUserMainEditFormR1pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelUserMainEditFormR1pvpartnameHandler()  {
        super();
    }
