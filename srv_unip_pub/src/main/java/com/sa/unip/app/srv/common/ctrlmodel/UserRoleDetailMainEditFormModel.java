...
/**
 * 实体[用户角色成员]编辑表单[form]部件模型
 */
public class UserRoleDetailMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserRoleDetailMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLEDETAILID");
            formItem.setCaption("用户角色成员标识");
        ...
        this.registerFormItem(iFormItem);
        // uesrrolename
        iFormItem = this.createFormItem("uesrrolename");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("uesrrolename");
            formItem.setDEFName("UESRROLENAME");
        ...
        this.registerFormItem(iFormItem);
        // usertag
        iFormItem = this.createFormItem("usertag");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("usertag");
            formItem.setDEFName("USERTAG");
            formItem.setCaption("用户自定义");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("usertag");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userroledetailid
        iFormItem = this.createFormItem("userroledetailid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroledetailid");
            formItem.setDEFName("USERROLEDETAILID");
            formItem.setCaption("用户角色成员标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroledetailid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
