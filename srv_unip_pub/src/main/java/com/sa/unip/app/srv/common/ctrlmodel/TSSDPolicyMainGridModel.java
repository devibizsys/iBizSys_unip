...
/**
 * 实体[任务时刻策略]数据表格[grid]部件模型
 */
public class  TSSDPolicyMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public TSSDPolicyMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 任务时刻策略名称
        iGridColumn = createGridColumn("tssdpolicyname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("tssdpolicyname");
            gridColumnModel.setDataItemName("tssdpolicyname");
            gridColumnModel.setCaption("任务时刻策略名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 tssdpolicytype
        iGridDataItem = createGridDataItem("tssdpolicytype");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdpolicytype");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDPOLICYTYPE");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 tssdpolicyname
        iGridDataItem = createGridDataItem("tssdpolicyname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdpolicyname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDPOLICYNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("TSSDPOLICYID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("任务时刻策略标识");
