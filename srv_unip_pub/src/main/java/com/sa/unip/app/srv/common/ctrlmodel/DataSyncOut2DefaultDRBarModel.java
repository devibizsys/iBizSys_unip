...
/**
 * 实体[数据同步发送队列2]数据关系栏[drbar]部件模型
 */
public class  DataSyncOut2DefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public DataSyncOut2DefaultDRBarModel() {
        super();
    }
