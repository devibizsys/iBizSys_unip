...
/**
 * 实体[门户页面]数据表格[grid]部件模型
 */
public class  PortalPageMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public PortalPageMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        if(iGridColumn==null) {
            ...
            gridColumnModel.setCaption("门户页面名称");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("PORTALPAGEID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("门户页面标识");
