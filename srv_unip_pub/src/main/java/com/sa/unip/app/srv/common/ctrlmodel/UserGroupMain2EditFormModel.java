...
/**
 * 实体[用户组]编辑表单[form]部件模型
 */
public class UserGroupMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserGroupMain2EditFormModel()  {
        super();
        this.setName("form");
    }
