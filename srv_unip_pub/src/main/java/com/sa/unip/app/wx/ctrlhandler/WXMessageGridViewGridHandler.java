...
import com.sa.unip.app.srv.wx.ctrlmodel.WXMessageMainGridModel;
...
/**
 * 应用视图[WXMessageGridView]表格[grid]后台处理对象基类
 */
public class WXMessageGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXMessageMainGridModel gridModel = null;
    public WXMessageGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WXMessageMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WXMessageMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WXMessage entity)throws Exception {
