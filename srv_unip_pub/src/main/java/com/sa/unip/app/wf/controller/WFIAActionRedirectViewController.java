...
/**
 * 视图[WFIAActionRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFIAActionRedirectView.do")
public class WFIAActionRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFIAActionRedirectViewController() throws Exception {
        super();
        this.setId("199ac788721aff2be13cff1ee93a62f7");
        this.setCaption("工作流交互操作");
        this.setTitle("工作流交互操作实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFIAActionRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFIAActionRedirectViewController",this);
    }
