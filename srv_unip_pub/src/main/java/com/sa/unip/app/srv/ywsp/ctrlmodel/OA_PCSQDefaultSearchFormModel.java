...
/**
 * 实体[派车申请]搜索表单[searchform]部件模型
 */
public class  OA_PCSQDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public OA_PCSQDefaultSearchFormModel() {
        super();
