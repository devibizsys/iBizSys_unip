...
/**
 * 视图[OrgUX_UserMgrView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUX_UserMgrView.do")
public class OrgUX_UserMgrViewController extends net.ibizsys.paas.controller.TreeExpViewControllerBase {
    public OrgUX_UserMgrViewController() throws Exception {
        super();
        this.setId("09a7c90875d6fca8d57af578d2d26583");
        this.setCaption("组织机构");
        this.setTitle("UX_用户树导航视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUX_UserMgrView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUX_UserMgrViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 treeexpbar_tree
        ICtrlModel treeexpbar_tree=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.OrgUX_DQS2TreeModel");
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 treeexpbar
        ICtrlHandler treeexpbar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUX_UserMgrViewTreeExpBarHandler");
        treeexpbar.init(this);
        this.registerCtrlHandler("treeexpbar",treeexpbar);
        //注册 treeexpbar_tree
        ICtrlHandler treeexpbar_tree = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUX_UserMgrViewTreeexpbar_treeHandler");
        treeexpbar_tree.init(this);
