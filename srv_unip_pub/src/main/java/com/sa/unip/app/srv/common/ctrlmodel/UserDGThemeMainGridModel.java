...
/**
 * 实体[用户表格自定义]数据表格[grid]部件模型
 */
public class  UserDGThemeMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserDGThemeMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 userdgthemeid
        iGridDataItem = createGridDataItem("userdgthemeid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userdgthemeid");
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERDGTHEMEID");
            gridEditItem.setCaption("表格列定义标识");
