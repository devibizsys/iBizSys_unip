...
/**
 * 视图[OA_HYSMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_HYSMPickupView.do")
public class OA_HYSMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OA_HYSMPickupViewController() throws Exception {
        super();
        this.setId("a2b464d3a975a40cce441a6a28770418");
        this.setCaption("会议室");
        this.setTitle("会议室数据多项选择视图");
        this.setCapLanResTag("DE.LNAME.OA_HYS");
        this.setTitleLanResTag("PAGE.TITLE.OA_HYS.MPICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/jcsj/OA_HYSMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_HYSMPickupViewController",this);
    }
