...
/**
 * 视图[UserDictRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserDictRedirectView.do")
public class UserDictRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public UserDictRedirectViewController() throws Exception {
        super();
        this.setId("09496645eff997e4330a5f777d4e1dbd");
        this.setCaption("用户词典");
        this.setTitle("用户词典实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/UserDictRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserDictRedirectViewController",this);
    }
