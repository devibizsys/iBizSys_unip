...
/**
 * 实体[实体查询模型]搜索表单[searchform]部件模型
 */
public class  QueryModelDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public QueryModelDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_querymodelname_like
        iFormItem = this.createFormItem("n_querymodelname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_querymodelname_like");
            formItem.setDEFName("QUERYMODELNAME");
            formItem.setCaption("实体查询模型名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_querymodelname_like");
