...
/**
 * 视图[CodeItemMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/CodeItemMPickupView.do")
public class CodeItemMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public CodeItemMPickupViewController() throws Exception {
        super();
        this.setId("f498a90c951f6c57f2cecc41e7a48499");
        this.setCaption("代码项");
        this.setTitle("代码项实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/CodeItemMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.CodeItemMPickupViewController",this);
    }
