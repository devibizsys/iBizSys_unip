...
/**
 * 实体[组织类型]数据关系栏[drbar]部件模型
 */
public class  OrgTypeDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public OrgTypeDefaultDRBarModel() {
        super();
    }
