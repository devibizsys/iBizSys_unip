...
/**
 * 应用视图[CodeListPickupGridView]表格[grid]后台处理对象基类
 */
public class CodeListPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected CodeListMainGridModel gridModel = null;
    public CodeListPickupGridViewGridHandler()  {
        super();
    }
