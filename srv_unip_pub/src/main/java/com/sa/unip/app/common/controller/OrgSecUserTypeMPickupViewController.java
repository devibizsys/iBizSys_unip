...
/**
 * 视图[OrgSecUserTypeMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgSecUserTypeMPickupView.do")
public class OrgSecUserTypeMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public OrgSecUserTypeMPickupViewController() throws Exception {
        super();
        this.setId("342eff86f679a22d913cf054b7f80f4a");
        this.setCaption("部门人员关系类型");
        this.setTitle("部门人员关系类型实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/OrgSecUserTypeMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgSecUserTypeMPickupViewController",this);
    }
