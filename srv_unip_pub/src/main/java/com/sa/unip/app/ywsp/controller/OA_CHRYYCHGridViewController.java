...
/**
 * 视图[OA_CHRYYCHGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CHRYYCHGridView.do")
public class OA_CHRYYCHGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_CHRYYCHGridViewController() throws Exception {
        super();
        this.setId("e4a54b42d248050cc8c251245fb910a7");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CHRYYCHGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CHRYYCHGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CHRYYCHGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CHRYYCHGridViewSearchFormHandler");
        searchForm.init(this);
