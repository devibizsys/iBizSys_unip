...
import com.sa.unip.app.srv.wf.ctrlmodel.WFUserGroupMainGridModel;
...
/**
 * 应用视图[WFUserGroupGridView]表格[grid]后台处理对象基类
 */
public class WFUserGroupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFUserGroupMainGridModel gridModel = null;
    public WFUserGroupGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFUserGroupMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFUserGroupMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFUserGroup entity)throws Exception {
