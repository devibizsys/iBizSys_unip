...
/**
 * 视图[UserRoleDataDetailGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDataDetailGridView.do")
public class UserRoleDataDetailGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public UserRoleDataDetailGridViewController() throws Exception {
        super();
        this.setId("09d428b166af8767576a4354c7e804b3");
        this.setCaption("数据对象能力明细");
        this.setTitle("数据对象能力明细实体表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/UserRoleDataDetailGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDataDetailGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDataDetailGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.UserRoleDataDetailGridViewSearchFormHandler");
        searchForm.init(this);
