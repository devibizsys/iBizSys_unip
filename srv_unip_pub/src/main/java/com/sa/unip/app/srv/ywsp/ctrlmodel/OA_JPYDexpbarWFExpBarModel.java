...
/**
 * 实体[机票预订]流程导航栏[expbar]部件模型
 */
public class  OA_JPYDexpbarWFExpBarModel extends net.ibizsys.pswf.ctrlmodel.WFExpBarModelBase {

    public OA_JPYDexpbarWFExpBarModel()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setWFModel(this.getViewController().getSystemModel().getWFModel("61BAE9BB-0074-4AB9-8AB1-2CCE45599290"));
        super.onInit();
    }
    ...
    protected void onPrepareRootItem(ExpBarRootItem expBarRootItem) throws Exception {
        ...
        expBarItem2.setExpViewId("JPYDLC:D:20");
        ...
        expBarItem3.setExpViewId("JPYDLC:D:20:10");
        ...
        expBarItem4.setExpViewId("JPYDLC:D:20:20");
        ...
        expBarItem5.setExpViewId("JPYDLC:D:30");
        ...
        expBarItem6.setExpViewId("JPYDLC:D:40");
        ...
        expBarItem7.setExpViewId("JPYDLC:W");
        ...
        expBarItem8.setExpViewId("JPYDLC:W:10");
        ...
        expBarItem9.setExpViewId("JPYDLC:W:20");
