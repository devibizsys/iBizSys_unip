...
/**
 * 视图[OA_YCSQPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQPickupGridView.do")
public class OA_YCSQPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_YCSQPickupGridViewController() throws Exception {
        super();
        this.setId("d00a2847162e74c8d56bdb0ecd728954");
        this.setCaption("用餐申请");
        this.setTitle("用餐申请选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_YCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_YCSQ.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQPickupGridViewSearchFormHandler");
        searchForm.init(this);
