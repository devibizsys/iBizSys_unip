...
public class OA_GZRZPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_GZRZDefaultSearchFormModel searchformModel = null;
    public OA_GZRZPickupGridViewSearchFormHandler()  {
        super();
    }
