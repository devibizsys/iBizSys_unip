...
/**
 * 视图[OA_YBHYSQYBHYSQ_WFExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQYBHYSQ_WFExpView.do")
public class OA_YBHYSQYBHYSQ_WFExpViewController extends net.ibizsys.pswf.controller.WFExpViewControllerBase {
    public OA_YBHYSQYBHYSQ_WFExpViewController() throws Exception {
        super();
        this.setId("ca080bda7ef3a6a775d2e5953ba82afb");
        this.setCaption("会议申请");
        this.setTitle("会议申请工作流导航视图(会议申请)");
        this.setCapLanResTag("DE.LNAME.OA_YBHYSQ");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.EXPBAR","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQYBHYSQ_WFExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQYBHYSQ_WFExpViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 expbar
        ICtrlModel expBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YBHYSQexpbarWFExpBarModel");
        expBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 expbar
        ICtrlHandler expBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_WFExpViewExpBarHandler");
        expBar.init(this);
