...
public class OrgUserUX_SpecOrgXJRYGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgUserDefaultSearchFormModel searchformModel = null;
    public OrgUserUX_SpecOrgXJRYGridViewSearchFormHandler()  {
        super();
    }
