...
/**
 * 实体[工作流步骤数据]编辑表单[form]部件模型
 */
public class WFStepDataMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFStepDataMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFSTEPDATAID");
            formItem.setCaption("工作流步骤数据标识");
            formItem.setCapLanResTag("DEF.LNAME.WFSTEPDATAID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.WFSTEPDATANAME");
        ...
        this.registerFormItem(iFormItem);
        // wfstepdataid
        iFormItem = this.createFormItem("wfstepdataid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfstepdataid");
            formItem.setDEFName("WFSTEPDATAID");
            formItem.setCaption("工作流步骤数据标识");
            formItem.setCapLanResTag("DEF.LNAME.WFSTEPDATAID");
