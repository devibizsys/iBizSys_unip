...
import com.sa.unip.app.srv.xxtz.ctrlmodel.OA_TZGGMainGridModel;
...
/**
 * 应用视图[OA_TZGGTZGGSQLC_D10_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_TZGGTZGGSQLC_D10_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_TZGGMainGridModel gridModel = null;
    public OA_TZGGTZGGSQLC_D10_WFGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        this.setMinorSortField("FSSJ");
        this.setMinorSortDir("DESC");

        gridModel = (OA_TZGGMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_TZGGMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_TZGG entity)throws Exception {
