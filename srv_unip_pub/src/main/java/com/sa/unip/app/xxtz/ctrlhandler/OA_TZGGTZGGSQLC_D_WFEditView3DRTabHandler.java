...
public class OA_TZGGTZGGSQLC_D_WFEditView3DRTabHandler extends net.ibizsys.paas.ctrlhandler.DRTabHandlerBase {

    protected OA_TZGGTZGGSQLCDRDRTabModel drTabModel = null;
    public OA_TZGGTZGGSQLC_D_WFEditView3DRTabHandler()  {
        super();
    }
