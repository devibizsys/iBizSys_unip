...
import com.sa.unip.app.srv.xtgl.ctrlmodel.OA_CZRZMainGridModel;
...
/**
 * 应用视图[OA_CZRZGridView]表格[grid]后台处理对象基类
 */
public class OA_CZRZGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_CZRZMainGridModel gridModel = null;
    public OA_CZRZGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_CZRZMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_CZRZMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_CZRZ entity)throws Exception {
