...
/**
 * 视图[WFInstancePickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFInstancePickupGridView.do")
public class WFInstancePickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public WFInstancePickupGridViewController() throws Exception {
        super();
        this.setId("8567c5b737f0641aa24ebe2c0c9f262e");
        this.setCaption("工作流实例");
        this.setTitle("工作流实例实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFInstancePickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFInstancePickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFInstancePickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFInstancePickupGridViewSearchFormHandler");
        searchForm.init(this);
