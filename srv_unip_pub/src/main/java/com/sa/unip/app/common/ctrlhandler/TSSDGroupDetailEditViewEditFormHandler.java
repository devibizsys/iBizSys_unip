...
public class TSSDGroupDetailEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected TSSDGroupDetailMainEditFormModel editformModel = null;
    public TSSDGroupDetailEditViewEditFormHandler()  {
        super();
    }
