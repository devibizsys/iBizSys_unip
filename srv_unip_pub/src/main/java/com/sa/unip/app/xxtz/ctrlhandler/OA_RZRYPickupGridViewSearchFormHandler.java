...
public class OA_RZRYPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_RZRYDefaultSearchFormModel searchformModel = null;
    public OA_RZRYPickupGridViewSearchFormHandler()  {
        super();
    }
