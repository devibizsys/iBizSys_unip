...
/**
 * 应用视图[UserRoleTypePickupGridView]表格[grid]后台处理对象基类
 */
public class UserRoleTypePickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected UserRoleTypeMainGridModel gridModel = null;
    public UserRoleTypePickupGridViewGridHandler()  {
        super();
    }
