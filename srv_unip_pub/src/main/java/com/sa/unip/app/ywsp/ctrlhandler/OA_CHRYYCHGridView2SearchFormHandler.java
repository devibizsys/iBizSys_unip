...
public class OA_CHRYYCHGridView2SearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_CHRYDefaultSearchFormModel searchformModel = null;
    public OA_CHRYYCHGridView2SearchFormHandler()  {
        super();
    }
