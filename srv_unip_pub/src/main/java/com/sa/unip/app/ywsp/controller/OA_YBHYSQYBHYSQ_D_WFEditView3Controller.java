...
/**
 * 视图[OA_YBHYSQYBHYSQ_D_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YBHYSQYBHYSQ_D_WFEditView3.do")
public class OA_YBHYSQYBHYSQ_D_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_YBHYSQYBHYSQ_D_WFEditView3Controller() throws Exception {
        super();
        this.setId("78b20644989cf0b37ca91198a8374126");
        this.setCaption("会议申请");
        this.setTitle("会议申请工作流视图(会议申请)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YBHYSQYBHYSQ_D_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YBHYSQYBHYSQ_D_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_D_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_D_WFEditView3EditFormHandler");
        editForm.init(this);
