...
/**
 * 应用视图[OA_CLWXCLWXLC_D20_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_CLWXCLWXLC_D20_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_CLWXMainGridModel gridModel = null;
    public OA_CLWXCLWXLC_D20_WFGridViewGridHandler()  {
        super();
    }
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_CLWX entity)throws Exception {
