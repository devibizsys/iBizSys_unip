...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_PCSQMainEditFormModel;
...
public class OA_PCSQPCSQLC_W10_WFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_PCSQMainEditFormModel editformModel = null;
    public OA_PCSQPCSQLC_W10_WFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_PCSQMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_PCSQMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'oa_clname'
        IFormItemHandler oa_clnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.ywsp.ctrlhandler.OA_PCSQMainEditFormOa_clnameHandler");
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.app.srv.ywsp.ctrlhandler.OA_PCSQMainEditFormOrgsectornameHandler");
