...
/**
 * 视图[DALogRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DALogRedirectView.do")
public class DALogRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public DALogRedirectViewController() throws Exception {
        super();
        this.setId("d262372a21a400789c83fba1b556b229");
        this.setCaption("DA日志");
        this.setTitle("DA日志实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/DALogRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DALogRedirectViewController",this);
    }
