...
/**
 * 应用视图[WFStepActorGridView]表格[grid]后台处理对象基类
 */
public class WFStepActorGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFStepActorMain2GridModel gridModel = null;
    public WFStepActorGridViewGridHandler()  {
        super();
    }
