...
public class OA_BGYPSQBGYPSQLC_W_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_BGYPSQDefaultSearchFormModel searchformModel = null;
    public OA_BGYPSQBGYPSQLC_W_WFGridViewSearchFormHandler()  {
        super();
    }
