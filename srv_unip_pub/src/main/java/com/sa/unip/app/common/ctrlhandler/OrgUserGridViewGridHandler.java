...
/**
 * 应用视图[OrgUserGridView]表格[grid]后台处理对象基类
 */
public class OrgUserGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserMain2GridModel gridModel = null;
    public OrgUserGridViewGridHandler()  {
        super();
    }
