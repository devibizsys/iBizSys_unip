...
/**
 * 实体[工作流用户组成员]编辑表单[form]部件模型
 */
public class WFUserGroupDetailMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public WFUserGroupDetailMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERGROUPDETAILID");
            formItem.setCaption("工作流用户组成员标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("WFUSERGROUPDETAILNAME");
        ...
        this.registerFormItem(iFormItem);
        // wfusergroupdetailid
        iFormItem = this.createFormItem("wfusergroupdetailid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wfusergroupdetailid");
            formItem.setDEFName("WFUSERGROUPDETAILID");
            formItem.setCaption("工作流用户组成员标识");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wfusergroupdetailid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
