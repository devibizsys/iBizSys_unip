...
/**
 * 视图[UserRoleDataPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDataPickupView.do")
public class UserRoleDataPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserRoleDataPickupViewController() throws Exception {
        super();
        this.setId("b9d638387923837c7a6a8d7b66389c7b");
        this.setCaption("数据对象能力");
        this.setTitle("数据对象能力实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDataPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDataPickupViewController",this);
    }
