...
import com.sa.unip.app.srv.xxtz.ctrlmodel.OA_XXRYMainGridModel;
...
/**
 * 应用视图[OA_XXRYGridView]表格[grid]后台处理对象基类
 */
public class OA_XXRYGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_XXRYMainGridModel gridModel = null;
    public OA_XXRYGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_XXRYMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_XXRYMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_XXRY entity)throws Exception {
