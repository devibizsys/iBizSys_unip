...
/**
 * 应用视图[OA_XMJDPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_XMJDPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_XMJDMainGridModel gridModel = null;
    public OA_XMJDPickupGridViewGridHandler()  {
        super();
    }
