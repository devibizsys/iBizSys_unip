...
/**
 * 实体[用户组]搜索表单[searchform]部件模型
 */
public class  UserGroupDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public UserGroupDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_usergroupname_like
        iFormItem = this.createFormItem("n_usergroupname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_usergroupname_like");
            formItem.setDEFName("USERGROUPNAME");
            formItem.setCaption("用户组名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_usergroupname_like");
