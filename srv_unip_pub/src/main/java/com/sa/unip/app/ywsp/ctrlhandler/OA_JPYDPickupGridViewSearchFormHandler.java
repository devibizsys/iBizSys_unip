...
public class OA_JPYDPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_JPYDDefaultSearchFormModel searchformModel = null;
    public OA_JPYDPickupGridViewSearchFormHandler()  {
        super();
    }
