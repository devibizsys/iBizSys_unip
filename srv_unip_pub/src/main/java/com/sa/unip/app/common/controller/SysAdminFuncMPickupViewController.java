...
/**
 * 视图[SysAdminFuncMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/SysAdminFuncMPickupView.do")
public class SysAdminFuncMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public SysAdminFuncMPickupViewController() throws Exception {
        super();
        this.setId("3da149b2d41ee36a0f7268aeb1f278b3");
        this.setCaption("系统管理功能");
        this.setTitle("系统管理功能实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/SysAdminFuncMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.SysAdminFuncMPickupViewController",this);
    }
