...
/**
 * 视图[OA_QXJPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJPickupGridView.do")
public class OA_QXJPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_QXJPickupGridViewController() throws Exception {
        super();
        this.setId("3e75174cb40d2300a40ccd2e77b649c8");
        this.setCaption("请休假");
        this.setTitle("请休假选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_QXJ");
        this.setTitleLanResTag("PAGE.TITLE.OA_QXJ.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_QXJPickupGridViewSearchFormHandler");
        searchForm.init(this);
