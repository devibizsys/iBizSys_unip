...
/**
 * 应用视图[OA_BGYPSQGridView]表格[grid]后台处理对象基类
 */
public class OA_BGYPSQGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_BGYPSQMainGridModel gridModel = null;
    public OA_BGYPSQGridViewGridHandler()  {
        super();
    }
