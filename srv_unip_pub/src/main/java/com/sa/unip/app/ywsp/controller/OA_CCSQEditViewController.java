...
/**
 * 视图[OA_CCSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQEditView.do")
public class OA_CCSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_CCSQEditViewController() throws Exception {
        super();
        this.setId("7f0b23686dbbb04079910f31e6f20ad5");
        this.setCaption("出差申请");
        this.setTitle("出差申请编辑视图");
        this.setCapLanResTag("DE.LNAME.QA_CCSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_CCSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQEditViewEditFormHandler");
        editForm.init(this);
