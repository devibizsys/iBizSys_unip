...
/**
 * 实体[用户角色实体属性访问]数据关系栏[drbar]部件模型
 */
public class  UserRoleDEFieldDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserRoleDEFieldDefaultDRBarModel() {
        super();
    }
    ...
    protected void onPrepareRootItem(DRCtrlRootItem drCtrlRootItem) throws Exception {
        ...
        drCtrlItem0.setText("用户角色实体属性访问");
