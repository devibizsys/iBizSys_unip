...
public class OA_YBHYSQYBHYSQ_D40_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_YBHYSQDefaultSearchFormModel searchformModel = null;
    public OA_YBHYSQYBHYSQ_D40_WFGridViewSearchFormHandler()  {
        super();
    }
