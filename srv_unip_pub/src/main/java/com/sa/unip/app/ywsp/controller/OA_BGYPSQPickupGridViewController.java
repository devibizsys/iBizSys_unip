...
/**
 * 视图[OA_BGYPSQPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQPickupGridView.do")
public class OA_BGYPSQPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OA_BGYPSQPickupGridViewController() throws Exception {
        super();
        this.setId("84c61c90a7d513b58c17552fac2a6b97");
        this.setCaption("办公用品申请");
        this.setTitle("办公用品申请选择表格视图");
        this.setCapLanResTag("DE.LNAME.OA_BGYPSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_BGYPSQ.PICKUPGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQPickupGridViewSearchFormHandler");
        searchForm.init(this);
