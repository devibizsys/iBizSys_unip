...
public class OA_CPMJSQCPMJSQLC_D10_WFGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_CPMJSQDefaultSearchFormModel searchformModel = null;
    public OA_CPMJSQCPMJSQLC_D10_WFGridViewSearchFormHandler()  {
        super();
    }
