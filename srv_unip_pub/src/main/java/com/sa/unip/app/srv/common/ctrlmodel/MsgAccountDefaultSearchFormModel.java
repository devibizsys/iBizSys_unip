...
/**
 * 实体[消息账户]搜索表单[searchform]部件模型
 */
public class  MsgAccountDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public MsgAccountDefaultSearchFormModel() {
        super();
