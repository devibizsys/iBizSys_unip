...
/**
 * 视图[OA_BGYPSQEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_BGYPSQEditView.do")
public class OA_BGYPSQEditViewController extends net.ibizsys.pswf.controller.EditViewControllerBase {
    public OA_BGYPSQEditViewController() throws Exception {
        super();
        this.setId("8bda4c7a1291f5e4e00d7432386f4e35");
        this.setCaption("办公用品申请");
        this.setTitle("办公用品申请编辑视图");
        this.setCapLanResTag("DE.LNAME.OA_BGYPSQ");
        this.setTitleLanResTag("PAGE.TITLE.OA_BGYPSQ.EDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_BGYPSQEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_BGYPSQEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_BGYPSQEditViewEditFormHandler");
        editForm.init(this);
