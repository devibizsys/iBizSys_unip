...
import com.sa.unip.app.srv.wf.ctrlmodel.WFSystemUserMainGridModel;
...
/**
 * 应用视图[WFSystemUserGridView]表格[grid]后台处理对象基类
 */
public class WFSystemUserGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WFSystemUserMainGridModel gridModel = null;
    public WFSystemUserGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (WFSystemUserMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected WFSystemUserMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(WFSystemUser entity)throws Exception {
