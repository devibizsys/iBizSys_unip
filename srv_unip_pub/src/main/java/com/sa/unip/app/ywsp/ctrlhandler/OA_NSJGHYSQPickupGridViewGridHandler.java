...
/**
 * 应用视图[OA_NSJGHYSQPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_NSJGHYSQPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_NSJGHYSQMainGridModel gridModel = null;
    public OA_NSJGHYSQPickupGridViewGridHandler()  {
        super();
    }
