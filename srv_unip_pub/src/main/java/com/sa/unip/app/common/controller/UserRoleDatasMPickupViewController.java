...
/**
 * 视图[UserRoleDatasMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDatasMPickupView.do")
public class UserRoleDatasMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserRoleDatasMPickupViewController() throws Exception {
        super();
        this.setId("6c71ea92947b9af0e55b5eeaf3321364");
        this.setCaption("用户角色数据能力");
        this.setTitle("用户角色数据能力实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDatasMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDatasMPickupViewController",this);
    }
