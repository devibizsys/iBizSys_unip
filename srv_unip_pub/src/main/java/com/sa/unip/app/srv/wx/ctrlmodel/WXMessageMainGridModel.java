...
/**
 * 实体[微信消息]数据表格[grid]部件模型
 */
public class  WXMessageMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public WXMessageMainGridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 微信消息名称
        iGridColumn = createGridColumn("wxmessagename");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("wxmessagename");
            gridColumnModel.setDataItemName("wxmessagename");
            gridColumnModel.setCaption("微信消息名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 wxmessagename
        iGridDataItem = createGridDataItem("wxmessagename");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxmessagename");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 wxmessageid
        iGridDataItem = createGridDataItem("wxmessageid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("wxmessageid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("WXMESSAGEID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("WXMESSAGEID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("微信消息标识");
