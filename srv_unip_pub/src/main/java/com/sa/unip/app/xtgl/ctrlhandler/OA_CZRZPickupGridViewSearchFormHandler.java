...
public class OA_CZRZPickupGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_CZRZDefaultSearchFormModel searchformModel = null;
    public OA_CZRZPickupGridViewSearchFormHandler()  {
        super();
    }
