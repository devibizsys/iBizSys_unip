...
/**
 * 实体[门户页面]搜索表单[searchform]部件模型
 */
public class  PortalPageDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public PortalPageDefaultSearchFormModel() {
        super();
