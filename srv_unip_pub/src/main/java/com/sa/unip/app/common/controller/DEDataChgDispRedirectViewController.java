...
/**
 * 视图[DEDataChgDispRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DEDataChgDispRedirectView.do")
public class DEDataChgDispRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public DEDataChgDispRedirectViewController() throws Exception {
        super();
        this.setId("902a1dcd88aa6c7e7c818f2dae34b6b8");
        this.setCaption("实体数据变更派发引擎");
        this.setTitle("实体数据变更派发引擎实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/DEDataChgDispRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DEDataChgDispRedirectViewController",this);
    }
