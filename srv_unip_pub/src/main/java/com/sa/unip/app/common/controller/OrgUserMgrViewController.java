...
/**
 * 视图[OrgUserMgrView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/OrgUserMgrView.do")
public class OrgUserMgrViewController extends net.ibizsys.paas.controller.TreeExpViewControllerBase {
    public OrgUserMgrViewController() throws Exception {
        super();
        this.setId("50e4b54af6e606eee9f680a74982a2ab");
        this.setCaption("组织机构");
        this.setTitle("用户树导航视图");
        ...
        ViewControllerGlobal.registerViewController("/app/common/OrgUserMgrView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.OrgUserMgrViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 treeexpbar_tree
        ICtrlModel treeexpbar_tree=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.common.ctrlmodel.OrgAllOrg3TreeModel");
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 treeexpbar
        ICtrlHandler treeexpbar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserMgrViewTreeExpBarHandler");
        treeexpbar.init(this);
        this.registerCtrlHandler("treeexpbar",treeexpbar);
        //注册 treeexpbar_tree
        ICtrlHandler treeexpbar_tree = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.common.ctrlhandler.OrgUserMgrViewTreeexpbar_treeHandler");
        treeexpbar_tree.init(this);
