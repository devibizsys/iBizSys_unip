...
import com.sa.unip.app.srv.xxtz.ctrlmodel.OA_RZRYMainEditFormModel;
...
public class OA_RZRYEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OA_RZRYMainEditFormModel editformModel = null;
    public OA_RZRYEditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_RZRYMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_RZRYMainEditFormModel getRealEditFormModel() {
