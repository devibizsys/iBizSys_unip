...
/**
 * 实体[数据审计]数据表格[grid]部件模型
 */
public class  DataAuditMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public DataAuditMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.DataAuditDEModel dataAuditDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.DataAuditDEModel getDataAuditDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 审计条目
        iGridColumn = createGridColumn("dataauditname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("dataauditname");
            gridColumnModel.setDataItemName("dataauditname");
            gridColumnModel.setCaption("审计条目");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 dataauditname
        iGridDataItem = createGridDataItem("dataauditname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("dataauditname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DATAAUDITNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("DATAAUDITID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("数据审计标识");
