...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_CLWXSHYJFormEditFormModel;
...
public class OA_CLWXWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_CLWXSHYJFormEditFormModel editformModel = null;
    public OA_CLWXWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CLWXSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CLWXSHYJFormEditFormModel getRealEditFormModel() {
