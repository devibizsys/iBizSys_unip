...
/**
 * 视图[OA_CCSQWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CCSQWFActionView.do")
public class OA_CCSQWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_CCSQWFActionViewController() throws Exception {
        super();
        this.setId("b3319c5b8da415a81f0340094191641b");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CCSQWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CCSQWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_CCSQSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CCSQWFActionViewEditFormHandler");
        editForm.init(this);
