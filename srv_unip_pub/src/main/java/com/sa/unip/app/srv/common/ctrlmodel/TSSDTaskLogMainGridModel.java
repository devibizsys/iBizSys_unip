...
/**
 * 实体[任务调度日志]数据表格[grid]部件模型
 */
public class  TSSDTaskLogMainGridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public TSSDTaskLogMainGridModel()  {
        super();
        this.setName("grid");
    }

    private net.ibizsys.psrt.srv.common.demodel.TSSDTaskLogDEModel tSSDTaskLogDEModel;
    protected  net.ibizsys.psrt.srv.common.demodel.TSSDTaskLogDEModel getTSSDTaskLogDEModel() {
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 任务调度日志名称
        iGridColumn = createGridColumn("tssdtasklogname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("tssdtasklogname");
            gridColumnModel.setDataItemName("tssdtasklogname");
            gridColumnModel.setCaption("任务调度日志名称");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        //建立数据项 tssdtasklogid
        iGridDataItem = createGridDataItem("tssdtasklogid");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdtasklogid");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDTASKLOGID");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 tssdtasklogname
        iGridDataItem = createGridDataItem("tssdtasklogname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("tssdtasklogname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("TSSDTASKLOGNAME");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("TSSDTASKLOGID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("任务调度日志标识");
