...
/**
 * 实体[用户角色实体属性访问]数据表格[grid]部件模型
 */
public class  UserRoleDEFieldMain2GridModel extends net.ibizsys.paas.ctrlmodel.GridModelBase {

    public UserRoleDEFieldMain2GridModel()  {
        super();
        this.setName("grid");
    }
    ...
    protected void prepareGridColumnModels()throws Exception {
        ...
        //建立表格列 实体属性访问能力
        iGridColumn = createGridColumn("userroledefieldname");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("userroledefieldname");
            gridColumnModel.setDataItemName("userroledefieldname");
            gridColumnModel.setCaption("实体属性访问能力");
        ...
        this.registerGridColumn(iGridColumn);
        //建立表格列 访问行为
        iGridColumn = createGridColumn("defaction");
        if(iGridColumn==null) {
            GridColumnModel gridColumnModel = new GridColumnModel();
            gridColumnModel.setName("defaction");
            gridColumnModel.setDataItemName("defaction");
            gridColumnModel.setCaption("访问行为");
            gridColumnModel.setCodeListId("com.sa.unip.srv.codelist.CodeList88CodeListModel");
    ...
    protected void prepareGridDataItemModels()throws Exception {
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 userroledefieldname
        iGridDataItem = createGridDataItem("userroledefieldname");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("userroledefieldname");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        this.registerGridDataItem(iGridDataItem);
        //建立数据项 defaction
        iGridDataItem = createGridDataItem("defaction");
        if(iGridDataItem == null) {
            GridDataItemModel gridDataItemModel = new GridDataItemModel();
            gridDataItemModel.setName("defaction");
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEFACTION");
            dataItemParam0.setFormat("%1$s");
            dataItemParam0.setDataItem(gridDataItemModel);
            gridDataItemModel.addDataItemParam(dataItemParam0);
            gridDataItemModel.init(this);
    ...
    protected void prepareGridEditItemModels()throws Exception {
        ...
        if(iGridEditItem==null) {
            ...
            gridEditItem.setDEFName("USERROLEDEFIELDID");
            gridEditItem.setEnableCond(0);
            gridEditItem.setCaption("实体属性访问能力标识");
