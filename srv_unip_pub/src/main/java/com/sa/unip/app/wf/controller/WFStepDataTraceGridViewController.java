...
/**
 * 视图[WFStepDataTraceGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFStepDataTraceGridView.do")
public class WFStepDataTraceGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public WFStepDataTraceGridViewController() throws Exception {
        super();
        this.setId("7561e1e39e7bc0f1c0fe8a8f0e771f2e");
        this.setCaption("工作流步骤数据");
        this.setTitle("工作流步骤数据跟踪表格视图");
        this.setCapLanResTag("DE.LNAME.WFSTEPDATA");
        this.setTitleLanResTag("PAGE.TITLE.WFSTEPDATA.TRACEGRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/wf/WFStepDataTraceGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFStepDataTraceGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepDataTraceGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wf.ctrlhandler.WFStepDataTraceGridViewSearchFormHandler");
        searchForm.init(this);
