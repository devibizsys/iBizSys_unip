...
/**
 * 视图[OA_GZRZRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_GZRZRedirectView.do")
public class OA_GZRZRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_GZRZRedirectViewController() throws Exception {
        super();
        this.setId("e141dc0bb4675e0c40e2cb3e1bf1a017");
        this.setCaption("工作日志");
        this.setTitle("工作日志数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_GZRZRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_GZRZRedirectViewController",this);
    }
