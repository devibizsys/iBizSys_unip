...
/**
 * 应用视图[OA_HYSPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_HYSPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_HYSMainGridModel gridModel = null;
    public OA_HYSPickupGridViewGridHandler()  {
        super();
    }
