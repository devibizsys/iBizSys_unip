...
/**
 * 视图[WFInstanceRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFInstanceRedirectView.do")
public class WFInstanceRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public WFInstanceRedirectViewController() throws Exception {
        super();
        this.setId("0220f16cd0c02a79b3e63d59901d128d");
        this.setCaption("工作流实例");
        this.setTitle("工作流实例实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/wf/WFInstanceRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFInstanceRedirectViewController",this);
    }
