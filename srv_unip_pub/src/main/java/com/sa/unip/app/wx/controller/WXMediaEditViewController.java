...
/**
 * 视图[WXMediaEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wx/WXMediaEditView.do")
public class WXMediaEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public WXMediaEditViewController() throws Exception {
        super();
        this.setId("da98aafaf1d13885e095e6eee6e390b2");
        this.setCaption("微信多媒体内容");
        this.setTitle("微信多媒体内容实体编辑视图");
        ...
        ViewControllerGlobal.registerViewController("/app/wx/WXMediaEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wx.controller.WXMediaEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.wx.ctrlhandler.WXMediaEditViewEditFormHandler");
        editForm.init(this);
