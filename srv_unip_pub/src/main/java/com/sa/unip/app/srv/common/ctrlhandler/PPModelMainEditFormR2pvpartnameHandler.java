...
public class PPModelMainEditFormR2pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelMainEditFormR2pvpartnameHandler()  {
        super();
    }
