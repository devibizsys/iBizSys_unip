...
/**
 * 视图[OA_CHRYYCHGridView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CHRYYCHGridView2.do")
public class OA_CHRYYCHGridView2Controller extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_CHRYYCHGridView2Controller() throws Exception {
        super();
        this.setId("36cf2633abbec5b89b672f12e292c34d");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CHRYYCHGridView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CHRYYCHGridView2Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CHRYYCHGridView2GridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CHRYYCHGridView2SearchFormHandler");
        searchForm.init(this);
