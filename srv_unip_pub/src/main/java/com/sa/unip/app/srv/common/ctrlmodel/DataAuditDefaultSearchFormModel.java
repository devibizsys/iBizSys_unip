...
/**
 * 实体[数据审计]搜索表单[searchform]部件模型
 */
public class  DataAuditDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public DataAuditDefaultSearchFormModel() {
        super();
