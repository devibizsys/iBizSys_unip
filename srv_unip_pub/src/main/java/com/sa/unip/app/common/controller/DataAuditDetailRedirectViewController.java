...
/**
 * 视图[DataAuditDetailRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataAuditDetailRedirectView.do")
public class DataAuditDetailRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public DataAuditDetailRedirectViewController() throws Exception {
        super();
        this.setId("1ec8f620601acc20b9608ee9ed32f5f1");
        this.setCaption("数据审计明细");
        this.setTitle("数据审计明细实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/DataAuditDetailRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataAuditDetailRedirectViewController",this);
    }
