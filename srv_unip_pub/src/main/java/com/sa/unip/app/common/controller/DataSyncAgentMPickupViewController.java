...
/**
 * 视图[DataSyncAgentMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncAgentMPickupView.do")
public class DataSyncAgentMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public DataSyncAgentMPickupViewController() throws Exception {
        super();
        this.setId("a14969ae87823782173553fc58c74ab7");
        this.setCaption("数据同步代理");
        this.setTitle("数据同步代理实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataSyncAgentMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncAgentMPickupViewController",this);
    }
