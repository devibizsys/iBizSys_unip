...
/**
 * 实体[用户角色资源能力]数据关系栏[drbar]部件模型
 */
public class  UserRoleResDefaultDRBarModel extends net.ibizsys.paas.ctrlmodel.DRBarModelBase {

    public UserRoleResDefaultDRBarModel() {
        super();
    }
