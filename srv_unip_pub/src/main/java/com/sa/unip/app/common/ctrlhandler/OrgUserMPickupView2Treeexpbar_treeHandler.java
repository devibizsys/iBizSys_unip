 ...
 * 树视图控件后台处理基类
 */
public class OrgUserMPickupView2Treeexpbar_treeHandler extends net.ibizsys.paas.ctrlhandler.TreeHandlerBase {

    protected OrgAllOrgTreeModel treeModel = null;
    public OrgUserMPickupView2Treeexpbar_treeHandler()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        treeModel  = (OrgAllOrgTreeModel)this.getViewController().getCtrlModel("treeexpbar_tree");
        super.onInit();
    }
