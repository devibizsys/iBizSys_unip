...
/**
 * 视图[UserRoleDetailMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDetailMPickupView.do")
public class UserRoleDetailMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserRoleDetailMPickupViewController() throws Exception {
        super();
        this.setId("303749a411277e40520d80c6a22ad400");
        this.setCaption("用户角色成员");
        this.setTitle("用户角色成员实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDetailMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDetailMPickupViewController",this);
    }
