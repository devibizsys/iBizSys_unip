...
/**
 * 视图[OA_CLWXGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_CLWXGridView.do")
public class OA_CLWXGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_CLWXGridViewController() throws Exception {
        super();
        this.setId("0c7e20c8c4ab04e4d89dec066baf6b18");
        this.setCaption("车辆维修");
        this.setTitle("车辆维修表格视图");
        this.setCapLanResTag("DE.LNAME.OA_CLWX");
        this.setTitleLanResTag("PAGE.TITLE.OA_CLWX.GRIDVIEW");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_CLWXGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_CLWXGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_CLWXGridViewSearchFormHandler");
        searchForm.init(this);
