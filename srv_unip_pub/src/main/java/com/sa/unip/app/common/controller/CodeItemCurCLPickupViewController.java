...
/**
 * 视图[CodeItemCurCLPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/CodeItemCurCLPickupView.do")
public class CodeItemCurCLPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public CodeItemCurCLPickupViewController() throws Exception {
        super();
        this.setId("5789174e063fc080d374be6f1b1a3d9a");
        this.setCaption("代码项");
        this.setTitle("当前代码表代码项数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/CodeItemCurCLPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.CodeItemCurCLPickupViewController",this);
    }
