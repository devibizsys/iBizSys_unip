...
/**
 * 视图[UserRoleDEFieldsPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleDEFieldsPickupView.do")
public class UserRoleDEFieldsPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public UserRoleDEFieldsPickupViewController() throws Exception {
        super();
        this.setId("3079c33218cf6e7616935c04f6184296");
        this.setCaption("用户角色相关实体属性访问控制");
        this.setTitle("用户角色相关实体属性访问控制实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleDEFieldsPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleDEFieldsPickupViewController",this);
    }
