...
/**
 * 视图[DataSyncAgentPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/DataSyncAgentPickupView.do")
public class DataSyncAgentPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public DataSyncAgentPickupViewController() throws Exception {
        super();
        this.setId("c5034af5ae10796f125421fe9922669b");
        this.setCaption("数据同步代理");
        this.setTitle("数据同步代理实体数据选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/DataSyncAgentPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.DataSyncAgentPickupViewController",this);
    }
