...
import com.sa.unip.app.srv.jcsj.ctrlmodel.OA_HYSMainGridModel;
...
/**
 * 应用视图[OA_HYSGridView]表格[grid]后台处理对象基类
 */
public class OA_HYSGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_HYSMainGridModel gridModel = null;
    public OA_HYSGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_HYSMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_HYSMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_HYS entity)throws Exception {
