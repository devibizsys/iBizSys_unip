...
import com.sa.unip.app.srv.jcsj.ctrlmodel.OA_HYSMainEditFormModel;
...
public class OA_HYSEditView2EditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OA_HYSMainEditFormModel editformModel = null;
    public OA_HYSEditView2EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_HYSMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_HYSMainEditFormModel getRealEditFormModel() {
