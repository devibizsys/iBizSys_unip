...
/**
 * 视图[WFUserGroupMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFUserGroupMPickupView.do")
public class WFUserGroupMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public WFUserGroupMPickupViewController() throws Exception {
        super();
        this.setId("e7d24edaf1ef9be021edc4378ad72ee3");
        this.setCaption("工作流用户组");
        this.setTitle("工作流用户组实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFUserGroupMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFUserGroupMPickupViewController",this);
    }
