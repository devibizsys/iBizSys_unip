...
/**
 * 视图[SysAdminFuncRedirectView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/SysAdminFuncRedirectView.do")
public class SysAdminFuncRedirectViewController extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public SysAdminFuncRedirectViewController() throws Exception {
        super();
        this.setId("54ea8aeb46d5d0502d0799b2bc01136f");
        this.setCaption("系统管理功能");
        this.setTitle("系统管理功能实体数据重定向视图");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/app/common/SysAdminFuncRedirectView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.SysAdminFuncRedirectViewController",this);
    }
