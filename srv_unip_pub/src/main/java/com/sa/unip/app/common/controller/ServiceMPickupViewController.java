...
/**
 * 视图[ServiceMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/ServiceMPickupView.do")
public class ServiceMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public ServiceMPickupViewController() throws Exception {
        super();
        this.setId("64ba77a338dd479d6791272229f5aa77");
        this.setCaption("服务");
        this.setTitle("服务实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/ServiceMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.ServiceMPickupViewController",this);
    }
