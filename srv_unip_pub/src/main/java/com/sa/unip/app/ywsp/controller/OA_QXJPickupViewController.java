...
/**
 * 视图[OA_QXJPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_QXJPickupView.do")
public class OA_QXJPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public OA_QXJPickupViewController() throws Exception {
        super();
        this.setId("e0a2ad4a3224b57dd40294eb46641f72");
        this.setCaption("请休假");
        this.setTitle("请休假数据选择视图");
        this.setCapLanResTag("DE.LNAME.OA_QXJ");
        this.setTitleLanResTag("PAGE.TITLE.OA_QXJ.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/ywsp/OA_QXJPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_QXJPickupViewController",this);
    }
