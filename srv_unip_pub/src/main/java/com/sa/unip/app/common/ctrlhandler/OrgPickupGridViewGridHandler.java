...
/**
 * 应用视图[OrgPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgMain2GridModel gridModel = null;
    public OrgPickupGridViewGridHandler()  {
        super();
    }
