...
/**
 * 应用视图[OA_CGSQCGSQLC_W50_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_CGSQCGSQLC_W50_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_CGSQMainGridModel gridModel = null;
    public OA_CGSQCGSQLC_W50_WFGridViewGridHandler()  {
        super();
    }
