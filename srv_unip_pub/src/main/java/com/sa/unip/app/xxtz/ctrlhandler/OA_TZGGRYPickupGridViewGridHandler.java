...
/**
 * 应用视图[OA_TZGGRYPickupGridView]表格[grid]后台处理对象基类
 */
public class OA_TZGGRYPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_TZGGRYMainGridModel gridModel = null;
    public OA_TZGGRYPickupGridViewGridHandler()  {
        super();
    }
