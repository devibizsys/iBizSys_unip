...
public class PPModelMainEditFormL4pvpartnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public PPModelMainEditFormL4pvpartnameHandler()  {
        super();
    }
