...
/**
 * 应用视图[WXEntAppPickupGridView]表格[grid]后台处理对象基类
 */
public class WXEntAppPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected WXEntAppMainGridModel gridModel = null;
    public WXEntAppPickupGridViewGridHandler()  {
        super();
    }
