...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_SBWXMainGridModel;
...
/**
 * 应用视图[OA_SBWXSBWXLC_D20_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_SBWXSBWXLC_D20_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_SBWXMainGridModel gridModel = null;
    public OA_SBWXSBWXLC_D20_WFGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_SBWXMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_SBWXMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_SBWX entity)throws Exception {
