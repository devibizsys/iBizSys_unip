...
/**
 * 实体[用户角色相关实体属性访问控制]编辑表单[form]部件模型
 */
public class UserRoleDEFieldsMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public UserRoleDEFieldsMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLEDEFIELDSID");
            formItem.setEnableCond(0);
            formItem.setCaption("用户角色相关实体属性访问控制标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("USERROLEDEFIELDSNAME");
            formItem.setCaption("用户角色相关实体属性访问控制");
        ...
        this.registerFormItem(iFormItem);
        // userroledefieldsname
        iFormItem = this.createFormItem("userroledefieldsname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroledefieldsname");
            formItem.setDEFName("USERROLEDEFIELDSNAME");
            formItem.setCaption("用户角色相关实体属性访问控制");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroledefieldsname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // userroledefieldsid
        iFormItem = this.createFormItem("userroledefieldsid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("userroledefieldsid");
            formItem.setDEFName("USERROLEDEFIELDSID");
            formItem.setEnableCond(0);
            formItem.setCaption("用户角色相关实体属性访问控制标识");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("userroledefieldsid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
