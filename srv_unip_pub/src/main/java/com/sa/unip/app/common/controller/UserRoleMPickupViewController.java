...
/**
 * 视图[UserRoleMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/common/UserRoleMPickupView.do")
public class UserRoleMPickupViewController extends net.ibizsys.paas.controller.MPickupViewControllerBase {
    public UserRoleMPickupViewController() throws Exception {
        super();
        this.setId("6e3499d7837f8229ef519f30c74b1cfc");
        this.setCaption("用户角色");
        this.setTitle("用户角色实体数据多项选择视图");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/common/UserRoleMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.common.controller.UserRoleMPickupViewController",this);
    }
