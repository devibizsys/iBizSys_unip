...
/**
 * 实体[实体查询模型]编辑表单[form]部件模型
 */
public class QueryModelMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public QueryModelMainEditFormModel()  {
        super();
        this.setName("form");
    }
