...
/**
 * 视图[OA_YCSQYCSQLC_W10_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_YCSQYCSQLC_W10_WFEditView3.do")
public class OA_YCSQYCSQLC_W10_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_YCSQYCSQLC_W10_WFEditView3Controller() throws Exception {
        super();
        this.setId("6e92d498a4b920da074925ab42b97938");
        this.setCaption("用餐申请");
        this.setTitle("用餐申请工作流视图(用餐申请流程v1:部门领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_YCSQYCSQLC_W10_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_YCSQYCSQLC_W10_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQYCSQLC_W10_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_YCSQYCSQLC_W10_WFEditView3EditFormHandler");
        editForm.init(this);
