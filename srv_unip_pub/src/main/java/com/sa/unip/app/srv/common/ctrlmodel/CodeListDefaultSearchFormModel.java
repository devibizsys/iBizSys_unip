...
/**
 * 实体[代码表]搜索表单[searchform]部件模型
 */
public class  CodeListDefaultSearchFormModel extends net.ibizsys.paas.ctrlmodel.SearchFormModelBase {

    public CodeListDefaultSearchFormModel() {
        super();
    ...
    protected void prepareFormItems()throws Exception {
        ...
        // n_codelistname_like
        iFormItem = this.createFormItem("n_codelistname_like");
        if(iFormItem==null) {
            SearchFormItemModel formItem = new SearchFormItemModel();
            formItem.setForm(this);
            formItem.setName("n_codelistname_like");
            formItem.setDEFName("CODELISTNAME");
            formItem.setCaption("代码表名称(%)");
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("n_codelistname_like");
