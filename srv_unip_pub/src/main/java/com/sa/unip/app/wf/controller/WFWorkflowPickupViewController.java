...
/**
 * 视图[WFWorkflowPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/app/wf/WFWorkflowPickupView.do")
public class WFWorkflowPickupViewController extends net.ibizsys.paas.controller.PickupViewControllerBase {
    public WFWorkflowPickupViewController() throws Exception {
        super();
        this.setId("94570cb4a50d75b3d2a942d4ab87174e");
        this.setCaption("工作流配置");
        this.setTitle("工作流配置实体数据选择视图");
        this.setCapLanResTag("DE.LNAME.WFWORKFLOW");
        this.setTitleLanResTag("PAGE.TITLE.WFWORKFLOW.PICKUPVIEW");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/app/wf/WFWorkflowPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.wf.controller.WFWorkflowPickupViewController",this);
    }
