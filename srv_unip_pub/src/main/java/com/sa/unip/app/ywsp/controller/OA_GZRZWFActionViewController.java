 ...
 */
@Controller
@RequestMapping(value = "/app/ywsp/OA_GZRZWFActionView.do")
public class OA_GZRZWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_GZRZWFActionViewController() throws Exception {
        super();
        this.setId("6d227c619ed04ff7e2e9b3f7897799f3");
        ...
        ViewControllerGlobal.registerViewController("/app/ywsp/OA_GZRZWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.ywsp.controller.OA_GZRZWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.app.srv.ywsp.ctrlmodel.OA_GZRZSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.ywsp.ctrlhandler.OA_GZRZWFActionViewEditFormHandler");
        editForm.init(this);
