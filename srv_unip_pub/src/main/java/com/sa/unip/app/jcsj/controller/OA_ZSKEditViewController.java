 ...
 */
@Controller
@RequestMapping(value = "/app/jcsj/OA_ZSKEditView.do")
public class OA_ZSKEditViewController extends net.ibizsys.paas.controller.EditViewControllerBase {
    public OA_ZSKEditViewController() throws Exception {
        super();
        this.setId("676262d7e630de1f549e58a335aef3ab");
        this.setCaption("知识库");
        ...
        ViewControllerGlobal.registerViewController("/app/jcsj/OA_ZSKEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.app.jcsj.controller.OA_ZSKEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.app.jcsj.ctrlhandler.OA_ZSKEditViewEditFormHandler");
        editForm.init(this);
