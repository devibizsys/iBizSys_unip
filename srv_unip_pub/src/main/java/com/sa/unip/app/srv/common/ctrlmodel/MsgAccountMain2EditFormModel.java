...
/**
 * 实体[消息账户]编辑表单[form]部件模型
 */
public class MsgAccountMain2EditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public MsgAccountMain2EditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("MSGACCOUNTID");
            formItem.setEnableCond(1);
            formItem.setCaption("消息账户标识");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("MSGACCOUNTNAME");
            formItem.setCaption("消息账户名称");
        ...
        this.registerFormItem(iFormItem);
        // msgaccountid
        iFormItem = this.createFormItem("msgaccountid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("msgaccountid");
            formItem.setDEFName("MSGACCOUNTID");
            formItem.setEnableCond(1);
            formItem.setCaption("消息账户标识");
        ...
        this.registerFormItem(iFormItem);
        // msgaccountname
        iFormItem = this.createFormItem("msgaccountname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("msgaccountname");
            formItem.setDEFName("MSGACCOUNTNAME");
            formItem.setCaption("消息账户名称");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("msgaccountname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // islist
        iFormItem = this.createFormItem("islist");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("islist");
            formItem.setDEFName("ISLIST");
            formItem.setCodeListId("com.sa.unip.srv.codelist.YesNoCodeListModel");
            formItem.setCaption("消息账户组");
            formItem.setAllowEmpty(false);
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("islist");
        ...
        this.registerFormItem(iFormItem);
        // msgaddress
        iFormItem = this.createFormItem("msgaddress");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("msgaddress");
            formItem.setDEFName("MSGADDRESS");
            formItem.setCaption("地址");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("msgaddress");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // mailaddress
        iFormItem = this.createFormItem("mailaddress");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("mailaddress");
            formItem.setDEFName("MAILADDRESS");
            formItem.setCaption("邮件地址");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("mailaddress");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // mobile
        iFormItem = this.createFormItem("mobile");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("mobile");
            formItem.setDEFName("MOBILE");
            formItem.setCaption("移动电话");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("mobile");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxaddr
        iFormItem = this.createFormItem("wxaddr");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxaddr");
            formItem.setDEFName("WXADDR");
            formItem.setCaption("微信地址");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxaddr");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
