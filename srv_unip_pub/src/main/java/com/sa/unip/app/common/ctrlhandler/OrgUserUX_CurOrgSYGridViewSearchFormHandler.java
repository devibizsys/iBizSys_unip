...
public class OrgUserUX_CurOrgSYGridViewSearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OrgUserDefaultSearchFormModel searchformModel = null;
    public OrgUserUX_CurOrgSYGridViewSearchFormHandler()  {
        super();
    }
