...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_YYSSQMainGridModel;
...
/**
 * 应用视图[OA_YYSSQYYSSQ_W20_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_YYSSQYYSSQ_W20_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_YYSSQMainGridModel gridModel = null;
    public OA_YYSSQYYSSQ_W20_WFGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_YYSSQMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_YYSSQMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_YYSSQ entity)throws Exception {
