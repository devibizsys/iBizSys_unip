...
import com.sa.unip.app.srv.ywsp.ctrlmodel.OA_STWMDGMainGridModel;
...
/**
 * 应用视图[OA_STWMDGSTWMDGLC_W20_WFGridView]表格[grid]后台处理对象基类
 */
public class OA_STWMDGSTWMDGLC_W20_WFGridViewGridHandler extends net.ibizsys.pswf.ctrlhandler.WFGridHandlerBase {

    protected OA_STWMDGMainGridModel gridModel = null;
    public OA_STWMDGSTWMDGLC_W20_WFGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_STWMDGMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_STWMDGMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_STWMDG entity)throws Exception {
