...
/**
 * 视图[OA_GZRZRZTJLC_WFExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/Angular/gzl/OA_GZRZRZTJLC_WFExpView.do")
public class OA_GZRZRZTJLC_WFExpViewController extends net.ibizsys.pswf.controller.WFExpViewControllerBase {
    public OA_GZRZRZTJLC_WFExpViewController() throws Exception {
        super();
        this.setId("acf0be08600e195e53ce18ab151bbf47");
        this.setCaption("工作日志");
        this.setTitle("工作日志工作流导航视图(日志提交流程)");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.EXPBAR","TRUE");

        ViewControllerGlobal.registerViewController("/Angular/gzl/OA_GZRZRZTJLC_WFExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.gzl.controller.OA_GZRZRZTJLC_WFExpViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 expbar
        ICtrlModel expBar=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.angular.srv.ywsp.ctrlmodel.OA_GZRZexpbarWFExpBarModel");
        expBar.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 expbar
        ICtrlHandler expBar = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_WFExpViewExpBarHandler");
        expBar.init(this);
