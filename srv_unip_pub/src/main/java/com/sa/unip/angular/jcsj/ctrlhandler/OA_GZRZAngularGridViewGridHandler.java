...
/**
 * 应用视图[OA_GZRZAngularGridView]表格[grid]后台处理对象基类
 */
public class OA_GZRZAngularGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_GZRZMainGridModel gridModel = null;
    public OA_GZRZAngularGridViewGridHandler()  {
        super();
    }
