 ...
 */
@Controller
@RequestMapping(value = "/Angular/gzl/OA_GZRZRZTJLC_D_WFEditView3.do")
public class OA_GZRZRZTJLC_D_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_GZRZRZTJLC_D_WFEditView3Controller() throws Exception {
        super();
        this.setId("328cb68a95b1755c87098371d5dc25b9");
        ...
        ViewControllerGlobal.registerViewController("/Angular/gzl/OA_GZRZRZTJLC_D_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.gzl.controller.OA_GZRZRZTJLC_D_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_D_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_D_WFEditView3EditFormHandler");
        editForm.init(this);
