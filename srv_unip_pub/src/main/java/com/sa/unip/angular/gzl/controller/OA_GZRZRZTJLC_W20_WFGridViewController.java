 ...
 */
@Controller
@RequestMapping(value = "/Angular/gzl/OA_GZRZRZTJLC_W20_WFGridView.do")
public class OA_GZRZRZTJLC_W20_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_GZRZRZTJLC_W20_WFGridViewController() throws Exception {
        super();
        this.setId("f92644cee97bcf18d6053fa5f35cf61a");
        ...
        ViewControllerGlobal.registerViewController("/Angular/gzl/OA_GZRZRZTJLC_W20_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.gzl.controller.OA_GZRZRZTJLC_W20_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_W20_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_W20_WFGridViewSearchFormHandler");
        searchForm.init(this);
