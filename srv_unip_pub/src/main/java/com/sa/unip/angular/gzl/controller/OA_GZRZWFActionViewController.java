...
/**
 * 视图[OA_GZRZWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/Angular/gzl/OA_GZRZWFActionView.do")
public class OA_GZRZWFActionViewController extends net.ibizsys.pswf.controller.WFActionViewControllerBase {
    public OA_GZRZWFActionViewController() throws Exception {
        super();
        this.setId("dba6d07761715379de84dddf685df9ae");
        ...
        ViewControllerGlobal.registerViewController("/Angular/gzl/OA_GZRZWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.gzl.controller.OA_GZRZWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.angular.srv.ywsp.ctrlmodel.OA_GZRZSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZWFActionViewEditFormHandler");
        editForm.init(this);
