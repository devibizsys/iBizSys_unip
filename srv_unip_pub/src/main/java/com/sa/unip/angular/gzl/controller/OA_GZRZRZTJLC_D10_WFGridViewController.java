 ...
 */
@Controller
@RequestMapping(value = "/Angular/gzl/OA_GZRZRZTJLC_D10_WFGridView.do")
public class OA_GZRZRZTJLC_D10_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_GZRZRZTJLC_D10_WFGridViewController() throws Exception {
        super();
        this.setId("46e6959105654091d6543d836dd0f5ea");
        ...
        ViewControllerGlobal.registerViewController("/Angular/gzl/OA_GZRZRZTJLC_D10_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.gzl.controller.OA_GZRZRZTJLC_D10_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_D10_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_D10_WFGridViewSearchFormHandler");
        searchForm.init(this);
