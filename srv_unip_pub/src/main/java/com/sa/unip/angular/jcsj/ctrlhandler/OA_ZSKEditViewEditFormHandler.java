...
import com.sa.unip.angular.srv.jcsj.ctrlmodel.OA_ZSKMainEditFormModel;
...
public class OA_ZSKEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.angular.srv.jcsj.ctrlhandler.OA_ZSKMainEditFormOrgsectornameHandler");
