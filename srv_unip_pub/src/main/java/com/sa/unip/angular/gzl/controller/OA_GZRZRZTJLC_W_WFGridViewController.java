 ...
 */
@Controller
@RequestMapping(value = "/Angular/gzl/OA_GZRZRZTJLC_W_WFGridView.do")
public class OA_GZRZRZTJLC_W_WFGridViewController extends net.ibizsys.pswf.controller.WFGridViewControllerBase {
    public OA_GZRZRZTJLC_W_WFGridViewController() throws Exception {
        super();
        this.setId("037cefb737718849113b16b0ac3c30fc");
        ...
        ViewControllerGlobal.registerViewController("/Angular/gzl/OA_GZRZRZTJLC_W_WFGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.gzl.controller.OA_GZRZRZTJLC_W_WFGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_W_WFGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_W_WFGridViewSearchFormHandler");
        searchForm.init(this);
