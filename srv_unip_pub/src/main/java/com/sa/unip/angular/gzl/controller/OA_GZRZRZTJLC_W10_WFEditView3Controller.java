...
/**
 * 视图[OA_GZRZRZTJLC_W10_WFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/Angular/gzl/OA_GZRZRZTJLC_W10_WFEditView3.do")
public class OA_GZRZRZTJLC_W10_WFEditView3Controller extends net.ibizsys.pswf.controller.WFEditView3ControllerBase {
    public OA_GZRZRZTJLC_W10_WFEditView3Controller() throws Exception {
        super();
        this.setId("ec9aa96a241e4747a993f7b11f03be84");
        this.setCaption("工作日志");
        this.setTitle("工作日志工作流视图(日志提交流程v1:部门领导审核)");
        ...
        ViewControllerGlobal.registerViewController("/Angular/gzl/OA_GZRZRZTJLC_W10_WFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.gzl.controller.OA_GZRZRZTJLC_W10_WFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 drtab
        ICtrlModel drTab=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.angular.srv.ywsp.ctrlmodel.OA_GZRZRZTJLCDRDRTabModel");
        drTab.init(this);
        this.registerCtrlModel("drtab",drTab);
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.angular.srv.ywsp.ctrlmodel.OA_GZRZMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_W10_WFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.gzl.ctrlhandler.OA_GZRZRZTJLC_W10_WFEditView3EditFormHandler");
        editForm.init(this);
