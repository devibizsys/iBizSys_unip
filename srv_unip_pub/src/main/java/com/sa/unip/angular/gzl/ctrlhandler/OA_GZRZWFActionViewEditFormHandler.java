...
import com.sa.unip.angular.srv.ywsp.ctrlmodel.OA_GZRZSHYJFormEditFormModel;
...
public class OA_GZRZWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_GZRZSHYJFormEditFormModel editformModel = null;
    public OA_GZRZWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_GZRZSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_GZRZSHYJFormEditFormModel getRealEditFormModel() {
