...
/**
 * 视图[OA_GZRZAngularGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/Angular/jcsj/OA_GZRZAngularGridView.do")
public class OA_GZRZAngularGridViewController extends net.ibizsys.paas.controller.GridViewControllerBase {
    public OA_GZRZAngularGridViewController() throws Exception {
        super();
        this.setId("6b7cbb8c8bb54fc01987d8245c96478e");
        ...
        ViewControllerGlobal.registerViewController("/Angular/jcsj/OA_GZRZAngularGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.jcsj.controller.OA_GZRZAngularGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.jcsj.ctrlhandler.OA_GZRZAngularGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.jcsj.ctrlhandler.OA_GZRZAngularGridViewSearchFormHandler");
        searchForm.init(this);
