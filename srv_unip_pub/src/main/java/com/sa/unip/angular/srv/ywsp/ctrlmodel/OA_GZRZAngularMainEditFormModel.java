 ...
 */
public class OA_GZRZAngularMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_GZRZAngularMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // oa_gzrzname
        iFormItem = this.createFormItem("oa_gzrzname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_gzrzname");
            formItem.setDEFName("OA_GZRZNAME");
            formItem.setCaption("工作日志名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_GZRZNAME");
        ...
        this.registerFormItem(iFormItem);
        // rzlx
        iFormItem = this.createFormItem("rzlx");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("rzlx");
        ...
        this.registerFormItem(iFormItem);
        // password
        iFormItem = this.createFormItem("password");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("password");
            formItem.setDEFName("");
            formItem.setCaption("密码框");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("password");
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
        ...
        this.registerFormItem(iFormItem);
        // mulselect
        iFormItem = this.createFormItem("mulselect");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("mulselect");
            formItem.setDEFName("");
            formItem.setCodeListId("com.sa.unip.srv.subsys.codelist.CL_MYWORKTYPECodeListModel");
            formItem.setCaption("选项框列表");
            formItem.setOutputCodeListConfig(true);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("mulselect");
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
