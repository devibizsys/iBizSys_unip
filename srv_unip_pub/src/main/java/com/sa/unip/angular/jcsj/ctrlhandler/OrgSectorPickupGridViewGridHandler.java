...
import com.sa.unip.angular.srv.common.ctrlmodel.OrgSectorMain2GridModel;
...
/**
 * 应用视图[OrgSectorPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgSectorPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgSectorMain2GridModel gridModel = null;
    public OrgSectorPickupGridViewGridHandler()  {
        super();
    }
