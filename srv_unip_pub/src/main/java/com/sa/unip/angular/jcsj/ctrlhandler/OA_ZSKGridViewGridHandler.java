...
import com.sa.unip.angular.srv.jcsj.ctrlmodel.OA_ZSKMainGridModel;
...
/**
 * 应用视图[OA_ZSKGridView]表格[grid]后台处理对象基类
 */
public class OA_ZSKGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OA_ZSKMainGridModel gridModel = null;
    public OA_ZSKGridViewGridHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        gridModel = (OA_ZSKMainGridModel)this.getViewController().getCtrlModel("grid");
        super.onInit();
     ...
     * @return
     */
    protected OA_ZSKMainGridModel getRealGridModel() {
    ...
    * 准备部件操作数据访问能力
     ...
     * @throws Exception
     */
    protected void getDraftEntity(OA_ZSK entity)throws Exception {
