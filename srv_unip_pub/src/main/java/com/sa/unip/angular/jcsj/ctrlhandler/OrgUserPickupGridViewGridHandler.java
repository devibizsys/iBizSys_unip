...
import com.sa.unip.angular.srv.common.ctrlmodel.OrgUserMain2GridModel;
...
/**
 * 应用视图[OrgUserPickupGridView]表格[grid]后台处理对象基类
 */
public class OrgUserPickupGridViewGridHandler extends net.ibizsys.paas.ctrlhandler.GridHandlerBase {

    protected OrgUserMain2GridModel gridModel = null;
    public OrgUserPickupGridViewGridHandler()  {
        super();
    }
