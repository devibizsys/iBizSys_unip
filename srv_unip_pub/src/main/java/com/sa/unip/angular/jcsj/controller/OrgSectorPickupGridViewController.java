...
/**
 * 视图[OrgSectorPickupGridView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/Angular/jcsj/OrgSectorPickupGridView.do")
public class OrgSectorPickupGridViewController extends net.ibizsys.paas.controller.PickupGridViewControllerBase {
    public OrgSectorPickupGridViewController() throws Exception {
        super();
        this.setId("1c361bfbe724397459229c74e442951e");
        this.setCaption("组织部门");
        this.setTitle("组织部门实体选择表格视图");
        ...
        ViewControllerGlobal.registerViewController("/Angular/jcsj/OrgSectorPickupGridView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.angular.jcsj.controller.OrgSectorPickupGridViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 grid
        ICtrlModel grid=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.angular.srv.common.ctrlmodel.OrgSectorMain2GridModel");
        grid.init(this);
        this.registerCtrlModel("grid",grid);
        //注册 searchform
        ICtrlModel searchForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.angular.srv.common.ctrlmodel.OrgSectorDefaultSearchFormModel");
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 grid
        ICtrlHandler grid = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.jcsj.ctrlhandler.OrgSectorPickupGridViewGridHandler");
        grid.init(this);
        this.registerCtrlHandler("grid",grid);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.angular.jcsj.ctrlhandler.OrgSectorPickupGridViewSearchFormHandler");
        searchForm.init(this);
