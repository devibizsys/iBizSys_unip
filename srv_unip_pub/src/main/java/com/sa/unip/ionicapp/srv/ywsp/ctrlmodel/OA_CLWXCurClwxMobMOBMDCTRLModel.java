...
/**
 * 实体[车辆维修]移动端数据列表[mdctrl]部件模型
 */
public class  OA_CLWXCurClwxMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_CLWXCurClwxMobMOBMDCTRLModel()  {
        super();
