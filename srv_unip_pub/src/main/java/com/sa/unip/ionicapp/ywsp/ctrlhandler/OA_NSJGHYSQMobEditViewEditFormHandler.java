...
public class OA_NSJGHYSQMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_NSJGHYSQMobMainEditFormModel editformModel = null;
    public OA_NSJGHYSQMobEditViewEditFormHandler()  {
        super();
    }
