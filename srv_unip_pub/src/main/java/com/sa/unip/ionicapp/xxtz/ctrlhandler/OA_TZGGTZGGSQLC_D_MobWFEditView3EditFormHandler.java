...
import com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_TZGGMobMainEditFormModel;
...
public class OA_TZGGTZGGSQLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_TZGGMobMainEditFormModel editformModel = null;
    public OA_TZGGTZGGSQLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_TZGGMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_TZGGMobMainEditFormModel getRealEditFormModel() {
