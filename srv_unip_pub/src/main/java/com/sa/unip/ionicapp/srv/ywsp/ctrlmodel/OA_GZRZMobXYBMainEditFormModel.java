 ...
 */
public class OA_GZRZMobXYBMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_GZRZMobXYBMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // bygzcx
        iFormItem = this.createFormItem("bygzcx");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("bygzcx");
            formItem.setDEFName("BYGZCX");
            formItem.setCaption("本月工作成效");
            formItem.setCapLanResTag("DEF.LNAME.JRGZCX");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("bygzcx");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
