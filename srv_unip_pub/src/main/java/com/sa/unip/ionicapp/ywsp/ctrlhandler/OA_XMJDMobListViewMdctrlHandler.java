...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_XMJDMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_XMJDMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_XMJDMobMOBMDCTRLModel listModel = null;
    public OA_XMJDMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_XMJDMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_XMJDMobMOBMDCTRLModel getRealListModel() {
