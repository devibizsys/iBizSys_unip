...
/**
 * 视图[OA_CLWXSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_CLWXSHJSMobEditView.do")
public class OA_CLWXSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CLWXSHJSMobEditViewController() throws Exception {
        super();
        this.setId("6ebb879abc734226a3101a7cb153a25f");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_CLWXSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_CLWXSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_CLWXSHJSMobEditViewEditFormHandler");
        editForm.init(this);
