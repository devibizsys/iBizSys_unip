...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMobXZBMainEditFormModel;
...
public class OA_GZRZRZTJLC_D_XZBMobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_GZRZMobXZBMainEditFormModel editformModel = null;
    public OA_GZRZRZTJLC_D_XZBMobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_GZRZMobXZBMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_GZRZMobXZBMainEditFormModel getRealEditFormModel() {
