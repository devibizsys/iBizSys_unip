...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_YBHYSQMobPickupListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_YBHYSQMobMOBMDCTRLModel listModel = null;
    public OA_YBHYSQMobPickupListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_YBHYSQMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_YBHYSQMobMOBMDCTRLModel getRealListModel() {
