 ...
 * 列表控件后台处理基类
 */
public class OA_YCSQYCSQLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_YCSQMobMOBMDCTRLModel listModel = null;
    public OA_YCSQYCSQLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
