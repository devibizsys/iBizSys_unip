...
/**
 * 视图[OA_YBHYSQYBHYMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YBHYSQYBHYMobEditView.do")
public class OA_YBHYSQYBHYMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_YBHYSQYBHYMobEditViewController() throws Exception {
        super();
        this.setId("fc1a01060cfe6b5f03450f4f4289bbc3");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YBHYSQYBHYMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YBHYSQYBHYMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YBHYSQYBHYMobEditViewEditFormHandler");
        editForm.init(this);
