...
public class OA_SBWXSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_SBWXWFMobMainEditFormModel editformModel = null;
    public OA_SBWXSHJSMobEditViewEditFormHandler()  {
        super();
    }
