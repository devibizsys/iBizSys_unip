...
/**
 * 视图[OA_TZGGTZGGSQLC_D_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/xxtz/OA_TZGGTZGGSQLC_D_MobWFEditView3.do")
public class OA_TZGGTZGGSQLC_D_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_TZGGTZGGSQLC_D_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("b0b3157b84762b3bc5b93fa789e0b997");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/xxtz/OA_TZGGTZGGSQLC_D_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.xxtz.controller.OA_TZGGTZGGSQLC_D_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_TZGGMobMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.xxtz.ctrlhandler.OA_TZGGTZGGSQLC_D_MobWFEditView3EditFormHandler");
        editForm.init(this);
