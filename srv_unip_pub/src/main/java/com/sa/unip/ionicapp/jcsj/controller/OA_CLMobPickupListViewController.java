...
/**
 * 视图[OA_CLMobPickupListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/jcsj/OA_CLMobPickupListView.do")
public class OA_CLMobPickupListViewController extends net.ibizsys.paas.controller.MobPickupListViewControllerBase {
    public OA_CLMobPickupListViewController() throws Exception {
        super();
        this.setId("e85f110b78ed300af3301e41c054ae06");
        this.setCaption("车辆");
        this.setTitle("车辆选择");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/jcsj/OA_CLMobPickupListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.jcsj.controller.OA_CLMobPickupListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.jcsj.ctrlmodel.OA_CLMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.jcsj.ctrlhandler.OA_CLMobPickupListViewMdctrlHandler");
        mdctrl.init(this);
