...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CHRYMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_CHRYCKCHRYMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CHRYMobMOBMDCTRLModel listModel = null;
    public OA_CHRYCKCHRYMobListViewMdctrlHandler()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setMinorSortField("CHSJ");
        this.setMinorSortDir("DESC");
        listModel = (OA_CHRYMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_CHRYMobMOBMDCTRLModel getRealListModel() {
