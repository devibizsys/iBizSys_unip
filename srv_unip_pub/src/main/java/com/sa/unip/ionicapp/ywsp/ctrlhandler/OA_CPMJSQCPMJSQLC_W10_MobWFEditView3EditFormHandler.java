...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CPMJSQMobWFFormEditFormModel;
...
public class OA_CPMJSQCPMJSQLC_W10_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CPMJSQMobWFFormEditFormModel editformModel = null;
    public OA_CPMJSQCPMJSQLC_W10_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CPMJSQMobWFFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CPMJSQMobWFFormEditFormModel getRealEditFormModel() {
