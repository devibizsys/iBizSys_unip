...
/**
 * 视图[OA_CCSQMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CCSQMobEditView.do")
public class OA_CCSQMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CCSQMobEditViewController() throws Exception {
        super();
        this.setId("5bfcb98726b3ea3cdcb3d5facff065cb");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CCSQMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CCSQMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CCSQMobEditViewEditFormHandler");
        editForm.init(this);
