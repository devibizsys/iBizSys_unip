...
/**
 * 视图[OA_HYSMobPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/jcsj/OA_HYSMobPickupView.do")
public class OA_HYSMobPickupViewController extends net.ibizsys.paas.controller.MobPickupViewControllerBase {
    public OA_HYSMobPickupViewController() throws Exception {
        super();
        this.setId("aaaf54bb6b603d5de57113dac8fb1de4");
        this.setCaption("会议室");
        this.setTitle("会议室");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/jcsj/OA_HYSMobPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.jcsj.controller.OA_HYSMobPickupViewController",this);
    }
