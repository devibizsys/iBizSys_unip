...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQSHYJMobFormEditFormModel;
...
public class OA_YBHYSQSHYJMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_YBHYSQSHYJMobFormEditFormModel editformModel = null;
    public OA_YBHYSQSHYJMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YBHYSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YBHYSQSHYJMobFormEditFormModel getRealEditFormModel() {
