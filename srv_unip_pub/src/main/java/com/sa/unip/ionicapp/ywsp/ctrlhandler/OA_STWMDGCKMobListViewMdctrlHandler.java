...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_STWMDGCurStwmdgMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_STWMDGCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_STWMDGCurStwmdgMobMOBMDCTRLModel listModel = null;
    public OA_STWMDGCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_STWMDGCurStwmdgMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_STWMDGCurStwmdgMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurStwmdg(deDataSetFetchContext);
    }
