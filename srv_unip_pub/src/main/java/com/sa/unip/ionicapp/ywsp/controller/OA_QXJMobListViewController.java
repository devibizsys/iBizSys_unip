...
/**
 * 视图[OA_QXJMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_QXJMobListView.do")
public class OA_QXJMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_QXJMobListViewController() throws Exception {
        super();
        this.setId("e352716f8f57a96d715dc70a4f482b6e");
        this.setCaption("请休假");
        this.setTitle("请假");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_QXJMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_QXJMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_QXJMobListViewMdctrlHandler");
        mdctrl.init(this);
