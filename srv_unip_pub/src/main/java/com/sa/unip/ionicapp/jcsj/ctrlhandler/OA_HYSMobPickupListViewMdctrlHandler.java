...
import com.sa.unip.ionicapp.srv.jcsj.ctrlmodel.OA_HYSMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_HYSMobPickupListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_HYSMobMOBMDCTRLModel listModel = null;
    public OA_HYSMobPickupListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_HYSMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_HYSMobMOBMDCTRLModel getRealListModel() {
