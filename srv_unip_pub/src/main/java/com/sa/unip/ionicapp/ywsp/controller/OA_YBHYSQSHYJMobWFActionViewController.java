...
/**
 * 视图[OA_YBHYSQSHYJMobWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YBHYSQSHYJMobWFActionView.do")
public class OA_YBHYSQSHYJMobWFActionViewController extends net.ibizsys.pswf.controller.MobWFActionViewControllerBase {
    public OA_YBHYSQSHYJMobWFActionViewController() throws Exception {
        super();
        this.setId("8b735ba25ad96ec6de899cf06a009a58");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YBHYSQSHYJMobWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YBHYSQSHYJMobWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQSHYJMobFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YBHYSQSHYJMobWFActionViewEditFormHandler");
        editForm.init(this);
