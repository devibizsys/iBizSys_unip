...
/**
 * 视图[OA_CPMJSQCKMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CPMJSQCKMobListView.do")
public class OA_CPMJSQCKMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CPMJSQCKMobListViewController() throws Exception {
        super();
        this.setId("fbedad69bb98a36641ccd4064f5d31b1");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CPMJSQCKMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CPMJSQCKMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CPMJSQCurCpmjsqMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CPMJSQCKMobListViewMdctrlHandler");
        mdctrl.init(this);
