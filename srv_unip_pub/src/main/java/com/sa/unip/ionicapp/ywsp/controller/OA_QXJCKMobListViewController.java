...
/**
 * 视图[OA_QXJCKMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_QXJCKMobListView.do")
public class OA_QXJCKMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_QXJCKMobListViewController() throws Exception {
        super();
        this.setId("a369b64ab3ceaed953a1de5eb594796a");
        this.setCaption("请休假");
        this.setTitle("请休假");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_QXJCKMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_QXJCKMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_QXJCurQxjMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_QXJCKMobListViewMdctrlHandler");
        mdctrl.init(this);
