 ...
 */
public class OA_RZRYMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_RZRYMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("TJRNAME");
            formItem.setCaption("提交人");
            formItem.setCapLanResTag("DEF.LNAME.TJRNAME");
