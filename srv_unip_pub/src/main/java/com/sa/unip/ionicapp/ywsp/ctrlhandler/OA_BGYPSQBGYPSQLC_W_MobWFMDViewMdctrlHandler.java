 ...
 * 列表控件后台处理基类
 */
public class OA_BGYPSQBGYPSQLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_BGYPSQMobMOBMDCTRLModel listModel = null;
    public OA_BGYPSQBGYPSQLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
