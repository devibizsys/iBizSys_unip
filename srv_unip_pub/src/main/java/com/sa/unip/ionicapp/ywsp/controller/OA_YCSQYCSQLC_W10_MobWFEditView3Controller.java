...
/**
 * 视图[OA_YCSQYCSQLC_W10_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YCSQYCSQLC_W10_MobWFEditView3.do")
public class OA_YCSQYCSQLC_W10_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_YCSQYCSQLC_W10_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("16b4acc1033158a52c96fdeba33aeb5c");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YCSQYCSQLC_W10_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YCSQYCSQLC_W10_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YCSQYCSQLC_W10_MobWFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YCSQYCSQLC_W10_MobWFEditView3EditFormHandler");
        editForm.init(this);
