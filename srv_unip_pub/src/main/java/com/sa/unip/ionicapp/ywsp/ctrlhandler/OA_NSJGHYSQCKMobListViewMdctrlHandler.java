...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_NSJGHYSQCurNsjghysqMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_NSJGHYSQCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_NSJGHYSQCurNsjghysqMobMOBMDCTRLModel listModel = null;
    public OA_NSJGHYSQCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_NSJGHYSQCurNsjghysqMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_NSJGHYSQCurNsjghysqMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurNsjghysq(deDataSetFetchContext);
    }
