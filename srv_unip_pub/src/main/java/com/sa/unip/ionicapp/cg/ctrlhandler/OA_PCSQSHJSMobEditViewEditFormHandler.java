...
public class OA_PCSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_PCSQMobWFFormEditFormModel editformModel = null;
    public OA_PCSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
