...
public class demoDEMOLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected DemoMOBFormEditFormModel editformModel = null;
    public demoDEMOLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
