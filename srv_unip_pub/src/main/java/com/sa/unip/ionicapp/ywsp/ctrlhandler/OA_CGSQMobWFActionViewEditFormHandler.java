...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CGSQSHYJMobFormEditFormModel;
...
public class OA_CGSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_CGSQSHYJMobFormEditFormModel editformModel = null;
    public OA_CGSQMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CGSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CGSQSHYJMobFormEditFormModel getRealEditFormModel() {
