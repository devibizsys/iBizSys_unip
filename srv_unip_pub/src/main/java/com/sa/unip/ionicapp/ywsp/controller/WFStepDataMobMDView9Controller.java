...
/**
 * 视图[WFStepDataMobMDView9]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/WFStepDataMobMDView9.do")
public class WFStepDataMobMDView9Controller extends net.ibizsys.paas.controller.MobMDView9ControllerBase {
    public WFStepDataMobMDView9Controller() throws Exception {
        super();
        this.setId("56640082950f5ff274d22478180f0b65");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/WFStepDataMobMDView9.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.WFStepDataMobMDView9Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.WFStepDataMobMDView9MdctrlHandler");
        mdctrl.init(this);
