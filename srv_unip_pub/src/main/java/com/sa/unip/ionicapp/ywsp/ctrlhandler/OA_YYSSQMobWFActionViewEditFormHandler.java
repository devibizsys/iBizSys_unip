...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YYSSQSHYJMobFormEditFormModel;
...
public class OA_YYSSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_YYSSQSHYJMobFormEditFormModel editformModel = null;
    public OA_YYSSQMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YYSSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YYSSQSHYJMobFormEditFormModel getRealEditFormModel() {
