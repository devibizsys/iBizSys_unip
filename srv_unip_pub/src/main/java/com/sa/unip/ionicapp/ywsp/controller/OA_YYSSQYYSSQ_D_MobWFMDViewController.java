...
/**
 * 视图[OA_YYSSQYYSSQ_D_MobWFMDView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YYSSQYYSSQ_D_MobWFMDView.do")
public class OA_YYSSQYYSSQ_D_MobWFMDViewController extends net.ibizsys.pswf.controller.MobWFMDViewControllerBase {
    public OA_YYSSQYYSSQ_D_MobWFMDViewController() throws Exception {
        super();
        this.setId("79c92bf867e8105dac6811f0122d79bb");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YYSSQYYSSQ_D_MobWFMDView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YYSSQYYSSQ_D_MobWFMDViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YYSSQYYSSQ_D_MobWFMDViewMdctrlHandler");
        mdctrl.init(this);
