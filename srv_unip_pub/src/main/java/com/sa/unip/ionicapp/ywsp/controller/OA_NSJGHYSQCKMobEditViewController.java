...
/**
 * 视图[OA_NSJGHYSQCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_NSJGHYSQCKMobEditView.do")
public class OA_NSJGHYSQCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_NSJGHYSQCKMobEditViewController() throws Exception {
        super();
        this.setId("ac125cee10eddb38c79eca3f6c200753");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_NSJGHYSQCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_NSJGHYSQCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_NSJGHYSQCKMobEditViewEditFormHandler");
        editForm.init(this);
