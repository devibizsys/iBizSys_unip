...
/**
 * 视图[OA_CGSQMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CGSQMobListView.do")
public class OA_CGSQMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CGSQMobListViewController() throws Exception {
        super();
        this.setId("d0d07bf3c39c4106ecc328b6531b755e");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CGSQMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CGSQMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CGSQMobListViewMdctrlHandler");
        mdctrl.init(this);
