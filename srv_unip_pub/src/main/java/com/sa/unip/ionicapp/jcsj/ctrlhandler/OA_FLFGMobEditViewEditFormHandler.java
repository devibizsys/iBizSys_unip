...
import com.sa.unip.ionicapp.srv.jcsj.ctrlmodel.OA_FLFGMobMainEditFormModel;
...
public class OA_FLFGMobEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OA_FLFGMobMainEditFormModel editformModel = null;
    public OA_FLFGMobEditViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_FLFGMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_FLFGMobMainEditFormModel getRealEditFormModel() {
