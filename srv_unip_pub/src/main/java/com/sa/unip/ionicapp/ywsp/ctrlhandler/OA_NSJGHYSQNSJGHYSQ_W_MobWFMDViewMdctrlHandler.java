 ...
 * 列表控件后台处理基类
 */
public class OA_NSJGHYSQNSJGHYSQ_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_NSJGHYSQMobMOBMDCTRLModel listModel = null;
    public OA_NSJGHYSQNSJGHYSQ_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
