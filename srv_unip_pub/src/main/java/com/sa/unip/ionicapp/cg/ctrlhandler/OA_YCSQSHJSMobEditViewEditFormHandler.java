...
public class OA_YCSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YCSQMobWFFormEditFormModel editformModel = null;
    public OA_YCSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
