...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_SBWXSHYJMobFormEditFormModel;
...
public class OA_SBWXMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_SBWXSHYJMobFormEditFormModel editformModel = null;
    public OA_SBWXMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_SBWXSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_SBWXSHYJMobFormEditFormModel getRealEditFormModel() {
