...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YYSSQMobMainEditFormModel;
...
public class OA_YYSSQYYSSQ_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YYSSQMobMainEditFormModel editformModel = null;
    public OA_YYSSQYYSSQ_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YYSSQMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YYSSQMobMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_YYSSQMobMainEditFormOrgsectornameHandler");
