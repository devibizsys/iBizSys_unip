...
/**
 * 视图[OA_YBHYSQMobPickupListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YBHYSQMobPickupListView.do")
public class OA_YBHYSQMobPickupListViewController extends net.ibizsys.paas.controller.MobPickupListViewControllerBase {
    public OA_YBHYSQMobPickupListViewController() throws Exception {
        super();
        this.setId("fad9969d075bf3d97987cec314533d06");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YBHYSQMobPickupListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YBHYSQMobPickupListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YBHYSQMobPickupListViewMdctrlHandler");
        mdctrl.init(this);
