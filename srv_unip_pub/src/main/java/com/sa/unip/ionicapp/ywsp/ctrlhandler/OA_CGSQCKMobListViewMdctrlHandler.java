...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CGSQCurCgsqMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_CGSQCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CGSQCurCgsqMobMOBMDCTRLModel listModel = null;
    public OA_CGSQCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_CGSQCurCgsqMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_CGSQCurCgsqMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurCgsq(deDataSetFetchContext);
    }
