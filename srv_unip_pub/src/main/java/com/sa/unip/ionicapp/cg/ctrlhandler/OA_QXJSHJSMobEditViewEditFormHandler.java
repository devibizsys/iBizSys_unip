...
public class OA_QXJSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_QXJMobWFFormEditFormModel editformModel = null;
    public OA_QXJSHJSMobEditViewEditFormHandler()  {
        super();
    }
