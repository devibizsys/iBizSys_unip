...
public class OA_CGSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CGSQWFMobMainEditFormModel editformModel = null;
    public OA_CGSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
