 ...
 * 列表控件后台处理基类
 */
public class OA_SBWXSBWXLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_SBWXMobMOBMDCTRLModel listModel = null;
    public OA_SBWXSBWXLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
