...
/**
 * 视图[OA_BGYPSQSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_BGYPSQSHJSMobEditView.do")
public class OA_BGYPSQSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_BGYPSQSHJSMobEditViewController() throws Exception {
        super();
        this.setId("302c8a812a475149749087bc8899ba81");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_BGYPSQSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_BGYPSQSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_BGYPSQSHJSMobEditViewEditFormHandler");
        editForm.init(this);
