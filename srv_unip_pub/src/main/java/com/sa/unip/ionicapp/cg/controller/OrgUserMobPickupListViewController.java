...
/**
 * 视图[OrgUserMobPickupListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OrgUserMobPickupListView.do")
public class OrgUserMobPickupListViewController extends net.ibizsys.paas.controller.MobPickupListViewControllerBase {
    public OrgUserMobPickupListViewController() throws Exception {
        super();
        this.setId("96d60b8bef953dad5616a6cea8307095");
        this.setCaption("组织人员");
        this.setTitle("组织人员选择");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.MDCTRL","TRUE");

        ViewControllerGlobal.registerViewController("/IonicApp/cg/OrgUserMobPickupListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OrgUserMobPickupListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.common.ctrlmodel.OrgUserMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OrgUserMobPickupListViewMdctrlHandler");
        mdctrl.init(this);
