...
public class OA_CLWXMobMainEditFormOa_clnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OA_CLWXMobMainEditFormOa_clnameHandler()  {
        super();
    }
