...
import com.sa.unip.ionicapp.srv.wf.ctrlmodel.WFWorkListDSPMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class WFWorkListDSPMobMDView9MdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected WFWorkListDSPMobMOBMDCTRLModel listModel = null;
    public WFWorkListDSPMobMDView9MdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (WFWorkListDSPMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected WFWorkListDSPMobMOBMDCTRLModel getRealListModel() {
