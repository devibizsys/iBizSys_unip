...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CPMJSQCurCpmjsqMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_CPMJSQCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CPMJSQCurCpmjsqMobMOBMDCTRLModel listModel = null;
    public OA_CPMJSQCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_CPMJSQCurCpmjsqMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_CPMJSQCurCpmjsqMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurCpmjsq(deDataSetFetchContext);
    }
