...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CCSQCurCcsqMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_CCSQCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CCSQCurCcsqMobMOBMDCTRLModel listModel = null;
    public OA_CCSQCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_CCSQCurCcsqMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_CCSQCurCcsqMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurCcsq(deDataSetFetchContext);
    }
