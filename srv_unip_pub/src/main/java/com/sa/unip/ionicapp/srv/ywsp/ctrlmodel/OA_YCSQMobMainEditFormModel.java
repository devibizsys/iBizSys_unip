...
/**
 * 实体[用餐申请]编辑表单[form]部件模型
 */
public class OA_YCSQMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_YCSQMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_YCSQID");
            formItem.setCaption("用餐申请标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_YCSQID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_YCSQNAME");
            formItem.setCaption("用餐申请名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_YCSQNAME");
        ...
        this.registerFormItem(iFormItem);
        // djr
        iFormItem = this.createFormItem("djr");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("djr");
            formItem.setDEFName("DJR");
            formItem.setCaption("登记人");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("djr");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // lkdw
        iFormItem = this.createFormItem("lkdw");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("lkdw");
            formItem.setDEFName("LKDW");
            formItem.setCaption("来客单位");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("lkdw");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // ycsj
        iFormItem = this.createFormItem("ycsj");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("ycsj");
            formItem.setDEFName("YCSJ");
            formItem.setCaption("用餐时间");
            formItem.setAllowEmpty(false);
            formItem.setValueTranslator("DATE|YYYY-MM-DD HH:mm:ss");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("ycsj");
            dataItem.setDataType(5);
        ...
        this.registerFormItem(iFormItem);
        // djsj
        iFormItem = this.createFormItem("djsj");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("djsj");
            formItem.setDEFName("DJSJ");
            formItem.setCaption("登记时间");
            formItem.setAllowEmpty(false);
            formItem.setValueTranslator("DATE|YYYY-MM-DD HH:mm:ss");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("djsj");
            dataItem.setDataType(5);
            dataItem.setFormat("%1$tY-%1$tm-%1$td %1$tH:%1$tM");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // fhsj
        iFormItem = this.createFormItem("fhsj");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("fhsj");
            formItem.setDEFName("FHSJ");
            formItem.setCaption("返回时间");
            formItem.setAllowEmpty(false);
            formItem.setValueTranslator("DATE|YYYY-MM-DD HH:mm:ss");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("fhsj");
            dataItem.setDataType(5);
            dataItem.setFormat("%1$tY-%1$tm-%1$td %1$tH:%1$tM");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_ycsqid
        iFormItem = this.createFormItem("oa_ycsqid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_ycsqid");
            formItem.setDEFName("OA_YCSQID");
            formItem.setCaption("用餐申请标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_YCSQID");
