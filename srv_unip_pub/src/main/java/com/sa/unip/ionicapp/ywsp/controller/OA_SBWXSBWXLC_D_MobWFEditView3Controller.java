...
/**
 * 视图[OA_SBWXSBWXLC_D_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_SBWXSBWXLC_D_MobWFEditView3.do")
public class OA_SBWXSBWXLC_D_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_SBWXSBWXLC_D_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("8da2a533d7f0836154c866deec9f4c05");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_SBWXSBWXLC_D_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_SBWXSBWXLC_D_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_SBWXMobMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_SBWXSBWXLC_D_MobWFEditView3EditFormHandler");
        editForm.init(this);
