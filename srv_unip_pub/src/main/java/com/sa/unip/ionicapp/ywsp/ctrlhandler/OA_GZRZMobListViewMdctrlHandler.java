...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMyGzrzMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_GZRZMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_GZRZMyGzrzMOBMDCTRLModel listModel = null;
    public OA_GZRZMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_GZRZMyGzrzMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_GZRZMyGzrzMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchMyGzrz(deDataSetFetchContext);
    }
