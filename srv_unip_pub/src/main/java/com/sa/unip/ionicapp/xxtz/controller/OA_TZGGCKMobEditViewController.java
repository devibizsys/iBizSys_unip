...
/**
 * 视图[OA_TZGGCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/xxtz/OA_TZGGCKMobEditView.do")
public class OA_TZGGCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_TZGGCKMobEditViewController() throws Exception {
        super();
        this.setId("0c1038914f59228da3c271790091bf5b");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/xxtz/OA_TZGGCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.xxtz.controller.OA_TZGGCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.xxtz.ctrlhandler.OA_TZGGCKMobEditViewEditFormHandler");
        editForm.init(this);
