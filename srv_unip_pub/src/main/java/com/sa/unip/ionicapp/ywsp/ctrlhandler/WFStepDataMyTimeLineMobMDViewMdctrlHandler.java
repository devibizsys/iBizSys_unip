 ...
 * 列表控件后台处理基类
 */
public class WFStepDataMyTimeLineMobMDViewMdctrlHandler extends net.ibizsys.pswf.ctrlhandler.WFStepDataListHandlerBase {
    protected WFStepDataMyMobMOBMDCTRLModel listModel = null;
    public WFStepDataMyTimeLineMobMDViewMdctrlHandler()  {
        super();
    }
