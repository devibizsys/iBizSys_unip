...
/**
 * 视图[OA_CGSQCKMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CGSQCKMobListView.do")
public class OA_CGSQCKMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CGSQCKMobListViewController() throws Exception {
        super();
        this.setId("3ed0f1c3721e6813c32542a80bb0c3bc");
        this.setCaption("采购申请");
        this.setTitle("采购申请查看");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CGSQCKMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CGSQCKMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CGSQCurCgsqMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CGSQCKMobListViewMdctrlHandler");
        mdctrl.init(this);
