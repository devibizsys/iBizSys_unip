...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQMobWFListMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_YBHYSQYBHYSQ_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_YBHYSQMobWFListMOBMDCTRLModel listModel = null;
    public OA_YBHYSQYBHYSQ_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_YBHYSQMobWFListMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_YBHYSQMobWFListMOBMDCTRLModel getRealListModel() {
