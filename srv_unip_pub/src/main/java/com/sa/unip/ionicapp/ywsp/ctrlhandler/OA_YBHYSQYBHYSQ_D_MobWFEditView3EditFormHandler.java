...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQMobHYMainEditFormModel;
...
public class OA_YBHYSQYBHYSQ_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YBHYSQMobHYMainEditFormModel editformModel = null;
    public OA_YBHYSQYBHYSQ_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YBHYSQMobHYMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YBHYSQMobHYMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_YBHYSQMobHYMainEditFormOrgsectornameHandler");
        ...
        //注册 'oa_hysname'
        IFormItemHandler oa_hysnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_YBHYSQMobHYMainEditFormOa_hysnameHandler");
