...
/**
 * 视图[OrgSectorMobPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OrgSectorMobPickupView.do")
public class OrgSectorMobPickupViewController extends net.ibizsys.paas.controller.MobPickupViewControllerBase {
    public OrgSectorMobPickupViewController() throws Exception {
        super();
        this.setId("1cf26ee740a191d23618d299629d1eeb");
        this.setCaption("组织部门");
        this.setTitle("组织部门选择");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.PICKUPVIEWPANEL","TRUE");

        ViewControllerGlobal.registerViewController("/IonicApp/cg/OrgSectorMobPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OrgSectorMobPickupViewController",this);
    }
