...
/**
 * 视图[WFWorkListDSPMobMDView9]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/WFWorkListDSPMobMDView9.do")
public class WFWorkListDSPMobMDView9Controller extends net.ibizsys.paas.controller.MobMDView9ControllerBase {
    public WFWorkListDSPMobMDView9Controller() throws Exception {
        super();
        this.setId("a2c0df83d7cf6cc3c62a838b1d633578");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/WFWorkListDSPMobMDView9.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.WFWorkListDSPMobMDView9Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.wf.ctrlmodel.WFWorkListDSPMobMOBMDCTRLModel");
        mdctrl.init(this);
        this.registerCtrlModel("mdctrl",mdctrl);
        //注册 searchform
        ICtrlModel searchForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.wf.ctrlmodel.WFWorkListMobSearchFormSearchFormModel");
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.WFWorkListDSPMobMDView9MdctrlHandler");
        mdctrl.init(this);
        this.registerCtrlHandler("mdctrl",mdctrl);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.WFWorkListDSPMobMDView9SearchFormHandler");
        searchForm.init(this);
