...
/**
 * 视图[OA_JPYDMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_JPYDMobListView.do")
public class OA_JPYDMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_JPYDMobListViewController() throws Exception {
        super();
        this.setId("f4c2dfef9b1e036980dcb3429a82cef9");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_JPYDMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_JPYDMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_JPYDMobListViewMdctrlHandler");
        mdctrl.init(this);
