...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_BGYPSQSHYJMobFormEditFormModel;
...
public class OA_BGYPSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_BGYPSQSHYJMobFormEditFormModel editformModel = null;
    public OA_BGYPSQMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_BGYPSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_BGYPSQSHYJMobFormEditFormModel getRealEditFormModel() {
