...
/**
 * 视图[OA_JPYDSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_JPYDSHJSMobEditView.do")
public class OA_JPYDSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_JPYDSHJSMobEditViewController() throws Exception {
        super();
        this.setId("7694aa11aa6c1919e5720105d023f255");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_JPYDSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_JPYDSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_JPYDSHJSMobEditViewEditFormHandler");
        editForm.init(this);
