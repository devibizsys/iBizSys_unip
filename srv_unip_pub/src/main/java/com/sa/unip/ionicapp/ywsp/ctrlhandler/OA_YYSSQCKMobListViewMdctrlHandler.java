...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YYSSQCurYyssqMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_YYSSQCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_YYSSQCurYyssqMobMOBMDCTRLModel listModel = null;
    public OA_YYSSQCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_YYSSQCurYyssqMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_YYSSQCurYyssqMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurYyssq(deDataSetFetchContext);
    }
