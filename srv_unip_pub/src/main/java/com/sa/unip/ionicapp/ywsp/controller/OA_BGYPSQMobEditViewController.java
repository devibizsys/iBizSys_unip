...
/**
 * 视图[OA_BGYPSQMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_BGYPSQMobEditView.do")
public class OA_BGYPSQMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_BGYPSQMobEditViewController() throws Exception {
        super();
        this.setId("361b1a40bda1e3570864a37df1c7442f");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_BGYPSQMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_BGYPSQMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_BGYPSQMobEditViewEditFormHandler");
        editForm.init(this);
