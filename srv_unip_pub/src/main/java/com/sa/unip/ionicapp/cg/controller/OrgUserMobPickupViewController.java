...
/**
 * 视图[OrgUserMobPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OrgUserMobPickupView.do")
public class OrgUserMobPickupViewController extends net.ibizsys.paas.controller.MobPickupViewControllerBase {
    public OrgUserMobPickupViewController() throws Exception {
        super();
        this.setId("aec1ca25c156cfdc651ad0215d68abc9");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OrgUserMobPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OrgUserMobPickupViewController",this);
    }
