...
/**
 * 视图[OA_GZRZRZTJLC_D_XZBMobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZRZTJLC_D_XZBMobWFEditView3.do")
public class OA_GZRZRZTJLC_D_XZBMobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_GZRZRZTJLC_D_XZBMobWFEditView3Controller() throws Exception {
        super();
        this.setId("d9000a5b8eaf29d747677a40a7ab9e16");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZRZTJLC_D_XZBMobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZRZTJLC_D_XZBMobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMobXZBMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZRZTJLC_D_XZBMobWFEditView3EditFormHandler");
        editForm.init(this);
