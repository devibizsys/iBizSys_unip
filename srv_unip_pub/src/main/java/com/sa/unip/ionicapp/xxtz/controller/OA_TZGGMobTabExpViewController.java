...
/**
 * 视图[OA_TZGGMobTabExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/xxtz/OA_TZGGMobTabExpView.do")
public class OA_TZGGMobTabExpViewController extends net.ibizsys.paas.controller.MobTabExpViewControllerBase {
    public OA_TZGGMobTabExpViewController() throws Exception {
        super();
        this.setId("7b1ebd1f9f4129e840081a8d0a32ec1a");
        this.setCaption("通知公告");
        this.setTitle("公告");
        this.setCapLanResTag("DE.LNAME.OA_TZGG");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGG.MOBTABEXPVIEW");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/xxtz/OA_TZGGMobTabExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.xxtz.controller.OA_TZGGMobTabExpViewController",this);
    }
