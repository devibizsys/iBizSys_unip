...
import com.sa.unip.ionicapp.srv.wf.ctrlmodel.WFWorkListMyWFMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class WFWorkListMyWFMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected WFWorkListMyWFMobMOBMDCTRLModel listModel = null;
    public WFWorkListMyWFMobListViewMdctrlHandler()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        listModel = (WFWorkListMyWFMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected WFWorkListMyWFMobMOBMDCTRLModel getRealListModel() {
