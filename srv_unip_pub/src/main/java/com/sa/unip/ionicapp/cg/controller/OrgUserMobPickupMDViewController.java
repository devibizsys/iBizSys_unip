...
/**
 * 视图[OrgUserMobPickupMDView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OrgUserMobPickupMDView.do")
public class OrgUserMobPickupMDViewController extends net.ibizsys.paas.controller.MobPickupMDViewControllerBase {
    public OrgUserMobPickupMDViewController() throws Exception {
        super();
        this.setId("5dc14450fc9e0ed40724721a637558d2");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OrgUserMobPickupMDView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OrgUserMobPickupMDViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OrgUserMobPickupMDViewMdctrlHandler");
        mdctrl.init(this);
