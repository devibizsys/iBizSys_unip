...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CLWXMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_CLWXCLWXLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CLWXMobMOBMDCTRLModel listModel = null;
    public OA_CLWXCLWXLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_CLWXMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_CLWXMobMOBMDCTRLModel getRealListModel() {
