 ...
 */
public class  OA_RZRYMobMySenderMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_RZRYMobMySenderMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        if(true) {
            ...
            dataItemParam0.setName("oa_ggrzname");
        ...
        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("rzryname");
        ...
        listDataItem3.setName("srftype");
        listDataItem3.setDataType(25);
        listDataItem3.setFormat("%1$s");

        //设置代码表 工作日志类型
        listDataItem3.setCodeListId("BBE9816D-6E00-4D36-830F-4DBFDE6493E2");
        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        listDataItem6.setName("orguserid");
