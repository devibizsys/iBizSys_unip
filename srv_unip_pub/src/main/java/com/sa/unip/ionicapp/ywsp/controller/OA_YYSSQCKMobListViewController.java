...
/**
 * 视图[OA_YYSSQCKMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YYSSQCKMobListView.do")
public class OA_YYSSQCKMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_YYSSQCKMobListViewController() throws Exception {
        super();
        this.setId("964ea43ebbcb48c9338ed6d88ffae001");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YYSSQCKMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YYSSQCKMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YYSSQCurYyssqMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YYSSQCKMobListViewMdctrlHandler");
        mdctrl.init(this);
