...
/**
 * 视图[OA_JPYDJPYDLC_W20_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_JPYDJPYDLC_W20_MobWFEditView3.do")
public class OA_JPYDJPYDLC_W20_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_JPYDJPYDLC_W20_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("676d9b882c4beed1fa1401ae80dae02e");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_JPYDJPYDLC_W20_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_JPYDJPYDLC_W20_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_JPYDJPYDLC_W20_MobWFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_JPYDJPYDLC_W20_MobWFEditView3EditFormHandler");
        editForm.init(this);
