...
public class OA_BGYPSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_BGYPSQWFMobMainEditFormModel editformModel = null;
    public OA_BGYPSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
