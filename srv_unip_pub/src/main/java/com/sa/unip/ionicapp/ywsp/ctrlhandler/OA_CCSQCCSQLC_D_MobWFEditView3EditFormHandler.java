...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CCSQMobMainEditFormModel;
...
public class OA_CCSQCCSQLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CCSQMobMainEditFormModel editformModel = null;
    public OA_CCSQCCSQLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CCSQMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CCSQMobMainEditFormModel getRealEditFormModel() {
