...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_JPYDMobMainEditFormModel;
...
public class OA_JPYDJPYDLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_JPYDMobMainEditFormModel editformModel = null;
    public OA_JPYDJPYDLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_JPYDMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_JPYDMobMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_JPYDMobMainEditFormOrgsectornameHandler");
        ...
        //注册 'jbrname'
        IFormItemHandler jbrnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_JPYDMobMainEditFormJbrnameHandler");
