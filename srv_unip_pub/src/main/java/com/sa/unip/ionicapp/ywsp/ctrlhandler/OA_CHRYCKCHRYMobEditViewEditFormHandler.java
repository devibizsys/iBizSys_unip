...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CHRYMobCKCHRYMainEditFormModel;
...
public class OA_CHRYCKCHRYMobEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OA_CHRYMobCKCHRYMainEditFormModel editformModel = null;
    public OA_CHRYCKCHRYMobEditViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CHRYMobCKCHRYMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CHRYMobCKCHRYMainEditFormModel getRealEditFormModel() {
