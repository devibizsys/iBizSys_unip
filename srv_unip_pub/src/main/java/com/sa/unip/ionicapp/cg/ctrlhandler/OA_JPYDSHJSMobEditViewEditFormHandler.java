...
public class OA_JPYDSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_JPYDMobWFFormEditFormModel editformModel = null;
    public OA_JPYDSHJSMobEditViewEditFormHandler()  {
        super();
    }
