...
/**
 * 视图[OA_GZRZSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_GZRZSHJSMobEditView.do")
public class OA_GZRZSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_GZRZSHJSMobEditViewController() throws Exception {
        super();
        this.setId("6301ecb9da5b0fac9f4a9c7bca265ae6");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_GZRZSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_GZRZSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_GZRZSHJSMobEditViewEditFormHandler");
        editForm.init(this);
