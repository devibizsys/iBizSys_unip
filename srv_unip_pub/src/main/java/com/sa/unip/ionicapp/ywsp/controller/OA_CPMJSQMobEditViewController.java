...
/**
 * 视图[OA_CPMJSQMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CPMJSQMobEditView.do")
public class OA_CPMJSQMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CPMJSQMobEditViewController() throws Exception {
        super();
        this.setId("0d28cc35e4c4b09497859fc1ca653837");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CPMJSQMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CPMJSQMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CPMJSQMobEditViewEditFormHandler");
        editForm.init(this);
