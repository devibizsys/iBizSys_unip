...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CPMJSQSHYJMobFormEditFormModel;
...
public class OA_CPMJSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_CPMJSQSHYJMobFormEditFormModel editformModel = null;
    public OA_CPMJSQMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CPMJSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CPMJSQSHYJMobFormEditFormModel getRealEditFormModel() {
