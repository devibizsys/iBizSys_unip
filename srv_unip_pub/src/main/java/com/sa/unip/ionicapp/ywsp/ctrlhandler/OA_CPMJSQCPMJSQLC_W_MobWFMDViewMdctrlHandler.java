 ...
 * 列表控件后台处理基类
 */
public class OA_CPMJSQCPMJSQLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CPMJSQMobMOBMDCTRLModel listModel = null;
    public OA_CPMJSQCPMJSQLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
