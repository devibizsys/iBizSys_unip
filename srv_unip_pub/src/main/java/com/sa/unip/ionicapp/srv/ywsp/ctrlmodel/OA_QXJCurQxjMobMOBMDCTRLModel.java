 ...
 */
public class  OA_QXJCurQxjMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_QXJCurQxjMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        //设置代码表 请休假类型
        listDataItem1.setCodeListId("8BFCFE6A-D949-4B65-BE38-5D64D283B37C");
        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
