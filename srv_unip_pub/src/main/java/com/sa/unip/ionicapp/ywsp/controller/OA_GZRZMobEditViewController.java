...
/**
 * 视图[OA_GZRZMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZMobEditView.do")
public class OA_GZRZMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_GZRZMobEditViewController() throws Exception {
        super();
        this.setId("43ffe0bf6dd2b92360e20adef2d626b6");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZMobEditViewEditFormHandler");
        editForm.init(this);
