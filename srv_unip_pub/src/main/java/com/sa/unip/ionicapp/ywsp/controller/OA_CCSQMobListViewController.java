...
/**
 * 视图[OA_CCSQMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CCSQMobListView.do")
public class OA_CCSQMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CCSQMobListViewController() throws Exception {
        super();
        this.setId("6f5bfddb05f8b2cddf3bfefa7247d8fd");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CCSQMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CCSQMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CCSQMobListViewMdctrlHandler");
        mdctrl.init(this);
