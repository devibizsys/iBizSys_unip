...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CLWXSHYJMobFormEditFormModel;
...
public class OA_CLWXMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_CLWXSHYJMobFormEditFormModel editformModel = null;
    public OA_CLWXMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CLWXSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CLWXSHYJMobFormEditFormModel getRealEditFormModel() {
