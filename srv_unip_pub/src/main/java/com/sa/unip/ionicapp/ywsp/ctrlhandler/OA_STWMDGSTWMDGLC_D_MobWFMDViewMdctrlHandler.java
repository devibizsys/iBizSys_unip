 ...
 * 列表控件后台处理基类
 */
public class OA_STWMDGSTWMDGLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_STWMDGMobMOBMDCTRLModel listModel = null;
    public OA_STWMDGSTWMDGLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
