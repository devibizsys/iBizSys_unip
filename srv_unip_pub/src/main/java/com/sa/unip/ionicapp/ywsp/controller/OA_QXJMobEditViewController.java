...
/**
 * 视图[OA_QXJMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_QXJMobEditView.do")
public class OA_QXJMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_QXJMobEditViewController() throws Exception {
        super();
        this.setId("5abe65f0a78a5883a00428fbb3d4a985");
        this.setCaption("请休假");
        this.setTitle("请假");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_QXJMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_QXJMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_QXJMobEditViewEditFormHandler");
        editForm.init(this);
