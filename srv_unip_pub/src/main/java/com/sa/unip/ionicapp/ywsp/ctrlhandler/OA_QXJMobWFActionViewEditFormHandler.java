...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_QXJMobSHYJFormEditFormModel;
...
public class OA_QXJMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_QXJMobSHYJFormEditFormModel editformModel = null;
    public OA_QXJMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_QXJMobSHYJFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_QXJMobSHYJFormEditFormModel getRealEditFormModel() {
