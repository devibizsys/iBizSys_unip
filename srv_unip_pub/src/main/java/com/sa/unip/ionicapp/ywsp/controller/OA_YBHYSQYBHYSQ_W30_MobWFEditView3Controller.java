...
/**
 * 视图[OA_YBHYSQYBHYSQ_W30_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YBHYSQYBHYSQ_W30_MobWFEditView3.do")
public class OA_YBHYSQYBHYSQ_W30_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_YBHYSQYBHYSQ_W30_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("7920961ee40c1b267534965df96c6ba0");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YBHYSQYBHYSQ_W30_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YBHYSQYBHYSQ_W30_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_W30_MobWFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_W30_MobWFEditView3EditFormHandler");
        editForm.init(this);
