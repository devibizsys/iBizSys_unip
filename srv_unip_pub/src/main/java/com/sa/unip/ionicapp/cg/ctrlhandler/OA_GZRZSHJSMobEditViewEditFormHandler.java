...
public class OA_GZRZSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_GZRZWFSPMobMainEditFormModel editformModel = null;
    public OA_GZRZSHJSMobEditViewEditFormHandler()  {
        super();
    }
