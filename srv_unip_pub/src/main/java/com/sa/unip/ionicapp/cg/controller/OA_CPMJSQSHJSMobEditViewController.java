...
/**
 * 视图[OA_CPMJSQSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_CPMJSQSHJSMobEditView.do")
public class OA_CPMJSQSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CPMJSQSHJSMobEditViewController() throws Exception {
        super();
        this.setId("90398f16e1d636c3d2d5092473404267");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_CPMJSQSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_CPMJSQSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_CPMJSQSHJSMobEditViewEditFormHandler");
        editForm.init(this);
