 ...
 * 列表控件后台处理基类
 */
public class OA_CCSQCCSQLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CCSQMobMOBMDCTRLModel listModel = null;
    public OA_CCSQCCSQLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
