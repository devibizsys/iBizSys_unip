...
/**
 * 视图[OA_GZRZRZTJLC_D_XYBMobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZRZTJLC_D_XYBMobWFEditView3.do")
public class OA_GZRZRZTJLC_D_XYBMobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_GZRZRZTJLC_D_XYBMobWFEditView3Controller() throws Exception {
        super();
        this.setId("fc6ccc14d61de4f3c92c14a8e801d1ff");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZRZTJLC_D_XYBMobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZRZTJLC_D_XYBMobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMobXYBMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZRZTJLC_D_XYBMobWFEditView3EditFormHandler");
        editForm.init(this);
