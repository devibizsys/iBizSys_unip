...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YCSQCurYcsqMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_YCSQCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_YCSQCurYcsqMobMOBMDCTRLModel listModel = null;
    public OA_YCSQCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_YCSQCurYcsqMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_YCSQCurYcsqMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurYcsq(deDataSetFetchContext);
    }
