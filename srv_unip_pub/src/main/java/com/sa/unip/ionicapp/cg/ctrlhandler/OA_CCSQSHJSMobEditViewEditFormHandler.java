...
public class OA_CCSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CCSQMobWFMainEditFormModel editformModel = null;
    public OA_CCSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
