...
/**
 * 视图[OA_YYSSQMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YYSSQMobEditView.do")
public class OA_YYSSQMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_YYSSQMobEditViewController() throws Exception {
        super();
        this.setId("1789bdd2c0ae6dcf45ddf677f8b20cb3");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YYSSQMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YYSSQMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YYSSQMobEditViewEditFormHandler");
        editForm.init(this);
