...
/**
 * 视图[OA_QXJSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_QXJSHJSMobEditView.do")
public class OA_QXJSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_QXJSHJSMobEditViewController() throws Exception {
        super();
        this.setId("2a4bf2e2387d742f08c4f80b550a2e55");
        this.setCaption("请休假");
        this.setTitle("请休假");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_QXJSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_QXJSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_QXJSHJSMobEditViewEditFormHandler");
        editForm.init(this);
