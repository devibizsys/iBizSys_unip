...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YCSQMobMainEditFormModel;
...
public class OA_YCSQYCSQLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YCSQMobMainEditFormModel editformModel = null;
    public OA_YCSQYCSQLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YCSQMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YCSQMobMainEditFormModel getRealEditFormModel() {
