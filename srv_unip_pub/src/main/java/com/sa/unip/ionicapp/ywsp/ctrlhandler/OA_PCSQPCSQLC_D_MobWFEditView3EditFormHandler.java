...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_PCSQMobMainEditFormModel;
...
public class OA_PCSQPCSQLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_PCSQMobMainEditFormModel editformModel = null;
    public OA_PCSQPCSQLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_PCSQMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_PCSQMobMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'oa_clname'
        IFormItemHandler oa_clnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_PCSQMobMainEditFormOa_clnameHandler");
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_PCSQMobMainEditFormOrgsectornameHandler");
