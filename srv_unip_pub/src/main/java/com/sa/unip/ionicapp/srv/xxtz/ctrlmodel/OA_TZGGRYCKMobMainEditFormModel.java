...
/**
 * 实体[通知公告人员]编辑表单[form]部件模型
 */
public class OA_TZGGRYCKMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_TZGGRYCKMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_TZGGRYID");
            formItem.setCaption("通知公告人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGRYID");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("OA_TZGGRYID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_TZGGRYNAME");
            formItem.setCaption("通知公告人员名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGRYNAME");
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("OA_TZGGRYNAME");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_tzggryid
        iFormItem = this.createFormItem("oa_tzggryid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_tzggryid");
            formItem.setDEFName("OA_TZGGRYID");
            formItem.setCaption("通知公告人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGRYID");
        ...
        this.registerFormItem(iFormItem);
        // oa_tzggryname
        iFormItem = this.createFormItem("oa_tzggryname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_tzggryname");
            formItem.setDEFName("OA_TZGGRYNAME");
            formItem.setCaption("通知公告人员名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGRYNAME");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("oa_tzggryname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // sfyd
        iFormItem = this.createFormItem("sfyd");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("sfyd");
            formItem.setDEFName("SFYD");
            formItem.setCaption("是否已读");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("sfyd");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
