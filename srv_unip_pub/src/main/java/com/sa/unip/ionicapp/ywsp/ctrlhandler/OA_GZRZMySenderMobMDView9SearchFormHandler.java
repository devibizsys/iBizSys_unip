...
public class OA_GZRZMySenderMobMDView9SearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected OA_GZRZMobSearchFormSearchFormModel searchformModel = null;
    public OA_GZRZMySenderMobMDView9SearchFormHandler()  {
        super();
    }
