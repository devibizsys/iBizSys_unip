...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_STWMDGMobMainEditFormModel;
...
public class OA_STWMDGSTWMDGLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_STWMDGMobMainEditFormModel editformModel = null;
    public OA_STWMDGSTWMDGLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_STWMDGMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_STWMDGMobMainEditFormModel getRealEditFormModel() {
