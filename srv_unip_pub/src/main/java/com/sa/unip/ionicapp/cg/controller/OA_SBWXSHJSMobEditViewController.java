...
/**
 * 视图[OA_SBWXSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_SBWXSHJSMobEditView.do")
public class OA_SBWXSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_SBWXSHJSMobEditViewController() throws Exception {
        super();
        this.setId("f73e2c5486c0669dc0e0039bda42859c");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_SBWXSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_SBWXSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_SBWXSHJSMobEditViewEditFormHandler");
        editForm.init(this);
