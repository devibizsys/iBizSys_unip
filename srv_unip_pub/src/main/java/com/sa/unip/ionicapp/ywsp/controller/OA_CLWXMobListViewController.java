...
/**
 * 视图[OA_CLWXMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CLWXMobListView.do")
public class OA_CLWXMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CLWXMobListViewController() throws Exception {
        super();
        this.setId("f71e800606e4f3280bf4853b11c3a2b8");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CLWXMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CLWXMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CLWXMobListViewMdctrlHandler");
        mdctrl.init(this);
