 ...
 * 列表控件后台处理基类
 */
public class OA_JPYDJPYDLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_JPYDMobMOBMDCTRLModel listModel = null;
    public OA_JPYDJPYDLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
