...
public class WFWorkListYSPMobMDView9SearchFormHandler extends net.ibizsys.paas.ctrlhandler.SearchFormHandlerBase {

    protected WFWorkListMobSearchFormSearchFormModel searchformModel = null;
    public WFWorkListYSPMobMDView9SearchFormHandler()  {
        super();
    }
