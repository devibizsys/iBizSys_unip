...
/**
 * 视图[OA_RZRYCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_RZRYCKMobEditView.do")
public class OA_RZRYCKMobEditViewController extends net.ibizsys.paas.controller.MobEditViewControllerBase {
    public OA_RZRYCKMobEditViewController() throws Exception {
        super();
        this.setId("600cc6510b4fbda14d7fb64fd28c3cab");
        this.setCaption("日志人员");
        this.setTitle("日志");
        this.setCapLanResTag("DE.LNAME.OA_RZRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_RZRY.CKMOBEDITVIEW");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_RZRYCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_RZRYCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_RZRYMobMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_RZRYCKMobEditViewEditFormHandler");
        editForm.init(this);
