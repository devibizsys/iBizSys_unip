 ...
 * 列表控件后台处理基类
 */
public class OA_YBHYSQYBHYSQ_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_YBHYSQMobWFListMOBMDCTRLModel listModel = null;
    public OA_YBHYSQYBHYSQ_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
