...
/**
 * 视图[OA_YYSSQYYSSQ_W20_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YYSSQYYSSQ_W20_MobWFEditView3.do")
public class OA_YYSSQYYSSQ_W20_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_YYSSQYYSSQ_W20_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("da199accdd1aa79e6bfda337da9f6c87");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YYSSQYYSSQ_W20_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YYSSQYYSSQ_W20_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YYSSQYYSSQ_W20_MobWFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YYSSQYYSSQ_W20_MobWFEditView3EditFormHandler");
        editForm.init(this);
