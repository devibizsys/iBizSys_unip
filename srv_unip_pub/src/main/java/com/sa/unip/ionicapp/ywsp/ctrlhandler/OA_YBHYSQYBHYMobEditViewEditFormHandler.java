...
public class OA_YBHYSQYBHYMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YBHYSQMobHYMainEditFormModel editformModel = null;
    public OA_YBHYSQYBHYMobEditViewEditFormHandler()  {
        super();
    }
