 ...
 */
public class  OA_CGSQMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_CGSQMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        //设置代码表 采购类型
        listDataItem1.setCodeListId("5D7F6E99-66F0-4AA6-A94B-4B2C7019C272");
        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
