...
/**
 * 视图[OA_GZRZZSMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZZSMobListView.do")
public class OA_GZRZZSMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_GZRZZSMobListViewController() throws Exception {
        super();
        this.setId("8c40cf7ac2fa866c1e28c2ea686c5a59");
        this.setCaption("工作日志");
        this.setTitle("我的日志展示");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZZSMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZZSMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZZSMobListViewMdctrlHandler");
        mdctrl.init(this);
