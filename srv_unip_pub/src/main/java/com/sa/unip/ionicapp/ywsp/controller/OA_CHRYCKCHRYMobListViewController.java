...
/**
 * 视图[OA_CHRYCKCHRYMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CHRYCKCHRYMobListView.do")
public class OA_CHRYCKCHRYMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CHRYCKCHRYMobListViewController() throws Exception {
        super();
        this.setId("c8ee279426cb3c4bf075c05d6e722bc4");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CHRYCKCHRYMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CHRYCKCHRYMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        ...
        //注册 searchform
        ICtrlModel searchForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CHRYMobSearchFormSearchFormModel");
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CHRYCKCHRYMobListViewMdctrlHandler");
        mdctrl.init(this);
        this.registerCtrlHandler("mdctrl",mdctrl);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CHRYCKCHRYMobListViewSearchFormHandler");
        searchForm.init(this);
