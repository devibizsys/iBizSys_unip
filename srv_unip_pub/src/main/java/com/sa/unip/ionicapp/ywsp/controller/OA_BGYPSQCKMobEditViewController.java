...
/**
 * 视图[OA_BGYPSQCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_BGYPSQCKMobEditView.do")
public class OA_BGYPSQCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_BGYPSQCKMobEditViewController() throws Exception {
        super();
        this.setId("a45eba8c5e0d22451f37f37c8ab2a1b9");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_BGYPSQCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_BGYPSQCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_BGYPSQCKMobEditViewEditFormHandler");
        editForm.init(this);
