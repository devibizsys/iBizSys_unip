...
/**
 * 视图[OA_JPYDCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_JPYDCKMobEditView.do")
public class OA_JPYDCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_JPYDCKMobEditViewController() throws Exception {
        super();
        this.setId("7f8cb08eab65285c8b08fdad576472c1");
        this.setCaption("机票预订");
        this.setTitle("机票预订查看");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_JPYDCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_JPYDCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_JPYDCKMobEditViewEditFormHandler");
        editForm.init(this);
