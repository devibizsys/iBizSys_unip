...
/**
 * 视图[OA_JPYDCKMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_JPYDCKMobListView.do")
public class OA_JPYDCKMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_JPYDCKMobListViewController() throws Exception {
        super();
        this.setId("04035946737be0a81f7b6abd5f3d8d3d");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_JPYDCKMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_JPYDCKMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_JPYDCurJpydMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_JPYDCKMobListViewMdctrlHandler");
        mdctrl.init(this);
