...
/**
 * 视图[OA_CCSQCCSQLC_D_MobWFMDView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CCSQCCSQLC_D_MobWFMDView.do")
public class OA_CCSQCCSQLC_D_MobWFMDViewController extends net.ibizsys.pswf.controller.MobWFMDViewControllerBase {
    public OA_CCSQCCSQLC_D_MobWFMDViewController() throws Exception {
        super();
        this.setId("c4297bd5c1bf093a8b074c1ce1f98b5d");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CCSQCCSQLC_D_MobWFMDView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CCSQCCSQLC_D_MobWFMDViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CCSQCCSQLC_D_MobWFMDViewMdctrlHandler");
        mdctrl.init(this);
