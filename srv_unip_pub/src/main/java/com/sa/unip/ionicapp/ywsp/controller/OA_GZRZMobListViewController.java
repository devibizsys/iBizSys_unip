...
/**
 * 视图[OA_GZRZMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZMobListView.do")
public class OA_GZRZMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_GZRZMobListViewController() throws Exception {
        super();
        this.setId("833a263c07dc62f1f0d978e81c2ed599");
        this.setCaption("工作日志");
        this.setTitle("我的工作日志");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMyGzrzMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZMobListViewMdctrlHandler");
        mdctrl.init(this);
