...
/**
 * 视图[OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3.do")
public class OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("8b4ce905f87f4e5e465cc7ba77521638");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3EditFormHandler");
        editForm.init(this);
