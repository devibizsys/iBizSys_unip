...
/**
 * 视图[WFWorkListMobTabExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/WFWorkListMobTabExpView.do")
public class WFWorkListMobTabExpViewController extends net.ibizsys.paas.controller.MobTabExpViewControllerBase {
    public WFWorkListMobTabExpViewController() throws Exception {
        super();
        this.setId("1310e57402662522580d19dc4118fa59");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/WFWorkListMobTabExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.WFWorkListMobTabExpViewController",this);
    }
