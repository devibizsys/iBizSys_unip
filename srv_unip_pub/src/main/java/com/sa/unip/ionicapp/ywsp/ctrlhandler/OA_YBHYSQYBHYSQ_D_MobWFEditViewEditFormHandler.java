...
public class OA_YBHYSQYBHYSQ_D_MobWFEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YBHYSQMobMainEditFormModel editformModel = null;
    public OA_YBHYSQYBHYSQ_D_MobWFEditViewEditFormHandler()  {
        super();
    }
