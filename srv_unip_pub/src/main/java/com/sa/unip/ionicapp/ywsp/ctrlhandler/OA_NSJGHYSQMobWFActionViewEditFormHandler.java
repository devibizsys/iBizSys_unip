...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_NSJGHYSQSHYJMobFormEditFormModel;
...
public class OA_NSJGHYSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_NSJGHYSQSHYJMobFormEditFormModel editformModel = null;
    public OA_NSJGHYSQMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_NSJGHYSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_NSJGHYSQSHYJMobFormEditFormModel getRealEditFormModel() {
