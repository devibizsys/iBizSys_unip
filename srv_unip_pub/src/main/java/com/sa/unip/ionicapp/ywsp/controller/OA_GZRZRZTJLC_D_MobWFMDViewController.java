...
/**
 * 视图[OA_GZRZRZTJLC_D_MobWFMDView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZRZTJLC_D_MobWFMDView.do")
public class OA_GZRZRZTJLC_D_MobWFMDViewController extends net.ibizsys.pswf.controller.MobWFMDViewControllerBase {
    public OA_GZRZRZTJLC_D_MobWFMDViewController() throws Exception {
        super();
        this.setId("4b5b3d1d5da7bb7701cc603a7a8349ad");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZRZTJLC_D_MobWFMDView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZRZTJLC_D_MobWFMDViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZRZTJLC_D_MobWFMDViewMdctrlHandler");
        mdctrl.init(this);
