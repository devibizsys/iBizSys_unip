...
/**
 * 视图[OA_CCSQSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_CCSQSHJSMobEditView.do")
public class OA_CCSQSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CCSQSHJSMobEditViewController() throws Exception {
        super();
        this.setId("e8897b1b197871c9e7b430c1bcd16b08");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_CCSQSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_CCSQSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_CCSQSHJSMobEditViewEditFormHandler");
        editForm.init(this);
