...
/**
 * 实体[机票预订]移动端数据列表[mdctrl]部件模型
 */
public class  OA_JPYDCurJpydMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_JPYDCurJpydMobMOBMDCTRLModel()  {
        super();
