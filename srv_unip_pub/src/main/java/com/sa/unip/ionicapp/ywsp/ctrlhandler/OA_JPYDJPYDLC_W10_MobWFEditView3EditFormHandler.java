...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_JPYDMobWFFormEditFormModel;
...
public class OA_JPYDJPYDLC_W10_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_JPYDMobWFFormEditFormModel editformModel = null;
    public OA_JPYDJPYDLC_W10_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_JPYDMobWFFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_JPYDMobWFFormEditFormModel getRealEditFormModel() {
