...
/**
 * 实体[请休假]移动端数据列表[mdctrl]部件模型
 */
public class  OA_QXJMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_QXJMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        //设置代码表 请休假类型
        listDataItem0.setCodeListId("8BFCFE6A-D949-4B65-BE38-5D64D283B37C");
        if(true) {
        ...
        listDataItem4.setName("ybhysqid");
