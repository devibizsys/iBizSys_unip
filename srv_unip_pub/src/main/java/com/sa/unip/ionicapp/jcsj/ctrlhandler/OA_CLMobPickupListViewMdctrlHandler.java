...
import com.sa.unip.ionicapp.srv.jcsj.ctrlmodel.OA_CLMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_CLMobPickupListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CLMobMOBMDCTRLModel listModel = null;
    public OA_CLMobPickupListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_CLMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_CLMobMOBMDCTRLModel getRealListModel() {
