...
import com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_TZGGMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_TZGGTZGGSQLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_TZGGMobMOBMDCTRLModel listModel = null;
    public OA_TZGGTZGGSQLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_TZGGMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_TZGGMobMOBMDCTRLModel getRealListModel() {
