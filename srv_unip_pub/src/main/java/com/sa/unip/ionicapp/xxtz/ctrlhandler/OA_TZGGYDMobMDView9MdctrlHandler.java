...
import com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_TZGGYDMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_TZGGYDMobMDView9MdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_TZGGYDMobMOBMDCTRLModel listModel = null;
    public OA_TZGGYDMobMDView9MdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_TZGGYDMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_TZGGYDMobMOBMDCTRLModel getRealListModel() {
