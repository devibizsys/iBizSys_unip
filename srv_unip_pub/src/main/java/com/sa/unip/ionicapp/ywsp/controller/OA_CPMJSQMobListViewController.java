...
/**
 * 视图[OA_CPMJSQMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CPMJSQMobListView.do")
public class OA_CPMJSQMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CPMJSQMobListViewController() throws Exception {
        super();
        this.setId("90c1804e91a47d2f876b3f7d2ce41665");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CPMJSQMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CPMJSQMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CPMJSQMobListViewMdctrlHandler");
        mdctrl.init(this);
