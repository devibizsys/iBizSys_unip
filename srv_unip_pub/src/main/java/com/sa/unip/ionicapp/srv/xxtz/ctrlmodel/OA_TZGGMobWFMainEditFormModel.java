...
/**
 * 实体[通知公告]编辑表单[form]部件模型
 */
public class OA_TZGGMobWFMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_TZGGMobWFMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_TZGGID");
            formItem.setCaption("通知公告标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_TZGGNAME");
            formItem.setCaption("通知公告标题");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGNAME");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGG.ORGUSERNAME");
        ...
        if(iFormItem==null) {
            ...
            dataItemParam0.setFormat("%1$tY-%1$tm-%1$td %1$tH:%1$tM");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("GGSFSHTG");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_tzggid
        iFormItem = this.createFormItem("oa_tzggid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_tzggid");
            formItem.setDEFName("OA_TZGGID");
            formItem.setCaption("通知公告标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGID");
        ...
        this.registerFormItem(iFormItem);
        // oa_tzggname
        iFormItem = this.createFormItem("oa_tzggname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_tzggname");
            formItem.setDEFName("OA_TZGGNAME");
            formItem.setCaption("通知公告标题");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGGNAME");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGG.ORGUSERID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCaption("通知公告内容");
            formItem.setCapLanResTag("DEF.LNAME.OA_TZGG.CONTENT");
