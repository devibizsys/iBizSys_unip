 ...
 * 列表控件后台处理基类
 */
public class OA_CLWXCLWXLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CLWXMobMOBMDCTRLModel listModel = null;
    public OA_CLWXCLWXLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
