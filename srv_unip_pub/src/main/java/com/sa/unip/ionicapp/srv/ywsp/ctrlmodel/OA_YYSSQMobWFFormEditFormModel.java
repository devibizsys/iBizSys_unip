...
/**
 * 实体[饮用水申请]编辑表单[form]部件模型
 */
public class OA_YYSSQMobWFFormEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_YYSSQMobWFFormEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_YYSSQID");
            formItem.setCaption("饮用水申请标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_YYSSQID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_YYSSQNAME");
            formItem.setCaption("饮用水申请名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_YYSSQNAME");
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("YYSSFSHTG");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_yyssqid
        iFormItem = this.createFormItem("oa_yyssqid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_yyssqid");
            formItem.setDEFName("OA_YYSSQID");
            formItem.setCaption("饮用水申请标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_YYSSQID");
