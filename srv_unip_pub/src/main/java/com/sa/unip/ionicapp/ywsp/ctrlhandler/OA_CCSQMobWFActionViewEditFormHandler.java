...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CCSQSHYJMobFormEditFormModel;
...
public class OA_CCSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_CCSQSHYJMobFormEditFormModel editformModel = null;
    public OA_CCSQMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CCSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CCSQSHYJMobFormEditFormModel getRealEditFormModel() {
