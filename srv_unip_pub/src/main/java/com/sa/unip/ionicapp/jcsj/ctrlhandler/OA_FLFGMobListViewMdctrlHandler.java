...
import com.sa.unip.ionicapp.srv.jcsj.ctrlmodel.OA_FLFGMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_FLFGMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_FLFGMobMOBMDCTRLModel listModel = null;
    public OA_FLFGMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_FLFGMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_FLFGMobMOBMDCTRLModel getRealListModel() {
