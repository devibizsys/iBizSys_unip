...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMobMainEditFormModel;
...
public class OA_GZRZRZTJLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_GZRZMobMainEditFormModel editformModel = null;
    public OA_GZRZRZTJLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_GZRZMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_GZRZMobMainEditFormModel getRealEditFormModel() {
