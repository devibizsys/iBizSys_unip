...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_BGYPSQMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_BGYPSQBGYPSQLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_BGYPSQMobMOBMDCTRLModel listModel = null;
    public OA_BGYPSQBGYPSQLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        this.setMinorSortField("RQ");
        this.setMinorSortDir("DESC");
        listModel = (OA_BGYPSQMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_BGYPSQMobMOBMDCTRLModel getRealListModel() {
