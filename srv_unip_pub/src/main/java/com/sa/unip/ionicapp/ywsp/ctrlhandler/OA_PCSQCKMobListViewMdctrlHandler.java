...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_PCSQCurPcsqMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_PCSQCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_PCSQCurPcsqMobMOBMDCTRLModel listModel = null;
    public OA_PCSQCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_PCSQCurPcsqMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_PCSQCurPcsqMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurPcsq(deDataSetFetchContext);
    }
