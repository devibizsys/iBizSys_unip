...
public class OA_STWMDGSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_STWMDGMobWFMainEditFormModel editformModel = null;
    public OA_STWMDGSHJSMobEditViewEditFormHandler()  {
        super();
    }
