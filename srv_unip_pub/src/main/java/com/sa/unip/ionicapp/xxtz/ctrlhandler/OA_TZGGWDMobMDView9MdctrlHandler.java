...
import com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_TZGGWDMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_TZGGWDMobMDView9MdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_TZGGWDMobMOBMDCTRLModel listModel = null;
    public OA_TZGGWDMobMDView9MdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_TZGGWDMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_TZGGWDMobMOBMDCTRLModel getRealListModel() {
