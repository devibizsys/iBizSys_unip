...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YCSQSHYJMobFormEditFormModel;
...
public class OA_YCSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_YCSQSHYJMobFormEditFormModel editformModel = null;
    public OA_YCSQMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YCSQSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YCSQSHYJMobFormEditFormModel getRealEditFormModel() {
