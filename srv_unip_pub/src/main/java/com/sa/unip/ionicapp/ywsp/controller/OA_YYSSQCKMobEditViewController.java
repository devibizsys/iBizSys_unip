...
/**
 * 视图[OA_YYSSQCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YYSSQCKMobEditView.do")
public class OA_YYSSQCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_YYSSQCKMobEditViewController() throws Exception {
        super();
        this.setId("643dc8b36392ed7b5730efafcadd7ee6");
        this.setCaption("饮用水申请");
        this.setTitle("饮用水申请查看");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YYSSQCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YYSSQCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YYSSQCKMobEditViewEditFormHandler");
        editForm.init(this);
