...
/**
 * 视图[OA_SBWXMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_SBWXMobEditView.do")
public class OA_SBWXMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_SBWXMobEditViewController() throws Exception {
        super();
        this.setId("ea070b7fcf0750964b4443e80d107bfc");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_SBWXMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_SBWXMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_SBWXMobEditViewEditFormHandler");
        editForm.init(this);
