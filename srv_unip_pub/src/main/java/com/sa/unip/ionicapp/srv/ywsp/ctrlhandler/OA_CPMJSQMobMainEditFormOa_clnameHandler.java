...
public class OA_CPMJSQMobMainEditFormOa_clnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OA_CPMJSQMobMainEditFormOa_clnameHandler()  {
        super();
    }
