...
/**
 * 视图[OA_YBHYSQSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_YBHYSQSHJSMobEditView.do")
public class OA_YBHYSQSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_YBHYSQSHJSMobEditViewController() throws Exception {
        super();
        this.setId("7207f36726026cac3001a58a3070d0e5");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_YBHYSQSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_YBHYSQSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_YBHYSQSHJSMobEditViewEditFormHandler");
        editForm.init(this);
