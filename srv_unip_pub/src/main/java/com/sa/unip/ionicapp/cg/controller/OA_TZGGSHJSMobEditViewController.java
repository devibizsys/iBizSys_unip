...
/**
 * 视图[OA_TZGGSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_TZGGSHJSMobEditView.do")
public class OA_TZGGSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_TZGGSHJSMobEditViewController() throws Exception {
        super();
        this.setId("4607ca8a958691fdfce22b6c05617464");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_TZGGSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_TZGGSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_TZGGSHJSMobEditViewEditFormHandler");
        editForm.init(this);
