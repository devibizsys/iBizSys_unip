...
/**
 * 实体[派车申请]移动端数据列表[mdctrl]部件模型
 */
public class  OA_PCSQCurPcsqMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_PCSQCurPcsqMobMOBMDCTRLModel()  {
        super();
