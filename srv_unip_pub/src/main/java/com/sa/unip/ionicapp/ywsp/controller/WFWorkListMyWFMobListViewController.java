...
/**
 * 视图[WFWorkListMyWFMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/WFWorkListMyWFMobListView.do")
public class WFWorkListMyWFMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public WFWorkListMyWFMobListViewController() throws Exception {
        super();
        this.setId("83d558e1d006924378afe41dbced269a");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/WFWorkListMyWFMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.WFWorkListMyWFMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.wf.ctrlmodel.WFWorkListMyWFMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.WFWorkListMyWFMobListViewMdctrlHandler");
        mdctrl.init(this);
