...
import com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_TZGGSHYJMobFormEditFormModel;
...
public class OA_TZGGMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_TZGGSHYJMobFormEditFormModel editformModel = null;
    public OA_TZGGMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_TZGGSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_TZGGSHYJMobFormEditFormModel getRealEditFormModel() {
