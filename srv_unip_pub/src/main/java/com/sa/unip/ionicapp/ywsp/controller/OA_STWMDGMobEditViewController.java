...
/**
 * 视图[OA_STWMDGMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_STWMDGMobEditView.do")
public class OA_STWMDGMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_STWMDGMobEditViewController() throws Exception {
        super();
        this.setId("ec83d855212fadeecc731429e3743c25");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_STWMDGMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_STWMDGMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_STWMDGMobEditViewEditFormHandler");
        editForm.init(this);
