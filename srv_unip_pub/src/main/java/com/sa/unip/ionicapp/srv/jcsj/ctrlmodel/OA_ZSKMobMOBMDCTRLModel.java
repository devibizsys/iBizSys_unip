...
/**
 * 实体[知识库]移动端数据列表[mdctrl]部件模型
 */
public class  OA_ZSKMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_ZSKMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        listDataItem1.setFormat("%1$tY-%1$tm-%1$td");
