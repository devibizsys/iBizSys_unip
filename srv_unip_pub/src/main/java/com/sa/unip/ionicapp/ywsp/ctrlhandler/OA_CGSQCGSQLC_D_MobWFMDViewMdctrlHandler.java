 ...
 * 列表控件后台处理基类
 */
public class OA_CGSQCGSQLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CGSQMobMOBMDCTRLModel listModel = null;
    public OA_CGSQCGSQLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
