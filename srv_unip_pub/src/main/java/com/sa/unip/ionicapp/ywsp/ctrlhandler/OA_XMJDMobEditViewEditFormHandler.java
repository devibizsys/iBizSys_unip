...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_XMJDMobMainEditFormModel;
...
public class OA_XMJDMobEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OA_XMJDMobMainEditFormModel editformModel = null;
    public OA_XMJDMobEditViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_XMJDMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_XMJDMobMainEditFormModel getRealEditFormModel() {
