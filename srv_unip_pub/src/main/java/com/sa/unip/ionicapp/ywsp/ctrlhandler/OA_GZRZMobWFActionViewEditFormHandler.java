...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZSHYJMobFormEditFormModel;
...
public class OA_GZRZMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_GZRZSHYJMobFormEditFormModel editformModel = null;
    public OA_GZRZMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_GZRZSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_GZRZSHYJMobFormEditFormModel getRealEditFormModel() {
