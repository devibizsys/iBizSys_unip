...
/**
 * 实体[演示]移动端数据列表[mdctrl]部件模型
 */
public class  DemoMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public DemoMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        listDataItem2.setName("demosqbz");
        listDataItem2.setDataType(25);
        listDataItem2.setFormat("%1$s");

        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEMOSQBZ");
        ...
        listDataItem3.setName("demosqzt");
        listDataItem3.setDataType(25);
        listDataItem3.setFormat("%1$s");

        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("DEMOSQZT");
            dataItemParam0.setFormat("%1$s");
