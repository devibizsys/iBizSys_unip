...
/**
 * 实体[食堂外卖订购]移动端数据列表[mdctrl]部件模型
 */
public class  OA_STWMDGCurStwmdgMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_STWMDGCurStwmdgMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        listDataItem5.setName("stwmdgbz");
        ...
        listDataItem6.setName("stwmdgzt");
