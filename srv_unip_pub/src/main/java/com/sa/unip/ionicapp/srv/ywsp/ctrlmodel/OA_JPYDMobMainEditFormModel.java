 ...
 */
public class OA_JPYDMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_JPYDMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // jbrid
        iFormItem = this.createFormItem("jbrid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("jbrid");
            formItem.setDEFName("JBRID");
            formItem.setCaption("经办人");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("jbrid");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
