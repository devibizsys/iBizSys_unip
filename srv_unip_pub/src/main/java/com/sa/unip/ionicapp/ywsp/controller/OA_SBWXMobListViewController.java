...
/**
 * 视图[OA_SBWXMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_SBWXMobListView.do")
public class OA_SBWXMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_SBWXMobListViewController() throws Exception {
        super();
        this.setId("a8f55801d1be9bcdaadfdaab31a6c799");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_SBWXMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_SBWXMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_SBWXMobListViewMdctrlHandler");
        mdctrl.init(this);
