...
/**
 * 视图[OA_CGSQCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CGSQCKMobEditView.do")
public class OA_CGSQCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CGSQCKMobEditViewController() throws Exception {
        super();
        this.setId("bf57f311cb8346a97485b2136832dec1");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CGSQCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CGSQCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CGSQCKMobEditViewEditFormHandler");
        editForm.init(this);
