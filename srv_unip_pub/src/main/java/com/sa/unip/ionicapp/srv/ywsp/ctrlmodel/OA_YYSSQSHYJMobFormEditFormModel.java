 ...
 */
public class OA_YYSSQSHYJMobFormEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_YYSSQSHYJMobFormEditFormModel()  {
        super();
        this.setName("form");
    }
