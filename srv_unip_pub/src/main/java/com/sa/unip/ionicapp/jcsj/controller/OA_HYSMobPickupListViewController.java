...
/**
 * 视图[OA_HYSMobPickupListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/jcsj/OA_HYSMobPickupListView.do")
public class OA_HYSMobPickupListViewController extends net.ibizsys.paas.controller.MobPickupListViewControllerBase {
    public OA_HYSMobPickupListViewController() throws Exception {
        super();
        this.setId("b5f254ed453e3b3eba77c59bd81b3a1b");
        this.setCaption("会议室");
        this.setTitle("会议室");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/jcsj/OA_HYSMobPickupListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.jcsj.controller.OA_HYSMobPickupListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.jcsj.ctrlhandler.OA_HYSMobPickupListViewMdctrlHandler");
        mdctrl.init(this);
