...
/**
 * 视图[OA_BGYPSQMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_BGYPSQMobListView.do")
public class OA_BGYPSQMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_BGYPSQMobListViewController() throws Exception {
        super();
        this.setId("2c97053162653d8a50c88fdab1b1fb8c");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_BGYPSQMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_BGYPSQMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_BGYPSQMobListViewMdctrlHandler");
        mdctrl.init(this);
