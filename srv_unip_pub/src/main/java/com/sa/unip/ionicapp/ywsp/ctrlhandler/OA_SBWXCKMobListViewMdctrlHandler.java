...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_SBWXCurSbwxMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_SBWXCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_SBWXCurSbwxMobMOBMDCTRLModel listModel = null;
    public OA_SBWXCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_SBWXCurSbwxMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_SBWXCurSbwxMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurSbwx(deDataSetFetchContext);
    }
