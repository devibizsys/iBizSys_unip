...
/**
 * 视图[OA_CLWXCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CLWXCKMobEditView.do")
public class OA_CLWXCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CLWXCKMobEditViewController() throws Exception {
        super();
        this.setId("8db9f956d0b9997080ee1617765ed9ff");
        this.setCaption("车辆维修");
        this.setTitle("车辆维修查看");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CLWXCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CLWXCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CLWXCKMobEditViewEditFormHandler");
        editForm.init(this);
