...
/**
 * 视图[OA_BGYPSQMobWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_BGYPSQMobWFActionView.do")
public class OA_BGYPSQMobWFActionViewController extends net.ibizsys.pswf.controller.MobWFActionViewControllerBase {
    public OA_BGYPSQMobWFActionViewController() throws Exception {
        super();
        this.setId("2d02851ece76b968616e1d02caed8adb");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_BGYPSQMobWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_BGYPSQMobWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_BGYPSQSHYJMobFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_BGYPSQMobWFActionViewEditFormHandler");
        editForm.init(this);
