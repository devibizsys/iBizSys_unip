...
/**
 * 视图[OA_YBHYSQYBHYSQ_D_MobWFEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YBHYSQYBHYSQ_D_MobWFEditView.do")
public class OA_YBHYSQYBHYSQ_D_MobWFEditViewController extends net.ibizsys.pswf.controller.MobWFEditViewControllerBase {
    public OA_YBHYSQYBHYSQ_D_MobWFEditViewController() throws Exception {
        super();
        this.setId("65c0720c633bc3833d9877b1ff58d846");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YBHYSQYBHYSQ_D_MobWFEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YBHYSQYBHYSQ_D_MobWFEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQMobMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YBHYSQYBHYSQ_D_MobWFEditViewEditFormHandler");
        editForm.init(this);
