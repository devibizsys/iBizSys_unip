...
/**
 * 视图[OA_YBHYSQMobWFStartView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YBHYSQMobWFStartView.do")
public class OA_YBHYSQMobWFStartViewController extends net.ibizsys.pswf.controller.MobWFStartViewControllerBase {
    public OA_YBHYSQMobWFStartViewController() throws Exception {
        super();
        this.setId("a9310da6b5bab15f831be0bd66ea6171");
        this.setCaption("会议申请");
        this.setTitle("院办会议申请");
        this.setCapLanResTag("DE.LNAME.OA_YBHYSQ");
        this.setAccessUserMode(2);
        //
        this.setAttribute("UI.CTRL.LEFTTOOLBAR","TRUE");
        //
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YBHYSQMobWFStartView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YBHYSQMobWFStartViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YBHYSQMobWFStartViewEditFormHandler");
        editForm.init(this);
