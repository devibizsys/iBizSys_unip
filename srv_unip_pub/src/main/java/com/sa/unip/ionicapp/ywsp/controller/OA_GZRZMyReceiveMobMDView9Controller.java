...
/**
 * 视图[OA_GZRZMyReceiveMobMDView9]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZMyReceiveMobMDView9.do")
public class OA_GZRZMyReceiveMobMDView9Controller extends net.ibizsys.paas.controller.MobMDView9ControllerBase {
    public OA_GZRZMyReceiveMobMDView9Controller() throws Exception {
        super();
        this.setId("e811eb3669ada9260d1b4cb348d2d71b");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZMyReceiveMobMDView9.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZMyReceiveMobMDView9Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZMyReceiveMobMDView9MdctrlHandler");
        mdctrl.init(this);
        this.registerCtrlHandler("mdctrl",mdctrl);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZMyReceiveMobMDView9SearchFormHandler");
        searchForm.init(this);
