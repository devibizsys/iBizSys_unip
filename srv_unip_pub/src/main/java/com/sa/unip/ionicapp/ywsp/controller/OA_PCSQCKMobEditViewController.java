...
/**
 * 视图[OA_PCSQCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_PCSQCKMobEditView.do")
public class OA_PCSQCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_PCSQCKMobEditViewController() throws Exception {
        super();
        this.setId("f59f516f97e6ffab434383a630831345");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_PCSQCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_PCSQCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_PCSQCKMobEditViewEditFormHandler");
        editForm.init(this);
