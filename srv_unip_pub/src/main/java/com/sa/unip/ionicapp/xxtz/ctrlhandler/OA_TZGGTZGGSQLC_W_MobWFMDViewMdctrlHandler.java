 ...
 * 列表控件后台处理基类
 */
public class OA_TZGGTZGGSQLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_TZGGMobMOBMDCTRLModel listModel = null;
    public OA_TZGGTZGGSQLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
