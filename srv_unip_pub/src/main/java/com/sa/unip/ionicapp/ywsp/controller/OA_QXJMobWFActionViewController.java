...
/**
 * 视图[OA_QXJMobWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_QXJMobWFActionView.do")
public class OA_QXJMobWFActionViewController extends net.ibizsys.pswf.controller.MobWFActionViewControllerBase {
    public OA_QXJMobWFActionViewController() throws Exception {
        super();
        this.setId("0784bccb1521749b25a22e2d4a318da3");
        this.setCaption("请休假");
        this.setTitle("审核意见");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_QXJMobWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_QXJMobWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_QXJMobSHYJFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_QXJMobWFActionViewEditFormHandler");
        editForm.init(this);
