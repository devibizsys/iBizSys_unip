...
/**
 * 实体[参会人员]编辑表单[form]部件模型
 */
public class OA_CHRYMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_CHRYMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_CHRYID");
            formItem.setCaption("参会人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_CHRYID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_CHRYNAME");
            formItem.setCaption("参会人员名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_CHRYNAME");
        ...
        this.registerFormItem(iFormItem);
        // ybhysqname
        iFormItem = this.createFormItem("ybhysqname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("ybhysqname");
            formItem.setDEFName("YBHYSQNAME");
            formItem.setCaption("院办会议标题");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("ybhysqname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // chsj
        iFormItem = this.createFormItem("chsj");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("chsj");
            formItem.setDEFName("CHSJ");
            formItem.setCaption("参会时间");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("chsj");
            dataItem.setDataType(5);
        ...
        this.registerFormItem(iFormItem);
        // chzt
        iFormItem = this.createFormItem("chzt");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("chzt");
            ...
            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("chzt");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.CL_CHZTCodeListModel");
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
        }
        ...
        this.registerFormItem(iFormItem);
        // zwh
        iFormItem = this.createFormItem("zwh");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("zwh");
            formItem.setDEFName("ZWH");
            formItem.setCaption("座位号");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("zwh");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // zwhms
        iFormItem = this.createFormItem("zwhms");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("zwhms");
            formItem.setDEFName("ZWHMS");
            formItem.setCaption("座位号描述");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("zwhms");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_chryid
        iFormItem = this.createFormItem("oa_chryid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_chryid");
            formItem.setDEFName("OA_CHRYID");
            formItem.setCaption("参会人员标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_CHRYID");
