 ...
 */
public class OA_GZRZMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_GZRZMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // picture
        iFormItem = this.createFormItem("picture");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("picture");
            formItem.setDEFName("PICTURE");
            formItem.setCaption("图片");
            formItem.setCapLanResTag("DEF.LNAME.PICTURE");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("picture");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // spr
        iFormItem = this.createFormItem("spr");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("spr");
            formItem.setDEFName("SPR");
            formItem.setCaption("审批人");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("spr");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // csr
        iFormItem = this.createFormItem("csr");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("csr");
            formItem.setDEFName("CSR");
            formItem.setCaption("抄送人");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("csr");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
