...
import com.sa.unip.ionicapp.srv.jcsj.ctrlmodel.OA_ZSKMobMainEditFormModel;
...
public class OA_ZSKMobEditViewEditFormHandler extends net.ibizsys.paas.ctrlhandler.EditFormHandlerBase {

    protected OA_ZSKMobMainEditFormModel editformModel = null;
    public OA_ZSKMobEditViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_ZSKMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_ZSKMobMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.jcsj.ctrlhandler.OA_ZSKMobMainEditFormOrgsectornameHandler");
