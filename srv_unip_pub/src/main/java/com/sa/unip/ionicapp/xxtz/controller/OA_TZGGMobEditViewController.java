...
/**
 * 视图[OA_TZGGMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/xxtz/OA_TZGGMobEditView.do")
public class OA_TZGGMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_TZGGMobEditViewController() throws Exception {
        super();
        this.setId("5323f2181b5d6fc4dc7888425ffa11f5");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/xxtz/OA_TZGGMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.xxtz.controller.OA_TZGGMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.xxtz.ctrlhandler.OA_TZGGMobEditViewEditFormHandler");
        editForm.init(this);
