...
/**
 * 视图[OA_GZRZCKMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZCKMobListView.do")
public class OA_GZRZCKMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_GZRZCKMobListViewController() throws Exception {
        super();
        this.setId("2b3328ec0c98a207312bbe74f0c14aea");
        this.setCaption("工作日志");
        this.setTitle("工作日志查看");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZCKMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZCKMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZCurGzrzMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZCKMobListViewMdctrlHandler");
        mdctrl.init(this);
