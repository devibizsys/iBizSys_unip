...
/**
 * 视图[OA_TZGGWDMobMDView9]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/xxtz/OA_TZGGWDMobMDView9.do")
public class OA_TZGGWDMobMDView9Controller extends net.ibizsys.paas.controller.MobMDView9ControllerBase {
    public OA_TZGGWDMobMDView9Controller() throws Exception {
        super();
        this.setId("9a7c7c438c2fa22be7478f424e4c07a7");
        this.setCaption("通知公告");
        this.setTitle("未读公告");
        this.setCapLanResTag("DE.LNAME.OA_TZGG");
        this.setTitleLanResTag("PAGE.TITLE.OA_TZGG.WDMOBMDVIEW9");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/xxtz/OA_TZGGWDMobMDView9.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.xxtz.controller.OA_TZGGWDMobMDView9Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_TZGGWDMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.xxtz.ctrlhandler.OA_TZGGWDMobMDView9MdctrlHandler");
        mdctrl.init(this);
