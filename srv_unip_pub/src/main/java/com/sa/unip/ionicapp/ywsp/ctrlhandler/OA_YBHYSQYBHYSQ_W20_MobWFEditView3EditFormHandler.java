...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YBHYSQMobWFFormEditFormModel;
...
public class OA_YBHYSQYBHYSQ_W20_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YBHYSQMobWFFormEditFormModel editformModel = null;
    public OA_YBHYSQYBHYSQ_W20_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_YBHYSQMobWFFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_YBHYSQMobWFFormEditFormModel getRealEditFormModel() {
