...
/**
 * 视图[OA_GZRZZSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZZSMobEditView.do")
public class OA_GZRZZSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_GZRZZSMobEditViewController() throws Exception {
        super();
        this.setId("5323294706168036042987830906f73e");
        this.setCaption("工作日志");
        this.setTitle("工作日志展示");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZZSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZZSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZZSMobMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZZSMobEditViewEditFormHandler");
        editForm.init(this);
