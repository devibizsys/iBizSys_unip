...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_JPYDSHYJMobFormEditFormModel;
...
public class OA_JPYDMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_JPYDSHYJMobFormEditFormModel editformModel = null;
    public OA_JPYDMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_JPYDSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_JPYDSHYJMobFormEditFormModel getRealEditFormModel() {
