...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_QXJMobMainEditFormModel;
...
public class OA_QXJQXJLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_QXJMobMainEditFormModel editformModel = null;
    public OA_QXJQXJLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_QXJMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_QXJMobMainEditFormModel getRealEditFormModel() {
