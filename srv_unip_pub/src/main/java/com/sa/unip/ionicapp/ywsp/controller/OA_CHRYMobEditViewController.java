...
/**
 * 视图[OA_CHRYMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CHRYMobEditView.do")
public class OA_CHRYMobEditViewController extends net.ibizsys.paas.controller.MobEditViewControllerBase {
    public OA_CHRYMobEditViewController() throws Exception {
        super();
        this.setId("b76bfec20964aa6c83bfd3429f0a1e2b");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CHRYMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CHRYMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CHRYMobMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CHRYMobEditViewEditFormHandler");
        editForm.init(this);
