...
/**
 * 视图[OA_SBWXSBWXLC_W20_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_SBWXSBWXLC_W20_MobWFEditView3.do")
public class OA_SBWXSBWXLC_W20_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_SBWXSBWXLC_W20_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("bfb48ff227fdb832db431a98cea94a04");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_SBWXSBWXLC_W20_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_SBWXSBWXLC_W20_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 drtab
        ICtrlModel drTab=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_SBWXSBWXLCMobDRDRTabModel");
        drTab.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_SBWXSBWXLC_W20_MobWFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_SBWXSBWXLC_W20_MobWFEditView3EditFormHandler");
        editForm.init(this);
