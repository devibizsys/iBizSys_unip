...
/**
 * 视图[OA_TZGGMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/xxtz/OA_TZGGMobListView.do")
public class OA_TZGGMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_TZGGMobListViewController() throws Exception {
        super();
        this.setId("700dfcbcbe8688eb0f0a7ab4b5fa3734");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/xxtz/OA_TZGGMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.xxtz.controller.OA_TZGGMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.xxtz.ctrlhandler.OA_TZGGMobListViewMdctrlHandler");
        mdctrl.init(this);
