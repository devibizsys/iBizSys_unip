...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZWDMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_GZRZMyReceiveMobMDView9MdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_GZRZWDMobMOBMDCTRLModel listModel = null;
    public OA_GZRZMyReceiveMobMDView9MdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_GZRZWDMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_GZRZWDMobMOBMDCTRLModel getRealListModel() {
