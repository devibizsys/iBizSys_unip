 ...
 */
public class  OA_GZRZCurGzrzMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_GZRZCurGzrzMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        //设置代码表 工作日志类型
        listDataItem1.setCodeListId("BBE9816D-6E00-4D36-830F-4DBFDE6493E2");
        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
