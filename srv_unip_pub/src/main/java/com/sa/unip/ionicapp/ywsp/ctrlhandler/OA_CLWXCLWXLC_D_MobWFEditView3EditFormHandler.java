...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CLWXMobMainEditFormModel;
...
public class OA_CLWXCLWXLC_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CLWXMobMainEditFormModel editformModel = null;
    public OA_CLWXCLWXLC_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CLWXMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CLWXMobMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_CLWXMobMainEditFormOrgsectornameHandler");
        ...
        //注册 'oa_clname'
        IFormItemHandler oa_clnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_CLWXMobMainEditFormOa_clnameHandler");
