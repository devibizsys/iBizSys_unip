...
public class OA_PCSQMobMainEditFormOa_clnameHandler extends net.ibizsys.paas.ctrlhandler.PickupTextFormItemHandlerBase {

    public OA_PCSQMobMainEditFormOa_clnameHandler()  {
        super();
    }
