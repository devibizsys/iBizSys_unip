...
import com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_RZRYMobMySenderMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_RZRYMySenderMobMDView9MdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_RZRYMobMySenderMOBMDCTRLModel listModel = null;
    public OA_RZRYMySenderMobMDView9MdctrlHandler()  {
        super();
    }

    @Override
    protected void onInit() throws Exception {
        listModel = (OA_RZRYMobMySenderMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_RZRYMobMySenderMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchMySender(deDataSetFetchContext);
    }
