...
/**
 * 视图[OA_YBHYSQCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_YBHYSQCKMobEditView.do")
public class OA_YBHYSQCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_YBHYSQCKMobEditViewController() throws Exception {
        super();
        this.setId("211ac03436c0c80c5c894686ae3276cb");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_YBHYSQCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_YBHYSQCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_YBHYSQCKMobEditViewDRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_YBHYSQCKMobEditViewEditFormHandler");
        editForm.init(this);
