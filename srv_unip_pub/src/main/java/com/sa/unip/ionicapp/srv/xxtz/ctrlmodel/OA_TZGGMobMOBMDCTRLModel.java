 ...
 */
public class  OA_TZGGMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_TZGGMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        listDataItem4.setName("tzggsqbz");
        ...
        listDataItem5.setName("tzggsqzt");
