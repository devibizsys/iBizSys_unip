 ...
 */
public class OA_GZRZMobXZBMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_GZRZMobXZBMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        this.registerFormItem(iFormItem);
        // bzgzcx
        iFormItem = this.createFormItem("bzgzcx");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("bzgzcx");
            formItem.setDEFName("BZGZCX");
            formItem.setCaption("本周工作成效");
            formItem.setCapLanResTag("DEF.LNAME.JRGZCX");
            formItem.setAllowEmpty(false);

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("bzgzcx");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
