...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CCSQMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_CCSQCCSQLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_CCSQMobMOBMDCTRLModel listModel = null;
    public OA_CCSQCCSQLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_CCSQMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_CCSQMobMOBMDCTRLModel getRealListModel() {
