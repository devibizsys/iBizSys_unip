...
/**
 * 实体[车辆维修]编辑表单[form]部件模型
 */
public class OA_CLWXWFMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_CLWXWFMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_CLWXID");
            formItem.setCaption("车辆维修标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_CLWXID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_CLWXNAME");
            formItem.setCaption("车辆维修名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_CLWXNAME");
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("CLWXSFSHTG");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // wxxm
        iFormItem = this.createFormItem("wxxm");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("wxxm");
            formItem.setDEFName("WXXM");
            formItem.setCaption("维修项目");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("wxxm");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // dph
        iFormItem = this.createFormItem("dph");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("dph");
            formItem.setDEFName("DPH");
            formItem.setCaption("底盘号");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("dph");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // fdjh
        iFormItem = this.createFormItem("fdjh");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("fdjh");
            formItem.setDEFName("FDJH");
            formItem.setCaption("发动机号");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("fdjh");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_clwxid
        iFormItem = this.createFormItem("oa_clwxid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_clwxid");
            formItem.setDEFName("OA_CLWXID");
            formItem.setCaption("车辆维修标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_CLWXID");
