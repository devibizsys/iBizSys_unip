...
public class OA_BGYPSQCKMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_BGYPSQWFMobMainEditFormModel editformModel = null;
    public OA_BGYPSQCKMobEditViewEditFormHandler()  {
        super();
    }
