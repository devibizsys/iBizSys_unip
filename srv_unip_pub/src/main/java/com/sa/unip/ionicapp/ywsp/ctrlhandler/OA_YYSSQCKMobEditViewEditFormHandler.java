...
public class OA_YYSSQCKMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YYSSQMobWFFormEditFormModel editformModel = null;
    public OA_YYSSQCKMobEditViewEditFormHandler()  {
        super();
    }
