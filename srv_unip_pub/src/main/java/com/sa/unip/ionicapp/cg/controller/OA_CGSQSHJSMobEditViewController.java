...
/**
 * 视图[OA_CGSQSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_CGSQSHJSMobEditView.do")
public class OA_CGSQSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CGSQSHJSMobEditViewController() throws Exception {
        super();
        this.setId("6fcf329d9a0b37b151f74367fa466e38");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_CGSQSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_CGSQSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_CGSQSHJSMobEditViewEditFormHandler");
        editForm.init(this);
