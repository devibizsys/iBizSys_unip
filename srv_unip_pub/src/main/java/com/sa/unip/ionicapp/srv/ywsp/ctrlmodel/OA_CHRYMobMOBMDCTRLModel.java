...
/**
 * 实体[参会人员]移动端数据列表[mdctrl]部件模型
 */
public class  OA_CHRYMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_CHRYMobMOBMDCTRLModel()  {
        super();
    ...
    */
    protected void prepareListDataItemModels()throws Exception {
        ...
        listDataItem4.setName("srftype");
        listDataItem4.setDataType(25);
        listDataItem4.setFormat("%1$s");

        //设置代码表 参会状态
        listDataItem4.setCodeListId("16B19126-0961-4814-9BF0-0039B4DDE1FA");
        if(true) {
            DataItemParamModel  dataItemParam0 = new DataItemParamModel();
        ...
        listDataItem6.setName("ybhysqid");
