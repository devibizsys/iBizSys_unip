...
public class OA_YYSSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YYSSQMobWFFormEditFormModel editformModel = null;
    public OA_YYSSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
