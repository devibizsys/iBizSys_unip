...
public class OA_YBHYSQMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_YBHYSQMobWFFormEditFormModel editformModel = null;
    public OA_YBHYSQMobWFActionViewEditFormHandler()  {
        super();
    }
