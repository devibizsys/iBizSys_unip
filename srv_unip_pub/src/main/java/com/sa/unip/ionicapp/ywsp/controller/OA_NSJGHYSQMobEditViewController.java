...
/**
 * 视图[OA_NSJGHYSQMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_NSJGHYSQMobEditView.do")
public class OA_NSJGHYSQMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_NSJGHYSQMobEditViewController() throws Exception {
        super();
        this.setId("b84a026acc57b84dd1002cb56c8bfdab");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_NSJGHYSQMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_NSJGHYSQMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_NSJGHYSQMobEditViewEditFormHandler");
        editForm.init(this);
