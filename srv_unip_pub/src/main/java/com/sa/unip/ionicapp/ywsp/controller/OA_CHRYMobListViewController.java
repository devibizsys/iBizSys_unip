...
/**
 * 视图[OA_CHRYMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CHRYMobListView.do")
public class OA_CHRYMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_CHRYMobListViewController() throws Exception {
        super();
        this.setId("b97d3ed5d3a0b67489fafa096b44da46");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CHRYMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CHRYMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CHRYMobListViewMdctrlHandler");
        mdctrl.init(this);
