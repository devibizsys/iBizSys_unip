...
/**
 * 视图[OA_QXJQXJLC_W20_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_QXJQXJLC_W20_MobWFEditView3.do")
public class OA_QXJQXJLC_W20_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_QXJQXJLC_W20_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("90b01f76abc21ad7a9a464c9a2817551");
        this.setCaption("请休假");
        this.setTitle("请休假");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_QXJQXJLC_W20_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_QXJQXJLC_W20_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 drtab
        ICtrlHandler drTab = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_QXJQXJLC_W20_MobWFEditView3DRTabHandler");
        drTab.init(this);
        this.registerCtrlHandler("drtab",drTab);
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_QXJQXJLC_W20_MobWFEditView3EditFormHandler");
        editForm.init(this);
