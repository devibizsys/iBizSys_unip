 ...
 */
public class OA_CGSQWFMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_CGSQWFMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("CGSQBZ");
            formItem.setIgnoreInput(3);
            formItem.setCodeListId("com.sa.unip.srv.codelist.CL_CGSPSQBZCodeListModel");
            formItem.setCaption("采购申请步骤");
            ...
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.CL_CGSPSQBZCodeListModel");
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("CGSQZT");
            formItem.setIgnoreInput(3);
            formItem.setCodeListId("com.sa.unip.srv.codelist.CL_CGSQZTCodeListModel");
            formItem.setCaption("采购申请状态");
            ...
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.CL_CGSQZTCodeListModel");
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("CGSFSHTG");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_cgsqname
        iFormItem = this.createFormItem("oa_cgsqname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_cgsqname");
            formItem.setDEFName("OA_CGSQNAME");
            formItem.setCaption("采购名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_CGSQNAME");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("oa_cgsqname");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        if(iFormItem==null) {
            ...
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.CGLXCodeListModel");
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
        }
        ...
        if(iFormItem==null) {
            ...
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.ZFFSCodeListModel");
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
        }
