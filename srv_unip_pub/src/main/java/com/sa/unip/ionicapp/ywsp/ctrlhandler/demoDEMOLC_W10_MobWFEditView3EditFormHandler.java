...
public class demoDEMOLC_W10_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected DemoMOBFormEditFormModel editformModel = null;
    public demoDEMOLC_W10_MobWFEditView3EditFormHandler()  {
        super();
    }
