...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZMobXYBMainEditFormModel;
...
public class OA_GZRZRZTJLC_D_XYBMobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_GZRZMobXYBMainEditFormModel editformModel = null;
    public OA_GZRZRZTJLC_D_XYBMobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_GZRZMobXYBMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_GZRZMobXYBMainEditFormModel getRealEditFormModel() {
