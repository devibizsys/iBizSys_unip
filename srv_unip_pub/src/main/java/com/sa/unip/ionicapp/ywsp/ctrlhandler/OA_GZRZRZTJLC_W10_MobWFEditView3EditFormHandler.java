...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZWFSPMobMainEditFormModel;
...
public class OA_GZRZRZTJLC_W10_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_GZRZWFSPMobMainEditFormModel editformModel = null;
    public OA_GZRZRZTJLC_W10_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_GZRZWFSPMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_GZRZWFSPMobMainEditFormModel getRealEditFormModel() {
