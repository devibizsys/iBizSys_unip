...
/**
 * 视图[OA_PCSQSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_PCSQSHJSMobEditView.do")
public class OA_PCSQSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_PCSQSHJSMobEditViewController() throws Exception {
        super();
        this.setId("7903e950b4bf116cd19ca1fecd20d62b");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_PCSQSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_PCSQSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_PCSQSHJSMobEditViewEditFormHandler");
        editForm.init(this);
