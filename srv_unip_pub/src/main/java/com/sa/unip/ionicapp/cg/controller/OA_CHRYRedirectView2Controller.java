...
/**
 * 视图[OA_CHRYRedirectView2]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_CHRYRedirectView2.do")
public class OA_CHRYRedirectView2Controller extends net.ibizsys.paas.controller.RedirectViewControllerBase {
    public OA_CHRYRedirectView2Controller() throws Exception {
        super();
        this.setId("db1b9a4217e35de39dcc6d1c61ee13d3");
        this.setCaption("参会人员");
        this.setTitle("参会人员数据重定向视图");
        this.setCapLanResTag("DE.LNAME.OA_CHRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_CHRY.REDIRECTVIEW");
        this.setAccessUserMode(2);

        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_CHRYRedirectView2.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_CHRYRedirectView2Controller",this);
    }
