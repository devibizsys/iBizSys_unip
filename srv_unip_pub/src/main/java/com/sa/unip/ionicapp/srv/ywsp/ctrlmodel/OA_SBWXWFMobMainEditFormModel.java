...
/**
 * 实体[设备维修]编辑表单[form]部件模型
 */
public class OA_SBWXWFMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_SBWXWFMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_SBWXID");
            formItem.setCaption("设备维修标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_SBWXID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_SBWXNAME");
            formItem.setCaption("设备维修名称");
            formItem.setCapLanResTag("DEF.LNAME.OA_SBWXNAME");
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SBWXBZ");
            formItem.setIgnoreInput(3);
            formItem.setCodeListId("com.sa.unip.srv.codelist.CL_SBWXSQBZCodeListModel");
            formItem.setCaption("设备维修步骤");
            ...
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.CL_SBWXSQBZCodeListModel");
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("SBWXZT");
            formItem.setIgnoreInput(3);
            formItem.setCodeListId("com.sa.unip.srv.codelist.CL_SBWXSQZTCodeListModel");
            formItem.setCaption("设备维修状态");
            ...
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.CL_SBWXSQZTCodeListModel");
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
        ...
        if(iFormItem==null) {
            ...
            //注册参数
            DataItemParamModel dataItemParam0 = new DataItemParamModel();
            dataItemParam0.setName("SBWXSFSHTG");
            dataItemParam0.setFormat("%1$s");
            dataItem.addDataItemParam(dataItemParam0);
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // sb
        iFormItem = this.createFormItem("sb");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("sb");
            formItem.setDEFName("SB");
            formItem.setCaption("设备");
        ...
        this.registerFormItem(iFormItem);
        // gzxx
        iFormItem = this.createFormItem("gzxx");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("gzxx");
            formItem.setDEFName("GZXX");
            formItem.setCaption("故障现象");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("gzxx");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        this.registerFormItem(iFormItem);
        // oa_sbwxid
        iFormItem = this.createFormItem("oa_sbwxid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_sbwxid");
            formItem.setDEFName("OA_SBWXID");
            formItem.setCaption("设备维修标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_SBWXID");
