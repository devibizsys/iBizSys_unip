...
/**
 * 视图[OrgUserTreeMobMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OrgUserTreeMobMPickupView.do")
public class OrgUserTreeMobMPickupViewController extends net.ibizsys.paas.controller.MobMPickupViewControllerBase {
    public OrgUserTreeMobMPickupViewController() throws Exception {
        super();
        this.setId("2ee6a6159c0f370706b902485a533ad5");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OrgUserTreeMobMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OrgUserTreeMobMPickupViewController",this);
    }
