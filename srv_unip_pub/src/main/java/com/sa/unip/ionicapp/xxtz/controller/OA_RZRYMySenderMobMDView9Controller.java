...
/**
 * 视图[OA_RZRYMySenderMobMDView9]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/xxtz/OA_RZRYMySenderMobMDView9.do")
public class OA_RZRYMySenderMobMDView9Controller extends net.ibizsys.paas.controller.MobMDView9ControllerBase {
    public OA_RZRYMySenderMobMDView9Controller() throws Exception {
        super();
        this.setId("37be462d2eb81a7730a5817503989041");
        this.setCaption("日志人员");
        this.setTitle("日志人员");
        this.setCapLanResTag("DE.LNAME.OA_RZRY");
        this.setTitleLanResTag("PAGE.TITLE.OA_RZRY.MYSENDERMOBMDVIEW9");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/xxtz/OA_RZRYMySenderMobMDView9.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.xxtz.controller.OA_RZRYMySenderMobMDView9Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.xxtz.ctrlmodel.OA_RZRYMobMySenderMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.xxtz.ctrlhandler.OA_RZRYMySenderMobMDView9MdctrlHandler");
        mdctrl.init(this);
        this.registerCtrlHandler("mdctrl",mdctrl);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.xxtz.ctrlhandler.OA_RZRYMySenderMobMDView9SearchFormHandler");
        searchForm.init(this);
