...
/**
 * 实体[法律法规]编辑表单[form]部件模型
 */
public class OA_FLFGMobMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_FLFGMobMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setDEFName("OA_FLFGID");
            formItem.setCaption("法律法规标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_FLFGID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.OA_FLFGNAME");
        ...
        this.registerFormItem(iFormItem);
        // oa_flfgname
        iFormItem = this.createFormItem("oa_flfgname");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_flfgname");
            formItem.setDEFName("OA_FLFGNAME");
            formItem.setCaption("标题");
            formItem.setCapLanResTag("DEF.LNAME.OA_FLFGNAME");
        ...
        this.registerFormItem(iFormItem);
        // zy
        iFormItem = this.createFormItem("zy");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("zy");
            formItem.setDEFName("ZY");
            formItem.setCaption("摘要");
            formItem.setCapLanResTag("DEF.LNAME.ZY");
        ...
        this.registerFormItem(iFormItem);
        // oa_flfgid
        iFormItem = this.createFormItem("oa_flfgid");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("oa_flfgid");
            formItem.setDEFName("OA_FLFGID");
            formItem.setCaption("法律法规标识");
            formItem.setCapLanResTag("DEF.LNAME.OA_FLFGID");
