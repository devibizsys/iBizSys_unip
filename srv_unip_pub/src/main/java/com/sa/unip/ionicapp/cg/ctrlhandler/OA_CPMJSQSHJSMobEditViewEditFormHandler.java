...
public class OA_CPMJSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CPMJSQMobWFFormEditFormModel editformModel = null;
    public OA_CPMJSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
