...
public class OA_TZGGSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_TZGGMobWFMainEditFormModel editformModel = null;
    public OA_TZGGSHJSMobEditViewEditFormHandler()  {
        super();
    }
