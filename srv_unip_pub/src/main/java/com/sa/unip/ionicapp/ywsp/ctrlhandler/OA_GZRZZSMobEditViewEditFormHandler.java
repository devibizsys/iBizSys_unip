...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZZSMobMainEditFormModel;
...
public class OA_GZRZZSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_GZRZZSMobMainEditFormModel editformModel = null;
    public OA_GZRZZSMobEditViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_GZRZZSMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_GZRZZSMobMainEditFormModel getRealEditFormModel() {
