...
public class OA_NSJGHYSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_NSJGHYSQMobWFFromEditFormModel editformModel = null;
    public OA_NSJGHYSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
