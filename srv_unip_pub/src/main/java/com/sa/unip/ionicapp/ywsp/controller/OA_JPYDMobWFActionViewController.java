...
/**
 * 视图[OA_JPYDMobWFActionView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_JPYDMobWFActionView.do")
public class OA_JPYDMobWFActionViewController extends net.ibizsys.pswf.controller.MobWFActionViewControllerBase {
    public OA_JPYDMobWFActionViewController() throws Exception {
        super();
        this.setId("035de24f4949a0acf920f796a7c4d114");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_JPYDMobWFActionView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_JPYDMobWFActionViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_JPYDSHYJMobFormEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_JPYDMobWFActionViewEditFormHandler");
        editForm.init(this);
