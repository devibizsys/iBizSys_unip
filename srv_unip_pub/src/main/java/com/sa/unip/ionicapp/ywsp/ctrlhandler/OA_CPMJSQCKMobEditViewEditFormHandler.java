...
public class OA_CPMJSQCKMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CPMJSQMobWFFormEditFormModel editformModel = null;
    public OA_CPMJSQCKMobEditViewEditFormHandler()  {
        super();
    }
