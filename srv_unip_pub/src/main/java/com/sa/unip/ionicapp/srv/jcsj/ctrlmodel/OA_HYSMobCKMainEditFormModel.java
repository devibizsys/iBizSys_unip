...
/**
 * 实体[会议室]编辑表单[form]部件模型
 */
public class OA_HYSMobCKMainEditFormModel extends net.ibizsys.paas.ctrlmodel.EditFormModelBase {

    public OA_HYSMobCKMainEditFormModel()  {
        super();
        this.setName("form");
    }
    ...
    protected void prepareFormItems()throws Exception {
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.OA_HYSID");
        ...
        if(iFormItem==null) {
            ...
            formItem.setCapLanResTag("DEF.LNAME.OA_HYSNAME");
        ...
        this.registerFormItem(iFormItem);
        // hysdz
        iFormItem = this.createFormItem("hysdz");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("hysdz");
            formItem.setDEFName("HYSDZ");
            formItem.setEnableCond(0);
            formItem.setCaption("会议室地址");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("hysdz");
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            formItem.setDataItem(dataItem);
            formItem.init();
        ...
        if(iFormItem==null) {
            ...
            dataItem.setDataType(25);
            dataItem.setFormat("%1$s");
            dataItem.setCodeListId("com.sa.unip.srv.codelist.HYSSYQKCodeListModel");
            formItem.setDataItem(dataItem);
            formItem.init();
            iFormItem = formItem;
        }
        this.registerFormItem(iFormItem);
        // sysj
        iFormItem = this.createFormItem("sysj");
        if(iFormItem==null) {
            EditFormItemModel formItem = new EditFormItemModel();
            formItem.setForm(this);
            formItem.setName("sysj");
            formItem.setDEFName("SYSJ");
            formItem.setCaption("使用时间");

            //设置数据项参数
            DataItemModel dataItem = new DataItemModel();
            dataItem.setName("sysj");
            dataItem.setDataType(5);
