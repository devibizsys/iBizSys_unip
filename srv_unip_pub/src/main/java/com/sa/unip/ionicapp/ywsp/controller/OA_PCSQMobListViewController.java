...
/**
 * 视图[OA_PCSQMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_PCSQMobListView.do")
public class OA_PCSQMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_PCSQMobListViewController() throws Exception {
        super();
        this.setId("8eb3da2daff145e89adf2e2434e22856");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_PCSQMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_PCSQMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_PCSQMobListViewMdctrlHandler");
        mdctrl.init(this);
