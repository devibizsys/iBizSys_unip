...
/**
 * 实体[饮用水申请]移动端数据列表[mdctrl]部件模型
 */
public class  OA_YYSSQCurYyssqMobMOBMDCTRLModel extends net.ibizsys.paas.ctrlmodel.ListModelBase {

    public OA_YYSSQCurYyssqMobMOBMDCTRLModel()  {
        super();
