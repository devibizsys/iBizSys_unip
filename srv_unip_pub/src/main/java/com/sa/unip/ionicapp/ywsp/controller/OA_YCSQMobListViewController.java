...
/**
 * 视图[OA_YCSQMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YCSQMobListView.do")
public class OA_YCSQMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_YCSQMobListViewController() throws Exception {
        super();
        this.setId("0bd274f3ae712183ca3c28c682b66723");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YCSQMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YCSQMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YCSQMobListViewMdctrlHandler");
        mdctrl.init(this);
