...
/**
 * 视图[OrgUserMobMPickupView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OrgUserMobMPickupView.do")
public class OrgUserMobMPickupViewController extends net.ibizsys.paas.controller.MobMPickupViewControllerBase {
    public OrgUserMobMPickupViewController() throws Exception {
        super();
        this.setId("3572b63b3481e0c66c93b6f3254613a9");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OrgUserMobMPickupView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OrgUserMobMPickupViewController",this);
    }
