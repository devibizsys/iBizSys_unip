...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_CCSQMobWFMainEditFormModel;
...
public class OA_CCSQCCSQLC_W20_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_CCSQMobWFMainEditFormModel editformModel = null;
    public OA_CCSQCCSQLC_W20_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_CCSQMobWFMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_CCSQMobWFMainEditFormModel getRealEditFormModel() {
