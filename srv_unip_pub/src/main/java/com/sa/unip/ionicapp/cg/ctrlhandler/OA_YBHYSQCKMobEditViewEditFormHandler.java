...
public class OA_YBHYSQCKMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YBHYSQMobWFFormEditFormModel editformModel = null;
    public OA_YBHYSQCKMobEditViewEditFormHandler()  {
        super();
    }
