...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_QXJMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_QXJQXJLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_QXJMobMOBMDCTRLModel listModel = null;
    public OA_QXJQXJLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_QXJMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_QXJMobMOBMDCTRLModel getRealListModel() {
