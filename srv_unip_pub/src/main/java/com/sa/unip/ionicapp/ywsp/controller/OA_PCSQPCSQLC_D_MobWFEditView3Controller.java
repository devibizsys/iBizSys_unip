...
/**
 * 视图[OA_PCSQPCSQLC_D_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_PCSQPCSQLC_D_MobWFEditView3.do")
public class OA_PCSQPCSQLC_D_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_PCSQPCSQLC_D_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("ba2f7e757867456d290b998f22f2fd3b");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_PCSQPCSQLC_D_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_PCSQPCSQLC_D_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_PCSQPCSQLC_D_MobWFEditView3EditFormHandler");
        editForm.init(this);
