...
/**
 * 视图[OA_CLWXMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CLWXMobEditView.do")
public class OA_CLWXMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CLWXMobEditViewController() throws Exception {
        super();
        this.setId("1fca1efdf3c5115a91bc0f39990ff759");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CLWXMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CLWXMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CLWXMobEditViewEditFormHandler");
        editForm.init(this);
