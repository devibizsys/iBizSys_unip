...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_PCSQMobWFFormEditFormModel;
...
public class OA_PCSQPCSQLC_W20_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_PCSQMobWFFormEditFormModel editformModel = null;
    public OA_PCSQPCSQLC_W20_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_PCSQMobWFFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_PCSQMobWFFormEditFormModel getRealEditFormModel() {
