...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_JPYDCurJpydMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_JPYDCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_JPYDCurJpydMobMOBMDCTRLModel listModel = null;
    public OA_JPYDCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_JPYDCurJpydMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_JPYDCurJpydMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurJpyd(deDataSetFetchContext);
    }
