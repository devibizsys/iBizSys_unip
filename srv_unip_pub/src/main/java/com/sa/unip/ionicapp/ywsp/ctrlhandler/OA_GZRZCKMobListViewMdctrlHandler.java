...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_GZRZCurGzrzMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_GZRZCKMobListViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_GZRZCurGzrzMobMOBMDCTRLModel listModel = null;
    public OA_GZRZCKMobListViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_GZRZCurGzrzMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_GZRZCurGzrzMobMOBMDCTRLModel getRealListModel() {
    ...
    protected DBFetchResult fetchDEDataSet(DEDataSetFetchContext deDataSetFetchContext) throws Exception {
        return  this.getRealService().fetchCurGzrz(deDataSetFetchContext);
    }
