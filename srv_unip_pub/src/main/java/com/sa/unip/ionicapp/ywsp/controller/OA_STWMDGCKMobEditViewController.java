...
/**
 * 视图[OA_STWMDGCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_STWMDGCKMobEditView.do")
public class OA_STWMDGCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_STWMDGCKMobEditViewController() throws Exception {
        super();
        this.setId("2345e347f3d791a02b9db8bb53bdd361");
        this.setCaption("食堂外卖订购");
        this.setTitle("食堂外卖订购查看");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_STWMDGCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_STWMDGCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_STWMDGCKMobEditViewEditFormHandler");
        editForm.init(this);
