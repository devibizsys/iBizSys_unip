 ...
 * 列表控件后台处理基类
 */
public class OA_GZRZRZTJLC_W_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_GZRZMobMOBMDCTRLModel listModel = null;
    public OA_GZRZRZTJLC_W_MobWFMDViewMdctrlHandler()  {
        super();
    }
