...
/**
 * 视图[OA_YYSSQSHJSMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/cg/OA_YYSSQSHJSMobEditView.do")
public class OA_YYSSQSHJSMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_YYSSQSHJSMobEditViewController() throws Exception {
        super();
        this.setId("f357e6232c424e2c3b4590e6c78865db");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/cg/OA_YYSSQSHJSMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.cg.controller.OA_YYSSQSHJSMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.cg.ctrlhandler.OA_YYSSQSHJSMobEditViewEditFormHandler");
        editForm.init(this);
