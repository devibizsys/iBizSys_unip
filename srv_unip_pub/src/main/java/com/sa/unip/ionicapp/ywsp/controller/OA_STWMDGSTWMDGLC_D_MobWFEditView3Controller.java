...
/**
 * 视图[OA_STWMDGSTWMDGLC_D_MobWFEditView3]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_STWMDGSTWMDGLC_D_MobWFEditView3.do")
public class OA_STWMDGSTWMDGLC_D_MobWFEditView3Controller extends net.ibizsys.pswf.controller.MobWFEditView3ControllerBase {
    public OA_STWMDGSTWMDGLC_D_MobWFEditView3Controller() throws Exception {
        super();
        this.setId("b70fb4eaa971125f9b90d0a0f518f1bb");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_STWMDGSTWMDGLC_D_MobWFEditView3.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_STWMDGSTWMDGLC_D_MobWFEditView3Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 form
        ICtrlModel editForm=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_STWMDGMobMainEditFormModel");
        editForm.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_STWMDGSTWMDGLC_D_MobWFEditView3EditFormHandler");
        editForm.init(this);
