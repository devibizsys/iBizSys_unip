...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_NSJGHYSQMobMainEditFormModel;
...
public class OA_NSJGHYSQNSJGHYSQ_D_MobWFEditView3EditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_NSJGHYSQMobMainEditFormModel editformModel = null;
    public OA_NSJGHYSQNSJGHYSQ_D_MobWFEditView3EditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_NSJGHYSQMobMainEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_NSJGHYSQMobMainEditFormModel getRealEditFormModel() {
    ...
    * 准备部件成员处理对象
    ...
    protected void prepareCtrlItemHandlers()throws Exception {
        ...
        //注册 'orgsectorname'
        IFormItemHandler orgsectornameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_NSJGHYSQMobMainEditFormOrgsectornameHandler");
        ...
        //注册 'hysname'
        IFormItemHandler hysnameHandler=(IFormItemHandler)iSystemRuntime.createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlhandler.OA_NSJGHYSQMobMainEditFormHysnameHandler");
        hysnameHandler.init(this.getEditFormModel(),this);
        this.registerCtrlItemHandler(ITEMACTIONTYPE_FORMITEM+"hysname",hysnameHandler);
