...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_YCSQMobMOBMDCTRLModel;
 ...
 * 列表控件后台处理基类
 */
public class OA_YCSQYCSQLC_D_MobWFMDViewMdctrlHandler extends net.ibizsys.paas.ctrlhandler.ListHandlerBase {
    protected OA_YCSQMobMOBMDCTRLModel listModel = null;
    public OA_YCSQYCSQLC_D_MobWFMDViewMdctrlHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        listModel = (OA_YCSQMobMOBMDCTRLModel)this.getViewController().getCtrlModel("mdctrl");
        super.onInit();
    }
    ...
    protected OA_YCSQMobMOBMDCTRLModel getRealListModel() {
