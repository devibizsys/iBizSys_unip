...
public class OA_YBHYSQSHJSMobEditViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFEditFormHandlerBase {

    protected OA_YBHYSQMobWFFormEditFormModel editformModel = null;
    public OA_YBHYSQSHJSMobEditViewEditFormHandler()  {
        super();
    }
