...
/**
 * 视图[WFWorkListYSPMobMDView9]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/WFWorkListYSPMobMDView9.do")
public class WFWorkListYSPMobMDView9Controller extends net.ibizsys.paas.controller.MobMDView9ControllerBase {
    public WFWorkListYSPMobMDView9Controller() throws Exception {
        super();
        this.setId("65ec7f8223f5ef7d19558f26821adcb7");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/WFWorkListYSPMobMDView9.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.WFWorkListYSPMobMDView9Controller",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.wf.ctrlmodel.WFWorkListYSPMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.WFWorkListYSPMobMDView9MdctrlHandler");
        mdctrl.init(this);
        this.registerCtrlHandler("mdctrl",mdctrl);
        //注册 searchform
        ICtrlHandler searchForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.WFWorkListYSPMobMDView9SearchFormHandler");
        searchForm.init(this);
