...
/**
 * 视图[OA_PCSQCKMobListView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_PCSQCKMobListView.do")
public class OA_PCSQCKMobListViewController extends net.ibizsys.paas.controller.MobListViewControllerBase {
    public OA_PCSQCKMobListViewController() throws Exception {
        super();
        this.setId("09713c9efa6847abaaf340d8a9104d0b");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_PCSQCKMobListView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_PCSQCKMobListViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlModels()throws Exception {
        //注册 mdctrl
        ICtrlModel mdctrl=(ICtrlModel)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_PCSQCurPcsqMobMOBMDCTRLModel");
        mdctrl.init(this);
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_PCSQCKMobListViewMdctrlHandler");
        mdctrl.init(this);
