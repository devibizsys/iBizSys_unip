...
/**
 * 视图[OA_GZRZRZTJLC_W_MobWFMDView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZRZTJLC_W_MobWFMDView.do")
public class OA_GZRZRZTJLC_W_MobWFMDViewController extends net.ibizsys.pswf.controller.MobWFMDViewControllerBase {
    public OA_GZRZRZTJLC_W_MobWFMDViewController() throws Exception {
        super();
        this.setId("34630c27831fc7f5fa7905659bb1c2b0");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZRZTJLC_W_MobWFMDView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZRZTJLC_W_MobWFMDViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_GZRZRZTJLC_W_MobWFMDViewMdctrlHandler");
        mdctrl.init(this);
