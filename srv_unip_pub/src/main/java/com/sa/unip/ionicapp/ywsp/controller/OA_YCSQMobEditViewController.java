...
/**
 * 视图[OA_YCSQMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_YCSQMobEditView.do")
public class OA_YCSQMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_YCSQMobEditViewController() throws Exception {
        super();
        this.setId("7330120a20b18002b841aa0a02a4665c");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_YCSQMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_YCSQMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_YCSQMobEditViewEditFormHandler");
        editForm.init(this);
