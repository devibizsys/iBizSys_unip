...
/**
 * 视图[WFStepDataMyTimeLineMobMDView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/WFStepDataMyTimeLineMobMDView.do")
public class WFStepDataMyTimeLineMobMDViewController extends net.ibizsys.paas.controller.MobMDViewControllerBase {
    public WFStepDataMyTimeLineMobMDViewController() throws Exception {
        super();
        this.setId("221dc36171072bcc8d1c24b697a33639");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/WFStepDataMyTimeLineMobMDView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.WFStepDataMyTimeLineMobMDViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 mdctrl
        ICtrlHandler mdctrl = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.WFStepDataMyTimeLineMobMDViewMdctrlHandler");
        mdctrl.init(this);
