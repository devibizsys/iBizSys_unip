...
/**
 * 视图[OA_CCSQCKMobEditView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_CCSQCKMobEditView.do")
public class OA_CCSQCKMobEditViewController extends net.ibizsys.pswf.controller.MobEditViewControllerBase {
    public OA_CCSQCKMobEditViewController() throws Exception {
        super();
        this.setId("518109a8d184b83e31cb9ba72d4685b2");
        this.setCaption("出差申请");
        this.setTitle("出差申请查看");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_CCSQCKMobEditView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_CCSQCKMobEditViewController",this);
    }
    ...
    */
    ...
    protected void prepareCtrlHandlers()throws Exception {
        //注册 form
        ICtrlHandler editForm = (ICtrlHandler)getUniPSampleSysModel().createObject("com.sa.unip.ionicapp.ywsp.ctrlhandler.OA_CCSQCKMobEditViewEditFormHandler");
        editForm.init(this);
