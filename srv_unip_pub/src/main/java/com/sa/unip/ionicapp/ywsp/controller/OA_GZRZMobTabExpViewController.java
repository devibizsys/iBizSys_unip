...
/**
 * 视图[OA_GZRZMobTabExpView]控制类基类
 *
 * !! 不要对此代码进行修改
 */
@Controller
@RequestMapping(value = "/IonicApp/ywsp/OA_GZRZMobTabExpView.do")
public class OA_GZRZMobTabExpViewController extends net.ibizsys.paas.controller.MobTabExpViewControllerBase {
    public OA_GZRZMobTabExpViewController() throws Exception {
        super();
        this.setId("4dbf0f506a23dadd4c4aaa7b553137b4");
        ...
        ViewControllerGlobal.registerViewController("/IonicApp/ywsp/OA_GZRZMobTabExpView.do",this);
        ViewControllerGlobal.registerViewController("com.sa.unip.ionicapp.ywsp.controller.OA_GZRZMobTabExpViewController",this);
    }
