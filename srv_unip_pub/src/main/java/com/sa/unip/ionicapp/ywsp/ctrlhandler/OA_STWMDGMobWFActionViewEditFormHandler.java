...
import com.sa.unip.ionicapp.srv.ywsp.ctrlmodel.OA_STWMDGSHYJMobFormEditFormModel;
...
public class OA_STWMDGMobWFActionViewEditFormHandler extends net.ibizsys.pswf.ctrlhandler.WFActionFormHandlerBase {

    protected OA_STWMDGSHYJMobFormEditFormModel editformModel = null;
    public OA_STWMDGMobWFActionViewEditFormHandler()  {
        super();
    }
    ...
    protected void onInit() throws Exception {
        ...
        editformModel  = (OA_STWMDGSHYJMobFormEditFormModel)this.getViewController().getCtrlModel("form");
        super.onInit();
    }
    ...
    protected OA_STWMDGSHYJMobFormEditFormModel getRealEditFormModel() {
