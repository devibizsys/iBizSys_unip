...
@DEDataQuery(id="440CD66A-8126-46AA-869D-17E74818AA0C",name="UX_ORGXJRY")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGID` LIKE  CONCAT(${srfsessioncontext('PRESJCODE','{\"defname\":\"ORGID\",\"dename\":\"ORGUSER\"}')},'%') )")
    }),
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID LIKE  ${srfsessioncontext('PRESJCODE','{\"defname\":\"ORGID\",\"dename\":\"ORGUSER\"}')} ||'%' )")
    })
})

public class OrgUserUX_ORGXJRYDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserUX_ORGXJRYDQModel() {
        super();

        this.initAnnotation(OrgUserUX_ORGXJRYDQModel.class);
    }
