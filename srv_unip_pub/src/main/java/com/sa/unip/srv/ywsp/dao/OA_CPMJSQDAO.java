 ...
 */
@Repository
public class OA_CPMJSQDAO extends com.sa.unip.srv.UniPSampleSysDAOBase<OA_CPMJSQ> {

    private static final long serialVersionUID = -1L;

    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_CURCPMJSQ = "CurCpmjsq";
    ...
    protected String getDAOId() {
        return "com.sa.unip.srv.ywsp.dao.OA_CPMJSQDAO";
    }
