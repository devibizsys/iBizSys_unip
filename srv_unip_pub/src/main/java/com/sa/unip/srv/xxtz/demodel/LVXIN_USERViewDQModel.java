...
@DEDataQuery(id="f6186b642dc3d87af1a14b72439b417f",name="VIEW",viewlevel=0)
@DEDataQueryCodes({
 ...
 *  实体数据查询 [默认（全部数据）]模型基类
 */
public class LVXIN_USERViewDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public LVXIN_USERViewDQModel() {
        super();

        this.initAnnotation(LVXIN_USERViewDQModel.class);
    }
