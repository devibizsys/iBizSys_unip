...
/**
 * 实体[OA_YYSSQ]逻辑处理[设置默认值]模型对象
 */
public class OA_YYSSQSZMRZLogicModel extends net.ibizsys.paas.demodel.DELogicModelBase<OA_YYSSQ> {

    private static final Log log = LogFactory.getLog(OA_YYSSQSZMRZLogicModel.class);

    public OA_YYSSQSZMRZLogicModel() {
        super();
        //设置逻辑基本信息
        this.setId("0F669D2C-83BC-4D14-BACA-131F24A2620B");
        this.setName("SZMRZ");
        //设置默认参数名称
    ...
    */
    protected void executeBegin(IActionContext iActionContext) throws Exception {
        com.sa.unip.srv.ywsp.entity.OA_YYSSQ _default = (com.sa.unip.srv.ywsp.entity.OA_YYSSQ)iActionContext.getParam("Default");
    ...
    */
    protected void executeRawsqlcall1(IActionContext iActionContext) throws Exception {
        ...
        String strSQL = "select concat( ?,'的饮用水申请') oa_yyssqname from dual";
//准备参数
