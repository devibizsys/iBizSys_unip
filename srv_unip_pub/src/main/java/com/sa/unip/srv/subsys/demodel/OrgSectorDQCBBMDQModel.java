...
@DEDataQuery(id="7AABE27C-74A1-4D60-963F-8DFE17BE446E",name="DQCBBM")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGNAME =  ${srfdatacontext('cbdw_mc','{\"defname\":\"ORGNAME\",\"dename\":\"ORGSECTOR\"}')} )")
    }),
...
public class OrgSectorDQCBBMDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorDQCBBMDQModel() {
        super();

        this.initAnnotation(OrgSectorDQCBBMDQModel.class);
    }
