...
@DEDataQuery(id="D068A102-DFBA-486F-BA81-D44D77A0A057",name="YCH")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`CHZT` = '30' )")
    })
})
/**
 *  实体数据查询 [已参会人数统计]模型基类
 */
public class OA_CHRYYCHDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_CHRYYCHDQModel() {
        super();

        this.initAnnotation(OA_CHRYYCHDQModel.class);
    }
