...
/**
 * 实体[OA_JPYD]逻辑处理[设置默认值]模型对象
 */
public class OA_JPYDSZMRZLogicModel extends net.ibizsys.paas.demodel.DELogicModelBase<OA_JPYD> {

    private static final Log log = LogFactory.getLog(OA_JPYDSZMRZLogicModel.class);

    public OA_JPYDSZMRZLogicModel() {
        super();
        //设置逻辑基本信息
        this.setId("5F473031-2AB0-4817-8F67-F252D70AC97A");
        this.setName("SZMRZ");
        //设置默认参数名称
    ...
    */
    protected void executeRawsqlcall1(IActionContext iActionContext) throws Exception {
        com.sa.unip.srv.ywsp.entity.OA_JPYD _default = (com.sa.unip.srv.ywsp.entity.OA_JPYD)iActionContext.getParam("Default");
        SessionFactory sessionFactory = iActionContext.getSessionFactory();

        String strSQL = "select concat(?,'的机票预定') oa_jpydname from dual";
//准备参数
