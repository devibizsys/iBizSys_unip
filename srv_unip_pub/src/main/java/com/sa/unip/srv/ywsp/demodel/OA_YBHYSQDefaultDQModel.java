...
@DEDataQuery(id="496247DF-DD79-492F-B2B5-D127EA54AB1A",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class OA_YBHYSQDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_YBHYSQDefaultDQModel() {
        super();

        this.initAnnotation(OA_YBHYSQDefaultDQModel.class);
    }
