...
@DEDataQuery(id="2B95C073-7438-4D41-B881-9016ADE0D67D",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class LVXIN_CIMSESSIONDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public LVXIN_CIMSESSIONDefaultDQModel() {
        super();

        this.initAnnotation(LVXIN_CIMSESSIONDefaultDQModel.class);
    }
