...
@DEDataQuery(id="2DE5447D-719E-4454-B315-25FDEE41F8CE",name="CurBgypsq")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGUSERID` =  ${srfsessioncontext('SRFPERSONID','{\"defname\":\"ORGUSERID\",\"dename\":\"OA_BGYPSQ\"}')} )")
    })
})
/**
 *  实体数据查询 [我的办公用品申请记录]模型基类
 */
public class OA_BGYPSQCurBgypsqDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_BGYPSQCurBgypsqDQModel() {
        super();

        this.initAnnotation(OA_BGYPSQCurBgypsqDQModel.class);
    }
