...
@DEDataQuery(id="C2C2EF9A-F585-425A-B5FA-6B209C603BB9",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class OA_JPYDDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_JPYDDefaultDQModel() {
        super();

        this.initAnnotation(OA_JPYDDefaultDQModel.class);
    }
