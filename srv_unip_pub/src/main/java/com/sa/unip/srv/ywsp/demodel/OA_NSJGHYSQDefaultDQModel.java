...
@DEDataQuery(id="2EA0D0E5-E11B-4934-AF41-5926E8BF5D7B",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class OA_NSJGHYSQDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_NSJGHYSQDefaultDQModel() {
        super();

        this.initAnnotation(OA_NSJGHYSQDefaultDQModel.class);
    }
