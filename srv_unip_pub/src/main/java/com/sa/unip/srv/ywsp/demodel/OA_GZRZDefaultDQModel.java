...
@DEDataQuery(id="9E65CB7B-BF62-4F57-A9F2-7FFBD4129A64",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class OA_GZRZDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_GZRZDefaultDQModel() {
        super();

        this.initAnnotation(OA_GZRZDefaultDQModel.class);
    }
