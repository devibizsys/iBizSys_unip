...
@DEDataQuery(id="663636EC-123A-4716-862A-B5081B2CF075",name="CurPcsq")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGUSERID` =  ${srfsessioncontext('SRFPERSONID','{\"defname\":\"ORGUSERID\",\"dename\":\"OA_PCSQ\"}')} )")
    })
})
/**
 *  实体数据查询 [我的派车申请记录]模型基类
 */
public class OA_PCSQCurPcsqDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_PCSQCurPcsqDQModel() {
        super();

        this.initAnnotation(OA_PCSQCurPcsqDQModel.class);
    }
