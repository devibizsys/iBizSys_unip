...
/**
 * 实体[OA_BGYPSQ]逻辑处理[设置默认值]模型对象
 */
public class OA_BGYPSQSZMRZLogicModel extends net.ibizsys.paas.demodel.DELogicModelBase<OA_BGYPSQ> {

    private static final Log log = LogFactory.getLog(OA_BGYPSQSZMRZLogicModel.class);

    public OA_BGYPSQSZMRZLogicModel() {
        super();
        //设置逻辑基本信息
        this.setId("FD470EF7-8825-4D83-9B56-5BC14CF5E9DE");
        this.setName("SZMRZ");
        //设置默认参数名称
    ...
    */
    protected void executeRawsqlcall1(IActionContext iActionContext) throws Exception {
        com.sa.unip.srv.ywsp.entity.OA_BGYPSQ _default = (com.sa.unip.srv.ywsp.entity.OA_BGYPSQ)iActionContext.getParam("Default");
        SessionFactory sessionFactory = iActionContext.getSessionFactory();

        String strSQL = "select concat( ?,'的办公用品申请') oa_bgypsqname from dual";
//准备参数
