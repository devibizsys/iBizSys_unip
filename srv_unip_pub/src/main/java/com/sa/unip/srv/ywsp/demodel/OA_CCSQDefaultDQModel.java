...
@DEDataQuery(id="593314DC-FAF1-41BE-BC04-C1C01FFD3412",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class OA_CCSQDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_CCSQDefaultDQModel() {
        super();

        this.initAnnotation(OA_CCSQDefaultDQModel.class);
    }
