...
@DEDataQuery(id="E61D00E5-CC70-4F43-8763-3FC4C87FAA25",name="DQCBR")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGNAME =  ${srfdatacontext('cbdw_mc','{\"defname\":\"ORGNAME\",\"dename\":\"ORGUSER\"}')}  AND  t1.ORGSECTORNAME =  ${srfdatacontext('cbbm_mc','{\"defname\":\"ORGSECTORNAME\",\"dename\":\"ORGUSER\"}')} )")
    }),
...
public class OrgUserDQCBRDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserDQCBRDQModel() {
        super();

        this.initAnnotation(OrgUserDQCBRDQModel.class);
    }
