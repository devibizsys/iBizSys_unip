 ...
 */
@Repository
public class OA_YBHYSQDAO extends com.sa.unip.srv.UniPSampleSysDAOBase<OA_YBHYSQ> {

    private static final long serialVersionUID = -1L;

    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_CURYBHYSQ = "CurYbhysq";
    ...
    protected String getDAOId() {
        return "com.sa.unip.srv.ywsp.dao.OA_YBHYSQDAO";
    }
