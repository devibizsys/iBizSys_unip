...
@DEDataQuery(id="3B0AE1B6-058F-4076-A4AC-65603F52A127",name="UX_QSDW")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGCODE` LIKE  CONCAT(${srfsessioncontext('SRFSJCODE','{\"defname\":\"ORGCODE\",\"dename\":\"ORG\"}')},'%') )")
    }),
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGCODE LIKE  ${srfsessioncontext('SRFSJCODE','{\"defname\":\"ORGCODE\",\"dename\":\"ORG\"}')} ||'%' )")
    })
})

public class OrgUX_QSDWDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUX_QSDWDQModel() {
        super();

        this.initAnnotation(OrgUX_QSDWDQModel.class);
    }
