...
@DEDataQuery(id="5B030788-BFB6-4AF1-9FD9-512160578972",name="UX_PRO")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGID` =  ${srfsessioncontext('SRFORGID','{\"defname\":\"ORGID\",\"dename\":\"ORG\"}')}  AND  t1.`PORGID` IS NULL )")
    }),
...
public class OrgUX_PRODQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUX_PRODQModel() {
        super();

        this.initAnnotation(OrgUX_PRODQModel.class);
    }
