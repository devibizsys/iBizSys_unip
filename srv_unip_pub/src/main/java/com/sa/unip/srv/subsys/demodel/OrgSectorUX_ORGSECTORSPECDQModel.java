...
@DEDataQuery(id="46BDF465-8042-48E5-AC2F-C8C9647B5DBB",name="UX_ORGSECTORSPEC")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID LIKE  ${srfwebcontext('PRECODE','{\"defname\":\"ORGID\",\"dename\":\"ORGSECTOR\"}')} ||'%' )")
    }),
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGID` LIKE  CONCAT(${srfwebcontext('PRECODE','{\"defname\":\"ORGID\",\"dename\":\"ORGSECTOR\"}')},'%') )")
    })
})

public class OrgSectorUX_ORGSECTORSPECDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorUX_ORGSECTORSPECDQModel() {
        super();

        this.initAnnotation(OrgSectorUX_ORGSECTORSPECDQModel.class);
    }
