...
@DEDataQuery(id="74FBDBBE-9220-4609-88BE-18ED559235FF",name="UX_CITYDW")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID LIKE  ${srfdatacontext('nodeid','{\"defname\":\"ORGID\",\"dename\":\"ORG\"}')} ||'%' )")
    }),
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`PORGID` LIKE  CONCAT(${srfdatacontext('nodeid','{\"defname\":\"PORGID\",\"dename\":\"ORG\"}')},'%') )")
    })
})

public class OrgUX_CITYDWDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUX_CITYDWDQModel() {
        super();

        this.initAnnotation(OrgUX_CITYDWDQModel.class);
    }
