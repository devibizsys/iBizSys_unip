...
@DEDataQuery(id="1212ED0D-1CE9-478A-AD54-C5AF308D84DA",name="CurStwmdg")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGUSERID` =  ${srfsessioncontext('SRFPERSONID','{\"defname\":\"ORGUSERID\",\"dename\":\"OA_STWMDG\"}')} )")
    })
})
/**
 *  实体数据查询 [我的外卖订购记录]模型基类
 */
public class OA_STWMDGCurStwmdgDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_STWMDGCurStwmdgDQModel() {
        super();

        this.initAnnotation(OA_STWMDGCurStwmdgDQModel.class);
    }
