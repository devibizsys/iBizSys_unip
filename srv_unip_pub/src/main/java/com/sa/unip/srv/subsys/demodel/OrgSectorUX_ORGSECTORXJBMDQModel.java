...
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGID` LIKE  CONCAT(${srfsessioncontext('PRESJCODE','{\"defname\":\"ORGID\",\"dename\":\"ORGSECTOR\"}')},'%') )")
    }),
    @DEDataQueryCode(querycode="SELECT t1.BIZCODE, t1.CREATEDATE, t1.CREATEMAN, t1.LEVELCODE, t1.MEMO, t1.ORDERVALUE, t1.ORGCODE, t1.ORGID, t1.ORGNAME, t1.ORGSECTORID, t1.ORGSECTORNAME, t1.PORGSECTORID, t1.PORGSECTORNAME, t1.REPORGSECTORID, t1.REPORGSECTORNAME, t1.RESERVER, t1.RESERVER10, t1.RESERVER11, t1.RESERVER12, t1.RESERVER13, t1.RESERVER14, t1.RESERVER15, t1.RESERVER16, t1.RESERVER17, t1.RESERVER18, t1.RESERVER19, t1.RESERVER2, t1.RESERVER20, t1.RESERVER21, t1.RESERVER22, t1.RESERVER25, t1.RESERVER26, t1.RESERVER27, t1.RESERVER28, t1.RESERVER29, t1.RESERVER3, t1.RESERVER30, t1.RESERVER4, t1.RESERVER5, t1.RESERVER6, t1.RESERVER7, t1.RESERVER8, t1.RESERVER9, t1.SHORTNAME, t1.UPDATEDATE, t1.UPDATEMAN, t1.USERDATA, t1.USERDATA2, t1.VALIDFLAG, t1.VIRTUALFLAG FROM T_SRFORGSECTOR t1  ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="RESERVER23",expression="t1.RESERVER23")
        ,@DEDataQueryCodeExp(name="RESERVER24",expression="t1.RESERVER24")
        ,@DEDataQueryCodeExp(name="BIZCODE",expression="t1.BIZCODE")
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID LIKE  ${srfsessioncontext('PRESJCODE','{\"defname\":\"ORGID\",\"dename\":\"ORGSECTOR\"}')} ||'%' )")
    })
})

public class OrgSectorUX_ORGSECTORXJBMDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorUX_ORGSECTORXJBMDQModel() {
        super();

        this.initAnnotation(OrgSectorUX_ORGSECTORXJBMDQModel.class);
    }
