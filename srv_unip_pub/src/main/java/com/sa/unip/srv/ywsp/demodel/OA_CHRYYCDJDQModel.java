...
@DEDataQuery(id="2869E093-3A95-4439-BE52-76F7E0E2194F",name="YCDJ")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`CHZT` = '40' )")
    })
})
/**
 *  实体数据查询 [已迟到人数统计]模型基类
 */
public class OA_CHRYYCDJDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_CHRYYCDJDQModel() {
        super();

        this.initAnnotation(OA_CHRYYCDJDQModel.class);
    }
