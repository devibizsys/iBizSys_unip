...
@DEDataQuery(id="3063D6F0-CA35-4E2C-93F4-BFBE858C664C",name="CurClwx")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGUSERID` =  ${srfsessioncontext('SRFPERSONID','{\"defname\":\"ORGUSERID\",\"dename\":\"OA_CLWX\"}')} )")
    })
})
/**
 *  实体数据查询 [我的车辆维修]模型基类
 */
public class OA_CLWXCurClwxDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_CLWXCurClwxDQModel() {
        super();

        this.initAnnotation(OA_CLWXCurClwxDQModel.class);
    }
