...
@CodeList(id="FE2DDE36-F64B-4B0C-B20A-215E438B0ACC",name="内设机构会议申请状态",type="STATIC",userscope=false,emptytext="未定义")
...
/**
 * 静态代码表[内设机构会议申请状态]模型类
 */
public class CL_NSJGHYSQZTCodeListModel extends com.sa.unip.srv.codelist.UniPSampleStaticCodeListModelBase  {
    ...
    public CL_NSJGHYSQZTCodeListModel() {
        super();
        this.initAnnotation(CL_NSJGHYSQZTCodeListModel.class);
        CodeListGlobal.registerCodeList("com.sa.unip.srv.codelist.CL_NSJGHYSQZTCodeListModel", this);
    }
