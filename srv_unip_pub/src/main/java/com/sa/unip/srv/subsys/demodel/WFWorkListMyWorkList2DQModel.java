...
@DEDataQuery(id="0BF3CE61-CEDA-4F92-A37F-D82FDFC2C0BD",name="MyWorkList2")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`CANCELFLAG` = 1  AND  t1.`WFACTORID` =  ${srfsessioncontext('SRFPERSONID','{\"defname\":\"WFACTORID\",\"dename\":\"WFWORKLIST\"}')} )")
    })
})

public class WFWorkListMyWorkList2DQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public WFWorkListMyWorkList2DQModel() {
        super();

        this.initAnnotation(WFWorkListMyWorkList2DQModel.class);
    }
