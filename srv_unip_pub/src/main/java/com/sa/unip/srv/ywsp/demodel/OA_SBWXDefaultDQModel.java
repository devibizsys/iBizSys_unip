...
@DEDataQuery(id="771BE2AB-E1B3-4DA8-A866-8A1D8F95D2D0",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class OA_SBWXDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_SBWXDefaultDQModel() {
        super();

        this.initAnnotation(OA_SBWXDefaultDQModel.class);
    }
