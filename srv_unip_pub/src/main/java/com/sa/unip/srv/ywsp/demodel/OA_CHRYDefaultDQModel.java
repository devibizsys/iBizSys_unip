...
@DEDataQuery(id="63C6E203-B6CF-4913-91BE-4CCD37EAC95C",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public class OA_CHRYDefaultDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_CHRYDefaultDQModel() {
        super();

        this.initAnnotation(OA_CHRYDefaultDQModel.class);
    }
