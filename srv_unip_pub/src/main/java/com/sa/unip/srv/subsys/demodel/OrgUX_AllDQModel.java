...
@DEDataQuery(id="FC873C60-95D3-4C95-AB7A-A8C65B3C3F5C",name="UX_All")
@DEDataQueryCodes({
...
public class OrgUX_AllDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUX_AllDQModel() {
        super();

        this.initAnnotation(OrgUX_AllDQModel.class);
    }
