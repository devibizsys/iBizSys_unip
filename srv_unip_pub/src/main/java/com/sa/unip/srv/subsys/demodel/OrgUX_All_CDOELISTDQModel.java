...
@DEDataQuery(id="44B39E1D-6F50-4A42-89A2-A0DB55C400E9",name="UX_All_CDOELIST")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGCODE LIKE  ${srfsessioncontext('SRFORGCODE','{\"defname\":\"ORGCODE\",\"dename\":\"ORG\"}')} ||'%' )")
    }),
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGCODE` LIKE  CONCAT(${srfsessioncontext('SRFORGCODE','{\"defname\":\"ORGCODE\",\"dename\":\"ORG\"}')},'%') )")
    })
})

public class OrgUX_All_CDOELISTDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUX_All_CDOELISTDQModel() {
        super();

        this.initAnnotation(OrgUX_All_CDOELISTDQModel.class);
    }
