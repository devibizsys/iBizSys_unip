...
/**
 * 实体[OA_STWMDG]逻辑处理[设置默认值]模型对象
 */
public class OA_STWMDGSZMRZLogicModel extends net.ibizsys.paas.demodel.DELogicModelBase<OA_STWMDG> {

    private static final Log log = LogFactory.getLog(OA_STWMDGSZMRZLogicModel.class);

    public OA_STWMDGSZMRZLogicModel() {
        super();
        //设置逻辑基本信息
        this.setId("D0AB0B63-79E9-42FA-876A-701155B0B33C");
        this.setName("SZMRZ");
        //设置默认参数名称
    ...
    */
    protected void executeBegin(IActionContext iActionContext) throws Exception {
        com.sa.unip.srv.ywsp.entity.OA_STWMDG _default = (com.sa.unip.srv.ywsp.entity.OA_STWMDG)iActionContext.getParam("Default");
    ...
    */
    protected void executeRawsqlcall1(IActionContext iActionContext) throws Exception {
        ...
        String strSQL = "select concat(?,'的食堂外卖订购') oa_stwmdgname from dual";
//准备参数
