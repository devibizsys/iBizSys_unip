 ...
 */
@Repository
public class OA_PCSQDAO extends com.sa.unip.srv.UniPSampleSysDAOBase<OA_PCSQ> {

    private static final long serialVersionUID = -1L;

    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_CURPCSQ = "CurPcsq";
    ...
    protected String getDAOId() {
        return "com.sa.unip.srv.ywsp.dao.OA_PCSQDAO";
    }
