...
@DEDataQuery(id="C12A1752-E63D-4D27-B3A4-ECAC09CCB328",name="UX_All_SJ_AH")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( ( t1.ORGCODE LIKE '32%'  OR  t1.ORGCODE LIKE '34%'  OR  t1.ORGCODE LIKE '53%'  OR  t1.ORGCODE LIKE '45%' ) )")
    }),
...
public class OrgUX_All_SJ_AHDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUX_All_SJ_AHDQModel() {
        super();

        this.initAnnotation(OrgUX_All_SJ_AHDQModel.class);
    }
