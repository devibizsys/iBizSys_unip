...
@DEDataQuery(id="46B29C4C-A6BD-447F-9675-07C9A39BB933",name="CurYyssq")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGUSERID` =  ${srfsessioncontext('SRFPERSONID','{\"defname\":\"ORGUSERID\",\"dename\":\"OA_YYSSQ\"}')} )")
    })
})
/**
 *  实体数据查询 [我的饮用水申请]模型基类
 */
public class OA_YYSSQCurYyssqDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_YYSSQCurYyssqDQModel() {
        super();

        this.initAnnotation(OA_YYSSQCurYyssqDQModel.class);
    }
