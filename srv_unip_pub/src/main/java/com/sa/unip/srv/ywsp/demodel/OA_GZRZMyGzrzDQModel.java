...
@DEDataQuery(id="26EAA134-7E54-4873-9891-F805890D4745",name="MyGzrz")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [我的工作日志]模型基类
 */
public class OA_GZRZMyGzrzDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_GZRZMyGzrzDQModel() {
        super();

        this.initAnnotation(OA_GZRZMyGzrzDQModel.class);
    }
