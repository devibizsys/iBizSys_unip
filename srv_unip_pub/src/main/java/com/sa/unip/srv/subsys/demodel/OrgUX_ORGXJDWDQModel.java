...
@DEDataQuery(id="6883D7B5-681C-49F6-A305-303F3C83F81A",name="UX_ORGXJDW")
@DEDataQueryCodes({
...
public class OrgUX_ORGXJDWDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUX_ORGXJDWDQModel() {
        super();

        this.initAnnotation(OrgUX_ORGXJDWDQModel.class);
    }
