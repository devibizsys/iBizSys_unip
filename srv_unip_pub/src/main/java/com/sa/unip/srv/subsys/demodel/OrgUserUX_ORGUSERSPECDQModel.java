...
@DEDataQuery(id="BE1C6462-5686-46B9-8E46-1CFCB77523B9",name="UX_ORGUSERSPEC")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID LIKE  ${srfwebcontext('PRECODE','{\"defname\":\"ORGID\",\"dename\":\"ORGUSER\"}')} ||'%' )")
    }),
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGID` LIKE  CONCAT(${srfwebcontext('PRECODE','{\"defname\":\"ORGID\",\"dename\":\"ORGUSER\"}')},'%') )")
    })
})

public class OrgUserUX_ORGUSERSPECDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserUX_ORGUSERSPECDQModel() {
        super();

        this.initAnnotation(OrgUserUX_ORGUSERSPECDQModel.class);
    }
