...
@DEDataQuery(id="4DB7A146-4F3B-42B7-9E6E-2FCA2F37A940",name="AHUX_All")
@DEDataQueryCodes({
...
public class OrgAHUX_AllDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgAHUX_AllDQModel() {
        super();

        this.initAnnotation(OrgAHUX_AllDQModel.class);
    }
