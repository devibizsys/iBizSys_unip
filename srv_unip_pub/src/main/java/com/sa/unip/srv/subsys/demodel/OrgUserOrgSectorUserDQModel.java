...
@DEDataQuery(id="FFD9BCFA-670A-45F3-8FDE-ED6D436A08B0",name="ORGSECTORUSER")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGSECTORID` =  ${srfdatacontext('nodeid','{\"defname\":\"ORGSECTORID\",\"dename\":\"ORGUSER\"}')} )")
    })
})

public class OrgUserOrgSectorUserDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserOrgSectorUserDQModel() {
        super();

        this.initAnnotation(OrgUserOrgSectorUserDQModel.class);
    }
