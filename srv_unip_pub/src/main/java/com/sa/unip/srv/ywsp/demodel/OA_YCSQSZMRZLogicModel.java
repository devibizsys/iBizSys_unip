...
/**
 * 实体[OA_YCSQ]逻辑处理[设置默认值]模型对象
 */
public class OA_YCSQSZMRZLogicModel extends net.ibizsys.paas.demodel.DELogicModelBase<OA_YCSQ> {

    private static final Log log = LogFactory.getLog(OA_YCSQSZMRZLogicModel.class);

    public OA_YCSQSZMRZLogicModel() {
        super();
        //设置逻辑基本信息
        this.setId("BB0FC044-2BDD-407D-8FC3-95339ED7C15E");
        this.setName("SZMRZ");
        //设置默认参数名称
    ...
    */
    protected void executeBegin(IActionContext iActionContext) throws Exception {
        com.sa.unip.srv.ywsp.entity.OA_YCSQ _default = (com.sa.unip.srv.ywsp.entity.OA_YCSQ)iActionContext.getParam("Default");
    ...
    */
    protected void executeRawsqlcall1(IActionContext iActionContext) throws Exception {
        ...
        String strSQL = "select concat( ?,'的用餐申请') oa_ycsqname from dual";
//准备参数
