...
@DEDataQuery(id="77761559-B61D-4995-BA11-B7730CDF2A67",name="MyReceive")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.`ORGUSERID` =  ${srfsessioncontext('SRFPERSONID','{\"defname\":\"ORGUSERID\",\"dename\":\"OA_RZRY\"}')} )")
    })
})
/**
 *  实体数据查询 [我收到的]模型基类
 */
public class OA_RZRYMyReceiveDQModel extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OA_RZRYMyReceiveDQModel() {
        super();

        this.initAnnotation(OA_RZRYMyReceiveDQModel.class);
    }
