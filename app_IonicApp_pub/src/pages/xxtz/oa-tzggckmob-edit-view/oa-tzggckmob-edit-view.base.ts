...
import {
	formService,
 } from './oa-tzggckmob-edit-view.service';

export class OA_TZGGCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_TZGGCKMobEditView.do' }));
  }
