...
import { OA_TZGGCKMobEditViewBase } from './oa-tzggckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggckmob-edit-view',
  templateUrl: 'oa-tzggckmob-edit-view.html',
})

export class OA_TZGGCKMobEditView extends OA_TZGGCKMobEditViewBase {
