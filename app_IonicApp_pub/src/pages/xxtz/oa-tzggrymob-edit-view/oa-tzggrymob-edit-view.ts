...
import { OA_TZGGRYMobEditViewBase } from './oa-tzggrymob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggrymob-edit-view',
  templateUrl: 'oa-tzggrymob-edit-view.html',
})

export class OA_TZGGRYMobEditView extends OA_TZGGRYMobEditViewBase {
