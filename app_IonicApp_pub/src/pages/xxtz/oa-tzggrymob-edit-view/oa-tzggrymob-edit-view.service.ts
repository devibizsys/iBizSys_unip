...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'oa_tzggryid', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'orguserid', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'oa_tzggryname', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'sfyd', 'visible': true, 'allowEmpty': false});
