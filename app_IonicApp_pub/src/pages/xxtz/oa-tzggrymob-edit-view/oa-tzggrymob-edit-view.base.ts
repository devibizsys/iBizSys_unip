...
import {
	formService,
 } from './oa-tzggrymob-edit-view.service';

export class OA_TZGGRYMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_TZGGRYMobEditView.do' }));
  }
