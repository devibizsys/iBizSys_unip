...
import { OA_TZGGWDMobMDView9Base } from './oa-tzggwdmob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggwdmob-mdview9',
  templateUrl: 'oa-tzggwdmob-mdview9.html',
})

export class OA_TZGGWDMobMDView9 extends OA_TZGGWDMobMDView9Base {
