...
import {
 } from './oa-rzrymob-tab-exp-view.service';

export class OA_RZRYMobTabExpViewBase extends IBizTabExpViewController {
  ...
  tab: IBizTabService;
    ...
    constructor(opt) {
        super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_RZRYMobTabExpView.do' }));
