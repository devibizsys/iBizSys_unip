...
import { OA_RZRYMobTabExpViewBase } from './oa-rzrymob-tab-exp-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-rzrymob-tab-exp-view',
  templateUrl: 'oa-rzrymob-tab-exp-view.html',
})

export class OA_RZRYMobTabExpView extends OA_RZRYMobTabExpViewBase {
