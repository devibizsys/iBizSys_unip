...
import { OA_TZGGTZGGSQLC_W10_MobWFEditView3Base } from './oa-tzggtzggsqlc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggtzggsqlc-w10-mob-wfedit-view3',
  templateUrl: 'oa-tzggtzggsqlc-w10-mob-wfedit-view3.html',
})

export class OA_TZGGTZGGSQLC_W10_MobWFEditView3 extends OA_TZGGTZGGSQLC_W10_MobWFEditView3Base {
