...
import {
	formService,
 } from './oa-tzggtzggsqlc-w10-mob-wfedit-view3.service';

export class OA_TZGGTZGGSQLC_W10_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_TZGGTZGGSQLC_W10_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC1020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_TZGGMobWFActionView","viewParam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"title":"通知公告",openMode:'POPUPMODAL'}
        };
