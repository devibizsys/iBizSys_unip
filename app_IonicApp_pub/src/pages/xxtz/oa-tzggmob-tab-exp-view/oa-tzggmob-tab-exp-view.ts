...
import { OA_TZGGMobTabExpViewBase } from './oa-tzggmob-tab-exp-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggmob-tab-exp-view',
  templateUrl: 'oa-tzggmob-tab-exp-view.html',
})

export class OA_TZGGMobTabExpView extends OA_TZGGMobTabExpViewBase {
