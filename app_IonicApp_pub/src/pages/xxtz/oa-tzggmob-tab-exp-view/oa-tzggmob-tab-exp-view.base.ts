...
import {
 } from './oa-tzggmob-tab-exp-view.service';

export class OA_TZGGMobTabExpViewBase extends IBizTabExpViewController {
  ...
  tab: IBizTabService;
    ...
    constructor(opt) {
        super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_TZGGMobTabExpView.do' }));
