...
import { OA_TZGGMobWFActionViewBase } from './oa-tzggmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggmob-wfaction-view',
  templateUrl: 'oa-tzggmob-wfaction-view.html',
})

export class OA_TZGGMobWFActionView extends OA_TZGGMobWFActionViewBase {
