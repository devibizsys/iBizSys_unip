...
import { OA_TZGGTZGGSQLC_W_MobWFMDViewBase } from './oa-tzggtzggsqlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggtzggsqlc-w-mob-wfmdview',
  templateUrl: 'oa-tzggtzggsqlc-w-mob-wfmdview.html',
})

export class OA_TZGGTZGGSQLC_W_MobWFMDView extends OA_TZGGTZGGSQLC_W_MobWFMDViewBase {
