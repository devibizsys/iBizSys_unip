...
import {
	mdctrlService,
 } from './oa-tzggmob-list-view.service';

export class OA_TZGGMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_TZGGMobListView.do' }));
  }
