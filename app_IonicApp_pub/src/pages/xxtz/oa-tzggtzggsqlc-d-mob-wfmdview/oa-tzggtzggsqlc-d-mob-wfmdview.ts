...
import { OA_TZGGTZGGSQLC_D_MobWFMDViewBase } from './oa-tzggtzggsqlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggtzggsqlc-d-mob-wfmdview',
  templateUrl: 'oa-tzggtzggsqlc-d-mob-wfmdview.html',
})

export class OA_TZGGTZGGSQLC_D_MobWFMDView extends OA_TZGGTZGGSQLC_D_MobWFMDViewBase {
