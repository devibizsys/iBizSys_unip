...
import { OA_TZGGYDMobMDView9Base } from './oa-tzggydmob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggydmob-mdview9',
  templateUrl: 'oa-tzggydmob-mdview9.html',
})

export class OA_TZGGYDMobMDView9 extends OA_TZGGYDMobMDView9Base {
