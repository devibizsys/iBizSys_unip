...
import {
	mdctrlService,
 } from './oa-tzggydmob-mdview9.service';

export class OA_TZGGYDMobMDView9Base extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_TZGGYDMobMDView9.do' }));
  }
