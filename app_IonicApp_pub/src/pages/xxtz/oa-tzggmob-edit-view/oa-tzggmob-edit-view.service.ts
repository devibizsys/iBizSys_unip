...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'oa_tzggid', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'oa_tzggname', 'visible': true, 'allowEmpty': true});
        this.regItem({'name': 'orguserid', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'orgusername', 'visible': true, 'allowEmpty': true});
        this.regItem({'name': 'fssj', 'visible': true, 'allowEmpty': true});
        this.regItem({'name': 'content', 'visible': true, 'allowEmpty': true});
