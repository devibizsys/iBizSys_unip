...
import { OA_TZGGMobEditViewBase } from './oa-tzggmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggmob-edit-view',
  templateUrl: 'oa-tzggmob-edit-view.html',
})

export class OA_TZGGMobEditView extends OA_TZGGMobEditViewBase {
