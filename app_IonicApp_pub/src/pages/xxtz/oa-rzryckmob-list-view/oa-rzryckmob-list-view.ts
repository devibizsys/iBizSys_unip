...
import { OA_RZRYCKMobListViewBase } from './oa-rzryckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-rzryckmob-list-view',
  templateUrl: 'oa-rzryckmob-list-view.html',
})

export class OA_RZRYCKMobListView extends OA_RZRYCKMobListViewBase {
