...
import {
	mdctrlService,
	searchformService,
 } from './oa-rzryckmob-list-view.service';

export class OA_RZRYCKMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;
    searchform: searchformService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_RZRYCKMobListView.do' }));
  }
