...
import { OA_TZGGCKMobListViewBase } from './oa-tzggckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggckmob-list-view',
  templateUrl: 'oa-tzggckmob-list-view.html',
})

export class OA_TZGGCKMobListView extends OA_TZGGCKMobListViewBase {
