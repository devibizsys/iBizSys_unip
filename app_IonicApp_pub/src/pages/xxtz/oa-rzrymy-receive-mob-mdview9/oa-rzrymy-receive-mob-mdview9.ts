...
import { OA_RZRYMyReceiveMobMDView9Base } from './oa-rzrymy-receive-mob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-rzrymy-receive-mob-mdview9',
  templateUrl: 'oa-rzrymy-receive-mob-mdview9.html',
})

export class OA_RZRYMyReceiveMobMDView9 extends OA_RZRYMyReceiveMobMDView9Base {
