...
import {
	mdctrlService,
	searchformService,
 } from './oa-rzrymy-receive-mob-mdview9.service';

export class OA_RZRYMyReceiveMobMDView9Base extends IBizListViewController {

    mdctrl: mdctrlService;
    searchform: searchformService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_RZRYMyReceiveMobMDView9.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getNewDataView(params: any = {}): any {
      ...
      if(true){
      	let view={
            openMode:'',
            className:'OA_RZRYCKMobEditView',
            viewParam:params
      	};
      	return view;
      }
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_RZRYCKMobEditView', viewParam:params };
      }
    }
