...
import {
	formService,
 } from './oa-tzggtzggsqlc-d-mob-wfedit-view3.service';

export class OA_TZGGTZGGSQLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_TZGGTZGGSQLC_D_MobWFEditView3.do' }));
  }
