...
import { OA_TZGGTZGGSQLC_D_MobWFEditView3Base } from './oa-tzggtzggsqlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggtzggsqlc-d-mob-wfedit-view3',
  templateUrl: 'oa-tzggtzggsqlc-d-mob-wfedit-view3.html',
})

export class OA_TZGGTZGGSQLC_D_MobWFEditView3 extends OA_TZGGTZGGSQLC_D_MobWFEditView3Base {
