...
import { OA_RZRYMySenderMobMDView9Base } from './oa-rzrymy-sender-mob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-rzrymy-sender-mob-mdview9',
  templateUrl: 'oa-rzrymy-sender-mob-mdview9.html',
})

export class OA_RZRYMySenderMobMDView9 extends OA_RZRYMySenderMobMDView9Base {
