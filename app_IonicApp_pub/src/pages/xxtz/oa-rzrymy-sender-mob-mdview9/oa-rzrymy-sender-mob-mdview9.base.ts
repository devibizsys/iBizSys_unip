...
import {
	mdctrlService,
	searchformService,
 } from './oa-rzrymy-sender-mob-mdview9.service';

export class OA_RZRYMySenderMobMDView9Base extends IBizListViewController {

    mdctrl: mdctrlService;
    searchform: searchformService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/xxtz/OA_RZRYMySenderMobMDView9.do' }));
  }
