...
import { demoDEMOLC_D_MobWFEditView3Base } from './demo-demolc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'demo-demolc-d-mob-wfedit-view3',
  templateUrl: 'demo-demolc-d-mob-wfedit-view3.html',
})

export class demoDEMOLC_D_MobWFEditView3 extends demoDEMOLC_D_MobWFEditView3Base {
