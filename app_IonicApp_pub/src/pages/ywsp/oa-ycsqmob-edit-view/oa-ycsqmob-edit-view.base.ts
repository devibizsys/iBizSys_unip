...
import {
	formService,
 } from './oa-ycsqmob-edit-view.service';

export class OA_YCSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YCSQMobEditView.do' }));
  }
