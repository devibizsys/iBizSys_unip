...
import {
	mdctrlService,
 } from './oa-yyssqckmob-list-view.service';

export class OA_YYSSQCKMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YYSSQCKMobListView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getNewDataView(params: any = {}): any {
      ...
      if(true){
      	let view={
            openMode:'',
            className:'OA_YYSSQCKMobEditView',
            viewParam:params
      	};
      	return view;
      }
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_YYSSQCKMobEditView', viewParam:params };
      }
    }
