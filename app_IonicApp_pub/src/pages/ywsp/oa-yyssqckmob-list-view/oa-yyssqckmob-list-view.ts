...
import { OA_YYSSQCKMobListViewBase } from './oa-yyssqckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-yyssqckmob-list-view',
  templateUrl: 'oa-yyssqckmob-list-view.html',
})

export class OA_YYSSQCKMobListView extends OA_YYSSQCKMobListViewBase {
