...
import { OA_BGYPSQBGYPSQLC_D_MobWFEditView3Base } from './oa-bgypsqbgypsqlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqbgypsqlc-d-mob-wfedit-view3',
  templateUrl: 'oa-bgypsqbgypsqlc-d-mob-wfedit-view3.html',
})

export class OA_BGYPSQBGYPSQLC_D_MobWFEditView3 extends OA_BGYPSQBGYPSQLC_D_MobWFEditView3Base {
