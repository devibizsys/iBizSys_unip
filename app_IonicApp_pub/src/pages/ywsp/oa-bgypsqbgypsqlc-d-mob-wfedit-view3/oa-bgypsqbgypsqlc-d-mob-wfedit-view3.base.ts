...
import {
	formService,
 } from './oa-bgypsqbgypsqlc-d-mob-wfedit-view3.service';

export class OA_BGYPSQBGYPSQLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_BGYPSQBGYPSQLC_D_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_BGYPSQCKMobListView","title":"办公用品申请",openMode:''}
        };
