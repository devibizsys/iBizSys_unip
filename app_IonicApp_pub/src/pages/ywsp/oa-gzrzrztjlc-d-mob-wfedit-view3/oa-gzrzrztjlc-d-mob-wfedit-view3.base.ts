...
import {
	formService,
 } from './oa-gzrzrztjlc-d-mob-wfedit-view3.service';

export class OA_GZRZRZTJLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_GZRZRZTJLC_D_MobWFEditView3.do' }));
  }
