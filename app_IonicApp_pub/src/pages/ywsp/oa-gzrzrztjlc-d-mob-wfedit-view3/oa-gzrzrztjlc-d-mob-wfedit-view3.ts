...
import { OA_GZRZRZTJLC_D_MobWFEditView3Base } from './oa-gzrzrztjlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzrztjlc-d-mob-wfedit-view3',
  templateUrl: 'oa-gzrzrztjlc-d-mob-wfedit-view3.html',
})

export class OA_GZRZRZTJLC_D_MobWFEditView3 extends OA_GZRZRZTJLC_D_MobWFEditView3Base {
