...
import { OA_SBWXSBWXLC_D_MobWFEditView3Base } from './oa-sbwxsbwxlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxsbwxlc-d-mob-wfedit-view3',
  templateUrl: 'oa-sbwxsbwxlc-d-mob-wfedit-view3.html',
})

export class OA_SBWXSBWXLC_D_MobWFEditView3 extends OA_SBWXSBWXLC_D_MobWFEditView3Base {
