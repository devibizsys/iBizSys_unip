...
import {
	formService,
 } from './oa-sbwxsbwxlc-d-mob-wfedit-view3.service';

export class OA_SBWXSBWXLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_SBWXSBWXLC_D_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_SBWXCKMobListView","title":"设备维修查看",openMode:''}
        };
