...
import {
	formService,
 } from './oa-cpmjsqmob-wfaction-view.service';

export class OA_CPMJSQMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CPMJSQMobWFActionView.do' }));
  }
