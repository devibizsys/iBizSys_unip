...
import {
	formService,
 } from './oa-stwmdgmob-wfaction-view.service';

export class OA_STWMDGMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_STWMDGMobWFActionView.do' }));
  }
