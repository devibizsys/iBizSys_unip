...
import { OA_STWMDGMobWFActionViewBase } from './oa-stwmdgmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgmob-wfaction-view',
  templateUrl: 'oa-stwmdgmob-wfaction-view.html',
})

export class OA_STWMDGMobWFActionView extends OA_STWMDGMobWFActionViewBase {
