...
import { OA_CGSQMobListViewBase } from './oa-cgsqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqmob-list-view',
  templateUrl: 'oa-cgsqmob-list-view.html',
})

export class OA_CGSQMobListView extends OA_CGSQMobListViewBase {
