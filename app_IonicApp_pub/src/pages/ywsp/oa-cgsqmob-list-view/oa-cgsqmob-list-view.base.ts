...
import {
	mdctrlService,
 } from './oa-cgsqmob-list-view.service';

export class OA_CGSQMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CGSQMobListView.do' }));
  }
