...
import { OA_YCSQMobListViewBase } from './oa-ycsqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ycsqmob-list-view',
  templateUrl: 'oa-ycsqmob-list-view.html',
})

export class OA_YCSQMobListView extends OA_YCSQMobListViewBase {
