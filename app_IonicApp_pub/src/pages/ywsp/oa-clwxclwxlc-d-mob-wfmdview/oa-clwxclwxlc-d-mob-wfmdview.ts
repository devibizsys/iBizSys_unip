...
import { OA_CLWXCLWXLC_D_MobWFMDViewBase } from './oa-clwxclwxlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxclwxlc-d-mob-wfmdview',
  templateUrl: 'oa-clwxclwxlc-d-mob-wfmdview.html',
})

export class OA_CLWXCLWXLC_D_MobWFMDView extends OA_CLWXCLWXLC_D_MobWFMDViewBase {
