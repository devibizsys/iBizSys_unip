...
import {
	mdctrlService,
 } from './oa-clwxclwxlc-d-mob-wfmdview.service';

export class OA_CLWXCLWXLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CLWXCLWXLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_CLWXMobEditView', viewParam:params };
      }
    }
