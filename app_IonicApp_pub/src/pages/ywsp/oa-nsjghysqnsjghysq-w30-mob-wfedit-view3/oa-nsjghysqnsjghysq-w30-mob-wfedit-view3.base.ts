...
import {
	formService,
 } from './oa-nsjghysqnsjghysq-w30-mob-wfedit-view3.service';

export class OA_NSJGHYSQNSJGHYSQ_W30_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQNSJGHYSQ_W30_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC3020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_NSJGHYSQMobWFActionView","viewParam":{"srfwfiatag":"AC3020","srfwfstep":"30"},"title":"内设机构会议申请",openMode:'POPUPMODAL'}
        };
