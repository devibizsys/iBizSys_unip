...
import { OA_YBHYSQYBHYSQ_D_MobWFMDViewBase } from './oa-ybhysqybhysq-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqybhysq-d-mob-wfmdview',
  templateUrl: 'oa-ybhysqybhysq-d-mob-wfmdview.html',
})

export class OA_YBHYSQYBHYSQ_D_MobWFMDView extends OA_YBHYSQYBHYSQ_D_MobWFMDViewBase {
