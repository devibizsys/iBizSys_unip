...
import {
	formService,
 } from './oa-clwxmob-edit-view.service';

export class OA_CLWXMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CLWXMobEditView.do' }));
  }
