...
import { OA_CCSQCKMobListViewBase } from './oa-ccsqckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqckmob-list-view',
  templateUrl: 'oa-ccsqckmob-list-view.html',
})

export class OA_CCSQCKMobListView extends OA_CCSQCKMobListViewBase {
