...
import { OA_CGSQMobWFActionViewBase } from './oa-cgsqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqmob-wfaction-view',
  templateUrl: 'oa-cgsqmob-wfaction-view.html',
})

export class OA_CGSQMobWFActionView extends OA_CGSQMobWFActionViewBase {
