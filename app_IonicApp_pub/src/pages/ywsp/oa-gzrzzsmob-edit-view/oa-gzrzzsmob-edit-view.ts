...
import { OA_GZRZZSMobEditViewBase } from './oa-gzrzzsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzzsmob-edit-view',
  templateUrl: 'oa-gzrzzsmob-edit-view.html',
})

export class OA_GZRZZSMobEditView extends OA_GZRZZSMobEditViewBase {
