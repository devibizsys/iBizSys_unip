...
import {
	mdctrlService,
 } from './oa-sbwxsbwxlc-d-mob-wfmdview.service';

export class OA_SBWXSBWXLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_SBWXSBWXLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_SBWXMobEditView', viewParam:params };
      }
    }
