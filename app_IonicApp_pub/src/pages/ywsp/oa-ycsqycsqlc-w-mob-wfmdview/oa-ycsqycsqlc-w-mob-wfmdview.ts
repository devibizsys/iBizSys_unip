...
import { OA_YCSQYCSQLC_W_MobWFMDViewBase } from './oa-ycsqycsqlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ycsqycsqlc-w-mob-wfmdview',
  templateUrl: 'oa-ycsqycsqlc-w-mob-wfmdview.html',
})

export class OA_YCSQYCSQLC_W_MobWFMDView extends OA_YCSQYCSQLC_W_MobWFMDViewBase {
