...
import { OA_PCSQCKMobListViewBase } from './oa-pcsqckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqckmob-list-view',
  templateUrl: 'oa-pcsqckmob-list-view.html',
})

export class OA_PCSQCKMobListView extends OA_PCSQCKMobListViewBase {
