...
import {
	mdctrlService,
 } from './oa-clwxmob-list-view.service';

export class OA_CLWXMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CLWXMobListView.do' }));
  }
