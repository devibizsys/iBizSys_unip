...
import {
	formService,
 } from './oa-stwmdgckmob-edit-view.service';

export class OA_STWMDGCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_STWMDGCKMobEditView.do' }));
  }
