...
import { OA_STWMDGCKMobEditViewBase } from './oa-stwmdgckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgckmob-edit-view',
  templateUrl: 'oa-stwmdgckmob-edit-view.html',
})

export class OA_STWMDGCKMobEditView extends OA_STWMDGCKMobEditViewBase {
