...
import { OA_BGYPSQCKMobEditViewBase } from './oa-bgypsqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqckmob-edit-view',
  templateUrl: 'oa-bgypsqckmob-edit-view.html',
})

export class OA_BGYPSQCKMobEditView extends OA_BGYPSQCKMobEditViewBase {
