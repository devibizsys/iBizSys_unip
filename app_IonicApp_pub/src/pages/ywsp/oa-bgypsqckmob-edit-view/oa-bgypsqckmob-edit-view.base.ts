...
import {
	formService,
 } from './oa-bgypsqckmob-edit-view.service';

export class OA_BGYPSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_BGYPSQCKMobEditView.do' }));
  }
