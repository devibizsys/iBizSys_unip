...
import {
	formService,
 } from './oa-ccsqmob-edit-view.service';

export class OA_CCSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CCSQMobEditView.do' }));
  }
