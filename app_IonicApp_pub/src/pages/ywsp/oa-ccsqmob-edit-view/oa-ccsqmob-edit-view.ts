...
import { OA_CCSQMobEditViewBase } from './oa-ccsqmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqmob-edit-view',
  templateUrl: 'oa-ccsqmob-edit-view.html',
})

export class OA_CCSQMobEditView extends OA_CCSQMobEditViewBase {
