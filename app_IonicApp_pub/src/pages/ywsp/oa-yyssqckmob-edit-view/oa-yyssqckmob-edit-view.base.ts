...
import {
	formService,
 } from './oa-yyssqckmob-edit-view.service';

export class OA_YYSSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YYSSQCKMobEditView.do' }));
  }
