...
import { OA_GZRZRZTJLC_D_MobWFMDViewBase } from './oa-gzrzrztjlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzrztjlc-d-mob-wfmdview',
  templateUrl: 'oa-gzrzrztjlc-d-mob-wfmdview.html',
})

export class OA_GZRZRZTJLC_D_MobWFMDView extends OA_GZRZRZTJLC_D_MobWFMDViewBase {
