...
import {
	mdctrlService,
 } from './oa-gzrzrztjlc-d-mob-wfmdview.service';

export class OA_GZRZRZTJLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_GZRZRZTJLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_GZRZMobEditView', viewParam:params };
      }
    }
