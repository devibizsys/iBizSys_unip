...
import {
	formService,
 } from './oa-sbwxmob-edit-view.service';

export class OA_SBWXMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_SBWXMobEditView.do' }));
  }
