...
import { OA_STWMDGMobListViewBase } from './oa-stwmdgmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgmob-list-view',
  templateUrl: 'oa-stwmdgmob-list-view.html',
})

export class OA_STWMDGMobListView extends OA_STWMDGMobListViewBase {
