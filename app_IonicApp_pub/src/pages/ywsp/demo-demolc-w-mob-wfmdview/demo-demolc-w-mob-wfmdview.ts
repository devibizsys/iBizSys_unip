...
import { demoDEMOLC_W_MobWFMDViewBase } from './demo-demolc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'demo-demolc-w-mob-wfmdview',
  templateUrl: 'demo-demolc-w-mob-wfmdview.html',
})

export class demoDEMOLC_W_MobWFMDView extends demoDEMOLC_W_MobWFMDViewBase {
