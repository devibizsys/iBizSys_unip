...
import { OA_NSJGHYSQMobWFActionViewBase } from './oa-nsjghysqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqmob-wfaction-view',
  templateUrl: 'oa-nsjghysqmob-wfaction-view.html',
})

export class OA_NSJGHYSQMobWFActionView extends OA_NSJGHYSQMobWFActionViewBase {
