...
import {
	formService,
 } from './oa-nsjghysqmob-wfaction-view.service';

export class OA_NSJGHYSQMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQMobWFActionView.do' }));
  }
