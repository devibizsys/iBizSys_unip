...
import {
	formService,
 } from './oa-jpydjpydlc-d-mob-wfedit-view3.service';

export class OA_JPYDJPYDLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_JPYDJPYDLC_D_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_JPYDCKMobListView","title":"机票预订查看",openMode:''}
        };
