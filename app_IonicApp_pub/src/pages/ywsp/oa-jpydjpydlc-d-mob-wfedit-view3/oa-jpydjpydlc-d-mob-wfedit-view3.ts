...
import { OA_JPYDJPYDLC_D_MobWFEditView3Base } from './oa-jpydjpydlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-jpydjpydlc-d-mob-wfedit-view3',
  templateUrl: 'oa-jpydjpydlc-d-mob-wfedit-view3.html',
})

export class OA_JPYDJPYDLC_D_MobWFEditView3 extends OA_JPYDJPYDLC_D_MobWFEditView3Base {
