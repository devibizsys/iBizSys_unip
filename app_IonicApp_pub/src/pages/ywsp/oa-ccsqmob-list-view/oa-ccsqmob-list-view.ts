...
import { OA_CCSQMobListViewBase } from './oa-ccsqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqmob-list-view',
  templateUrl: 'oa-ccsqmob-list-view.html',
})

export class OA_CCSQMobListView extends OA_CCSQMobListViewBase {
