...
import {
	mdctrlService,
 } from './oa-ccsqmob-list-view.service';

export class OA_CCSQMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CCSQMobListView.do' }));
  }
