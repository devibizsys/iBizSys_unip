...
import { OA_JPYDCKMobEditViewBase } from './oa-jpydckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-jpydckmob-edit-view',
  templateUrl: 'oa-jpydckmob-edit-view.html',
})

export class OA_JPYDCKMobEditView extends OA_JPYDCKMobEditViewBase {
