...
import { OA_YCSQYCSQLC_D_MobWFEditView3Base } from './oa-ycsqycsqlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ycsqycsqlc-d-mob-wfedit-view3',
  templateUrl: 'oa-ycsqycsqlc-d-mob-wfedit-view3.html',
})

export class OA_YCSQYCSQLC_D_MobWFEditView3 extends OA_YCSQYCSQLC_D_MobWFEditView3Base {
