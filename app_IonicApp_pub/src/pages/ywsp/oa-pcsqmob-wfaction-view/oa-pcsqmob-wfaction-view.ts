...
import { OA_PCSQMobWFActionViewBase } from './oa-pcsqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqmob-wfaction-view',
  templateUrl: 'oa-pcsqmob-wfaction-view.html',
})

export class OA_PCSQMobWFActionView extends OA_PCSQMobWFActionViewBase {
