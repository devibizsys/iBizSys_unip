...
import { OA_JPYDJPYDLC_D_MobWFMDViewBase } from './oa-jpydjpydlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-jpydjpydlc-d-mob-wfmdview',
  templateUrl: 'oa-jpydjpydlc-d-mob-wfmdview.html',
})

export class OA_JPYDJPYDLC_D_MobWFMDView extends OA_JPYDJPYDLC_D_MobWFMDViewBase {
