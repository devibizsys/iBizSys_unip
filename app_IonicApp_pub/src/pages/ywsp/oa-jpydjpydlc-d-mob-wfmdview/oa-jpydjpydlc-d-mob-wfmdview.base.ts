...
import {
	mdctrlService,
 } from './oa-jpydjpydlc-d-mob-wfmdview.service';

export class OA_JPYDJPYDLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_JPYDJPYDLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_JPYDMobEditView', viewParam:params };
      }
    }
