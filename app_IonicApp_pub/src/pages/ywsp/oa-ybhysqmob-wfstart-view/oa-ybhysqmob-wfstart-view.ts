...
import { OA_YBHYSQMobWFStartViewBase } from './oa-ybhysqmob-wfstart-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqmob-wfstart-view',
  templateUrl: 'oa-ybhysqmob-wfstart-view.html',
})

export class OA_YBHYSQMobWFStartView extends OA_YBHYSQMobWFStartViewBase {
