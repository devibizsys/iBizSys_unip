...
import {
 } from './wfwork-list-mob-tab-exp-view.service';

export class WFWorkListMobTabExpViewBase extends IBizTabExpViewController {
  ...
  tab: IBizTabService;
    ...
    constructor(opt) {
        super(Object.assign(opt, { 'url': '/IonicApp/ywsp/WFWorkListMobTabExpView.do' }));
