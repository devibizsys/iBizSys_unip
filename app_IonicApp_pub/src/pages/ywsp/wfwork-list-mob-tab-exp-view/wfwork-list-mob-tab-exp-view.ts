...
import { WFWorkListMobTabExpViewBase } from './wfwork-list-mob-tab-exp-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'wfwork-list-mob-tab-exp-view',
  templateUrl: 'wfwork-list-mob-tab-exp-view.html',
})

export class WFWorkListMobTabExpView extends WFWorkListMobTabExpViewBase {
