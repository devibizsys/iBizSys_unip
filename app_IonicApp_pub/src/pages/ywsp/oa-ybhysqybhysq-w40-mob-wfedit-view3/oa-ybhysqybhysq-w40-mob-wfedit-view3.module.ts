...
import { OA_YBHYSQYBHYSQ_W40_MobWFEditView3 } from './oa-ybhysqybhysq-w40-mob-wfedit-view3';
...
@NgModule({
  declarations: [
    OA_YBHYSQYBHYSQ_W40_MobWFEditView3,
  ],
  imports: [
    IonicPageModule.forChild(OA_YBHYSQYBHYSQ_W40_MobWFEditView3),
    IBizSysModule,
    UserModule,
...
export class OA_YBHYSQYBHYSQ_W40_MobWFEditView3Module {}