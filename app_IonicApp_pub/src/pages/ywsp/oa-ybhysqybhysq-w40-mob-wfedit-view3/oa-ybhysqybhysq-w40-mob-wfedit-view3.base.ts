...
import {
	formService,
 } from './oa-ybhysqybhysq-w40-mob-wfedit-view3.service';

export class OA_YBHYSQYBHYSQ_W40_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YBHYSQYBHYSQ_W40_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC4020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_YBHYSQSHYJMobWFActionView","viewParam":{"srfwfiatag":"AC4020","srfwfstep":"40"},"title":"会议申请",openMode:'POPUPMODAL'}
        };
