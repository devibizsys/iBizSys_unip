...
import { OA_CGSQCGSQLC_D_MobWFEditView3Base } from './oa-cgsqcgsqlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqcgsqlc-d-mob-wfedit-view3',
  templateUrl: 'oa-cgsqcgsqlc-d-mob-wfedit-view3.html',
})

export class OA_CGSQCGSQLC_D_MobWFEditView3 extends OA_CGSQCGSQLC_D_MobWFEditView3Base {
