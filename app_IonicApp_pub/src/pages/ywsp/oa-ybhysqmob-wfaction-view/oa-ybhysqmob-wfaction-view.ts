...
import { OA_YBHYSQMobWFActionViewBase } from './oa-ybhysqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqmob-wfaction-view',
  templateUrl: 'oa-ybhysqmob-wfaction-view.html',
})

export class OA_YBHYSQMobWFActionView extends OA_YBHYSQMobWFActionViewBase {
