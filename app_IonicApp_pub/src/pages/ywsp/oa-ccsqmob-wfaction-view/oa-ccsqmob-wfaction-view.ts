...
import { OA_CCSQMobWFActionViewBase } from './oa-ccsqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqmob-wfaction-view',
  templateUrl: 'oa-ccsqmob-wfaction-view.html',
})

export class OA_CCSQMobWFActionView extends OA_CCSQMobWFActionViewBase {
