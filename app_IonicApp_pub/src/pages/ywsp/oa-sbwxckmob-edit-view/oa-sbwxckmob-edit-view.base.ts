...
import {
	formService,
 } from './oa-sbwxckmob-edit-view.service';

export class OA_SBWXCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_SBWXCKMobEditView.do' }));
  }
