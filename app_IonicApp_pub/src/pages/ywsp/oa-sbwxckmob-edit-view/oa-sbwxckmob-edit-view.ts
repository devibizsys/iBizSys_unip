...
import { OA_SBWXCKMobEditViewBase } from './oa-sbwxckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxckmob-edit-view',
  templateUrl: 'oa-sbwxckmob-edit-view.html',
})

export class OA_SBWXCKMobEditView extends OA_SBWXCKMobEditViewBase {
