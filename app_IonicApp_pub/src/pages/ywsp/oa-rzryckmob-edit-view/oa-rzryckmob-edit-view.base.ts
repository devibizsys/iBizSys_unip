...
import {
	formService,
 } from './oa-rzryckmob-edit-view.service';

export class OA_RZRYCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_RZRYCKMobEditView.do' }));
  }
