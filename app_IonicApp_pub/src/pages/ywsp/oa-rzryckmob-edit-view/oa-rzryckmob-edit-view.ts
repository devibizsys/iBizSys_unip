...
import { OA_RZRYCKMobEditViewBase } from './oa-rzryckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-rzryckmob-edit-view',
  templateUrl: 'oa-rzryckmob-edit-view.html',
})

export class OA_RZRYCKMobEditView extends OA_RZRYCKMobEditViewBase {
