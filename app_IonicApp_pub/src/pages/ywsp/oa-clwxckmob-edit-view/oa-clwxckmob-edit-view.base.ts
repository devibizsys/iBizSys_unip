...
import {
	formService,
 } from './oa-clwxckmob-edit-view.service';

export class OA_CLWXCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CLWXCKMobEditView.do' }));
  }
