...
import { OA_CLWXCKMobEditViewBase } from './oa-clwxckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxckmob-edit-view',
  templateUrl: 'oa-clwxckmob-edit-view.html',
})

export class OA_CLWXCKMobEditView extends OA_CLWXCKMobEditViewBase {
