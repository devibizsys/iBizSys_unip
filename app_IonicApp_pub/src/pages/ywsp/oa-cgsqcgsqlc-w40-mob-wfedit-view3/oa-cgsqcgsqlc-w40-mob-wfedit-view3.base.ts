...
import {
	formService,
 } from './oa-cgsqcgsqlc-w40-mob-wfedit-view3.service';

export class OA_CGSQCGSQLC_W40_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CGSQCGSQLC_W40_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC4020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_CGSQMobWFActionView","viewParam":{"srfwfiatag":"AC4020","srfwfstep":"40"},"title":"采购申请",openMode:'POPUPMODAL'}
        };
