...
import {
	formService,
 } from './oa-bgypsqbgypsqlc-w10-mob-wfedit-view3.service';

export class OA_BGYPSQBGYPSQLC_W10_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_BGYPSQBGYPSQLC_W10_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC1020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_BGYPSQMobWFActionView","viewParam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"title":"办公用品申请",openMode:'POPUPMODAL'}
        };
