...
import { OA_BGYPSQBGYPSQLC_W10_MobWFEditView3Base } from './oa-bgypsqbgypsqlc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqbgypsqlc-w10-mob-wfedit-view3',
  templateUrl: 'oa-bgypsqbgypsqlc-w10-mob-wfedit-view3.html',
})

export class OA_BGYPSQBGYPSQLC_W10_MobWFEditView3 extends OA_BGYPSQBGYPSQLC_W10_MobWFEditView3Base {
