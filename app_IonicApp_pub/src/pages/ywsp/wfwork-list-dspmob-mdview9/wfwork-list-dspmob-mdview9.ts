...
import { WFWorkListDSPMobMDView9Base } from './wfwork-list-dspmob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'wfwork-list-dspmob-mdview9',
  templateUrl: 'wfwork-list-dspmob-mdview9.html',
})

export class WFWorkListDSPMobMDView9 extends WFWorkListDSPMobMDView9Base {
