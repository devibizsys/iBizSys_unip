...
import { OA_QXJQXJLC_D_MobWFMDViewBase } from './oa-qxjqxjlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjqxjlc-d-mob-wfmdview',
  templateUrl: 'oa-qxjqxjlc-d-mob-wfmdview.html',
})

export class OA_QXJQXJLC_D_MobWFMDView extends OA_QXJQXJLC_D_MobWFMDViewBase {
