...
import {
	mdctrlService,
 } from './oa-qxjqxjlc-d-mob-wfmdview.service';

export class OA_QXJQXJLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_QXJQXJLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_QXJMobEditView', viewParam:params };
      }
    }
