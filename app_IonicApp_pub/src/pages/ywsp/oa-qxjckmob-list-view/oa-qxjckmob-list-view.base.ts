...
import {
	mdctrlService,
 } from './oa-qxjckmob-list-view.service';

export class OA_QXJCKMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_QXJCKMobListView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_QXJCKMobEditView', viewParam:params };
      }
    }
