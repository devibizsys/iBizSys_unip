...
import { OA_QXJCKMobListViewBase } from './oa-qxjckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjckmob-list-view',
  templateUrl: 'oa-qxjckmob-list-view.html',
})

export class OA_QXJCKMobListView extends OA_QXJCKMobListViewBase {
