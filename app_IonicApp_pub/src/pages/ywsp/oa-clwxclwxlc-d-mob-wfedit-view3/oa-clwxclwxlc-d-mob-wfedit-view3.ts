...
import { OA_CLWXCLWXLC_D_MobWFEditView3Base } from './oa-clwxclwxlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxclwxlc-d-mob-wfedit-view3',
  templateUrl: 'oa-clwxclwxlc-d-mob-wfedit-view3.html',
})

export class OA_CLWXCLWXLC_D_MobWFEditView3 extends OA_CLWXCLWXLC_D_MobWFEditView3Base {
