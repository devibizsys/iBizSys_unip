...
import { OA_YCSQMobWFActionViewBase } from './oa-ycsqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ycsqmob-wfaction-view',
  templateUrl: 'oa-ycsqmob-wfaction-view.html',
})

export class OA_YCSQMobWFActionView extends OA_YCSQMobWFActionViewBase {
