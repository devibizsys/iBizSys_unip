...
import {
	formService,
 } from './oa-ycsqmob-wfaction-view.service';

export class OA_YCSQMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YCSQMobWFActionView.do' }));
  }
