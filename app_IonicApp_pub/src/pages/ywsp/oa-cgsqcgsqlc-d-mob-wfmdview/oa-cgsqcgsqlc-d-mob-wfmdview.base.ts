...
import {
	mdctrlService,
 } from './oa-cgsqcgsqlc-d-mob-wfmdview.service';

export class OA_CGSQCGSQLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CGSQCGSQLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_CGSQMobEditView', viewParam:params };
      }
    }
