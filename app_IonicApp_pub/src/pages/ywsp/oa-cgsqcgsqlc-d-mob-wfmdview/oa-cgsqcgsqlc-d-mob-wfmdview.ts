...
import { OA_CGSQCGSQLC_D_MobWFMDViewBase } from './oa-cgsqcgsqlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqcgsqlc-d-mob-wfmdview',
  templateUrl: 'oa-cgsqcgsqlc-d-mob-wfmdview.html',
})

export class OA_CGSQCGSQLC_D_MobWFMDView extends OA_CGSQCGSQLC_D_MobWFMDViewBase {
