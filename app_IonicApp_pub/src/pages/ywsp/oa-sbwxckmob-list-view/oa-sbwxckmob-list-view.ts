...
import { OA_SBWXCKMobListViewBase } from './oa-sbwxckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxckmob-list-view',
  templateUrl: 'oa-sbwxckmob-list-view.html',
})

export class OA_SBWXCKMobListView extends OA_SBWXCKMobListViewBase {
