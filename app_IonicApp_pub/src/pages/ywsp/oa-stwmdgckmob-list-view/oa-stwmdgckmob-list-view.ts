...
import { OA_STWMDGCKMobListViewBase } from './oa-stwmdgckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgckmob-list-view',
  templateUrl: 'oa-stwmdgckmob-list-view.html',
})

export class OA_STWMDGCKMobListView extends OA_STWMDGCKMobListViewBase {
