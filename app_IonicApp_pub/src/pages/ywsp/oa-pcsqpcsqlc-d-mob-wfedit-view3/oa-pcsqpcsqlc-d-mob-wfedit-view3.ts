...
import { OA_PCSQPCSQLC_D_MobWFEditView3Base } from './oa-pcsqpcsqlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqpcsqlc-d-mob-wfedit-view3',
  templateUrl: 'oa-pcsqpcsqlc-d-mob-wfedit-view3.html',
})

export class OA_PCSQPCSQLC_D_MobWFEditView3 extends OA_PCSQPCSQLC_D_MobWFEditView3Base {
