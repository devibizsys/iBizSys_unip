...
import {
	formService,
 } from './oa-pcsqpcsqlc-d-mob-wfedit-view3.service';

export class OA_PCSQPCSQLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_PCSQPCSQLC_D_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_PCSQCKMobListView","title":"派车申请",openMode:''}
        };
