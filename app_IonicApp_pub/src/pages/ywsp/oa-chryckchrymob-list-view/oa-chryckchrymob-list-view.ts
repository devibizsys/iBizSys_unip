...
import { OA_CHRYCKCHRYMobListViewBase } from './oa-chryckchrymob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-chryckchrymob-list-view',
  templateUrl: 'oa-chryckchrymob-list-view.html',
})

export class OA_CHRYCKCHRYMobListView extends OA_CHRYCKCHRYMobListViewBase {
