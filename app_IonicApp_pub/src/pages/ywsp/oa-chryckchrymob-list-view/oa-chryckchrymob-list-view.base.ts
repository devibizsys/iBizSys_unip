...
import {
	mdctrlService,
	searchformService,
 } from './oa-chryckchrymob-list-view.service';

export class OA_CHRYCKCHRYMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;
    searchform: searchformService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CHRYCKCHRYMobListView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getNewDataView(params: any = {}): any {
      ...
      if(true){
      	let view={
            openMode:'',
            className:'OA_CHRYCKCHRYMobEditView',
            viewParam:params
      	};
      	return view;
      }
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_CHRYCKCHRYMobEditView', viewParam:params };
      }
    }
