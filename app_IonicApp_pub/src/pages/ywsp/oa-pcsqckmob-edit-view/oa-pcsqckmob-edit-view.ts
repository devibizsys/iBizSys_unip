...
import { OA_PCSQCKMobEditViewBase } from './oa-pcsqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqckmob-edit-view',
  templateUrl: 'oa-pcsqckmob-edit-view.html',
})

export class OA_PCSQCKMobEditView extends OA_PCSQCKMobEditViewBase {
