...
import {
	formService,
 } from './oa-pcsqckmob-edit-view.service';

export class OA_PCSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_PCSQCKMobEditView.do' }));
  }
