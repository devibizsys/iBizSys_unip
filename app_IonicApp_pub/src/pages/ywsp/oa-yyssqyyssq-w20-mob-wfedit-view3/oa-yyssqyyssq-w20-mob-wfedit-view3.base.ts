...
import {
	formService,
 } from './oa-yyssqyyssq-w20-mob-wfedit-view3.service';

export class OA_YYSSQYYSSQ_W20_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YYSSQYYSSQ_W20_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC2020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_YYSSQMobWFActionView","viewParam":{"srfwfiatag":"AC2020","srfwfstep":"20"},"title":"饮用水申请",openMode:'POPUPMODAL'}
        };
