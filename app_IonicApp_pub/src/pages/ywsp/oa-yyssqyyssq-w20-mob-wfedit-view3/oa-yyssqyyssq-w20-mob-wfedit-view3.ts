...
import { OA_YYSSQYYSSQ_W20_MobWFEditView3Base } from './oa-yyssqyyssq-w20-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-yyssqyyssq-w20-mob-wfedit-view3',
  templateUrl: 'oa-yyssqyyssq-w20-mob-wfedit-view3.html',
})

export class OA_YYSSQYYSSQ_W20_MobWFEditView3 extends OA_YYSSQYYSSQ_W20_MobWFEditView3Base {
