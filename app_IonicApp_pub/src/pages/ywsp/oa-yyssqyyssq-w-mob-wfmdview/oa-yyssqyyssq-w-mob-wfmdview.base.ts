...
import {
	mdctrlService,
 } from './oa-yyssqyyssq-w-mob-wfmdview.service';

export class OA_YYSSQYYSSQ_W_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YYSSQYYSSQ_W_MobWFMDView.do' }));
  }
    ...
    public getEditDataView(params: any = {}): any {
       ...
       for(let i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='10'){
              return { openMode:'', className:'OA_YYSSQYYSSQ_W10_MobWFEditView3', viewParam:params };
          }
          if(editmode=='10@1'){
              return { openMode:'', className:'OA_YYSSQYYSSQ_W10_MobWFEditView3', viewParam:params };
          }
          if(editmode=='20'){
              return { openMode:'', className:'OA_YYSSQYYSSQ_W20_MobWFEditView3', viewParam:params };
          }
          if(editmode=='20@1'){
              return { openMode:'', className:'OA_YYSSQYYSSQ_W20_MobWFEditView3', viewParam:params };
          }
