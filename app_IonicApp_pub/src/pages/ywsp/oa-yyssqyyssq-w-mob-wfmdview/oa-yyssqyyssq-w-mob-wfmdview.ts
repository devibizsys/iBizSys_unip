...
import { OA_YYSSQYYSSQ_W_MobWFMDViewBase } from './oa-yyssqyyssq-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-yyssqyyssq-w-mob-wfmdview',
  templateUrl: 'oa-yyssqyyssq-w-mob-wfmdview.html',
})

export class OA_YYSSQYYSSQ_W_MobWFMDView extends OA_YYSSQYYSSQ_W_MobWFMDViewBase {
