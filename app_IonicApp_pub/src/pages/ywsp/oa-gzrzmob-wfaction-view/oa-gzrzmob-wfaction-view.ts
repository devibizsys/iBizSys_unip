...
import { OA_GZRZMobWFActionViewBase } from './oa-gzrzmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzmob-wfaction-view',
  templateUrl: 'oa-gzrzmob-wfaction-view.html',
})

export class OA_GZRZMobWFActionView extends OA_GZRZMobWFActionViewBase {
