...
import { OA_GZRZZSMobListViewBase } from './oa-gzrzzsmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzzsmob-list-view',
  templateUrl: 'oa-gzrzzsmob-list-view.html',
})

export class OA_GZRZZSMobListView extends OA_GZRZZSMobListViewBase {
