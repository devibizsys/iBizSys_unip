...
import {
	mdctrlService,
 } from './oa-gzrzzsmob-list-view.service';

export class OA_GZRZZSMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_GZRZZSMobListView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getNewDataView(params: any = {}): any {
      ...
      if(true){
      	let view={
            openMode:'',
            className:'OA_GZRZZSMobEditView',
            viewParam:params
      	};
      	return view;
      }
