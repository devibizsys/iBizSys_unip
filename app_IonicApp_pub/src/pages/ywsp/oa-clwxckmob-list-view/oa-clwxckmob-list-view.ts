...
import { OA_CLWXCKMobListViewBase } from './oa-clwxckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxckmob-list-view',
  templateUrl: 'oa-clwxckmob-list-view.html',
})

export class OA_CLWXCKMobListView extends OA_CLWXCKMobListViewBase {
