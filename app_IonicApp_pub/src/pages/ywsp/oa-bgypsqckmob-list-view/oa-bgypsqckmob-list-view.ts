...
import { OA_BGYPSQCKMobListViewBase } from './oa-bgypsqckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqckmob-list-view',
  templateUrl: 'oa-bgypsqckmob-list-view.html',
})

export class OA_BGYPSQCKMobListView extends OA_BGYPSQCKMobListViewBase {
