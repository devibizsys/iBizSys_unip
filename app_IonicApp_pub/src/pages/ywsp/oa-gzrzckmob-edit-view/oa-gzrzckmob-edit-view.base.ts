...
import {
	formService,
 } from './oa-gzrzckmob-edit-view.service';

export class OA_GZRZCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_GZRZCKMobEditView.do' }));
  }
