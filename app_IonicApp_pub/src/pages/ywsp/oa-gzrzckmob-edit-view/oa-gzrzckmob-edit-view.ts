...
import { OA_GZRZCKMobEditViewBase } from './oa-gzrzckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzckmob-edit-view',
  templateUrl: 'oa-gzrzckmob-edit-view.html',
})

export class OA_GZRZCKMobEditView extends OA_GZRZCKMobEditViewBase {
