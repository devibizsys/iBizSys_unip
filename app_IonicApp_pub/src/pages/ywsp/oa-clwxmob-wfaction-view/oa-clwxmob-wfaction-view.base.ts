...
import {
	formService,
 } from './oa-clwxmob-wfaction-view.service';

export class OA_CLWXMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CLWXMobWFActionView.do' }));
  }
