...
import { OA_CLWXMobWFActionViewBase } from './oa-clwxmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxmob-wfaction-view',
  templateUrl: 'oa-clwxmob-wfaction-view.html',
})

export class OA_CLWXMobWFActionView extends OA_CLWXMobWFActionViewBase {
