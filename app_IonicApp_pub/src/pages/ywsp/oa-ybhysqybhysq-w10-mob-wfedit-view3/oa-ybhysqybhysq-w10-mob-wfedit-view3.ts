...
import { OA_YBHYSQYBHYSQ_W10_MobWFEditView3Base } from './oa-ybhysqybhysq-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqybhysq-w10-mob-wfedit-view3',
  templateUrl: 'oa-ybhysqybhysq-w10-mob-wfedit-view3.html',
})

export class OA_YBHYSQYBHYSQ_W10_MobWFEditView3 extends OA_YBHYSQYBHYSQ_W10_MobWFEditView3Base {
