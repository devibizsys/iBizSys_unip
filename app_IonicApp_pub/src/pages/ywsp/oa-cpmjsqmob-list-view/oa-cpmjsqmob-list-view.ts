...
import { OA_CPMJSQMobListViewBase } from './oa-cpmjsqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqmob-list-view',
  templateUrl: 'oa-cpmjsqmob-list-view.html',
})

export class OA_CPMJSQMobListView extends OA_CPMJSQMobListViewBase {
