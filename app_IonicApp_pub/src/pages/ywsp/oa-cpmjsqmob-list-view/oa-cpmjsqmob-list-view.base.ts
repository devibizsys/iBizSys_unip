...
import {
	mdctrlService,
 } from './oa-cpmjsqmob-list-view.service';

export class OA_CPMJSQMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CPMJSQMobListView.do' }));
  }
