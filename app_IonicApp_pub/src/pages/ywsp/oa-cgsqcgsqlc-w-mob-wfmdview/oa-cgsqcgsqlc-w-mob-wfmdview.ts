...
import { OA_CGSQCGSQLC_W_MobWFMDViewBase } from './oa-cgsqcgsqlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqcgsqlc-w-mob-wfmdview',
  templateUrl: 'oa-cgsqcgsqlc-w-mob-wfmdview.html',
})

export class OA_CGSQCGSQLC_W_MobWFMDView extends OA_CGSQCGSQLC_W_MobWFMDViewBase {
