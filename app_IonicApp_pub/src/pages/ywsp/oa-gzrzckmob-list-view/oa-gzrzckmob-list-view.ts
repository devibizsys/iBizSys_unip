...
import { OA_GZRZCKMobListViewBase } from './oa-gzrzckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzckmob-list-view',
  templateUrl: 'oa-gzrzckmob-list-view.html',
})

export class OA_GZRZCKMobListView extends OA_GZRZCKMobListViewBase {
