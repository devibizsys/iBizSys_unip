...
import { OA_CCSQCCSQLC_W_MobWFMDViewBase } from './oa-ccsqccsqlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqccsqlc-w-mob-wfmdview',
  templateUrl: 'oa-ccsqccsqlc-w-mob-wfmdview.html',
})

export class OA_CCSQCCSQLC_W_MobWFMDView extends OA_CCSQCCSQLC_W_MobWFMDViewBase {
