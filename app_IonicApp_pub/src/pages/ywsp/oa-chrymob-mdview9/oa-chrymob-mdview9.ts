...
import { OA_CHRYMobMDView9Base } from './oa-chrymob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-chrymob-mdview9',
  templateUrl: 'oa-chrymob-mdview9.html',
})

export class OA_CHRYMobMDView9 extends OA_CHRYMobMDView9Base {
