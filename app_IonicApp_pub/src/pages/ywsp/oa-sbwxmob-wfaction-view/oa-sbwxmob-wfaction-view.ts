...
import { OA_SBWXMobWFActionViewBase } from './oa-sbwxmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxmob-wfaction-view',
  templateUrl: 'oa-sbwxmob-wfaction-view.html',
})

export class OA_SBWXMobWFActionView extends OA_SBWXMobWFActionViewBase {
