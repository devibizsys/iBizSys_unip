...
import { OA_CLWXCLWXLC_W_MobWFMDViewBase } from './oa-clwxclwxlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxclwxlc-w-mob-wfmdview',
  templateUrl: 'oa-clwxclwxlc-w-mob-wfmdview.html',
})

export class OA_CLWXCLWXLC_W_MobWFMDView extends OA_CLWXCLWXLC_W_MobWFMDViewBase {
