...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'oa_nsjghysqname', 'visible': true, 'allowEmpty': false});
        ...
        this.regItem({'name': 'hysname', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'hyyq', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'chld', 'visible': true, 'allowEmpty': false});
