...
import {
	formService,
 } from './oa-nsjghysqnsjghysq-w10-mob-wfedit-view3.service';

export class OA_NSJGHYSQNSJGHYSQ_W10_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQNSJGHYSQ_W10_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC1020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_NSJGHYSQMobWFActionView","viewParam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"title":"内设机构会议申请",openMode:'POPUPMODAL'}
        };
