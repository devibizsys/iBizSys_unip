...
import { OA_BGYPSQMobWFActionViewBase } from './oa-bgypsqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqmob-wfaction-view',
  templateUrl: 'oa-bgypsqmob-wfaction-view.html',
})

export class OA_BGYPSQMobWFActionView extends OA_BGYPSQMobWFActionViewBase {
