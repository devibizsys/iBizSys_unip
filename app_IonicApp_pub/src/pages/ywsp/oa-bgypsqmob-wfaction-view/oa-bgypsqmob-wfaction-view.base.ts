...
import {
	formService,
 } from './oa-bgypsqmob-wfaction-view.service';

export class OA_BGYPSQMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_BGYPSQMobWFActionView.do' }));
  }
