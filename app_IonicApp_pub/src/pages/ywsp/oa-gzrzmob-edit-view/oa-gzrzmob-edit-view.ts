...
import { OA_GZRZMobEditViewBase } from './oa-gzrzmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzmob-edit-view',
  templateUrl: 'oa-gzrzmob-edit-view.html',
})

export class OA_GZRZMobEditView extends OA_GZRZMobEditViewBase {
