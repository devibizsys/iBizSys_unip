...
import { WFStepDataMobMDViewBase } from './wfstep-data-mob-mdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'wfstep-data-mob-mdview',
  templateUrl: 'wfstep-data-mob-mdview.html',
})

export class WFStepDataMobMDView extends WFStepDataMobMDViewBase {
