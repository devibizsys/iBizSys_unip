...
import {
	mdctrlService,
 } from './wfstep-data-mob-mdview.service';

export class WFStepDataMobMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/WFStepDataMobMDView.do' }));
  }
