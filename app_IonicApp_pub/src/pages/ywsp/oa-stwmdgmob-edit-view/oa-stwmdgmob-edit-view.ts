...
import { OA_STWMDGMobEditViewBase } from './oa-stwmdgmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgmob-edit-view',
  templateUrl: 'oa-stwmdgmob-edit-view.html',
})

export class OA_STWMDGMobEditView extends OA_STWMDGMobEditViewBase {
