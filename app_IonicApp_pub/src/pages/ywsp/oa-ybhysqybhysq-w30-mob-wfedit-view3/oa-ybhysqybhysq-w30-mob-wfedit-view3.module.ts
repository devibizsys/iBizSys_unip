...
import { OA_YBHYSQYBHYSQ_W30_MobWFEditView3 } from './oa-ybhysqybhysq-w30-mob-wfedit-view3';
...
@NgModule({
  declarations: [
    OA_YBHYSQYBHYSQ_W30_MobWFEditView3,
  ],
  imports: [
    IonicPageModule.forChild(OA_YBHYSQYBHYSQ_W30_MobWFEditView3),
    IBizSysModule,
    UserModule,
...
export class OA_YBHYSQYBHYSQ_W30_MobWFEditView3Module {}