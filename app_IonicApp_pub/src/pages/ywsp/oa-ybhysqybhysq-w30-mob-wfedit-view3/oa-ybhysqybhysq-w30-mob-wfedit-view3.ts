...
import { OA_YBHYSQYBHYSQ_W30_MobWFEditView3Base } from './oa-ybhysqybhysq-w30-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqybhysq-w30-mob-wfedit-view3',
  templateUrl: 'oa-ybhysqybhysq-w30-mob-wfedit-view3.html',
})

export class OA_YBHYSQYBHYSQ_W30_MobWFEditView3 extends OA_YBHYSQYBHYSQ_W30_MobWFEditView3Base {
