...
import { OA_GZRZMobListViewBase } from './oa-gzrzmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzmob-list-view',
  templateUrl: 'oa-gzrzmob-list-view.html',
})

export class OA_GZRZMobListView extends OA_GZRZMobListViewBase {
