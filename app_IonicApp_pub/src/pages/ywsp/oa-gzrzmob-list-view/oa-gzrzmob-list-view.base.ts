...
import {
	mdctrlService,
 } from './oa-gzrzmob-list-view.service';

export class OA_GZRZMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_GZRZMobListView.do' }));
  }
