...
import { OA_NSJGHYSQCKMobEditViewBase } from './oa-nsjghysqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqckmob-edit-view',
  templateUrl: 'oa-nsjghysqckmob-edit-view.html',
})

export class OA_NSJGHYSQCKMobEditView extends OA_NSJGHYSQCKMobEditViewBase {
