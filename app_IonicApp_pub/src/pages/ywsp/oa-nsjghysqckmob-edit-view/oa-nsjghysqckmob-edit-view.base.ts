...
import {
	formService,
 } from './oa-nsjghysqckmob-edit-view.service';

export class OA_NSJGHYSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQCKMobEditView.do' }));
  }
