...
import {
	formService,
 } from './oa-nsjghysqmob-edit-view.service';

export class OA_NSJGHYSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQMobEditView.do' }));
  }
