...
import { OA_NSJGHYSQMobEditViewBase } from './oa-nsjghysqmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqmob-edit-view',
  templateUrl: 'oa-nsjghysqmob-edit-view.html',
})

export class OA_NSJGHYSQMobEditView extends OA_NSJGHYSQMobEditViewBase {
