...
import {
	mdctrlService,
 } from './wfstep-data-my-time-line-mob-mdview.service';

export class WFStepDataMyTimeLineMobMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/WFStepDataMyTimeLineMobMDView.do' }));
  }
