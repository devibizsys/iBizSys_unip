...
import { OA_BGYPSQMobListViewBase } from './oa-bgypsqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqmob-list-view',
  templateUrl: 'oa-bgypsqmob-list-view.html',
})

export class OA_BGYPSQMobListView extends OA_BGYPSQMobListViewBase {
