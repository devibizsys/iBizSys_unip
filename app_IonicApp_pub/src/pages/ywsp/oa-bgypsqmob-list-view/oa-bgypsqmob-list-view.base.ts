...
import {
	mdctrlService,
 } from './oa-bgypsqmob-list-view.service';

export class OA_BGYPSQMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_BGYPSQMobListView.do' }));
  }
