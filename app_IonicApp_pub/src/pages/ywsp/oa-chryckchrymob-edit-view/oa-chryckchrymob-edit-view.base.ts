...
import {
	formService,
 } from './oa-chryckchrymob-edit-view.service';

export class OA_CHRYCKCHRYMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CHRYCKCHRYMobEditView.do' }));
  }
