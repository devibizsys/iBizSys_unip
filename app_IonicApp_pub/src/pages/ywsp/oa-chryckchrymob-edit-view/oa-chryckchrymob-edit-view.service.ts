...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'ybhysqname', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'orgusername', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'orgsecusertypename', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'chzt', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'chsj', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'zwh', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'zwhms', 'visible': true, 'allowEmpty': false});
        ...
        this.regItem({'name': 'oa_chryid', 'visible': true, 'allowEmpty': false});
    }
}
