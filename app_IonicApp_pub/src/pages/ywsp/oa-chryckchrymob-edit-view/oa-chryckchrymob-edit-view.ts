...
import { OA_CHRYCKCHRYMobEditViewBase } from './oa-chryckchrymob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-chryckchrymob-edit-view',
  templateUrl: 'oa-chryckchrymob-edit-view.html',
})

export class OA_CHRYCKCHRYMobEditView extends OA_CHRYCKCHRYMobEditViewBase {
