...
import { OA_CHRYMobListViewBase } from './oa-chrymob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-chrymob-list-view',
  templateUrl: 'oa-chrymob-list-view.html',
})

export class OA_CHRYMobListView extends OA_CHRYMobListViewBase {
