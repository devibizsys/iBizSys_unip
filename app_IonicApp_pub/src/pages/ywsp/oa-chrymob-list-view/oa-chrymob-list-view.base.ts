...
import {
	mdctrlService,
 } from './oa-chrymob-list-view.service';

export class OA_CHRYMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CHRYMobListView.do' }));
  }
