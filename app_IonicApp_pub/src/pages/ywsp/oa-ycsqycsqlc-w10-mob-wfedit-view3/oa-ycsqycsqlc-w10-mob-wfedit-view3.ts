...
import { OA_YCSQYCSQLC_W10_MobWFEditView3Base } from './oa-ycsqycsqlc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ycsqycsqlc-w10-mob-wfedit-view3',
  templateUrl: 'oa-ycsqycsqlc-w10-mob-wfedit-view3.html',
})

export class OA_YCSQYCSQLC_W10_MobWFEditView3 extends OA_YCSQYCSQLC_W10_MobWFEditView3Base {
