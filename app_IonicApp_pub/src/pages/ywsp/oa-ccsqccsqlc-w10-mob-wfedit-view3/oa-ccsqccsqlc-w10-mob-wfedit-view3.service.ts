...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'oa_ccsqid', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'ccdz', 'visible': true, 'allowEmpty': false});
        ...
        this.regItem({'name': 'ccsy', 'visible': true, 'allowEmpty': false});
