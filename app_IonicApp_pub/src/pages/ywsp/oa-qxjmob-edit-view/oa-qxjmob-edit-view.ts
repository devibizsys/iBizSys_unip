...
import { OA_QXJMobEditViewBase } from './oa-qxjmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjmob-edit-view',
  templateUrl: 'oa-qxjmob-edit-view.html',
})

export class OA_QXJMobEditView extends OA_QXJMobEditViewBase {
