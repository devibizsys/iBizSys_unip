...
import {
	formService,
 } from './oa-qxjmob-edit-view.service';

export class OA_QXJMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_QXJMobEditView.do' }));
  }
