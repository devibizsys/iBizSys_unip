...
import { OA_BGYPSQBGYPSQLC_W20_MobWFEditView3Base } from './oa-bgypsqbgypsqlc-w20-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqbgypsqlc-w20-mob-wfedit-view3',
  templateUrl: 'oa-bgypsqbgypsqlc-w20-mob-wfedit-view3.html',
})

export class OA_BGYPSQBGYPSQLC_W20_MobWFEditView3 extends OA_BGYPSQBGYPSQLC_W20_MobWFEditView3Base {
