...
import { OA_SBWXSBWXLC_W10_MobWFEditView3Base } from './oa-sbwxsbwxlc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxsbwxlc-w10-mob-wfedit-view3',
  templateUrl: 'oa-sbwxsbwxlc-w10-mob-wfedit-view3.html',
})

export class OA_SBWXSBWXLC_W10_MobWFEditView3 extends OA_SBWXSBWXLC_W10_MobWFEditView3Base {
