...
import {
	formService,
 } from './oa-sbwxsbwxlc-w10-mob-wfedit-view3.service';

export class OA_SBWXSBWXLC_W10_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_SBWXSBWXLC_W10_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC1020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_SBWXMobWFActionView","viewParam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"title":"设备维修",openMode:'POPUPMODAL'}
        };
