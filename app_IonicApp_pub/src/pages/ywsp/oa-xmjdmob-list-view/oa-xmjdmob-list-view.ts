...
import { OA_XMJDMobListViewBase } from './oa-xmjdmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-xmjdmob-list-view',
  templateUrl: 'oa-xmjdmob-list-view.html',
})

export class OA_XMJDMobListView extends OA_XMJDMobListViewBase {
