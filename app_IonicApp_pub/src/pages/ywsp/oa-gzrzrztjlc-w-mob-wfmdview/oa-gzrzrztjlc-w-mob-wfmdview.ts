...
import { OA_GZRZRZTJLC_W_MobWFMDViewBase } from './oa-gzrzrztjlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzrztjlc-w-mob-wfmdview',
  templateUrl: 'oa-gzrzrztjlc-w-mob-wfmdview.html',
})

export class OA_GZRZRZTJLC_W_MobWFMDView extends OA_GZRZRZTJLC_W_MobWFMDViewBase {
