...
import { OA_STWMDGSTWMDGLC_D_MobWFMDViewBase } from './oa-stwmdgstwmdglc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgstwmdglc-d-mob-wfmdview',
  templateUrl: 'oa-stwmdgstwmdglc-d-mob-wfmdview.html',
})

export class OA_STWMDGSTWMDGLC_D_MobWFMDView extends OA_STWMDGSTWMDGLC_D_MobWFMDViewBase {
