...
import {
	mdctrlService,
 } from './oa-stwmdgstwmdglc-d-mob-wfmdview.service';

export class OA_STWMDGSTWMDGLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_STWMDGSTWMDGLC_D_MobWFMDView.do' }));
  }
