...
import {
	formService,
 } from './oa-cgsqmob-edit-view.service';

export class OA_CGSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CGSQMobEditView.do' }));
  }
