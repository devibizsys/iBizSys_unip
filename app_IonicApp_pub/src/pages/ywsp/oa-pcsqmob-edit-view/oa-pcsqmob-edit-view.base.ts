...
import {
	formService,
 } from './oa-pcsqmob-edit-view.service';

export class OA_PCSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_PCSQMobEditView.do' }));
  }
