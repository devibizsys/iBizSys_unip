...
import { OA_BGYPSQBGYPSQLC_D_MobWFMDViewBase } from './oa-bgypsqbgypsqlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqbgypsqlc-d-mob-wfmdview',
  templateUrl: 'oa-bgypsqbgypsqlc-d-mob-wfmdview.html',
})

export class OA_BGYPSQBGYPSQLC_D_MobWFMDView extends OA_BGYPSQBGYPSQLC_D_MobWFMDViewBase {
