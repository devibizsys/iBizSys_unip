...
import {
	mdctrlService,
 } from './oa-bgypsqbgypsqlc-d-mob-wfmdview.service';

export class OA_BGYPSQBGYPSQLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_BGYPSQBGYPSQLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getNewDataView(params: any = {}): any {
      ...
      if(true){
      	let view={
            openMode:'',
            className:'OA_BGYPSQMobEditView',
            viewParam:params
      	};
      	return view;
      }
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_BGYPSQMobEditView', viewParam:params };
      }
    }
