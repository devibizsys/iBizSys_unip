...
import { OA_CGSQCGSQLC_W20_MobWFEditView3Base } from './oa-cgsqcgsqlc-w20-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqcgsqlc-w20-mob-wfedit-view3',
  templateUrl: 'oa-cgsqcgsqlc-w20-mob-wfedit-view3.html',
})

export class OA_CGSQCGSQLC_W20_MobWFEditView3 extends OA_CGSQCGSQLC_W20_MobWFEditView3Base {
