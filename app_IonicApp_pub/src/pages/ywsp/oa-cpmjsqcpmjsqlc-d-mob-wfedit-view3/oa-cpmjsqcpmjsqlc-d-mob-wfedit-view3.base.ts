...
import {
	formService,
 } from './oa-cpmjsqcpmjsqlc-d-mob-wfedit-view3.service';

export class OA_CPMJSQCPMJSQLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CPMJSQCPMJSQLC_D_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_CPMJSQCKMobListView","title":"车牌门禁申请",openMode:''}
        };
