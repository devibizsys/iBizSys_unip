...
import { OA_CPMJSQCPMJSQLC_D_MobWFEditView3Base } from './oa-cpmjsqcpmjsqlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqcpmjsqlc-d-mob-wfedit-view3',
  templateUrl: 'oa-cpmjsqcpmjsqlc-d-mob-wfedit-view3.html',
})

export class OA_CPMJSQCPMJSQLC_D_MobWFEditView3 extends OA_CPMJSQCPMJSQLC_D_MobWFEditView3Base {
