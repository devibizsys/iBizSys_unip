...
import { OA_CPMJSQCPMJSQLC_W20_MobWFEditView3Base } from './oa-cpmjsqcpmjsqlc-w20-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqcpmjsqlc-w20-mob-wfedit-view3',
  templateUrl: 'oa-cpmjsqcpmjsqlc-w20-mob-wfedit-view3.html',
})

export class OA_CPMJSQCPMJSQLC_W20_MobWFEditView3 extends OA_CPMJSQCPMJSQLC_W20_MobWFEditView3Base {
