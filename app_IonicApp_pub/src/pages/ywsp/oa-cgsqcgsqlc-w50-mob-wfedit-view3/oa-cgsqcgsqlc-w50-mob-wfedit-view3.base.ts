...
import {
	formService,
 } from './oa-cgsqcgsqlc-w50-mob-wfedit-view3.service';

export class OA_CGSQCGSQLC_W50_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CGSQCGSQLC_W50_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC5020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_CGSQMobWFActionView","viewParam":{"srfwfiatag":"AC5020","srfwfstep":"50"},"title":"采购申请",openMode:'POPUPMODAL'}
        };
