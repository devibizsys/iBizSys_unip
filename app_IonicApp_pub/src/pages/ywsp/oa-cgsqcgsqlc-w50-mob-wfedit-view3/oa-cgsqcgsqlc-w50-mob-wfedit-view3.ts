...
import { OA_CGSQCGSQLC_W50_MobWFEditView3Base } from './oa-cgsqcgsqlc-w50-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqcgsqlc-w50-mob-wfedit-view3',
  templateUrl: 'oa-cgsqcgsqlc-w50-mob-wfedit-view3.html',
})

export class OA_CGSQCGSQLC_W50_MobWFEditView3 extends OA_CGSQCGSQLC_W50_MobWFEditView3Base {
