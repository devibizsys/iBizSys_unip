...
import { OA_YYSSQMobListViewBase } from './oa-yyssqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-yyssqmob-list-view',
  templateUrl: 'oa-yyssqmob-list-view.html',
})

export class OA_YYSSQMobListView extends OA_YYSSQMobListViewBase {
