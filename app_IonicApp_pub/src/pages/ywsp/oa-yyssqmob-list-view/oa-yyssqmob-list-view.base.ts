...
import {
	mdctrlService,
 } from './oa-yyssqmob-list-view.service';

export class OA_YYSSQMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YYSSQMobListView.do' }));
  }
