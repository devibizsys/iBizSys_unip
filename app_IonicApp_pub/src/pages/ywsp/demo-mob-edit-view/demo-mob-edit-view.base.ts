...
import {
	formService,
 } from './demo-mob-edit-view.service';

export class demoMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/demoMobEditView.do' }));
  }
