...
import { demoMobEditViewBase } from './demo-mob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'demo-mob-edit-view',
  templateUrl: 'demo-mob-edit-view.html',
})

export class demoMobEditView extends demoMobEditViewBase {
