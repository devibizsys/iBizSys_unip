...
import { OA_STWMDGSTWMDGLC_D_MobWFEditView3Base } from './oa-stwmdgstwmdglc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgstwmdglc-d-mob-wfedit-view3',
  templateUrl: 'oa-stwmdgstwmdglc-d-mob-wfedit-view3.html',
})

export class OA_STWMDGSTWMDGLC_D_MobWFEditView3 extends OA_STWMDGSTWMDGLC_D_MobWFEditView3Base {
