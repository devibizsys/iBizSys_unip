...
import {
	formService,
 } from './oa-stwmdgstwmdglc-d-mob-wfedit-view3.service';

export class OA_STWMDGSTWMDGLC_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_STWMDGSTWMDGLC_D_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_STWMDGCKMobListView","title":"食堂外卖订购查看",openMode:''}
        };
