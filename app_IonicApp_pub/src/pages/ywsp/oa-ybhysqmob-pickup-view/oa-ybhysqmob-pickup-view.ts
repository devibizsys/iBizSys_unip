...
import { OA_YBHYSQMobPickupViewBase } from './oa-ybhysqmob-pickup-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqmob-pickup-view',
  templateUrl: 'oa-ybhysqmob-pickup-view.html',
})

export class OA_YBHYSQMobPickupView extends OA_YBHYSQMobPickupViewBase {
