...
import {
	formService,
 } from './oa-ybhysqshyjmob-wfaction-view.service';

export class OA_YBHYSQSHYJMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YBHYSQSHYJMobWFActionView.do' }));
  }
