...
import { demoMobListViewBase } from './demo-mob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'demo-mob-list-view',
  templateUrl: 'demo-mob-list-view.html',
})

export class demoMobListView extends demoMobListViewBase {
