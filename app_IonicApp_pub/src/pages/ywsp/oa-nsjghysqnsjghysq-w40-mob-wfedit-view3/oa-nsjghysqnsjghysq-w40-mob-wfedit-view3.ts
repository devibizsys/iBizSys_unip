...
import { OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3Base } from './oa-nsjghysqnsjghysq-w40-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqnsjghysq-w40-mob-wfedit-view3',
  templateUrl: 'oa-nsjghysqnsjghysq-w40-mob-wfedit-view3.html',
})

export class OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3 extends OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3Base {
