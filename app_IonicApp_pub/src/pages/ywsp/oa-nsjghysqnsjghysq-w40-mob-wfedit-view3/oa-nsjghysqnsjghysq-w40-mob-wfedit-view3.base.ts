...
import {
	formService,
 } from './oa-nsjghysqnsjghysq-w40-mob-wfedit-view3.service';

export class OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC4020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_NSJGHYSQMobWFActionView","viewParam":{"srfwfiatag":"AC4020","srfwfstep":"40"},"title":"内设机构会议申请",openMode:'POPUPMODAL'}
        };
        super.regUIAction(uiaction_0);
        let uiaction_1 = {"type":"WFUIACTION","tag":"AC4010","actiontarget":"MULTIKEY"
