...
import { WFWorkListMyWFMobListViewBase } from './wfwork-list-my-wfmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'wfwork-list-my-wfmob-list-view',
  templateUrl: 'wfwork-list-my-wfmob-list-view.html',
})

export class WFWorkListMyWFMobListView extends WFWorkListMyWFMobListViewBase {
