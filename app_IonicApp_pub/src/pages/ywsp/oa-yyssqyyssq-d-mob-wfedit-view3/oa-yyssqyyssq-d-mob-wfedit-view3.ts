...
import { OA_YYSSQYYSSQ_D_MobWFEditView3Base } from './oa-yyssqyyssq-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-yyssqyyssq-d-mob-wfedit-view3',
  templateUrl: 'oa-yyssqyyssq-d-mob-wfedit-view3.html',
})

export class OA_YYSSQYYSSQ_D_MobWFEditView3 extends OA_YYSSQYYSSQ_D_MobWFEditView3Base {
