...
import {
	mdctrlService,
 } from './oa-qxjmob-list-view.service';

export class OA_QXJMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_QXJMobListView.do' }));
  }
