...
import { OA_QXJMobListViewBase } from './oa-qxjmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjmob-list-view',
  templateUrl: 'oa-qxjmob-list-view.html',
})

export class OA_QXJMobListView extends OA_QXJMobListViewBase {
