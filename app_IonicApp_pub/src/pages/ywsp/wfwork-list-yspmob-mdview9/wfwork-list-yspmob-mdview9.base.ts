...
import {
	mdctrlService,
	searchformService,
 } from './wfwork-list-yspmob-mdview9.service';

export class WFWorkListYSPMobMDView9Base extends IBizListViewController {

    mdctrl: mdctrlService;
    searchform: searchformService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/WFWorkListYSPMobMDView9.do' }));
  }
