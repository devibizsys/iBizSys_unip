...
import { WFWorkListYSPMobMDView9Base } from './wfwork-list-yspmob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'wfwork-list-yspmob-mdview9',
  templateUrl: 'wfwork-list-yspmob-mdview9.html',
})

export class WFWorkListYSPMobMDView9 extends WFWorkListYSPMobMDView9Base {
