...
import { OA_STWMDGSTWMDGLC_W10_MobWFEditView3Base } from './oa-stwmdgstwmdglc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgstwmdglc-w10-mob-wfedit-view3',
  templateUrl: 'oa-stwmdgstwmdglc-w10-mob-wfedit-view3.html',
})

export class OA_STWMDGSTWMDGLC_W10_MobWFEditView3 extends OA_STWMDGSTWMDGLC_W10_MobWFEditView3Base {
