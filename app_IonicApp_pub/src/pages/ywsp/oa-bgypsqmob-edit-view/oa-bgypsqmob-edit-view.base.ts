...
import {
	formService,
 } from './oa-bgypsqmob-edit-view.service';

export class OA_BGYPSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_BGYPSQMobEditView.do' }));
  }
