...
import { OA_BGYPSQMobEditViewBase } from './oa-bgypsqmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqmob-edit-view',
  templateUrl: 'oa-bgypsqmob-edit-view.html',
})

export class OA_BGYPSQMobEditView extends OA_BGYPSQMobEditViewBase {
