...
import { OA_QXJCKMobEditViewBase } from './oa-qxjckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjckmob-edit-view',
  templateUrl: 'oa-qxjckmob-edit-view.html',
})

export class OA_QXJCKMobEditView extends OA_QXJCKMobEditViewBase {
