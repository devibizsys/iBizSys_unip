...
import {
	formService,
 } from './oa-qxjckmob-edit-view.service';

export class OA_QXJCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_QXJCKMobEditView.do' }));
  }
