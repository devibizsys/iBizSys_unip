...
import { OA_QXJQXJLC_W_MobWFMDViewBase } from './oa-qxjqxjlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjqxjlc-w-mob-wfmdview',
  templateUrl: 'oa-qxjqxjlc-w-mob-wfmdview.html',
})

export class OA_QXJQXJLC_W_MobWFMDView extends OA_QXJQXJLC_W_MobWFMDViewBase {
