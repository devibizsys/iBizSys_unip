...
import { OA_GZRZMyReceiveMobMDView9Base } from './oa-gzrzmy-receive-mob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzmy-receive-mob-mdview9',
  templateUrl: 'oa-gzrzmy-receive-mob-mdview9.html',
})

export class OA_GZRZMyReceiveMobMDView9 extends OA_GZRZMyReceiveMobMDView9Base {
