...
import {
	formService,
 } from './oa-gzrzrztjlc-d-xybmob-wfedit-view3.service';

export class OA_GZRZRZTJLC_D_XYBMobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_GZRZRZTJLC_D_XYBMobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_GZRZCKMobListView","title":"工作日志查看",openMode:''}
        };
