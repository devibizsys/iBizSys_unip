...
import { OA_GZRZRZTJLC_D_XYBMobWFEditView3Base } from './oa-gzrzrztjlc-d-xybmob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzrztjlc-d-xybmob-wfedit-view3',
  templateUrl: 'oa-gzrzrztjlc-d-xybmob-wfedit-view3.html',
})

export class OA_GZRZRZTJLC_D_XYBMobWFEditView3 extends OA_GZRZRZTJLC_D_XYBMobWFEditView3Base {
