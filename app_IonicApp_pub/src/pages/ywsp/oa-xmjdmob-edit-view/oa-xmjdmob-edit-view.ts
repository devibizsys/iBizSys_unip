...
import { OA_XMJDMobEditViewBase } from './oa-xmjdmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-xmjdmob-edit-view',
  templateUrl: 'oa-xmjdmob-edit-view.html',
})

export class OA_XMJDMobEditView extends OA_XMJDMobEditViewBase {
