...
import {
	formService,
 } from './oa-xmjdmob-edit-view.service';

export class OA_XMJDMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_XMJDMobEditView.do' }));
  }
