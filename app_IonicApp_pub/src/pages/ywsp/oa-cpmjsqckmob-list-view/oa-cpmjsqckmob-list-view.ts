...
import { OA_CPMJSQCKMobListViewBase } from './oa-cpmjsqckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqckmob-list-view',
  templateUrl: 'oa-cpmjsqckmob-list-view.html',
})

export class OA_CPMJSQCKMobListView extends OA_CPMJSQCKMobListViewBase {
