...
import { OA_CGSQCKMobEditViewBase } from './oa-cgsqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqckmob-edit-view',
  templateUrl: 'oa-cgsqckmob-edit-view.html',
})

export class OA_CGSQCKMobEditView extends OA_CGSQCKMobEditViewBase {
