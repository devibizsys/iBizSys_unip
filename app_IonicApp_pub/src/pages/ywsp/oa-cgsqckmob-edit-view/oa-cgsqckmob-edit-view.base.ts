...
import {
	formService,
 } from './oa-cgsqckmob-edit-view.service';

export class OA_CGSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CGSQCKMobEditView.do' }));
  }
