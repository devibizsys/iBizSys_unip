...
import {
	formService,
 } from './oa-cpmjsqcpmjsqlc-w10-mob-wfedit-view3.service';

export class OA_CPMJSQCPMJSQLC_W10_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CPMJSQCPMJSQLC_W10_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC1020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_CPMJSQMobWFActionView","viewParam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"title":"车牌门禁申请",openMode:'POPUPMODAL'}
        };
