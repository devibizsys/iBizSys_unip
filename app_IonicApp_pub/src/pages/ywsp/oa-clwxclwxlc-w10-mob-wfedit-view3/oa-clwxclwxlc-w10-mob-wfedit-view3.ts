...
import { OA_CLWXCLWXLC_W10_MobWFEditView3Base } from './oa-clwxclwxlc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxclwxlc-w10-mob-wfedit-view3',
  templateUrl: 'oa-clwxclwxlc-w10-mob-wfedit-view3.html',
})

export class OA_CLWXCLWXLC_W10_MobWFEditView3 extends OA_CLWXCLWXLC_W10_MobWFEditView3Base {
