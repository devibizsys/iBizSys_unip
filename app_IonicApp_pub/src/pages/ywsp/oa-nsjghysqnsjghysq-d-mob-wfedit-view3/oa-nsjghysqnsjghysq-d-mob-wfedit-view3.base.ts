...
import {
	formService,
 } from './oa-nsjghysqnsjghysq-d-mob-wfedit-view3.service';

export class OA_NSJGHYSQNSJGHYSQ_D_MobWFEditView3Base extends IBizWFEditViewController {

  drtab: IBizDRTabService;
  form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQNSJGHYSQ_D_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        ...
        let uiaction_1 = {"type":"DEUIACTION","tag":"CKJL","actiontarget":"NONE"
            ,"actionmode":"FRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_NSJGHYSQCKMobListView","title":"内设机构会议申请查看",openMode:''}
        };
