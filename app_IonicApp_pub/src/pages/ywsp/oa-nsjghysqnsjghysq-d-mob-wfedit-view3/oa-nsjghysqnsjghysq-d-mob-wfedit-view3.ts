...
import { OA_NSJGHYSQNSJGHYSQ_D_MobWFEditView3Base } from './oa-nsjghysqnsjghysq-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqnsjghysq-d-mob-wfedit-view3',
  templateUrl: 'oa-nsjghysqnsjghysq-d-mob-wfedit-view3.html',
})

export class OA_NSJGHYSQNSJGHYSQ_D_MobWFEditView3 extends OA_NSJGHYSQNSJGHYSQ_D_MobWFEditView3Base {
