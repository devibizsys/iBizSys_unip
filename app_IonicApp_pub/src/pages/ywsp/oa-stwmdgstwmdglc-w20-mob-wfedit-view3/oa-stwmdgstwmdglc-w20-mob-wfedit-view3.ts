...
import { OA_STWMDGSTWMDGLC_W20_MobWFEditView3Base } from './oa-stwmdgstwmdglc-w20-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgstwmdglc-w20-mob-wfedit-view3',
  templateUrl: 'oa-stwmdgstwmdglc-w20-mob-wfedit-view3.html',
})

export class OA_STWMDGSTWMDGLC_W20_MobWFEditView3 extends OA_STWMDGSTWMDGLC_W20_MobWFEditView3Base {
