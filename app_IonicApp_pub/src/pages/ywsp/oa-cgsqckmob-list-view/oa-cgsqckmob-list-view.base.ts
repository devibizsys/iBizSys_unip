...
import {
	mdctrlService,
 } from './oa-cgsqckmob-list-view.service';

export class OA_CGSQCKMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CGSQCKMobListView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getNewDataView(params: any = {}): any {
      ...
      if(true){
      	let view={
            openMode:'',
            className:'OA_CGSQCKMobEditView',
            viewParam:params
      	};
      	return view;
      }
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_CGSQCKMobEditView', viewParam:params };
      }
    }
