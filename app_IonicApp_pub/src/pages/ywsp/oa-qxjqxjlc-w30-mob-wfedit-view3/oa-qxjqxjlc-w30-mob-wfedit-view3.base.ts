...
import {
	formService,
 } from './oa-qxjqxjlc-w30-mob-wfedit-view3.service';

export class OA_QXJQXJLC_W30_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_QXJQXJLC_W30_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC3020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_QXJMobWFActionView","viewParam":{"srfwfiatag":"AC3020","srfwfstep":"30"},"title":"审核意见",openMode:'POPUPMODAL'}
        };
