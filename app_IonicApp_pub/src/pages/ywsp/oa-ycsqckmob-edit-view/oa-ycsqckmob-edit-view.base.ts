...
import {
	formService,
 } from './oa-ycsqckmob-edit-view.service';

export class OA_YCSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YCSQCKMobEditView.do' }));
  }
