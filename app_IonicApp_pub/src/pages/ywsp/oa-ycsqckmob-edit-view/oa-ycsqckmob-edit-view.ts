...
import { OA_YCSQCKMobEditViewBase } from './oa-ycsqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ycsqckmob-edit-view',
  templateUrl: 'oa-ycsqckmob-edit-view.html',
})

export class OA_YCSQCKMobEditView extends OA_YCSQCKMobEditViewBase {
