...
import { OA_NSJGHYSQNSJGHYSQ_W_MobWFMDViewBase } from './oa-nsjghysqnsjghysq-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqnsjghysq-w-mob-wfmdview',
  templateUrl: 'oa-nsjghysqnsjghysq-w-mob-wfmdview.html',
})

export class OA_NSJGHYSQNSJGHYSQ_W_MobWFMDView extends OA_NSJGHYSQNSJGHYSQ_W_MobWFMDViewBase {
