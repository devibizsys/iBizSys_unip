...
import {
	mdctrlService,
 } from './oa-nsjghysqmob-list-view.service';

export class OA_NSJGHYSQMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQMobListView.do' }));
  }
