...
import { OA_NSJGHYSQMobListViewBase } from './oa-nsjghysqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqmob-list-view',
  templateUrl: 'oa-nsjghysqmob-list-view.html',
})

export class OA_NSJGHYSQMobListView extends OA_NSJGHYSQMobListViewBase {
