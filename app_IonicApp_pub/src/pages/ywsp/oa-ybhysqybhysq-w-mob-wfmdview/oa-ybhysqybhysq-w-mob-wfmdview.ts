...
import { OA_YBHYSQYBHYSQ_W_MobWFMDViewBase } from './oa-ybhysqybhysq-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqybhysq-w-mob-wfmdview',
  templateUrl: 'oa-ybhysqybhysq-w-mob-wfmdview.html',
})

export class OA_YBHYSQYBHYSQ_W_MobWFMDView extends OA_YBHYSQYBHYSQ_W_MobWFMDViewBase {
