...
import { OA_CPMJSQMobEditViewBase } from './oa-cpmjsqmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqmob-edit-view',
  templateUrl: 'oa-cpmjsqmob-edit-view.html',
})

export class OA_CPMJSQMobEditView extends OA_CPMJSQMobEditViewBase {
