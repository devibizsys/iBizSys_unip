...
import {
	formService,
 } from './oa-cpmjsqmob-edit-view.service';

export class OA_CPMJSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CPMJSQMobEditView.do' }));
  }
