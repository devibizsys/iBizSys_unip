...
import {
	formService,
 } from './oa-ccsqccsqlc-w20-mob-wfedit-view3.service';

export class OA_CCSQCCSQLC_W20_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CCSQCCSQLC_W20_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC2020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_CCSQMobWFActionView","viewParam":{"srfwfiatag":"AC2020","srfwfstep":"20"},"title":"出差申请",openMode:'POPUPMODAL'}
        };
