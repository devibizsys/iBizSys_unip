...
import { OA_CCSQCCSQLC_W20_MobWFEditView3Base } from './oa-ccsqccsqlc-w20-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqccsqlc-w20-mob-wfedit-view3',
  templateUrl: 'oa-ccsqccsqlc-w20-mob-wfedit-view3.html',
})

export class OA_CCSQCCSQLC_W20_MobWFEditView3 extends OA_CCSQCCSQLC_W20_MobWFEditView3Base {
