...
import {
	mdctrlService,
 } from './oa-sbwxmob-list-view.service';

export class OA_SBWXMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_SBWXMobListView.do' }));
  }
