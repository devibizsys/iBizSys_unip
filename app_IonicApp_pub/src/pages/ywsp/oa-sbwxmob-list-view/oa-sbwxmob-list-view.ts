...
import { OA_SBWXMobListViewBase } from './oa-sbwxmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxmob-list-view',
  templateUrl: 'oa-sbwxmob-list-view.html',
})

export class OA_SBWXMobListView extends OA_SBWXMobListViewBase {
