...
import { OA_JPYDCKMobListViewBase } from './oa-jpydckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-jpydckmob-list-view',
  templateUrl: 'oa-jpydckmob-list-view.html',
})

export class OA_JPYDCKMobListView extends OA_JPYDCKMobListViewBase {
