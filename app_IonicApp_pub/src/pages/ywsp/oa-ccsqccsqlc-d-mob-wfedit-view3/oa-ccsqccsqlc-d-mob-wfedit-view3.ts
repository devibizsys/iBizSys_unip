...
import { OA_CCSQCCSQLC_D_MobWFEditView3Base } from './oa-ccsqccsqlc-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqccsqlc-d-mob-wfedit-view3',
  templateUrl: 'oa-ccsqccsqlc-d-mob-wfedit-view3.html',
})

export class OA_CCSQCCSQLC_D_MobWFEditView3 extends OA_CCSQCCSQLC_D_MobWFEditView3Base {
