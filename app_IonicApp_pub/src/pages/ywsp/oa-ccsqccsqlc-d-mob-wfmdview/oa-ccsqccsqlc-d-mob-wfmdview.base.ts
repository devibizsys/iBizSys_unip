...
import {
	mdctrlService,
 } from './oa-ccsqccsqlc-d-mob-wfmdview.service';

export class OA_CCSQCCSQLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CCSQCCSQLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_CCSQMobEditView', viewParam:params };
      }
    }
