...
import { OA_CCSQCCSQLC_D_MobWFMDViewBase } from './oa-ccsqccsqlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqccsqlc-d-mob-wfmdview',
  templateUrl: 'oa-ccsqccsqlc-d-mob-wfmdview.html',
})

export class OA_CCSQCCSQLC_D_MobWFMDView extends OA_CCSQCCSQLC_D_MobWFMDViewBase {
