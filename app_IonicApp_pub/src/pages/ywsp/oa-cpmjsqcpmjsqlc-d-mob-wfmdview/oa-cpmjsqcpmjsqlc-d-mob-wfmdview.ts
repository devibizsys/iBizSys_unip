...
import { OA_CPMJSQCPMJSQLC_D_MobWFMDViewBase } from './oa-cpmjsqcpmjsqlc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqcpmjsqlc-d-mob-wfmdview',
  templateUrl: 'oa-cpmjsqcpmjsqlc-d-mob-wfmdview.html',
})

export class OA_CPMJSQCPMJSQLC_D_MobWFMDView extends OA_CPMJSQCPMJSQLC_D_MobWFMDViewBase {
