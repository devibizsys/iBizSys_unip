...
import { OA_CHRYMobEditViewBase } from './oa-chrymob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-chrymob-edit-view',
  templateUrl: 'oa-chrymob-edit-view.html',
})

export class OA_CHRYMobEditView extends OA_CHRYMobEditViewBase {
