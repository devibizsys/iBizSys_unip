...
import { WFStepDataMobMDView9Base } from './wfstep-data-mob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'wfstep-data-mob-mdview9',
  templateUrl: 'wfstep-data-mob-mdview9.html',
})

export class WFStepDataMobMDView9 extends WFStepDataMobMDView9Base {
