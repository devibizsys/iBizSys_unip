...
import { OA_STWMDGSTWMDGLC_W_MobWFMDViewBase } from './oa-stwmdgstwmdglc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgstwmdglc-w-mob-wfmdview',
  templateUrl: 'oa-stwmdgstwmdglc-w-mob-wfmdview.html',
})

export class OA_STWMDGSTWMDGLC_W_MobWFMDView extends OA_STWMDGSTWMDGLC_W_MobWFMDViewBase {
