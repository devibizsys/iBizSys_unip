...
import {
	formService,
 } from './oa-jpydjpydlc-w10-mob-wfedit-view3.service';

export class OA_JPYDJPYDLC_W10_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_JPYDJPYDLC_W10_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC1020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_JPYDMobWFActionView","viewParam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"title":"机票预订",openMode:'POPUPMODAL'}
        };
