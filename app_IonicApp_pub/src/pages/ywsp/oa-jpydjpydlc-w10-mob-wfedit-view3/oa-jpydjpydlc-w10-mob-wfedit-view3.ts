...
import { OA_JPYDJPYDLC_W10_MobWFEditView3Base } from './oa-jpydjpydlc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-jpydjpydlc-w10-mob-wfedit-view3',
  templateUrl: 'oa-jpydjpydlc-w10-mob-wfedit-view3.html',
})

export class OA_JPYDJPYDLC_W10_MobWFEditView3 extends OA_JPYDJPYDLC_W10_MobWFEditView3Base {
