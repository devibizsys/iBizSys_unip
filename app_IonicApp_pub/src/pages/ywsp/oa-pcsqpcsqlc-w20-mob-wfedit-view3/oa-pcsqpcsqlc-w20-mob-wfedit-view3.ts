...
import { OA_PCSQPCSQLC_W20_MobWFEditView3Base } from './oa-pcsqpcsqlc-w20-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqpcsqlc-w20-mob-wfedit-view3',
  templateUrl: 'oa-pcsqpcsqlc-w20-mob-wfedit-view3.html',
})

export class OA_PCSQPCSQLC_W20_MobWFEditView3 extends OA_PCSQPCSQLC_W20_MobWFEditView3Base {
