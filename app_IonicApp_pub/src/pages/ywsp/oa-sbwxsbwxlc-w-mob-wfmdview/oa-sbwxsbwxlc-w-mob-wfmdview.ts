...
import { OA_SBWXSBWXLC_W_MobWFMDViewBase } from './oa-sbwxsbwxlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxsbwxlc-w-mob-wfmdview',
  templateUrl: 'oa-sbwxsbwxlc-w-mob-wfmdview.html',
})

export class OA_SBWXSBWXLC_W_MobWFMDView extends OA_SBWXSBWXLC_W_MobWFMDViewBase {
