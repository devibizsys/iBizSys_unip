...
import { OA_GZRZMySenderMobMDView9Base } from './oa-gzrzmy-sender-mob-mdview9.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzmy-sender-mob-mdview9',
  templateUrl: 'oa-gzrzmy-sender-mob-mdview9.html',
})

export class OA_GZRZMySenderMobMDView9 extends OA_GZRZMySenderMobMDView9Base {
