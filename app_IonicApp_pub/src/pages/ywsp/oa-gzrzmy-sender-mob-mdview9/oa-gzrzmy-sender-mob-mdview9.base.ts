...
import {
	mdctrlService,
	searchformService,
 } from './oa-gzrzmy-sender-mob-mdview9.service';

export class OA_GZRZMySenderMobMDView9Base extends IBizListViewController {

    mdctrl: mdctrlService;
    searchform: searchformService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_GZRZMySenderMobMDView9.do' }));
  }
