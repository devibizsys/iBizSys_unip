...
import {
	mdctrlService,
 } from './oa-jpydmob-list-view.service';

export class OA_JPYDMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_JPYDMobListView.do' }));
  }
