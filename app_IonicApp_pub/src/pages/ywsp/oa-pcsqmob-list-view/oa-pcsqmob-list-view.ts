...
import { OA_PCSQMobListViewBase } from './oa-pcsqmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqmob-list-view',
  templateUrl: 'oa-pcsqmob-list-view.html',
})

export class OA_PCSQMobListView extends OA_PCSQMobListViewBase {
