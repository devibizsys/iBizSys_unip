...
import {
	mdctrlService,
 } from './oa-pcsqmob-list-view.service';

export class OA_PCSQMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_PCSQMobListView.do' }));
  }
