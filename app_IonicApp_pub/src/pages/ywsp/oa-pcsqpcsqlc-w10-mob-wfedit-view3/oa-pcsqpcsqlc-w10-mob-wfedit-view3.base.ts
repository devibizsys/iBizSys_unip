...
import {
	formService,
 } from './oa-pcsqpcsqlc-w10-mob-wfedit-view3.service';

export class OA_PCSQPCSQLC_W10_MobWFEditView3Base extends IBizWFEditViewController {
  ...
  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_PCSQPCSQLC_W10_MobWFEditView3.do' }));
  }
  ...
  regUIActions(config){
        let uiaction_0 = {"type":"WFUIACTION","tag":"AC1020","actiontarget":"MULTIKEY"
            ,"actionmode":"WFFRONT"
            ,"fronttype":"WIZARD"
,"frontview":{"className":"OA_PCSQMobWFActionView","viewParam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"title":"派车申请",openMode:'POPUPMODAL'}
        };
