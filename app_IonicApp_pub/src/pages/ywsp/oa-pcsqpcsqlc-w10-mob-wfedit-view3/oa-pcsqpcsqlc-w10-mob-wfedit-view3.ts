...
import { OA_PCSQPCSQLC_W10_MobWFEditView3Base } from './oa-pcsqpcsqlc-w10-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqpcsqlc-w10-mob-wfedit-view3',
  templateUrl: 'oa-pcsqpcsqlc-w10-mob-wfedit-view3.html',
})

export class OA_PCSQPCSQLC_W10_MobWFEditView3 extends OA_PCSQPCSQLC_W10_MobWFEditView3Base {
