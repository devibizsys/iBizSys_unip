...
import { OA_YBHYSQYBHYMobEditViewBase } from './oa-ybhysqybhymob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqybhymob-edit-view',
  templateUrl: 'oa-ybhysqybhymob-edit-view.html',
})

export class OA_YBHYSQYBHYMobEditView extends OA_YBHYSQYBHYMobEditViewBase {
