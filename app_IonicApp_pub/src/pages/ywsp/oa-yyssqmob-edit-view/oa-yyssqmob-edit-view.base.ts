...
import {
	formService,
 } from './oa-yyssqmob-edit-view.service';

export class OA_YYSSQMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YYSSQMobEditView.do' }));
  }
