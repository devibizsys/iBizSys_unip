...
import { OA_YBHYSQYBHYSQ_D_MobWFEditView3Base } from './oa-ybhysqybhysq-d-mob-wfedit-view3.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqybhysq-d-mob-wfedit-view3',
  templateUrl: 'oa-ybhysqybhysq-d-mob-wfedit-view3.html',
})

export class OA_YBHYSQYBHYSQ_D_MobWFEditView3 extends OA_YBHYSQYBHYSQ_D_MobWFEditView3Base {
