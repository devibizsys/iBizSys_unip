...
import { OA_PCSQPCSQLC_W_MobWFMDViewBase } from './oa-pcsqpcsqlc-w-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqpcsqlc-w-mob-wfmdview',
  templateUrl: 'oa-pcsqpcsqlc-w-mob-wfmdview.html',
})

export class OA_PCSQPCSQLC_W_MobWFMDView extends OA_PCSQPCSQLC_W_MobWFMDViewBase {
