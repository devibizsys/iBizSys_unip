...
import { OA_QXJMobWFActionViewBase } from './oa-qxjmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjmob-wfaction-view',
  templateUrl: 'oa-qxjmob-wfaction-view.html',
})

export class OA_QXJMobWFActionView extends OA_QXJMobWFActionViewBase {
