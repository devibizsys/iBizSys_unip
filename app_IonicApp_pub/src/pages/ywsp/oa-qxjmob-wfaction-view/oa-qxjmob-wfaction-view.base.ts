...
import {
	formService,
 } from './oa-qxjmob-wfaction-view.service';

export class OA_QXJMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_QXJMobWFActionView.do' }));
  }
