...
import { demoDEMOLC_D_MobWFMDViewBase } from './demo-demolc-d-mob-wfmdview.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'demo-demolc-d-mob-wfmdview',
  templateUrl: 'demo-demolc-d-mob-wfmdview.html',
})

export class demoDEMOLC_D_MobWFMDView extends demoDEMOLC_D_MobWFMDViewBase {
