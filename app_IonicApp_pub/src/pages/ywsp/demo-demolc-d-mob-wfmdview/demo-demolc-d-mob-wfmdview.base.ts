...
import {
	mdctrlService,
 } from './demo-demolc-d-mob-wfmdview.service';

export class demoDEMOLC_D_MobWFMDViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/demoDEMOLC_D_MobWFMDView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'demoMobEditView', viewParam:params };
      }
    }
