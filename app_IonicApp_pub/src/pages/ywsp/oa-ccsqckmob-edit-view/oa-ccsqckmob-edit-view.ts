...
import { OA_CCSQCKMobEditViewBase } from './oa-ccsqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqckmob-edit-view',
  templateUrl: 'oa-ccsqckmob-edit-view.html',
})

export class OA_CCSQCKMobEditView extends OA_CCSQCKMobEditViewBase {
