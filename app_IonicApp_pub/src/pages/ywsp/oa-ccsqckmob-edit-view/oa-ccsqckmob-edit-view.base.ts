...
import {
	formService,
 } from './oa-ccsqckmob-edit-view.service';

export class OA_CCSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CCSQCKMobEditView.do' }));
  }
