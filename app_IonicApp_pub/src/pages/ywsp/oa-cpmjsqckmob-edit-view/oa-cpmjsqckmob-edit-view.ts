...
import { OA_CPMJSQCKMobEditViewBase } from './oa-cpmjsqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqckmob-edit-view',
  templateUrl: 'oa-cpmjsqckmob-edit-view.html',
})

export class OA_CPMJSQCKMobEditView extends OA_CPMJSQCKMobEditViewBase {
