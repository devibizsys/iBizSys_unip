...
import {
	formService,
 } from './oa-cpmjsqckmob-edit-view.service';

export class OA_CPMJSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_CPMJSQCKMobEditView.do' }));
  }
