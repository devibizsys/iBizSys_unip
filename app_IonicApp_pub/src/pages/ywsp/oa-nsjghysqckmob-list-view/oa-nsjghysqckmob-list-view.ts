...
import { OA_NSJGHYSQCKMobListViewBase } from './oa-nsjghysqckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqckmob-list-view',
  templateUrl: 'oa-nsjghysqckmob-list-view.html',
})

export class OA_NSJGHYSQCKMobListView extends OA_NSJGHYSQCKMobListViewBase {
