...
import {
	mdctrlService,
 } from './oa-nsjghysqckmob-list-view.service';

export class OA_NSJGHYSQCKMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_NSJGHYSQCKMobListView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getNewDataView(params: any = {}): any {
      ...
      if(true){
      	let view={
            openMode:'',
            className:'OA_NSJGHYSQCKMobEditView',
            viewParam:params
      	};
      	return view;
      }
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_NSJGHYSQCKMobEditView', viewParam:params };
      }
    }
