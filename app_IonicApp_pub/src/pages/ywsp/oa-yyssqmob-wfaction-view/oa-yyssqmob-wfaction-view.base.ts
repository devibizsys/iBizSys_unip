...
import {
	formService,
 } from './oa-yyssqmob-wfaction-view.service';

export class OA_YYSSQMobWFActionViewBase extends IBizWFActionViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/ywsp/OA_YYSSQMobWFActionView.do' }));
  }
