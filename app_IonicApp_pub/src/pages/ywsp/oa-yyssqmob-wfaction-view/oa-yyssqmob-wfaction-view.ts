...
import { OA_YYSSQMobWFActionViewBase } from './oa-yyssqmob-wfaction-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-yyssqmob-wfaction-view',
  templateUrl: 'oa-yyssqmob-wfaction-view.html',
})

export class OA_YYSSQMobWFActionView extends OA_YYSSQMobWFActionViewBase {
