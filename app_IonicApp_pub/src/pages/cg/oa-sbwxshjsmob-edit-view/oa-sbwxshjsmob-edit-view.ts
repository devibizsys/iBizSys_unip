...
import { OA_SBWXSHJSMobEditViewBase } from './oa-sbwxshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-sbwxshjsmob-edit-view',
  templateUrl: 'oa-sbwxshjsmob-edit-view.html',
})

export class OA_SBWXSHJSMobEditView extends OA_SBWXSHJSMobEditViewBase {
