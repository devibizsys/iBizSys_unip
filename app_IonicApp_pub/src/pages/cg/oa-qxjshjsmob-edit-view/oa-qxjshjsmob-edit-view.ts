...
import { OA_QXJSHJSMobEditViewBase } from './oa-qxjshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-qxjshjsmob-edit-view',
  templateUrl: 'oa-qxjshjsmob-edit-view.html',
})

export class OA_QXJSHJSMobEditView extends OA_QXJSHJSMobEditViewBase {
