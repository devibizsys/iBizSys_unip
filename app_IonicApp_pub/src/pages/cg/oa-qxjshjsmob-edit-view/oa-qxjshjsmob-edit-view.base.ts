...
import {
	formService,
 } from './oa-qxjshjsmob-edit-view.service';

export class OA_QXJSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_QXJSHJSMobEditView.do' }));
  }
