...
import { OA_GZRZSHJSMobEditViewBase } from './oa-gzrzshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-gzrzshjsmob-edit-view',
  templateUrl: 'oa-gzrzshjsmob-edit-view.html',
})

export class OA_GZRZSHJSMobEditView extends OA_GZRZSHJSMobEditViewBase {
