...
import { OrgUserTreeMobMPickupViewBase } from './org-user-tree-mob-mpickup-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'org-user-tree-mob-mpickup-view',
  templateUrl: 'org-user-tree-mob-mpickup-view.html',
})

export class OrgUserTreeMobMPickupView extends OrgUserTreeMobMPickupViewBase {
