...
import { OA_STWMDGSHJSMobEditViewBase } from './oa-stwmdgshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-stwmdgshjsmob-edit-view',
  templateUrl: 'oa-stwmdgshjsmob-edit-view.html',
})

export class OA_STWMDGSHJSMobEditView extends OA_STWMDGSHJSMobEditViewBase {
