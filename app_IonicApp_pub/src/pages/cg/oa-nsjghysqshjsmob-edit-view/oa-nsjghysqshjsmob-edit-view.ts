...
import { OA_NSJGHYSQSHJSMobEditViewBase } from './oa-nsjghysqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-nsjghysqshjsmob-edit-view',
  templateUrl: 'oa-nsjghysqshjsmob-edit-view.html',
})

export class OA_NSJGHYSQSHJSMobEditView extends OA_NSJGHYSQSHJSMobEditViewBase {
