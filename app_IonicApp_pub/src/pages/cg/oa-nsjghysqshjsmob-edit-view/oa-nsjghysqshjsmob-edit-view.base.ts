...
import {
	formService,
 } from './oa-nsjghysqshjsmob-edit-view.service';

export class OA_NSJGHYSQSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_NSJGHYSQSHJSMobEditView.do' }));
  }
