...
import { OA_YBHYSQCKMobListViewBase } from './oa-ybhysqckmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqckmob-list-view',
  templateUrl: 'oa-ybhysqckmob-list-view.html',
})

export class OA_YBHYSQCKMobListView extends OA_YBHYSQCKMobListViewBase {
