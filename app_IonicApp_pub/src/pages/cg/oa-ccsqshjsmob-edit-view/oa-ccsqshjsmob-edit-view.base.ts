...
import {
	formService,
 } from './oa-ccsqshjsmob-edit-view.service';

export class OA_CCSQSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_CCSQSHJSMobEditView.do' }));
  }
