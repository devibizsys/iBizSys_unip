...
import { OA_CCSQSHJSMobEditViewBase } from './oa-ccsqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ccsqshjsmob-edit-view',
  templateUrl: 'oa-ccsqshjsmob-edit-view.html',
})

export class OA_CCSQSHJSMobEditView extends OA_CCSQSHJSMobEditViewBase {
