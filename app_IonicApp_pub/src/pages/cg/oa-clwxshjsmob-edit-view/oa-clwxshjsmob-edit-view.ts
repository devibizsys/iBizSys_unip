...
import { OA_CLWXSHJSMobEditViewBase } from './oa-clwxshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clwxshjsmob-edit-view',
  templateUrl: 'oa-clwxshjsmob-edit-view.html',
})

export class OA_CLWXSHJSMobEditView extends OA_CLWXSHJSMobEditViewBase {
