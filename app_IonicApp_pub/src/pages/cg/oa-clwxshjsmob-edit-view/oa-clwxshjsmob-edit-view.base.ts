...
import {
	formService,
 } from './oa-clwxshjsmob-edit-view.service';

export class OA_CLWXSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_CLWXSHJSMobEditView.do' }));
  }
