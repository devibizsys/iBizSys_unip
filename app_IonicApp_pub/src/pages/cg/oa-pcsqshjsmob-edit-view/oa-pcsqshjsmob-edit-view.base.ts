...
import {
	formService,
 } from './oa-pcsqshjsmob-edit-view.service';

export class OA_PCSQSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_PCSQSHJSMobEditView.do' }));
  }
