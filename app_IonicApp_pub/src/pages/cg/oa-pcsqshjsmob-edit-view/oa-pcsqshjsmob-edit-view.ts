...
import { OA_PCSQSHJSMobEditViewBase } from './oa-pcsqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-pcsqshjsmob-edit-view',
  templateUrl: 'oa-pcsqshjsmob-edit-view.html',
})

export class OA_PCSQSHJSMobEditView extends OA_PCSQSHJSMobEditViewBase {
