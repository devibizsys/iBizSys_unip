...
import { OA_TZGGSHJSMobEditViewBase } from './oa-tzggshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-tzggshjsmob-edit-view',
  templateUrl: 'oa-tzggshjsmob-edit-view.html',
})

export class OA_TZGGSHJSMobEditView extends OA_TZGGSHJSMobEditViewBase {
