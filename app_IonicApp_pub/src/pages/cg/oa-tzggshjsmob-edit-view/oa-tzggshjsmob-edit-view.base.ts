...
import {
	formService,
 } from './oa-tzggshjsmob-edit-view.service';

export class OA_TZGGSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_TZGGSHJSMobEditView.do' }));
  }
