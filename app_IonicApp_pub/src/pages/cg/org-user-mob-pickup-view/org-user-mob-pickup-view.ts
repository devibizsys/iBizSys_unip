...
import { OrgUserMobPickupViewBase } from './org-user-mob-pickup-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'org-user-mob-pickup-view',
  templateUrl: 'org-user-mob-pickup-view.html',
})

export class OrgUserMobPickupView extends OrgUserMobPickupViewBase {
