...
import { OrgUserMobPickupListViewBase } from './org-user-mob-pickup-list-view.base';

@Component({
  selector: 'org-user-mob-pickup-list-view',
  templateUrl: 'org-user-mob-pickup-list-view.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => OrgUserMobPickupListView),
      multi: true
    }
  ]
})

export class OrgUserMobPickupListView extends OrgUserMobPickupListViewBase {
