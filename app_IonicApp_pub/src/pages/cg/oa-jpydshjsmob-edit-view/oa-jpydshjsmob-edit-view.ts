...
import { OA_JPYDSHJSMobEditViewBase } from './oa-jpydshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-jpydshjsmob-edit-view',
  templateUrl: 'oa-jpydshjsmob-edit-view.html',
})

export class OA_JPYDSHJSMobEditView extends OA_JPYDSHJSMobEditViewBase {
