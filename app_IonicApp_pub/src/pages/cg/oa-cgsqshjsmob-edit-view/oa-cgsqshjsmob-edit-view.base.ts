...
import {
	formService,
 } from './oa-cgsqshjsmob-edit-view.service';

export class OA_CGSQSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_CGSQSHJSMobEditView.do' }));
  }
