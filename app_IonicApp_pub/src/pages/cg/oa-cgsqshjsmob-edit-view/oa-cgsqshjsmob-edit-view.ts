...
import { OA_CGSQSHJSMobEditViewBase } from './oa-cgsqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cgsqshjsmob-edit-view',
  templateUrl: 'oa-cgsqshjsmob-edit-view.html',
})

export class OA_CGSQSHJSMobEditView extends OA_CGSQSHJSMobEditViewBase {
