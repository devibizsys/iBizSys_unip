...
import { OA_YBHYSQSHJSMobEditViewBase } from './oa-ybhysqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqshjsmob-edit-view',
  templateUrl: 'oa-ybhysqshjsmob-edit-view.html',
})

export class OA_YBHYSQSHJSMobEditView extends OA_YBHYSQSHJSMobEditViewBase {
