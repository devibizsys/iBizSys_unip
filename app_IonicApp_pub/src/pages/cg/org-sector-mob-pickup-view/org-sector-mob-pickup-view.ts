...
import { OrgSectorMobPickupViewBase } from './org-sector-mob-pickup-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'org-sector-mob-pickup-view',
  templateUrl: 'org-sector-mob-pickup-view.html',
})

export class OrgSectorMobPickupView extends OrgSectorMobPickupViewBase {
