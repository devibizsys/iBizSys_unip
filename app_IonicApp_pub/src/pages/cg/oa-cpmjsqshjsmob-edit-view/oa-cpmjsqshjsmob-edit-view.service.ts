...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'lxfs', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'clpp', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'color', 'visible': true, 'allowEmpty': false});
        ...
        this.regItem({'name': 'oa_cpmjsqid', 'visible': true, 'allowEmpty': false});
    }
}
