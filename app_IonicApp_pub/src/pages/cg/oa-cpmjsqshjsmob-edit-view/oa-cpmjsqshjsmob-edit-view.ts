...
import { OA_CPMJSQSHJSMobEditViewBase } from './oa-cpmjsqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-cpmjsqshjsmob-edit-view',
  templateUrl: 'oa-cpmjsqshjsmob-edit-view.html',
})

export class OA_CPMJSQSHJSMobEditView extends OA_CPMJSQSHJSMobEditViewBase {
