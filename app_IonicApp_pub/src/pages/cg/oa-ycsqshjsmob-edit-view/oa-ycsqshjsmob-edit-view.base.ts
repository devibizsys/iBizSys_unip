...
import {
	formService,
 } from './oa-ycsqshjsmob-edit-view.service';

export class OA_YCSQSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_YCSQSHJSMobEditView.do' }));
  }
