...
import { OA_YCSQSHJSMobEditViewBase } from './oa-ycsqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ycsqshjsmob-edit-view',
  templateUrl: 'oa-ycsqshjsmob-edit-view.html',
})

export class OA_YCSQSHJSMobEditView extends OA_YCSQSHJSMobEditViewBase {
