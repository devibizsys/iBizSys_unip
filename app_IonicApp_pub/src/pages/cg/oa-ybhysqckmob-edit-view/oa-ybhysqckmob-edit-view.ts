...
import { OA_YBHYSQCKMobEditViewBase } from './oa-ybhysqckmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-ybhysqckmob-edit-view',
  templateUrl: 'oa-ybhysqckmob-edit-view.html',
})

export class OA_YBHYSQCKMobEditView extends OA_YBHYSQCKMobEditViewBase {
