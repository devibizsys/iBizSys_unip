...
import {
	formService,
 } from './oa-ybhysqckmob-edit-view.service';

export class OA_YBHYSQCKMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_YBHYSQCKMobEditView.do' }));
  }
