...
import { OA_BGYPSQSHJSMobEditViewBase } from './oa-bgypsqshjsmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-bgypsqshjsmob-edit-view',
  templateUrl: 'oa-bgypsqshjsmob-edit-view.html',
})

export class OA_BGYPSQSHJSMobEditView extends OA_BGYPSQSHJSMobEditViewBase {
