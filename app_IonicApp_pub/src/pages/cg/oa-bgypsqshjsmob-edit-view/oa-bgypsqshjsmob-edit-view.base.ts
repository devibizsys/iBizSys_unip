...
import {
	formService,
 } from './oa-bgypsqshjsmob-edit-view.service';

export class OA_BGYPSQSHJSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/cg/OA_BGYPSQSHJSMobEditView.do' }));
  }
