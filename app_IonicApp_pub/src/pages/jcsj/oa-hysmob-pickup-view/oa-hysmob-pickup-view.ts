...
import { OA_HYSMobPickupViewBase } from './oa-hysmob-pickup-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-hysmob-pickup-view',
  templateUrl: 'oa-hysmob-pickup-view.html',
})

export class OA_HYSMobPickupView extends OA_HYSMobPickupViewBase {
