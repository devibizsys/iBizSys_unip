...
import { OA_FLFGMobListViewBase } from './oa-flfgmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-flfgmob-list-view',
  templateUrl: 'oa-flfgmob-list-view.html',
})

export class OA_FLFGMobListView extends OA_FLFGMobListViewBase {
