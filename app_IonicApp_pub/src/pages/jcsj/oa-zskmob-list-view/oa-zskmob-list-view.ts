...
import { OA_ZSKMobListViewBase } from './oa-zskmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-zskmob-list-view',
  templateUrl: 'oa-zskmob-list-view.html',
})

export class OA_ZSKMobListView extends OA_ZSKMobListViewBase {
