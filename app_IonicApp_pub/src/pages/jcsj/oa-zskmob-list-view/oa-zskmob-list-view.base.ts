...
import {
	mdctrlService,
	searchformService,
 } from './oa-zskmob-list-view.service';

export class OA_ZSKMobListViewBase extends IBizListViewController {

    mdctrl: mdctrlService;
    searchform: searchformService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/jcsj/OA_ZSKMobListView.do' }));
  }
  ...
  regUIActions(config){
    ...
    public getEditDataView(params: any = {}): any {
      ...
      if(true){
	      return { openMode:'', className:'OA_ZSKMobEditView', viewParam:params };
      }
    }
