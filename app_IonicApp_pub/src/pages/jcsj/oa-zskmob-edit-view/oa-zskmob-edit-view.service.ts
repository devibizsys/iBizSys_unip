...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'oa_zskid', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'oa_zskname', 'visible': true, 'allowEmpty': true});
        ...
        this.regItem({'name': 'lrsj', 'visible': true, 'allowEmpty': true});
        this.regItem({'name': 'content', 'visible': true, 'allowEmpty': false});
