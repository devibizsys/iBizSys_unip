...
import { OA_ZSKMobEditViewBase } from './oa-zskmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-zskmob-edit-view',
  templateUrl: 'oa-zskmob-edit-view.html',
})

export class OA_ZSKMobEditView extends OA_ZSKMobEditViewBase {
