...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'hysdz', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'syqk', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'sysj', 'visible': true, 'allowEmpty': false});
