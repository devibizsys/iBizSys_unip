...
import { OA_HYSMobEditViewBase } from './oa-hysmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-hysmob-edit-view',
  templateUrl: 'oa-hysmob-edit-view.html',
})

export class OA_HYSMobEditView extends OA_HYSMobEditViewBase {
