...
import {
	formService,
 } from './oa-hysmob-edit-view.service';

export class OA_HYSMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/jcsj/OA_HYSMobEditView.do' }));
  }
