...
import { OA_HYSMobListViewBase } from './oa-hysmob-list-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-hysmob-list-view',
  templateUrl: 'oa-hysmob-list-view.html',
})

export class OA_HYSMobListView extends OA_HYSMobListViewBase {
