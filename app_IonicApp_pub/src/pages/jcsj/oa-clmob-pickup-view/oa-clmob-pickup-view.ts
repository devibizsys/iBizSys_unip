...
import { OA_CLMobPickupViewBase } from './oa-clmob-pickup-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-clmob-pickup-view',
  templateUrl: 'oa-clmob-pickup-view.html',
})

export class OA_CLMobPickupView extends OA_CLMobPickupViewBase {
