...
import {
	formService,
 } from './oa-flfgmob-edit-view.service';

export class OA_FLFGMobEditViewBase extends IBizEditViewController {

    form: formService;

  constructor(opt) {
    super(Object.assign(opt, { 'url': '/IonicApp/jcsj/OA_FLFGMobEditView.do' }));
  }
