...
export class formService extends IBizEditFormService {
    ...
    public regItems(): void {
        ...
        this.regItem({'name': 'oa_flfgname', 'visible': true, 'allowEmpty': false});
        this.regItem({'name': 'zy', 'visible': true, 'allowEmpty': false});
        ...
        this.regItem({'name': 'oa_flfgid', 'visible': true, 'allowEmpty': false});
    }
}
