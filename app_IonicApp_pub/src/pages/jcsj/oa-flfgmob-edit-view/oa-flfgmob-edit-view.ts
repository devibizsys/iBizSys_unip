...
import { OA_FLFGMobEditViewBase } from './oa-flfgmob-edit-view.base';

@IonicPage({
  priority: 'off'
})
@Component({
  selector: 'oa-flfgmob-edit-view',
  templateUrl: 'oa-flfgmob-edit-view.html',
})

export class OA_FLFGMobEditView extends OA_FLFGMobEditViewBase {
