var QueryModelCurDEMPickupViewControllerBase = MPickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/demodel/QueryModelCurDEMPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/demodel/querymodelcurdempickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
