var QueryModelEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    ...
    this.regController(new DataEntityGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C2'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/demodel/QueryModelEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/demodel/querymodeleditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M3',name:'querymodelid'}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/demodel/dataentitygridview.jsp',embedviewid:'C2'};
      	}
      if(drmode=='DRITEM1'){
