var DataEntityPickupGridViewControllerBase = PickupGridViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/demodel/DataEntityPickupGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/demodel/dataentitypickupgridview.jsp?'+'srfcid='+cfg.containerid+'&'
