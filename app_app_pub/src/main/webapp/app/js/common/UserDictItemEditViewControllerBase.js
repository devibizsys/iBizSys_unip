var UserDictItemEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/UserDictItemEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userdictitemeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/UserDictItemEditView.do?SRFCTRLID=form&SRFFORMITEMID=userdictname'
...
,ac:true
,url:this.getAppCtx()+'/common/UserDictItemEditView.do?SRFCTRLID=form&SRFFORMITEMID=userdictcatname'
