var MsgSendQueueHisEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/MsgSendQueueHisEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/msgsendqueuehiseditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
