var OrgUserLevelEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/OrgUserLevelEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orguserleveleditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M5',name:'orguserlevelid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'orguserlevelname',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'levelcode',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M8',name:'ordervalue',allowBlank:false,form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/orgusergridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});