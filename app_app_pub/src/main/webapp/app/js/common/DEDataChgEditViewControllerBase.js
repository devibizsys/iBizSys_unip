var DEDataChgEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/DEDataChgEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/dedatachgeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
