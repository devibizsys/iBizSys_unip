var OrgTypeEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/OrgTypeEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgtypeeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M5',name:'orgtypeid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'orgtypename',allowBlank:false,form:form}));
