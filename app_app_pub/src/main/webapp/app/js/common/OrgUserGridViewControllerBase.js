var OrgUserGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/orgusereditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '组织人员实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/orgusereditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/orgusergridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '所属组织',"width":100,"data" :'orgname',"orderable":true}

,{ "title" : '所属部门',"width":100,"data" :'orgsectorname',"orderable":true}

,{ "title" : '人员名称',"width":150,"data" :'orgusername',"orderable":true}

,{ "title" : '用户编号',"width":150,"data" :'usercode',"orderable":true}

,{ "title" : '人员级别',"width":100,"data" :'orguserlevelname',"orderable":true}

,{ "title" : '备注',"width":100,"data" :'memo',"orderable":true}

,{ "title" : '人员排序',"width":100,"data" :'ordervalue',"orderable":true}
...
,{ "title" : '头衔名称',"width":100,"data" :'titlename',"orderable":true}

,{ "title" : '部门人员关系',"width":100,"data" :'orgsecusertypename',"orderable":true}
