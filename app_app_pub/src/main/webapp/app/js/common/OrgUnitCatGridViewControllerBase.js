var OrgUnitCatGridViewControllerBase = GridViewControllerBase.extend({
...
form.register(new IBizTextField({id:this.getCId2()+'M4',name:'n_orgunitcatname_like',form:form,width:100})
);
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/orgunitcateditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '组织单元类别实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/orgunitcateditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUnitCatGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/orgunitcatgridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '组织单元类别名称',"width":150,"data" :'orgunitcatname',"orderable":true}

,{ "title" : '类别代码',"width":100,"data" :'catcode',"orderable":true}
...
},searchForm:{enableAdvanceSearch:false,dename:'ORGUNITCAT'}}};
