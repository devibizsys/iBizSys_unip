var TSSDTaskEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/TSSDTaskEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/tssdtaskeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
