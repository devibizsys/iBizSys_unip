var UserRoleDetailEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserRoleDetailEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userroledetaileditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDetailEditView2.do?SRFCTRLID=form&SRFFORMITEMID=uesrrolename'
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDetailEditView2.do?SRFCTRLID=form&SRFFORMITEMID=userobjectname'
