var MsgAccountEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/MsgAccountEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/msgaccounteditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M5',name:'msgaccountid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'msgaccountname',allowBlank:false,form:form}));
form.register(new IBizDropDownListField({id:this.getCId2()+'M7',name:'islist',allowBlank:false,form:form,codelistid:'uniPSample_YesNo',width:100}));
form.register(new IBizTextField({id:this.getCId2()+'M8',name:'msgaddress',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M9',name:'mailaddress',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Ma',name:'mobile',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mb',name:'wxaddr',form:form}));
