var LoginLogEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/LoginLogEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/loginlogeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/LoginLogEditView2.do?SRFCTRLID=form&SRFFORMITEMID=loginaccountname'
