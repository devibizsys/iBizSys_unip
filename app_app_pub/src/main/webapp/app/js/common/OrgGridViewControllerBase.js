var OrgGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/orgeditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '组织机构实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/orgeditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/orggridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : $IGM('DEF.LNAME.ORGNAME','组织机构名称'),"width":150,"data" :'orgname',"orderable":true}

,{ "title" : $IGM('DEF.LNAME.ORGCODE','组织编号'),"width":150,"data" :'orgcode',"orderable":true}

,{ "title" : $IGM('DEF.LNAME.PORGNAME','上级机构'),"width":150,"data" :'porgname',"orderable":true}

,{ "title" : $IGM('DEF.LNAME.MEMO','备注'),"data" :'memo',"orderable":true}
...
},searchForm:{enableAdvanceSearch:false,dename:'ORG'}}};
...
,doHideParentColumns: function (parentMode)
    {
        ...
        arguments.callee.$.doHideParentColumns.call(this,parentMode);
         ...
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_ORG_ORG_PORGID')
         {
              me.hideGridColumn('porgname');
              return;
         }
}
});