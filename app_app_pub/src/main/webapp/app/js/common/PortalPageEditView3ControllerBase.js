var PortalPageEditView3ControllerBase = EditView3ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new PVPartGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/PortalPageEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/portalpageeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Md',name:'portalpageid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M5',name:'group1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'portalpagename',allowBlank:false,form:form}));
form.register(new IBizFormGroup({id:this.getCId2()+'M8',name:'group2',titleBarCloseMode:'0',form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/common/ppmodelgridview.jsp',embedviewid:'C2',viewparam:{"srfparentdeid":"f63040021720d1401ec2014d30b02bb6","srfparenttype":"DER1N","srfder1nid":"DER1N_PPMODEL_PORTALPAGE_PORTALPAGEID"}};
      	}
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/pvpartgridview.jsp',embedviewid:'C1',viewparam:{"srfparentdeid":"f63040021720d1401ec2014d30b02bb6","srfparenttype":"DER1N","srfder1nid":"DER1N_PVPART_PORTALPAGE_PORTALPAGEID"}};
      	}
       return null;
 }
});