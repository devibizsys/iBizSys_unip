var LoginAccountEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new LoginLogGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/LoginAccountEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/loginaccounteditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/LoginAccountEditView2.do?SRFCTRLID=form&SRFFORMITEMID=username'
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/loginloggridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});