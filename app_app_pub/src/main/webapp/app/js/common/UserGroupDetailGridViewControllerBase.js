var UserGroupDetailGridViewControllerBase = GridViewControllerBase.extend({
...
form.register(new IBizTextField({id:this.getCId2()+'M4',name:'n_usergroupdetailname_like',form:form,width:100})
);
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/usergroupdetaileditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '用户组成员编辑', openMode:'POPUPMODAL', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/usergroupdetaileditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
   ...
   ,getMPickupView: function (arg)
    {
        ...
        if(!tempMode)
             tempMode=false;
        if ( parentMode.srfder1nid=='DER1N_USERGROUPDETAIL_USERGROUP_USERGROUPID'){
arg.srftempmode=false;
        ...
        if (parentMode.srfder1nid=='DER1N_USERGROUPDETAIL_USEROBJECT_USEROBJECTID'){
arg.srftempmode=false;
            var view={
                modal:true,
    	        title: '用户组实体数据多项选择视图',
    	        ...
    	        width: 0,
    	        layout: 'fit',
                viewurl:'/common/usergroupmpickupview.jsp',
                viewparam:arg
    	     };
	    return view;
        }
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/UserGroupDetailGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/usergroupdetailgridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '用户组',"width":194,"data" :'usergroupname',"orderable":true}

,{ "title" : '用户对象',"width":190,"data" :'userobjectname',"orderable":true}

,{ "title" : '更新人',"width":120,"data" :'updateman',"orderable":true}

,{ "title" : '更新时间',"width":150,"data" :'updatedate',"orderable":true}
]
},searchForm:{enableAdvanceSearch:false,dename:'USERGROUPDETAIL'}}};
...
,doHideParentColumns: function (parentMode)
    {
        ...
        arguments.callee.$.doHideParentColumns.call(this,parentMode);
         ...
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_USERGROUPDETAIL_USERGROUP_USERGROUPID')
         {
              me.hideGridColumn('USERGROUPNAME');
              return;
         }
         //关系类型 : DER1N ,主实体 :USEROBJECT / 用户对象
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_USERGROUPDETAIL_USEROBJECT_USEROBJECTID')
         {
