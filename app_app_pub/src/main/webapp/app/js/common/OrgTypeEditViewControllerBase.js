var OrgTypeEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/OrgTypeEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgtypeeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
