var CodeListGridViewControllerBase = GridViewControllerBase.extend({
...
,regUIActions:function(config)
{
  ...
  var uiaction_9 = {"type":"DEUIACTION","tag":"RefreshModel","actiontarget":"MULTIKEY"
,"actionmode":"BACKEND"
,"timeout":60000
};
...
form.register(new IBizTextField({id:this.getCId2()+'M4',name:'n_codelistname_like',form:form,width:100})
);
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/codelisteditview3.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '代码表编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/codelisteditview3.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/CodeListGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/codelistgridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '代码表名称',"width":150,"data" :'codelistname',"orderable":true}

,{ "title" : '代码表标识',"width":150,"data" :'codelistid',"orderable":true}
...
},searchForm:{enableAdvanceSearch:false,dename:'CODELIST'}}};
...
,doHideParentColumns: function (parentMode)
    {
        ...
        arguments.callee.$.doHideParentColumns.call(this,parentMode);
         ...
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_CODELIST_DATAENTITY_DEID')
         {
              return;
         }
}
