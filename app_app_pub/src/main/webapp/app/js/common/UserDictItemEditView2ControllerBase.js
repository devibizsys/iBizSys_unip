var UserDictItemEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserDictItemEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userdictitemeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M11',name:'userdictcatid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M12',name:'userdictid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M13',name:'userdictitemid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M4',name:'grouppanel1',titleBarCloseMode:'0',form:form}));
form.register(new IBizPickerField({id:this.getCId2()+'M5',name:'userdictname',allowBlank:false,form:form,forceSelection:true,queryCaching:false, displayField:'text',valueField: 'value',valueItem:'userdictid',minChars:2,pageSize:50
,pickupView:{view:'/common/userdictpickupview.jsp',title:'用户词典实体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/UserDictItemEditView2.do?SRFCTRLID=form&SRFFORMITEMID=userdictname'

}));
form.register(new IBizPickerField({id:this.getCId2()+'M6',name:'userdictcatname',allowBlank:false,form:form,forceSelection:true,queryCaching:false, displayField:'text',valueField: 'value',valueItem:'userdictcatid',minChars:2,pageSize:50
,ac:true
,url:this.getAppCtx()+'/common/UserDictItemEditView2.do?SRFCTRLID=form&SRFFORMITEMID=userdictcatname'

}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'userdictitemname',allowBlank:false,form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M8',name:'content',allowBlank:false,form:form,height:200}));
form.register(new IBizTextField({id:this.getCId2()+'M9',name:'markflag',form:form}));
