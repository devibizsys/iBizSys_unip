var MsgTemplateEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new WFAppSettingGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
    this.regController(new WFWorkflowGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C2'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/MsgTemplateEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/msgtemplateeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/MsgTemplateEditView2.do?SRFCTRLID=form&SRFFORMITEMID=dename'
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/wf/wfworkflowgridview.jsp',embedviewid:'C2'};
      	}
      if(drmode=='DRITEM1'){
          return {viewurl:'/wf/wfappsettinggridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});