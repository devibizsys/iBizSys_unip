var CodeListEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/CodeListEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/codelisteditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M5',name:'codelistid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'codelistname',allowBlank:false,form:form}));
