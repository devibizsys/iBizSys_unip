var OrgUserLevelEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/OrgUserLevelEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orguserleveleditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
