var UserDictGridViewControllerBase = GridViewControllerBase.extend({
...
,regUIActions:function(config)
{
  ...
  var uiaction_9 = {"type":"DEUIACTION","tag":"ReloadCurUser","actiontarget":"NONE"
,"actionmode":"BACKEND"
,"timeout":60000
};
...
form.register(new IBizTextField({id:this.getCId2()+'M4',name:'n_userdictname_like',form:form,width:100})
);
...
,getNewDataView:function(arg){
      ...
      if(true){
	var view={
			title: '用户词典实体编辑视图（分页关系）',
			openMode:'',
			 height: 0,
	    	    width: 0,
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/userdicteditview3.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '用户词典实体编辑视图（分页关系）', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/userdicteditview3.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/UserDictGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/userdictgridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '用户词典名称',"width":150,"data" :'userdictname',"orderable":true}
...
},searchForm:{enableAdvanceSearch:false,dename:'USERDICT'}}};
