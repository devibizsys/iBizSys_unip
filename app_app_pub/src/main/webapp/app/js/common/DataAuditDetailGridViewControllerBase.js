var DataAuditDetailGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/dataauditdetaileditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '数据审计明细实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/dataauditdetaileditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/DataAuditDetailGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/dataauditdetailgridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '属性',"width":150,"data" :'dataauditdetailname',"orderable":true}

,{ "title" : '更新人',"width":150,"data" :'updateman',"orderable":true}

,{ "title" : '更新时间',"width":150,"data" :'updatedate',"orderable":true}
]
},searchForm:{enableAdvanceSearch:false,dename:'DATAAUDITDETAIL'}}};
...
,doHideParentColumns: function (parentMode)
    {
        ...
        arguments.callee.$.doHideParentColumns.call(this,parentMode);
         ...
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_DATAAUDITDETAIL_DATAAUDIT_DATAAUDITID')
         {
              return;
         }
}
