var UserDictEditView3ControllerBase = EditView3ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new UserDictItemGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserDictEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userdicteditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M10',name:'userdictid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M5',name:'grouppanel1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'userdictname',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'ownertype',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M8',name:'ownerid',allowBlank:false,form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/userdictitemgridview.jsp',embedviewid:'C1',viewparam:{"srfparentdeid":"de0f12cf67b20fb12eb5454093998c74","srfparenttype":"DER1N","srfder1nid":"DER1N_USERDICTITEM_USERDICT_USERDICTID"}};
      	}
       return null;
 }
});