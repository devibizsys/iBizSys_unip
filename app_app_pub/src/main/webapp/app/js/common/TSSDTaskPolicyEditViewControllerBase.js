var TSSDTaskPolicyEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/TSSDTaskPolicyEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/tssdtaskpolicyeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
