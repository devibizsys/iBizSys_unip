var UserGroupDetailEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserGroupDetailEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/usergroupdetaileditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/UserGroupDetailEditView2.do?SRFCTRLID=form&SRFFORMITEMID=usergroupname'
...
,ac:true
,url:this.getAppCtx()+'/common/UserGroupDetailEditView2.do?SRFCTRLID=form&SRFFORMITEMID=userobjectname'
