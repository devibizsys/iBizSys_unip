var SysAdminFuncEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/SysAdminFuncEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/sysadminfunceditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
