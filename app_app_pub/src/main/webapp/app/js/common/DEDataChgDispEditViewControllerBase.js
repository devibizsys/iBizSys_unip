var DEDataChgDispEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/DEDataChgDispEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/dedatachgdispeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
