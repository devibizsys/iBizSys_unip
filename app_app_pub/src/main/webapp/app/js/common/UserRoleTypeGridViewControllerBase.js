var UserRoleTypeGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/userroletypeeditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '用户角色类型实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/userroletypeeditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/UserRoleTypeGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/userroletypegridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '用户角色类型标识',"width":150,"data" :'userroletypeid',"orderable":true}

,{ "title" : '用户角色类型名称',"width":150,"data" :'userroletypename',"orderable":true}

,{ "title" : '用户数据',"width":150,"data" :'userdata',"orderable":true}

,{ "title" : '用户数据2',"width":150,"data" :'userdata2',"orderable":true}
...
},searchForm:{enableAdvanceSearch:false,dename:'USERROLETYPE'}}};
