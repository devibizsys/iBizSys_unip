var OrgUserPickupViewControllerBase = PickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orguserpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
