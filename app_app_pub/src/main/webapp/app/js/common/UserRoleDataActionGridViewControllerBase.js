var UserRoleDataActionGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
      ...
      if(true){
	var view={
			title: '用户角色数据操作实体编辑视图',
			openMode:'POPUPMODAL',
			 height: 400,
	    	    width: 600,
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/userroledataactioneditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '用户角色数据操作实体编辑视图', openMode:'POPUPMODAL', height: 400, width: 600,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/userroledataactioneditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/UserRoleDataActionGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/userroledataactiongridview.jsp?'+'srfcid='+cfg.containerid+'&'
