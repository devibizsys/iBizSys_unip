var TSSDPolicyEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/TSSDPolicyEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/tssdpolicyeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
