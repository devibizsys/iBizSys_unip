var UserRoleDEFieldsGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
      ...
      if(true){
	var view={
			title: '用户角色相关实体属性访问控制实体编辑视图',
			openMode:'',
			 height: 0,
	    	    width: 0,
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/userroledefieldseditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '用户角色相关实体属性访问控制实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/userroledefieldseditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
   ...
   ,getMPickupView: function (arg)
    {
        ...
        if(!tempMode)
             tempMode=false;
        if ( parentMode.srfder1nid=='DER1N_USERROLEDEFIELDS_USERROLEDEFIELD_USERROLEDEFIELDID'){
arg.srftempmode=false;
        ...
        if (parentMode.srfder1nid=='DER1N_USERROLEDEFIELDS_USERROLE_USERROLEID'){
arg.srftempmode=false;
            var view={
                modal:true,
    	        title: '用户角色实体属性访问实体数据多项选择视图',
    	        height: 0,
    	        width: 0,
    	        layout: 'fit',
                viewurl:'/common/userroledefieldmpickupview.jsp',
                viewparam:arg
    	     };
	    return view;
        }
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/UserRoleDEFieldsGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/userroledefieldsgridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '用户角色相关实体属性访问控制',"width":150,"data" :'userroledefieldsname',"orderable":true}

,{ "title" : '更新人',"width":150,"data" :'updateman',"orderable":true}

,{ "title" : '更新时间',"width":150,"data" :'updatedate',"orderable":true}
]
},searchForm:{enableAdvanceSearch:false,dename:'USERROLEDEFIELDS'}}};
...
,doHideParentColumns: function (parentMode)
    {
        ...
        arguments.callee.$.doHideParentColumns.call(this,parentMode);
         ...
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_USERROLEDEFIELDS_USERROLEDEFIELD_USERROLEDEFIELDID')
         {
              return;
         }
         //关系类型 : DER1N ,主实体 :USERROLE / 用户角色
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_USERROLEDEFIELDS_USERROLE_USERROLEID')
         {
              return;
         }
}
