var OrgUserLevelPickupViewControllerBase = PickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserLevelPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orguserlevelpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
