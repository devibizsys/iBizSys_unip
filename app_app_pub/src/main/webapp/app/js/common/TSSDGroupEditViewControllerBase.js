var TSSDGroupEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/TSSDGroupEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/tssdgroupeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
