var OrgEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/OrgEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/OrgEditView.do?SRFCTRLID=form&SRFFORMITEMID=porgname'
