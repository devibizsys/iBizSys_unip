var TSSDGroupDetailEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/TSSDGroupDetailEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/tssdgroupdetaileditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
