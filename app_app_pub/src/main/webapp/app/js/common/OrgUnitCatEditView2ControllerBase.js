var OrgUnitCatEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/OrgUnitCatEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgunitcateditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M5',name:'orgunitcatid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'orgunitcatname',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'catcode',allowBlank:false,form:form}));
