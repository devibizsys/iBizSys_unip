var UserRoleDatasEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserRoleDatasEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userroledataseditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDatasEditView2.do?SRFCTRLID=form&SRFFORMITEMID=userrolename'
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDatasEditView2.do?SRFCTRLID=form&SRFFORMITEMID=userroledataname'
