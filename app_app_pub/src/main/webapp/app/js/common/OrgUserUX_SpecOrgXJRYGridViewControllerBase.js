var OrgUserUX_SpecOrgXJRYGridViewControllerBase = GridViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserUX_SpecOrgXJRYGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/orguserux_specorgxjrygridview.jsp?'+'srfcid='+cfg.containerid+'&'
