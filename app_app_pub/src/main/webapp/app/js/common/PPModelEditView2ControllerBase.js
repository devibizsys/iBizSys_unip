var PPModelEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/PPModelEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/ppmodeleditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=l1pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=c1pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=r1pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=l2pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=c2pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=r2pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=l3pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=c3pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=r3pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=l4pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=c4pvpartname'
...
,pickupView:{view:'/common/pvpartcurpvpickupview.jsp',title:'当前门户视图部件体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/common/PPModelEditView2.do?SRFCTRLID=form&SRFFORMITEMID=r4pvpartname'
