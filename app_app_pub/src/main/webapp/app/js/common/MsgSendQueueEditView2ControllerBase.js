var MsgSendQueueEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/MsgSendQueueEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/msgsendqueueeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M1d',name:'msgsendqueueid'}));
