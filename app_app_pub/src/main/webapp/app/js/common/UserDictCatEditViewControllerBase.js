var UserDictCatEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/UserDictCatEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userdictcateditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
