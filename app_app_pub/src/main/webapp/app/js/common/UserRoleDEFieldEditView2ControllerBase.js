var UserRoleDEFieldEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserRoleDEFieldEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userroledefieldeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDEFieldEditView2.do?SRFCTRLID=form&SRFFORMITEMID=dename'
