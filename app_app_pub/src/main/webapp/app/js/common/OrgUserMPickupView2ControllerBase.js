var OrgUserMPickupView2ControllerBase = MPickupView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserMPickupView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgusermpickupview2.jsp?'+'srfcid='+cfg.containerid+'&'};
