var UserDictCatGridViewControllerBase = GridViewControllerBase.extend({
...
form.register(new IBizTextField({id:this.getCId2()+'M4',name:'n_userdictcatname_like',form:form,width:100})
);
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/userdictcateditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '用户词典类别实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/userdictcateditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/UserDictCatGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/userdictcatgridview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{grid:{multiSelect:true
,enablePaging:true,pageSize:20,forceFit:false
,columns:[
{ "title" : '用户词典类别名称',"width":150,"data" :'userdictcatname',"orderable":true}
...
},searchForm:{enableAdvanceSearch:false,dename:'USERDICTCAT'}}};
