var MsgSendQueueEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/MsgSendQueueEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/msgsendqueueeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
