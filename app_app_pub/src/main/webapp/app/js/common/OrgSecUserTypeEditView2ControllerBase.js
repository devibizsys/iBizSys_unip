var OrgSecUserTypeEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/OrgSecUserTypeEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgsecusertypeeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M10',name:'orgsecusertypeid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M4',name:'grouppanel1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M5',name:'orgsecusertypename',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'typecode',allowBlank:false,form:form}));
