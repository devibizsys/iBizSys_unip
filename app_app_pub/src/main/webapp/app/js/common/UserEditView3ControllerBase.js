var UserEditView3ControllerBase = EditView3ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    ...
    this.regController(new UserGroupDetailGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C2'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/usereditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M6',name:'userid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'username',allowBlank:false,form:form}));
form.register(new IBizDropDownListField({id:this.getCId2()+'M8',name:'validflag',allowBlank:false,form:form,codelistid:'uniPSample_YesNo',width:100}));
form.register(new IBizTextField({id:this.getCId2()+'M9',name:'usermode',form:form}));
form.register(new IBizDropDownListField({id:this.getCId2()+'Ma',name:'timezone',form:form,codelistid:'uniPSample_CodeList59'}));
form.register(new IBizTextAreaField({id:this.getCId2()+'Mb',name:'memo',form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/common/usergroupdetailgridview.jsp',embedviewid:'C2',viewparam:{"srfparentdeid":"f4552a6291c79e3934263b31b83aec33","srfparenttype":"DER1N","srfder1nid":"DER1N_USERGROUPDETAIL_USEROBJECT_USEROBJECTID"}};
      	}
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/loginaccountgridview.jsp',embedviewid:'C1',viewparam:{"srfparentdeid":"f4552a6291c79e3934263b31b83aec33","srfparenttype":"DER1N","srfder1nid":"DER1N_LOGINACCOUNT_USER_USERID"}};
      	}
       return null;
 }
});