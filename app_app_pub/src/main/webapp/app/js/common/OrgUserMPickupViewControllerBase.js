var OrgUserMPickupViewControllerBase = MPickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserMPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgusermpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
