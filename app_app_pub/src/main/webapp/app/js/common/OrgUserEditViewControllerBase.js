var OrgUserEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/OrgUserEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgusereditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/OrgUserEditView.do?SRFCTRLID=form&SRFFORMITEMID=orgname'
...
,ac:true
,url:this.getAppCtx()+'/common/OrgUserEditView.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'
...
,ac:true
,url:this.getAppCtx()+'/common/OrgUserEditView.do?SRFCTRLID=form&SRFFORMITEMID=orgsecusertypename'
...
,ac:true
,url:this.getAppCtx()+'/common/OrgUserEditView.do?SRFCTRLID=form&SRFFORMITEMID=orguserlevelname'
