var OrgUserUX_EditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/OrgUserUX_EditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orguserux_editview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M13',name:'userdata'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M15',name:'orgsectorid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M16',name:'orgsecusertypeid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M17',name:'orguserlevelid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M4',name:'group1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M14',name:'memo',form:form,height:60}));
...
,ac:true
,url:this.getAppCtx()+'/common/OrgUserUX_EditView.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'
...
,ac:true
,url:this.getAppCtx()+'/common/OrgUserUX_EditView.do?SRFCTRLID=form&SRFFORMITEMID=orgsecusertypename'
...
form.register(new IBizRadioField({id:this.getCId2()+'Ma',name:'reserver5',form:form,codelistid:'uniPSample_XB',itemWidth:150}));
...
,ac:true
,url:this.getAppCtx()+'/common/OrgUserUX_EditView.do?SRFCTRLID=form&SRFFORMITEMID=orguserlevelname'
...
form.register(new IBizTextField({id:this.getCId2()+'Me',name:'reserver6',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mf',name:'ordervalue',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M10',name:'usercode',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M11',name:'reserver30',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M12',name:'reserver4',form:form}));
form.register(new IBizHiddenField({id:this.getCId2()+'M13',name:'userdata',form:form}));
