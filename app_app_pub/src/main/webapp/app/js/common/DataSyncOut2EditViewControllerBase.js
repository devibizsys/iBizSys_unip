var DataSyncOut2EditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/DataSyncOut2EditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/datasyncout2editview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
