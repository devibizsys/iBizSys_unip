var UserRoleDataEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/UserRoleDataEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userroledataeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDataEditView.do?SRFCTRLID=form&SRFFORMITEMID=dename'
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDataEditView.do?SRFCTRLID=form&SRFFORMITEMID=dstorgname'
...
,ac:true
,url:this.getAppCtx()+'/common/UserRoleDataEditView.do?SRFCTRLID=form&SRFFORMITEMID=dstorgsectorname'
