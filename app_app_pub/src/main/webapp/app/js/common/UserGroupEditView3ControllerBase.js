var UserGroupEditView3ControllerBase = EditView3ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new UserGroupDetailGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserGroupEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/usergroupeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M6',name:'usergroupid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'usergroupname',allowBlank:false,form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M8',name:'memo',form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/usergroupdetailgridview.jsp',embedviewid:'C1',viewparam:{"srfparentdeid":"5eba267a2d34c0c5dc686961a48f62d1","srfparenttype":"DER1N","srfder1nid":"DER1N_USERGROUPDETAIL_USERGROUP_USERGROUPID"}};
      	}
       return null;
 }
});