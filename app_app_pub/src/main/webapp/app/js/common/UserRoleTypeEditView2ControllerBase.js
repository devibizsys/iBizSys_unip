var UserRoleTypeEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserRoleTypeEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userroletypeeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizTextField({id:this.getCId2()+'M5',name:'userroletypeid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'userroletypename',allowBlank:false,form:form}));
