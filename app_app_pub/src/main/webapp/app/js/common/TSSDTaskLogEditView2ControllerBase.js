var TSSDTaskLogEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/TSSDTaskLogEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/tssdtasklogeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Mc',name:'tssdtasklogid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M4',name:'group1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M5',name:'tssdtasklogname',allowBlank:false,form:form}));
