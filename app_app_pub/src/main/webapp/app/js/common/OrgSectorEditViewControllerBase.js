var OrgSectorEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/OrgSectorEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/orgsectoreditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/OrgSectorEditView.do?SRFCTRLID=form&SRFFORMITEMID=orgname'
...
,ac:true
,url:this.getAppCtx()+'/common/OrgSectorEditView.do?SRFCTRLID=form&SRFFORMITEMID=porgsectorname'
...
,ac:true
,url:this.getAppCtx()+'/common/OrgSectorEditView.do?SRFCTRLID=form&SRFFORMITEMID=reporgsectorname'
