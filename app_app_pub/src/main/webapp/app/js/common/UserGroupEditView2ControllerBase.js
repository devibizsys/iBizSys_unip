var UserGroupEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserGroupEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/usergroupeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M5',name:'usergroupid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'usergroupname',allowBlank:false,form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M7',name:'memo',form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/usergroupdetailgridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});