var OrgUserPickupGridViewControllerBase = PickupGridViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserPickupGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/orguserpickupgridview.jsp?'+'srfcid='+cfg.containerid+'&'
