var OrgUserPickupGridView3ControllerBase = PickupGridViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/OrgUserPickupGridView3.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/orguserpickupgridview3.jsp?'+'srfcid='+cfg.containerid+'&'
