var UserObjectEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/UserObjectEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/userobjecteditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Mc',name:'userobjectid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M4',name:'grouppanel1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M5',name:'userobjectname',allowBlank:false,form:form}));
form.register(new IBizFormGroup({id:this.getCId2()+'M7',name:'grouppanel2',titleBarCloseMode:'0',form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/common/usergroupdetailgridview.jsp',embedviewid:'C2'};
      	}
      if(drmode=='DRITEM1'){
