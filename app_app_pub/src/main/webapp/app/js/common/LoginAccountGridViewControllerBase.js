var LoginAccountGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
	...
	var view={
    	    ...
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/loginaccounteditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '登录帐户实体编辑视图', openMode:'POPUPMODAL', height: 600, width: 800,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/loginaccounteditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/LoginAccountGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/loginaccountgridview.jsp?'+'srfcid='+cfg.containerid+'&'
