var UserRoleResGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
      ...
      if(true){
	var view={
			title: '用户角色资源能力实体编辑视图',
			openMode:'POPUPMODAL',
			 height: 0,
	    	    width: 0,
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/common/userrolereseditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '用户角色资源能力实体编辑视图', openMode:'POPUPMODAL', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/common/userrolereseditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
   ...
   ,getMPickupView: function (arg)
    {
        ...
        if(!tempMode)
             tempMode=false;
        if ( parentMode.srfder1nid=='DER1N_USERROLERES_USERROLE_USERROLEID'){
arg.srftempmode=false;
            var view={
                modal:true,
    	        title: '统一资源实体数据多项选择视图',
    	        height: 0,
    	        width: 0,
    	        layout: 'fit',
                 viewurl:'/common/uniresmpickupview.jsp',
                viewparam:arg
    	     };
	    return view;
        }       

        if (parentMode.srfder1nid=='DER1N_USERROLERES_UNIRES_UNIRESID'){
arg.srftempmode=false;
            var view={
                modal:true,
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/common/UserRoleResGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/common/userroleresgridview.jsp?'+'srfcid='+cfg.containerid+'&'
...
,{ "title" : '资源',"width":150,"data" :'uniresname',"orderable":true}
]
},searchForm:{enableAdvanceSearch:false,dename:'USERROLERES'}}};
...
,doHideParentColumns: function (parentMode)
    {
        ...
        arguments.callee.$.doHideParentColumns.call(this,parentMode);
         ...
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_USERROLERES_USERROLE_USERROLEID')
         {
              me.hideGridColumn('userrolename');
              return;
         }
         //关系类型 : DER1N ,主实体 :UNIRES / 统一资源
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_USERROLERES_UNIRES_UNIRESID')
         {
              me.hideGridColumn('uniresname');
              return;
         }
}
});