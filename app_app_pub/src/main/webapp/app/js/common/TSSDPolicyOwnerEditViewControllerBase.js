var TSSDPolicyOwnerEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/common/TSSDPolicyOwnerEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/tssdpolicyownereditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
