var CodeItemEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/CodeItemEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/codeitemeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/common/CodeItemEditView2.do?SRFCTRLID=form&SRFFORMITEMID=codelistname'
...
,ac:true
,url:this.getAppCtx()+'/common/CodeItemEditView2.do?SRFCTRLID=form&SRFFORMITEMID=pcodeitemname'
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/codeitemgridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});