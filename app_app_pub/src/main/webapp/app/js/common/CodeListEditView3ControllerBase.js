var CodeListEditView3ControllerBase = EditView3ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new CodeItemGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/common/CodeListEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/common/codelisteditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizSpanField({id:this.getCId2()+'M6',name:'codelistid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'codelistname',allowBlank:false,form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/common/codeitemgridview.jsp',embedviewid:'C1',viewparam:{"srfparentdeid":"85317205b415aa6af990684ca7704515","srfparenttype":"DER1N","srfder1nid":"DER1N_CODEITEM_CODELIST_CODELISTID"}};
      	}
       return null;
 }
});