var WFUCPolicyEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFUCPolicyEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfucpolicyeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wf/WFUCPolicyEditView.do?SRFCTRLID=form&SRFFORMITEMID=majorwfusername'
...
,pickupView:{view:'/wf/wfuserpickupview.jsp',title:'工作流用户实体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/wf/WFUCPolicyEditView.do?SRFCTRLID=form&SRFFORMITEMID=minorwfusername'
