var WFInstanceEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFInstanceEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfinstanceeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wf/WFInstanceEditView.do?SRFCTRLID=form&SRFFORMITEMID=wfworkflowname'
