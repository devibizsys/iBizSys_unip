var WFActorEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFActorEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfactoreditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
