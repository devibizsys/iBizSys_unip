var WFUserGroupGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
      ...
      if(true){
	var view={
			title: '工作流用户组实体编辑视图（分页关系）',
			openMode:'',
			 height: 0,
	    	    width: 0,
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/wf/wfusergroupeditview3.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '工作流用户组实体编辑视图（分页关系）', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/wf/wfusergroupeditview3.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/wf/WFUserGroupGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/wf/wfusergroupgridview.jsp?'+'srfcid='+cfg.containerid+'&'
