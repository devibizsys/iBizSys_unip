var WFDynamicUserEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wf/WFDynamicUserEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfdynamicusereditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M3',name:'wfdynamicuserid'}));
