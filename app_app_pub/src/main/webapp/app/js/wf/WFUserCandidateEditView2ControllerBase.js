var WFUserCandidateEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wf/WFUserCandidateEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfusercandidateeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Mf',name:'wfminoruserid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M10',name:'wfmajoruserid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M11',name:'wfusercandidateid'}));
...
,ac:true
,url:this.getAppCtx()+'/wf/WFUserCandidateEditView2.do?SRFCTRLID=form&SRFFORMITEMID=wfmajorusername'
...
,pickupView:{view:'/wf/wfuserpickupview.jsp',title:'工作流用户实体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/wf/WFUserCandidateEditView2.do?SRFCTRLID=form&SRFFORMITEMID=wfminorusername'

}));
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'candidateorder',allowBlank:false,form:form}));
