var WFUserEditView3ControllerBase = EditView3ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wf/WFUserEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfusereditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Ma',name:'wfuserid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M5',name:'grouppanel1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'wfusername',allowBlank:false,form:form}));
form.register(new IBizDropDownListField({id:this.getCId2()+'M7',name:'isrecvwork',form:form,codelistid:'uniPSample_YesNo',width:100}));
form.register(new IBizDropDownListField({id:this.getCId2()+'M8',name:'recvinform',form:form,codelistid:'uniPSample_YesNo',width:100}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/wf/wfusergroupdetailgridview.jsp',embedviewid:'C1',viewparam:{"srfparentdeid":"ef2c7b349c855e594aa4fe0cb7ad8b48","srfparenttype":"DER1N","srfder1nid":"DER1N_WFUSERGROUPDETAIL_WFUSER_WFUSERID"}};
      	}
       return null;
 }
});