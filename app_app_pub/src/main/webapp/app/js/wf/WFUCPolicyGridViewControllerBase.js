var WFUCPolicyGridViewControllerBase = GridViewControllerBase.extend({
...
,regUIActions:function(config)
{
  ...
  var uiaction_9 = {"type":"DEUIACTION","tag":"EnablePolicy","actiontarget":"MULTIKEY"
,"actionmode":"BACKEND"
,"timeout":60000
};
    this.regUIAction(uiaction_9);
  var uiaction_10 = {"type":"DEUIACTION","tag":"DisablePolicy","actiontarget":"MULTIKEY"
,"actionmode":"BACKEND"
,"timeout":60000
};
...
,getNewDataView:function(arg){
      ...
      if(true){
	var view={
			title: '工作流候选用户策略实体编辑视图',
			openMode:'',
			 height: 0,
	    	    width: 0,
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/wf/wfucpolicyeditview.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '工作流候选用户策略实体编辑视图', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/wf/wfucpolicyeditview.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/wf/WFUCPolicyGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/wf/wfucpolicygridview.jsp?'+'srfcid='+cfg.containerid+'&'
