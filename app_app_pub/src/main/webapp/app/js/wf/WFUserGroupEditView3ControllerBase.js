var WFUserGroupEditView3ControllerBase = EditView3ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wf/WFUserGroupEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfusergroupeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Me',name:'wfusergroupid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M5',name:'grouppanel2',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'wfusergroupname',allowBlank:false,form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M7',name:'memo',form:form,height:200}));
form.register(new IBizFormGroup({id:this.getCId2()+'M9',name:'grouppanel1',titleBarCloseMode:'0',form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM1'){
          return {viewurl:'/wf/wfusergroupdetailgridview.jsp',embedviewid:'C1',viewparam:{"srfparentdeid":"e64a576e41250c73ac1f51c15d6631e2","srfparenttype":"DER1N","srfder1nid":"DER1N_WFUSERGROUPDETAIL_WFUSERGROUP_WFUSERGROUPID"}};
      	}
       return null;
 }
});