var WFAppSettingEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFAppSettingEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfappsettingeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wf/WFAppSettingEditView.do?SRFCTRLID=form&SRFFORMITEMID=remindmsgtemplname'
