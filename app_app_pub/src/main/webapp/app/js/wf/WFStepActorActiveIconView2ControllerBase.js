...
var WFStepActorActiveIconView2ControllerBase = WFStepActorView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/wf/WFStepActorActiveIconView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfstepactoractiveiconview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{}};
