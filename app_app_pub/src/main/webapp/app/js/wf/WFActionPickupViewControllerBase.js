var WFActionPickupViewControllerBase = PickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/wf/WFActionPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfactionpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
