var WFUserAssistEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wf/WFUserAssistEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfuserassisteditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wf/WFUserAssistEditView2.do?SRFCTRLID=form&SRFFORMITEMID=wfmajorusername'
...
,pickupView:{view:'/wf/wfuserpickupview.jsp',title:'工作流用户实体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/wf/WFUserAssistEditView2.do?SRFCTRLID=form&SRFFORMITEMID=wfminorusername'
...
,ac:true
,url:this.getAppCtx()+'/wf/WFUserAssistEditView2.do?SRFCTRLID=form&SRFFORMITEMID=wfworkflowname'
