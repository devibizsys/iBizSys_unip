var WFStepDataEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wf/WFStepDataEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfstepdataeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M4',name:'wfstepdataid'}));
