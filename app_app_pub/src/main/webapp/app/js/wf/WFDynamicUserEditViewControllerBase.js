var WFDynamicUserEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFDynamicUserEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfdynamicusereditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
