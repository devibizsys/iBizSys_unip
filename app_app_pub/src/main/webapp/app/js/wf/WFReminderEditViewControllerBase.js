var WFReminderEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFReminderEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfremindereditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
