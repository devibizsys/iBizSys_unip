var WFUserCandidateEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFUserCandidateEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfusercandidateeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wf/WFUserCandidateEditView.do?SRFCTRLID=form&SRFFORMITEMID=wfmajorusername'
...
,pickupView:{view:'/wf/wfuserpickupview.jsp',title:'工作流用户实体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/wf/WFUserCandidateEditView.do?SRFCTRLID=form&SRFFORMITEMID=wfminorusername'
