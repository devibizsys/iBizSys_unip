var WFActionEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFActionEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfactioneditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
