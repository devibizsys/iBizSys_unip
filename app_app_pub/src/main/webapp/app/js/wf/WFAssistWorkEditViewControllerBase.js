var WFAssistWorkEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFAssistWorkEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfassistworkeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
