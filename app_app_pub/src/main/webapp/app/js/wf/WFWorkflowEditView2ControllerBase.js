var WFWorkflowEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new WFVersionGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C4'}));
    this.regController(new WFActionGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C3'}));
    this.regController(new WFInstanceGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
    this.regController(new WFUserAssistGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C2'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wf/WFWorkflowEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfworkfloweditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wf/WFWorkflowEditView2.do?SRFCTRLID=form&SRFFORMITEMID=remindmsgtemplname'
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM3'){
          return {viewurl:'/wf/wfactiongridview.jsp',embedviewid:'C3'};
      	}
      if(drmode=='DRITEM2'){
          return {viewurl:'/wf/wfuserassistgridview.jsp',embedviewid:'C2'};
      	}
      if(drmode=='DRITEM4'){
          return {viewurl:'/wf/wfversiongridview.jsp',embedviewid:'C4'};
      	}
      if(drmode=='DRITEM1'){
