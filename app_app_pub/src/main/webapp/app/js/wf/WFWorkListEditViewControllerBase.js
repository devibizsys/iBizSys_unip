var WFWorkListEditViewControllerBase = EditViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/wf/WFWorkListEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wf/wfworklisteditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
