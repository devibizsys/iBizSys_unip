var OA_PCSQPCSQLC_W20_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='20@1'){
              return {title: '派车申请工作流视图(派车申请流程v1:承办处领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_pcsqpcsqlc_w20_wfeditview3.jsp', viewparam:arg};
          }
      }
      if(true){
	   return {  title: '派车申请工作流视图(派车申请流程v1:承办处领导审核)', openMode:'', height: 0, width: 0,
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_PCSQPCSQLC_W20_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_pcsqpcsqlc_w20_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
...
,{ "title" : '返程时间',"width":150,"data" :'fcsj',"orderable":true}
...
,{ "title" : '用车类型',"width":150,"data" :'yclx',"orderable":true}
...
},searchForm:{enableAdvanceSearch:false,dename:'OA_PCSQ'}}};
...
,doHideParentColumns: function (parentMode)
    {
        ...
        arguments.callee.$.doHideParentColumns.call(this,parentMode);
         ...
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_OA_PCSQ_ORGSECTOR_ORGSECTORID')
         {
              me.hideGridColumn('orgsectorname');
              return;
         }
         //关系类型 : DER1N ,主实体 :OA_CL / 车辆
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_OA_PCSQ_OA_CL_OA_CLID')
         {
              me.hideGridColumn('oa_clname');
              return;
         }
         //关系类型 : DER1N ,主实体 :ORGUSER / 组织人员
         if (parentMode.srfparenttype=='DER1N' && parentMode.srfder1nid=='DER1N_OA_PCSQ_ORGUSER_ORGUSERID')
         {
