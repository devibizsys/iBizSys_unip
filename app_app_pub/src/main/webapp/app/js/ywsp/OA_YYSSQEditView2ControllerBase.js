var OA_YYSSQEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_YYSSQEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_yyssqeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M13',name:'oa_yyssqid'}));
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_YYSSQEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'
...
form.register(new IBizTextField({id:this.getCId2()+'Mb',name:'dh',form:form}));
