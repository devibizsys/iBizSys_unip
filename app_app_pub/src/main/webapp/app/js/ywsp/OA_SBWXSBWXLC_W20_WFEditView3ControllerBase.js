var OA_SBWXSBWXLC_W20_WFEditView3ControllerBase = WFEditView3ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_SBWXSBWXLC_W20_WFEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_sbwxsbwxlc_w20_wfeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M16',name:'oa_sbwxid'}));
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_SBWXSBWXLC_W20_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'

}));
form.register(new IBizTextField({id:this.getCId2()+'Ma',name:'sb',allowBlank:false,form:form}));
...
form.register(new IBizTextAreaField({id:this.getCId2()+'Me',name:'gzxx',allowBlank:false,form:form,height:60}));
