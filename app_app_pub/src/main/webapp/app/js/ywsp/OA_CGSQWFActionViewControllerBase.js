var OA_CGSQWFActionViewControllerBase = WFActionViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CGSQWFActionView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_cgsqwfactionview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Ma',name:'oa_cgsqid'}));
