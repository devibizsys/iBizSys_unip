var OA_CLWXCLWXLC_W20_WFEditView3ControllerBase = WFEditView3ControllerBase.extend({
...
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_clwxwfactionview.jsp","viewparam":{"srfwfiatag":"AC2020","srfwfstep":"20"},"width":0,"height":0,"title":"车辆维修",openMode:'POPUPMODAL'}
};
    this.regUIAction(uiaction_4);
  var uiaction_5 = {"type":"WFUIACTION","tag":"AC2010","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_clwxwfactionview.jsp","viewparam":{"srfwfiatag":"AC2010","srfwfstep":"20"},"width":0,"height":0,"title":"车辆维修",openMode:'POPUPMODAL'}
};
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_CLWXCLWXLC_W20_WFEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_clwxclwxlc_w20_wfeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CLWXCLWXLC_W20_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CLWXCLWXLC_W20_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=oa_clname'
