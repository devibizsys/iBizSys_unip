var OA_CHRYEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_CHRYEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_chryeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CHRYEditView2.do?SRFCTRLID=form&SRFFORMITEMID=ybhysqname'
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CHRYEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgusername'
