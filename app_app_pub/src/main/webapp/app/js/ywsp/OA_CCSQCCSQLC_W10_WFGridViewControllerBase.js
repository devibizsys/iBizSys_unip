var OA_CCSQCCSQLC_W10_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_ccsqwfactionview.jsp","viewparam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"width":0,"height":0,"title":"出差申请",openMode:'POPUPMODAL'}
};
    this.regUIAction(uiaction_3);
  var uiaction_4 = {"type":"WFUIACTION","tag":"AC1010","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_ccsqwfactionview.jsp","viewparam":{"srfwfiatag":"AC1010","srfwfstep":"10"},"width":0,"height":0,"title":"出差申请",openMode:'POPUPMODAL'}
};
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='10@1'){
              return {title: '出差申请工作流视图(出差申请流程v1:部门领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_ccsqccsqlc_w10_wfeditview3.jsp', viewparam:arg};
          }
      }
      if(true){
	   return {  title: '出差申请工作流视图(出差申请流程v1:部门领导审核)', openMode:'', height: 0, width: 0,
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CCSQCCSQLC_W10_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_ccsqccsqlc_w10_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
