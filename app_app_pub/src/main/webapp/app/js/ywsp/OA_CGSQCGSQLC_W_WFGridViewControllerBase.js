var OA_CGSQCGSQLC_W_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='10'){
              return {title: '采购申请工作流视图(采购申请流程v1:部门申报)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_cgsqcgsqlc_w10_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='30'){
              return {title: '采购申请工作流视图(采购申请流程v1:固定资产相关人员审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_cgsqcgsqlc_w30_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='40@1'){
              return {title: '采购申请工作流视图(采购申请流程v1:计财负责人审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_cgsqcgsqlc_w40_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='30@1'){
              return {title: '采购申请工作流视图(采购申请流程v1:固定资产相关人员审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_cgsqcgsqlc_w30_wfeditview3.jsp', viewparam:arg};
          ...
          if(editmode=='20'){
              return {title: '采购申请工作流视图(采购申请流程v1:部门负责人审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_cgsqcgsqlc_w20_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='50@1'){
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CGSQCGSQLC_W_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_cgsqcgsqlc_w_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
