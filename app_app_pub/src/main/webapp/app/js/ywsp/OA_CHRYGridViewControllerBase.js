var OA_CHRYGridViewControllerBase = GridViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CHRYGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_chrygridview.jsp?'+'srfcid='+cfg.containerid+'&'
