var OA_JPYDEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_JPYDEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_jpydeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Md',name:'jbrid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M19',name:'oa_jpydid'}));
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_JPYDEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'

}));
form.register(new IBizTextField({id:this.getCId2()+'M9',name:'mdd',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Ma',name:'zw',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mb',name:'je',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mc',name:'sfzhm',allowBlank:false,form:form}));
form.register(new IBizHiddenField({id:this.getCId2()+'Md',name:'jbrid',form:form}));
form.register(new IBizPickerField({id:this.getCId2()+'Me',name:'jbrname',allowBlank:false,form:form,forceSelection:true,queryCaching:false, displayField:'text',valueField: 'value',valueItem:'jbrid',minChars:2,pageSize:50
,pickupView:{view:'/common/orguserpickupview.jsp',title:'组织人员实体数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_JPYDEditView2.do?SRFCTRLID=form&SRFFORMITEMID=jbrname'

}));
form.register(new IBizDateField({id:this.getCId2()+'Mf',name:'cfsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizDateField({id:this.getCId2()+'M10',name:'fcsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M11',name:'sqsy',allowBlank:false,form:form,height:60}));
