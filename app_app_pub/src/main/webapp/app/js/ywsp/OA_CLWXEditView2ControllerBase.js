var OA_CLWXEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_CLWXEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_clwxeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M18',name:'oa_clid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M19',name:'oa_clwxid'}));
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CLWXEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CLWXEditView2.do?SRFCTRLID=form&SRFFORMITEMID=oa_clname'

}));
form.register(new IBizTextField({id:this.getCId2()+'Ma',name:'cph',allowBlank:false,form:form}));
...
form.register(new IBizTextField({id:this.getCId2()+'Md',name:'wxxm',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Me',name:'clpp',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mf',name:'dph',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M10',name:'fdjh',form:form}));
