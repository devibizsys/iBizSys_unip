var OA_CLWXPickupViewControllerBase = PickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CLWXPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_clwxpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
