var OA_CLWXCLWXLC_W10_WFEditView3ControllerBase = WFEditView3ControllerBase.extend({
...
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_clwxwfactionview.jsp","viewparam":{"srfwfiatag":"AC1020","srfwfstep":"10"},"width":0,"height":0,"title":"车辆维修",openMode:'POPUPMODAL'}
};
    this.regUIAction(uiaction_4);
  var uiaction_5 = {"type":"WFUIACTION","tag":"AC1010","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_clwxwfactionview.jsp","viewparam":{"srfwfiatag":"AC1010","srfwfstep":"10"},"width":0,"height":0,"title":"车辆维修",openMode:'POPUPMODAL'}
};
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_CLWXCLWXLC_W10_WFEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_clwxclwxlc_w10_wfeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M19',name:'oa_clid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M1a',name:'oa_clwxid'}));
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CLWXCLWXLC_W10_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'

}));
form.register(new IBizPickerField({id:this.getCId2()+'Ma',name:'oa_clname',allowBlank:false,form:form,forceSelection:true,queryCaching:false, displayField:'text',valueField: 'value',valueItem:'oa_clid',minChars:2,pageSize:50
,pickupView:{view:'/jcsj/oa_clpickupview.jsp',title:'车辆数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_CLWXCLWXLC_W10_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=oa_clname'

}));
form.register(new IBizTextField({id:this.getCId2()+'Mb',name:'cph',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mc',name:'je',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Md',name:'dz',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Me',name:'wxxm',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mf',name:'clpp',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M10',name:'dph',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M11',name:'fdjh',form:form}));
