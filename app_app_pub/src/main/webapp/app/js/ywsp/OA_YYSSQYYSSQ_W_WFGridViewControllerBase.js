var OA_YYSSQYYSSQ_W_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='10'){
              return {title: '饮用水申请工作流视图(饮用水申请流程v1:部门领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_yyssqyyssq_w10_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='10@1'){
              return {title: '饮用水申请工作流视图(饮用水申请流程v1:部门领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_yyssqyyssq_w10_wfeditview3.jsp', viewparam:arg};
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_YYSSQYYSSQ_W_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_yyssqyyssq_w_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
