var OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3ControllerBase = WFEditView3ControllerBase.extend({
...
,regUIActions:function(config)
{
  ...
  var uiaction_4 = {"type":"WFUIACTION","tag":"AC4020","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_nsjghysqwfactionview.jsp","viewparam":{"srfwfiatag":"AC4020","srfwfstep":"40"},"width":0,"height":0,"title":"内设机构会议申请",openMode:'POPUPMODAL'}
};
    this.regUIAction(uiaction_4);
  var uiaction_5 = {"type":"WFUIACTION","tag":"AC4010","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_nsjghysqwfactionview.jsp","viewparam":{"srfwfiatag":"AC4010","srfwfstep":"40"},"width":0,"height":0,"title":"内设机构会议申请",openMode:'POPUPMODAL'}
};
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_nsjghysqnsjghysq_w40_wfeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=orgusername'
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=hysname'
