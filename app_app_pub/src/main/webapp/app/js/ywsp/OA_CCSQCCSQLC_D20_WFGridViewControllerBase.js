var OA_CCSQCCSQLC_D20_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getNewDataView:function(arg){
      ...
      if(true){
	var view={
			title: '出差申请工作流视图(出差申请流程)',
			openMode:'',
			 height: 0,
	    	    width: 0,
    	    layout: 'fit',
            maximizable:true,
            viewurl:'/ywsp/oa_ccsqccsqlc_d_wfeditview3.jsp',
            viewparam:arg
      	};
	return view;
       }
...
,getEditDataView:function(arg){
      ...
      if(true){
	   return {  title: '出差申请工作流视图(出差申请流程)', openMode:'', height: 0, width: 0,
    	              layout: 'fit',   maximizable:true,   viewurl:'/ywsp/oa_ccsqccsqlc_d_wfeditview3.jsp',   viewparam:arg  	};
       }
       return null;
    }
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CCSQCCSQLC_D20_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_ccsqccsqlc_d20_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
