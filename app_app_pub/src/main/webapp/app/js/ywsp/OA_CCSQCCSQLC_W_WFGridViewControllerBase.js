var OA_CCSQCCSQLC_W_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CCSQCCSQLC_W_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_ccsqccsqlc_w_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
