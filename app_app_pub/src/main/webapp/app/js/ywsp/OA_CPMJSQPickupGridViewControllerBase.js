var OA_CPMJSQPickupGridViewControllerBase = PickupGridViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CPMJSQPickupGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_cpmjsqpickupgridview.jsp?'+'srfcid='+cfg.containerid+'&'
