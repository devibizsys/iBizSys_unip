var OA_SBWXEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_SBWXEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_sbwxeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M15',name:'oa_sbwxid'}));
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_SBWXEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'

}));
form.register(new IBizTextField({id:this.getCId2()+'M9',name:'sb',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Ma',name:'fjh',allowBlank:false,form:form}));
form.register(new IBizDateField({id:this.getCId2()+'Mb',name:'rq',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizTextField({id:this.getCId2()+'Mc',name:'dh',form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'Md',name:'gzxx',allowBlank:false,form:form,height:60}));
