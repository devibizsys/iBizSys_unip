var OA_CCSQMPickupViewControllerBase = MPickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_CCSQMPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_ccsqmpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
