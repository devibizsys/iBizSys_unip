var OA_YCSQYCSQLC_W20_WFEditView3ControllerBase = WFEditView3ControllerBase.extend({
...
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_ycsqwfactionview.jsp","viewparam":{"srfwfiatag":"AC2020","srfwfstep":"20"},"width":0,"height":0,"title":"用餐申请",openMode:'POPUPMODAL'}
};
    this.regUIAction(uiaction_4);
  var uiaction_5 = {"type":"WFUIACTION","tag":"AC2010","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_ycsqwfactionview.jsp","viewparam":{"srfwfiatag":"AC2010","srfwfstep":"20"},"width":0,"height":0,"title":"用餐申请",openMode:'POPUPMODAL'}
};
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_YCSQYCSQLC_W20_WFEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_ycsqycsqlc_w20_wfeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M17',name:'oa_ycsqid'}));
...
form.register(new IBizTextField({id:this.getCId2()+'M8',name:'djr',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M9',name:'lkdw',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Ma',name:'ycdd',allowBlank:false,form:form}));
form.register(new IBizDateField({id:this.getCId2()+'Mb',name:'ycsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizDateField({id:this.getCId2()+'Mc',name:'djsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
...
form.register(new IBizDateField({id:this.getCId2()+'Me',name:'cfsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizDateField({id:this.getCId2()+'Mf',name:'fhsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
