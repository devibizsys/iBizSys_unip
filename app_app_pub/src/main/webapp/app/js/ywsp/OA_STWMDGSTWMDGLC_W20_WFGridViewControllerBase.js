var OA_STWMDGSTWMDGLC_W20_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='20@1'){
              return {title: '食堂外卖订购工作流视图(食堂外卖订购流程v1:承办处领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_stwmdgstwmdglc_w20_wfeditview3.jsp', viewparam:arg};
          }
      }
      if(true){
	   return {  title: '食堂外卖订购工作流视图(食堂外卖订购流程v1:承办处领导审核)', openMode:'', height: 0, width: 0,
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_STWMDGSTWMDGLC_W20_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_stwmdgstwmdglc_w20_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
