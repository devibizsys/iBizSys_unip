var OA_JPYDWFActionViewControllerBase = WFActionViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_JPYDWFActionView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_jpydwfactionview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Ma',name:'oa_jpydid'}));
