var OA_BGYPSQBGYPSQLC_W_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(editmode=='20'){
              return {title: '办公用品申请工作流视图(办公用品申领流程v1:承办处领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_bgypsqbgypsqlc_w20_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='20@1'){
              return {title: '办公用品申请工作流视图(办公用品申领流程v1:承办处领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_bgypsqbgypsqlc_w20_wfeditview3.jsp', viewparam:arg};
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_BGYPSQBGYPSQLC_W_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_bgypsqbgypsqlc_w_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
