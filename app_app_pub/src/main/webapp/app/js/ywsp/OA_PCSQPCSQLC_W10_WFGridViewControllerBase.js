var OA_PCSQPCSQLC_W10_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='10@1'){
              return {title: '派车申请工作流视图(派车申请流程v1:部门领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_pcsqpcsqlc_w10_wfeditview3.jsp', viewparam:arg};
          }
      }
      if(true){
	   return {  title: '派车申请工作流视图(派车申请流程v1:部门领导审核)', openMode:'', height: 0, width: 0,
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_PCSQPCSQLC_W10_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_pcsqpcsqlc_w10_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
