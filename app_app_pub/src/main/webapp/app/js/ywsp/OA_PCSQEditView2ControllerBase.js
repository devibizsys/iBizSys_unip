var OA_PCSQEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_PCSQEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_pcsqeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M7',name:'oa_clid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M9',name:'orgsectorid'}));
form.register(new IBizHiddenField({id:this.getCId2()+'M1a',name:'oa_pcsqid'}));
...
form.register(new IBizHiddenField({id:this.getCId2()+'M7',name:'oa_clid',form:form}));
form.register(new IBizPickerField({id:this.getCId2()+'M8',name:'oa_clname',allowBlank:false,form:form,forceSelection:true,queryCaching:false, displayField:'text',valueField: 'value',valueItem:'oa_clid',minChars:2,pageSize:50
,pickupView:{view:'/jcsj/oa_clpickupview.jsp',title:'车辆数据选择视图'}
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_PCSQEditView2.do?SRFCTRLID=form&SRFFORMITEMID=oa_clname'
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_PCSQEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'

}));
form.register(new IBizTextField({id:this.getCId2()+'Mb',name:'dz',allowBlank:false,form:form}));
form.register(new IBizDateField({id:this.getCId2()+'Mc',name:'cfsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizDateField({id:this.getCId2()+'Md',name:'fcsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizTextField({id:this.getCId2()+'Me',name:'cph',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'Mf',name:'je',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M10',name:'yclx',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M11',name:'clpp',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M12',name:'sy',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M13',name:'fj',form:form}));
