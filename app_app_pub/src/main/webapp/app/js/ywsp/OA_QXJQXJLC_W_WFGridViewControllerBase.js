var OA_QXJQXJLC_W_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(editmode=='30'){
              return {title: '请休假工作流视图(请休假流程v1:院领导审批)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_qxjqxjlc_w30_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='30@1'){
              return {title: '请休假工作流视图(请休假流程v1:院领导审批)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_qxjqxjlc_w30_wfeditview3.jsp', viewparam:arg};
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_QXJQXJLC_W_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_qxjqxjlc_w_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
