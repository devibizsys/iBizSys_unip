var OA_CCSQEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_CCSQEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_ccsqeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M13',name:'oa_ccsqid'}));
...
form.register(new IBizTextField({id:this.getCId2()+'M7',name:'ccdz',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M8',name:'sc',allowBlank:false,form:form}));
form.register(new IBizDateField({id:this.getCId2()+'M9',name:'kssj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizDateField({id:this.getCId2()+'Ma',name:'jssj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizTextAreaField({id:this.getCId2()+'Mb',name:'ccsy',allowBlank:false,form:form,height:60}));
