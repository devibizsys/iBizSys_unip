var OA_YBHYSQYBHYSQ_W50_WFEditView3ControllerBase = WFEditView3ControllerBase.extend({
...
,regUIActions:function(config)
{
  ...
  var uiaction_4 = {"type":"WFUIACTION","tag":"AC5020","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_ybhysqshyjwfactionview.jsp","viewparam":{"srfwfiatag":"AC5020","srfwfstep":"50"},"width":0,"height":0,"title":"院办会议申请",openMode:'POPUPMODAL'}
};
    this.regUIAction(uiaction_4);
  var uiaction_5 = {"type":"WFUIACTION","tag":"AC5010","actiontarget":"MULTIKEY"
,"actionmode":"WFFRONT"
,"fronttype":"WIZARD"
,"frontview":{"viewurl":"/ywsp/oa_ybhysqshyjwfactionview.jsp","viewparam":{"srfwfiatag":"AC5010","srfwfstep":"50"},"width":0,"height":0,"title":"院办会议申请",openMode:'POPUPMODAL'}
};
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_YBHYSQYBHYSQ_W50_WFEditView3.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_ybhysqybhysq_w50_wfeditview3.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_YBHYSQYBHYSQ_W50_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'
...
,ac:true
,url:this.getAppCtx()+'/ywsp/OA_YBHYSQYBHYSQ_W50_WFEditView3.do?SRFCTRLID=form&SRFFORMITEMID=oa_hysname'
