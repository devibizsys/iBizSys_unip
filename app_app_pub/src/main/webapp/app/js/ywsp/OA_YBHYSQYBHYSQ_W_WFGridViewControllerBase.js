var OA_YBHYSQYBHYSQ_W_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(editmode=='30'){
              return {title: '院办会议申请工作流视图(院办会议申请v1:编制座位图)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_ybhysqybhysq_w30_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='40@1'){
              return {title: '院办会议申请工作流视图(院办会议申请v1:参会人员对号入座)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_ybhysqybhysq_w40_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='30@1'){
              return {title: '院办会议申请工作流视图(院办会议申请v1:编制座位图)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_ybhysqybhysq_w30_wfeditview3.jsp', viewparam:arg};
          ...
          if(editmode=='20'){
              return {title: '院办会议申请工作流视图(院办会议申请v1:会议室申请)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_ybhysqybhysq_w20_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='50@1'){
              return {title: '院办会议申请工作流视图(院办会议申请v1:会情况通报)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_ybhysqybhysq_w50_wfeditview3.jsp', viewparam:arg};
          }
          if(editmode=='20@1'){
              return {title: '院办会议申请工作流视图(院办会议申请v1:会议室申请)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/ywsp/oa_ybhysqybhysq_w20_wfeditview3.jsp', viewparam:arg};
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/ywsp/OA_YBHYSQYBHYSQ_W_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/ywsp/oa_ybhysqybhysq_w_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
