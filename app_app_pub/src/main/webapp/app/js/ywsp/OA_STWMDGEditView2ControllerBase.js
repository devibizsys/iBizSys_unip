var OA_STWMDGEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/ywsp/OA_STWMDGEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/ywsp/oa_stwmdgeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M13',name:'oa_stwmdgid'}));
...
form.register(new IBizDateField({id:this.getCId2()+'M7',name:'scsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizTextField({id:this.getCId2()+'M8',name:'ycrs',allowBlank:false,form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M9',name:'ycdd',allowBlank:false,form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'Ma',name:'sy',allowBlank:false,form:form,height:60}));
form.register(new IBizTextAreaField({id:this.getCId2()+'Mb',name:'bz',form:form}));
