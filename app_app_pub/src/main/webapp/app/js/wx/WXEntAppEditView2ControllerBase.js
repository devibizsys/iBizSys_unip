var WXEntAppEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new WXMediaGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
    this.regController(new WXMessageGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C2'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wx/WXEntAppEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wx/wxentappeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wx/WXEntAppEditView2.do?SRFCTRLID=form&SRFFORMITEMID=wxaccountname'
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/wx/wxmessagegridview.jsp',embedviewid:'C2'};
      	}
      if(drmode=='DRITEM1'){
          return {viewurl:'/wx/wxmediagridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});