var WXMessageEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wx/WXMessageEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wx/wxmessageeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
