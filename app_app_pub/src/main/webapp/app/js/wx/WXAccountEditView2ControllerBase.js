var WXAccountEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/wx/WXAccountEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/wx/wxaccounteditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,ac:true
,url:this.getAppCtx()+'/wx/WXAccountEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgname'
