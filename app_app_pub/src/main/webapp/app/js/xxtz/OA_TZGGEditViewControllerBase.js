var OA_TZGGEditViewControllerBase = EditViewControllerBase.extend({
...
{
  var uiaction_0 = {"type":"DEUIACTION","tag":"FSTZGGXX","actiontarget":"SINGLEKEY"
,"actionmode":"BACKEND"
,"timeout":60000
};
...
,getDefaultCfg:function(cfg){
    var me=this;     
    var config={backendurl:cfg.appctx+'/xxtz/OA_TZGGEditView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/xxtz/oa_tzggeditview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
