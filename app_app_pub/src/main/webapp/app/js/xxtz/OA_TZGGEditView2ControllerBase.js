var OA_TZGGEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new OA_TZGGRYGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/xxtz/OA_TZGGEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/xxtz/oa_tzggeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M5',name:'oa_tzggid'}));
...
form.register(new IBizHiddenField({id:this.getCId2()+'M5',name:'oa_tzggid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'oa_tzggname',allowBlank:false,form:form}));
...
form.register(new IBizTextField({id:this.getCId2()+'Ma',name:'content',allowBlank:false,form:form}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/xxtz/oa_tzggrygridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});