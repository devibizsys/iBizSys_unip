var OA_TZGGWFActionViewControllerBase = WFActionViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/xxtz/OA_TZGGWFActionView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/xxtz/oa_tzggwfactionview.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Ma',name:'oa_tzggid'}));
