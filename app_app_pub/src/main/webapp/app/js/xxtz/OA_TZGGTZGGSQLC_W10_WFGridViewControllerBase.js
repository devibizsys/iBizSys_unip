var OA_TZGGTZGGSQLC_W10_WFGridViewControllerBase = GridViewControllerBase.extend({
...
,getEditDataView:function(arg){
       ...
       for(var i=0;i<2;i++){
          ...
          if(!editmode)
             continue;
          if(editmode=='10@1'){
              return {title: '通知公告工作流视图(通知公告申请v1:部门领导审核)',openMode:'',height: 0,width: 0,
   		    	layout: 'fit',maximizable:true, viewurl:'/xxtz/oa_tzggtzggsqlc_w10_wfeditview3.jsp', viewparam:arg};
          }
      }
      if(true){
	   return {  title: '通知公告工作流视图(通知公告申请v1:部门领导审核)', openMode:'', height: 0, width: 0,
...
,getDefaultCfg:function(cfg){
     var me=this;   
    var config={backendurl:cfg.appctx+'/xxtz/OA_TZGGTZGGSQLC_W10_WFGridView.do?'+'srfcid='+cfg.containerid+'&',loaddefault:true
                ,viewurl:'/xxtz/oa_tzggtzggsqlc_w10_wfgridview.jsp?'+'srfcid='+cfg.containerid+'&'
...
,getEditMode:function(data){
    ...
    if(editMode&&editMode!='')
       editMode= editMode+':'+ data.tzggsqbz;
    else 
       editMode= data.tzggsqbz;
