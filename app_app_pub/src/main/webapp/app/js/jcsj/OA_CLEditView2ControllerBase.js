var OA_CLEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new OA_CPMJSQGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C3'}));
    this.regController(new OA_CLWXGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
    this.regController(new OA_PCSQGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C2'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/jcsj/OA_CLEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/jcsj/oa_cleditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM3'){
          return {viewurl:'/ywsp/oa_cpmjsqgridview.jsp',embedviewid:'C3'};
      	}
      if(drmode=='DRITEM2'){
          return {viewurl:'/ywsp/oa_pcsqgridview.jsp',embedviewid:'C2'};
      	}
      if(drmode=='DRITEM1'){
          return {viewurl:'/ywsp/oa_clwxgridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});