var OA_HYSEditView2ControllerBase = EditView2ControllerBase.extend({
...
,regControllers:function(config)
{
  var cid=config.containerid;
    if(cid!='')cid=cid+'_';
    this.regController(new OA_YBHYSQGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C1'}));
    this.regController(new OA_NSJGHYSQGridViewController({pcontroller:this,appctx:config.appctx,containerid:cid+'C2'}));
}
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/jcsj/OA_HYSEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/jcsj/oa_hyseditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Mf',name:'oa_hysid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M4',name:'group1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M5',name:'oa_hysname',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'hysdz',form:form}));
form.register(new IBizDropDownListField({id:this.getCId2()+'M7',name:'syqk',form:form,codelistid:'uniPSample_HYSSYQK'}));
form.register(new IBizDateField({id:this.getCId2()+'M8',name:'sysj',fmt:'YYYY-MM-DD HH:mm:ss',form:form,width:160}));
...
,getDRItemView:function(arg){
       ...
       if(!drmode)drmode='';
      if(drmode=='DRITEM2'){
          return {viewurl:'/ywsp/oa_nsjghysqgridview.jsp',embedviewid:'C2'};
      	}
      if(drmode=='DRITEM1'){
          return {viewurl:'/ywsp/oa_ybhysqgridview.jsp',embedviewid:'C1'};
      	}
       return null;
 }
});