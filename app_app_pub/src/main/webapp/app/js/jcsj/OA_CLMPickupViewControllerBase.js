var OA_CLMPickupViewControllerBase = MPickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/jcsj/OA_CLMPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/jcsj/oa_clmpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
