var OA_ZSKMPickupViewControllerBase = MPickupViewControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;   
    var config={backendurl:cfg.appctx+'/jcsj/OA_ZSKMPickupView.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/jcsj/oa_zskmpickupview.jsp?'+'srfcid='+cfg.containerid+'&'};
