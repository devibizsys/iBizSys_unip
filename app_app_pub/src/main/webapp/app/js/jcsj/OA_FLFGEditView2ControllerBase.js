var OA_FLFGEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/jcsj/OA_FLFGEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/jcsj/oa_flfgeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'Me',name:'oa_flfgid'}));
form.register(new IBizFormGroup({id:this.getCId2()+'M4',name:'group1',titleBarCloseMode:'0',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M5',name:'oa_flfgname',form:form}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M6',name:'zy',form:form,height:60}));
form.register(new IBizTextAreaField({id:this.getCId2()+'M7',name:'memo',form:form,height:60}));
form.register(new IBizFormGroup({id:this.getCId2()+'M9',name:'group2',titleBarCloseMode:'0',form:form}));
