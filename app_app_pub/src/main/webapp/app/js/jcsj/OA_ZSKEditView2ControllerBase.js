var OA_ZSKEditView2ControllerBase = EditView2ControllerBase.extend({
...
,getDefaultCfg:function(cfg){
    var me=this;
    var config={backendurl:cfg.appctx+'/jcsj/OA_ZSKEditView2.do?'+'srfcid='+cfg.containerid+'&'
                ,viewurl:'/jcsj/oa_zskeditview2.jsp?'+'srfcid='+cfg.containerid+'&'
               ,ctrls:{form:{}}};
...
form.register(new IBizHiddenField({id:this.getCId2()+'M5',name:'oa_zskid'}));
...
form.register(new IBizHiddenField({id:this.getCId2()+'M5',name:'oa_zskid',form:form}));
form.register(new IBizTextField({id:this.getCId2()+'M6',name:'oa_zskname',allowBlank:false,form:form}));
...
,ac:true
,url:this.getAppCtx()+'/jcsj/OA_ZSKEditView2.do?SRFCTRLID=form&SRFFORMITEMID=orgsectorname'

}));
form.register(new IBizDateField({id:this.getCId2()+'Mb',name:'lrsj',fmt:'YYYY-MM-DD HH:mm:ss',allowBlank:false,form:form,width:160}));
form.register(new IBizTextAreaField({id:this.getCId2()+'Mc',name:'content',form:form,height:60}));
form.register(new IBizTextField({id:this.getCId2()+'Md',name:'memo',form:form}));
form.register(new IBizFileField({id:this.getCId2()+'Me',name:'fj',form:form,uploadLimited:''}));
