...
<jsp:useBean id="page1" scope="page" class="com.sa.cmp.cmp.web.util.UX_WFTraceChartPage" />
...
<html>
    <head>
		...
		<link rel="stylesheet" href="../assets/jsplumb/demo.css">
    ...
    <body data-demo-id="flowchart" data-library="dom">
        ...
        <script src="../assets/jsplumb/lib/jsBezier-0.6.js"></script>
		<script src="../assets/jsplumb/lib/mottle-0.4.js"></script>
        <script src="../assets/jsplumb/lib/biltong-0.2.js"></script>
        <script src="../assets/jsplumb/lib/katavorio-0.4.js"></script>
        <script src="../assets/jsplumb/lib/jquery-1.11.2.min.js"></script>
        <script src="../assets/jsplumb/src/util.js"></script>
        <script src="../assets/jsplumb/src/browser-util.js"></script>
        <script src="../assets/jsplumb/src/dom-adapter.js"></script>
        <script src="../assets/jsplumb/src/jsPlumb.js"></script>
        <script src="../assets/jsplumb/src/endpoint.js"></script>
        <script src="../assets/jsplumb/src/connection.js"></script>
        <script src="../assets/jsplumb/src/anchors.js"></script>
        <script src="../assets/jsplumb/src/defaults.js"></script>
        <script src="../assets/jsplumb/src/connectors-bezier.js"></script>
        <script src="../assets/jsplumb/src/connectors-statemachine.js"></script>
        <script src="../assets/jsplumb/src/connectors-flowchart.js"></script>
        <script src="../assets/jsplumb/src/connector-editors.js"></script>
        <script src="../assets/jsplumb/src/renderers-svg.js"></script>
        <script src="../assets/jsplumb/src/renderers-vml.js"></script>

        <script src="../assets/jsplumb/src/base-library-adapter.js"></script>
        <script src="../assets/jsplumb/src/dom.jsPlumb.js"></script>
        <!--  demo code -->
        <script src="../assets/jsplumb/demo.js"></script>
         
    	<script src="../assets/jsplumb/flowchataction2.js"></script>
    <script>
...
//					connname = _lastLogicLink.pswflinkname;
		...
		_jsInstance.bind('connectionDetached',function(obj, originalEvent){
				...
				if(!_removeConnection)
				{
					...
					_jsInstance.bind('endpointClick', function(obj,
										originalEvent) {
									//console.log('endpointClick');
								});
								_jsInstance.bind('endpointDblClick', function(
										obj, originalEvent) {
									//console.log('endpointDblClick');
								});

								_fl = new SRFFlowChat(document
										.getElementById('flowchart-demo'),
										_jsInstance);
								_flReady = true;
								if (_parentObj) {
