...
<% if(!p.init(pageContext,"/app/common/TSSDTaskMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskPickupGridViewControllerBase.js?v=479_20171123142622' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskPickupGridViewController.js?v=479_20171123142622' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskMPickupViewControllerBase.js?v=479_20171123142622' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskMPickupViewController.js?v=479_20171123142622' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
