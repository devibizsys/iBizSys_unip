...
<% if(!p.init(pageContext,"/app/common/TSSDTaskPolicyGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskPolicyGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskpolicygridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskPolicyGridViewControllerBase.js?v=425_20171123142411' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskPolicyGridViewController.js?v=425_20171123142411' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskPolicyGridViewController({appctx:'${ctx2}',webctx:'${web}'});
