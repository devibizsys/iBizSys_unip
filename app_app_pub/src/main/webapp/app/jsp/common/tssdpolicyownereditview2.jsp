...
<% if(!p.init(pageContext,"/app/common/TSSDPolicyOwnerEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDPolicyOwnerEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdpolicyownereditview2_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDPolicyOwnerEditView2ControllerBase.js?v=330_20171123142604' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyOwnerEditView2Controller.js?v=330_20171123142604' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDPolicyOwnerEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
