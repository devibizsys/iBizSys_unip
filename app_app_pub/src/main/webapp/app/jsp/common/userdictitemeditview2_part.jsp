...
<%@include file="userdictitemeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M1b"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M1a"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M19"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M18"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M17"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M16"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M15"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M14"><INPUT type="hidden" name="userdictcatid" id="<%=strCId%>M11"><INPUT type="hidden" name="userdictid" id="<%=strCId%>M12"><INPUT type="hidden" name="userdictitemid" id="<%=strCId%>M13">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>用户词典项信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >用户词典</label>
	</div>
	...
	<div class="ibiz-field-picker">
		<div>
			...
			<input type="text" class="form-control text" name="userdictname" id="<%=strCId%>M5" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >词条类别</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			...
			<input type="text" class="form-control text" name="userdictcatname" id="<%=strCId%>M6" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >词条名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M7_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M7" name="userdictitemname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-sm-12 col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >完整内容</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M8_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>M8" name="content"  type="text"  class="form-control" ></textarea>
...
<div id='<%=strCId%>M9__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M9__lb' class="control-label" style="width:130px;"  >标记常用</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M9_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M9" name="markflag" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
