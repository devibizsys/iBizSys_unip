...
<% if(!p.init(pageContext,"/app/common/DALogPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DALogPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dalogpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DALogPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
