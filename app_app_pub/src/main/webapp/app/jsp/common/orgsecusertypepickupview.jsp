...
<% if(!p.init(pageContext,"/app/common/OrgSecUserTypePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserTypePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusertypepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserTypePickupViewControllerBase.js?v=971_20171123142310' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserTypePickupViewController.js?v=971_20171123142310' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserTypePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
