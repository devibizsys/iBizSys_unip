...
<% if(!p.init(pageContext,"/app/common/UserRoleDatasGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDatasGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledatasgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleDatasGridViewController({appctx:'${ctx2}',webctx:'${web}'});
