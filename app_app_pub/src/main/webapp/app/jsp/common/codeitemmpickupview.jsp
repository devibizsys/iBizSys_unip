...
<% if(!p.init(pageContext,"/app/common/CodeItemMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitemmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/CodeItemPickupGridViewControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemPickupGridViewController.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemMPickupViewControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemMPickupViewController.js?v=453_20171123142328' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeItemMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
