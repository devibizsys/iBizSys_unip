...
<%@include file="orgusereditview2_userpart.jsp"%>
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>组织人员信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >所属组织</label>
	</div>
	...
	<div class="ibiz-field-picker">
		<div>
			...
			<input type="text" class="form-control text" name="orgname" id="<%=strCId%>M5" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >所属部门</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			<span class="toggle fa fa-search"></span>
			<input type="text" class="form-control text" name="orgsectorname" id="<%=strCId%>M6" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >人员名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M7_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M7" name="orgusername" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >用户编号</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M8_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M8" name="usercode" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M9__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M9__lb' class="control-label" style="width:130px;"  >部门人员关系</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			<span class="toggle fa fa-search"></span>
			<input type="text" class="form-control text" name="orgsecusertypename" id="<%=strCId%>M9" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>Ma__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Ma__lb' class="control-label" style="width:130px;"  >头衔名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Ma_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Ma" name="titlename" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>Mb__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mb__lb' class="control-label" style="width:130px;"  >启用标志</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Mb_c" style="width:100px;" ><SELECT id="<%=strCId%>Mb" name="validflag" class="form-control ibiz-field-dropdownlist"></SELECT></div>
	</div>
</div>
<div id='<%=strCId%>Mc__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mc__lb' class="control-label" style="width:130px;"  >人员级别</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			<span class="toggle fa fa-search"></span>
			<input type="text" class="form-control text" name="orguserlevelname" id="<%=strCId%>Mc" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>Md__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Md__lb' class="control-label" style="width:130px;"  >人员排序</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>Me__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Me__lb' class="control-label" style="width:130px;"  >备注</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Me_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>Me" name="memo"  type="text"  class="form-control" ></textarea>
<div class="input-group-btn ibiz-id-dropdown">
  ...
  <div class="tab-pane  row" id="<%=strCId%>form_formpage2_tab" ><div id="<%=strCId%>M10" name="grouppanel2" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
...
<div id='<%=strCId%>M11__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M11__lb' class="control-label" style="width:130px;"  >建立人</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>M12__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M12__lb' class="control-label" style="width:130px;"  >建立时间</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>M13__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M13__lb' class="control-label" style="width:130px;"  >更新人</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>M14__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M14__lb' class="control-label" style="width:130px;"  >更新时间</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<li><a href="#<%=strCId%>drtab_DRITEM11" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM12" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM13" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM14" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM15" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM17" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM18" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM19" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM20" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM4" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM6" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM21" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM22" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM23" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM16" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM24" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM9" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM10" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM7" data-toggle="tab"></a></li>
<li><a href="#<%=strCId%>drtab_DRITEM8" data-toggle="tab"></a></li>
</ul>
<% return;} %>
...
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM11"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM12"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM13"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM14"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM15"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM17"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM18"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM19"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM20"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM4"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM6"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM21"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM22"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM23"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM16"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM24"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM9"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM10"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM7"></div>
<div class="tab-pane " id="<%=strCId%>drtab_DRITEM8"></div>
<% return;} %>
