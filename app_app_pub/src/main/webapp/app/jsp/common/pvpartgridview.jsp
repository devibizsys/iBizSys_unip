...
<% if(!p.init(pageContext,"/app/common/PVPartGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PVPartGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/pvpartgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new PVPartGridViewController({appctx:'${ctx2}',webctx:'${web}'});
