...
<% if(!p.init(pageContext,"/app/common/DataAuditDetailEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataAuditDetailEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/dataauditdetaileditview2_part.jsp"/>
...
<script src='${ctx}/js/common/DataAuditDetailEditView2ControllerBase.js?v=332_20171123142408' type='text/javascript'></script>
<script src='${ctx}/js/common/DataAuditDetailEditView2Controller.js?v=332_20171123142408' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataAuditDetailEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
