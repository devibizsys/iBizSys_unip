...
<% if(!p.init(pageContext,"/app/common/UserDictEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdicteditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictEditView2ControllerBase.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictEditView2Controller.js?v=395_20171123142516' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
