...
<% if(!p.init(pageContext,"/app/common/LoginLogEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginLogEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginlogeditview_part.jsp"/>
...
<script src='${ctx}/js/common/LoginLogEditViewControllerBase.js?v=150_20171123142356' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginLogEditViewController.js?v=150_20171123142356' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new LoginLogEditViewController({appctx:'${ctx2}',webctx:'${web}'});
