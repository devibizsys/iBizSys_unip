...
<% if(!p.init(pageContext,"/app/common/UserRoleDEFieldEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDEFieldEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledefieldeditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDEFieldEditViewControllerBase.js?v=458_20171123142126' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDEFieldEditViewController.js?v=458_20171123142126' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDEFieldEditViewController({appctx:'${ctx2}',webctx:'${web}'});
