...
<% if(!p.init(pageContext,"/app/common/PVPartMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PVPartMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/pvpartmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/PVPartMPickupViewControllerBase.js?v=384_20171123142513' type='text/javascript'></script>
<script src='${ctx}/js/common/PVPartMPickupViewController.js?v=384_20171123142513' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PVPartMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
