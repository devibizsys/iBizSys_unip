...
<% if(!p.init(pageContext,"/app/common/DataSyncInGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncInGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncingridview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncInGridViewControllerBase.js?v=364_20171123142229' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncInGridViewController.js?v=364_20171123142229' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncInGridViewController({appctx:'${ctx2}',webctx:'${web}'});
