...
<% if(!p.init(pageContext,"/app/common/DataSyncOut2EditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOut2EditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncout2editview2_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOut2EditView2ControllerBase.js?v=290_20171123142151' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOut2EditView2Controller.js?v=290_20171123142151' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOut2EditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
