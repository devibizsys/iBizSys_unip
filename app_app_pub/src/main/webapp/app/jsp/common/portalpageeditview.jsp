...
<% if(!p.init(pageContext,"/app/common/PortalPageEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PortalPageEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/portalpageeditview_part.jsp"/>
...
<script src='${ctx}/js/common/PortalPageEditViewControllerBase.js?v=165_20171123142618' type='text/javascript'></script>
<script src='${ctx}/js/common/PortalPageEditViewController.js?v=165_20171123142618' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PortalPageEditViewController({appctx:'${ctx2}',webctx:'${web}'});
