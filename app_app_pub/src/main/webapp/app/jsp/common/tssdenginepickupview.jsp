...
<% if(!p.init(pageContext,"/app/common/TSSDEnginePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDEnginePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdenginepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDEnginePickupViewControllerBase.js?v=377_20171123142542' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDEnginePickupViewController.js?v=377_20171123142542' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDEnginePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
