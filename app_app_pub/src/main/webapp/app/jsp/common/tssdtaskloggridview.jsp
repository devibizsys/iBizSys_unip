...
<% if(!p.init(pageContext,"/app/common/TSSDTaskLogGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskLogGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskloggridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskLogGridViewControllerBase.js?v=355_20171123142318' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskLogGridViewController.js?v=355_20171123142318' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskLogGridViewController({appctx:'${ctx2}',webctx:'${web}'});
