...
<% if(!p.init(pageContext,"/app/common/UserRoleDetailPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDetailPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledetailpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleDetailPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
