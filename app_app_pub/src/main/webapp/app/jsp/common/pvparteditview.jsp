...
<% if(!p.init(pageContext,"/app/common/PVPartEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PVPartEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/pvparteditview_part.jsp"/>
...
<script src='${ctx}/js/common/PVPartEditViewControllerBase.js?v=384_20171123142513' type='text/javascript'></script>
<script src='${ctx}/js/common/PVPartEditViewController.js?v=384_20171123142513' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PVPartEditViewController({appctx:'${ctx2}',webctx:'${web}'});
