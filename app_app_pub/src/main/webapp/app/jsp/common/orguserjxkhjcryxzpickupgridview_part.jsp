...
<%@include file="orguserjxkhjcryxzpickupgridview_userpart.jsp"%>
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >所属组织(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_orgname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >所属部门(%)</label>
</td>
<td>
<div class="col-md-12" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >保留字段25(=)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M6_c" style="" >
<div class="radio-list ibiz-field-radiobuttonlist"  id="<%=strCId%>M6" name="n_reserver25_eq"></div>
</div>
</div>
</td>
</tr>
...
<DIV id='<%=strCId%>M7__fi' style=""  class=" col-md-12 form-group" data-ibiz-allowblank="1">
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
...
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M7_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M7" name="n_orgusername_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
