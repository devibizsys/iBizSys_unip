...
<% if(!p.init(pageContext,"/app/common/TSSDEngineEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDEngineEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdengineeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDEngineEditView2ControllerBase.js?v=377_20171123142542' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDEngineEditView2Controller.js?v=377_20171123142542' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDEngineEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
