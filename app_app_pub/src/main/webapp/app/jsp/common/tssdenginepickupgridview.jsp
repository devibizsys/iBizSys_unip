...
<% if(!p.init(pageContext,"/app/common/TSSDEnginePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDEnginePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdenginepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new TSSDEnginePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
