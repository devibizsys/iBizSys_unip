...
<% if(!p.init(pageContext,"/app/common/RegistryPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/RegistryPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/registrypickupview_part.jsp"/>
...
<script src='${ctx}/js/common/RegistryPickupViewControllerBase.js?v=177_20171123142346' type='text/javascript'></script>
<script src='${ctx}/js/common/RegistryPickupViewController.js?v=177_20171123142346' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new RegistryPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
