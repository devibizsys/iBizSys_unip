...
<% if(!p.init(pageContext,"/app/common/DEDataChgEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgEditView2ControllerBase.js?v=251_20171123142453' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgEditView2Controller.js?v=251_20171123142453' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
