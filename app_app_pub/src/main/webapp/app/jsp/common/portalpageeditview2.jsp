...
<% if(!p.init(pageContext,"/app/common/PortalPageEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PortalPageEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/portalpageeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/PortalPageEditView2ControllerBase.js?v=165_20171123142619' type='text/javascript'></script>
<script src='${ctx}/js/common/PortalPageEditView2Controller.js?v=165_20171123142619' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PortalPageEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
