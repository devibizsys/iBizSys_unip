...
<%@include file="servicegridview_userpart.jsp"%>
...
<!--分割符号-->
<button title="启动服务"  data-ibiz-tag="StartService" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >启动服务</span>  </button>  
<button title="停止服务"  data-ibiz-tag="StopService" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >停止服务</span>  </button>  
<!--分割符号-->
<!--操作集合-->
<!--分割符号-->
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >服务名称(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_servicename_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >服务容器(=)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M5_c" style="width:100px;" ><SELECT id="<%=strCId%>M5" name="n_container_eq" class="form-control ibiz-field-dropdownlist"></SELECT></div>
</div>
</td>
</tr>
</table>
