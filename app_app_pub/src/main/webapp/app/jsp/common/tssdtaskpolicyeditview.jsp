...
<% if(!p.init(pageContext,"/app/common/TSSDTaskPolicyEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskPolicyEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskpolicyeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskPolicyEditViewControllerBase.js?v=425_20171123142411' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskPolicyEditViewController.js?v=425_20171123142411' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskPolicyEditViewController({appctx:'${ctx2}',webctx:'${web}'});
