...
<% if(!p.init(pageContext,"/app/common/DataSyncAgentEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncAgentEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncagenteditview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncAgentEditViewControllerBase.js?v=436_20171123142556' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncAgentEditViewController.js?v=436_20171123142556' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncAgentEditViewController({appctx:'${ctx2}',webctx:'${web}'});
