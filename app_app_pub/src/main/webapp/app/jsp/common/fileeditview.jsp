...
<% if(!p.init(pageContext,"/app/common/FileEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/FileEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/fileeditview_part.jsp"/>
...
<script src='${ctx}/js/common/FileEditViewControllerBase.js?v=454_20171123142148' type='text/javascript'></script>
<script src='${ctx}/js/common/FileEditViewController.js?v=454_20171123142148' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new FileEditViewController({appctx:'${ctx2}',webctx:'${web}'});
