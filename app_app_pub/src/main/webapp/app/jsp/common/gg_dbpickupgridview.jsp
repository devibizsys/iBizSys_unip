...
<% if(!p.init(pageContext,"/app/common/GG_DBPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/GG_DBPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/gg_dbpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new GG_DBPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
