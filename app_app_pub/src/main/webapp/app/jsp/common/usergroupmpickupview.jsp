...
<% if(!p.init(pageContext,"/app/common/UserGroupMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergroupmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserGroupPickupGridViewControllerBase.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupPickupGridViewController.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupMPickupViewControllerBase.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupMPickupViewController.js?v=184_20171123142323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGroupMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
