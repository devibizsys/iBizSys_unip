...
<% if(!p.init(pageContext,"/app/common/PPModelMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PPModelMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/ppmodelmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/PPModelPickupGridViewControllerBase.js?v=682_20171123142143' type='text/javascript'></script>
<script src='${ctx}/js/common/PPModelPickupGridViewController.js?v=682_20171123142143' type='text/javascript'></script>
<script src='${ctx}/js/common/PPModelMPickupViewControllerBase.js?v=682_20171123142143' type='text/javascript'></script>
<script src='${ctx}/js/common/PPModelMPickupViewController.js?v=682_20171123142143' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PPModelMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
