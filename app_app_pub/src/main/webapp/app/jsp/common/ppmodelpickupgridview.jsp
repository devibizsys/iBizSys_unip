...
<% if(!p.init(pageContext,"/app/common/PPModelPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PPModelPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/ppmodelpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new PPModelPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
