...
<% if(!p.init(pageContext,"/app/common/UserRoleEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroleeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleEditView2ControllerBase.js?v=461_20171123142155' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleEditView2Controller.js?v=461_20171123142155' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
