...
<% if(!p.init(pageContext,"/app/common/UserDictPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserDictPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
