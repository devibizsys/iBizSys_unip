...
<% if(!p.init(pageContext,"/app/common/TSSDTaskTypeGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskTypeGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtasktypegridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskTypeGridViewControllerBase.js?v=327_20171123142252' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskTypeGridViewController.js?v=327_20171123142252' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskTypeGridViewController({appctx:'${ctx2}',webctx:'${web}'});
