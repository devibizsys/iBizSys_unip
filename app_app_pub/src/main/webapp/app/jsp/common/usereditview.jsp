...
<% if(!p.init(pageContext,"/app/common/UserEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usereditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserEditViewControllerBase.js?v=1330_20171123142613' type='text/javascript'></script>
<script src='${ctx}/js/common/UserEditViewController.js?v=1330_20171123142613' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserEditViewController({appctx:'${ctx2}',webctx:'${web}'});
