...
<% if(!p.init(pageContext,"/app/common/ServiceMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/ServiceMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/servicempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/ServicePickupGridViewControllerBase.js?v=462_20171123142113' type='text/javascript'></script>
<script src='${ctx}/js/common/ServicePickupGridViewController.js?v=462_20171123142113' type='text/javascript'></script>
<script src='${ctx}/js/common/ServiceMPickupViewControllerBase.js?v=462_20171123142113' type='text/javascript'></script>
<script src='${ctx}/js/common/ServiceMPickupViewController.js?v=462_20171123142113' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new ServiceMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
