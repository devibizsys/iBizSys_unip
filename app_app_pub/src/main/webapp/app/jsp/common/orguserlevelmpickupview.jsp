...
<% if(!p.init(pageContext,"/app/common/OrgUserLevelMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserLevelMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserlevelmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserLevelPickupGridViewControllerBase.js?v=920_20171123142550' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserLevelPickupGridViewController.js?v=920_20171123142550' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserLevelMPickupViewControllerBase.js?v=920_20171123142550' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserLevelMPickupViewController.js?v=920_20171123142550' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserLevelMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
