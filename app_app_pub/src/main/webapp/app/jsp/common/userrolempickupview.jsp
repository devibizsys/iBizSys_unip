...
<% if(!p.init(pageContext,"/app/common/UserRoleMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRolePickupGridViewControllerBase.js?v=461_20171123142155' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRolePickupGridViewController.js?v=461_20171123142155' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleMPickupViewControllerBase.js?v=461_20171123142155' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleMPickupViewController.js?v=461_20171123142155' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
