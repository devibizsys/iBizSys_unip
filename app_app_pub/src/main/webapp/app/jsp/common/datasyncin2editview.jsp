...
<% if(!p.init(pageContext,"/app/common/DataSyncIn2EditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncIn2EditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncin2editview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncIn2EditViewControllerBase.js?v=412_20171123142110' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncIn2EditViewController.js?v=412_20171123142110' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncIn2EditViewController({appctx:'${ctx2}',webctx:'${web}'});
