...
<% if(!p.init(pageContext,"/app/common/UserDictCatPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictCatPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictcatpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictCatPickupViewControllerBase.js?v=357_20171123142502' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatPickupViewController.js?v=357_20171123142502' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictCatPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
