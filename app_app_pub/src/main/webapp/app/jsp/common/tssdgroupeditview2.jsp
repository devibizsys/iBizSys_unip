...
<% if(!p.init(pageContext,"/app/common/TSSDGroupEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgroupeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDGroupEditView2ControllerBase.js?v=345_20171123142606' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupEditView2Controller.js?v=345_20171123142606' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDGroupEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
