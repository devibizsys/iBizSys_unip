...
<% if(!p.init(pageContext,"/app/common/OrgSecUserPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecuserpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserPickupViewControllerBase.js?v=1186_20171123142433' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserPickupViewController.js?v=1186_20171123142433' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
