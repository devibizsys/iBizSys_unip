...
<% if(!p.init(pageContext,"/app/common/UserDictGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictgridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictGridViewControllerBase.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictGridViewController.js?v=395_20171123142516' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictGridViewController({appctx:'${ctx2}',webctx:'${web}'});
