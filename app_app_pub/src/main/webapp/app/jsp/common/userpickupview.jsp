...
<% if(!p.init(pageContext,"/app/common/UserPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserPickupViewControllerBase.js?v=1330_20171123142613' type='text/javascript'></script>
<script src='${ctx}/js/common/UserPickupViewController.js?v=1330_20171123142613' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
