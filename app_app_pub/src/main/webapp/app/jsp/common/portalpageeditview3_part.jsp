...
<%@include file="portalpageeditview3_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M15"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M14"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M13"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M12"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M11"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M10"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>Mf"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Me"><INPUT type="hidden" name="portalpageid" id="<%=strCId%>Md">
...
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >门户页面名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="portalpagename" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
</div>
</fieldset>
  ...
  <div class="tab-pane  row" id="<%=strCId%>form_formpage2_tab" ><div id="<%=strCId%>M8" name="group2" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
...
<li class="active"><a href="#<%=strCId%>drtab_form" data-toggle="tab">门户页面</a></li>
<li id="<%=strCId%>drtab_h_DRITEM1"><a href="#<%=strCId%>drtab_DRITEM1" data-toggle="tab">门户部件</a></li>
<li id="<%=strCId%>drtab_h_DRITEM2"><a href="#<%=strCId%>drtab_DRITEM2" data-toggle="tab">门户布局</a></li>
</ul>
<% return;} %>
