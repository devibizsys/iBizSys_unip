...
<% if(!p.init(pageContext,"/app/common/TSSDEngineMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDEngineMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdenginempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDEnginePickupGridViewControllerBase.js?v=377_20171123142542' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDEnginePickupGridViewController.js?v=377_20171123142542' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDEngineMPickupViewControllerBase.js?v=377_20171123142542' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDEngineMPickupViewController.js?v=377_20171123142542' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDEngineMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
