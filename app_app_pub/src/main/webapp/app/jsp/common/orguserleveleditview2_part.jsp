...
<%@include file="orguserleveleditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M18"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M17"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M16"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M15"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M14"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M13"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M12"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M11">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>组织人员级别信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >组织人员级别标识</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M5_c" style="" >
<input type="text" class="form-control text ibiz-field-span" readonly="readonly" name="orguserlevelid" id="<%=strCId%>M5"  >
</div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >人员级别名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="orguserlevelname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >级别代码</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M7_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M7" name="levelcode" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<div id='<%=strCId%>M9__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
