...
<% if(!p.init(pageContext,"/app/common/UserRoleDatasPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDatasPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataspickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleDatasPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
