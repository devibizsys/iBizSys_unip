...
<%@include file="orguserlevelpickupgridview_userpart.jsp"%>
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >人员级别名称(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_orguserlevelname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
