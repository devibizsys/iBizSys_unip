...
<% if(!p.init(pageContext,"/app/common/UserRoleTypeGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleTypeGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroletypegridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleTypeGridViewControllerBase.js?v=342_20171123142616' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleTypeGridViewController.js?v=342_20171123142616' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleTypeGridViewController({appctx:'${ctx2}',webctx:'${web}'});
