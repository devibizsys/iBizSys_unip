...
<% if(!p.init(pageContext,"/app/common/UserRoleDataActionEditView.do")){return;}%>
...
<%@include file="../../lib/deeditviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataActionEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataactioneditview_part.jsp"/>
...
<%@include file="../../lib/deeditviewlib-script.jsp"%>
<script src='${ctx}/js/common/UserRoleDataActionEditViewControllerBase.js?v=358_20171123142122' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataActionEditViewController.js?v=358_20171123142122' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataActionEditViewController({appctx:'${ctx2}',webctx:'${web}'});
