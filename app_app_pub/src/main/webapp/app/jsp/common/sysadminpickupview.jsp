...
<% if(!p.init(pageContext,"/app/common/SysAdminPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadminpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminPickupViewControllerBase.js?v=338_20171123142116' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminPickupViewController.js?v=338_20171123142116' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
