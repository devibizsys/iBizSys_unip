...
<% if(!p.init(pageContext,"/app/common/RegistryEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/RegistryEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/registryeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/RegistryEditView2ControllerBase.js?v=177_20171123142346' type='text/javascript'></script>
<script src='${ctx}/js/common/RegistryEditView2Controller.js?v=177_20171123142346' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new RegistryEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
