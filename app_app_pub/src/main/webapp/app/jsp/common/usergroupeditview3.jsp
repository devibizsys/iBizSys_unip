...
<% if(!p.init(pageContext,"/app/common/UserGroupEditView3.do")){return;}%>
...
<jsp:include page="../../templ/deeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergroupeditview3_part.jsp"/>
...
<script src='${ctx}/js/common/UserGroupEditView3ControllerBase.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupEditView3Controller.js?v=184_20171123142323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGroupEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
