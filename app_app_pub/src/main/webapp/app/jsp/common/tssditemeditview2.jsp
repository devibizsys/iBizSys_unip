...
<% if(!p.init(pageContext,"/app/common/TSSDItemEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDItemEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssditemeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDItemEditView2ControllerBase.js?v=1796_20171123142400' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDItemEditView2Controller.js?v=1796_20171123142400' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDItemEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
