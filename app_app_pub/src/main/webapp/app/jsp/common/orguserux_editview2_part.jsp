...
<%@include file="orguserux_editview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M20"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M1f"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M1e"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M1d"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M1c"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M1b"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M1a"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M19"><INPUT type="hidden" name="userdata" id="<%=strCId%>M14"><INPUT type="hidden" name="orgsectorid" id="<%=strCId%>M16"><INPUT type="hidden" name="orgsecusertypeid" id="<%=strCId%>M17"><INPUT type="hidden" name="orguserlevelid" id="<%=strCId%>M18">
<div class="tab_title"><a href="#<%=strCId%>form_formpage1_tab">基本信息</a></div>
  <div id="<%=strCId%>M4" name="group1" style="" class="ibiz-form-formgroup-nocap row form-group  col-md-12 ">
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >人员标识</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M5_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="orguserid" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >人员名称</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="orgusername" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >所属部门</label>
	</div>
	<div style="margin-left:140px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			...
			<input type="text" class="form-control text" name="orgsectorname" id="<%=strCId%>M7" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >职务</label>
	</div>
	<div style="margin-left:140px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			<span class="toggle fa fa-search"></span>
			<input type="text" class="form-control text" name="orgsecusertypename" id="<%=strCId%>M8" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
</div>
<div id='<%=strCId%>M9__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M9__lb' class="control-label" style="width:130px;"  >启用标志</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M9_c" style="width:100px;" ><SELECT id="<%=strCId%>M9" name="validflag" class="form-control ibiz-field-dropdownlist"></SELECT></div>
	</div>
</div>
<div id='<%=strCId%>Ma__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Ma__lb' class="control-label" style="width:130px;"  >性别</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Ma_c" style="" ><SELECT id="<%=strCId%>Ma" name="reserver5" class="form-control ibiz-field-dropdownlist"></SELECT></div>
	</div>
</div>
<div id='<%=strCId%>Mb__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mb__lb' class="control-label" style="width:130px;"  >人员级别</label>
	</div>
	<div style="margin-left:140px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			<span class="toggle fa fa-search"></span>
			<input type="text" class="form-control text" name="orguserlevelname" id="<%=strCId%>Mb" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>Mc__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mc__lb' class="control-label" style="width:130px;"  >头衔名称</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Mc_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Mc" name="titlename" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>Md__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Md__lb' class="control-label" style="width:130px;"  >登录名</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Md_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Md" name="reserver" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>Me__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Me__lb' class="control-label" style="width:130px;"  >生日</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Me_c" style="width:100px;" >
<div class="input-group ibiz-field-datepicker">
	<input id="<%=strCId%>Me" name="reserver19"  class="form-control form-control-inline date-picker"  type="text" />
</div>
</div>
	</div>
</div>
<div id='<%=strCId%>Mf__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mf__lb' class="control-label" style="width:130px;"  >邮箱地址</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Mf_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Mf" name="reserver6" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M10__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M10__lb' class="control-label" style="width:130px;"  >人员排序</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M10_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M10" name="ordervalue" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M11__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M11__lb' class="control-label" style="width:130px;"  >工号</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M11_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M11" name="usercode" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M12__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M12__lb' class="control-label" style="width:130px;"  >手机号码</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M12_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M12" name="reserver30" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M13__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M13__lb' class="control-label" style="width:130px;"  >工作证号</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M13_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M13" name="reserver4" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
</div>
<div id='<%=strCId%>M15__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M15__lb' class="control-label" style="width:130px;"  >备注</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M15_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>M15" name="memo"  type="text"  class="form-control" ></textarea>
