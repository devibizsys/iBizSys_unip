...
<%@include file="userroleeditview3_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M13"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M12"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M11"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M10"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>Mf"><INPUT type="hidden" name="srfuf" id="<%=strCId%>Me"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>Md"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Mc"><INPUT type="hidden" name="userroleid" id="<%=strCId%>Mb">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>系统角色基本信息</h5></div>
</div>
<div id="<%=strCId%>M5_gd" >
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >用户角色名称</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="userrolename" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >用户角色类型</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M7_c" style="" ><SELECT id="<%=strCId%>M7" name="userroletype" class="form-control ibiz-field-dropdownlist"></SELECT></div>
	</div>
</div>
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >用户数据</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M8_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M8" name="userdata" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M9__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M9__lb' class="control-label" style="width:130px;"  >用户数据2</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M9_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M9" name="userdata2" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<li class="active"><a href="#<%=strCId%>drtab_form" data-toggle="tab">用户角色</a></li>
<li id="<%=strCId%>drtab_h_DRITEM1"><a href="#<%=strCId%>drtab_DRITEM1" data-toggle="tab">角色成员</a></li>
<li id="<%=strCId%>drtab_h_DRITEM2"><a href="#<%=strCId%>drtab_DRITEM2" data-toggle="tab">实体数据访问</a></li>
<li id="<%=strCId%>drtab_h_DRITEM3"><a href="#<%=strCId%>drtab_DRITEM3" data-toggle="tab">统一资源访问</a></li>
<li id="<%=strCId%>drtab_h_DRITEM4"><a href="#<%=strCId%>drtab_DRITEM4" data-toggle="tab">实体属性访问</a></li>
</ul>
<% return;} %>
