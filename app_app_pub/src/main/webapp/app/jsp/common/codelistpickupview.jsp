...
<% if(!p.init(pageContext,"/app/common/CodeListPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeListPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codelistpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/CodeListPickupViewControllerBase.js?v=1595_20171123142418' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListPickupViewController.js?v=1595_20171123142418' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeListPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
