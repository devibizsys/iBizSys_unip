...
<% if(!p.init(pageContext,"/app/common/OrgEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgeditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgEditViewControllerBase.js?v=1692_20171115093119' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgEditViewController.js?v=1692_20171115093119' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgEditViewController({appctx:'${ctx2}',webctx:'${web}'});
