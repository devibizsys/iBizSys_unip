...
<% if(!p.init(pageContext,"/app/common/MsgSendQueuePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgSendQueuePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgsendqueuepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgSendQueuePickupViewControllerBase.js?v=321_20171123142222' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgSendQueuePickupViewController.js?v=321_20171123142222' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgSendQueuePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
