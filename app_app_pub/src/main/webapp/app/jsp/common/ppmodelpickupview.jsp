...
<% if(!p.init(pageContext,"/app/common/PPModelPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PPModelPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/ppmodelpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/PPModelPickupViewControllerBase.js?v=682_20171123142143' type='text/javascript'></script>
<script src='${ctx}/js/common/PPModelPickupViewController.js?v=682_20171123142143' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PPModelPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
