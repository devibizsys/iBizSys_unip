...
<% if(!p.init(pageContext,"/app/common/UserDictMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictPickupGridViewControllerBase.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictPickupGridViewController.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictMPickupViewControllerBase.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictMPickupViewController.js?v=395_20171123142516' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
