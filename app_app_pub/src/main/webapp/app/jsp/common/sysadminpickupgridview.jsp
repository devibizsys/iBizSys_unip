...
<% if(!p.init(pageContext,"/app/common/SysAdminPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadminpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new SysAdminPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
