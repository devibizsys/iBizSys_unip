...
<% if(!p.init(pageContext,"/app/common/LoginLogMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginLogMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginlogmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/LoginLogPickupGridViewControllerBase.js?v=150_20171123142356' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginLogPickupGridViewController.js?v=150_20171123142356' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginLogMPickupViewControllerBase.js?v=150_20171123142356' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginLogMPickupViewController.js?v=150_20171123142356' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new LoginLogMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
