...
<% if(!p.init(pageContext,"/app/common/OrgTypeEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgTypeEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgtypeeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/OrgTypeEditView2ControllerBase.js?v=858_20171123142246' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgTypeEditView2Controller.js?v=858_20171123142246' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgTypeEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
