...
<% if(!p.init(pageContext,"/app/common/DALogMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DALogMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dalogmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DALogPickupGridViewControllerBase.js?v=301_20171123142259' type='text/javascript'></script>
<script src='${ctx}/js/common/DALogPickupGridViewController.js?v=301_20171123142259' type='text/javascript'></script>
<script src='${ctx}/js/common/DALogMPickupViewControllerBase.js?v=301_20171123142259' type='text/javascript'></script>
<script src='${ctx}/js/common/DALogMPickupViewController.js?v=301_20171123142259' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DALogMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
