...
<% if(!p.init(pageContext,"/app/common/OrgSecUserTypeEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserTypeEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusertypeeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserTypeEditView2ControllerBase.js?v=971_20171123142310' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserTypeEditView2Controller.js?v=971_20171123142310' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserTypeEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
