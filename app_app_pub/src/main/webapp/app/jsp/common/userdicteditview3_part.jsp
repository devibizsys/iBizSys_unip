...
<%@include file="userdicteditview3_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M18"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M17"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M16"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M15"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M14"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M13"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M12"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M11"><INPUT type="hidden" name="userdictid" id="<%=strCId%>M10">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>用户词典信息</h5></div>
</div>
<div id="<%=strCId%>M5_gd" >
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >用户词典名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="userdictname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >所有者类型</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M7_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M7" name="ownertype" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >所有者标识</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M8_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M8" name="ownerid" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<div class="input-group-btn ibiz-id-dropdown">
  ...
  <div class="tab-pane  row" id="<%=strCId%>form_formpage2_tab" ><div id="<%=strCId%>Mb" name="grouppanel2" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
...
<li class="active"><a href="#<%=strCId%>drtab_form" data-toggle="tab">用户词典</a></li>
<li id="<%=strCId%>drtab_h_DRITEM1"><a href="#<%=strCId%>drtab_DRITEM1" data-toggle="tab">用户词典词条</a></li>
</ul>
<% return;} %>
