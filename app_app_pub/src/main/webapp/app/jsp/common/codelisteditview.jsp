...
<% if(!p.init(pageContext,"/app/common/CodeListEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeListEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codelisteditview_part.jsp"/>
...
<script src='${ctx}/js/common/CodeListEditViewControllerBase.js?v=1595_20171123142418' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListEditViewController.js?v=1595_20171123142418' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeListEditViewController({appctx:'${ctx2}',webctx:'${web}'});
