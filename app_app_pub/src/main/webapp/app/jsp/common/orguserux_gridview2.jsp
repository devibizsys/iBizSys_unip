...
<% if(!p.init(pageContext,"/app/common/OrgUserUX_GridView2.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserUX_GridView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserux_gridview2_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserUX_GridView2ControllerBase.js?v=1332_20171219151357' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserUX_GridView2Controller.js?v=1332_20171219151357' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserUX_GridView2Controller({appctx:'${ctx2}',webctx:'${web}'});
