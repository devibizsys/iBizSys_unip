...
<% if(!p.init(pageContext,"/app/common/DataSyncAgentPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncAgentPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncagentpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncAgentPickupViewControllerBase.js?v=436_20171123142556' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncAgentPickupViewController.js?v=436_20171123142556' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncAgentPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
