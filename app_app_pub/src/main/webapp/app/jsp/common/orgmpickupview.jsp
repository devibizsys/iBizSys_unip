...
<% if(!p.init(pageContext,"/app/common/OrgMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgPickupGridViewControllerBase.js?v=1692_20171115093119' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgPickupGridViewController.js?v=1692_20171115093119' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgMPickupViewControllerBase.js?v=1692_20171115093119' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgMPickupViewController.js?v=1692_20171115093119' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
