...
<% if(!p.init(pageContext,"/app/common/TSSDTaskLogEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskLogEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtasklogeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskLogEditViewControllerBase.js?v=355_20171123142318' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskLogEditViewController.js?v=355_20171123142318' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskLogEditViewController({appctx:'${ctx2}',webctx:'${web}'});
