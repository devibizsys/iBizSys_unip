...
<% if(!p.init(pageContext,"/app/common/MsgTemplateMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgTemplateMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgtemplatempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgTemplatePickupGridViewControllerBase.js?v=563_20171123142529' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgTemplatePickupGridViewController.js?v=563_20171123142529' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgTemplateMPickupViewControllerBase.js?v=563_20171123142529' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgTemplateMPickupViewController.js?v=563_20171123142529' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgTemplateMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
