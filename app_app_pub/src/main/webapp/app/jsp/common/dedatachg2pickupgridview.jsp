...
<% if(!p.init(pageContext,"/app/common/DEDataChg2PickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChg2PickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachg2pickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DEDataChg2PickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
