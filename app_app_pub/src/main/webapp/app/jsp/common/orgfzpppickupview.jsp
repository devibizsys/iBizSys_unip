...
<% if(!p.init(pageContext,"/app/common/OrgFZPPPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgFZPPPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgfzpppickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgFZPPPickupGridViewControllerBase.js?v=1692_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgFZPPPickupGridViewController.js?v=1692_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgFZPPPickupViewControllerBase.js?v=1692_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgFZPPPickupViewController.js?v=1692_20171115095050' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgFZPPPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
