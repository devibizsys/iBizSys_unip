...
<% if(!p.init(pageContext,"/app/common/DEDataChgPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DEDataChgPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
