...
<% if(!p.init(pageContext,"/app/common/UserRoleDataActionEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataActionEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataactioneditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDataActionEditView2ControllerBase.js?v=358_20171123142122' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataActionEditView2Controller.js?v=358_20171123142122' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataActionEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
