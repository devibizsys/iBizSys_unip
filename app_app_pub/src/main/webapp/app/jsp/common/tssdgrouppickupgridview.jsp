...
<% if(!p.init(pageContext,"/app/common/TSSDGroupPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgrouppickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new TSSDGroupPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
