...
<% if(!p.init(pageContext,"/app/common/TSSDGroupDetailPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupDetailPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgroupdetailpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new TSSDGroupDetailPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
