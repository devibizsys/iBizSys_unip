...
<% if(!p.init(pageContext,"/app/common/ServicePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/ServicePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/servicepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new ServicePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
