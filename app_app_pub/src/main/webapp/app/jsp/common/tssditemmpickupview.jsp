...
<% if(!p.init(pageContext,"/app/common/TSSDItemMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDItemMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssditemmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDItemMPickupViewControllerBase.js?v=1796_20171123142400' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDItemMPickupViewController.js?v=1796_20171123142400' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDItemMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
