...
<% if(!p.init(pageContext,"/app/common/CodeItemEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitemeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/CodeItemEditView2ControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemEditView2Controller.js?v=453_20171123142328' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeItemEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
