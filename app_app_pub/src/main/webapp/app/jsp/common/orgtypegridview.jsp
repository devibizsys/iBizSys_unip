...
<% if(!p.init(pageContext,"/app/common/OrgTypeGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgTypeGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgtypegridview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgTypeGridViewControllerBase.js?v=858_20171123142246' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgTypeGridViewController.js?v=858_20171123142246' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgTypeGridViewController({appctx:'${ctx2}',webctx:'${web}'});
