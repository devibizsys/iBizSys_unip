...
<% if(!p.init(pageContext,"/app/common/UserRoleDataPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledatapickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDataPickupViewControllerBase.js?v=884_20171123142459' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataPickupViewController.js?v=884_20171123142459' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
