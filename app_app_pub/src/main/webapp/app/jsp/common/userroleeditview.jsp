...
<% if(!p.init(pageContext,"/app/common/UserRoleEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroleeditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleEditViewControllerBase.js?v=461_20171123142155' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleEditViewController.js?v=461_20171123142155' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleEditViewController({appctx:'${ctx2}',webctx:'${web}'});
