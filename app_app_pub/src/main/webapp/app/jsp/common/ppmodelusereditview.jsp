...
<% if(!p.init(pageContext,"/app/common/PPModelUserEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PPModelUserEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/ppmodelusereditview_part.jsp"/>
...
<script src='${ctx}/js/common/PPModelUserEditViewControllerBase.js?v=682_20171123142144' type='text/javascript'></script>
<script src='${ctx}/js/common/PPModelUserEditViewController.js?v=682_20171123142144' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PPModelUserEditViewController({appctx:'${ctx2}',webctx:'${web}'});
