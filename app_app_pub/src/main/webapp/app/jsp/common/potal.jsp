...
<% if(!p.init(pageContext,"/app/common/potal.do")){return;}%>
...
<%@include file="../../lib/appportalviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/appportalview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/potal.do"/>
	<jsp:param name="parturl" value="../jsp/common/potal_part.jsp"/>
...
<%@include file="../../lib/appportalviewlib-script.jsp"%>
<script src='${ctx}/js/common/potalControllerBase.js?v=20180120191349' type='text/javascript'></script>
<script src='${ctx}/js/common/potalController.js?v=20180120191349' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new potalController({appctx:'${ctx2}',webctx:'${web}'});
