...
<% if(!p.init(pageContext,"/app/common/SysAdminFuncEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminFuncEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadminfunceditview_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminFuncEditViewControllerBase.js?v=158_20171123142212' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminFuncEditViewController.js?v=158_20171123142212' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminFuncEditViewController({appctx:'${ctx2}',webctx:'${web}'});
