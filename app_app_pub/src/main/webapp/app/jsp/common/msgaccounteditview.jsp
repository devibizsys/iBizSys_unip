...
<% if(!p.init(pageContext,"/app/common/MsgAccountEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgAccountEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgaccounteditview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgAccountEditViewControllerBase.js?v=1560_20171123142404' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountEditViewController.js?v=1560_20171123142404' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgAccountEditViewController({appctx:'${ctx2}',webctx:'${web}'});
