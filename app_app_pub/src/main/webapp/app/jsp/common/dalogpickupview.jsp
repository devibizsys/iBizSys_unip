...
<% if(!p.init(pageContext,"/app/common/DALogPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DALogPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dalogpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DALogPickupViewControllerBase.js?v=301_20171123142259' type='text/javascript'></script>
<script src='${ctx}/js/common/DALogPickupViewController.js?v=301_20171123142259' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DALogPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
