...
<% if(!p.init(pageContext,"/app/common/OrgUserLevelEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserLevelEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserleveleditview2_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserLevelEditView2ControllerBase.js?v=920_20171123142550' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserLevelEditView2Controller.js?v=920_20171123142550' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserLevelEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
