...
<% if(!p.init(pageContext,"/app/common/TSSDGroupGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgroupgridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDGroupGridViewControllerBase.js?v=345_20171123142606' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupGridViewController.js?v=345_20171123142606' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDGroupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
