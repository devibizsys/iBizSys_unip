...
<% if(!p.init(pageContext,"/app/common/LoginLogEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginLogEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginlogeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/LoginLogEditView2ControllerBase.js?v=150_20171123142356' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginLogEditView2Controller.js?v=150_20171123142356' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new LoginLogEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
