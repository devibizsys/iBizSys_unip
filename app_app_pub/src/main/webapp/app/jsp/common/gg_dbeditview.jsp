...
<% if(!p.init(pageContext,"/app/common/GG_DBEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/GG_DBEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/gg_dbeditview_part.jsp"/>
...
<script src='${ctx}/js/common/GG_DBEditViewControllerBase.js?v=330_20171119152152' type='text/javascript'></script>
<script src='${ctx}/js/common/GG_DBEditViewController.js?v=330_20171119152152' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new GG_DBEditViewController({appctx:'${ctx2}',webctx:'${web}'});
