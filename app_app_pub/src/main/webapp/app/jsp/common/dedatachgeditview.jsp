...
<% if(!p.init(pageContext,"/app/common/DEDataChgEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgeditview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgEditViewControllerBase.js?v=251_20171123142453' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgEditViewController.js?v=251_20171123142453' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgEditViewController({appctx:'${ctx2}',webctx:'${web}'});
