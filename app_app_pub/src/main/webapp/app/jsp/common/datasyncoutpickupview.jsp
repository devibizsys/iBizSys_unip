...
<% if(!p.init(pageContext,"/app/common/DataSyncOutPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOutPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncoutpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOutPickupViewControllerBase.js?v=384_20171123142506' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOutPickupViewController.js?v=384_20171123142506' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOutPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
