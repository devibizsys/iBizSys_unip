...
<% if(!p.init(pageContext,"/app/common/UniResMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UniResMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/uniresmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UniResPickupGridViewControllerBase.js?v=371_20171123142421' type='text/javascript'></script>
<script src='${ctx}/js/common/UniResPickupGridViewController.js?v=371_20171123142421' type='text/javascript'></script>
<script src='${ctx}/js/common/UniResMPickupViewControllerBase.js?v=371_20171123142421' type='text/javascript'></script>
<script src='${ctx}/js/common/UniResMPickupViewController.js?v=371_20171123142421' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UniResMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
