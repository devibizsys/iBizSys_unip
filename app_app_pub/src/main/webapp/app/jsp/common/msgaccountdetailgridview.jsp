...
<% if(!p.init(pageContext,"/app/common/MsgAccountDetailGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgAccountDetailGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgaccountdetailgridview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgAccountDetailGridViewControllerBase.js?v=160_20171123142446' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountDetailGridViewController.js?v=160_20171123142446' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgAccountDetailGridViewController({appctx:'${ctx2}',webctx:'${web}'});
