...
<% if(!p.init(pageContext,"/app/common/LoginAccountPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginAccountPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginaccountpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/LoginAccountPickupViewControllerBase.js?v=222_20171123142315' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginAccountPickupViewController.js?v=222_20171123142315' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new LoginAccountPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
