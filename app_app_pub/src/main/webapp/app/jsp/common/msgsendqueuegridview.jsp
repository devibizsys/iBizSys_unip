...
<% if(!p.init(pageContext,"/app/common/MsgSendQueueGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgSendQueueGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgsendqueuegridview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgSendQueueGridViewControllerBase.js?v=321_20171123142222' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgSendQueueGridViewController.js?v=321_20171123142222' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgSendQueueGridViewController({appctx:'${ctx2}',webctx:'${web}'});
