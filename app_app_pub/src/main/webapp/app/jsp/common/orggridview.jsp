...
<% if(!p.init(pageContext,"/app/common/OrgGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orggridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgGridViewController({appctx:'${ctx2}',webctx:'${web}'});
