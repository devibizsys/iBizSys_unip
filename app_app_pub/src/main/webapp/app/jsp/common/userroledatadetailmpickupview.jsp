...
<% if(!p.init(pageContext,"/app/common/UserRoleDataDetailMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataDetailMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledatadetailmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDataDetailPickupGridViewControllerBase.js?v=447_20171123142438' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataDetailPickupGridViewController.js?v=447_20171123142438' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataDetailMPickupViewControllerBase.js?v=447_20171123142438' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataDetailMPickupViewController.js?v=447_20171123142438' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataDetailMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
