...
<% if(!p.init(pageContext,"/app/common/TSSDItemEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDItemEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssditemeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDItemEditViewControllerBase.js?v=1796_20171123142400' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDItemEditViewController.js?v=1796_20171123142400' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDItemEditViewController({appctx:'${ctx2}',webctx:'${web}'});
