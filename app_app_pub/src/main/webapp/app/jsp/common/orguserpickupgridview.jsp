...
<% if(!p.init(pageContext,"/app/common/OrgUserPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgUserPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
