...
<% if(!p.init(pageContext,"/app/common/PPModelGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PPModelGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/ppmodelgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new PPModelGridViewController({appctx:'${ctx2}',webctx:'${web}'});
