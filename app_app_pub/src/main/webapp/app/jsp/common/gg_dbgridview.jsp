...
<% if(!p.init(pageContext,"/app/common/GG_DBGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/GG_DBGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/gg_dbgridview_part.jsp"/>
...
<script src='${ctx}/js/common/GG_DBGridViewControllerBase.js?v=330_20171119152152' type='text/javascript'></script>
<script src='${ctx}/js/common/GG_DBGridViewController.js?v=330_20171119152152' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new GG_DBGridViewController({appctx:'${ctx2}',webctx:'${web}'});
