...
<% if(!p.init(pageContext,"/app/common/UserPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
