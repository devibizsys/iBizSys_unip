...
<% if(!p.init(pageContext,"/app/common/PortalPagePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PortalPagePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/portalpagepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/PortalPagePickupViewControllerBase.js?v=165_20171123142618' type='text/javascript'></script>
<script src='${ctx}/js/common/PortalPagePickupViewController.js?v=165_20171123142618' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PortalPagePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
