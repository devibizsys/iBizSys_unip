...
<% if(!p.init(pageContext,"/app/common/OrgUserPickupView3.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserPickupView3.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserpickupview3_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserPickupGridView3ControllerBase.js?v=1332_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserPickupGridView3Controller.js?v=1332_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserPickupView3ControllerBase.js?v=1332_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserPickupView3Controller.js?v=1332_20171115095050' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserPickupView3Controller({appctx:'${ctx2}',webctx:'${web}'});
