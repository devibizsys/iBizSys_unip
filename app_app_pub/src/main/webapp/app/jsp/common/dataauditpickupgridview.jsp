...
<% if(!p.init(pageContext,"/app/common/DataAuditPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataAuditPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dataauditpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DataAuditPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
