...
<% if(!p.init(pageContext,"/app/common/DataSyncOutPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOutPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncoutpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DataSyncOutPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
