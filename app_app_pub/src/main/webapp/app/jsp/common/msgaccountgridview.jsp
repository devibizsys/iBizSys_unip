...
<% if(!p.init(pageContext,"/app/common/MsgAccountGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgAccountGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgaccountgridview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgAccountGridViewControllerBase.js?v=1560_20171123142404' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountGridViewController.js?v=1560_20171123142404' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgAccountGridViewController({appctx:'${ctx2}',webctx:'${web}'});
