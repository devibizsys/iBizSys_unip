...
<% if(!p.init(pageContext,"/app/common/UserDictItemPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictItemPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictitempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictItemPickupViewControllerBase.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictItemPickupViewController.js?v=459_20171123142256' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictItemPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
