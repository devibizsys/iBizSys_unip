...
<% if(!p.init(pageContext,"/app/common/RegistryPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/RegistryPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/registrypickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new RegistryPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
