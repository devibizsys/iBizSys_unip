...
<% if(!p.init(pageContext,"/app/common/PPModelEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PPModelEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/ppmodeleditview_part.jsp"/>
...
<script src='${ctx}/js/common/PPModelEditViewControllerBase.js?v=682_20171123142143' type='text/javascript'></script>
<script src='${ctx}/js/common/PPModelEditViewController.js?v=682_20171123142143' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PPModelEditViewController({appctx:'${ctx2}',webctx:'${web}'});
