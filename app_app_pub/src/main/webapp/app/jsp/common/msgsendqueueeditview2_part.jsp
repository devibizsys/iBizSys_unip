...
<%@include file="msgsendqueueeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M25"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M24"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M23"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M22"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M21"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M20"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M1f"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M1e"><INPUT type="hidden" name="msgsendqueueid" id="<%=strCId%>M1d">
<ul class="nav nav-tabs" id="<%=strCId%>form_tab">
   <li class="active"><a href="#<%=strCId%>form_formpage1_tab" data-toggle="tab"><ibiz5:message code="CONTROL.DEFORM.MSGSENDQUEUE.MAIN2.FORMPAGE.FORMPAGE1" text="基本信息"></ibiz5:message></a></li>
   <li class=""><a href="#<%=strCId%>form_formpage2_tab" data-toggle="tab"><ibiz5:message code="CONTROL.DEFORM.MSGSENDQUEUE.MAIN2.FORMPAGE.FORMPAGE2" text="其它"></ibiz5:message></a></li>
</ul>
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5><ibiz5:message code="CONTROL.DEFORM.MSGSENDQUEUE.MAIN2.GROUPPANEL.GROUPPANEL1" text="消息发送队列信息"></ibiz5:message></h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
...
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
<div class="panel-heading panel-text grouppanel2_text"  style="height:40px;" ><h5><ibiz5:message code="CONTROL.DEFORM.MSGSENDQUEUE.MAIN2.GROUPPANEL.GROUPPANEL2" text="操作信息"></ibiz5:message></h5></div>
</div>
