...
<% if(!p.init(pageContext,"/app/common/OrgUserEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgusereditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserEditViewControllerBase.js?v=1332_20171123142205' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserEditViewController.js?v=1332_20171123142205' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserEditViewController({appctx:'${ctx2}',webctx:'${web}'});
