...
<% if(!p.init(pageContext,"/app/common/DataSyncInPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncInPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncinpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DataSyncInPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
