...
<% if(!p.init(pageContext,"/app/common/DataAuditPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataAuditPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dataauditpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataAuditPickupViewControllerBase.js?v=381_20171123142225' type='text/javascript'></script>
<script src='${ctx}/js/common/DataAuditPickupViewController.js?v=381_20171123142225' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataAuditPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
