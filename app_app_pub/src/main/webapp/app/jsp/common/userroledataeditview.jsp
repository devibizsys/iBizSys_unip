...
<% if(!p.init(pageContext,"/app/common/UserRoleDataEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataeditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDataEditViewControllerBase.js?v=884_20171123142459' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataEditViewController.js?v=884_20171123142459' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataEditViewController({appctx:'${ctx2}',webctx:'${web}'});
