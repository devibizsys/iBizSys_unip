...
<% if(!p.init(pageContext,"/app/common/RegistryGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/RegistryGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/registrygridview_part.jsp"/>
...
<script src='${ctx}/js/common/RegistryGridViewControllerBase.js?v=177_20171123142346' type='text/javascript'></script>
<script src='${ctx}/js/common/RegistryGridViewController.js?v=177_20171123142346' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new RegistryGridViewController({appctx:'${ctx2}',webctx:'${web}'});
