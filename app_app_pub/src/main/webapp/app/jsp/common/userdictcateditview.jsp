...
<% if(!p.init(pageContext,"/app/common/UserDictCatEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictCatEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictcateditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictCatEditViewControllerBase.js?v=357_20171123142502' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatEditViewController.js?v=357_20171123142502' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictCatEditViewController({appctx:'${ctx2}',webctx:'${web}'});
