...
<% if(!p.init(pageContext,"/app/common/SysAdminFuncMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminFuncMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadminfuncmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminFuncPickupGridViewControllerBase.js?v=158_20171123142212' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminFuncPickupGridViewController.js?v=158_20171123142212' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminFuncMPickupViewControllerBase.js?v=158_20171123142212' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminFuncMPickupViewController.js?v=158_20171123142212' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminFuncMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
