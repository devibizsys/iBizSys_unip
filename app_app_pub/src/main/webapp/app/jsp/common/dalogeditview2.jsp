...
<% if(!p.init(pageContext,"/app/common/DALogEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DALogEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/dalogeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/DALogEditView2ControllerBase.js?v=301_20171123142259' type='text/javascript'></script>
<script src='${ctx}/js/common/DALogEditView2Controller.js?v=301_20171123142259' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DALogEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
