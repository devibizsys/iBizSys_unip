...
<% if(!p.init(pageContext,"/app/common/DataSyncOut2PickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOut2PickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncout2pickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DataSyncOut2PickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
