...
<% if(!p.init(pageContext,"/app/common/UserGroupPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergrouppickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserGroupPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
