...
<% if(!p.init(pageContext,"/app/common/PVPartEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PVPartEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/pvparteditview2_part.jsp"/>
...
<script src='${ctx}/js/common/PVPartEditView2ControllerBase.js?v=384_20171123142513' type='text/javascript'></script>
<script src='${ctx}/js/common/PVPartEditView2Controller.js?v=384_20171123142513' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PVPartEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
