...
<% if(!p.init(pageContext,"/app/common/MsgSendQueuePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgSendQueuePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgsendqueuepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new MsgSendQueuePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
