...
<% if(!p.init(pageContext,"/app/common/PortalPagePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PortalPagePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/portalpagepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new PortalPagePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
