...
<% if(!p.init(pageContext,"/app/common/UserRoleDetailEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDetailEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledetaileditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDetailEditViewControllerBase.js?v=460_20171123142442' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDetailEditViewController.js?v=460_20171123142442' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDetailEditViewController({appctx:'${ctx2}',webctx:'${web}'});
