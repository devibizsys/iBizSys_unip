...
<% if(!p.init(pageContext,"/app/common/UserRoleResEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleResEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolereseditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleResEditViewControllerBase.js?v=474_20171123142601' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleResEditViewController.js?v=474_20171123142601' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleResEditViewController({appctx:'${ctx2}',webctx:'${web}'});
