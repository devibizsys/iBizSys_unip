...
<% if(!p.init(pageContext,"/app/common/OrgSectorPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSectorPickupViewControllerBase.js?v=1797_20180116134836' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSectorPickupViewController.js?v=1797_20180116134836' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSectorPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
