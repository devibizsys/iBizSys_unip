...
<% if(!p.init(pageContext,"/app/common/UserDictItemMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictItemMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictitemmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictItemPickupGridViewControllerBase.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictItemPickupGridViewController.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictItemMPickupViewControllerBase.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictItemMPickupViewController.js?v=459_20171123142256' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictItemMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
