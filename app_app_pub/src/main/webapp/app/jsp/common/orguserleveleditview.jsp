...
<% if(!p.init(pageContext,"/app/common/OrgUserLevelEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserLevelEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserleveleditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserLevelEditViewControllerBase.js?v=920_20171123142550' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserLevelEditViewController.js?v=920_20171123142550' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserLevelEditViewController({appctx:'${ctx2}',webctx:'${web}'});
