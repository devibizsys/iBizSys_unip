...
<% if(!p.init(pageContext,"/app/common/ServicePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/ServicePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/servicepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/ServicePickupViewControllerBase.js?v=462_20171123142113' type='text/javascript'></script>
<script src='${ctx}/js/common/ServicePickupViewController.js?v=462_20171123142113' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new ServicePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
