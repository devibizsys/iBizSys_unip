...
<% if(!p.init(pageContext,"/app/common/DataSyncInPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncInPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncinpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncInPickupViewControllerBase.js?v=364_20171123142229' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncInPickupViewController.js?v=364_20171123142229' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncInPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
