...
<% if(!p.init(pageContext,"/app/common/PPModelEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PPModelEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/ppmodeleditview2_part.jsp"/>
...
<script src='${ctx}/js/common/PPModelEditView2ControllerBase.js?v=682_20171123142143' type='text/javascript'></script>
<script src='${ctx}/js/common/PPModelEditView2Controller.js?v=682_20171123142143' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PPModelEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
