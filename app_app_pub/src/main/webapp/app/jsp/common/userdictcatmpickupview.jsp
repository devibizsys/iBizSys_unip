...
<% if(!p.init(pageContext,"/app/common/UserDictCatMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictCatMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictcatmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictCatPickupGridViewControllerBase.js?v=357_20171123142502' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatPickupGridViewController.js?v=357_20171123142502' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatMPickupViewControllerBase.js?v=357_20171123142502' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatMPickupViewController.js?v=357_20171123142502' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictCatMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
