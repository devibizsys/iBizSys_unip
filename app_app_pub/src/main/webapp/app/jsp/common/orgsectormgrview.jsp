...
<% if(!p.init(pageContext,"/app/common/OrgSectorMgrView.do")){return;}%>
...
<jsp:include page="../../templ/detreeexpview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorMgrView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectormgrview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSectorMgrViewControllerBase.js?v=1692_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSectorMgrViewController.js?v=1692_20171115095050' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSectorMgrViewController({appctx:'${ctx2}',webctx:'${web}'});
