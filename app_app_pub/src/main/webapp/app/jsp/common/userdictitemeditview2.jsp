...
<% if(!p.init(pageContext,"/app/common/UserDictItemEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictItemEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictitemeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictItemEditView2ControllerBase.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictItemEditView2Controller.js?v=459_20171123142256' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictItemEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
