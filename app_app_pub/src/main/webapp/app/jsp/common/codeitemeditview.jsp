...
<% if(!p.init(pageContext,"/app/common/CodeItemEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitemeditview_part.jsp"/>
...
<script src='${ctx}/js/common/CodeItemEditViewControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemEditViewController.js?v=453_20171123142328' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeItemEditViewController({appctx:'${ctx2}',webctx:'${web}'});
