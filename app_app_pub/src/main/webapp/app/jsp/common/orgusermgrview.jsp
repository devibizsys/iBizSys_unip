...
<% if(!p.init(pageContext,"/app/common/OrgUserMgrView.do")){return;}%>
...
<jsp:include page="../../templ/detreeexpview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserMgrView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgusermgrview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserMgrViewControllerBase.js?v=1692_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserMgrViewController.js?v=1692_20171115095050' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserMgrViewController({appctx:'${ctx2}',webctx:'${web}'});
