...
<% if(!p.init(pageContext,"/app/common/UserDGThemeEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDGThemeEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdgthemeeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserDGThemeEditView2ControllerBase.js?v=139_20171123142523' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDGThemeEditView2Controller.js?v=139_20171123142523' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDGThemeEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
