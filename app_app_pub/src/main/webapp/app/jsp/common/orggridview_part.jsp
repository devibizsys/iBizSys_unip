...
<%@include file="orggridview_userpart.jsp"%>
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="CONTROL.DEFSFITEM.ORG.N_ORGNAME_LIKE" text="组织机构名称(%)"></ibiz5:message></label>
</td>
<td>
<div class="col-md-12" >
