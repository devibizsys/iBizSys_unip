...
<% if(!p.init(pageContext,"/app/common/SysAdminEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadmineditview_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminEditViewControllerBase.js?v=338_20171123142116' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminEditViewController.js?v=338_20171123142116' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminEditViewController({appctx:'${ctx2}',webctx:'${web}'});
