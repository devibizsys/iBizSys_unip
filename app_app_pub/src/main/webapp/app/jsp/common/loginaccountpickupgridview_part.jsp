...
<%@include file="loginaccountpickupgridview_userpart.jsp"%>
...
<!-- 表单区:开始-->
 <div class="col-md-10 row">
  ...
  <DIV id='<%=strCId%>M4__fi' style=""  class=" col-md-4 form-group" data-ibiz-allowblank="1">
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >登录帐户(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_loginaccountname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
</DIV>
<DIV id='<%=strCId%>M5__fi' style=""  class=" col-md-4 form-group" data-ibiz-allowblank="1">
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
...
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M5_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="n_username_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
</DIV>
<DIV id='<%=strCId%>M6__fi' style=""  class=" col-md-4 form-group" data-ibiz-allowblank="1">
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >是否启用(=)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M6_c" style="width:100px;" ><SELECT id="<%=strCId%>M6" name="n_isenable_eq" class="form-control ibiz-field-dropdownlist"></SELECT></div>
</div>
</td>
</tr>
</table>
