...
<% if(!p.init(pageContext,"/app/common/UniResPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UniResPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/unirespickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UniResPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
