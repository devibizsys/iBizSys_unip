...
<% if(!p.init(pageContext,"/app/common/UserEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/usereditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserEditView2ControllerBase.js?v=1330_20171123142613' type='text/javascript'></script>
<script src='${ctx}/js/common/UserEditView2Controller.js?v=1330_20171123142613' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
