...
<% if(!p.init(pageContext,"/app/common/FileEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/FileEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/fileeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/FileEditView2ControllerBase.js?v=454_20171123142148' type='text/javascript'></script>
<script src='${ctx}/js/common/FileEditView2Controller.js?v=454_20171123142148' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new FileEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
