...
<% if(!p.init(pageContext,"/app/common/LoginAccountGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginAccountGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginaccountgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new LoginAccountGridViewController({appctx:'${ctx2}',webctx:'${web}'});
