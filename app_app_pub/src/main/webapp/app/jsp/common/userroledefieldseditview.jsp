...
<% if(!p.init(pageContext,"/app/common/UserRoleDEFieldsEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDEFieldsEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledefieldseditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDEFieldsEditViewControllerBase.js?v=429_20171123142510' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDEFieldsEditViewController.js?v=429_20171123142510' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDEFieldsEditViewController({appctx:'${ctx2}',webctx:'${web}'});
