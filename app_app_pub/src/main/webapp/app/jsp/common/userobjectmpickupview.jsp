...
<% if(!p.init(pageContext,"/app/common/UserObjectMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserObjectMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userobjectmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserObjectPickupGridViewControllerBase.js?v=588_20171123142216' type='text/javascript'></script>
<script src='${ctx}/js/common/UserObjectPickupGridViewController.js?v=588_20171123142216' type='text/javascript'></script>
<script src='${ctx}/js/common/UserObjectMPickupViewControllerBase.js?v=588_20171123142216' type='text/javascript'></script>
<script src='${ctx}/js/common/UserObjectMPickupViewController.js?v=588_20171123142216' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserObjectMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
