...
<% if(!p.init(pageContext,"/app/common/FileMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/FileMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/filempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/FilePickupGridViewControllerBase.js?v=454_20171123142148' type='text/javascript'></script>
<script src='${ctx}/js/common/FilePickupGridViewController.js?v=454_20171123142148' type='text/javascript'></script>
<script src='${ctx}/js/common/FileMPickupViewControllerBase.js?v=454_20171123142148' type='text/javascript'></script>
<script src='${ctx}/js/common/FileMPickupViewController.js?v=454_20171123142148' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new FileMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
