...
<% if(!p.init(pageContext,"/app/common/TSSDTaskEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskEditView2ControllerBase.js?v=479_20171123142622' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskEditView2Controller.js?v=479_20171123142622' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
