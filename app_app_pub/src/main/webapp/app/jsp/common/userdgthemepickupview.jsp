...
<% if(!p.init(pageContext,"/app/common/UserDGThemePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDGThemePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdgthemepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDGThemePickupViewControllerBase.js?v=139_20171123142523' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDGThemePickupViewController.js?v=139_20171123142523' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDGThemePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
