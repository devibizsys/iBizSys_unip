...
<% if(!p.init(pageContext,"/app/common/UniResEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UniResEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/unireseditview_part.jsp"/>
...
<script src='${ctx}/js/common/UniResEditViewControllerBase.js?v=371_20171123142421' type='text/javascript'></script>
<script src='${ctx}/js/common/UniResEditViewController.js?v=371_20171123142421' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UniResEditViewController({appctx:'${ctx2}',webctx:'${web}'});
