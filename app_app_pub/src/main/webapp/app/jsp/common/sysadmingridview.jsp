...
<% if(!p.init(pageContext,"/app/common/SysAdminGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadmingridview_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminGridViewControllerBase.js?v=338_20171123142116' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminGridViewController.js?v=338_20171123142116' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminGridViewController({appctx:'${ctx2}',webctx:'${web}'});
