...
<% if(!p.init(pageContext,"/app/common/CodeListEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeListEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/codelisteditview2_part.jsp"/>
...
<script src='${ctx}/js/common/CodeListEditView2ControllerBase.js?v=1595_20171123142418' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListEditView2Controller.js?v=1595_20171123142418' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeListEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
