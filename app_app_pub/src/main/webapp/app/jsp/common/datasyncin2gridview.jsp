...
<% if(!p.init(pageContext,"/app/common/DataSyncIn2GridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncIn2GridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncin2gridview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncIn2GridViewControllerBase.js?v=412_20171123142110' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncIn2GridViewController.js?v=412_20171123142110' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncIn2GridViewController({appctx:'${ctx2}',webctx:'${web}'});
