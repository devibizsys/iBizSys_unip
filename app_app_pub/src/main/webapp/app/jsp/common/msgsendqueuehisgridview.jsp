...
<% if(!p.init(pageContext,"/app/common/MsgSendQueueHisGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgSendQueueHisGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgsendqueuehisgridview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgSendQueueHisGridViewControllerBase.js?v=312_20171123142352' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgSendQueueHisGridViewController.js?v=312_20171123142352' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgSendQueueHisGridViewController({appctx:'${ctx2}',webctx:'${web}'});
