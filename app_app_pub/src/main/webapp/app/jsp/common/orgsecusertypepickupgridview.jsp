...
<% if(!p.init(pageContext,"/app/common/OrgSecUserTypePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserTypePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusertypepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSecUserTypePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
