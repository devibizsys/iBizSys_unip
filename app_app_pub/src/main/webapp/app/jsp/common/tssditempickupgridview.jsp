...
<% if(!p.init(pageContext,"/app/common/TSSDItemPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDItemPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssditempickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new TSSDItemPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
