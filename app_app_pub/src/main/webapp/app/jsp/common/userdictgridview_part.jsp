...
<%@include file="userdictgridview_userpart.jsp"%>
...
<!--分割符号-->
<button title="重新加载当前用户"  data-ibiz-tag="ReloadCurUser" data-ibiz-target="NONE"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >重新加载当前用户</span>  </button>  
<!--分割符号-->
<!--操作集合-->
<!--分割符号-->
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >用户词典名称(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_userdictname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
