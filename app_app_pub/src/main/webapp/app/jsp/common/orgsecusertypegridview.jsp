...
<% if(!p.init(pageContext,"/app/common/OrgSecUserTypeGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserTypeGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusertypegridview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserTypeGridViewControllerBase.js?v=971_20171123142310' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserTypeGridViewController.js?v=971_20171123142310' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserTypeGridViewController({appctx:'${ctx2}',webctx:'${web}'});
