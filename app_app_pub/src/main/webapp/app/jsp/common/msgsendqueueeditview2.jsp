...
<% if(!p.init(pageContext,"/app/common/MsgSendQueueEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgSendQueueEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgsendqueueeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/MsgSendQueueEditView2ControllerBase.js?v=321_20171123142222' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgSendQueueEditView2Controller.js?v=321_20171123142222' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgSendQueueEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
