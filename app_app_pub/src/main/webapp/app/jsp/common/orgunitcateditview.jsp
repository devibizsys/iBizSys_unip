...
<% if(!p.init(pageContext,"/app/common/OrgUnitCatEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUnitCatEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgunitcateditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUnitCatEditViewControllerBase.js?v=885_20171123142238' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUnitCatEditViewController.js?v=885_20171123142238' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUnitCatEditViewController({appctx:'${ctx2}',webctx:'${web}'});
