...
<% if(!p.init(pageContext,"/app/common/UserGroupEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergroupeditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserGroupEditViewControllerBase.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupEditViewController.js?v=184_20171123142323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGroupEditViewController({appctx:'${ctx2}',webctx:'${web}'});
