...
<% if(!p.init(pageContext,"/app/common/DataSyncOutEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOutEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncouteditview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOutEditViewControllerBase.js?v=384_20171123142506' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOutEditViewController.js?v=384_20171123142506' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOutEditViewController({appctx:'${ctx2}',webctx:'${web}'});
