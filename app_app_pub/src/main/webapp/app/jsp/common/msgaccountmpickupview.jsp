...
<% if(!p.init(pageContext,"/app/common/MsgAccountMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgAccountMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgaccountmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgAccountPickupGridViewControllerBase.js?v=1560_20171123142404' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountPickupGridViewController.js?v=1560_20171123142404' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountMPickupViewControllerBase.js?v=1560_20171123142404' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountMPickupViewController.js?v=1560_20171123142404' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgAccountMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
