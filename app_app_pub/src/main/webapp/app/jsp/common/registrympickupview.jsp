...
<% if(!p.init(pageContext,"/app/common/RegistryMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/RegistryMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/registrympickupview_part.jsp"/>
...
<script src='${ctx}/js/common/RegistryPickupGridViewControllerBase.js?v=177_20171123142346' type='text/javascript'></script>
<script src='${ctx}/js/common/RegistryPickupGridViewController.js?v=177_20171123142346' type='text/javascript'></script>
<script src='${ctx}/js/common/RegistryMPickupViewControllerBase.js?v=177_20171123142346' type='text/javascript'></script>
<script src='${ctx}/js/common/RegistryMPickupViewController.js?v=177_20171123142346' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new RegistryMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
