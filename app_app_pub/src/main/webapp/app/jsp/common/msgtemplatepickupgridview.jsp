...
<% if(!p.init(pageContext,"/app/common/MsgTemplatePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgTemplatePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgtemplatepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new MsgTemplatePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
