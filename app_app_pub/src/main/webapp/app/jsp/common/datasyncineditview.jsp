...
<% if(!p.init(pageContext,"/app/common/DataSyncInEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncInEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncineditview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncInEditViewControllerBase.js?v=364_20171123142229' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncInEditViewController.js?v=364_20171123142229' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncInEditViewController({appctx:'${ctx2}',webctx:'${web}'});
