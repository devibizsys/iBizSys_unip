...
<% if(!p.init(pageContext,"/app/common/DEDataChgMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgMPickupViewControllerBase.js?v=251_20171123142453' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgMPickupViewController.js?v=251_20171123142453' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
