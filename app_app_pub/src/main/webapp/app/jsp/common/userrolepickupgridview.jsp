...
<% if(!p.init(pageContext,"/app/common/UserRolePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRolePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRolePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
