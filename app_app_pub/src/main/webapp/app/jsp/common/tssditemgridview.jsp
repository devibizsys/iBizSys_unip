...
<% if(!p.init(pageContext,"/app/common/TSSDItemGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDItemGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssditemgridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDItemGridViewControllerBase.js?v=1796_20171123142400' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDItemGridViewController.js?v=1796_20171123142400' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDItemGridViewController({appctx:'${ctx2}',webctx:'${web}'});
