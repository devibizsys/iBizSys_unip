...
<% if(!p.init(pageContext,"/app/common/UserRoleTypeMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleTypeMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroletypempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleTypePickupGridViewControllerBase.js?v=342_20171123142616' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleTypePickupGridViewController.js?v=342_20171123142616' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleTypeMPickupViewControllerBase.js?v=342_20171123142616' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleTypeMPickupViewController.js?v=342_20171123142616' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleTypeMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
