...
<% if(!p.init(pageContext,"/app/common/OrgTypeEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgTypeEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgtypeeditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgTypeEditViewControllerBase.js?v=858_20171123142246' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgTypeEditViewController.js?v=858_20171123142246' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgTypeEditViewController({appctx:'${ctx2}',webctx:'${web}'});
