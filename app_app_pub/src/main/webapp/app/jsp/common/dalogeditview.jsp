...
<% if(!p.init(pageContext,"/app/common/DALogEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DALogEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dalogeditview_part.jsp"/>
...
<script src='${ctx}/js/common/DALogEditViewControllerBase.js?v=301_20171123142259' type='text/javascript'></script>
<script src='${ctx}/js/common/DALogEditViewController.js?v=301_20171123142259' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DALogEditViewController({appctx:'${ctx2}',webctx:'${web}'});
