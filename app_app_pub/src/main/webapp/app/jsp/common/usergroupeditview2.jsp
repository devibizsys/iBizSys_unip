...
<% if(!p.init(pageContext,"/app/common/UserGroupEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergroupeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserGroupEditView2ControllerBase.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupEditView2Controller.js?v=184_20171123142323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGroupEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
