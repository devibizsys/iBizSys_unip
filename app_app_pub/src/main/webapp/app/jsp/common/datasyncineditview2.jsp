...
<% if(!p.init(pageContext,"/app/common/DataSyncInEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncInEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncineditview2_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncInEditView2ControllerBase.js?v=364_20171123142229' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncInEditView2Controller.js?v=364_20171123142229' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncInEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
