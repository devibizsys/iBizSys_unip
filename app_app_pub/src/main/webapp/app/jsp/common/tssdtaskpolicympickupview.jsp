...
<% if(!p.init(pageContext,"/app/common/TSSDTaskPolicyMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskPolicyMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskpolicympickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskPolicyPickupGridViewControllerBase.js?v=425_20171123142411' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskPolicyPickupGridViewController.js?v=425_20171123142411' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskPolicyMPickupViewControllerBase.js?v=425_20171123142411' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskPolicyMPickupViewController.js?v=425_20171123142411' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskPolicyMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
