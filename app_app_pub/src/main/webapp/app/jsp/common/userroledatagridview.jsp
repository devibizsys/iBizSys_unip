...
<% if(!p.init(pageContext,"/app/common/UserRoleDataGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledatagridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleDataGridViewController({appctx:'${ctx2}',webctx:'${web}'});
