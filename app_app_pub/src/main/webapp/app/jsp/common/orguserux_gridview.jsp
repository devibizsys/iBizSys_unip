...
<% if(!p.init(pageContext,"/app/common/OrgUserUX_GridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserUX_GridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserux_gridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgUserUX_GridViewController({appctx:'${ctx2}',webctx:'${web}'});
