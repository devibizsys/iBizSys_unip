...
<% if(!p.init(pageContext,"/app/common/TSSDPolicyOwnerMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDPolicyOwnerMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdpolicyownermpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDPolicyOwnerPickupGridViewControllerBase.js?v=330_20171123142604' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyOwnerPickupGridViewController.js?v=330_20171123142604' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyOwnerMPickupViewControllerBase.js?v=330_20171123142604' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyOwnerMPickupViewController.js?v=330_20171123142604' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDPolicyOwnerMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
