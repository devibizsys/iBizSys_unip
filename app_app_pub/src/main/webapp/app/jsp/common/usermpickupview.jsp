...
<% if(!p.init(pageContext,"/app/common/UserMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usermpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserPickupGridViewControllerBase.js?v=1330_20171123142613' type='text/javascript'></script>
<script src='${ctx}/js/common/UserPickupGridViewController.js?v=1330_20171123142613' type='text/javascript'></script>
<script src='${ctx}/js/common/UserMPickupViewControllerBase.js?v=1330_20171123142613' type='text/javascript'></script>
<script src='${ctx}/js/common/UserMPickupViewController.js?v=1330_20171123142613' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
