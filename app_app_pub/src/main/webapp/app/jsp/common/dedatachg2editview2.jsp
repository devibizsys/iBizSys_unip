...
<% if(!p.init(pageContext,"/app/common/DEDataChg2EditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChg2EditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachg2editview2_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChg2EditView2ControllerBase.js?v=275_20171123142209' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChg2EditView2Controller.js?v=275_20171123142209' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChg2EditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
