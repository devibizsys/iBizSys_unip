...
<% if(!p.init(pageContext,"/app/common/MsgAccountPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgAccountPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgaccountpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgAccountPickupViewControllerBase.js?v=1560_20171123142404' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountPickupViewController.js?v=1560_20171123142404' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgAccountPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
