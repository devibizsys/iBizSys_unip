...
<% if(!p.init(pageContext,"/app/common/OrgSectorPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSectorPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
