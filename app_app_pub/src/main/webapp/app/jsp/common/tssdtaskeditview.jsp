...
<% if(!p.init(pageContext,"/app/common/TSSDTaskEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskEditViewControllerBase.js?v=479_20171123142622' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskEditViewController.js?v=479_20171123142622' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskEditViewController({appctx:'${ctx2}',webctx:'${web}'});
