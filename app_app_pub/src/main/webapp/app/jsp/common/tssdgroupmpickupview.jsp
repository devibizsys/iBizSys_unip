...
<% if(!p.init(pageContext,"/app/common/TSSDGroupMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgroupmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDGroupPickupGridViewControllerBase.js?v=345_20171123142606' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupPickupGridViewController.js?v=345_20171123142606' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupMPickupViewControllerBase.js?v=345_20171123142606' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupMPickupViewController.js?v=345_20171123142606' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDGroupMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
