...
<% if(!p.init(pageContext,"/app/common/OrgPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgPickupViewControllerBase.js?v=1692_20171115093119' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgPickupViewController.js?v=1692_20171115093119' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
