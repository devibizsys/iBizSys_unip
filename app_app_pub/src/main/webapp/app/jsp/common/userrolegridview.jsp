...
<% if(!p.init(pageContext,"/app/common/UserRoleGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolegridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleGridViewControllerBase.js?v=461_20171123142155' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleGridViewController.js?v=461_20171123142155' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleGridViewController({appctx:'${ctx2}',webctx:'${web}'});
