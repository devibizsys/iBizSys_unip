...
<% if(!p.init(pageContext,"/app/common/DEDataChg2GridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChg2GridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachg2gridview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChg2GridViewControllerBase.js?v=275_20171123142209' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChg2GridViewController.js?v=275_20171123142209' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChg2GridViewController({appctx:'${ctx2}',webctx:'${web}'});
