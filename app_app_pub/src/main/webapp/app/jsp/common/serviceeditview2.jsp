...
<% if(!p.init(pageContext,"/app/common/ServiceEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/ServiceEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/serviceeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/ServiceEditView2ControllerBase.js?v=462_20171123142113' type='text/javascript'></script>
<script src='${ctx}/js/common/ServiceEditView2Controller.js?v=462_20171123142113' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new ServiceEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
