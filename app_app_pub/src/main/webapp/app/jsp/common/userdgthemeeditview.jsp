...
<% if(!p.init(pageContext,"/app/common/UserDGThemeEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDGThemeEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdgthemeeditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDGThemeEditViewControllerBase.js?v=139_20171123142523' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDGThemeEditViewController.js?v=139_20171123142523' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDGThemeEditViewController({appctx:'${ctx2}',webctx:'${web}'});
