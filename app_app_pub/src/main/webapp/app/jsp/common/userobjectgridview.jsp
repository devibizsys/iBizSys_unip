...
<% if(!p.init(pageContext,"/app/common/UserObjectGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserObjectGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userobjectgridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserObjectGridViewControllerBase.js?v=588_20171123142216' type='text/javascript'></script>
<script src='${ctx}/js/common/UserObjectGridViewController.js?v=588_20171123142216' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserObjectGridViewController({appctx:'${ctx2}',webctx:'${web}'});
