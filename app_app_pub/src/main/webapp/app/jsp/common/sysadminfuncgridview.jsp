...
<% if(!p.init(pageContext,"/app/common/SysAdminFuncGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminFuncGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadminfuncgridview_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminFuncGridViewControllerBase.js?v=158_20171123142212' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminFuncGridViewController.js?v=158_20171123142212' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminFuncGridViewController({appctx:'${ctx2}',webctx:'${web}'});
