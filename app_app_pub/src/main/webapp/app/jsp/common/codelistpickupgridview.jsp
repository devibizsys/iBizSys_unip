...
<% if(!p.init(pageContext,"/app/common/CodeListPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeListPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codelistpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new CodeListPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
