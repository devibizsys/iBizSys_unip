...
<% if(!p.init(pageContext,"/app/common/PVPartPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PVPartPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/pvpartpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new PVPartPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
