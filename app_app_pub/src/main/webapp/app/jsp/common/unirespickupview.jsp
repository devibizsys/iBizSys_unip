...
<% if(!p.init(pageContext,"/app/common/UniResPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UniResPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/unirespickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UniResPickupViewControllerBase.js?v=371_20171123142421' type='text/javascript'></script>
<script src='${ctx}/js/common/UniResPickupViewController.js?v=371_20171123142421' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UniResPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
