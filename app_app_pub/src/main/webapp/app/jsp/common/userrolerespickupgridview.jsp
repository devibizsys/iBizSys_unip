...
<% if(!p.init(pageContext,"/app/common/UserRoleResPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleResPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolerespickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleResPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
