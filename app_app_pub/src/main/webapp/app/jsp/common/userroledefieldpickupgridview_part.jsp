...
<%@include file="userroledefieldpickupgridview_userpart.jsp"%>
...
<INPUT type="hidden" name="n_deid_eq" id="<%=strCId%>M4">
  <DIV id='<%=strCId%>M5__fi' style=""  class=" col-md-12 form-group" data-ibiz-allowblank="1">
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >实体属性访问能力(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M5_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="n_userroledefieldname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
