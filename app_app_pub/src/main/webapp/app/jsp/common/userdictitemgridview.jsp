...
<% if(!p.init(pageContext,"/app/common/UserDictItemGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictItemGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictitemgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserDictItemGridViewController({appctx:'${ctx2}',webctx:'${web}'});
