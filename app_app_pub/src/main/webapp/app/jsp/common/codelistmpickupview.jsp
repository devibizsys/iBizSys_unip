...
<% if(!p.init(pageContext,"/app/common/CodeListMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeListMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codelistmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/CodeListPickupGridViewControllerBase.js?v=1595_20171123142418' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListPickupGridViewController.js?v=1595_20171123142418' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListMPickupViewControllerBase.js?v=1595_20171123142418' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListMPickupViewController.js?v=1595_20171123142418' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeListMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
