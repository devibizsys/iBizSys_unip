...
<% if(!p.init(pageContext,"/app/common/OrgSectorSpecOrgXJBMGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorSpecOrgXJBMGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorspecorgxjbmgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSectorSpecOrgXJBMGridViewController({appctx:'${ctx2}',webctx:'${web}'});
