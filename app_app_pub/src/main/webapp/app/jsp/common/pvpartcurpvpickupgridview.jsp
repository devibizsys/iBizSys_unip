...
<% if(!p.init(pageContext,"/app/common/PVPartCurPVPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PVPartCurPVPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/pvpartcurpvpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new PVPartCurPVPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
