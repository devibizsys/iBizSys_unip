...
<%@include file="usergroupeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M15"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M14"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M13"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M12"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M11"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M10"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>Mf"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Me">
...
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >用户组标识</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M5_c" style="" >
<input type="text" class="form-control text ibiz-field-span" readonly="readonly" name="usergroupid" id="<%=strCId%>M5"  >
</div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
        ...
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="usergroupname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
