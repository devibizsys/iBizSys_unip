...
<% if(!p.init(pageContext,"/app/common/DataSyncInMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncInMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncinmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncInPickupGridViewControllerBase.js?v=364_20171123142229' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncInPickupGridViewController.js?v=364_20171123142229' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncInMPickupViewControllerBase.js?v=364_20171123142229' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncInMPickupViewController.js?v=364_20171123142229' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncInMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
