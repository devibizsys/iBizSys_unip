...
<% if(!p.init(pageContext,"/app/common/CodeItemGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitemgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new CodeItemGridViewController({appctx:'${ctx2}',webctx:'${web}'});
