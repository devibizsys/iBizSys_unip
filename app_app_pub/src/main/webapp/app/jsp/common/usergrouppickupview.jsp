...
<% if(!p.init(pageContext,"/app/common/UserGroupPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergrouppickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserGroupPickupViewControllerBase.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupPickupViewController.js?v=184_20171123142323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGroupPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
