...
<% if(!p.init(pageContext,"/app/common/UniResGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UniResGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/uniresgridview_part.jsp"/>
...
<script src='${ctx}/js/common/UniResGridViewControllerBase.js?v=371_20171123142421' type='text/javascript'></script>
<script src='${ctx}/js/common/UniResGridViewController.js?v=371_20171123142421' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UniResGridViewController({appctx:'${ctx2}',webctx:'${web}'});
