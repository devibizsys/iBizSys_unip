...
<% if(!p.init(pageContext,"/app/common/TSSDPolicyOwnerGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDPolicyOwnerGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdpolicyownergridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDPolicyOwnerGridViewControllerBase.js?v=330_20171123142604' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyOwnerGridViewController.js?v=330_20171123142604' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDPolicyOwnerGridViewController({appctx:'${ctx2}',webctx:'${web}'});
