...
<% if(!p.init(pageContext,"/app/common/UserRoleTypePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleTypePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroletypepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleTypePickupViewControllerBase.js?v=342_20171123142616' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleTypePickupViewController.js?v=342_20171123142616' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleTypePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
