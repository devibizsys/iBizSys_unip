...
<% if(!p.init(pageContext,"/app/common/UserRoleDEFieldGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDEFieldGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledefieldgridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDEFieldGridViewControllerBase.js?v=458_20171123142125' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDEFieldGridViewController.js?v=458_20171123142125' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDEFieldGridViewController({appctx:'${ctx2}',webctx:'${web}'});
