...
<% if(!p.init(pageContext,"/app/common/OrgSecUserGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusergridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSecUserGridViewController({appctx:'${ctx2}',webctx:'${web}'});
