...
<% if(!p.init(pageContext,"/app/common/UserRoleDatasEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDatasEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataseditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDatasEditViewControllerBase.js?v=436_20171123142450' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDatasEditViewController.js?v=436_20171123142450' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDatasEditViewController({appctx:'${ctx2}',webctx:'${web}'});
