...
<% if(!p.init(pageContext,"/app/common/PortalPageGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PortalPageGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/portalpagegridview_part.jsp"/>
...
<script src='${ctx}/js/common/PortalPageGridViewControllerBase.js?v=165_20171123142619' type='text/javascript'></script>
<script src='${ctx}/js/common/PortalPageGridViewController.js?v=165_20171123142619' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PortalPageGridViewController({appctx:'${ctx2}',webctx:'${web}'});
