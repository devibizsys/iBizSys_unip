...
<% if(!p.init(pageContext,"/app/common/UserDictItemPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictItemPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictitempickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserDictItemPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
