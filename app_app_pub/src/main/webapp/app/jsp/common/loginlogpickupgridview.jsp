...
<% if(!p.init(pageContext,"/app/common/LoginLogPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginLogPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginlogpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new LoginLogPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
