...
<% if(!p.init(pageContext,"/app/common/DataSyncIn2PickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncIn2PickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncin2pickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncIn2PickupViewControllerBase.js?v=412_20171123142110' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncIn2PickupViewController.js?v=412_20171123142110' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncIn2PickupViewController({appctx:'${ctx2}',webctx:'${web}'});
