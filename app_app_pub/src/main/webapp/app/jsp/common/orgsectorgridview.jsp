...
<% if(!p.init(pageContext,"/app/common/OrgSectorGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSectorGridViewController({appctx:'${ctx2}',webctx:'${web}'});
