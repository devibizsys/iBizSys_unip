...
<% if(!p.init(pageContext,"/app/common/UserRoleDataPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledatapickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleDataPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
