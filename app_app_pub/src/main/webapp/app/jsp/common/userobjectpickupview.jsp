...
<% if(!p.init(pageContext,"/app/common/UserObjectPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserObjectPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userobjectpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserObjectPickupViewControllerBase.js?v=588_20171123142216' type='text/javascript'></script>
<script src='${ctx}/js/common/UserObjectPickupViewController.js?v=588_20171123142216' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserObjectPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
