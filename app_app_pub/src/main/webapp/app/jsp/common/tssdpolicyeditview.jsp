...
<% if(!p.init(pageContext,"/app/common/TSSDPolicyEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDPolicyEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdpolicyeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDPolicyEditViewControllerBase.js?v=395_20171123142118' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyEditViewController.js?v=395_20171123142118' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDPolicyEditViewController({appctx:'${ctx2}',webctx:'${web}'});
