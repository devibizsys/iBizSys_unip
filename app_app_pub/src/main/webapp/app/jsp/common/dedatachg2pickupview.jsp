...
<% if(!p.init(pageContext,"/app/common/DEDataChg2PickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChg2PickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachg2pickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChg2PickupViewControllerBase.js?v=275_20171123142209' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChg2PickupViewController.js?v=275_20171123142209' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChg2PickupViewController({appctx:'${ctx2}',webctx:'${web}'});
