...
<% if(!p.init(pageContext,"/app/common/MsgTemplatePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgTemplatePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgtemplatepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgTemplatePickupViewControllerBase.js?v=563_20171123142529' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgTemplatePickupViewController.js?v=563_20171123142529' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgTemplatePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
