...
<% if(!p.init(pageContext,"/app/common/DataSyncOut2GridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOut2GridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncout2gridview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOut2GridViewControllerBase.js?v=290_20171123142151' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOut2GridViewController.js?v=290_20171123142151' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOut2GridViewController({appctx:'${ctx2}',webctx:'${web}'});
