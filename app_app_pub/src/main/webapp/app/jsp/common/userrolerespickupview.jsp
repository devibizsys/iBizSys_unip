...
<% if(!p.init(pageContext,"/app/common/UserRoleResPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleResPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolerespickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleResPickupViewControllerBase.js?v=474_20171123142601' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleResPickupViewController.js?v=474_20171123142601' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleResPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
