...
<% if(!p.init(pageContext,"/app/common/FileGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/FileGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/filegridview_part.jsp"/>
...
<script src='${ctx}/js/common/FileGridViewControllerBase.js?v=454_20171123142148' type='text/javascript'></script>
<script src='${ctx}/js/common/FileGridViewController.js?v=454_20171123142148' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new FileGridViewController({appctx:'${ctx2}',webctx:'${web}'});
