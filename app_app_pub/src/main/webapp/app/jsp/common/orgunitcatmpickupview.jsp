...
<% if(!p.init(pageContext,"/app/common/OrgUnitCatMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUnitCatMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgunitcatmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUnitCatPickupGridViewControllerBase.js?v=885_20171123142238' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUnitCatPickupGridViewController.js?v=885_20171123142238' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUnitCatMPickupViewControllerBase.js?v=885_20171123142238' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUnitCatMPickupViewController.js?v=885_20171123142238' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUnitCatMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
