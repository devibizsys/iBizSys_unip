...
<% if(!p.init(pageContext,"/app/common/OrgUserPickupGridView3.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserPickupGridView3.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserpickupgridview3_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgUserPickupGridView3Controller({appctx:'${ctx2}',webctx:'${web}'});
