...
<% if(!p.init(pageContext,"/app/common/OrgSecUserEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusereditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserEditViewControllerBase.js?v=1186_20171123142433' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserEditViewController.js?v=1186_20171123142433' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserEditViewController({appctx:'${ctx2}',webctx:'${web}'});
