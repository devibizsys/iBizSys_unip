...
<% if(!p.init(pageContext,"/app/common/SystemEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SystemEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/systemeditview_part.jsp"/>
...
<script src='${ctx}/js/common/SystemEditViewControllerBase.js?v=174_20171123142520' type='text/javascript'></script>
<script src='${ctx}/js/common/SystemEditViewController.js?v=174_20171123142520' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SystemEditViewController({appctx:'${ctx2}',webctx:'${web}'});
