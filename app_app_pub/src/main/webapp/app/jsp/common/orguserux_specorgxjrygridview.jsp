...
<% if(!p.init(pageContext,"/app/common/OrgUserUX_SpecOrgXJRYGridView.do")){return;}%>
...
<%}%>
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserUX_SpecOrgXJRYGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserux_specorgxjrygridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgUserUX_SpecOrgXJRYGridViewController({appctx:'${ctx2}',webctx:'${web}'});
