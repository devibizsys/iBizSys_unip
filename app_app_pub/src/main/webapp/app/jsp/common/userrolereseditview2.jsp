...
<% if(!p.init(pageContext,"/app/common/UserRoleResEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleResEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolereseditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleResEditView2ControllerBase.js?v=474_20171123142601' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleResEditView2Controller.js?v=474_20171123142601' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleResEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
