...
<% if(!p.init(pageContext,"/app/common/MsgTemplateEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgTemplateEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgtemplateeditview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgTemplateEditViewControllerBase.js?v=563_20171123142529' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgTemplateEditViewController.js?v=563_20171123142529' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgTemplateEditViewController({appctx:'${ctx2}',webctx:'${web}'});
