...
<% if(!p.init(pageContext,"/app/common/UserRoleDatasMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDatasMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledatasmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDatasPickupGridViewControllerBase.js?v=436_20171123142450' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDatasPickupGridViewController.js?v=436_20171123142450' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDatasMPickupViewControllerBase.js?v=436_20171123142450' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDatasMPickupViewController.js?v=436_20171123142450' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDatasMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
