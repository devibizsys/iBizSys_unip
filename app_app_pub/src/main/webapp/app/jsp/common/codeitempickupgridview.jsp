...
<% if(!p.init(pageContext,"/app/common/CodeItemPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitempickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new CodeItemPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
