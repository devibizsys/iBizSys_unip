...
<% if(!p.init(pageContext,"/app/common/DataSyncAgentGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncAgentGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncagentgridview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncAgentGridViewControllerBase.js?v=436_20171123142556' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncAgentGridViewController.js?v=436_20171123142556' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncAgentGridViewController({appctx:'${ctx2}',webctx:'${web}'});
