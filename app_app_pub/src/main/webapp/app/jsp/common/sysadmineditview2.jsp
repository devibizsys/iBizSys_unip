...
<% if(!p.init(pageContext,"/app/common/SysAdminEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadmineditview2_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminEditView2ControllerBase.js?v=338_20171123142116' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminEditView2Controller.js?v=338_20171123142116' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
