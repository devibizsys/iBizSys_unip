...
<%@include file="orgsecusereditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M1d"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M1c"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M1b"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M1a"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M19"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M18"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M17"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M16"><INPUT type="hidden" name="orguserid" id="<%=strCId%>M11"><INPUT type="hidden" name="orgsectorid" id="<%=strCId%>M12"><INPUT type="hidden" name="orgsecusertypeid" id="<%=strCId%>M13"><INPUT type="hidden" name="orgid" id="<%=strCId%>M14"><INPUT type="hidden" name="orgsecuserid" id="<%=strCId%>M15">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>组织部门人员信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >组织机构</label>
	</div>
...
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >组织部门</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >组织人员</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			<span class="toggle fa fa-search"></span>
			<input type="text" class="form-control text" name="orgusername" id="<%=strCId%>M7" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
...
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >组织部门人员名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M8_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M8" name="orgsecusername" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<div id='<%=strCId%>Ma__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Ma__lb' class="control-label" style="width:130px;"  >默认关系</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Ma_c" style="width:100px;" ><SELECT id="<%=strCId%>Ma" name="defaultflag" class="form-control ibiz-field-dropdownlist"></SELECT></div>
	</div>
</div>
</div>
</fieldset>
