...
<% if(!p.init(pageContext,"/app/common/UserObjectPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserObjectPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userobjectpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserObjectPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
