...
<% if(!p.init(pageContext,"/app/common/UserDGThemePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDGThemePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdgthemepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserDGThemePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
