...
<% if(!p.init(pageContext,"/app/common/MsgAccountPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgAccountPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgaccountpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new MsgAccountPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
