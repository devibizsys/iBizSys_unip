...
<% if(!p.init(pageContext,"/app/common/OrgSectorEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectoreditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSectorEditViewControllerBase.js?v=1797_20171115093216' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSectorEditViewController.js?v=1797_20171115093216' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSectorEditViewController({appctx:'${ctx2}',webctx:'${web}'});
