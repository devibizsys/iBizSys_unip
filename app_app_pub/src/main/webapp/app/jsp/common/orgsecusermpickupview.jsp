...
<% if(!p.init(pageContext,"/app/common/OrgSecUserMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusermpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserPickupGridViewControllerBase.js?v=1186_20171123142433' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserPickupGridViewController.js?v=1186_20171123142433' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserMPickupViewControllerBase.js?v=1186_20171123142433' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserMPickupViewController.js?v=1186_20171123142433' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
