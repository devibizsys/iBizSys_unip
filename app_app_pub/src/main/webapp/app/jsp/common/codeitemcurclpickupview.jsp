...
<% if(!p.init(pageContext,"/app/common/CodeItemCurCLPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemCurCLPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitemcurclpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/CodeItemCurCLPickupGridViewControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemCurCLPickupGridViewController.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemCurCLPickupViewControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemCurCLPickupViewController.js?v=453_20171123142328' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeItemCurCLPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
