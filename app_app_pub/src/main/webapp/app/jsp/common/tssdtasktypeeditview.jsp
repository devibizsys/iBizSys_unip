...
<% if(!p.init(pageContext,"/app/common/TSSDTaskTypeEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskTypeEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtasktypeeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskTypeEditViewControllerBase.js?v=327_20171123142252' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskTypeEditViewController.js?v=327_20171123142252' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskTypeEditViewController({appctx:'${ctx2}',webctx:'${web}'});
