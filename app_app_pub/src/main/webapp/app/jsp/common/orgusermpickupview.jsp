...
<% if(!p.init(pageContext,"/app/common/OrgUserMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgusermpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserMPickupViewControllerBase.js?v=1332_20171123142205' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserMPickupViewController.js?v=1332_20171123142205' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
