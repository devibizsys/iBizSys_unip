...
<% if(!p.init(pageContext,"/app/common/TSSDPolicyOwnerEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDPolicyOwnerEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdpolicyownereditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDPolicyOwnerEditViewControllerBase.js?v=330_20171123142604' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyOwnerEditViewController.js?v=330_20171123142604' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDPolicyOwnerEditViewController({appctx:'${ctx2}',webctx:'${web}'});
