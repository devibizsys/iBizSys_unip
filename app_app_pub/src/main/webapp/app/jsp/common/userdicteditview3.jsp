...
<% if(!p.init(pageContext,"/app/common/UserDictEditView3.do")){return;}%>
...
<jsp:include page="../../templ/deeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdicteditview3_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictEditView3ControllerBase.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictEditView3Controller.js?v=395_20171123142516' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
