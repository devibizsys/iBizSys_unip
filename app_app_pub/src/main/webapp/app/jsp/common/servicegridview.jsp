...
<% if(!p.init(pageContext,"/app/common/ServiceGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/ServiceGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/servicegridview_part.jsp"/>
...
<script src='${ctx}/js/common/ServiceGridViewControllerBase.js?v=462_20171123142113' type='text/javascript'></script>
<script src='${ctx}/js/common/ServiceGridViewController.js?v=462_20171123142113' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new ServiceGridViewController({appctx:'${ctx2}',webctx:'${web}'});
