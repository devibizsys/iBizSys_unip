...
<% if(!p.init(pageContext,"/app/common/UniResEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UniResEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/unireseditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UniResEditView2ControllerBase.js?v=371_20171123142421' type='text/javascript'></script>
<script src='${ctx}/js/common/UniResEditView2Controller.js?v=371_20171123142421' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UniResEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
