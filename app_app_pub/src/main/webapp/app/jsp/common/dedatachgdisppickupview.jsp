...
<% if(!p.init(pageContext,"/app/common/DEDataChgDispPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgDispPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgdisppickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgDispPickupViewControllerBase.js?v=237_20171123142302' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgDispPickupViewController.js?v=237_20171123142302' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgDispPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
