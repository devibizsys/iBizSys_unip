...
<% if(!p.init(pageContext,"/app/common/OrgSectorPickupGridView2.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorPickupGridView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorpickupgridview2_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSectorPickupGridView2Controller({appctx:'${ctx2}',webctx:'${web}'});
