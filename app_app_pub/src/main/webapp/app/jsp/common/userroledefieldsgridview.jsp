...
<% if(!p.init(pageContext,"/app/common/UserRoleDEFieldsGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDEFieldsGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledefieldsgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleDEFieldsGridViewController({appctx:'${ctx2}',webctx:'${web}'});
