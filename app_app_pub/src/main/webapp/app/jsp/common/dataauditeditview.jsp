...
<% if(!p.init(pageContext,"/app/common/DataAuditEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataAuditEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dataauditeditview_part.jsp"/>
...
<script src='${ctx}/js/common/DataAuditEditViewControllerBase.js?v=381_20171123142225' type='text/javascript'></script>
<script src='${ctx}/js/common/DataAuditEditViewController.js?v=381_20171123142225' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataAuditEditViewController({appctx:'${ctx2}',webctx:'${web}'});
