...
<% if(!p.init(pageContext,"/app/common/OrgTypeMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgTypeMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgtypempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgTypePickupGridViewControllerBase.js?v=858_20171123142246' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgTypePickupGridViewController.js?v=858_20171123142246' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgTypeMPickupViewControllerBase.js?v=858_20171123142246' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgTypeMPickupViewController.js?v=858_20171123142246' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgTypeMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
