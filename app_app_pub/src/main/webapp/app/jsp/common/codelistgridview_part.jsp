...
<%@include file="codelistgridview_userpart.jsp"%>
...
<!--分割符号-->
<button title="刷新"  data-ibiz-tag="RefreshModel" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >刷新</span>  </button>  
<!--分割符号-->
<!--操作集合-->
<!--分割符号-->
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >代码表名称(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_codelistname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
