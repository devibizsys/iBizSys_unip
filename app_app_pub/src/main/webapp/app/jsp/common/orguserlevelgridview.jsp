...
<% if(!p.init(pageContext,"/app/common/OrgUserLevelGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserLevelGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserlevelgridview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserLevelGridViewControllerBase.js?v=920_20171123142550' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserLevelGridViewController.js?v=920_20171123142550' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserLevelGridViewController({appctx:'${ctx2}',webctx:'${web}'});
