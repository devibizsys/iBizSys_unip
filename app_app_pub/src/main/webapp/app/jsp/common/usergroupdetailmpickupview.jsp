...
<% if(!p.init(pageContext,"/app/common/UserGroupDetailMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupDetailMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergroupdetailmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserGroupDetailPickupGridViewControllerBase.js?v=167_20171123142249' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupDetailPickupGridViewController.js?v=167_20171123142249' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupDetailMPickupViewControllerBase.js?v=167_20171123142250' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupDetailMPickupViewController.js?v=167_20171123142250' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGroupDetailMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
