...
<% if(!p.init(pageContext,"/app/common/UserGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserGridViewControllerBase.js?v=1330_20171123142613' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGridViewController.js?v=1330_20171123142613' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGridViewController({appctx:'${ctx2}',webctx:'${web}'});
