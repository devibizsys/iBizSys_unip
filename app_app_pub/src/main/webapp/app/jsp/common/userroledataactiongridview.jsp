...
<% if(!p.init(pageContext,"/app/common/UserRoleDataActionGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataActionGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataactiongridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleDataActionGridViewController({appctx:'${ctx2}',webctx:'${web}'});
