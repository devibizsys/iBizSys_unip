...
<% if(!p.init(pageContext,"/app/common/UserDictCatGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictCatGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictcatgridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictCatGridViewControllerBase.js?v=357_20171123142502' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatGridViewController.js?v=357_20171123142502' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictCatGridViewController({appctx:'${ctx2}',webctx:'${web}'});
