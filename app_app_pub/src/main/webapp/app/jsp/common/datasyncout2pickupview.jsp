...
<% if(!p.init(pageContext,"/app/common/DataSyncOut2PickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOut2PickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncout2pickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOut2PickupViewControllerBase.js?v=290_20171123142151' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOut2PickupViewController.js?v=290_20171123142151' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOut2PickupViewController({appctx:'${ctx2}',webctx:'${web}'});
