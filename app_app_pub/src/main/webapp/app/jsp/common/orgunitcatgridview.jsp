...
<% if(!p.init(pageContext,"/app/common/OrgUnitCatGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUnitCatGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgunitcatgridview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUnitCatGridViewControllerBase.js?v=885_20171123142238' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUnitCatGridViewController.js?v=885_20171123142238' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUnitCatGridViewController({appctx:'${ctx2}',webctx:'${web}'});
