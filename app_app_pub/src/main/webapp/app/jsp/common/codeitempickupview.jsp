...
<% if(!p.init(pageContext,"/app/common/CodeItemPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/CodeItemPickupViewControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemPickupViewController.js?v=453_20171123142328' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeItemPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
