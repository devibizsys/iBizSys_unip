...
<% if(!p.init(pageContext,"/app/common/TSSDTaskGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskgridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskGridViewControllerBase.js?v=479_20171123142622' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskGridViewController.js?v=479_20171123142622' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskGridViewController({appctx:'${ctx2}',webctx:'${web}'});
