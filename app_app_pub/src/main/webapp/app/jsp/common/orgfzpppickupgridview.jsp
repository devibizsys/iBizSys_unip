...
<% if(!p.init(pageContext,"/app/common/OrgFZPPPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgFZPPPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgfzpppickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgFZPPPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
