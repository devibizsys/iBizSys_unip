...
<% if(!p.init(pageContext,"/app/common/TSSDPolicyGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDPolicyGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdpolicygridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDPolicyGridViewControllerBase.js?v=395_20171123142118' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDPolicyGridViewController.js?v=395_20171123142118' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDPolicyGridViewController({appctx:'${ctx2}',webctx:'${web}'});
