...
<% if(!p.init(pageContext,"/app/common/TSSDEngineEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDEngineEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdengineeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDEngineEditViewControllerBase.js?v=377_20171123142542' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDEngineEditViewController.js?v=377_20171123142542' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDEngineEditViewController({appctx:'${ctx2}',webctx:'${web}'});
