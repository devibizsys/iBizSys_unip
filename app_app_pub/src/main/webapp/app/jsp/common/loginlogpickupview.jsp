...
<% if(!p.init(pageContext,"/app/common/LoginLogPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginLogPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginlogpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/LoginLogPickupViewControllerBase.js?v=150_20171123142356' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginLogPickupViewController.js?v=150_20171123142356' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new LoginLogPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
