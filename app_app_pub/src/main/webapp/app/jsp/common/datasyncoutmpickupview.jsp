...
<% if(!p.init(pageContext,"/app/common/DataSyncOutMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOutMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncoutmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOutPickupGridViewControllerBase.js?v=384_20171123142506' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOutPickupGridViewController.js?v=384_20171123142506' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOutMPickupViewControllerBase.js?v=384_20171123142506' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOutMPickupViewController.js?v=384_20171123142506' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOutMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
