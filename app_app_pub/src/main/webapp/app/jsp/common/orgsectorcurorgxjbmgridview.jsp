...
<% if(!p.init(pageContext,"/app/common/OrgSectorCurOrgXJBMGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorCurOrgXJBMGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorcurorgxjbmgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSectorCurOrgXJBMGridViewController({appctx:'${ctx2}',webctx:'${web}'});
