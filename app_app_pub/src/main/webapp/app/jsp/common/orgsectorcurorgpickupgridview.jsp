...
<% if(!p.init(pageContext,"/app/common/OrgSectorCurOrgPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorCurOrgPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorcurorgpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSectorCurOrgPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
