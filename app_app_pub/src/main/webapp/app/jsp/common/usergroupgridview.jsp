...
<% if(!p.init(pageContext,"/app/common/UserGroupGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserGroupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/usergroupgridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserGroupGridViewControllerBase.js?v=184_20171123142323' type='text/javascript'></script>
<script src='${ctx}/js/common/UserGroupGridViewController.js?v=184_20171123142323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserGroupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
