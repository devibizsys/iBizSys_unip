...
<% if(!p.init(pageContext,"/app/common/GG_DBPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/GG_DBPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/gg_dbpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/GG_DBPickupViewControllerBase.js?v=330_20171119152152' type='text/javascript'></script>
<script src='${ctx}/js/common/GG_DBPickupViewController.js?v=330_20171119152152' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new GG_DBPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
