...
<% if(!p.init(pageContext,"/app/common/LoginAccountPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginAccountPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginaccountpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new LoginAccountPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
