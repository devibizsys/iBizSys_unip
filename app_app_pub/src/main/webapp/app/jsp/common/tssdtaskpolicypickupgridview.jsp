...
<% if(!p.init(pageContext,"/app/common/TSSDTaskPolicyPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskPolicyPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtaskpolicypickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new TSSDTaskPolicyPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
