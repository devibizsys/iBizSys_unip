...
<% if(!p.init(pageContext,"/app/common/OrgSectorPickupView2.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSectorPickupView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsectorpickupview2_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSectorPickupGridView2ControllerBase.js?v=1797_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSectorPickupGridView2Controller.js?v=1797_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSectorPickupView2ControllerBase.js?v=1797_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSectorPickupView2Controller.js?v=1797_20171115095050' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSectorPickupView2Controller({appctx:'${ctx2}',webctx:'${web}'});
