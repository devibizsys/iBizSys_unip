...
<% if(!p.init(pageContext,"/app/common/UserRoleResGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleResGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroleresgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleResGridViewController({appctx:'${ctx2}',webctx:'${web}'});
