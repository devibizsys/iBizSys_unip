...
<% if(!p.init(pageContext,"/app/common/FilePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/FilePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/filepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new FilePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
