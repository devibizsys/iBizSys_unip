...
<% if(!p.init(pageContext,"/app/common/DataSyncOutEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOutEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncouteditview2_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOutEditView2ControllerBase.js?v=384_20171123142506' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOutEditView2Controller.js?v=384_20171123142506' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOutEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
