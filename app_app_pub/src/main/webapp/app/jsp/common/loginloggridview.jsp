...
<% if(!p.init(pageContext,"/app/common/LoginLogGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginLogGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginloggridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new LoginLogGridViewController({appctx:'${ctx2}',webctx:'${web}'});
