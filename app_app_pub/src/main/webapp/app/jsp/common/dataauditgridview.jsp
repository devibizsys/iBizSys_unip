...
<% if(!p.init(pageContext,"/app/common/DataAuditGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataAuditGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dataauditgridview_part.jsp"/>
...
<script src='${ctx}/js/common/DataAuditGridViewControllerBase.js?v=381_20171123142225' type='text/javascript'></script>
<script src='${ctx}/js/common/DataAuditGridViewController.js?v=381_20171123142225' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataAuditGridViewController({appctx:'${ctx2}',webctx:'${web}'});
