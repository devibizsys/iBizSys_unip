...
<% if(!p.init(pageContext,"/app/common/DataAuditEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataAuditEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/dataauditeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/DataAuditEditView2ControllerBase.js?v=381_20171123142225' type='text/javascript'></script>
<script src='${ctx}/js/common/DataAuditEditView2Controller.js?v=381_20171123142225' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataAuditEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
