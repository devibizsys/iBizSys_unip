...
<% if(!p.init(pageContext,"/app/common/UserRoleDataActionMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataActionMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataactionmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDataActionPickupGridViewControllerBase.js?v=358_20171123142122' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataActionPickupGridViewController.js?v=358_20171123142122' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataActionMPickupViewControllerBase.js?v=358_20171123142122' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataActionMPickupViewController.js?v=358_20171123142122' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataActionMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
