...
<% if(!p.init(pageContext,"/app/common/OrgUserGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgusergridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgUserGridViewController({appctx:'${ctx2}',webctx:'${web}'});
