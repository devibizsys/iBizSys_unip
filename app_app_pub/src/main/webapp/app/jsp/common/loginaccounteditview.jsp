...
<% if(!p.init(pageContext,"/app/common/LoginAccountEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/LoginAccountEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/loginaccounteditview_part.jsp"/>
...
<script src='${ctx}/js/common/LoginAccountEditViewControllerBase.js?v=222_20171123142315' type='text/javascript'></script>
<script src='${ctx}/js/common/LoginAccountEditViewController.js?v=222_20171123142315' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new LoginAccountEditViewController({appctx:'${ctx2}',webctx:'${web}'});
