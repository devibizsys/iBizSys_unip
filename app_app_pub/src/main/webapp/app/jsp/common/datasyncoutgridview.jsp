...
<% if(!p.init(pageContext,"/app/common/DataSyncOutGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOutGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncoutgridview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOutGridViewControllerBase.js?v=384_20171123142506' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOutGridViewController.js?v=384_20171123142506' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOutGridViewController({appctx:'${ctx2}',webctx:'${web}'});
