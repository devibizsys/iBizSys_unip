...
<%@include file="orguserux_editview_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M1f"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M1e"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M1d"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M1c"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M1b"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M1a"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M19"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M18"><INPUT type="hidden" name="userdata" id="<%=strCId%>M13"><INPUT type="hidden" name="orgsectorid" id="<%=strCId%>M15"><INPUT type="hidden" name="orgsecusertypeid" id="<%=strCId%>M16"><INPUT type="hidden" name="orguserlevelid" id="<%=strCId%>M17">
...
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >组织人员标识</label>
	</div>
...
<div class="radio-list ibiz-field-radiobuttonlist"  id="<%=strCId%>Ma" name="reserver5"></div>
</div>
	</div>
</div>
...
<div id='<%=strCId%>Me__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Me__lb' class="control-label" style="width:130px;"  >邮箱地址</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Me_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Me" name="reserver6" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>Mf__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mf__lb' class="control-label" style="width:130px;"  >人员排序</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Mf_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Mf" name="ordervalue" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M10__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M10__lb' class="control-label" style="width:130px;"  >工号</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M10_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M10" name="usercode" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M11__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M11__lb' class="control-label" style="width:130px;"  >手机号码</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M11_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M11" name="reserver30" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M12__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M12__lb' class="control-label" style="width:130px;"  >工作证号</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M12_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M12" name="reserver4" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
</div>
<div id='<%=strCId%>M14__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M14__lb' class="control-label" style="width:130px;"  >备注</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M14_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>M14" name="memo"  type="text"  class="form-control" ></textarea>
