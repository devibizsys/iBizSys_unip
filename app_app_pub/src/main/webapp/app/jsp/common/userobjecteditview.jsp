...
<% if(!p.init(pageContext,"/app/common/UserObjectEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserObjectEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userobjecteditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserObjectEditViewControllerBase.js?v=588_20171123142216' type='text/javascript'></script>
<script src='${ctx}/js/common/UserObjectEditViewController.js?v=588_20171123142216' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserObjectEditViewController({appctx:'${ctx2}',webctx:'${web}'});
