...
<% if(!p.init(pageContext,"/app/common/RegistryEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/RegistryEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/registryeditview_part.jsp"/>
...
<script src='${ctx}/js/common/RegistryEditViewControllerBase.js?v=177_20171123142346' type='text/javascript'></script>
<script src='${ctx}/js/common/RegistryEditViewController.js?v=177_20171123142346' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new RegistryEditViewController({appctx:'${ctx2}',webctx:'${web}'});
