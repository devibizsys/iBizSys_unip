...
<% if(!p.init(pageContext,"/app/common/DataSyncAgentMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncAgentMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncagentmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncAgentPickupGridViewControllerBase.js?v=436_20171123142556' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncAgentPickupGridViewController.js?v=436_20171123142556' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncAgentMPickupViewControllerBase.js?v=436_20171123142556' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncAgentMPickupViewController.js?v=436_20171123142556' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncAgentMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
