...
<% if(!p.init(pageContext,"/app/common/SysAdminMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SysAdminMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/sysadminmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/SysAdminPickupGridViewControllerBase.js?v=338_20171123142116' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminPickupGridViewController.js?v=338_20171123142116' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminMPickupViewControllerBase.js?v=338_20171123142116' type='text/javascript'></script>
<script src='${ctx}/js/common/SysAdminMPickupViewController.js?v=338_20171123142116' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SysAdminMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
