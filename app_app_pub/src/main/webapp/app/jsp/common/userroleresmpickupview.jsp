...
<% if(!p.init(pageContext,"/app/common/UserRoleResMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleResMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroleresmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleResPickupGridViewControllerBase.js?v=474_20171123142601' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleResPickupGridViewController.js?v=474_20171123142601' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleResMPickupViewControllerBase.js?v=474_20171123142601' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleResMPickupViewController.js?v=474_20171123142601' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleResMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
