...
<% if(!p.init(pageContext,"/app/common/MsgAccountEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgAccountEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgaccounteditview2_part.jsp"/>
...
<script src='${ctx}/js/common/MsgAccountEditView2ControllerBase.js?v=1560_20171123142404' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgAccountEditView2Controller.js?v=1560_20171123142404' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgAccountEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
