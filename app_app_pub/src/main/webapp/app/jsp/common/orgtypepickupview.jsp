...
<% if(!p.init(pageContext,"/app/common/OrgTypePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgTypePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgtypepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgTypePickupViewControllerBase.js?v=858_20171123142246' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgTypePickupViewController.js?v=858_20171123142246' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgTypePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
