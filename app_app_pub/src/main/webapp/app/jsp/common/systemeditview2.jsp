...
<% if(!p.init(pageContext,"/app/common/SystemEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SystemEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/systemeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/SystemEditView2ControllerBase.js?v=174_20171123142520' type='text/javascript'></script>
<script src='${ctx}/js/common/SystemEditView2Controller.js?v=174_20171123142520' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SystemEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
