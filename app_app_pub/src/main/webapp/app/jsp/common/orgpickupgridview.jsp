...
<% if(!p.init(pageContext,"/app/common/OrgPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
