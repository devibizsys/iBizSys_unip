...
<% if(!p.init(pageContext,"/app/common/UserRoleDEFieldsMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDEFieldsMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledefieldsmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDEFieldsPickupGridViewControllerBase.js?v=429_20171123142510' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDEFieldsPickupGridViewController.js?v=429_20171123142510' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDEFieldsMPickupViewControllerBase.js?v=429_20171123142510' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDEFieldsMPickupViewController.js?v=429_20171123142510' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDEFieldsMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
