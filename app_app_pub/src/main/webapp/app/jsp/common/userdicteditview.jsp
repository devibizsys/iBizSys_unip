...
<% if(!p.init(pageContext,"/app/common/UserDictEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdicteditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictEditViewControllerBase.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictEditViewController.js?v=395_20171123142516' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictEditViewController({appctx:'${ctx2}',webctx:'${web}'});
