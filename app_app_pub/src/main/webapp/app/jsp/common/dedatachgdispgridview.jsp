...
<% if(!p.init(pageContext,"/app/common/DEDataChgDispGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgDispGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgdispgridview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgDispGridViewControllerBase.js?v=237_20171123142302' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgDispGridViewController.js?v=237_20171123142302' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgDispGridViewController({appctx:'${ctx2}',webctx:'${web}'});
