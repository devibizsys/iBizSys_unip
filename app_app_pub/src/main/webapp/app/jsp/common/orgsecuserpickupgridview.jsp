...
<% if(!p.init(pageContext,"/app/common/OrgSecUserPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecuserpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgSecUserPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
