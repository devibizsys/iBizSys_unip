...
<% if(!p.init(pageContext,"/app/common/DEDataChgDispMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgDispMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgdispmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgDispPickupGridViewControllerBase.js?v=237_20171123142302' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgDispPickupGridViewController.js?v=237_20171123142302' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgDispMPickupViewControllerBase.js?v=237_20171123142302' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgDispMPickupViewController.js?v=237_20171123142302' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgDispMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
