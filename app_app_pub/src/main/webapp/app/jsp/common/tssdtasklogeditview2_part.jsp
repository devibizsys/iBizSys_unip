...
<%@include file="tssdtasklogeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M14"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M13"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M12"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M11"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M10"><INPUT type="hidden" name="srfuf" id="<%=strCId%>Mf"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>Me"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Md"><INPUT type="hidden" name="tssdtasklogid" id="<%=strCId%>Mc">
...
<div class="panel-heading panel-text group1_text"  style="height:40px;" ><h5>任务调度日志基本信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >任务调度日志名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M5_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="tssdtasklogname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
</div>
</fieldset>
