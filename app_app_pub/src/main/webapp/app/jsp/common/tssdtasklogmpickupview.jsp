...
<% if(!p.init(pageContext,"/app/common/TSSDTaskLogMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskLogMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtasklogmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskLogPickupGridViewControllerBase.js?v=355_20171123142318' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskLogPickupGridViewController.js?v=355_20171123142318' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskLogMPickupViewControllerBase.js?v=355_20171123142318' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskLogMPickupViewController.js?v=355_20171123142318' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskLogMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
