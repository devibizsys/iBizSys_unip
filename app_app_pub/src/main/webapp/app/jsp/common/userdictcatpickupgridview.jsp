...
<% if(!p.init(pageContext,"/app/common/UserDictCatPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictCatPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictcatpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserDictCatPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
