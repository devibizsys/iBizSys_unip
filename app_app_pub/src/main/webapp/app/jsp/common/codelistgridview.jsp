...
<% if(!p.init(pageContext,"/app/common/CodeListGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeListGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codelistgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new CodeListGridViewController({appctx:'${ctx2}',webctx:'${web}'});
