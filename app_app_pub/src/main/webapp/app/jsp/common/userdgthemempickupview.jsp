...
<% if(!p.init(pageContext,"/app/common/UserDGThemeMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDGThemeMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdgthemempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDGThemePickupGridViewControllerBase.js?v=139_20171123142523' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDGThemePickupGridViewController.js?v=139_20171123142523' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDGThemeMPickupViewControllerBase.js?v=139_20171123142523' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDGThemeMPickupViewController.js?v=139_20171123142523' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDGThemeMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
