...
<% if(!p.init(pageContext,"/app/common/UserDictPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictPickupViewControllerBase.js?v=395_20171123142516' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictPickupViewController.js?v=395_20171123142516' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
