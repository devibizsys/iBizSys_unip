...
<% if(!p.init(pageContext,"/app/common/UserRoleTypeEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleTypeEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroletypeeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleTypeEditView2ControllerBase.js?v=342_20171123142616' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleTypeEditView2Controller.js?v=342_20171123142616' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleTypeEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
