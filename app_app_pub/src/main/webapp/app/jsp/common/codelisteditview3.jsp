...
<% if(!p.init(pageContext,"/app/common/CodeListEditView3.do")){return;}%>
...
<jsp:include page="../../templ/deeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeListEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/common/codelisteditview3_part.jsp"/>
...
<script src='${ctx}/js/common/CodeItemGridViewControllerBase.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeItemGridViewController.js?v=453_20171123142328' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListEditView3ControllerBase.js?v=1595_20171123142418' type='text/javascript'></script>
<script src='${ctx}/js/common/CodeListEditView3Controller.js?v=1595_20171123142418' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new CodeListEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
