...
<% if(!p.init(pageContext,"/app/common/MsgSendQueueHisEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgSendQueueHisEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgsendqueuehiseditview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgSendQueueHisEditViewControllerBase.js?v=312_20171123142352' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgSendQueueHisEditViewController.js?v=312_20171123142352' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgSendQueueHisEditViewController({appctx:'${ctx2}',webctx:'${web}'});
