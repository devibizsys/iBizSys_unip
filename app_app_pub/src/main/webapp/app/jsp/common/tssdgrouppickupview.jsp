...
<% if(!p.init(pageContext,"/app/common/TSSDGroupPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgrouppickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDGroupPickupViewControllerBase.js?v=345_20171123142606' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupPickupViewController.js?v=345_20171123142606' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDGroupPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
