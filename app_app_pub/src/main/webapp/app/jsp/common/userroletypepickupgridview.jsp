...
<% if(!p.init(pageContext,"/app/common/UserRoleTypePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleTypePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroletypepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new UserRoleTypePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
