...
<% if(!p.init(pageContext,"/app/common/MsgTemplateGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgTemplateGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgtemplategridview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgTemplateGridViewControllerBase.js?v=563_20171123142529' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgTemplateGridViewController.js?v=563_20171123142529' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgTemplateGridViewController({appctx:'${ctx2}',webctx:'${web}'});
