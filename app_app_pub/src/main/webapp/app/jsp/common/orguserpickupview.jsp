...
<% if(!p.init(pageContext,"/app/common/OrgUserPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserPickupViewControllerBase.js?v=1332_20180124112702' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserPickupViewController.js?v=1332_20180124112702' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
