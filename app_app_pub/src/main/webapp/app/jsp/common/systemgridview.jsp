...
<% if(!p.init(pageContext,"/app/common/SystemGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SystemGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/systemgridview_part.jsp"/>
...
<script src='${ctx}/js/common/SystemGridViewControllerBase.js?v=174_20171123142520' type='text/javascript'></script>
<script src='${ctx}/js/common/SystemGridViewController.js?v=174_20171123142520' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SystemGridViewController({appctx:'${ctx2}',webctx:'${web}'});
