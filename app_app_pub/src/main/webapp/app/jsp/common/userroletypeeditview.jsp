...
<% if(!p.init(pageContext,"/app/common/UserRoleTypeEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleTypeEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroletypeeditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleTypeEditViewControllerBase.js?v=342_20171123142616' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleTypeEditViewController.js?v=342_20171123142616' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleTypeEditViewController({appctx:'${ctx2}',webctx:'${web}'});
