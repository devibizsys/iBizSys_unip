...
<% if(!p.init(pageContext,"/app/common/DEDataChgDispEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgDispEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachgdispeditview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgDispEditViewControllerBase.js?v=237_20171123142302' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgDispEditViewController.js?v=237_20171123142302' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgDispEditViewController({appctx:'${ctx2}',webctx:'${web}'});
