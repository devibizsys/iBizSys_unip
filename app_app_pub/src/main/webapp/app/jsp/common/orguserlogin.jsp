...
<% if(!p.init(pageContext,"/app/common/OrgUserLogin.do")){return;}%>
...
<jsp:include page="../../templ/decustomview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserLogin.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserlogin_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserLoginControllerBase.js?v=1332_20171115095049' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserLoginController.js?v=1332_20171115095049' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserLoginController({appctx:'${ctx2}',webctx:'${web}'});
