...
<% if(!p.init(pageContext,"/app/common/DataSyncIn2PickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncIn2PickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncin2pickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DataSyncIn2PickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
