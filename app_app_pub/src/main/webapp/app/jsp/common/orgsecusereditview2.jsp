...
<% if(!p.init(pageContext,"/app/common/OrgSecUserEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusereditview2_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserEditView2ControllerBase.js?v=1186_20171123142433' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserEditView2Controller.js?v=1186_20171123142433' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
