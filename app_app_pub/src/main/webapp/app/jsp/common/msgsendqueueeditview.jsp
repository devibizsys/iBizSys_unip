...
<% if(!p.init(pageContext,"/app/common/MsgSendQueueEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/MsgSendQueueEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/msgsendqueueeditview_part.jsp"/>
...
<script src='${ctx}/js/common/MsgSendQueueEditViewControllerBase.js?v=321_20171123142222' type='text/javascript'></script>
<script src='${ctx}/js/common/MsgSendQueueEditViewController.js?v=321_20171123142222' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new MsgSendQueueEditViewController({appctx:'${ctx2}',webctx:'${web}'});
