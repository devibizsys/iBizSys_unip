...
<% if(!p.init(pageContext,"/app/common/TSSDGroupEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgroupeditview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDGroupEditViewControllerBase.js?v=345_20171123142606' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupEditViewController.js?v=345_20171123142606' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDGroupEditViewController({appctx:'${ctx2}',webctx:'${web}'});
