...
<% if(!p.init(pageContext,"/app/common/ServiceEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/ServiceEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/serviceeditview_part.jsp"/>
...
<script src='${ctx}/js/common/ServiceEditViewControllerBase.js?v=462_20171123142113' type='text/javascript'></script>
<script src='${ctx}/js/common/ServiceEditViewController.js?v=462_20171123142113' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new ServiceEditViewController({appctx:'${ctx2}',webctx:'${web}'});
