...
<% if(!p.init(pageContext,"/app/common/UserDictItemEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictItemEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictitemeditview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictItemEditViewControllerBase.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictItemEditViewController.js?v=459_20171123142256' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictItemEditViewController({appctx:'${ctx2}',webctx:'${web}'});
