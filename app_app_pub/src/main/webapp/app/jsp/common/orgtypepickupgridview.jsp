...
<% if(!p.init(pageContext,"/app/common/OrgTypePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgTypePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgtypepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgTypePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
