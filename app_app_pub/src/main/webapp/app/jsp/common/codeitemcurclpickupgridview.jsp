...
<% if(!p.init(pageContext,"/app/common/CodeItemCurCLPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/CodeItemCurCLPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/codeitemcurclpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new CodeItemCurCLPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
