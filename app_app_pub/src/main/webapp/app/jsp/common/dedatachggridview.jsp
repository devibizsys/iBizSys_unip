...
<% if(!p.init(pageContext,"/app/common/DEDataChgGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChgGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachggridview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChgGridViewControllerBase.js?v=251_20171123142453' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChgGridViewController.js?v=251_20171123142453' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChgGridViewController({appctx:'${ctx2}',webctx:'${web}'});
