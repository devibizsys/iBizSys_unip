...
<% if(!p.init(pageContext,"/app/common/TSSDEngineGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDEngineGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdenginegridview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDEngineGridViewControllerBase.js?v=377_20171123142542' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDEngineGridViewController.js?v=377_20171123142542' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDEngineGridViewController({appctx:'${ctx2}',webctx:'${web}'});
