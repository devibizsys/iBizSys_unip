...
<% if(!p.init(pageContext,"/app/common/TSSDGroupDetailMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDGroupDetailMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdgroupdetailmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDGroupDetailPickupGridViewControllerBase.js?v=338_20171123142553' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupDetailPickupGridViewController.js?v=338_20171123142553' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupDetailMPickupViewControllerBase.js?v=338_20171123142553' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDGroupDetailMPickupViewController.js?v=338_20171123142553' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDGroupDetailMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
