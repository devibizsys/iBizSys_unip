...
<% if(!p.init(pageContext,"/app/common/FilePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/FilePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/filepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/FilePickupViewControllerBase.js?v=454_20171123142148' type='text/javascript'></script>
<script src='${ctx}/js/common/FilePickupViewController.js?v=454_20171123142148' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new FilePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
