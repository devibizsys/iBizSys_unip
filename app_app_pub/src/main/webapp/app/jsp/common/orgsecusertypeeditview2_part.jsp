...
<%@include file="orgsecusertypeeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M18"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M17"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M16"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M15"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M14"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M13"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M12"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M11"><INPUT type="hidden" name="orgsecusertypeid" id="<%=strCId%>M10">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>组织部门人员关系类型信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >部门人员关系类型名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M5_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="orgsecusertypename" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >类型代码</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="typecode" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >启用标志</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M7_c" style="width:100px;" ><SELECT id="<%=strCId%>M7" name="validflag" class="form-control ibiz-field-dropdownlist"></SELECT></div>
	</div>
</div>
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >排序值</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M8_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M8" name="ordervalue" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<div class="input-group-btn ibiz-id-dropdown">
  ...
  <div class="tab-pane  row" id="<%=strCId%>form_formpage2_tab" ><div id="<%=strCId%>Mb" name="grouppanel2" style="" class="ibiz-form-formgroup  col-md-6 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
