...
<% if(!p.init(pageContext,"/app/common/GG_DBMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/GG_DBMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/gg_dbmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/GG_DBPickupGridViewControllerBase.js?v=330_20171119152152' type='text/javascript'></script>
<script src='${ctx}/js/common/GG_DBPickupGridViewController.js?v=330_20171119152152' type='text/javascript'></script>
<script src='${ctx}/js/common/GG_DBMPickupViewControllerBase.js?v=330_20171119152152' type='text/javascript'></script>
<script src='${ctx}/js/common/GG_DBMPickupViewController.js?v=330_20171119152152' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new GG_DBMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
