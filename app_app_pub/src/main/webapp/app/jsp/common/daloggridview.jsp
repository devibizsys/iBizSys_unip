...
<% if(!p.init(pageContext,"/app/common/DALogGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DALogGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/daloggridview_part.jsp"/>
...
<script src='${ctx}/js/common/DALogGridViewControllerBase.js?v=301_20171123142259' type='text/javascript'></script>
<script src='${ctx}/js/common/DALogGridViewController.js?v=301_20171123142259' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DALogGridViewController({appctx:'${ctx2}',webctx:'${web}'});
