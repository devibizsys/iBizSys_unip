...
<% if(!p.init(pageContext,"/app/common/UserRoleDataEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledataeditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDataEditView2ControllerBase.js?v=884_20171123142459' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataEditView2Controller.js?v=884_20171123142459' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
