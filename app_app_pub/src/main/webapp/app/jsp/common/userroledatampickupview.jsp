...
<% if(!p.init(pageContext,"/app/common/UserRoleDataMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRoleDataMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userroledatampickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRoleDataPickupGridViewControllerBase.js?v=884_20171123142500' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataPickupGridViewController.js?v=884_20171123142500' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataMPickupViewControllerBase.js?v=884_20171123142459' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRoleDataMPickupViewController.js?v=884_20171123142459' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRoleDataMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
