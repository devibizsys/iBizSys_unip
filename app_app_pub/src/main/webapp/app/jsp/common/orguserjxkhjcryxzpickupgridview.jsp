...
<% if(!p.init(pageContext,"/app/common/OrgUserJXKHJCRYXZPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserJXKHJCRYXZPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserjxkhjcryxzpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OrgUserJXKHJCRYXZPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
