...
<% if(!p.init(pageContext,"/app/common/OrgUserQLCBRXZGLPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserQLCBRXZGLPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserqlcbrxzglpickupgridview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserQLCBRXZGLPickupGridViewControllerBase.js?v=1332_20171115095050' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserQLCBRXZGLPickupGridViewController.js?v=1332_20171115095050' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserQLCBRXZGLPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
