...
<% if(!p.init(pageContext,"/app/common/TSSDTaskTypeMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/TSSDTaskTypeMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/tssdtasktypempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/TSSDTaskTypePickupGridViewControllerBase.js?v=327_20171123142252' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskTypePickupGridViewController.js?v=327_20171123142252' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskTypeMPickupViewControllerBase.js?v=327_20171123142252' type='text/javascript'></script>
<script src='${ctx}/js/common/TSSDTaskTypeMPickupViewController.js?v=327_20171123142252' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new TSSDTaskTypeMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
