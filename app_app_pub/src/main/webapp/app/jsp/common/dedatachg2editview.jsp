...
<% if(!p.init(pageContext,"/app/common/DEDataChg2EditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DEDataChg2EditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/dedatachg2editview_part.jsp"/>
...
<script src='${ctx}/js/common/DEDataChg2EditViewControllerBase.js?v=275_20171123142209' type='text/javascript'></script>
<script src='${ctx}/js/common/DEDataChg2EditViewController.js?v=275_20171123142209' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DEDataChg2EditViewController({appctx:'${ctx2}',webctx:'${web}'});
