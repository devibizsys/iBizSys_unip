...
<% if(!p.init(pageContext,"/app/common/PortalPageMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/PortalPageMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/portalpagempickupview_part.jsp"/>
...
<script src='${ctx}/js/common/PortalPagePickupGridViewControllerBase.js?v=165_20171123142619' type='text/javascript'></script>
<script src='${ctx}/js/common/PortalPagePickupGridViewController.js?v=165_20171123142619' type='text/javascript'></script>
<script src='${ctx}/js/common/PortalPageMPickupViewControllerBase.js?v=165_20171123142619' type='text/javascript'></script>
<script src='${ctx}/js/common/PortalPageMPickupViewController.js?v=165_20171123142619' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new PortalPageMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
