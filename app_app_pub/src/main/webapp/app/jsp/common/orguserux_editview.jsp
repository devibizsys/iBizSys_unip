...
<% if(!p.init(pageContext,"/app/common/OrgUserUX_EditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgUserUX_EditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orguserux_editview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgUserUX_EditViewControllerBase.js?v=1332_20171115160217' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgUserUX_EditViewController.js?v=1332_20171115160217' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgUserUX_EditViewController({appctx:'${ctx2}',webctx:'${web}'});
