...
<% if(!p.init(pageContext,"/app/common/DataSyncOut2EditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/DataSyncOut2EditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/datasyncout2editview_part.jsp"/>
...
<script src='${ctx}/js/common/DataSyncOut2EditViewControllerBase.js?v=290_20171123142151' type='text/javascript'></script>
<script src='${ctx}/js/common/DataSyncOut2EditViewController.js?v=290_20171123142151' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataSyncOut2EditViewController({appctx:'${ctx2}',webctx:'${web}'});
