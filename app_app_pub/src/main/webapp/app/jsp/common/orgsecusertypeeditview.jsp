...
<% if(!p.init(pageContext,"/app/common/OrgSecUserTypeEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/OrgSecUserTypeEditView.do"/>
	<jsp:param name="parturl" value="../jsp/common/orgsecusertypeeditview_part.jsp"/>
...
<script src='${ctx}/js/common/OrgSecUserTypeEditViewControllerBase.js?v=971_20171123142310' type='text/javascript'></script>
<script src='${ctx}/js/common/OrgSecUserTypeEditViewController.js?v=971_20171123142310' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OrgSecUserTypeEditViewController({appctx:'${ctx2}',webctx:'${web}'});
