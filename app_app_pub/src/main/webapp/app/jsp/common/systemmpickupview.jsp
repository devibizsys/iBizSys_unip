...
<% if(!p.init(pageContext,"/app/common/SystemMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/SystemMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/systemmpickupview_part.jsp"/>
...
<script src='${ctx}/js/common/SystemMPickupViewControllerBase.js?v=174_20171123142520' type='text/javascript'></script>
<script src='${ctx}/js/common/SystemMPickupViewController.js?v=174_20171123142520' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new SystemMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
