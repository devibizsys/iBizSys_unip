...
<% if(!p.init(pageContext,"/app/common/UserRolePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserRolePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userrolepickupview_part.jsp"/>
...
<script src='${ctx}/js/common/UserRolePickupViewControllerBase.js?v=461_20171123142155' type='text/javascript'></script>
<script src='${ctx}/js/common/UserRolePickupViewController.js?v=461_20171123142155' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserRolePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
