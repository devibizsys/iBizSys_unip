...
<% if(!p.init(pageContext,"/app/common/UserDGThemeGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDGThemeGridView.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdgthemegridview_part.jsp"/>
...
<script src='${ctx}/js/common/UserDGThemeGridViewControllerBase.js?v=139_20171123142523' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDGThemeGridViewController.js?v=139_20171123142523' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDGThemeGridViewController({appctx:'${ctx2}',webctx:'${web}'});
