...
<% if(!p.init(pageContext,"/app/common/UserDictCatEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/common/UserDictCatEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/common/userdictcateditview2_part.jsp"/>
...
<script src='${ctx}/js/common/UserDictItemGridViewControllerBase.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictItemGridViewController.js?v=459_20171123142256' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatEditView2ControllerBase.js?v=357_20171123142502' type='text/javascript'></script>
<script src='${ctx}/js/common/UserDictCatEditView2Controller.js?v=357_20171123142502' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new UserDictCatEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
