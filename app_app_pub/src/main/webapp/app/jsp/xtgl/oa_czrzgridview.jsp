...
<% if(!p.init(pageContext,"/app/xtgl/OA_CZRZGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xtgl/OA_CZRZGridView.do"/>
	<jsp:param name="parturl" value="../jsp/xtgl/oa_czrzgridview_part.jsp"/>
...
<script src='${ctx}/js/xtgl/OA_CZRZGridViewControllerBase.js?v=344_20171217110644' type='text/javascript'></script>
<script src='${ctx}/js/xtgl/OA_CZRZGridViewController.js?v=344_20171217110644' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CZRZGridViewController({appctx:'${ctx2}',webctx:'${web}'});
