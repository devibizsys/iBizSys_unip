...
<% if(!p.init(pageContext,"/app/xtgl/OA_CZRZEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xtgl/OA_CZRZEditView.do"/>
	<jsp:param name="parturl" value="../jsp/xtgl/oa_czrzeditview_part.jsp"/>
...
<script src='${ctx}/js/xtgl/OA_CZRZEditViewControllerBase.js?v=344_20171217110649' type='text/javascript'></script>
<script src='${ctx}/js/xtgl/OA_CZRZEditViewController.js?v=344_20171217110649' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CZRZEditViewController({appctx:'${ctx2}',webctx:'${web}'});
