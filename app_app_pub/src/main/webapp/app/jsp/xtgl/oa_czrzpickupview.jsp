...
<% if(!p.init(pageContext,"/app/xtgl/OA_CZRZPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xtgl/OA_CZRZPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/xtgl/oa_czrzpickupview_part.jsp"/>
...
<script src='${ctx}/js/xtgl/OA_CZRZPickupViewControllerBase.js?v=344_20171217110705' type='text/javascript'></script>
<script src='${ctx}/js/xtgl/OA_CZRZPickupViewController.js?v=344_20171217110705' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CZRZPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
