...
<%@include file="oa_czrzeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M14"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M13"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M12"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M11"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M10"><INPUT type="hidden" name="srfuf" id="<%=strCId%>Mf"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>Me"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Md"><INPUT type="hidden" name="oa_czrzid" id="<%=strCId%>Mc">
<ul class="nav nav-tabs" id="<%=strCId%>form_tab">
   <li class="active"><a href="#<%=strCId%>form_formpage1_tab" data-toggle="tab"><ibiz5:message code="CONTROL.DEFORM.OA_CZRZ.MAIN.FORMPAGE.FORMPAGE1" text="基本信息"></ibiz5:message></a></li>
   <li class=""><a href="#<%=strCId%>form_formpage2_tab" data-toggle="tab"><ibiz5:message code="CONTROL.DEFORM.OA_CZRZ.MAIN.FORMPAGE.FORMPAGE2" text="其它"></ibiz5:message></a></li>
</ul>
...
<div class="panel-heading panel-text group1_text"  style="height:40px;" ><h5><ibiz5:message code="CONTROL.DEFORM.OA_CZRZ.MAIN.GROUPPANEL.GROUP1" text="工作日志基本信息"></ibiz5:message></h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.OA_CZRZNAME" text="操作日志名称"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M5_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="oa_czrzname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
</div>
</fieldset>
...
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
<div class="panel-heading panel-text group2_text"  style="height:40px;" ><h5><ibiz5:message code="CONTROL.DEFORM.OA_CZRZ.MAIN.GROUPPANEL.GROUP2" text="操作信息"></ibiz5:message></h5></div>
</div>
<div id="<%=strCId%>M7_gd" >
