...
<% if(!p.init(pageContext,"/app/xtgl/OA_CZRZMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xtgl/OA_CZRZMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/xtgl/oa_czrzmpickupview_part.jsp"/>
...
<script src='${ctx}/js/xtgl/OA_CZRZPickupGridViewControllerBase.js?v=344_20171217110639' type='text/javascript'></script>
<script src='${ctx}/js/xtgl/OA_CZRZPickupGridViewController.js?v=344_20171217110639' type='text/javascript'></script>
<script src='${ctx}/js/xtgl/OA_CZRZMPickupViewControllerBase.js?v=344_20171217110623' type='text/javascript'></script>
<script src='${ctx}/js/xtgl/OA_CZRZMPickupViewController.js?v=344_20171217110623' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CZRZMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
