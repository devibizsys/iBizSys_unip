...
<% if(!p.init(pageContext,"/app/xtgl/OA_CZRZEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xtgl/OA_CZRZEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/xtgl/oa_czrzeditview2_part.jsp"/>
...
<script src='${ctx}/js/xtgl/OA_CZRZEditView2ControllerBase.js?v=344_20171217110654' type='text/javascript'></script>
<script src='${ctx}/js/xtgl/OA_CZRZEditView2Controller.js?v=344_20171217110654' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CZRZEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
