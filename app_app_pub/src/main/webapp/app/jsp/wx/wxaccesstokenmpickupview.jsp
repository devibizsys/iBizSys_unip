...
<% if(!p.init(pageContext,"/app/wx/WXAccessTokenMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccessTokenMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccesstokenmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccessTokenPickupGridViewControllerBase.js?v=410_20171123141910' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccessTokenPickupGridViewController.js?v=410_20171123141910' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccessTokenMPickupViewControllerBase.js?v=410_20171123141910' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccessTokenMPickupViewController.js?v=410_20171123141910' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccessTokenMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
