...
<% if(!p.init(pageContext,"/app/wx/WXMessageEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMessageEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmessageeditview2_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMessageEditView2ControllerBase.js?v=838_20171123141902' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMessageEditView2Controller.js?v=838_20171123141902' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMessageEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
