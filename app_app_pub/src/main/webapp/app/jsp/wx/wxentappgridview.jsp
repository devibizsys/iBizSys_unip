...
<% if(!p.init(pageContext,"/app/wx/WXEntAppGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXEntAppGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxentappgridview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXEntAppGridViewControllerBase.js?v=709_20171123141919' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXEntAppGridViewController.js?v=709_20171123141919' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXEntAppGridViewController({appctx:'${ctx2}',webctx:'${web}'});
