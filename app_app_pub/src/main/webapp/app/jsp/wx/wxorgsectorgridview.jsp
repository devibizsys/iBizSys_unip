...
<% if(!p.init(pageContext,"/app/wx/WXOrgSectorGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXOrgSectorGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxorgsectorgridview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXOrgSectorGridViewControllerBase.js?v=482_20171123141854' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXOrgSectorGridViewController.js?v=482_20171123141854' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXOrgSectorGridViewController({appctx:'${ctx2}',webctx:'${web}'});
