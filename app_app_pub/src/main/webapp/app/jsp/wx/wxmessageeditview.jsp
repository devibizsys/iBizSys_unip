...
<% if(!p.init(pageContext,"/app/wx/WXMessageEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMessageEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmessageeditview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMessageEditViewControllerBase.js?v=838_20171123141902' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMessageEditViewController.js?v=838_20171123141902' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMessageEditViewController({appctx:'${ctx2}',webctx:'${web}'});
