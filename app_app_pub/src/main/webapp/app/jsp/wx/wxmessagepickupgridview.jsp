...
<% if(!p.init(pageContext,"/app/wx/WXMessagePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMessagePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmessagepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WXMessagePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
