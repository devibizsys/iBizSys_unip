...
<% if(!p.init(pageContext,"/app/wx/WXAccountGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccountGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccountgridview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccountGridViewControllerBase.js?v=1045_20171123141914' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccountGridViewController.js?v=1045_20171123141914' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccountGridViewController({appctx:'${ctx2}',webctx:'${web}'});
