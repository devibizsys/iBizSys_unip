...
<%@include file="wxentapppickupgridview_userpart.jsp"%>
...
<!-- 表单区:开始-->
 <div class="col-md-10 row">
  ...
  <DIV id='<%=strCId%>M4__fi' style=""  class=" col-md-4 col-lg-4 form-group" data-ibiz-allowblank="1">
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >微信企业应用名称(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_wxentappname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
</DIV>
<DIV id='<%=strCId%>M5__fi' style=""  class=" col-md-4 col-lg-4 form-group" data-ibiz-allowblank="1">
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >应用类型(=)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M5_c" style="width:100px;" ><SELECT id="<%=strCId%>M5" name="n_apptype_eq" class="form-control ibiz-field-dropdownlist"></SELECT></div>
</div>
</td>
</tr>
</table>
