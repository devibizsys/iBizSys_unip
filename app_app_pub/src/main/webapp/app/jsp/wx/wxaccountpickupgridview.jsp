...
<% if(!p.init(pageContext,"/app/wx/WXAccountPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccountPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccountpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WXAccountPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
