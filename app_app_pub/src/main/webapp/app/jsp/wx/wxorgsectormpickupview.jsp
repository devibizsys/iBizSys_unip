...
<% if(!p.init(pageContext,"/app/wx/WXOrgSectorMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXOrgSectorMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxorgsectormpickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXOrgSectorPickupGridViewControllerBase.js?v=482_20171123141854' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXOrgSectorPickupGridViewController.js?v=482_20171123141854' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXOrgSectorMPickupViewControllerBase.js?v=482_20171123141854' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXOrgSectorMPickupViewController.js?v=482_20171123141854' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXOrgSectorMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
