...
<% if(!p.init(pageContext,"/app/wx/WXEntAppMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXEntAppMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxentappmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXEntAppPickupGridViewControllerBase.js?v=709_20171123141919' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXEntAppPickupGridViewController.js?v=709_20171123141919' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXEntAppMPickupViewControllerBase.js?v=709_20171123141919' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXEntAppMPickupViewController.js?v=709_20171123141919' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXEntAppMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
