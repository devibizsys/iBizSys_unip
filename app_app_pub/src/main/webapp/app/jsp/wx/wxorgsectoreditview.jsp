...
<% if(!p.init(pageContext,"/app/wx/WXOrgSectorEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXOrgSectorEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxorgsectoreditview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXOrgSectorEditViewControllerBase.js?v=482_20171123141854' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXOrgSectorEditViewController.js?v=482_20171123141854' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXOrgSectorEditViewController({appctx:'${ctx2}',webctx:'${web}'});
