...
<% if(!p.init(pageContext,"/app/wx/WXAccessTokenGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccessTokenGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccesstokengridview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccessTokenGridViewControllerBase.js?v=410_20171123141910' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccessTokenGridViewController.js?v=410_20171123141910' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccessTokenGridViewController({appctx:'${ctx2}',webctx:'${web}'});
