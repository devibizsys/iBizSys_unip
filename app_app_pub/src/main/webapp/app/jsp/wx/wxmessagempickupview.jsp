...
<% if(!p.init(pageContext,"/app/wx/WXMessageMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMessageMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmessagempickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMessagePickupGridViewControllerBase.js?v=838_20171123141902' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMessagePickupGridViewController.js?v=838_20171123141902' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMessageMPickupViewControllerBase.js?v=838_20171123141902' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMessageMPickupViewController.js?v=838_20171123141902' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMessageMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
