...
<% if(!p.init(pageContext,"/app/wx/WXMediaEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMediaEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmediaeditview2_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMediaEditView2ControllerBase.js?v=452_20171123141906' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMediaEditView2Controller.js?v=452_20171123141906' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMediaEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
