...
<% if(!p.init(pageContext,"/app/wx/WXAccessTokenEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccessTokenEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccesstokeneditview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccessTokenEditViewControllerBase.js?v=410_20171123141910' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccessTokenEditViewController.js?v=410_20171123141910' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccessTokenEditViewController({appctx:'${ctx2}',webctx:'${web}'});
