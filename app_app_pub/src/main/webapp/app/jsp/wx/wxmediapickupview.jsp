...
<% if(!p.init(pageContext,"/app/wx/WXMediaPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMediaPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmediapickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMediaPickupViewControllerBase.js?v=452_20171123141906' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMediaPickupViewController.js?v=452_20171123141906' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMediaPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
