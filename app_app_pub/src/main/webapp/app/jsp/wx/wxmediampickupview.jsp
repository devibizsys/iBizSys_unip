...
<% if(!p.init(pageContext,"/app/wx/WXMediaMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMediaMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmediampickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMediaPickupGridViewControllerBase.js?v=452_20171123141906' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMediaPickupGridViewController.js?v=452_20171123141906' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMediaMPickupViewControllerBase.js?v=452_20171123141906' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMediaMPickupViewController.js?v=452_20171123141906' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMediaMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
