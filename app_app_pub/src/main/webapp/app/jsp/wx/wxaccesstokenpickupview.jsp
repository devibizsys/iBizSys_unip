...
<% if(!p.init(pageContext,"/app/wx/WXAccessTokenPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccessTokenPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccesstokenpickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccessTokenPickupViewControllerBase.js?v=410_20171123141910' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccessTokenPickupViewController.js?v=410_20171123141910' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccessTokenPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
