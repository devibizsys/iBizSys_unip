...
<% if(!p.init(pageContext,"/app/wx/WXAccountMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccountMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccountmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccountPickupGridViewControllerBase.js?v=1045_20171123141914' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccountPickupGridViewController.js?v=1045_20171123141914' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccountMPickupViewControllerBase.js?v=1045_20171123141914' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccountMPickupViewController.js?v=1045_20171123141914' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccountMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
