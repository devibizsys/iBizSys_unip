...
<% if(!p.init(pageContext,"/app/wx/WXMediaPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMediaPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmediapickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WXMediaPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
