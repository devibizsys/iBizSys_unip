...
<% if(!p.init(pageContext,"/app/wx/WXMediaEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMediaEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmediaeditview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMediaEditViewControllerBase.js?v=452_20171123141906' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMediaEditViewController.js?v=452_20171123141906' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMediaEditViewController({appctx:'${ctx2}',webctx:'${web}'});
