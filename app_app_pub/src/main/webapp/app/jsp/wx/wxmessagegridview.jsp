...
<% if(!p.init(pageContext,"/app/wx/WXMessageGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMessageGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmessagegridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WXMessageGridViewController({appctx:'${ctx2}',webctx:'${web}'});
