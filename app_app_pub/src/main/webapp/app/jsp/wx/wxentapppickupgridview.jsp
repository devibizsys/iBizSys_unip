...
<% if(!p.init(pageContext,"/app/wx/WXEntAppPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXEntAppPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxentapppickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WXEntAppPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
