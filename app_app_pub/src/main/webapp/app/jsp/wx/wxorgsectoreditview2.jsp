...
<% if(!p.init(pageContext,"/app/wx/WXOrgSectorEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXOrgSectorEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxorgsectoreditview2_part.jsp"/>
...
<script src='${ctx}/js/wx/WXOrgSectorEditView2ControllerBase.js?v=482_20171123141854' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXOrgSectorEditView2Controller.js?v=482_20171123141854' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXOrgSectorEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
