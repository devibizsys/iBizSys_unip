...
<% if(!p.init(pageContext,"/app/wx/WXMessagePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMessagePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmessagepickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXMessagePickupViewControllerBase.js?v=838_20171123141902' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXMessagePickupViewController.js?v=838_20171123141902' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXMessagePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
