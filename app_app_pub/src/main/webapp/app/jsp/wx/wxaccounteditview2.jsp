...
<% if(!p.init(pageContext,"/app/wx/WXAccountEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccountEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccounteditview2_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccountEditView2ControllerBase.js?v=1045_20171123141914' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccountEditView2Controller.js?v=1045_20171123141914' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccountEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
