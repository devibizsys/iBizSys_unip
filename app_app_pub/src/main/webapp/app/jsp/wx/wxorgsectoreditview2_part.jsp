...
<%@include file="wxorgsectoreditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M1a"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M19"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M18"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M17"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M16"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M15"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M14"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M13"><INPUT type="hidden" name="wxorgsectorid" id="<%=strCId%>M10"><INPUT type="hidden" name="orgsectorid" id="<%=strCId%>M11"><INPUT type="hidden" name="wxaccountid" id="<%=strCId%>M12">
...
<div class="panel-heading panel-text group1_text"  style="height:40px;" ><h5>微信部门基本信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >微信部门名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M5_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="wxorgsectorname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >部门编号</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="deptid" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >机构部门</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >微信公众号</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			<span class="toggle fa fa-search"></span>
			<input type="text" class="form-control text" name="wxaccountname" id="<%=strCId%>M8" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
