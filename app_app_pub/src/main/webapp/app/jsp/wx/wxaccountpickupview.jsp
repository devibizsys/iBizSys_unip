...
<% if(!p.init(pageContext,"/app/wx/WXAccountPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccountPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccountpickupview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccountPickupViewControllerBase.js?v=1045_20171123141914' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccountPickupViewController.js?v=1045_20171123141914' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccountPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
