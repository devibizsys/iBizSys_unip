...
<% if(!p.init(pageContext,"/app/wx/WXAccountEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXAccountEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxaccounteditview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXAccountEditViewControllerBase.js?v=1045_20171123141914' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXAccountEditViewController.js?v=1045_20171123141914' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXAccountEditViewController({appctx:'${ctx2}',webctx:'${web}'});
