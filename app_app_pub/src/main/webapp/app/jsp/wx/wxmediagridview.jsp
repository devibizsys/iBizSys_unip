...
<% if(!p.init(pageContext,"/app/wx/WXMediaGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXMediaGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxmediagridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WXMediaGridViewController({appctx:'${ctx2}',webctx:'${web}'});
