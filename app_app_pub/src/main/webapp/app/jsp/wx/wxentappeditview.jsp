...
<% if(!p.init(pageContext,"/app/wx/WXEntAppEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wx/WXEntAppEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wx/wxentappeditview_part.jsp"/>
...
<script src='${ctx}/js/wx/WXEntAppEditViewControllerBase.js?v=709_20171123141919' type='text/javascript'></script>
<script src='${ctx}/js/wx/WXEntAppEditViewController.js?v=709_20171123141919' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WXEntAppEditViewController({appctx:'${ctx2}',webctx:'${web}'});
