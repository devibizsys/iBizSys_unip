...
<%@include file="oa_xxeditview_userpart.jsp"%>
<% if(strCtrlId.compareTo("toolbar")==0){ %>
 <div id="<%=strCId%>toolbar">
<button title="发送消息"  data-ibiz-tag="FSXX" data-ibiz-target="SINGLEKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >发送消息</span>  </button>  
<!--分割符号-->
