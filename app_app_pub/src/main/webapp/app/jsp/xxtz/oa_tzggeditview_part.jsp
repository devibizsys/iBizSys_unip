...
<%@include file="oa_tzggeditview_userpart.jsp"%>
<% if(strCtrlId.compareTo("toolbar")==0){ %>
 <div id="<%=strCId%>toolbar">
<button title="发送公告通知消息"  data-ibiz-tag="FSTZGGXX" data-ibiz-target="SINGLEKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >发送公告通知消息</span>  </button>  
<!--分割符号-->
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M18"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M17"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M16"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M15"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M14"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M13"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M12"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M11"><INPUT type="hidden" name="oa_tzggid" id="<%=strCId%>M5"><INPUT type="hidden" name="orguserid" id="<%=strCId%>M7"><INPUT type="hidden" name="orgusername" id="<%=strCId%>M8">
...
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.OA_TZGGNAME" text="通知公告标题"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="oa_tzggname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<div id='<%=strCId%>Ma__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Ma__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.OA_TZGG.CONTENT" text="通知公告内容"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Ma_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Ma" name="content" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
</div>
</fieldset>
