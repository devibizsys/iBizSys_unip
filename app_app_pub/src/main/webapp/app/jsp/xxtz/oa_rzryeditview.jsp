...
<% if(!p.init(pageContext,"/app/xxtz/OA_RZRYEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_RZRYEditView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_rzryeditview_part.jsp"/>
...
<script src='${ctx}/js/xxtz/OA_RZRYEditViewControllerBase.js?v=611_20171227105858' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_RZRYEditViewController.js?v=611_20171227105858' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_RZRYEditViewController({appctx:'${ctx2}',webctx:'${web}'});
