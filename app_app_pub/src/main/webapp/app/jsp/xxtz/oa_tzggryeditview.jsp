...
<% if(!p.init(pageContext,"/app/xxtz/OA_TZGGRYEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_TZGGRYEditView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_tzggryeditview_part.jsp"/>
...
<script src='${ctx}/js/xxtz/OA_TZGGRYEditViewControllerBase.js?v=220_20171228115143' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_TZGGRYEditViewController.js?v=220_20171228115143' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_TZGGRYEditViewController({appctx:'${ctx2}',webctx:'${web}'});
