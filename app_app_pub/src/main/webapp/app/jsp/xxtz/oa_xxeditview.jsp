...
<% if(!p.init(pageContext,"/app/xxtz/OA_XXEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_XXEditView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_xxeditview_part.jsp"/>
...
<script src='${ctx}/js/xxtz/OA_XXEditViewControllerBase.js?v=847_20171228160134' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_XXEditViewController.js?v=847_20171228160134' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_XXEditViewController({appctx:'${ctx2}',webctx:'${web}'});
