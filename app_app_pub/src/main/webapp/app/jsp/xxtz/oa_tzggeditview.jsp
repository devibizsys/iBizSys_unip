...
<% if(!p.init(pageContext,"/app/xxtz/OA_TZGGEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_TZGGEditView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_tzggeditview_part.jsp"/>
...
<script src='${ctx}/js/xxtz/OA_TZGGEditViewControllerBase.js?v=1443_20171228105601' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_TZGGEditViewController.js?v=1443_20171228105601' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_TZGGEditViewController({appctx:'${ctx2}',webctx:'${web}'});
