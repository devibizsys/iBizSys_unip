...
<% if(!p.init(pageContext,"/app/xxtz/OA_TZGGGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_TZGGGridView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_tzgggridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_TZGGGridViewController({appctx:'${ctx2}',webctx:'${web}'});
