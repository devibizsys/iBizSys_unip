...
<% if(!p.init(pageContext,"/app/xxtz/OA_RZRYMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_RZRYMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_rzrympickupview_part.jsp"/>
...
<script src='${ctx}/js/xxtz/OA_RZRYPickupGridViewControllerBase.js?v=611_20171227105858' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_RZRYPickupGridViewController.js?v=611_20171227105858' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_RZRYMPickupViewControllerBase.js?v=611_20171227105858' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_RZRYMPickupViewController.js?v=611_20171227105858' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_RZRYMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
