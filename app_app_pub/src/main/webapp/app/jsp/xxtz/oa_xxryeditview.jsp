...
<% if(!p.init(pageContext,"/app/xxtz/OA_XXRYEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_XXRYEditView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_xxryeditview_part.jsp"/>
...
<script src='${ctx}/js/xxtz/OA_XXRYEditViewControllerBase.js?v=197_20171228155033' type='text/javascript'></script>
<script src='${ctx}/js/xxtz/OA_XXRYEditViewController.js?v=197_20171228155033' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_XXRYEditViewController({appctx:'${ctx2}',webctx:'${web}'});
