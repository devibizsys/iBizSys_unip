...
<% if(!p.init(pageContext,"/app/xxtz/OA_XXGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/xxtz/OA_XXGridView.do"/>
	<jsp:param name="parturl" value="../jsp/xxtz/oa_xxgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_XXGridViewController({appctx:'${ctx2}',webctx:'${web}'});
