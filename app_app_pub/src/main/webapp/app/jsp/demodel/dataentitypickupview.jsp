...
<% if(!p.init(pageContext,"/app/demodel/DataEntityPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/DataEntityPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/dataentitypickupview_part.jsp"/>
...
<script src='${ctx}/js/demodel/DataEntityPickupViewControllerBase.js?v=2245_20171123141844' type='text/javascript'></script>
<script src='${ctx}/js/demodel/DataEntityPickupViewController.js?v=2245_20171123141844' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataEntityPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
