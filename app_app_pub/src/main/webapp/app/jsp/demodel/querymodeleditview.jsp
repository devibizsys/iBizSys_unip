...
<% if(!p.init(pageContext,"/app/demodel/QueryModelEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelEditView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodeleditview_part.jsp"/>
...
<script src='${ctx}/js/demodel/QueryModelEditViewControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelEditViewController.js?v=356_20171123141850' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new QueryModelEditViewController({appctx:'${ctx2}',webctx:'${web}'});
