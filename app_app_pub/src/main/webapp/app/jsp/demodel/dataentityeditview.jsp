...
<% if(!p.init(pageContext,"/app/demodel/DataEntityEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/DataEntityEditView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/dataentityeditview_part.jsp"/>
...
<script src='${ctx}/js/demodel/DataEntityEditViewControllerBase.js?v=2245_20171123141844' type='text/javascript'></script>
<script src='${ctx}/js/demodel/DataEntityEditViewController.js?v=2245_20171123141844' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataEntityEditViewController({appctx:'${ctx2}',webctx:'${web}'});
