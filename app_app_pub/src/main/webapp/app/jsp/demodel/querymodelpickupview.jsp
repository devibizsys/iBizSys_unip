...
<% if(!p.init(pageContext,"/app/demodel/QueryModelPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodelpickupview_part.jsp"/>
...
<script src='${ctx}/js/demodel/QueryModelPickupViewControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelPickupViewController.js?v=356_20171123141850' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new QueryModelPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
