...
<% if(!p.init(pageContext,"/app/demodel/QueryModelCurDEMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelCurDEMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodelcurdempickupview_part.jsp"/>
...
<script src='${ctx}/js/demodel/QueryModelCurDEPickupGridViewControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelCurDEPickupGridViewController.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelCurDEMPickupViewControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelCurDEMPickupViewController.js?v=356_20171123141850' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new QueryModelCurDEMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
