...
<% if(!p.init(pageContext,"/app/demodel/QueryModelEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodeleditview2_part.jsp"/>
...
<script src='${ctx}/js/demodel/QueryModelEditView2ControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelEditView2Controller.js?v=356_20171123141850' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new QueryModelEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
