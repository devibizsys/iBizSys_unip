...
<% if(!p.init(pageContext,"/app/demodel/QueryModelCurDEPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelCurDEPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodelcurdepickupview_part.jsp"/>
...
<script src='${ctx}/js/demodel/QueryModelCurDEPickupViewControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelCurDEPickupViewController.js?v=356_20171123141850' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new QueryModelCurDEPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
