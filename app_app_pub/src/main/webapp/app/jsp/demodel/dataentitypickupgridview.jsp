...
<% if(!p.init(pageContext,"/app/demodel/DataEntityPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/DataEntityPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/dataentitypickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DataEntityPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
