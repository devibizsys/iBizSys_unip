...
<% if(!p.init(pageContext,"/app/demodel/DataEntityMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/DataEntityMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/dataentitympickupview_part.jsp"/>
...
<script src='${ctx}/js/demodel/DataEntityPickupGridViewControllerBase.js?v=2245_20171123141844' type='text/javascript'></script>
<script src='${ctx}/js/demodel/DataEntityPickupGridViewController.js?v=2245_20171123141844' type='text/javascript'></script>
<script src='${ctx}/js/demodel/DataEntityMPickupViewControllerBase.js?v=2245_20171123141844' type='text/javascript'></script>
<script src='${ctx}/js/demodel/DataEntityMPickupViewController.js?v=2245_20171123141844' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new DataEntityMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
