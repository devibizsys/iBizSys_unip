...
<%@include file="dataentitygridview_userpart.jsp"%>
...
<!--分割符号-->
<button title="初始化"  data-ibiz-tag="InitAll" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >初始化</span>  </button>  
<!--分割符号-->
<!--操作集合-->
<!--分割符号-->
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >实体名称(%)</label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_dename_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
