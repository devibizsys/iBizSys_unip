...
<% if(!p.init(pageContext,"/app/demodel/DataEntityGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/DataEntityGridView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/dataentitygridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new DataEntityGridViewController({appctx:'${ctx2}',webctx:'${web}'});
