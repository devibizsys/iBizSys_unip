...
<%@include file="dataentityeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>Mf"><INPUT type="hidden" name="srforikey" id="<%=strCId%>Me"><INPUT type="hidden" name="srfkey" id="<%=strCId%>Md"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>Mc"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>Mb"><INPUT type="hidden" name="srfuf" id="<%=strCId%>Ma"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M9"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M8"><INPUT type="hidden" name="deid" id="<%=strCId%>M7">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>实体基本信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >实体名称</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M5_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="dename" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-sm-12 col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >备注</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M6_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>M6" name="memo"  type="text"  class="form-control" ></textarea>
