...
<% if(!p.init(pageContext,"/app/demodel/QueryModelCurDEPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelCurDEPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodelcurdepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new QueryModelCurDEPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
