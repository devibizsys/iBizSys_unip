...
<% if(!p.init(pageContext,"/app/demodel/QueryModelPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodelpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new QueryModelPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
