...
<% if(!p.init(pageContext,"/app/demodel/QueryModelMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodelmpickupview_part.jsp"/>
...
<script src='${ctx}/js/demodel/QueryModelPickupGridViewControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelPickupGridViewController.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelMPickupViewControllerBase.js?v=356_20171123141850' type='text/javascript'></script>
<script src='${ctx}/js/demodel/QueryModelMPickupViewController.js?v=356_20171123141850' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new QueryModelMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
