...
<% if(!p.init(pageContext,"/app/demodel/QueryModelGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/demodel/QueryModelGridView.do"/>
	<jsp:param name="parturl" value="../jsp/demodel/querymodelgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new QueryModelGridViewController({appctx:'${ctx2}',webctx:'${web}'});
