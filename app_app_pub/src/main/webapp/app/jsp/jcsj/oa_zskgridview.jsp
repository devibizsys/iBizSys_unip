...
<% if(!p.init(pageContext,"/app/jcsj/OA_ZSKGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_ZSKGridView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_zskgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_ZSKGridViewController({appctx:'${ctx2}',webctx:'${web}'});
