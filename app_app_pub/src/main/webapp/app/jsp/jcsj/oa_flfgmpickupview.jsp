...
<% if(!p.init(pageContext,"/app/jcsj/OA_FLFGMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_FLFGMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_flfgmpickupview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_FLFGPickupGridViewControllerBase.js?v=370_20171217111408' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_FLFGPickupGridViewController.js?v=370_20171217111408' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_FLFGMPickupViewControllerBase.js?v=370_20171217111408' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_FLFGMPickupViewController.js?v=370_20171217111408' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_FLFGMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
