...
<% if(!p.init(pageContext,"/app/jcsj/OA_CLGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_CLGridView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_clgridview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_CLGridViewControllerBase.js?v=475_20171217114541' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_CLGridViewController.js?v=475_20171217114541' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CLGridViewController({appctx:'${ctx2}',webctx:'${web}'});
