...
<% if(!p.init(pageContext,"/app/jcsj/OA_ZSKMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_ZSKMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_zskmpickupview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_ZSKPickupGridViewControllerBase.js?v=617_20171215155121' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_ZSKPickupGridViewController.js?v=617_20171215155121' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_ZSKMPickupViewControllerBase.js?v=617_20171215155121' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_ZSKMPickupViewController.js?v=617_20171215155121' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_ZSKMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
