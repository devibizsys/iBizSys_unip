...
<% if(!p.init(pageContext,"/app/jcsj/OA_ZSKPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_ZSKPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_zskpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_ZSKPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
