...
<% if(!p.init(pageContext,"/app/jcsj/OA_HYSPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_HYSPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_hyspickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_HYSPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
