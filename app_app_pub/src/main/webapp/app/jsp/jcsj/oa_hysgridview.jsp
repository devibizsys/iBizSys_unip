...
<% if(!p.init(pageContext,"/app/jcsj/OA_HYSGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_HYSGridView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_hysgridview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_HYSGridViewControllerBase.js?v=399_20180104151402' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_HYSGridViewController.js?v=399_20180104151402' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_HYSGridViewController({appctx:'${ctx2}',webctx:'${web}'});
