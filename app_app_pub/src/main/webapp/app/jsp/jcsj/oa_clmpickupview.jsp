...
<% if(!p.init(pageContext,"/app/jcsj/OA_CLMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_CLMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_clmpickupview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_CLPickupGridViewControllerBase.js?v=475_20171217114541' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_CLPickupGridViewController.js?v=475_20171217114541' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_CLMPickupViewControllerBase.js?v=475_20171217114541' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_CLMPickupViewController.js?v=475_20171217114541' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CLMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
