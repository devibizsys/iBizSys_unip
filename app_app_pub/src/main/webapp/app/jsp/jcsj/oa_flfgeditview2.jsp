...
<% if(!p.init(pageContext,"/app/jcsj/OA_FLFGEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_FLFGEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_flfgeditview2_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_FLFGEditView2ControllerBase.js?v=370_20171217111408' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_FLFGEditView2Controller.js?v=370_20171217111408' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_FLFGEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
