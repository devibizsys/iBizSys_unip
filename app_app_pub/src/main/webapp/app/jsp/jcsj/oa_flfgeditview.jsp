...
<% if(!p.init(pageContext,"/app/jcsj/OA_FLFGEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_FLFGEditView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_flfgeditview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_FLFGEditViewControllerBase.js?v=370_20171217111408' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_FLFGEditViewController.js?v=370_20171217111408' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_FLFGEditViewController({appctx:'${ctx2}',webctx:'${web}'});
