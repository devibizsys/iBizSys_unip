...
<% if(!p.init(pageContext,"/app/jcsj/OA_ZSKEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_ZSKEditView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_zskeditview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_ZSKEditViewControllerBase.js?v=617_20171215155121' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_ZSKEditViewController.js?v=617_20171215155121' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_ZSKEditViewController({appctx:'${ctx2}',webctx:'${web}'});
