...
<% if(!p.init(pageContext,"/app/jcsj/OA_HYSEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_HYSEditView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_hyseditview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_HYSEditViewControllerBase.js?v=399_20180104151402' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_HYSEditViewController.js?v=399_20180104151402' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_HYSEditViewController({appctx:'${ctx2}',webctx:'${web}'});
