...
<% if(!p.init(pageContext,"/app/jcsj/OA_CLEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_CLEditView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_cleditview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_CLEditViewControllerBase.js?v=475_20171217114541' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_CLEditViewController.js?v=475_20171217114541' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CLEditViewController({appctx:'${ctx2}',webctx:'${web}'});
