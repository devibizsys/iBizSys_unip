...
<% if(!p.init(pageContext,"/app/jcsj/OA_FLFGGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/jcsj/OA_FLFGGridView.do"/>
	<jsp:param name="parturl" value="../jsp/jcsj/oa_flfggridview_part.jsp"/>
...
<script src='${ctx}/js/jcsj/OA_FLFGGridViewControllerBase.js?v=370_20171217111408' type='text/javascript'></script>
<script src='${ctx}/js/jcsj/OA_FLFGGridViewController.js?v=370_20171217111408' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_FLFGGridViewController({appctx:'${ctx2}',webctx:'${web}'});
