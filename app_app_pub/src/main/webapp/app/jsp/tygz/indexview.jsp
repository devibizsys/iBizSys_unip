...
<% if(!p.init(pageContext,"/app/tygz/IndexView.do")){return;}%>
...
<%@include file="../../lib/appindexviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/appindexview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/tygz/IndexView.do"/>
	<jsp:param name="parturl" value="../jsp/tygz/indexview_part.jsp"/>
...
<%@include file="../../lib/appindexviewlib-script.jsp"%>
<script src='${ctx}/js/tygz/IndexViewControllerBase.js?v=20180120170913' type='text/javascript'></script>
<script src='${ctx}/js/tygz/IndexViewController.js?v=20180120170913' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new IndexViewController({appctx:'${ctx2}',webctx:'${web}'});
