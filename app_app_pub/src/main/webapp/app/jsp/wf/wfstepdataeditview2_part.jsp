...
<%@include file="wfstepdataeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>Mc"><INPUT type="hidden" name="srforikey" id="<%=strCId%>Mb"><INPUT type="hidden" name="srfkey" id="<%=strCId%>Ma"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M9"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M8"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M7"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M6"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M5"><INPUT type="hidden" name="wfstepdataid" id="<%=strCId%>M4">
<div class="tab_title"><a href="#<%=strCId%>form_formpage1_tab"><ibiz5:message code="CONTROL.DEFORM.WFSTEPDATA.MAIN.FORMPAGE.FORMPAGE1" text="基本信息"></ibiz5:message></a></div>
