...
<% if(!p.init(pageContext,"/app/wf/WFWorkflowGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkflowGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworkflowgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFWorkflowGridViewController({appctx:'${ctx2}',webctx:'${web}'});
