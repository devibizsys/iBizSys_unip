...
<% if(!p.init(pageContext,"/app/wf/WFStepDataEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdataeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepDataEditViewControllerBase.js?v=414_20171123141945' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepDataEditViewController.js?v=414_20171123141945' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepDataEditViewController({appctx:'${ctx2}',webctx:'${web}'});
