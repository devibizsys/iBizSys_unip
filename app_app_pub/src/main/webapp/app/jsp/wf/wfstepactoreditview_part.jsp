...
<%@include file="wfstepactoreditview_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M15"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M14"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M13"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M12"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M11"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M10"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>Mf"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Me"><INPUT type="hidden" name="isfinish" id="<%=strCId%>M8"><INPUT type="hidden" name="wfstepactorid" id="<%=strCId%>Md">
...
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >操作者</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M5_c" style="" >
<input type="text" class="form-control text ibiz-field-span" readonly="readonly" name="wfstepactorname" id="<%=strCId%>M5"  >
</div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >查看时间</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M6_c" style="" >
<input type="text" class="form-control text ibiz-field-span" readonly="readonly" name="firstreadtime" id="<%=strCId%>M6"  >
</div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >是否完成</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M7_c" style="" >
<input type="text" class="form-control text ibiz-field-span" readonly="readonly" name="isfinish1" id="<%=strCId%>M7"  >
</div>
	</div>
</div>
<div id='<%=strCId%>M9__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M9__lb' class="control-label" style="width:130px;"  >完成时间</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>M9_c" style="" >
<input type="text" class="form-control text ibiz-field-span" readonly="readonly" name="finishdate" id="<%=strCId%>M9"  >
</div>
	</div>
</div>
</div>
...
<div id="<%=strCId%>Ma" name="grouppanel2" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
...
<div id='<%=strCId%>Mb__fi' style="" class="ibiz-form-formitem  col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mb__lb' class="control-label" style="width:130px;"  >督促次数</label>
	</div>
	<div style="margin-left:140px;" >
		<div id="<%=strCId%>Mb_c" style="" >
<input type="text" class="form-control text ibiz-field-span" readonly="readonly" name="remindercount" id="<%=strCId%>Mb"  >
</div>
	</div>
</div>
...
<textarea id="<%=strCId%>Mc" name="remindmemo"  type="text"  class="form-control" ></textarea>
