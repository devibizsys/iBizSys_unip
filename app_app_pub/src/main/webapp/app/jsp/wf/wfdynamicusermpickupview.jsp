...
<% if(!p.init(pageContext,"/app/wf/WFDynamicUserMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFDynamicUserMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfdynamicusermpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFDynamicUserPickupGridViewControllerBase.js?v=104_20171123142020' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFDynamicUserPickupGridViewController.js?v=104_20171123142020' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFDynamicUserMPickupViewControllerBase.js?v=104_20171123142020' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFDynamicUserMPickupViewController.js?v=104_20171123142020' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFDynamicUserMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
