...
<% if(!p.init(pageContext,"/app/wf/WFVersionEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFVersionEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfversioneditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFVersionEditView2ControllerBase.js?v=160_20171123142101' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFVersionEditView2Controller.js?v=160_20171123142101' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFVersionEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
