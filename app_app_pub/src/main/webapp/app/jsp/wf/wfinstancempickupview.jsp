...
<% if(!p.init(pageContext,"/app/wf/WFInstanceMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFInstanceMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfinstancempickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFInstancePickupGridViewControllerBase.js?v=486_20171123141937' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFInstancePickupGridViewController.js?v=486_20171123141937' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFInstanceMPickupViewControllerBase.js?v=486_20171123141937' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFInstanceMPickupViewController.js?v=486_20171123141937' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFInstanceMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
