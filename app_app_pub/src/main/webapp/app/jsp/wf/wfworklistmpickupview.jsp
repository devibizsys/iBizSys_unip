...
<% if(!p.init(pageContext,"/app/wf/WFWorkListMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkListMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworklistmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFWorkListPickupGridViewControllerBase.js?v=239_20171123142049' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkListPickupGridViewController.js?v=239_20171123142049' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkListMPickupViewControllerBase.js?v=239_20171123142049' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkListMPickupViewController.js?v=239_20171123142049' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFWorkListMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
