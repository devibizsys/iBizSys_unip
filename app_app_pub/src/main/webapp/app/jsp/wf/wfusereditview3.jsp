...
<% if(!p.init(pageContext,"/app/wf/WFUserEditView3.do")){return;}%>
...
<jsp:include page="../../templ/deeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusereditview3_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserEditView3ControllerBase.js?v=1036_20171123142058' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserEditView3Controller.js?v=1036_20171123142058' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
