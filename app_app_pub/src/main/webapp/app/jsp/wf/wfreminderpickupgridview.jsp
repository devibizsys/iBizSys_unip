...
<% if(!p.init(pageContext,"/app/wf/WFReminderPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFReminderPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfreminderpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFReminderPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
