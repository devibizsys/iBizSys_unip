...
<% if(!p.init(pageContext,"/app/wf/WFStepEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepEditViewControllerBase.js?v=318_20171123142039' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepEditViewController.js?v=318_20171123142039' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepEditViewController({appctx:'${ctx2}',webctx:'${web}'});
