...
<% if(!p.init(pageContext,"/app/wf/WFAppSettingGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFAppSettingGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfappsettinggridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFAppSettingGridViewController({appctx:'${ctx2}',webctx:'${web}'});
