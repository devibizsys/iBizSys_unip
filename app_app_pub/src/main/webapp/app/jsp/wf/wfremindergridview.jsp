...
<% if(!p.init(pageContext,"/app/wf/WFReminderGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFReminderGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfremindergridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFReminderGridViewController({appctx:'${ctx2}',webctx:'${web}'});
