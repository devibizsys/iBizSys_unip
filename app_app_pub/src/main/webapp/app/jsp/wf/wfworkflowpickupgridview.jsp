...
<% if(!p.init(pageContext,"/app/wf/WFWorkflowPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkflowPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworkflowpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFWorkflowPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
