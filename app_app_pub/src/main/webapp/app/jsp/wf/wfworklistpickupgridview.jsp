...
<% if(!p.init(pageContext,"/app/wf/WFWorkListPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkListPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworklistpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFWorkListPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
