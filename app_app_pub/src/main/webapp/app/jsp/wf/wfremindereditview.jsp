...
<% if(!p.init(pageContext,"/app/wf/WFReminderEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFReminderEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfremindereditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFReminderEditViewControllerBase.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFReminderEditViewController.js?v=189_20171123141957' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFReminderEditViewController({appctx:'${ctx2}',webctx:'${web}'});
