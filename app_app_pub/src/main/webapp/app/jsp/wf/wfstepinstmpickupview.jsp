...
<% if(!p.init(pageContext,"/app/wf/WFStepInstMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepInstMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepinstmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepInstPickupGridViewControllerBase.js?v=202_20171123142018' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepInstPickupGridViewController.js?v=202_20171123142018' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepInstMPickupViewControllerBase.js?v=202_20171123142018' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepInstMPickupViewController.js?v=202_20171123142018' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepInstMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
