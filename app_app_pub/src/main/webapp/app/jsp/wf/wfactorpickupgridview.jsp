...
<% if(!p.init(pageContext,"/app/wf/WFActorPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActorPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactorpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFActorPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
