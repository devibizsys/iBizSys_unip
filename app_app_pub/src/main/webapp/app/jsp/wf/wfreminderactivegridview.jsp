...
<% if(!p.init(pageContext,"/app/wf/WFReminderActiveGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFReminderActiveGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfreminderactivegridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFReminderActiveGridViewController({appctx:'${ctx2}',webctx:'${web}'});
