...
<% if(!p.init(pageContext,"/app/wf/WFWorkListPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkListPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworklistpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFWorkListPickupViewControllerBase.js?v=239_20171123142049' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkListPickupViewController.js?v=239_20171123142049' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFWorkListPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
