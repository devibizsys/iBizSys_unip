...
<% if(!p.init(pageContext,"/app/wf/WFStepDataMyHistGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataMyHistGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdatamyhistgridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepDataMyHistGridViewControllerBase.js?v=414_20171123141945' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepDataMyHistGridViewController.js?v=414_20171123141945' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepDataMyHistGridViewController({appctx:'${ctx2}',webctx:'${web}'});
