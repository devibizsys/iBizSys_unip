...
<% if(!p.init(pageContext,"/app/wf/WFIAActionEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFIAActionEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfiaactioneditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFIAActionEditViewControllerBase.js?v=170_20171123142053' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionEditViewController.js?v=170_20171123142053' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFIAActionEditViewController({appctx:'${ctx2}',webctx:'${web}'});
