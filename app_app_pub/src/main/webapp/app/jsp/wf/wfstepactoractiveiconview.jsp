...
<% if(!p.init(pageContext,"/app/wf/WFStepActorActiveIconView.do")){return;}%>
...
<%@include file="../../lib/wfstepactorviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/wfstepactorview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorActiveIconView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactoractiveiconview_part.jsp"/>
...
<%@include file="../../lib/wfstepactorviewlib-script.jsp"%>
<script src='${ctx}/js/wf/WFStepActorActiveIconViewControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorActiveIconViewController.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorActiveIconViewController({appctx:'${ctx2}',webctx:'${web}'});
