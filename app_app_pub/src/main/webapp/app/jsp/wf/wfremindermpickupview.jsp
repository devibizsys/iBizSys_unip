...
<% if(!p.init(pageContext,"/app/wf/WFReminderMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFReminderMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfremindermpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFReminderPickupGridViewControllerBase.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFReminderPickupGridViewController.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFReminderMPickupViewControllerBase.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFReminderMPickupViewController.js?v=189_20171123141957' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFReminderMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
