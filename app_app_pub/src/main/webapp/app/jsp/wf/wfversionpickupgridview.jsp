...
<% if(!p.init(pageContext,"/app/wf/WFVersionPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFVersionPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfversionpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFVersionPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
