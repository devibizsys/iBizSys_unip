...
<% if(!p.init(pageContext,"/app/wf/WFReminderPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFReminderPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfreminderpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFReminderPickupViewControllerBase.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFReminderPickupViewController.js?v=189_20171123141957' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFReminderPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
