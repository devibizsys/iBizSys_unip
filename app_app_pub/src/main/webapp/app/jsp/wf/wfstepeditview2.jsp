...
<% if(!p.init(pageContext,"/app/wf/WFStepEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepeditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFTmpStepActorGridViewControllerBase.js?v=150_20171123141952' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFTmpStepActorGridViewController.js?v=150_20171123141952' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionGridViewControllerBase.js?v=170_20171123142053' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionGridViewController.js?v=170_20171123142053' type='text/javascript'></script>
...
<script src='${ctx}/js/wf/WFStepEditView2ControllerBase.js?v=318_20171123142039' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepEditView2Controller.js?v=318_20171123142039' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
