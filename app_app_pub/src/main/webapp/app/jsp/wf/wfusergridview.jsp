...
<% if(!p.init(pageContext,"/app/wf/WFUserGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusergridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserGridViewControllerBase.js?v=1036_20171123142058' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGridViewController.js?v=1036_20171123142058' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserGridViewController({appctx:'${ctx2}',webctx:'${web}'});
