...
<% if(!p.init(pageContext,"/app/wf/WFStepInstEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepInstEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepinsteditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepInstEditViewControllerBase.js?v=202_20171123142018' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepInstEditViewController.js?v=202_20171123142018' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepInstEditViewController({appctx:'${ctx2}',webctx:'${web}'});
