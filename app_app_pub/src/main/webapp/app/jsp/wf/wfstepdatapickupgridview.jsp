...
<% if(!p.init(pageContext,"/app/wf/WFStepDataPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdatapickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepDataPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
