...
<% if(!p.init(pageContext,"/app/wf/WFUCPolicyEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUCPolicyEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfucpolicyeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUCPolicyEditViewControllerBase.js?v=231_20171123142106' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUCPolicyEditViewController.js?v=231_20171123142106' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUCPolicyEditViewController({appctx:'${ctx2}',webctx:'${web}'});
