...
<% if(!p.init(pageContext,"/app/wf/WFActionPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActionPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactionpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActionPickupViewControllerBase.js?v=120_20171123142010' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActionPickupViewController.js?v=120_20171123142010' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActionPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
