...
<% if(!p.init(pageContext,"/app/wf/WFUCPolicyMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUCPolicyMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfucpolicympickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUCPolicyPickupGridViewControllerBase.js?v=231_20171123142106' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUCPolicyPickupGridViewController.js?v=231_20171123142106' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUCPolicyMPickupViewControllerBase.js?v=231_20171123142106' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUCPolicyMPickupViewController.js?v=231_20171123142106' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUCPolicyMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
