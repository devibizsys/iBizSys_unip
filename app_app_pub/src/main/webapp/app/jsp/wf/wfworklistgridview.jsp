...
<% if(!p.init(pageContext,"/app/wf/WFWorkListGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkListGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworklistgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFWorkListGridViewController({appctx:'${ctx2}',webctx:'${web}'});
