...
<% if(!p.init(pageContext,"/app/wf/WFWorkflowEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkflowEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworkfloweditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFWorkflowEditViewControllerBase.js?v=369_20171123141925' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkflowEditViewController.js?v=369_20171123141925' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFWorkflowEditViewController({appctx:'${ctx2}',webctx:'${web}'});
