...
<% if(!p.init(pageContext,"/app/wf/WFAppSettingEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFAppSettingEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfappsettingeditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFAppSettingEditView2ControllerBase.js?v=137_20171123142012' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFAppSettingEditView2Controller.js?v=137_20171123142012' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFAppSettingEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
