...
<% if(!p.init(pageContext,"/app/wf/WFVersionEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFVersionEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfversioneditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFVersionEditViewControllerBase.js?v=160_20171123142101' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFVersionEditViewController.js?v=160_20171123142101' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFVersionEditViewController({appctx:'${ctx2}',webctx:'${web}'});
