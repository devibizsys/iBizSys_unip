...
<% if(!p.init(pageContext,"/app/wf/WFActionPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActionPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactionpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFActionPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
