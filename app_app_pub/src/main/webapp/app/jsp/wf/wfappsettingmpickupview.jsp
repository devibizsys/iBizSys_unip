...
<% if(!p.init(pageContext,"/app/wf/WFAppSettingMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFAppSettingMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfappsettingmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFAppSettingPickupGridViewControllerBase.js?v=137_20171123142012' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFAppSettingPickupGridViewController.js?v=137_20171123142012' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFAppSettingMPickupViewControllerBase.js?v=137_20171123142012' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFAppSettingMPickupViewController.js?v=137_20171123142012' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFAppSettingMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
