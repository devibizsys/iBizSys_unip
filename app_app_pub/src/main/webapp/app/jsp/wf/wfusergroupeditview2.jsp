...
<% if(!p.init(pageContext,"/app/wf/WFUserGroupEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserGroupEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusergroupeditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserGroupEditView2ControllerBase.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupEditView2Controller.js?v=134_20171123142055' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserGroupEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
