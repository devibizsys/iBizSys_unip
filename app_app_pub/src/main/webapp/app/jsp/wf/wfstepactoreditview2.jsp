...
<% if(!p.init(pageContext,"/app/wf/WFStepActorEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactoreditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepActorEditView2ControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorEditView2Controller.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
