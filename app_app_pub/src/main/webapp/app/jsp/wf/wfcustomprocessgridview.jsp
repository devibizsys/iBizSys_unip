...
<% if(!p.init(pageContext,"/app/wf/WFCustomProcessGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFCustomProcessGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfcustomprocessgridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFCustomProcessGridViewControllerBase.js?v=105_20171123142007' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFCustomProcessGridViewController.js?v=105_20171123142007' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFCustomProcessGridViewController({appctx:'${ctx2}',webctx:'${web}'});
