...
<% if(!p.init(pageContext,"/app/wf/WFIAActionEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFIAActionEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfiaactioneditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFIAActionEditView2ControllerBase.js?v=170_20171123142053' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionEditView2Controller.js?v=170_20171123142053' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFIAActionEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
