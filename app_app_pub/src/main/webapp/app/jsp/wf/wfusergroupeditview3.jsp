...
<% if(!p.init(pageContext,"/app/wf/WFUserGroupEditView3.do")){return;}%>
...
<jsp:include page="../../templ/deeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserGroupEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusergroupeditview3_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserGroupEditView3ControllerBase.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupEditView3Controller.js?v=134_20171123142055' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserGroupEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
