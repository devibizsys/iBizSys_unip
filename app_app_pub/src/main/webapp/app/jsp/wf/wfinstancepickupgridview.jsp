...
<% if(!p.init(pageContext,"/app/wf/WFInstancePickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFInstancePickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfinstancepickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFInstancePickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
