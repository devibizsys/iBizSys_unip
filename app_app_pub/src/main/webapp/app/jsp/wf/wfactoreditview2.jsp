...
<% if(!p.init(pageContext,"/app/wf/WFActorEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActorEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactoreditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActorEditView2ControllerBase.js?v=139_20171123142033' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActorEditView2Controller.js?v=139_20171123142033' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActorEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
