...
<% if(!p.init(pageContext,"/app/wf/WFUserCandidateGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserCandidateGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusercandidategridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFUserCandidateGridViewController({appctx:'${ctx2}',webctx:'${web}'});
