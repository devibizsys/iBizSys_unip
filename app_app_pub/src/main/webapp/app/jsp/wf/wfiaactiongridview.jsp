...
<% if(!p.init(pageContext,"/app/wf/WFIAActionGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFIAActionGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfiaactiongridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFIAActionGridViewController({appctx:'${ctx2}',webctx:'${web}'});
