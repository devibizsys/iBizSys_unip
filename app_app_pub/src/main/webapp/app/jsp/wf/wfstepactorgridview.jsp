...
<% if(!p.init(pageContext,"/app/wf/WFStepActorGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactorgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepActorGridViewController({appctx:'${ctx2}',webctx:'${web}'});
