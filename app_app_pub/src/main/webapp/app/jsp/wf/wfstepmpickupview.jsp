...
<% if(!p.init(pageContext,"/app/wf/WFStepMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepPickupGridViewControllerBase.js?v=318_20171123142039' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepPickupGridViewController.js?v=318_20171123142039' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepMPickupViewControllerBase.js?v=318_20171123142039' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepMPickupViewController.js?v=318_20171123142039' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
