...
<% if(!p.init(pageContext,"/app/wf/WFCustomProcessMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFCustomProcessMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfcustomprocessmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFCustomProcessPickupGridViewControllerBase.js?v=105_20171123142007' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFCustomProcessPickupGridViewController.js?v=105_20171123142007' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFCustomProcessMPickupViewControllerBase.js?v=105_20171123142007' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFCustomProcessMPickupViewController.js?v=105_20171123142007' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFCustomProcessMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
