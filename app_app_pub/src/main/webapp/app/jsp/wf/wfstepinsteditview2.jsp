...
<% if(!p.init(pageContext,"/app/wf/WFStepInstEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepInstEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepinsteditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepInstEditView2ControllerBase.js?v=202_20171123142018' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepInstEditView2Controller.js?v=202_20171123142018' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepInstEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
