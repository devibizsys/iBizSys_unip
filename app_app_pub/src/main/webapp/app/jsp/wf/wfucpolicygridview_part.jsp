...
<%@include file="wfucpolicygridview_userpart.jsp"%>
...
<!--分割符号-->
<button title="启用策略"  data-ibiz-tag="EnablePolicy" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >启用策略</span>  </button>  
<button title="禁用策略"  data-ibiz-tag="DisablePolicy" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >禁用策略</span>  </button>  
<!--分割符号-->
<!--操作集合-->
<!--分割符号-->
