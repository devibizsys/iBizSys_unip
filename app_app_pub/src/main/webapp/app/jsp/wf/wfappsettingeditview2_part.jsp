...
<%@include file="wfappsettingeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M17"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M16"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M15"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M14"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M13"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M12"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M11"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M10"><INPUT type="hidden" name="wfappsettingid" id="<%=strCId%>Me"><INPUT type="hidden" name="remindmsgtempid" id="<%=strCId%>Mf">
...
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>系统流程设置</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
<div id='<%=strCId%>M5__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  >系统工作流设定</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M5_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="wfappsettingname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >催办消息模板</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
	...
	<div class="ibiz-field-picker">
		<div>
			...
			<input type="text" class="form-control text" name="remindmsgtemplname" id="<%=strCId%>M6" autocomplete="off" />
		</div>
	</div>
</div>
	</div>
