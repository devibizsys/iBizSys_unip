...
<% if(!p.init(pageContext,"/app/wf/WFStepActorEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactoreditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepActorEditViewControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorEditViewController.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorEditViewController({appctx:'${ctx2}',webctx:'${web}'});
