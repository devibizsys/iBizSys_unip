...
<% if(!p.init(pageContext,"/app/wf/WFInstanceEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFInstanceEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfinstanceeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFInstanceEditViewControllerBase.js?v=486_20171123141937' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFInstanceEditViewController.js?v=486_20171123141937' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFInstanceEditViewController({appctx:'${ctx2}',webctx:'${web}'});
