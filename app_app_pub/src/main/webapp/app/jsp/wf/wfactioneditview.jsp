...
<% if(!p.init(pageContext,"/app/wf/WFActionEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActionEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactioneditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActionEditViewControllerBase.js?v=120_20171123142010' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActionEditViewController.js?v=120_20171123142010' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActionEditViewController({appctx:'${ctx2}',webctx:'${web}'});
