...
<% if(!p.init(pageContext,"/app/wf/WFActionMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActionMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactionmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActionPickupGridViewControllerBase.js?v=120_20171123142010' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActionPickupGridViewController.js?v=120_20171123142010' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActionMPickupViewControllerBase.js?v=120_20171123142010' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActionMPickupViewController.js?v=120_20171123142010' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActionMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
