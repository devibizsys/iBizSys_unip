...
<% if(!p.init(pageContext,"/app/wf/WFVersionGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFVersionGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfversiongridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFVersionGridViewController({appctx:'${ctx2}',webctx:'${web}'});
