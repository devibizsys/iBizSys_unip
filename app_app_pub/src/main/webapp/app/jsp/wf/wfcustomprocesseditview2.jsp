...
<% if(!p.init(pageContext,"/app/wf/WFCustomProcessEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFCustomProcessEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfcustomprocesseditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFCustomProcessEditView2ControllerBase.js?v=105_20171123142007' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFCustomProcessEditView2Controller.js?v=105_20171123142007' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFCustomProcessEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
