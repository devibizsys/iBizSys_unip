...
<% if(!p.init(pageContext,"/app/wf/WFStepInstPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepInstPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepinstpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepInstPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
