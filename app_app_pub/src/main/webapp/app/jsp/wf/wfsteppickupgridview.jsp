...
<% if(!p.init(pageContext,"/app/wf/WFStepPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfsteppickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
