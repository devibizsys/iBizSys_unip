...
<% if(!p.init(pageContext,"/app/wf/WFStepInstPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepInstPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepinstpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepInstPickupViewControllerBase.js?v=202_20171123142018' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepInstPickupViewController.js?v=202_20171123142018' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepInstPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
