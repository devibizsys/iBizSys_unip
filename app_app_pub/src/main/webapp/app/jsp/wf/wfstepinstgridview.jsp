...
<% if(!p.init(pageContext,"/app/wf/WFStepInstGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepInstGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepinstgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepInstGridViewController({appctx:'${ctx2}',webctx:'${web}'});
