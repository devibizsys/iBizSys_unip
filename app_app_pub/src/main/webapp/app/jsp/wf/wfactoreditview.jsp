...
<% if(!p.init(pageContext,"/app/wf/WFActorEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActorEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactoreditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActorEditViewControllerBase.js?v=139_20171123142033' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActorEditViewController.js?v=139_20171123142033' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActorEditViewController({appctx:'${ctx2}',webctx:'${web}'});
