...
<%@include file="wfusergroupeditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>Mb"><INPUT type="hidden" name="srforikey" id="<%=strCId%>Ma"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M9"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M8"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M7"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M6"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M5"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M4"><INPUT type="hidden" name="wfusergroupid" id="<%=strCId%>M3">
