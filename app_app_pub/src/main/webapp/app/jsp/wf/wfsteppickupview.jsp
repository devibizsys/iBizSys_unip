...
<% if(!p.init(pageContext,"/app/wf/WFStepPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfsteppickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepPickupViewControllerBase.js?v=318_20171123142039' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepPickupViewController.js?v=318_20171123142039' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
