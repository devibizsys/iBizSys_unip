...
<% if(!p.init(pageContext,"/app/wf/WFStepDataEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdataeditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepDataEditView2ControllerBase.js?v=414_20171123141945' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepDataEditView2Controller.js?v=414_20171123141945' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepDataEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
