...
<% if(!p.init(pageContext,"/app/wf/WFUIWizardGotoOptionView.do")){return;}%>
...
<%@include file="../../lib/deoptviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/deoptview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUIWizardGotoOptionView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuiwizardgotooptionview_part.jsp"/>
...
<%@include file="../../lib/deoptviewlib-script.jsp"%>
<script src='${ctx}/js/wf/WFUIWizardGotoOptionViewControllerBase.js?v=171_20171123142015' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUIWizardGotoOptionViewController.js?v=171_20171123142015' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUIWizardGotoOptionViewController({appctx:'${ctx2}',webctx:'${web}'});
