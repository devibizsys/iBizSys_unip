...
<% if(!p.init(pageContext,"/app/wf/WFAssistWorkGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFAssistWorkGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfassistworkgridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFAssistWorkGridViewControllerBase.js?v=231_20171123142026' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFAssistWorkGridViewController.js?v=231_20171123142026' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFAssistWorkGridViewController({appctx:'${ctx2}',webctx:'${web}'});
