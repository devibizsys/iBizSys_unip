...
<%@include file="wfusergroupeditview3_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M16"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M15"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M14"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M13"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M12"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M11"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M10"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Mf"><INPUT type="hidden" name="wfusergroupid" id="<%=strCId%>Me">
...
<div class="tab-content ">
  <div class="tab-pane active row" id="<%=strCId%>form_formpage1_tab" ><div id="<%=strCId%>M5" name="grouppanel2" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
<div class="panel-heading panel-text grouppanel2_text"  style="height:40px;" ><h5>工作流用户组信息</h5></div>
</div>
<div id="<%=strCId%>M5_gd" >
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-md-4 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >用户组名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M6_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M6" name="wfusergroupname" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >备注</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M7_c" >
...
<div class="input-group-btn ibiz-id-dropdown">
  ...
  <div class="tab-pane  row" id="<%=strCId%>form_formpage2_tab" ><div id="<%=strCId%>M9" name="grouppanel1" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
...
<li class="active"><a href="#<%=strCId%>drtab_form" data-toggle="tab">工作流用户组</a></li>
<li id="<%=strCId%>drtab_h_DRITEM1"><a href="#<%=strCId%>drtab_DRITEM1" data-toggle="tab">组成员</a></li>
</ul>
<% return;} %>
