...
<% if(!p.init(pageContext,"/app/wf/WFUserGroupGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserGroupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusergroupgridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserGroupGridViewControllerBase.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupGridViewController.js?v=134_20171123142055' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserGroupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
