...
<% if(!p.init(pageContext,"/app/wf/WFUIWizardEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUIWizardEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuiwizardeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUIWizardEditViewControllerBase.js?v=171_20171123142015' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUIWizardEditViewController.js?v=171_20171123142015' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUIWizardEditViewController({appctx:'${ctx2}',webctx:'${web}'});
