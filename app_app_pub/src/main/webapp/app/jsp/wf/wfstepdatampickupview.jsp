...
<% if(!p.init(pageContext,"/app/wf/WFStepDataMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdatampickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepDataMPickupViewControllerBase.js?v=414_20171123141945' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepDataMPickupViewController.js?v=414_20171123141945' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepDataMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
