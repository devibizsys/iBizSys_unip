...
<% if(!p.init(pageContext,"/app/wf/WFUserMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusermpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserPickupGridViewControllerBase.js?v=1036_20171123142058' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserPickupGridViewController.js?v=1036_20171123142058' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserMPickupViewControllerBase.js?v=1036_20171123142058' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserMPickupViewController.js?v=1036_20171123142058' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
