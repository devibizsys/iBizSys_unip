...
<% if(!p.init(pageContext,"/app/wf/WFIAActionPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFIAActionPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfiaactionpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFIAActionPickupViewControllerBase.js?v=170_20171123142053' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionPickupViewController.js?v=170_20171123142053' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFIAActionPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
