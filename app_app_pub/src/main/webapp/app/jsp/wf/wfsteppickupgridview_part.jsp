...
<%@include file="wfsteppickupgridview_userpart.jsp"%>
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="CONTROL.DEFSFITEM.WFSTEP.N_WFSTEPNAME_LIKE" text="工作流步骤名称(%)"></ibiz5:message></label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_wfstepname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
