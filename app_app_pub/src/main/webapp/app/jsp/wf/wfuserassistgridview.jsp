...
<% if(!p.init(pageContext,"/app/wf/WFUserAssistGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserAssistGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuserassistgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFUserAssistGridViewController({appctx:'${ctx2}',webctx:'${web}'});
