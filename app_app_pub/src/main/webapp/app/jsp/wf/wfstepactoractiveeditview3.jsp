...
<% if(!p.init(pageContext,"/app/wf/WFStepActorActiveEditView3.do")){return;}%>
...
<jsp:include page="../../templ/deeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorActiveEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactoractiveeditview3_part.jsp"/>
...
<script src='${ctx}/js/wf/WFReminderActiveGridViewControllerBase.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFReminderActiveGridViewController.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorActiveEditView3ControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorActiveEditView3Controller.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorActiveEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
