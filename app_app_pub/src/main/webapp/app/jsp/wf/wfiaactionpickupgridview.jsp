...
<% if(!p.init(pageContext,"/app/wf/WFIAActionPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFIAActionPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfiaactionpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFIAActionPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
