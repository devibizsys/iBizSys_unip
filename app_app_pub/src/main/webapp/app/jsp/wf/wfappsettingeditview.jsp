...
<% if(!p.init(pageContext,"/app/wf/WFAppSettingEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFAppSettingEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfappsettingeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFAppSettingEditViewControllerBase.js?v=137_20171123142012' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFAppSettingEditViewController.js?v=137_20171123142012' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFAppSettingEditViewController({appctx:'${ctx2}',webctx:'${web}'});
