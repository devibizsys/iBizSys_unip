...
<% if(!p.init(pageContext,"/app/wf/WFReminderEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFReminderEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfremindereditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFReminderEditView2ControllerBase.js?v=189_20171123141957' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFReminderEditView2Controller.js?v=189_20171123141957' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFReminderEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
