...
<% if(!p.init(pageContext,"/app/wf/WFTmpStepActorGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFTmpStepActorGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wftmpstepactorgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFTmpStepActorGridViewController({appctx:'${ctx2}',webctx:'${web}'});
