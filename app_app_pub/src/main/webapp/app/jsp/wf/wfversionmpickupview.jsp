...
<% if(!p.init(pageContext,"/app/wf/WFVersionMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFVersionMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfversionmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFVersionMPickupViewControllerBase.js?v=160_20171123142101' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFVersionMPickupViewController.js?v=160_20171123142101' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFVersionMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
