...
<% if(!p.init(pageContext,"/app/wf/WFTmpStepActorEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFTmpStepActorEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wftmpstepactoreditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFTmpStepActorEditViewControllerBase.js?v=150_20171123141952' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFTmpStepActorEditViewController.js?v=150_20171123141952' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFTmpStepActorEditViewController({appctx:'${ctx2}',webctx:'${web}'});
