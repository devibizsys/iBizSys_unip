...
<% if(!p.init(pageContext,"/app/wf/WFAssistWorkEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFAssistWorkEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfassistworkeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFAssistWorkEditViewControllerBase.js?v=231_20171123142026' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFAssistWorkEditViewController.js?v=231_20171123142026' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFAssistWorkEditViewController({appctx:'${ctx2}',webctx:'${web}'});
