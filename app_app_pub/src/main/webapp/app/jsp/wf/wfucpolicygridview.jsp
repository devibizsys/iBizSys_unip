...
<% if(!p.init(pageContext,"/app/wf/WFUCPolicyGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUCPolicyGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfucpolicygridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUCPolicyGridViewControllerBase.js?v=231_20171123142106' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUCPolicyGridViewController.js?v=231_20171123142106' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUCPolicyGridViewController({appctx:'${ctx2}',webctx:'${web}'});
