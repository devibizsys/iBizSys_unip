...
<% if(!p.init(pageContext,"/app/wf/WFUserEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusereditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserEditViewControllerBase.js?v=1036_20171123142058' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserEditViewController.js?v=1036_20171123142058' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserEditViewController({appctx:'${ctx2}',webctx:'${web}'});
