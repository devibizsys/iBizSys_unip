...
<% if(!p.init(pageContext,"/app/wf/WFInstanceGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFInstanceGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfinstancegridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFInstanceGridViewController({appctx:'${ctx2}',webctx:'${web}'});
