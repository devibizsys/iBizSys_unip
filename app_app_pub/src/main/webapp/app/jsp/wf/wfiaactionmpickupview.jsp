...
<% if(!p.init(pageContext,"/app/wf/WFIAActionMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFIAActionMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfiaactionmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFIAActionPickupGridViewControllerBase.js?v=170_20171123142053' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionPickupGridViewController.js?v=170_20171123142053' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionMPickupViewControllerBase.js?v=170_20171123142053' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFIAActionMPickupViewController.js?v=170_20171123142053' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFIAActionMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
