...
<% if(!p.init(pageContext,"/app/wf/WFUIWizardGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUIWizardGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuiwizardgridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUIWizardGridViewControllerBase.js?v=171_20171123142015' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUIWizardGridViewController.js?v=171_20171123142015' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUIWizardGridViewController({appctx:'${ctx2}',webctx:'${web}'});
