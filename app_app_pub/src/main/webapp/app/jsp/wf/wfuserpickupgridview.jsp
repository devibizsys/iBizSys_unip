...
<% if(!p.init(pageContext,"/app/wf/WFUserPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuserpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFUserPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
