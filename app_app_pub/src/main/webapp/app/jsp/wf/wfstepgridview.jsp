...
<% if(!p.init(pageContext,"/app/wf/WFStepGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepGridViewController({appctx:'${ctx2}',webctx:'${web}'});
