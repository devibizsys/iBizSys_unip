...
<% if(!p.init(pageContext,"/app/wf/WFStepActorPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactorpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepActorPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
