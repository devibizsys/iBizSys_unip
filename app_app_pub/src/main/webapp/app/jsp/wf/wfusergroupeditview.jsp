...
<% if(!p.init(pageContext,"/app/wf/WFUserGroupEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserGroupEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusergroupeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserGroupEditViewControllerBase.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupEditViewController.js?v=134_20171123142055' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserGroupEditViewController({appctx:'${ctx2}',webctx:'${web}'});
