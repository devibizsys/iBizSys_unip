...
<%@include file="wfuserassisteditview2_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M1b"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M1a"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M19"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M18"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M17"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M16"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M15"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M14"><INPUT type="hidden" name="wfminoruserid" id="<%=strCId%>M10"><INPUT type="hidden" name="wfuserassistid" id="<%=strCId%>M11"><INPUT type="hidden" name="wfmajoruserid" id="<%=strCId%>M12"><INPUT type="hidden" name="wfworkflowid" id="<%=strCId%>M13">
...
<div class="tab-content ">
  <div class="tab-pane active row" id="<%=strCId%>form_formpage1_tab" ><div id="<%=strCId%>M4" name="grouppanel2" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
<div class="panel-heading panel-text grouppanel2_text"  style="height:40px;" ><h5>流程代办策略信息</h5></div>
</div>
<div id="<%=strCId%>M4_gd" >
...
<div id='<%=strCId%>M6__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M6__lb' class="control-label" style="width:130px;"  >工作流代办用户</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >工作流</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<div id='<%=strCId%>M8__fi' style="" class="ibiz-form-formitem  col-sm-6 col-md-6 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M8__lb' class="control-label" style="width:130px;"  >代办步骤</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M8_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M8" name="wfstep" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<div class="input-group-btn ibiz-id-dropdown">
  ...
  <div class="tab-pane  row" id="<%=strCId%>form_formpage2_tab" ><div id="<%=strCId%>Mb" name="grouppanel1" style="" class="ibiz-form-formgroup  col-md-12 ">
<fieldset style="border: 1px solid #e5e5e5;margin-bottom:10px;">
<div class="panel panel-success">
<div class="panel-heading panel-text grouppanel1_text"  style="height:40px;" ><h5>操作信息</h5></div>
</div>
<div id="<%=strCId%>Mb_gd" >
