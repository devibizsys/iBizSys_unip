...
<% if(!p.init(pageContext,"/app/wf/WFTmpStepActorMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFTmpStepActorMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wftmpstepactormpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFTmpStepActorPickupGridViewControllerBase.js?v=150_20171123141952' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFTmpStepActorPickupGridViewController.js?v=150_20171123141952' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFTmpStepActorMPickupViewControllerBase.js?v=150_20171123141952' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFTmpStepActorMPickupViewController.js?v=150_20171123141952' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFTmpStepActorMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
