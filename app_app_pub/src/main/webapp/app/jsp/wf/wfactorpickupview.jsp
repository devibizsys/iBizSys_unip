...
<% if(!p.init(pageContext,"/app/wf/WFActorPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActorPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactorpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActorPickupViewControllerBase.js?v=139_20171123142033' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActorPickupViewController.js?v=139_20171123142033' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActorPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
