...
<% if(!p.init(pageContext,"/app/wf/WFUserAssistEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserAssistEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuserassisteditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserAssistEditViewControllerBase.js?v=185_20171123142043' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserAssistEditViewController.js?v=185_20171123142043' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserAssistEditViewController({appctx:'${ctx2}',webctx:'${web}'});
