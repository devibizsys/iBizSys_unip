...
<% if(!p.init(pageContext,"/app/wf/WFActionEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActionEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactioneditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActionEditView2ControllerBase.js?v=120_20171123142010' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActionEditView2Controller.js?v=120_20171123142010' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActionEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
