...
<% if(!p.init(pageContext,"/app/wf/WFUIWizardEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUIWizardEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuiwizardeditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUIWizardEditView2ControllerBase.js?v=171_20171123142015' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUIWizardEditView2Controller.js?v=171_20171123142015' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUIWizardEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
