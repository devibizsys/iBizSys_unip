...
<% if(!p.init(pageContext,"/app/wf/WFWorkListEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkListEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworklisteditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFWorkListEditView2ControllerBase.js?v=239_20171123142049' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkListEditView2Controller.js?v=239_20171123142049' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFWorkListEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
