...
<% if(!p.init(pageContext,"/app/wf/WFStepDataTraceChartView.do")){return;}%>
...
<%@include file="../../lib/wftracechartviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/wftracechartview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataTraceChartView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdatatracechartview_part.jsp"/>
...
<%@include file="../../lib/wftracechartviewlib-script.jsp"%>
<script src='${ctx}/js/wf/WFStepDataTraceChartViewControllerBase.js?v=414_20171123141945' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepDataTraceChartViewController.js?v=414_20171123141945' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepDataTraceChartViewController({appctx:'${ctx2}',webctx:'${web}'});
