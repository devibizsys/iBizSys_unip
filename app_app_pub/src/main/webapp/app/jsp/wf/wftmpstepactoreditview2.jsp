...
<% if(!p.init(pageContext,"/app/wf/WFTmpStepActorEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFTmpStepActorEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wftmpstepactoreditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFTmpStepActorEditView2ControllerBase.js?v=150_20171123141952' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFTmpStepActorEditView2Controller.js?v=150_20171123141952' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFTmpStepActorEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
