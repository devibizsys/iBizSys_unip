...
<% if(!p.init(pageContext,"/app/wf/WFWorkListEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkListEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworklisteditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFWorkListEditViewControllerBase.js?v=239_20171123142049' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkListEditViewController.js?v=239_20171123142049' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFWorkListEditViewController({appctx:'${ctx2}',webctx:'${web}'});
