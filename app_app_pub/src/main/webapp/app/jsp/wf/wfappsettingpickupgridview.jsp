...
<% if(!p.init(pageContext,"/app/wf/WFAppSettingPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFAppSettingPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfappsettingpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFAppSettingPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
