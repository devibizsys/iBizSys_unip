...
<% if(!p.init(pageContext,"/app/wf/WFCustomProcessEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFCustomProcessEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfcustomprocesseditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFCustomProcessEditViewControllerBase.js?v=105_20171123142007' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFCustomProcessEditViewController.js?v=105_20171123142007' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFCustomProcessEditViewController({appctx:'${ctx2}',webctx:'${web}'});
