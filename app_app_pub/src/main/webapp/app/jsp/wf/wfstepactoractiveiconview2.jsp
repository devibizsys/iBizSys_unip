...
<% if(!p.init(pageContext,"/app/wf/WFStepActorActiveIconView2.do")){return;}%>
...
<%@include file="../../lib/wfstepactorview2lib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/wfstepactorview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorActiveIconView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactoractiveiconview2_part.jsp"/>
...
<%@include file="../../lib/wfstepactorview2lib-script.jsp"%>
<script src='${ctx}/js/wf/WFStepActorActiveIconView2ControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorActiveIconView2Controller.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorActiveIconView2Controller({appctx:'${ctx2}',webctx:'${web}'});
