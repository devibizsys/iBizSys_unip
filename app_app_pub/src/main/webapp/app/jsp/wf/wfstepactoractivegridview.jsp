...
<% if(!p.init(pageContext,"/app/wf/WFStepActorActiveGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorActiveGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactoractivegridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepActorActiveGridViewControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorActiveGridViewController.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorActiveGridViewController({appctx:'${ctx2}',webctx:'${web}'});
