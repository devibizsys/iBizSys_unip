...
<% if(!p.init(pageContext,"/app/wf/WFInstancePickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFInstancePickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfinstancepickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFInstancePickupViewControllerBase.js?v=486_20171123141937' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFInstancePickupViewController.js?v=486_20171123141937' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFInstancePickupViewController({appctx:'${ctx2}',webctx:'${web}'});
