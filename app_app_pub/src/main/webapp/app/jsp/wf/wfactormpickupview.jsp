...
<% if(!p.init(pageContext,"/app/wf/WFActorMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActorMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactormpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActorPickupGridViewControllerBase.js?v=139_20171123142033' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActorPickupGridViewController.js?v=139_20171123142033' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActorMPickupViewControllerBase.js?v=139_20171123142033' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActorMPickupViewController.js?v=139_20171123142033' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActorMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
