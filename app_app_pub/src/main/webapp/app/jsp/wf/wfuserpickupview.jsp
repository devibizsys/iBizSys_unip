...
<% if(!p.init(pageContext,"/app/wf/WFUserPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuserpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserPickupViewControllerBase.js?v=1036_20171123142058' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserPickupViewController.js?v=1036_20171123142058' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
