...
<% if(!p.init(pageContext,"/app/wf/WFStepActorMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactormpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepActorPickupGridViewControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorPickupGridViewController.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorMPickupViewControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorMPickupViewController.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
