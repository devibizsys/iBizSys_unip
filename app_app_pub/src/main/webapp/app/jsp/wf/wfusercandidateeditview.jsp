...
<% if(!p.init(pageContext,"/app/wf/WFUserCandidateEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserCandidateEditView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusercandidateeditview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserCandidateEditViewControllerBase.js?v=177_20171123142031' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserCandidateEditViewController.js?v=177_20171123142031' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserCandidateEditViewController({appctx:'${ctx2}',webctx:'${web}'});
