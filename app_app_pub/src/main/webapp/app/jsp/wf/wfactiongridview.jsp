...
<% if(!p.init(pageContext,"/app/wf/WFActionGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActionGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactiongridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFActionGridViewController({appctx:'${ctx2}',webctx:'${web}'});
