...
<% if(!p.init(pageContext,"/app/wf/WFUserGroupMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserGroupMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusergroupmpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserGroupPickupGridViewControllerBase.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupPickupGridViewController.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupMPickupViewControllerBase.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupMPickupViewController.js?v=134_20171123142055' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserGroupMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
