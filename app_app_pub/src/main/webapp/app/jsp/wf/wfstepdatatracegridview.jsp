...
<% if(!p.init(pageContext,"/app/wf/WFStepDataTraceGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataTraceGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdatatracegridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepDataTraceGridViewControllerBase.js?v=414_20171123141945' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepDataTraceGridViewController.js?v=414_20171123141945' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepDataTraceGridViewController({appctx:'${ctx2}',webctx:'${web}'});
