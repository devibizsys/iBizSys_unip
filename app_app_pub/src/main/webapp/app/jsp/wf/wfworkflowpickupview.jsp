...
<% if(!p.init(pageContext,"/app/wf/WFWorkflowPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFWorkflowPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfworkflowpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFWorkflowPickupViewControllerBase.js?v=369_20171123141925' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFWorkflowPickupViewController.js?v=369_20171123141925' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFWorkflowPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
