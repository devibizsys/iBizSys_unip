...
<% if(!p.init(pageContext,"/app/wf/WFActorGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFActorGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfactorgridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFActorGridViewControllerBase.js?v=139_20171123142033' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFActorGridViewController.js?v=139_20171123142033' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFActorGridViewController({appctx:'${ctx2}',webctx:'${web}'});
