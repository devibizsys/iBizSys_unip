...
<% if(!p.init(pageContext,"/app/wf/WFDynamicUserGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFDynamicUserGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfdynamicusergridview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFDynamicUserGridViewControllerBase.js?v=104_20171123142020' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFDynamicUserGridViewController.js?v=104_20171123142020' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFDynamicUserGridViewController({appctx:'${ctx2}',webctx:'${web}'});
