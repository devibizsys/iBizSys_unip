...
<% if(!p.init(pageContext,"/app/wf/WFStepDataTimelineView.do")){return;}%>
...
<%@include file="../../lib/wftimelineviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/wftimelineview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataTimelineView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdatatimelineview_part.jsp"/>
...
<%@include file="../../lib/wftimelineviewlib-script.jsp"%>
<script src='${ctx}/js/wf/WFStepDataTimelineViewControllerBase.js?v=414_20171123141945' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepDataTimelineViewController.js?v=414_20171123141945' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepDataTimelineViewController({appctx:'${ctx2}',webctx:'${web}'});
