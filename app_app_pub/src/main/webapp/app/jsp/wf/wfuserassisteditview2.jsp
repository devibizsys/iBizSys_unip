...
<% if(!p.init(pageContext,"/app/wf/WFUserAssistEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserAssistEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfuserassisteditview2_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserAssistEditView2ControllerBase.js?v=185_20171123142043' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserAssistEditView2Controller.js?v=185_20171123142043' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserAssistEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
