...
<% if(!p.init(pageContext,"/app/wf/WFStepActorPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepActorPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepactorpickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFStepActorPickupViewControllerBase.js?v=310_20171123142003' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFStepActorPickupViewController.js?v=310_20171123142003' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFStepActorPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
