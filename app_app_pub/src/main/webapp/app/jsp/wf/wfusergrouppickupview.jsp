...
<% if(!p.init(pageContext,"/app/wf/WFUserGroupPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFUserGroupPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfusergrouppickupview_part.jsp"/>
...
<script src='${ctx}/js/wf/WFUserGroupPickupViewControllerBase.js?v=134_20171123142055' type='text/javascript'></script>
<script src='${ctx}/js/wf/WFUserGroupPickupViewController.js?v=134_20171123142055' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new WFUserGroupPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
