...
<% if(!p.init(pageContext,"/app/wf/WFStepDataGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/wf/WFStepDataGridView.do"/>
	<jsp:param name="parturl" value="../jsp/wf/wfstepdatagridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new WFStepDataGridViewController({appctx:'${ctx2}',webctx:'${web}'});
