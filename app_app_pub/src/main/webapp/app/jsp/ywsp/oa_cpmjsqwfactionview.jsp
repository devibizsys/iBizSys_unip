...
<% if(!p.init(pageContext,"/app/ywsp/OA_CPMJSQWFActionView.do")){return;}%>
...
<jsp:include page="../../templ/dewfactionview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CPMJSQWFActionView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_cpmjsqwfactionview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CPMJSQWFActionViewControllerBase.js?v=1165_20180116145731' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CPMJSQWFActionViewController.js?v=1165_20180116145731' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CPMJSQWFActionViewController({appctx:'${ctx2}',webctx:'${web}'});
