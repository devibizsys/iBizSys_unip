...
<%@include file="oa_gzrzrztjlc_w10_wfeditview3_userpart.jsp"%>
...
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M1f"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M1e"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M1d"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>M1c"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>M1b"><INPUT type="hidden" name="srfuf" id="<%=strCId%>M1a"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>M19"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>M18"><INPUT type="hidden" name="oa_gzrzid" id="<%=strCId%>M6"><INPUT type="hidden" name="orguserid" id="<%=strCId%>M7"><INPUT type="hidden" name="orgusername" id="<%=strCId%>M8">
...
<div id='<%=strCId%>M9__fi' style="" class="ibiz-form-formitem  col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M9__lb' class="control-label" style="width:130px;"  >日志类型</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M9_c" style="" ><SELECT id="<%=strCId%>M9" name="rzlx" class="form-control ibiz-field-dropdownlist"></SELECT></div>
	</div>
</div>
<div id='<%=strCId%>Ma__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Ma__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.JRGZCX" text="今日工作成效"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Ma_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>Ma" name="jrgzcx"  type="text"  class="form-control" ></textarea>
...
<div id='<%=strCId%>Mb__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mb__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.MRJH" text="明日计划"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Mb_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>Mb" name="mrjh"  type="text"  class="form-control" ></textarea>
<div class="input-group-btn ibiz-id-dropdown">
	<button type="button" class="btn default dropdown-toggle"
		data-toggle="dropdown">
		<i class="fa fa-angle-down"></i>
...
<div id='<%=strCId%>Mc__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mc__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.XXT" text="需协调"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Mc_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>Mc" name="xxt"  type="text"  class="form-control" ></textarea>
<div class="input-group-btn ibiz-id-dropdown">
	<button type="button" class="btn default dropdown-toggle"
		data-toggle="dropdown">
		<i class="fa fa-angle-down"></i>
...
<div id='<%=strCId%>Md__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Md__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.CZWT" text="存在问题"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Md_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>Md" name="czwt"  type="text"  class="form-control" ></textarea>
<div class="input-group-btn ibiz-id-dropdown">
	<button type="button" class="btn default dropdown-toggle"
		data-toggle="dropdown">
		<i class="fa fa-angle-down"></i>
...
<div id='<%=strCId%>Me__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="0">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Me__lb' class="control-label" style="width:130px;"  >审批人</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Me_c" >
<div class="input-group  ibiz-field-textarea">
<textarea id="<%=strCId%>Me" name="spr"  type="text"  class="form-control" ></textarea>
<div class="input-group-btn ibiz-id-dropdown">
	<button type="button" class="btn default dropdown-toggle"
		data-toggle="dropdown">
		<i class="fa fa-angle-down"></i>
...
<div id='<%=strCId%>Mf__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>Mf__lb' class="control-label" style="width:130px;"  >抄送人</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>Mf_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>Mf" name="csr" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<div id='<%=strCId%>M11__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M11__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="DEF.LNAME.FJ" text="附件"></ibiz5:message></label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
...
<li class="active"><a href="#<%=strCId%>drtab_form" data-toggle="tab">工作日志</a></li>
</ul>
<% return;} %>
