...
<% if(!p.init(pageContext,"/app/ywsp/OA_BGYPSQPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_BGYPSQPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_bgypsqpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_BGYPSQPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
