...
<% if(!p.init(pageContext,"/app/ywsp/OA_QXJGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_QXJGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_qxjgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_QXJGridViewController({appctx:'${ctx2}',webctx:'${web}'});
