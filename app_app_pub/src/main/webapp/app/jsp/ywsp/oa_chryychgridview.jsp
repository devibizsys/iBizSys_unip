...
<% if(!p.init(pageContext,"/app/ywsp/OA_CHRYYCHGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CHRYYCHGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_chryychgridview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CHRYYCHGridViewControllerBase.js?v=871_20171220185323' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CHRYYCHGridViewController.js?v=871_20171220185323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CHRYYCHGridViewController({appctx:'${ctx2}',webctx:'${web}'});
