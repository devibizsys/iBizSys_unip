...
<% if(!p.init(pageContext,"/app/ywsp/OA_CLWXGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CLWXGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_clwxgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_CLWXGridViewController({appctx:'${ctx2}',webctx:'${web}'});
