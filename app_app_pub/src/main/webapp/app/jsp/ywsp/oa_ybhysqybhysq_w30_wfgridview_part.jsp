...
<%@include file="oa_ybhysqybhysq_w30_wfgridview_userpart.jsp"%>
...
<button title="发送座位号通知"  data-ibiz-tag="AC3010" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >发送座位号通知</span>  </button>  
<!--分割符号-->
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="CONTROL.DEFSFITEM.OA_YBHYSQ.N_OA_YBHYSQNAME_LIKE" text="会议标题"></ibiz5:message></label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M4_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M4" name="n_oa_ybhysqname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
