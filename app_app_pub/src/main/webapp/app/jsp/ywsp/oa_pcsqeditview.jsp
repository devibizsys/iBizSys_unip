...
<% if(!p.init(pageContext,"/app/ywsp/OA_PCSQEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_PCSQEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_pcsqeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_PCSQEditViewControllerBase.js?v=981_20171215112812' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_PCSQEditViewController.js?v=981_20171215112812' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_PCSQEditViewController({appctx:'${ctx2}',webctx:'${web}'});
