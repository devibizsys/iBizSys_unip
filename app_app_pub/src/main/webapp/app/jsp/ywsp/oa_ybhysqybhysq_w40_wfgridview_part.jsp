...
<%@include file="oa_ybhysqybhysq_w40_wfgridview_userpart.jsp"%>
...
<button title="入座确认"  data-ibiz-tag="AC4010" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >入座确认</span>  </button>  
<!--分割符号-->
