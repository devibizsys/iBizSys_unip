...
<% if(!p.init(pageContext,"/app/ywsp/OA_STWMDGEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_STWMDGEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_stwmdgeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_STWMDGEditViewControllerBase.js?v=1005_20171215154840' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_STWMDGEditViewController.js?v=1005_20171215154840' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_STWMDGEditViewController({appctx:'${ctx2}',webctx:'${web}'});
