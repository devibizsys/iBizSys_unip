...
<% if(!p.init(pageContext,"/app/ywsp/OA_CHRYYQJGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CHRYYQJGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_chryyqjgridview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CHRYYQJGridViewControllerBase.js?v=871_20171220185323' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CHRYYQJGridViewController.js?v=871_20171220185323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CHRYYQJGridViewController({appctx:'${ctx2}',webctx:'${web}'});
