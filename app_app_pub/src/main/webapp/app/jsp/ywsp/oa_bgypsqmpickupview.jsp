...
<% if(!p.init(pageContext,"/app/ywsp/OA_BGYPSQMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_BGYPSQMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_bgypsqmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_BGYPSQPickupGridViewControllerBase.js?v=915_20171216161624' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_BGYPSQPickupGridViewController.js?v=915_20171216161624' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_BGYPSQMPickupViewControllerBase.js?v=915_20171216161624' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_BGYPSQMPickupViewController.js?v=915_20171216161624' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_BGYPSQMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
