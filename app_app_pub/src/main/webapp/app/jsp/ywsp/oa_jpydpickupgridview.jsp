...
<% if(!p.init(pageContext,"/app/ywsp/OA_JPYDPickupGridView.do")){return;}%>
...
<jsp:include page="../../templ/depickupgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_JPYDPickupGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_jpydpickupgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_JPYDPickupGridViewController({appctx:'${ctx2}',webctx:'${web}'});
