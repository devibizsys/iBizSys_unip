...
<% if(!p.init(pageContext,"/app/ywsp/OA_XMJDPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_XMJDPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_xmjdpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_XMJDPickupViewControllerBase.js?v=897_20171219172723' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_XMJDPickupViewController.js?v=897_20171219172723' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_XMJDPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
