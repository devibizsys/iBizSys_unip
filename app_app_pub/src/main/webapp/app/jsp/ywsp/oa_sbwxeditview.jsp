...
<% if(!p.init(pageContext,"/app/ywsp/OA_SBWXEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_SBWXEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_sbwxeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_SBWXEditViewControllerBase.js?v=1042_20171215155025' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_SBWXEditViewController.js?v=1042_20171215155025' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_SBWXEditViewController({appctx:'${ctx2}',webctx:'${web}'});
