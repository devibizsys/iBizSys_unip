...
<% if(!p.init(pageContext,"/app/ywsp/OA_CGSQMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CGSQMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_cgsqmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CGSQPickupGridViewControllerBase.js?v=1179_20171215145930' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CGSQPickupGridViewController.js?v=1179_20171215145930' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CGSQMPickupViewControllerBase.js?v=1179_20171215145930' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CGSQMPickupViewController.js?v=1179_20171215145930' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CGSQMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
