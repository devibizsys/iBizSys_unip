...
<% if(!p.init(pageContext,"/app/ywsp/OA_CLWXCLWXLC_D_WFGridView.do")){return;}%>
...
<jsp:include page="../../templ/dewfgridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CLWXCLWXLC_D_WFGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_clwxclwxlc_d_wfgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_CLWXCLWXLC_D_WFGridViewController({appctx:'${ctx2}',webctx:'${web}'});
