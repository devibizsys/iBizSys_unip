...
<% if(!p.init(pageContext,"/app/ywsp/OA_SBWXSBWXLC_D_WFEditView3.do")){return;}%>
...
<jsp:include page="../../templ/dewfeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_SBWXSBWXLC_D_WFEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_sbwxsbwxlc_d_wfeditview3_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_SBWXSBWXLC_D_WFEditView3ControllerBase.js?v=1042_20171225145649' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_SBWXSBWXLC_D_WFEditView3Controller.js?v=1042_20171225145649' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_SBWXSBWXLC_D_WFEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
