...
<% if(!p.init(pageContext,"/app/ywsp/OA_CLWXEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CLWXEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_clwxeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CLWXEditViewControllerBase.js?v=1055_20171215174057' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CLWXEditViewController.js?v=1055_20171215174057' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CLWXEditViewController({appctx:'${ctx2}',webctx:'${web}'});
