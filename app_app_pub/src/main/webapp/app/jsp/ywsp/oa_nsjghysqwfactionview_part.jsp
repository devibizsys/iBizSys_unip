...
<%@include file="oa_nsjghysqwfactionview_userpart.jsp"%>
<% if(strCtrlId.compareTo("form")==0){ %>
 <div id="<%=strCId%>form" class="form-horizontal">
   <div class="col-md-12  form-body">
<INPUT type="hidden" name="srfupdatedate" id="<%=strCId%>M12"><INPUT type="hidden" name="srforikey" id="<%=strCId%>M11"><INPUT type="hidden" name="srfkey" id="<%=strCId%>M10"><INPUT type="hidden" name="srfmajortext" id="<%=strCId%>Mf"><INPUT type="hidden" name="srftempmode" id="<%=strCId%>Me"><INPUT type="hidden" name="srfuf" id="<%=strCId%>Md"><INPUT type="hidden" name="srfdeid" id="<%=strCId%>Mc"><INPUT type="hidden" name="srfsourcekey" id="<%=strCId%>Mb"><INPUT type="hidden" name="oa_nsjghysqid" id="<%=strCId%>Ma">
