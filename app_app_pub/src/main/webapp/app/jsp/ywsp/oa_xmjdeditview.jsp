...
<% if(!p.init(pageContext,"/app/ywsp/OA_XMJDEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_XMJDEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_xmjdeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_XMJDEditViewControllerBase.js?v=897_20171219172723' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_XMJDEditViewController.js?v=897_20171219172723' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_XMJDEditViewController({appctx:'${ctx2}',webctx:'${web}'});
