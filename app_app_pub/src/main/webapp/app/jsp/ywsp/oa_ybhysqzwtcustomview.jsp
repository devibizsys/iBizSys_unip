...
<% if(!p.init(pageContext,"/app/ywsp/OA_YBHYSQZWTCustomView.do")){return;}%>
...
<%@include file="../../lib/decustomviewlib-style.jsp"%>
<%}%>
<jsp:include page="../../templ/decustomview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_YBHYSQZWTCustomView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_ybhysqzwtcustomview_part.jsp"/>
...
<%@include file="../../lib/decustomviewlib-script.jsp"%>
<script src='${ctx}/js/ywsp/OA_YBHYSQZWTCustomViewControllerBase.js?v=2831_20171221152931' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_YBHYSQZWTCustomViewController.js?v=2831_20171221152931' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_YBHYSQZWTCustomViewController({appctx:'${ctx2}',webctx:'${web}'});
