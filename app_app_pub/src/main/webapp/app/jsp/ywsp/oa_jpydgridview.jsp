...
<% if(!p.init(pageContext,"/app/ywsp/OA_JPYDGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_JPYDGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_jpydgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_JPYDGridViewController({appctx:'${ctx2}',webctx:'${web}'});
