...
<% if(!p.init(pageContext,"/app/ywsp/OA_CHRYWCHGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CHRYWCHGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_chrywchgridview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CHRYWCHGridViewControllerBase.js?v=871_20171220185323' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CHRYWCHGridViewController.js?v=871_20171220185323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CHRYWCHGridViewController({appctx:'${ctx2}',webctx:'${web}'});
