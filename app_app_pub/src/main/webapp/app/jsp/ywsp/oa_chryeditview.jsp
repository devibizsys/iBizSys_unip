...
<% if(!p.init(pageContext,"/app/ywsp/OA_CHRYEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CHRYEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_chryeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CHRYEditViewControllerBase.js?v=871_20171221133810' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CHRYEditViewController.js?v=871_20171221133810' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CHRYEditViewController({appctx:'${ctx2}',webctx:'${web}'});
