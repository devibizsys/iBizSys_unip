...
<% if(!p.init(pageContext,"/app/ywsp/OA_CHRYGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CHRYGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_chrygridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_CHRYGridViewController({appctx:'${ctx2}',webctx:'${web}'});
