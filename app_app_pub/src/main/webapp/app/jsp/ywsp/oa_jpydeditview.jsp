...
<% if(!p.init(pageContext,"/app/ywsp/OA_JPYDEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_JPYDEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_jpydeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_JPYDEditViewControllerBase.js?v=1074_20171215104403' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_JPYDEditViewController.js?v=1074_20171215104403' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_JPYDEditViewController({appctx:'${ctx2}',webctx:'${web}'});
