...
<% if(!p.init(pageContext,"/app/ywsp/OA_CLWXMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CLWXMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_clwxmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CLWXPickupGridViewControllerBase.js?v=1055_20171215174057' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CLWXPickupGridViewController.js?v=1055_20171215174057' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CLWXMPickupViewControllerBase.js?v=1055_20171215174057' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CLWXMPickupViewController.js?v=1055_20171215174057' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CLWXMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
