...
<% if(!p.init(pageContext,"/app/ywsp/OA_YBHYSQPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_YBHYSQPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_ybhysqpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_YBHYSQPickupViewControllerBase.js?v=2831_20171213163859' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_YBHYSQPickupViewController.js?v=2831_20171213163859' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_YBHYSQPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
