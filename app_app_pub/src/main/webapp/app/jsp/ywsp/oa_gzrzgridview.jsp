...
<% if(!p.init(pageContext,"/app/ywsp/OA_GZRZGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_GZRZGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_gzrzgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_GZRZGridViewController({appctx:'${ctx2}',webctx:'${web}'});
