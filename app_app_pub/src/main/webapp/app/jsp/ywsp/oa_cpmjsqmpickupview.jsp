...
<% if(!p.init(pageContext,"/app/ywsp/OA_CPMJSQMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CPMJSQMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_cpmjsqmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CPMJSQPickupGridViewControllerBase.js?v=1165_20171215112838' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CPMJSQPickupGridViewController.js?v=1165_20171215112838' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CPMJSQMPickupViewControllerBase.js?v=1165_20171215112838' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CPMJSQMPickupViewController.js?v=1165_20171215112838' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CPMJSQMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
