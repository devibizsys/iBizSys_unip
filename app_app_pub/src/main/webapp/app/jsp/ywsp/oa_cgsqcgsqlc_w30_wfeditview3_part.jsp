...
<%@include file="oa_cgsqcgsqlc_w30_wfeditview3_userpart.jsp"%>
<% if(strCtrlId.compareTo("toolbar")==0){ %>
 <div id="<%=strCId%>toolbar">
<button title="拒绝"  data-ibiz-tag="AC3020" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >拒绝</span>  </button>  
<button title="确认"  data-ibiz-tag="AC3010" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >确认</span>  </button>  
