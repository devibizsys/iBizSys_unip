...
<%@include file="oa_ybhysqybhysq_w20_wfgridview_userpart.jsp"%>
...
<button title="申请成功"  data-ibiz-tag="AC2010" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >申请成功</span>  </button>  
<!--分割符号-->
