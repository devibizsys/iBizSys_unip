...
<%@include file="oa_qxjqxjlc_w30_wfgridview_userpart.jsp"%>
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="CONTROL.DEFSFITEM.OA_QXJ.N_ORGUSERNAME_LIKE" text="申请人(%)"></ibiz5:message></label>
</td>
<td>
<div class="col-md-12" >
