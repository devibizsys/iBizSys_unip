...
<% if(!p.init(pageContext,"/app/ywsp/OA_XMJDGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_XMJDGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_xmjdgridview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_XMJDGridViewControllerBase.js?v=897_20171219172723' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_XMJDGridViewController.js?v=897_20171219172723' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_XMJDGridViewController({appctx:'${ctx2}',webctx:'${web}'});
