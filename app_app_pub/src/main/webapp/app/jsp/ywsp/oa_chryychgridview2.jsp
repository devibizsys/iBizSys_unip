...
<% if(!p.init(pageContext,"/app/ywsp/OA_CHRYYCHGridView2.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CHRYYCHGridView2.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_chryychgridview2_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CHRYYCHGridView2ControllerBase.js?v=871_20171220185323' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CHRYYCHGridView2Controller.js?v=871_20171220185323' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CHRYYCHGridView2Controller({appctx:'${ctx2}',webctx:'${web}'});
