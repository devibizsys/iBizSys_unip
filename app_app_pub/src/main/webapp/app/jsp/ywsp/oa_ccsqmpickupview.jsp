...
<% if(!p.init(pageContext,"/app/ywsp/OA_CCSQMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CCSQMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_ccsqmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CCSQPickupGridViewControllerBase.js?v=942_20171215173958' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CCSQPickupGridViewController.js?v=942_20171215173958' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CCSQMPickupViewControllerBase.js?v=942_20171215173958' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CCSQMPickupViewController.js?v=942_20171215173958' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CCSQMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
