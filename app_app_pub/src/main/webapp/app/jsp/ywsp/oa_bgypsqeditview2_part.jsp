...
<%@include file="oa_bgypsqeditview2_userpart.jsp"%>
...
<div id='<%=strCId%>M7__fi' style="" class="ibiz-form-formitem  col-md-12 form-group" data-ibiz-allowblank="1">
	<div class='ibiz-formitem-label-left ' style="position: absolute;">
		<label id='<%=strCId%>M7__lb' class="control-label" style="width:130px;"  >办公用品名称</label>
	</div>
        <div style="margin-left:140px;margin-right:10px;" >
		<div id="<%=strCId%>M7_c" style="" class="ibiz-field-textbox-container"><input id="<%=strCId%>M7" name="bgypmc" type="text"  class="form-control text ibiz-field-textbox" ></div>
	</div>
</div>
...
<textarea id="<%=strCId%>Me" name="bz"  type="text"  class="form-control" ></textarea>
