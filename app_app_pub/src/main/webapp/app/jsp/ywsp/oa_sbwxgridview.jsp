...
<% if(!p.init(pageContext,"/app/ywsp/OA_SBWXGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_SBWXGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_sbwxgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_SBWXGridViewController({appctx:'${ctx2}',webctx:'${web}'});
