...
<% if(!p.init(pageContext,"/app/ywsp/OA_QXJEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_QXJEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_qxjeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_QXJEditViewControllerBase.js?v=1914_20171215173849' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_QXJEditViewController.js?v=1914_20171215173849' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_QXJEditViewController({appctx:'${ctx2}',webctx:'${web}'});
