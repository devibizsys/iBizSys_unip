...
<% if(!p.init(pageContext,"/app/ywsp/OA_STWMDGMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_STWMDGMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_stwmdgmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_STWMDGPickupGridViewControllerBase.js?v=1005_20171215154840' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_STWMDGPickupGridViewController.js?v=1005_20171215154840' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_STWMDGMPickupViewControllerBase.js?v=1005_20171215154840' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_STWMDGMPickupViewController.js?v=1005_20171215154840' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_STWMDGMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
