...
<% if(!p.init(pageContext,"/app/ywsp/OA_GZRZEditView.do")){return;}%>
...
<jsp:include page="../../templ/deeditview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_GZRZEditView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_gzrzeditview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_GZRZEditViewControllerBase.js?v=1984_20171223153416' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_GZRZEditViewController.js?v=1984_20171223153416' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_GZRZEditViewController({appctx:'${ctx2}',webctx:'${web}'});
