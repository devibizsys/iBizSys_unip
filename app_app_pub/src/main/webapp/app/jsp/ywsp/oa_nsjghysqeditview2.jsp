...
<% if(!p.init(pageContext,"/app/ywsp/OA_NSJGHYSQEditView2.do")){return;}%>
...
<jsp:include page="../../templ/deeditview2.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_NSJGHYSQEditView2.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_nsjghysqeditview2_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_NSJGHYSQEditView2ControllerBase.js?v=1116_20171222175447' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_NSJGHYSQEditView2Controller.js?v=1116_20171222175447' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_NSJGHYSQEditView2Controller({appctx:'${ctx2}',webctx:'${web}'});
