...
<% if(!p.init(pageContext,"/app/ywsp/OA_STWMDGGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_STWMDGGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_stwmdggridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_STWMDGGridViewController({appctx:'${ctx2}',webctx:'${web}'});
