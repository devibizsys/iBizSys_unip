...
<% if(!p.init(pageContext,"/app/ywsp/OA_YCSQPickupView.do")){return;}%>
...
<jsp:include page="../../templ/depickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_YCSQPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_ycsqpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_YCSQPickupViewControllerBase.js?v=908_20171215134835' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_YCSQPickupViewController.js?v=908_20171215134835' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_YCSQPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
