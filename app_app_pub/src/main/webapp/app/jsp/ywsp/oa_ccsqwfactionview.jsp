...
<% if(!p.init(pageContext,"/app/ywsp/OA_CCSQWFActionView.do")){return;}%>
...
<jsp:include page="../../templ/dewfactionview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CCSQWFActionView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_ccsqwfactionview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_CCSQWFActionViewControllerBase.js?v=942_20180116172837' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_CCSQWFActionViewController.js?v=942_20180116172837' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_CCSQWFActionViewController({appctx:'${ctx2}',webctx:'${web}'});
