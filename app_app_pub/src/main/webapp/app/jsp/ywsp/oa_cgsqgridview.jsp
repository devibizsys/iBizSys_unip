...
<% if(!p.init(pageContext,"/app/ywsp/OA_CGSQGridView.do")){return;}%>
...
<jsp:include page="../../templ/degridview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_CGSQGridView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_cgsqgridview_part.jsp"/>
...
jQuery(document).ready(function(){
        controller = new OA_CGSQGridViewController({appctx:'${ctx2}',webctx:'${web}'});
