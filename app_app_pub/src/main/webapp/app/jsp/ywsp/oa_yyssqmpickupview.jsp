...
<% if(!p.init(pageContext,"/app/ywsp/OA_YYSSQMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_YYSSQMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_yyssqmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_YYSSQPickupGridViewControllerBase.js?v=819_20171215154917' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_YYSSQPickupGridViewController.js?v=819_20171215154917' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_YYSSQMPickupViewControllerBase.js?v=819_20171215154916' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_YYSSQMPickupViewController.js?v=819_20171215154916' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_YYSSQMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
