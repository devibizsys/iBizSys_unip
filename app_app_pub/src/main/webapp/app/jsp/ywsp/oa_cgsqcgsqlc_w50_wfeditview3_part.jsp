...
<%@include file="oa_cgsqcgsqlc_w50_wfeditview3_userpart.jsp"%>
...
<button title="确认"  data-ibiz-tag="AC5010" data-ibiz-target="MULTIKEY"  class="btn   btn-blue  ibiz-toolbar-item" >                       <span >确认</span>  </button>  
