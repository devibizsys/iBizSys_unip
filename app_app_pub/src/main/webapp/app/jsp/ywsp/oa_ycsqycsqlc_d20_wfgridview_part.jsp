...
<%@include file="oa_ycsqycsqlc_d20_wfgridview_userpart.jsp"%>
...
<label id='<%=strCId%>M4__lb' class="control-label" style="width:130px;"  >接待负责人姓名(%)</label>
</td>
<td>
<div class="col-md-12" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="130" valign="top">
<label id='<%=strCId%>M5__lb' class="control-label" style="width:130px;"  ><ibiz5:message code="CONTROL.DEFSFITEM.OA_YCSQ.N_OA_YCSQNAME_LIKE" text="用餐申请名称(%)"></ibiz5:message></label>
</td>
<td>
<div class="col-md-12" >
	<div id="<%=strCId%>M5_c" style="width:100px;" class="ibiz-field-textbox-container"><input id="<%=strCId%>M5" name="n_oa_ycsqname_like" type="text"  class="form-control text ibiz-field-textbox" ></div>
</div>
</td>
</tr>
</table>
