...
<% if(!p.init(pageContext,"/app/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3.do")){return;}%>
...
<jsp:include page="../../templ/dewfeditview3.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_nsjghysqnsjghysq_w40_wfeditview3_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3ControllerBase.js?v=1116_20171223111733' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3Controller.js?v=1116_20171223111733' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_NSJGHYSQNSJGHYSQ_W40_WFEditView3Controller({appctx:'${ctx2}',webctx:'${web}'});
