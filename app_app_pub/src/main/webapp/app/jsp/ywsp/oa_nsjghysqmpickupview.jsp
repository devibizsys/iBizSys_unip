...
<% if(!p.init(pageContext,"/app/ywsp/OA_NSJGHYSQMPickupView.do")){return;}%>
...
<jsp:include page="../../templ/dempickupview.jsp" flush="true" >
	<jsp:param name="controller" value="/app/ywsp/OA_NSJGHYSQMPickupView.do"/>
	<jsp:param name="parturl" value="../jsp/ywsp/oa_nsjghysqmpickupview_part.jsp"/>
...
<script src='${ctx}/js/ywsp/OA_NSJGHYSQPickupGridViewControllerBase.js?v=1116_20171222175447' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_NSJGHYSQPickupGridViewController.js?v=1116_20171222175447' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_NSJGHYSQMPickupViewControllerBase.js?v=1116_20171222175447' type='text/javascript'></script>
<script src='${ctx}/js/ywsp/OA_NSJGHYSQMPickupViewController.js?v=1116_20171222175447' type='text/javascript'></script>
<script>
var controller = null;
...
jQuery(document).ready(function(){
        controller = new OA_NSJGHYSQMPickupViewController({appctx:'${ctx2}',webctx:'${web}'});
