...
<div style='padding:5px;'>
	...
	<%}%>
	<div >
			<div class="ibiz-ctrl-border" style='float: left; width:230px;min-height:600px; height:auto!important; height:600px; margin-top:10px;margin-left:5px;'>
					<div id="<%=strCId%>drbar"></div>
			</div>
			<div style="overflow:hidden;">
					<jsp:include page="<%=strPartUrl%>" flush="true" >
						...
						<jsp:param name="ctrlid" value="drbar_header"/>
					</jsp:include>     
						<div class="tab-content" style="margin:10px">
							...
							<jsp:include page="<%=strPartUrl%>" flush="true" >
								...
								<jsp:param name="cid" value="<%=strCId%>"/>
								<jsp:param name="embed" value="<%=strEmbed%>"/>
								<jsp:param name="ctrlid" value="drbar_content"/>
							</jsp:include>     
				    </div>
			</div>
	</div>
