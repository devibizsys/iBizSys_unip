...
.ModifyButton{
background-image: url(../../apputil/images/bt_main_bg.gif);
width:130px;
height:32px;
}
</style>
...
<div class="ibiz-page-content ibiz-layout <%if (!bEmbedMode) {%>ibiz-fill<%} %>" id="<%=strCId%>" style='padding:5px 5px 0px 5px;'>
	...
	<div class="ibiz-layout" data-ibiz-layout="region:'center'" >
		<div class=" ibiz-layout" data-ibiz-layout="region:'west',width:'230'" data-ibiz-layout-item="treeexpbar" style='float: left; width:230px;'>
				<div data-ibiz-layout="region:'north',height:'40'" style='height:40px;'>
					<div style="text-align:center;">
						<div class="ModifyButton" style="margin:0 auto;font-size:14px;font-weight:bold;color:#fff;padding-top:6px;">修改我的信息</div>
					</div>
				</div>
				<div id="<%=strCId%>treeexpbar"  class="ibiz-ctrl-border ibiz-layout" data-ibiz-layout="region:'center'" >
